...
$ec_lang['lpn_inp_drop_tanks']='Matanki ya kuhifadhi maji yaliachwa nje. Ukurasa huu una hifadhi za maji, ambazo huwa na kiwango kimoja cha maji kisichobadilika. Tanki la kuhifadhi maji halina kiwango kisichobadilika, hivyo si hifadhi ya maji.';
$ec_lang['lpn_inp_drop_tank_links']='Mabomba haya yaliachwa nje kwa sababu yanaunganika na tanki lililoachwa nje.';
...
$ec_lang['lpn_backdrop_position_prompt1']='Bofya kituo chochote kwenye picha ya nyuma. Hiki ndicho kituo utakachohamisha.';
$ec_lang['lpn_backdrop_position_prompt2']='Chagua mahali kituo hicho kinapaswa kwenda, kisha bofya Endelea.';
...
$ec_lang['lpn_settings_engine_epanet']='Tatua kwa injini ya EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='Inaendesha injini halisi ya EPANET kutoka Shirika la Ulinzi wa Mazingira la Marekani (US EPA), hapa ndani ya kivinjari chako. Kikokotoo cha ndani hutoa majibu yale yale na ni cha haraka zaidi, hivyo iache imezimwa isipokuwa unahitaji EPANET yenyewe.';
$ec_lang['lpn_engine_loading']='Inapakia injini ya EPANET…';
$ec_lang['lpn_engine_failed']='Imeshindwa kupakia injini ya EPANET. Inaonyesha kikokotoo cha ndani badala yake.';
