...
$ec_lang['lpn_inp_drop_quality']='Faili hili linaeleza jinsi ubora wa maji unavyobadilika unaposafiri: kilichomo ndani ya maji mwanzoni, wapi zaidi ya dutu hiyo inapoingia, jinsi inavyoitikia, na jinsi matanki yanavyochanganya. Ukurasa huu hukokotoa umri wa maji na ufuatiliaji wa chanzo, lakini si kemia, hivyo hakuna kati ya hayo kinachotumika hapa. Mistari hiyo inahifadhiwa, na inaandikwa tena ukihifadhi faili la EPANET.';
...
$ec_lang['lpn_tip_select']='Tumia hali hii kubadilisha, kuhamisha, na kuburuta vitu kwenye ramani. Ukurasa hurudi kwenye hali hii wenyewe baada ya vitendo fulani, kama vile kufungua mradi.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Huficha lebo za vifundo na viungo ili rangi tu zibaki kwenye ramani. Maandishi uliyoyaweka mwenyewe yanabaki. Chaguo lako la lebo linahifadhiwa, na kuzima hili kunayarudisha.';
...
$ec_lang['lpn_file_import_geo']='Fungua faili la xy kwenye ramani…';
$ec_lang['lpn_file_import_geo_tip']='Inafungua faili la mradi au faili la EPANET kwenye kichupo kipya cha mradi katika ukurasa huu, juu ya ramani ya barabara. Unaweka mchoro duniani kwa mkono: sogeza na ukuze hadi eneo lako, kisha ubadilishe ukubwa na uugeuze ili ukae vizuri. Kama x na y katika faili tayari ni longitudo na latitudo, bofya kitufe cha Hizi tayari ni lat/lon na mtandao utaruka moja kwa moja mahali unapostahili. Kila namba uliyoandika inabaki jinsi ilivyo.';
...
$ec_lang['lpn_time_no_engine']='Kitatuzi kilichojengwa ndani hukokotoa wakati mmoja kwa wakati, hivyo huu ni mtandao wa {time} pekee: kila muundo unasomwa wakati huo, na kila tanki bado liko kwenye kiwango chake cha mwanzo badala ya kujaa na kupungua. Unganisha kwenye intaneti mara moja ili kupakua kitatuzi cha EPANET, ambacho huendesha kipindi chote.';
...
$ec_lang['lpn_time_run_note']='Unaona mtandao katika wakati wake wa kwanza wa taarifa. Mtandao huu unachukua muda mrefu sana kukokotoa kwa kipindi chake chote cha muda, hivyo matokeo ya nyakati za baadaye hayasasishwi unapofanya kazi. Bonyeza kitufe cha Kokotoa ili kuyasasisha.';
...
$ec_lang['lpn_result_water_age_tip']='Muda ambao maji yanayofika hapa yamekuwa ndani ya mfumo. Hakuna kikomo cha kisheria cha kulinganisha nacho, hivyo pima namba hii dhidi ya mfumo wako mwenyewe.';
...
$ec_lang['lpn_new_coords_xy']='kuratibu za xy';
$ec_lang['lpn_new_coords_geo']='lat/lon';
$ec_lang['lpn_new_coords_tip']='Mradi wa xy hutumia kuratibu ambazo si latitudo na longitudo. Mradi wa lat/lon una kuratibu za kijiografia, hivyo ramani ya barabara au picha ya setilaiti inaweza kuchorwa nyuma yake, na miinuko ya vifundo inaweza kusomwa kutoka usoni mwa ardhi. Mradi wa xy unaweza kubadilishwa kuwa lat/lon kwa Faili, Fungua faili la xy kwenye ramani.';
$ec_lang['lpn_new_place']='Anza karibu na mahali hapa';
$ec_lang['lpn_new_place_tip']='Si lazima. Andika mji, barabara, au alama ya eneo na ramani mpya itafunguka hapo. Maneno unayoandika yanaenda kwenye huduma ya majina ya mahali ya OpenStreetMap, ambayo itakuomba ruhusa mara ya kwanza. Iache tupu na ramani itafunguka kwenye dunia nzima.';
$ec_lang['lpn_new_place_hint']='Zanzibar, Tanzania';
$ec_lang['lpn_new_create']='Unda';
$ec_lang['lpn_inp_drop_rules']='Faili hili lina vidhibiti vya msingi wa kanuni. Havitumiki hapa, hivyo mabomba, pampu na vali vinavyotajwa navyo vinabaki katika hali iliyoandikwa kwenye faili. Kanuni zenyewe zinahifadhiwa, na zinaandikwa tena ukihifadhi faili la EPANET.';
$ec_lang['lpn_inp_drop_energy']='Faili hili la EPANET lina data ya uigaji wa gharama za kusukuma maji. Ukurasa huu haukokotoi nishati wala gharama, hivyo hakuna kinachotumia namba hizo hapa. Zinahifadhiwa, na zinaandikwa tena ukihifadhi faili la EPANET.';
$ec_lang['lpn_inp_drop_tags']='Faili hili linatoa lebo za utambulisho kwa baadhi ya miunganiko yake, mabomba, au vipengele vingine. Bado hakuna sehemu kwenye ukurasa huu ya kuona au kubadilisha lebo ya utambulisho. Lebo hizo zinahifadhiwa, na zinaandikwa tena ukihifadhi faili la EPANET.';
$ec_lang['lpn_inp_drop_report']='Faili hili lina mipangilio ya EPANET yenyewe kwa ripoti inazochapisha. Ukurasa huu unaonyesha majibu yake kwa njia yake mwenyewe, hivyo hakuna kinachotumia mipangilio hiyo hapa. Inahifadhiwa, na inaandikwa tena ukihifadhi faili la EPANET.';
...
$ec_lang['lpn_inp_drop_quality_options']='Faili hili linaeleza chaguo za ubora wa maji za EPANET: Ubora wa maji, linalotaja aina ya uchambuzi wa ubora wa maji, na mipangilio miwili inayohusiana na kemikali, Usambaaji wa uwiano na Uvumilivu wa ubora. Umri wa maji na ufuatiliaji wa chanzo ndivyo vinavyokokotolewa hapa; kemikali hakikotolewi, hivyo mipangilio hiyo miwili inahifadhiwa bila kutumika. Yote inaandikwa tena ukihifadhi faili la EPANET.';
...
$ec_lang['lpn_settings_quality_track_tip']='Chagua kile ambacho utendeshaji unapaswa kufuatilia kupitia mabomba: muda ambao maji yamekuwa ndani ya mfumo, au yalikotoka. Hakuna kati ya hivyo kinachohitaji mkusanyiko au kasi ya mwitikio.';
...
$ec_lang['lpn_quality_chemical']='Kemikali inayotajwa na faili hili (imehifadhiwa, haikokotolewi)';
$ec_lang['lpn_quality_needs_run']='Ubora wa maji hubebwa kupitia mabomba kwa muda, hivyo unahitaji kitatuzi cha EPANET na muda wote wa kuendesha. Weka Muda wote wa kuendesha chini ya Muda, kisha bofya kitufe cha Kokotoa.';
...
$ec_lang['lpn_ff_menu']='Mtiririko wa moto…';
...
$ec_lang['lpn_ff_title']='Mtiririko wa moto';
...
$ec_lang['lpn_ff_required_node_tip']='Mtiririko wa moto unaohitajika kwenye muunganiko huu hasa, kutoka kanuni yako ya moto au mamlaka yako ya zimamoto kwa matumizi ya ardhi anayohudumia. Kiache tupu na muunganiko utajaribiwa dhidi ya namba iliyo kwenye kisanduku cha Mtiririko wa moto unaohitajika.';
