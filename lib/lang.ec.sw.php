...
$ec_lang['lpn_settings_sec_assets']='Vipengele vipya';
...
$ec_lang['lpn_basemap_satellite_hide']='Ficha picha za satelaiti';
$ec_lang['lpn_basemap_satellite_tip']='Picha za ardhi kutoka Mapbox, zinazopakuliwa kwa mtandao wa intaneti unaposogeza au kukuza ramani. Zinasaidia kuona bomba linapopita hasa. Mtandao wako unachorwa iwe picha hizi zinaonekana au la.';
$ec_lang['lpn_georef_asdeg_btn']='Hizi tayari ni longitudo/latitudo';
$ec_lang['lpn_georef_asdeg_tip']='Bonyeza hii tu kama x na y katika faili hii kwa kweli ni longitudo na latitudo. Mtandao utaruka kwenda mahali ambapo namba hizo zinasema uko, na hakuna kinachohitaji kuwekwa upya. Kila namba inabaki kama ilivyo katika hali zote mbili.';
$ec_lang['lpn_georef_asdegrees']='X na y katika faili hii zilisomwa kama longitudo na latitudo, hivyo mtandao tayari uko kwenye ramani na hakuna kilichosogezwa. Angalia kama uko mahali sahihi, kisha bonyeza Weka mahali hapa.';
...
$ec_lang['lpn_menu_project']='Mradi';
...
$ec_lang['lpn_run_menu_tip']='Kokotoa upya mtandao huu sasa hivi. Unatafuta kitufe cha Endesha? Wakati mradi huu unakokotoa upya baada ya kila mabadiliko, upauzana haina kitufe cha Endesha. Zima “Kokotoa upya kiotomatiki” kwenye Mipangilio, chini ya Ukokotoaji, Haidroliki, na kitufe kitarudi.';
...
$ec_lang['lpn_replace_button']='Badilisha';
...
$ec_lang['lpn_profile_draw']='Chagua njia kwenye ramani';
$ec_lang['lpn_profile_draw_stop']='Acha kuchagua';
...
$ec_lang['lpn_inp_drop_head_pattern']='Hifadhi hizi za maji zinapanda na kushuka wakati wa siku. Miundo yao iliingia kamili, na kiwango cha maji unachokiona ni kile cha wakati ambao saa inaonyesha.';
$ec_lang['lpn_inp_drop_pump_speed']='Pampu hizi zinaendesha kwa kasi tofauti na ile iliyopimwa kwenye mkondo wake, au kasi yao inabadilika wakati wa siku. Kasi na muundo wake viliingia kamili, na kimo unachokiona ni cha wakati ambao saa inaonyesha.';
...
$ec_lang['lpn_import_notes_heading']='Kutoka kwenye faili la EPANET';
...
$ec_lang['lpn_time_run_report_tip']='Kile ambacho kitatuzi cha EPANET chenyewe kilichapisha kuhusu uendeshaji wa mwisho: jinsi kilivyotulia, na chochote kilichoonya kuhusu. Ni maandishi ya kitatuzi chenyewe, si yetu.';
...
$ec_lang['lpn_library_curves_tip']='Mkondo ni vituo vinavyosema jinsi pampu inavyofanya kazi: ni kimo kiasi gani inachotoa kwa kila mtiririko.';
$ec_lang['lpn_library_curves_note']='Mkondo unamilikiwa na pampu au vali inayoutumia, hivyo hii ni orodha nzima mahali pamoja pa kusoma. Bofya kitambulisho ili kwenda kwenye kipengele hicho na kubadilisha vituo vyake huko. Kwa pampu, mstari uliochorwa ndio mkondo unaotumika wakati wa uendeshaji, uliopatanishwa kupitia vituo hivyo; kwa vali ni ngazi zilizonyooka kati yao.';
...
$ec_lang['lpn_library_default_pattern']='Muundo wa chaguo-msingi wa mahitaji';
$ec_lang['lpn_library_default_pattern_tip']='Kila muunganiko usio na muundo hutumia huu.';
...
$ec_lang['lpn_field_demand_pattern_tip']='Jinsi mahitaji ya muunganiko huu yanavyopanda na kushuka wakati wa uendeshaji. Acha kwenye Hakuna muundo ili kufuata muundo wa mradi wenyewe.';
...
$ec_lang['lpn_field_speed_pattern_tip']='Jinsi kasi ya pampu hii inavyopanda na kushuka wakati wa uendeshaji. Kila kizidishi NDIYO kasi ya uwiano kwa sehemu hiyo ya siku, na kinachukua nafasi ya kasi iliyoandikwa hapo juu, hivyo kizidishi cha 0 husimamisha pampu.';
...
$ec_lang['lpn_terrain_menu']='Jaza miinuko kutoka ardhini…';
$ec_lang['lpn_terrain_tip']='Soma mwinuko wa ardhi chini ya kila kifundo kisicho na mwinuko, na ukuandikie wewe. Kifundo chenye mwinuko tayari kinaachwa jinsi kilivyo, na Tendua moja hurudisha vyote. Matumizi ya kwanza yanauliza ruhusa yako, kwa sababu nafasi za vifundo vyako zinakwenda Mapbox.';
$ec_lang['lpn_terrain_accuracy']='Data ya ardhi ina usahihi wa mita 30 hivi juu ya ardhi, na mara nyingi inakosea mita kadhaa kiwima. Ichukulie kama ramani ya mikondo ya usawa, si upimaji sahihi: hakiki chochote unachokitegemea.';
...
$ec_lang['lpn_terrain_confirm']='Jaza mwinuko wa vifundo {n} kutoka usoni mwa ardhi?';
...
$ec_lang['lpn_terrain_confirm_default_2']='Badilisha vile {n} kwa usoni mwa ardhi?';
...
$ec_lang['lpn_terrain_none_needed']='Kila kifundo tayari kina mwinuko ulioweka wewe mwenyewe. Hakuna kilichobadilishwa, na hakuna kilichotumwa — hatuandiki upya mwinuko ulio pale tayari.';
$ec_lang['lpn_terrain_no_nodes']='Bado hakuna vifundo vya kujaza.';
