...
$ec_lang['lpn_inp_drop_patterns']='Miundo ya mahitaji iliachwa nje, kwa sababu sehemu ya ukurasa huu inayoendesha mtandao kwa muda haikupakia. Kila mahitaji ni namba iliyoandikwa kwenye faili.';
...
$ec_lang['lpn_inp_drop_curve_missing']='Pampu hii inataja mkondo ambao haupo kwenye faili. Iliingia bila mkondo, hivyo haiongezi kimo chochote.';
$ec_lang['lpn_inp_drop_pump_other']='Pampu hii inaelezwa kwa nguvu (power), kasi, au ratiba, badala ya mkondo. Iliingia bila mkondo, hivyo haiongezi kimo chochote.';
...
$ec_lang['lpn_inp_drop_controls']='Vidhibiti na kanuni ziliachwa nje. Kila bomba, pampu na vali iliingia katika hali iliyoandikwa kwenye faili, na haibadiliki.';
$ec_lang['lpn_inp_drop_eps']='Faili hili linaelezea uigaji unaoendesha kwa kipindi cha muda. Sehemu ya ukurasa huu inayoendesha mtandao kwa muda haikupakia, hivyo hali za mwanzo pekee ndizo zilizoingia.';
$ec_lang['lpn_inp_drop_quality']='Ubora wa maji, miitikio ya kemikali, na mipangilio ya nishati ya pampu iliachwa nje. Ukurasa huu unatatua mtiririko na shinikizo tu.';
...
$ec_lang['lpn_lock_open_heading_unsaved']='{name} ana faili hili wazi; hariri ya mwisho ilikuwa {x} zilizopita, na hakuna hata moja iliyohifadhiwa kwenye faili hili bado.';
$ec_lang['lpn_lock_open_heading_saved']='{name} ana faili hili wazi; hariri ya mwisho ilikuwa {x} zilizopita, na kazi yao imehifadhiwa kwenye faili.';
$ec_lang['lpn_lock_open_heading_seen']='{name} ana faili hili wazi lakini hajaharirika. Kivinjari chao kilikagua mara ya mwisho {x} zilizopita.';
$ec_lang['lpn_lock_open_choices']='Chaguo zako: (1) Ghairi na uwaombe walifungue ikihitajika kisha walifunge vizuri (kufunga kivinjari hakufungi mradi), (2) Fungua kwa kusoma tu, au (3) ikiwa kila kitu kingine kimeshindikana, unaweza kuvunja mfungo wao. Kazi yao isiyohifadhiwa haipotei, lakini hawataweza kuhifadhi juu ya mabadiliko yako, na huenda mtu akalazimika kuunganisha zote mbili kwa mkono.';
...
$ec_lang['lpn_notes_4_def']='Hali mbalimbali (scenarios), ili mradi mmoja uweze kubeba seti kadhaa za mahitaji. Majedwali ya matokeo ya vifundo na mabomba. Kuandika faili za EPANET .inp, ili mradi uweze kurudi EPANET. Maoni na mapendekezo yanakaribishwa daima (angalia kiungo cha maoni hapo juu).';
...
$ec_lang['lpn_pump_curve_note']='Kituo kimoja, viwili, au vitatu — angalia "Mkondo wa pampu" kwenye Maelezo hapa chini.';
$ec_lang['lpn_pump_point1']='Kituo cha 1';
$ec_lang['lpn_pump_point2']='Kituo cha 2';
$ec_lang['lpn_pump_point3']='Kituo cha 3';
...
$ec_lang['lpn_labels_mark_extrema_tip']='Huchora mstari juu ya thamani ya juu kabisa ya kila aina kwenye ramani, na mstari chini ya thamani ya chini kabisa ya aina hiyo, ili uweze kutambua ncha hizo mbili bila kusoma namba.';
...
$ec_lang['lpn_labels_prefix_tip']='Maandishi yanayoonyeshwa kabla ya thamani hii kwenye ramani';
$ec_lang['lpn_labels_prefix_id_tip']='Maandishi yanayoonyeshwa kabla ya kitambulisho kwenye ramani. Acha hili tupu na kitambulisho kitaonyeshwa peke yake, kikianza na herufi lililopewa, kama J1 au L1.';
$ec_lang['lpn_labels_suffix_tip']='Maandishi yanayoonyeshwa baada ya thamani hii kwenye ramani';
$ec_lang['lpn_labels_suffix_gradient_tip']='Maandishi yanayoonyeshwa baada ya mteremko wa upotevu wa kimo kwenye ramani. Usiandike alama ya asilimia hapa. Inaongezwa kwa ajili yako pale vitengo vinapokuwa asilimia.';
$ec_lang['lpn_labels_separator']='Maandishi kati ya thamani';
$ec_lang['lpn_labels_separator_tip']='Maandishi kati ya thamani moja na nyingine kwenye lebo. Nafasi (space) huwa ndiyo ya kawaida.';
...
$ec_lang['lpn_labels_priority_node_tip']='Kipaumbele cha kuamua lebo ipi iondolewe kwanza wakati ramani imejaa: mahitaji ya chini kabisa, shinikizo lililo karibu na katikati ya wigo, au mwinuko au kimo kilicho karibu zaidi na vile vya vifundo jirani. 1 huamua kwanza.';
...
$ec_lang['lpn_settings_scope_project']='Mipangilio ya mradi';
$ec_lang['lpn_settings_scope_calculator']='Mipangilio ya kikokotoo';
...
$ec_lang['lpn_settings_push_btn']='Tumia thamani za kuanzia kwa vipengele vyote';
...
$ec_lang['lpn_push_elements']='Vifundo na mabomba:';
...
$ec_lang['lpn_settings_engine_epanet']='Tatua kwa kitatuzi cha EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='Inaendesha kitatuzi cha EPANET kutoka Shirika la Ulinzi wa Mazingira la Marekani (US EPA), hapa ndani ya kivinjari chako. Kwenye mtandao wa ukubwa huu hutaona tofauti ya kasi. Vitatuzi vyote viwili hukubaliana karibu kabisa, lakini si kabisa: EPANET hurunda thamani inayoitumia kwa mvuto wa dunia, hivyo upotevu wake wa ndani hutokea chini kwa takriban 0.08% kuliko kitatuzi kilichojengwa ndani, na kwa usuguo wa Manning upotevu wake wa kimo hutokea chini kwa takriban 0.6%. Mara ya kwanza unapowasha kisanduku hiki, takriban KB 650 hupakuliwa kisha kubaki kwenye kifaa hiki.';
...
$ec_lang['lpn_settings_colors']='Rangi kwa thamani';
...
$ec_lang['lpn_settings_color_thematic']='Ramani ya mada: rangi tu, bila lebo';
...
// Sprint 438-series delta: profile view, project georeferencing (lat/lon <-> XY), find/select,
// color-by-value legend, PBV/GPV valves, .inp export, EPANET-engine time simulation. sw pass.
...
$ec_lang['lpn_units_warn_body']='{unit} ni kitengo cha unachoingiza kwa: {list}. Fasiri upya huacha kila namba jinsi ilivyo na kuisoma kwa kitengo kipya. Badilisha zote huandika upya kila moja ya namba hizo, ili mtandao ubaki na ukubwa uleule wa awali.';
$ec_lang['lpn_units_reinterpret']='Fasiri upya (badilisha maana yake)';
$ec_lang['lpn_units_convert']='Badilisha zote';
...
$ec_lang['lpn_units_group_inputs']='Vitengo vya maingizo';
$ec_lang['lpn_units_group_results']='Vitengo vya matokeo';
...
$ec_lang['lpn_file_import_geo']='Badilisha kuwa lat/lon…';
$ec_lang['lpn_file_import_geo_tip']='Kutoka gridi ya eneo hadi ulimwengu halisi. Weka mchoro uliochorwa kwenye gridi ya XY kwenye kuratibu za kijiografia, ili ukae kwenye ramani ya barabara mahali unapostahili. Kila namba uliyoandika inabaki jinsi ilivyo — X na Y pekee ndizo zinakuwa longitudo na latitudo.';
...
$ec_lang['lpn_tool_add_tank_tip']='Bofya ramani ili kuongeza tanki: hifadhi yenye uso wa maji unaoupanga wewe.';
...
$ec_lang['lpn_find_menu_tip']='Tafuta kipengele kwa kitambulisho chake, au tafuta kila kipengele kinachokidhi kigezo.';
...
$ec_lang['lpn_color_ranges_note']='Hali iliyo hapo juu huweka mipaka hii kutoka thamani zilizopo sasa kwenye ramani. Ibadilishe kwa kuandika juu yake, na namba ile ile daima itamaanisha rangi ile ile.';
$ec_lang['lpn_color_criterion_note']='Mipaka ya wigo inatoka kwenye kiwango cha kubuni, hivyo idadi ya wigo haibadiliki wakati hali hiyo imechaguliwa.';
...
$ec_lang['lpn_pane_toggle_tip']='Onyesha au ficha kidirisha kilicho chini ya ramani. Kina wasifu na jedwali la miunganiko.';
...
$ec_lang['lpn_pane_tab_tip']='Kila muunganiko kama jedwali unaloweza kupanga na kuhariri.';
$ec_lang['lpn_pane_none']='Mtandao huu hauna miunganiko bado.';
$ec_lang['lpn_pane_sort_tip']='Panga kwa safu hii. Bofya tena ili kugeuza mpangilio.';
$ec_lang['lpn_clean_map']='Ficha visomo vya ramani';
$ec_lang['lpn_clean_map_off']='Onyesha visomo vya ramani';

// batch 3
$ec_lang['lpn_clean_map_tip']='Ficha mstari wa hali na kisomo cha kuratibu ili picha ya skrini ionyeshe ramani pekee. Mchoro wako hauguswi, na chaguo hili halihifadhiwi — kupakia upya ukurasa kunarudisha visomo.';
$ec_lang['lpn_find_menu']='Tafuta';
$ec_lang['lpn_find_title']='Tafuta vipengele';
...
$ec_lang['lpn_find_button']='Tafuta';
...
$ec_lang['lpn_profile_title']='Wasifu kwa njia iliyochaguliwa';
$ec_lang['lpn_profile_from']='Kutoka';
$ec_lang['lpn_profile_to']='Hadi';
$ec_lang['lpn_profile_pick']='Ongeza vifundo kwenye njia kwa kuvibofya kwenye ramani';
$ec_lang['lpn_profile_through']='Vifundo njiani';
$ec_lang['lpn_profile_clear']='Ondoa vyote';
...
$ec_lang['lpn_new_geo_us']='Mradi tupu wa lat/lon, vitengo vya US (gpm)';
$ec_lang['lpn_new_geo_si']='Mradi tupu wa lat/lon, vitengo vya SI (L/s)';
...
$ec_lang['lpn_inp_drop_demand_pattern']='Miunganiko hii hubadilisha mahitaji yake wakati wa siku. Miundo yake iliingia kamili, na mahitaji unayoyaona ni yale ya wakati ambao saa inaonyesha.';
...
// batch 4
$ec_lang['lpn_inp_drop_gpv_curve']='Vali hii inataja mkondo wa upotevu wa kimo ambao haupo kwenye faili. Vali iliingia bila mkondo, hivyo inabaki wazi mpaka utakapoipa mkondo.';
$ec_lang['lpn_gpv_curve_note']='Hadi vituo vitatu vya mtiririko na upotevu wa kimo kwenye mtiririko huo. Viache wazi na vali itabaki wazi kabisa.';
...
$ec_lang['lpn_time_no_period']='Mradi huu hauna kipindi cha muda, hivyo kuna wakati mmoja tu wa kuonyesha. Weka Muda wote wa kuendesha kwenye Mipangilio ili kukokotoa mtandao kwa muda.';
...
$ec_lang['lpn_time_run']='Endesha';
$ec_lang['lpn_time_run_tip']='Kokotoa mtandao huu kwa kila wakati wake wa taarifa, kutoka wa kwanza hadi wa mwisho.';
$ec_lang['lpn_time_run_note']='Unaona mtandao katika wakati wake wa kwanza wa taarifa. Mtandao huu unachukua muda mrefu sana kukokotoa kwa kipindi chake chote cha muda, hivyo matokeo ya nyakati za baadaye hayasasishwi unapofanya kazi. Bonyeza Endesha ili kuyasasisha.';
...
$ec_lang['lpn_settings_sec_visualization']='Taswira';
$ec_lang['lpn_settings_sec_map']='Ramani na ukurasa';
$ec_lang['lpn_settings_sec_elements']='Vipengele vipya';
$ec_lang['lpn_settings_sec_calculation']='Ukokotoaji';
$ec_lang['lpn_settings_node_symbology']='Alama za vifundo';
$ec_lang['lpn_settings_link_symbology']='Alama za viungo';
...
$ec_lang['lpn_settings_node_link']='Kifundo na kiungo';
