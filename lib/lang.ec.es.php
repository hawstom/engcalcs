...
$ec_lang['lpn_field_text_match_pipe']='Igualar el ángulo de la tubería';
...
$ec_lang['lpn_examples_size']='{nodes} nudos, {links} tuberías';
...
$ec_lang['lpn_ex_net3_desc']='El ejemplo grande de EPANET: 97 nudos, dos depósitos y una fuente de río. Vale la pena abrirlo para ver cómo se ve en el mapa un modelo de tamaño real.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Ejecuta el solucionador de EPANET de la EPA de EE. UU., aquí en su navegador. Ambos solucionadores dan los mismos resultados, y en una red de este tamaño no notará una diferencia de velocidad. La primera vez que active esto, se descargan cerca de 650 KB, que luego se guardan en este dispositivo.';
...
$ec_lang['lpn_settings_readability_bias']='Grados a la izquierda de la vertical antes de girar una etiqueta';
...
$ec_lang['lpn_unit_unknown']='Este dibujo indica una unidad que esta página no ofrece: {unit}. Todo se conserva y se muestra exactamente como llegó, y no se cambió nada. No se pueden dar resultados hasta que esta página conozca esa unidad, porque no hay forma de saber qué tan grande es.';
