...
$ec_lang['template_translation_help']='¿Puede sugerir una mejor redacción o cualquier otra cosa? Cuéntenos.';
...
$ec_lang['ip_du_estimate']='<span class="ec-help" title="Caudal calculado del último emisor dividido entre el caudal promedio estimado de emisor de campo &mdash; esto es una aproximación de la Uniformidad de Distribución del cuarto inferior estándar (promedio del grupo inferior &divide; media poblacional); proviene de una muestra pequeña modelada y una corrección estimada por el usuario, en lugar de una muestra estadística de campo completo. Los valores en o por encima de 1 son posibles y válidos: solo significan que la presión del último emisor está en o por encima del promedio de campo estimado, por lo que algún otro emisor es el punto de menor presión. Esto podría deberse a que el último emisor está en terreno bajo o a que la estimación de &Delta;presión es demasiado pequeña.">Verificación de uniformidad, q<sub>last</sub>/q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
$ec_lang['ip_worst_case_warn']='Presión en el emisor de prueba &ge; presión de suministro. Es probable que este no sea el emisor de peor caso, o que las tuberías podrían ser de menor tamaño.';
$ec_lang['ip_q_ratio']='<span class="ec-help" title="Esto es diferente de nuestra aproximación de la medida de uniformidad estándar.">Caudal del último emisor &divide; caudal de diseño, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_notes_3_def']='Modela una presión de suministro fija (sin curva de bomba), una sola ruta de prueba (no el campo completo), y una curva de emisor de 2 parámetros (establezca el exponente cerca de 0 para aproximar un emisor con compensación de presión). Se reportan dos ratios de uniformidad diferentes, mantenidos deliberadamente separados: q<sub>last</sub>/q<sub>avg,field</sub> es una aproximación de la Uniformidad de Distribución del cuarto inferior estándar (promedio del grupo inferior &divide; media poblacional); pero esto proviene de una muestra pequeña modelada y una corrección estimada por el usuario, en lugar de la muestra estadística de campo completo estándar. Además, la lateral de prueba es deliberadamente el caso peor presumido, por lo que su promedio crudo, sin corregir, subestimaría el verdadero promedio de campo y haría que la uniformidad pareciera mejor de lo que es; la entrada de &Delta;presión existe específicamente para contrarrestar ese sesgo. Los valores de uniformidad en o por encima de 1 aún son posibles: solo significan que la presión del último emisor está en o por encima del promedio de campo estimado, por lo que algún otro emisor es el punto de menor presión. Esto podría deberse a que el último emisor está en terreno bajo o a que la estimación de &Delta;presión es demasiado pequeña. q<sub>last</sub>/q<sub>design</sub> es una verificación diferente, no de uniformidad, contra el caudal nominal del fabricante &mdash; útil para detectar un sistema sobre- o subpresurizado en general, pero es una verificación separada que debe leerse junto con el número de uniformidad, ya que el caudal de diseño/nominal es independiente de la presión operativa media real del sistema.';
