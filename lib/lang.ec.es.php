...
$ec_lang['lpn_pane_tab_junctions_tip']='Todos los nudos en una tabla que puede ordenar y editar.';
$ec_lang['lpn_pane_junctions_none']='Esta red todavía no tiene nudos.';
...
$ec_lang['lpn_georef_menu']='Convertir a lat/lon…';
$ec_lang['lpn_georef_tip']='De una cuadrícula local al mundo real. Coloca un dibujo hecho en la cuadrícula XY sobre coordenadas geográficas, para que quede en su lugar sobre el mapa de calles. Cada número que escribió permanece igual — solo la X y la Y se convierten en una longitud y una latitud.';
...
$ec_lang['lpn_profile_from']='Desde';
$ec_lang['lpn_profile_to']='Hasta';
$ec_lang['lpn_profile_pick']='Agregue nodos a la ruta haciendo clic en ellos en el mapa';
$ec_lang['lpn_profile_through']='Nodos en el camino';
$ec_lang['lpn_profile_clear']='Quitar todos';
...
$ec_lang['lpn_new_blank_us']='Proyecto XY en blanco, unidades US (gpm)';
$ec_lang['lpn_new_blank_si']='Proyecto XY en blanco, unidades SI (l/s)';
$ec_lang['lpn_new_geo_us']='Proyecto lat/lon en blanco, unidades US (gpm)';
$ec_lang['lpn_new_geo_si']='Proyecto lat/lon en blanco, unidades SI (l/s)';
...
$ec_lang['lpn_labels_prefix_id_tip']='Texto que se muestra antes del ID en el mapa. Déjelo en blanco y el ID se muestra solo, empezando con la letra que se le dio, como J1 o L1.';
...
$ec_lang['lpn_settings_sec_elements']='Elementos nuevos';
