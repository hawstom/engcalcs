...
$ec_lang['consent_decline']='Rechazar';
...
$ec_lang['lpn_main_title']='Calculadora gratis en línea de redes de distribución de agua con el motor EPANET';
...
$ec_lang['lpn_new_blank_us']='Proyecto en blanco, unidades US (gpm)';
$ec_lang['lpn_new_blank_si']='Proyecto en blanco, unidades SI (l/s)';
$ec_lang['lpn_new_from_examples']='A partir de ejemplos';
...
$ec_lang['lpn_new_example_us']='Red básica, unidades US (gpm)';
$ec_lang['lpn_new_example_si']='Red básica, unidades SI (l/s)';
...
$ec_lang['lpn_inp_report_counts']='{nodes} nudos y embalses, {links} tuberías y bombas, en {units}.';
...
$ec_lang['lpn_inp_drop_tanks']='Se dejaron fuera los tanques de almacenamiento. Esta página tiene embalses, que mantienen un nivel de agua fijo. Un tanque de almacenamiento no mantiene un nivel fijo, así que no es un embalse.';
$ec_lang['lpn_inp_drop_tank_links']='Estas tuberías se dejaron fuera porque se conectan a un tanque que se dejó fuera.';
$ec_lang['lpn_inp_drop_tcv']='Estas válvulas de control de estrangulamiento se incorporaron como tuberías muy cortas que llevan la misma pérdida localizada. El agua se comporta igual, pero el elemento no es el mismo.';
$ec_lang['lpn_inp_drop_valve']='Estas válvulas controlan la presión o el caudal, y esta página no tiene un elemento así. Se incorporaron como tuberías abiertas, así que la red sigue conectada, pero ya nada la controla.';
...
$ec_lang['lpn_inp_drop_patterns']='Se dejaron fuera los patrones de demanda. Esta página resuelve un solo instante, así que cada demanda es el número escrito en el archivo.';
...
$ec_lang['lpn_inp_drop_controls']='Se dejaron fuera los controles y las reglas. Cada tubería, bomba y válvula se incorporó en el estado escrito en el archivo, y no cambia.';
$ec_lang['lpn_inp_drop_eps']='Este archivo describe una simulación que se ejecuta a lo largo de un período de tiempo. Esta página resuelve un solo instante, así que solo se incorporaron las condiciones iniciales.';
...
$ec_lang['lpn_settings_engine_epanet']='Resolver con el motor de EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='Ejecuta el motor original de EPANET de la EPA de EE. UU., aquí en su navegador. El solucionador incorporado da los mismos resultados y es más rápido, así que deje esto desactivado a menos que necesite EPANET en sí.';
$ec_lang['lpn_engine_loading']='Cargando el motor de EPANET…';
$ec_lang['lpn_engine_failed']='No se pudo cargar el motor de EPANET. Se muestra el solucionador incorporado en su lugar.';
