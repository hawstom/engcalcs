...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="Altura de rugosidad de Darcy-Weisbach"><span class="ec-tip">?</span></span>';
$ec_lang['dw_kinematic_viscosity']='<span class="ec-help" title="1×10⁻⁶ m²/s para agua limpia a 20°C">Viscosidad cinemática, &nu; <span class="ec-tip">?</span></span>';
...
$ec_lang['mtc_sgrock']='<span class="ec-help" title="Típicamente &asymp; 2.65 para roca triturada">Gravedad específica de la roca, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">Coef. pérdidas menores, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">Viscosidad cinemática, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="Granito o basalto triturado típico ≈ 2,65. Rango válido Robinson: 2,54 a 2,82.">Gravedad específica de la roca, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_e']='<span class="ec-help" title="Altura de rugosidad de Darcy-Weisbach">e <span class="ec-tip">?</span></span>';
$ec_lang['ip_km']='<span class="ec-help" title="Coeficiente genérico de pérdida menor para los accesorios/válvulas/acoples de este tramo (≥0,5 mínimo sugerido)">k<sub>m</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_ratio']='<span class="ec-help" title="Una verificación separada, no una cifra de uniformidad: qué tan lejos del punto de diseño nominal del fabricante funciona el último emisor. Arriba de 1: funcionando por encima de su punto de diseño (p. ej., de una ganancia de elevación favorable cuesta abajo). Abajo de 1: funcionando bajo diseño (caso típico dominado por fricción).">Caudal del último emisor vs. caudal de diseño, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
