...
$ec_lang['bpn_line_problem']='Revise la columna Aguas arriba: un tramo apunta a un ID desconocido, se referencia a sí mismo, o forma un bucle, por lo que parte de la red no está conectada a la fuente. Esos tramos quedan sin resolver.';
$ec_lang['bpn_bad_id_short']='Red';
