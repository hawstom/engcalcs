...
$ec_lang['mhp_nu']='Viscosidad cinemática, &nu; <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['mhp_efficiency']='Rendimiento de la instalación, &eta; (0&ndash;1)';
...
$ec_lang['mhp_vel_low']='menor de 1 m/s — reducir diámetro ⚠';
$ec_lang['mhp_vel_high']='mayor de 3 m/s — aumentar diámetro ⚠';
...
$ec_lang['mhp_notes_1_def']='La pérdida total en la tubería de presión h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, donde h<sub>f</sub> = f(L/D)(v&sup2;/2g) es la pérdida por fricción de Darcy-Weisbach y h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g cubre entradas, codos y válvulas. Altura neta H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Velocidad';
$ec_lang['mhp_notes_2_def']='Objetivo: 1&ndash;3 m/s. Por debajo de 1 m/s la tubería queda sobredimensionada para el caudal; por encima de 3 m/s aumentan las pérdidas por fricción y el riesgo de golpe de ariete.';
$ec_lang['mhp_notes_3_term']='Objetivo de pérdida de carga';
$ec_lang['mhp_notes_3_def']='Las pérdidas en la tubería de presión inferiores al 10% de la altura bruta son generalmente económicas. La compensación óptima entre el coste de la tubería y la potencia perdida suele situarse en torno al 4&ndash;6% para instalaciones de electricidad de alto valor.';
