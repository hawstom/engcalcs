...
$ec_lang['dw_roughness']='Rugosidad, e';
$ec_lang['dw_roughness_tip']='<span title="Altura de rugosidad de Darcy-Weisbach" class="ec-tip">?</span>';
$ec_lang['dw_kinematic_viscosity']='Viscosidad cinemática, &nu; <span title="1×10⁻⁶ m²/s para agua limpia a 20°C" class="ec-tip">?</span>';
...
$ec_lang['mi_q_617']='Q <span title="El caudal compuesto, Q, usando una n compuesta para cada región según Chow 6-17, velocidades iguales" class="ec-tip">?</span>';
...
$ec_lang['mpf_friction_slope']='Pendiente de fricción (a veces <a target="_blank" href="../frictionslope.php">?</a> igual a la pendiente de la tubería), S<sub>f</sub>';
...
$ec_lang['mpf_velocity_head']='Carga de velocidad, h<sub>v</sub>';
...
$ec_lang['mtc_bend_angle']='Ángulo de la curva, β <a target="_blank" href="riprap-bend-angle.png" title="Haga clic para ver imagen">?</a> (para el tamaño de roca)';
$ec_lang['mtc_sgrock']='Gravedad específica de la roca, sg <span title="Típicamente &asymp; 2.65 para roca triturada" class="ec-tip">?</span>';
...
$ec_lang['mtc_d50_bottom']='Tamaño de roca angular requerido en el fondo, D<sub>50</sub> (Isbash y MC) <span title="Según Isbash (1936) y el condado de Maricopa, Arizona, EE. UU." class="ec-tip">?</span>';
$ec_lang['mtc_d50_z1']='Tamaño de roca angular requerido en el lado 1, D<sub>50</sub> (Isbash y MC) <span title="Según Isbash (1936) y el condado de Maricopa, Arizona, EE. UU." class="ec-tip">?</span>';
$ec_lang['mtc_d50_z2']='Tamaño de roca angular requerido en el lado 2, D<sub>50</sub> (Isbash y MC) <span title="Según Isbash (1936) y el condado de Maricopa, Arizona, EE. UU." class="ec-tip">?</span>';
...
$ec_lang['mtc_vel_high']='Velocidad elevada — verificar pérdidas de transición, energía disponible y golpe de ariete.';
...
$ec_lang['or_diameter']='Diámetro o altura, D <span title="Diámetro para circular; altura para rectangular" class="ec-tip">?</span>';
$ec_lang['or_width']='Ancho, W <span title="Solo aperturas rectangulares" class="ec-tip">?</span>';
$ec_lang['or_invert']='Cota de la solera <span title="Fondo de la apertura" class="ec-tip">?</span>';
...
$ec_lang['or_notes_1_def']='Q = C<sub>d</sub> &times; A &times; &radic;(2gh). Para salida libre: h = HWE &minus; centroide. Para flujo sumergido (TWE sobre la solera): h = HWE &minus; TWE.';
...
$ec_lang['or_notes_3_def']='C<sub>d</sub> varía entre aproximadamente 0,60&ndash;0,65 para orificios de borde agudo. Las entradas redondeadas o reentrantes usan valores diferentes. Consulte <a target="_blank" href="https://www.engineeringtoolbox.com/orifice-nozzle-venture-d_590.html">Engineering Toolbox</a> o el Manual de Referencia Hidráulica de HEC-RAS para orientación.';
$ec_lang['or_notes_4_term']='Sumersión';
$ec_lang['or_notes_4_def']='Cuando TWE está sobre la solera de la apertura, esta calculadora aplica automáticamente la ecuación de orificio sumergido usando h = HWE &minus; TWE. Cuando TWE está en o por debajo de la solera, se asume salida libre y h = HWE &minus; centroide.';
// Micro-Hydro Power
...
$ec_lang['mhp_km']='Coef. pérdidas menores, k<sub>m</sub> <span title="Sum of all junction and fitting loss coefficients along the penstock" class="ec-tip">?</span>';
$ec_lang['mhp_nu']='Viscosidad cinemática, ν <span title="1×10⁻⁶ m²/s for clean water near 20°C" class="ec-tip">?</span>';
...
$ec_lang['odt_a_ending']='Área final, A<sub>2</sub> <span title="Interpolada del modelo cónico en la elevación final" class="ec-tip">?</span>';
...
$ec_lang['odt_d']='Orificio D <span title="Diámetro (circular) o altura (rectangular)" class="ec-tip">?</span>';
$ec_lang['odt_w']='Ancho del orificio, W <span title="Solo rectangular" class="ec-tip">?</span>';
...
$ec_lang['odt_h1']='Carga inicial, H<sub>1</sub> <span title="Elevación inicial de la superficie del agua menos la elevación del centroide del orificio" class="ec-tip">?</span>';
...
$ec_lang['ip_se']='Espaciado emisores, S<sub>e</sub>';
$ec_lang['ip_sl']='Espaciado laterales, S<sub>l</sub>';
...
$ec_lang['cs_Ec_target']='Objetivo Ec, E<sub>c,target</sub> <span title="Objetivo de eficiencia de conducción tras el revestimiento; fracción 0–1" class="ec-tip">?</span>';
...
$ec_lang['cs_payback_years']='Período recuperación <span title="Simple payback = total lining cost ÷ annual value recovered" class="ec-tip">?</span>';
...
$ec_lang['ip_x']='Exponente de descarga del emisor, x <span title="0,5 para emisores estándar sin compensación; cercano a 0 para emisores con compensación de presión" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='Lat. <span title="Marcada: este tramo es un segmento de la lateral de prueba, extraído por emisores individuales. Sin marcar: este tramo es una tubería principal, solo pasando caudal a laterales no en la ruta de prueba." class="ec-tip">?</span>';
$ec_lang['ip_count']='Emisores <span title="Filas de laterales: emisores en este tramo solo. Filas de tubería principal: total de emisores en laterales OTROS que este que se ramifican desde este tramo. Para el tramo justo en el punto de extracción de la lateral de prueba, esto también incluye cualquier lateral más abajo en la tubería principal más allá de ese punto, o compartiendo la misma unión (p. ej., una lateral del lado opuesto) — su caudal se ramifica desde este mismo tramo también." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
...
$ec_lang['ip_hl']='H<sub>l</sub> <span title="Pérdida total del tramo, H_f + H_m" class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='Caudal de suministro de ruta de prueba, Q<sub>supply</sub> <span title="Caudal que ingresa a la ruta de prueba modelada solo, no a toda la zona/sistema — ver Q_zone en Diseño de Aplicación abajo para el total del sistema." class="ec-tip">?</span>';
...
$ec_lang['ip_dp_avg']='Est. Diferencia de presión, prom. vs. lateral de prueba <span title="Cuánto más alto (o más bajo) cree que funciona una lateral típica/promedio en comparación con esta lateral de prueba. La lateral de prueba es deliberadamente el caso presumido peor, por lo que su promedio es un sustituto sesgado a la baja para un promedio de campo — dejado en 0, la verificación de uniformidad y los números de diseño de aplicación abajo usan el de la lateral de prueba propio (probablemente optimista) tal cual." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='Caudal promedio de emisor estimado de campo, q<sub>avg,field</sub> <span title="q_avg_lateral reevaluado a la presión de cada fila lateral más la diferencia de presión ingresada arriba — un intento de corregir el hecho de que la lateral de prueba sea el caso presumido peor, no uno representativo. Alimenta tanto la verificación de uniformidad como la sección de diseño de aplicación abajo." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='Verificación de uniformidad, q<sub>last</sub>/q<sub>avg,field</sub> <span title="Caudal computado del último emisor dividido entre el caudal promedio de emisor estimado de campo — misma forma que la Uniformidad de Distribución de cuarto bajo de libro de texto (promedio de grupo bajo ÷ media poblacional), pero de una muestra pequeña modelada y una corrección estimada por el usuario, no una muestra estadística de campo completo. Los valores en o por encima de 1 son posibles y no un error: simplemente significa que el último emisor no es el punto bajo relativo al promedio de campo estimado (p. ej., una corrida favorable cuesta abajo, o la estimación de diferencia de presión arriba es demasiado pequeña)." class="ec-tip">?</span>';
$ec_lang['ip_worst_case_warn']='La presión del emisor de prueba está en o por encima de la presión de suministro — esta ruta probablemente no es su lateral peor caso. Verifique una lateral más remota o de mayor fricción, o un perfil de elevación que represente mejor el caso peor real.';
$ec_lang['ip_q_ratio']='Caudal del último emisor vs. caudal de diseño, q<sub>last</sub>/q<sub>design</sub> <span title="Una verificación separada, no una cifra de uniformidad: qué tan lejos del punto de diseño nominal del fabricante funciona el último emisor. Arriba de 1: funcionando por encima de su punto de diseño (p. ej., de una ganancia de elevación favorable cuesta abajo). Abajo de 1: funcionando bajo diseño (caso típico dominado por fricción)." class="ec-tip">?</span>';
...
$ec_lang['ip_notes_3_def']='Modela una presión de entrada fija (sin curva de bomba), una sola ruta de prueba (no el campo completo), y una curva de emisor de 2 parámetros (establezca el exponente cerca de 0 para aproximar un emisor con compensación de presión). Se reportan dos ratios diferentes, deliberadamente mantenidos separados: q<sub>last</sub>/q<sub>avg,field</sub> es una verificación de uniformidad, con forma como la Uniformidad de Distribución de cuarto bajo de libro de texto (promedio de grupo bajo ÷ media poblacional) pero computada a partir de los emisores modelados de la propia lateral de prueba, corregida por una estimación de diferencia de presión ingresada en lugar de una muestra estadística de campo completo — la lateral de prueba es deliberadamente el caso presumido peor, por lo que su promedio crudo sin corregir subestimaría el verdadero promedio de campo y haría que la uniformidad luciera mejor de lo que es; la entrada de diferencia de presión existe específicamente para contrarrestar ese sesgo. Los valores en o por encima de 1 aún son posibles (p. ej., la estimación de diferencia de presión es demasiado pequeña, o una corrida favorable cuesta abajo). q<sub>last</sub>/q<sub>design</sub> es una verificación diferente y no de uniformidad contra el caudal nominal de diseño del fabricante — útil para detectar un sistema en general sobre- o bajo-presurizado, pero no un sustituto del número de uniformidad, ya que el caudal nominal/de diseño no tiene necesaria relación con la presión operativa real media del sistema.';
$ec_lang['ip_notes_4_term']='Referencia';
