...
$ec_lang['template_welcome']='>> Dejad vuestros miedos en la puerta; el amor se habla aquí. No estáis arruinando todo. Disfrutad tambi&eacute;n <a target="_blank" href="https://hawsedc.com/download.php">las herramientas libres HawsEDC para AutoCAD.</a> <<';
...
$ec_lang['dw_kinematic_viscosity']='Viscosidad cinemática, &nu; <span title="1×10⁻⁶ m²/s for clean water at 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_main_desc']='Tiempo de vaciado de estanque o laguna por orificio &mdash; Método del volumen cónico';
...
$ec_lang['mhp_gross_head']='Altura bruta (desnivel), H<sub>gross</sub>';
$ec_lang['mhp_head_loss']='Pérdidas de carga en tubería de presión, h<sub>L</sub>';
$ec_lang['mhp_efficiency']='Eficiencia de la planta, &eta; (0&ndash;1)';
$ec_lang['mhp_net_head']='Altura neta, H<sub>net</sub>';
$ec_lang['mhp_power']='Potencia generada, P';
$ec_lang['mhp_annual_kwh']='Energía anual al 100% de capacidad';
$ec_lang['mhp_notes_1_term']='Ecuación de Potencia';
$ec_lang['mhp_notes_1_def']='P = &eta; &times; &rho; &times; g &times; Q &times; H<sub>net</sub>, donde &rho; = 1000 kg/m&sup3; (agua dulce) y g = 9,806 m/s&sup2;.';
$ec_lang['mhp_notes_2_term']='Altura Neta';
$ec_lang['mhp_notes_2_def']='Altura neta = altura bruta &minus; pérdidas de carga en tubería de presión. Una primera estimación habitual es h<sub>L</sub> &asymp; 5% de H<sub>gross</sub>. Use la <a href="Darcy-Weisbach.php">calculadora de Darcy-Weisbach</a> para estimaciones más precisas de las pérdidas en tubería de presión.';
$ec_lang['mhp_notes_3_term']='Eficiencia';
$ec_lang['mhp_notes_3_def']='La eficiencia típica de la planta &eta; oscila entre 0,70 y 0,85 para turbinas Pelton y de flujo cruzado, comunes en micro-hidroeléctricas. Use 0,75 como primera estimación conservadora.';
$ec_lang['mhp_notes_4_term']='Energía Anual';
$ec_lang['mhp_notes_4_def']='La energía anual supone operación continua a pleno caudal (8760 horas/año). La producción real será menor debido a la variación estacional del caudal, tiempos de mantenimiento y factor de carga.';
// Penstock Design
$ec_lang['ps_main_menu']='Diseño de tubería de presión';
$ec_lang['ps_main_title']='Calculadora gratuita en línea de diseño de tubería de presión';
$ec_lang['ps_main_desc']='Dimensionamiento de tubería de presión micro-hidráulica — Pérdida de carga, potencia y velocidad';
$ec_lang['ps_flow']='Caudal, Q';
$ec_lang['ps_gross_head']='Altura bruta, H<sub>gross</sub>';
$ec_lang['ps_diameter']='Diámetro de la tubería de presión, D';
$ec_lang['ps_length']='Longitud de la tubería de presión, L';
$ec_lang['ps_roughness']='Rugosidad de la tubería, e';
$ec_lang['ps_km']='Coef. pérdidas menores, k<sub>m</sub> <span title="Sum of all junction and fitting loss coefficients along the penstock" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['ps_nu']='Viscosidad cinemática, &nu; <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['ps_efficiency']='Rendimiento de la instalación, &eta; (0&ndash;1)';
$ec_lang['ps_velocity']='Velocidad del flujo, v';
$ec_lang['ps_vel_check']='Verificación de velocidad';
$ec_lang['ps_f']='Factor de fricción, f';
$ec_lang['ps_hf']='Pérdida de carga por fricción, h<sub>f</sub>';
$ec_lang['ps_hm']='Pérdida menor, h<sub>m</sub>';
$ec_lang['ps_hl']='Pérdida total en la tubería de presión, h<sub>L</sub>';
$ec_lang['ps_hl_check']='Verificación de pérdida de carga';
$ec_lang['ps_hnet']='Altura neta, H<sub>net</sub>';
$ec_lang['ps_power']='Potencia producida, P';
$ec_lang['ps_annual_kwh']='Energía anual al 100% de capacidad';
$ec_lang['ps_vel_ok']='1–3 m/s — dentro del objetivo ✓';
$ec_lang['ps_vel_low']='menor de 1 m/s — aumentar diámetro ⚠';
$ec_lang['ps_vel_high']='mayor de 3 m/s — reducir diámetro ⚠';
$ec_lang['ps_hl_ok']='dentro del objetivo del 10% ✓';
$ec_lang['ps_hl_warn']='supera el objetivo del 10% — considerar tubería más grande ⚠';
$ec_lang['ps_hl_bad']='supera el 20% — redimensionar la tubería';
$ec_lang['ps_notes_1_term']='Pérdida de carga';
$ec_lang['ps_notes_1_def']='La pérdida total en la tubería de presión h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, donde h<sub>f</sub> = f(L/D)(v&sup2;/2g) es la pérdida por fricción de Darcy-Weisbach y h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g cubre entradas, codos y válvulas. Altura neta H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['ps_notes_2_term']='Velocidad';
$ec_lang['ps_notes_2_def']='Objetivo: 1&ndash;3 m/s. Por debajo de 1 m/s la tubería queda sobredimensionada para el caudal; por encima de 3 m/s aumentan las pérdidas por fricción y el riesgo de golpe de ariete.';
$ec_lang['ps_notes_3_term']='Objetivo de pérdida de carga';
$ec_lang['ps_notes_3_def']='Las pérdidas en la tubería de presión inferiores al 10% de la altura bruta son generalmente económicas. La compensación óptima entre el coste de la tubería y la potencia perdida suele situarse en torno al 4&ndash;6% para instalaciones de electricidad de alto valor.';
$ec_lang['ps_notes_4_term']='Pérdidas menores k<sub>m</sub>';
...
$ec_lang['ds_main_desc']='Riego por Goteo &amp; Aspersión &mdash; Tasa de Aplicación y Uniformidad';
...
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>, donde A<sub>e</sub> = S<sub>e</sub> &times; S<sub>l</sub> es el área servida por cada emisor. Una tasa de aplicación menor da más tiempo para la infiltración &mdash; importante en suelos pesados o campos con pendiente.';
...
$ec_lang['ds_notes_3_def']='Tiempo de riego = lámina objetivo &divide; tasa de aplicación. En suelos con pendiente o compactados, divida el tiempo de riego en dos o tres ciclos más cortos con períodos de descanso entre ellos para evitar escorrentía superficial.';
...
$ec_lang['cs_main_desc']='Pérdida por Infiltración &amp; Eficiencia de Conducción &mdash; Método Entrada-Salida';
...
$ec_lang['cs_Ec_target']='Objetivo Ec, E<sub>c,target</sub> <span title="Conveyance efficiency goal after lining; fraction 0&ndash;1" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['cs_lining_area']='Área revestimiento, L &times; P<sub>w</sub>';
...
$ec_lang['cs_payback_years']='Período recuperación <span title="Simple payback = total lining cost &divide; annual value recovered" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['cs_notes_1_def']='El método entrada-salida estima la infiltración midiendo el gasto al inicio y al final de un tramo del canal: Q<sub>loss</sub> = Q<sub>in</sub> &minus; Q<sub>out</sub>. La eficiencia de conducción E<sub>c</sub> = Q<sub>out</sub> / Q<sub>in</sub>. El volumen anual asume operación continua a plena carga; la pérdida real es menor en canales de funcionamiento estacional o parcial.';
$ec_lang['cs_notes_2_term']='Clasificaciones de Eficiencia';
$ec_lang['cs_notes_2_def']='Canales de tierra sin revestir típicos: E<sub>c</sub> = 60&ndash;80%. Canales de tierra bien mantenidos: 75&ndash;85%. Canales revestidos de concreto: 90&ndash;98%. Las pérdidas por infiltración superiores al 30% del gasto de entrada suelen justificar una inversión en revestimiento. (USBR, FAO)';
$ec_lang['cs_notes_3_term']='Recuperación por Revestimiento';
$ec_lang['cs_notes_3_def']='Ingrese el valor del agua y el costo del revestimiento en cualquier moneda consistente. Área de revestimiento = longitud del tramo &times; perímetro mojado &mdash; el perímetro mojado de la sección transversal del canal a la profundidad de flujo medida (ancho de plantilla más ambas orillas mojadas). El valor anual recuperado supone que el canal revestido alcanza la E<sub>c</sub> objetivo de forma continua. El período de recuperación real será mayor en canales de uso estacional o si el revestimiento no alcanza la eficiencia objetivo.';
...
$ec_lang['rc_main_desc']='Dimensionamiento de Escollera en Canal de Roca &mdash; Robinson, Rice &amp; Kadavy (1998)';
...
$ec_lang['rc_layer']='Espesor de la capa de roca (2 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_radius']='Radio de curva en cresta superior (40 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_length']='Longitud de arco en cresta superior';
$ec_lang['rc_apron_length']='Longitud del colchón de salida (15 &times; D<sub>50</sub>) <span title="Requerido para el soporte estructural de la roca del canal. &quot;El tirante aguas abajo mínimo que resulta del tramo de salida y la resistencia del canal aguas abajo es suficiente para garantizar la estabilidad de la escollera en el tramo de salida.&quot; (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_qs']='Gasto unitario superficial, q<sub>s</sub> (q<sub>t</sub> &minus; q<sub>m</sub>)';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice &amp; Kadavy (1998) desarrollaron dos ecuaciones empíricas para el tamaño mediano de escollera D<sub>50</sub> en función de la pendiente del canal y el gasto unitario. La ecuación 1 aplica para pendientes suaves (S<sub>0</sub> &lt; 0,10); la ecuación 2 para pendientes pronunciadas (0,10 &le; S<sub>0</sub> &le; 0,40). Ambas ecuaciones requieren q<sub>t</sub> en m&sup2;/s y devuelven D<sub>50</sub> en mm. El rango validado es 0,02 &le; S<sub>0</sub> &le; 0,40.';
$ec_lang['rc_notes_2_term']='Gasto unitario';
$ec_lang['rc_notes_2_def']='q<sub>t</sub> es el gasto unitario total en la cresta del canal (gasto total por unidad de ancho). Para un canal de ancho de plantilla B con gasto total Q, q<sub>t</sub> &asymp; Q / B, o se calcula a partir de la condición de tirante crítico en la entrada del canal.';
$ec_lang['rc_notes_3_term']='Flujo a través del manto de roca';
$ec_lang['rc_notes_3_def']='Una fracción del gasto total fluye por los poros de la escollera (gasto de manto q<sub>m</sub>); el resto fluye por la superficie de la roca (q<sub>s</sub> = q<sub>t</sub> &minus; q<sub>m</sub>). El tirante d se calcula con la ecuación de Manning aplicada al gasto superficial q<sub>s</sub> usando la rugosidad n del canal. La porosidad por defecto n<sub>p</sub> = 0,45 es típica para roca triturada angular.';
