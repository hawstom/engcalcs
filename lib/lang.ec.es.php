...
$ec_lang['odt_a1']='Área inicial del estanque o laguna, A1';
$ec_lang['odt_h2_elev']='Cota final de la lámina de agua';
$ec_lang['odt_h_orifice']='Cota del centroide del orificio';
$ec_lang['odt_a0']='Área del estanque o laguna a la cota del orificio, A0';
...
$ec_lang['ps_km']='Coeficiente de pérdidas menores, k<sub>m</sub>';
$ec_lang['ps_nu']='Viscosidad cinemática, &nu;, en m<sup>2</sup>/s (1E-6 para agua cerca de 20&deg;C)';
...
$ec_lang['ps_hm']='Pérdida de carga menor, h<sub>m</sub>';
...
$ec_lang['ds_se']='Separación de emisores a lo largo de la lateral, S<sub>e</sub>';
$ec_lang['ds_sl']='Separación de laterales (separación entre hileras), S<sub>l</sub>';
...
$ec_lang['ds_pr']='Tasa de aplicación (intensidad de precipitación), PR';
...
$ec_lang['ds_t_run']='Tiempo de riego para la lámina objetivo (horas)';
...
$ec_lang['cs_Q_in']='Gasto de entrada al tramo, Q<sub>in</sub>';
$ec_lang['cs_Q_out']='Gasto de salida del tramo, Q<sub>out</sub>';
$ec_lang['cs_Q_loss']='Tasa de pérdida por infiltración, Q<sub>loss</sub>';
$ec_lang['cs_loss_check']='Verificación de medición';
$ec_lang['cs_pct_loss']='Pérdida como fracción del gasto de entrada';
...
$ec_lang['cs_wp']='Perímetro mojado de la sección transversal del canal, P<sub>w</sub>';
$ec_lang['cs_Q_loss_per_L']='Pérdida por infiltración por unidad de longitud, Q<sub>loss</sub>/L';
$ec_lang['cs_water_value']='Valor del agua (moneda por unidad de volumen)';
$ec_lang['cs_lining_cost']='Costo de revestimiento (moneda por unidad de área)';
$ec_lang['cs_Ec_target']='Eficiencia de conducción objetivo tras el revestimiento, E<sub>c,target</sub> (fracción, 0&ndash;1) &mdash; meta de retención de agua del canal revestido';
$ec_lang['cs_lining_area']='Área de revestimiento del canal (L &times; P<sub>w</sub>)';
$ec_lang['cs_annual_value_lost']='Valor anual del agua perdida (moneda)';
$ec_lang['cs_annual_value_recovered']='Valor anual recuperado por el revestimiento (moneda)';
$ec_lang['cs_lining_total_cost']='Costo total del revestimiento (moneda)';
$ec_lang['cs_payback_years']='Período de recuperación simple (años)';
