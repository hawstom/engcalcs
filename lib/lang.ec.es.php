...
$ec_lang['wi_notes_we_def']='q = si (distancia = 0) entonces 0 o si (slope=0) entoces cw*distancia*d<sub>0</sub><sup>1.5</sup> o cw/(2.5*pendiente) * (d<sub>0</sub><sup>2.5</sup> - d1<sup>2.5</sup>) donde d<sub>1</sub> y d<sub>0</sub> son siempre positivos o cero';
// Orifice Flow
