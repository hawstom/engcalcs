...
$ec_lang['mhp_length']='Longitud, L <span title="Longitud de la tubería de conducción de entrada (obra de toma) o del canal" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_warn']='supera el objetivo del 10%';
$ec_lang['mhp_hl_warn_tip']='Considerar una tubería más grande';
$ec_lang['mhp_hl_bad']='supera el 20%';
$ec_lang['mhp_hl_bad_tip']='Redimensionar la tubería';
...
$ec_lang['mhp_notes_4_term']='Pérdidas menores (locales), k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Estas pérdidas ocurren en uniones de tubería, entradas, codos y válvulas — el término "menores" es convencional pero engañoso; en una tubería de presión corta pueden igualar o superar las pérdidas por fricción. Valores típicos de k: entrada de borde vivo 0,5, cada codo de 45° 0,2–0,3, válvula compuerta (totalmente abierta) 0,1, válvula mariposa 0,2. Sume todos los accesorios para obtener el k<sub>m</sub> total. El valor por defecto 1,5 supone una entrada y dos codos.';
...
$ec_lang['rc_qt']='Caudal unitario total, q<sub>t</sub> <span title="Caudal por unidad de ancho en la entrada del canal. Para un canal de ancho de plantilla B con caudal total Q, usar q_t = Q / B." class="ec-tip">?</span>';
$ec_lang['rc_np']='Porosidad de la escollera, n<sub>p</sub>';
$ec_lang['rc_sg']='Gravedad específica de la roca, sg <span title="Granito o basalto triturado típico ≈ 2,65. Rango válido Robinson: 2,54 a 2,82." class="ec-tip">?</span>';
$ec_lang['rc_SD']='Gradación SD = D<sub>84.1</sub>/D<sub>50</sub> <span title="Desviación estándar de gradación. Roca uniforme ≈ 1,25. Rango válido Robinson: 1,15 a 1,47." class="ec-tip">?</span>';
$ec_lang['rc_yn']='Tirante normal en el canal de entrada, y<sub>n</sub> <span title="El remanso (Hp > yn) es favorable — reduce la erosión aguas arriba. (USDA)" class="ec-tip">?</span>';
$ec_lang['rc_D50']='Tamaño mediano de roca requerido, D<sub>50</sub> <span title="Ec. 1 (S0 < 0,10) o Ec. 2 (0,10-0,40). Válido: D50 15-278 mm, S0 0,02-0,40. Fuera del rango: extrapolado." class="ec-tip">?</span>';
...
$ec_lang['rc_apron_length']='Longitud del zampeado de salida (15 × D<sub>50</sub>) <span title="Requerido para el soporte estructural de la roca del canal. “El tirante mínimo aguas abajo que resulta del tramo de salida y la resistencia del canal aguas abajo es suficiente para garantizar la estabilidad de la escollera en el tramo de salida.” (Robinson)" class="ec-tip">?</span>';
$ec_lang['rc_n_chute']='Rugosidad de Manning en el canal, n';
$ec_lang['rc_Vm']='Velocidad a través del manto de roca, V<sub>m</sub> <span title="Fracción de qt que fluye por los poros de la roca. El resto qs fluye por la superficie. np por defecto = 0,45 para roca triturada angular." class="ec-tip">?</span>';
...
$ec_lang['rc_Hp']='Carga en el vertedor de entrada, H<sub>p</sub> <span title="El remanso (Hp > yn) es favorable — reduce la erosión aguas arriba. (USDA)" class="ec-tip">?</span>';
