...
$ec_lang['mphl_total_junction_k_tip']='Coeficiente de pérdida localizada (menor), k<sub>m</sub>. Estas pérdidas ocurren en uniones de tubería, entradas, salidas, codos y válvulas — el término "menor" es convencional pero engañoso; en un tramo corto pueden igualar o superar las pérdidas por fricción. Valores típicos de k: entrada de borde vivo 0.5, cada codo de 45° 0.2–0.3, válvula de compuerta (totalmente abierta) 0.1, válvula mariposa 0.2, salida (a un depósito o a la atmósfera) 1.0. Sume todos los accesorios para obtener el k<sub>m</sub> total. El valor predeterminado 2.0 supone una entrada, una salida y dos codos de 45°.';
