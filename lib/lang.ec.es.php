...
$ec_lang['lpn_tool_zoom_extent']='Ajustar zoom';
...
$ec_lang['lpn_empty_hint']='Para comenzar, use la barra de herramientas para agregar una imagen de fondo o un embalse, o para dibujar una red de ejemplo.';
...
$ec_lang['lpn_units_length']='Longitud y mapa';
...
$ec_lang['lpn_settings_restore_tip']='Restablece solo la configuración de este proyecto. Su dibujo y sus otros proyectos no cambian.';
...
$ec_lang['lpn_file_write_failed']='No se pudo escribir en el archivo. Puede que se haya movido o renombrado, o que se haya retirado el permiso. Su trabajo sigue guardado en este navegador. Use Guardar en archivo para elegir el archivo de nuevo.';
...
$ec_lang['lpn_lock_dismiss']='Descartar';
...
$ec_lang['lpn_notes_4_term']='Planificado';
$ec_lang['lpn_notes_4_def']='Escenarios, para que un proyecto pueda contener varios conjuntos de demandas. Tablas de resultados de nodos y tuberías. Abrir un archivo que usó recientemente sin tener que buscarlo de nuevo. Leer y escribir archivos .inp de EPANET. Los comentarios y sugerencias siempre son bienvenidos (vea el enlace de comentarios arriba).';
$ec_lang['lpn_notes_epanet_term']='Las constantes de Hazen-Williams ahora coinciden con EPANET (agosto de 2026)';
...
$ec_lang['lpn_tip_labels_draggable']='Puede arrastrar una etiqueta para moverla. Haga doble clic en una etiqueta para devolverla a su lugar.';
$ec_lang['lpn_field_auto']='Auto';
$ec_lang['lpn_field_x']='X';
$ec_lang['lpn_field_y']='Y';
$ec_lang['lpn_field_text_size']='Tamaño ×';
...
$ec_lang['lpn_backdrop_scale']='Escalar imagen';
$ec_lang['lpn_backdrop_position']='Posicionar imagen';
...
$ec_lang['lpn_backdrop_target_coords']='Coordenadas escritas';
...
$ec_lang['lpn_settings_defaults']='Valores predeterminados';
...
$ec_lang['lpn_settings_push_btn']='Aplicar valores predeterminados a todos los elementos';
$ec_lang['lpn_push_confirm']='¿Reemplazar estas propiedades en todos los elementos existentes con los valores predeterminados actuales? Los valores que haya escrito se sobrescribirán. Puede deshacer esto.';
$ec_lang['lpn_push_properties']='Propiedades:';
$ec_lang['lpn_push_elements']='Elementos:';
$ec_lang['lpn_push_none_displayed']='Ningún valor predeterminado se muestra como etiqueta en este momento, así que no hay nada que aplicar. Active las etiquetas de las propiedades que desee en el panel Etiquetas, y luego intente de nuevo.';
...
$ec_lang['lpn_settings_text_size_map']='Unidades del mapa';
...
$ec_lang['lpn_settings_map_display']='Visualización del mapa y tamaños';
...
$ec_lang['lpn_settings_restore_btn']='Restablecer toda la configuración';
$ec_lang['lpn_confirm_restore_defaults']='¿Restablecer toda la configuración (prefijos de ID, valores predeterminados, configuración del solucionador, visualización del mapa, posición de la leyenda y etiquetas visibles) a sus valores predeterminados? Su red no cambia. La configuración pertenece al proyecto abierto, así que sus otros proyectos conservan la suya.';
$ec_lang['lpn_settings_wipe_btn']='Borrar calculadora';
