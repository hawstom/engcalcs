...
$ec_lang['template_feedback']='Envoyez-nous vos suggestions ou vos éloges. Ce calculateur gratuit vous a-t-il été utile ?';
...
$ec_lang['lpn_main_menu']='Réseau de conduites maillé (interface cartographique) — VERSION PRÉLIMINAIRE';
$ec_lang['lpn_main_title']='VERSION PRÉLIMINAIRE : Calculateur en ligne gratuit de réseau de conduites maillé avec interface cartographique';
$ec_lang['lpn_main_desc']='VERSION PRÉLIMINAIRE — Pression et débit d\'un réseau de conduites maillé que vous dessinez sur une carte';
