...
$ec_lang['calc_defaults_confirm']='Réinitialiser la calculatrice aux valeurs par défaut d\'origine ?';
...
$ec_lang['mhp_hl_warn']='dépasse la cible de 10 %';
$ec_lang['mhp_hl_warn_tip']='Envisager une conduite plus grande';
$ec_lang['mhp_hl_bad']='dépasse 20 %';
$ec_lang['mhp_hl_bad_tip']='Redimensionner la conduite';
...
$ec_lang['mhp_notes_4_def']='Ces pertes se produisent aux jonctions, entrées, coudes et vannes de la conduite — le terme « mineures » est conventionnel mais trompeur ; dans une conduite forcée courte, elles peuvent égaler ou dépasser les pertes par frottement. Valeurs typiques : entrée à arête vive 0,5, chaque coude à 45° 0,2–0,3, vanne-guillotine (pleinement ouverte) 0,1, vanne papillon 0,2. Additionner tous les accessoires pour obtenir le k<sub>m</sub> total. La valeur par défaut 1,5 suppose une entrée et deux coudes.';
...
$ec_lang['cs_Ec_target']='Objectif de revêtement, E<sub>c,target</sub> <span title="Objectif de rendement de transport d\'eau après revêtement ; fraction 0–1" class="ec-tip">?</span>';
...
$ec_lang['ip_x']='Exposant de débit du goutteur, x <span title="0,5 pour les goutteurs non compensés standards ; proche de 0 pour les goutteurs autorégulés (compensés en pression)" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='Lat. <span title="Coché : ce tronçon est un segment de la rampe testée, dont les goutteurs individuels prélèvent l\'eau. Non coché : ce tronçon est une conduite principale, qui ne fait que transmettre le débit vers des rampes ne faisant pas partie du cheminement testé." class="ec-tip">?</span>';
$ec_lang['ip_count']='Goutteurs <span title="Rangées de rampe : goutteurs présents dans ce tronçon uniquement. Rangées de conduite principale : nombre total de goutteurs sur les rampes AUTRES que celle testée qui se raccordent à ce tronçon. Pour le tronçon de la conduite principale qui aboutit à la rampe testée, ceci inclut aussi toute rampe située plus loin le long de la conduite principale au-delà de ce point, ou partageant le même embranchement (par exemple une rampe du côté opposé) — leur débit se sépare aussi à partir de ce même tronçon." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_e']='e <span title="Hauteur de rugosité Darcy-Weisbach" class="ec-tip">?</span>';
$ec_lang['ip_km']='k<sub>m</sub> <span title="Coefficient générique de perte de charge singulière pour les raccords/vannes/coupleurs de ce tronçon (minimum suggéré ≥ 0,5)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='Cote av. <span title="Cote de l\'extrémité aval de ce tronçon. Optionnelle sur les rangées intérieures (par défaut plane / identique au nœud ci-dessus si laissée vide). Obligatoire sur la dernière rangée : cette valeur est la cote du dernier goutteur, qui détermine directement la pression d\'alimentation requise." class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='Débit d\'alimentation du cheminement de test, Q<sub>supply</sub> <span title="Débit entrant uniquement dans le cheminement de test modélisé — pour l\'ensemble de la zone/du système, voir Q_zone dans Conception d\'Application ci-dessous." class="ec-tip">?</span>';
...
$ec_lang['ip_q_ratio']='Débit du dernier goutteur ÷ débit de conception, q<sub>last</sub>/q<sub>design</sub> <span title="Ceci diffère de notre approximation de la mesure d\'uniformité standard." class="ec-tip">?</span>';
