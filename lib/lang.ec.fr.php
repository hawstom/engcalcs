...
$ec_lang['lpn_v2_restore_prompt']='Ce calculateur ne modifie plus vos nombres lorsque vous changez d\'unités. Ce projet a été enregistré avant ce changement : ses nombres ont donc été enregistrés en unités métriques et seraient désormais lus dans les unités que vous utilisez. Peut-il les convertir, une dernière fois ? Ces diamètres de conduite proviennent de ce projet, avant et après :';
$ec_lang['lpn_v2_restore_yes']='Convertir';
$ec_lang['lpn_v2_restore_no']='Ne touchez pas à mes nombres';
