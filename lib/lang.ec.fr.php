...
$ec_lang['cs_Q_in']='Débit en tête du bief, Q<sub>in</sub>';
$ec_lang['cs_Q_out']='Débit en queue du bief, Q<sub>out</sub>';
$ec_lang['cs_Q_loss']='Taux de perte par infiltration, Q<sub>loss</sub>';
$ec_lang['cs_loss_check']='Vérification de la mesure';
$ec_lang['cs_pct_loss']='Perte en fraction du débit entrant';
...
$ec_lang['cs_wp']='Périmètre mouillé de la section transversale du canal, P<sub>w</sub>';
$ec_lang['cs_Q_loss_per_L']='Perte par infiltration par unité de longueur, Q<sub>loss</sub>/L';
$ec_lang['cs_water_value']='Valeur de l\'eau (devise par unité de volume)';
$ec_lang['cs_lining_cost']='Coût du revêtement (devise par unité de surface)';
$ec_lang['cs_Ec_target']='Efficience de transport cible après revêtement, E<sub>c,target</sub> (fraction, 0&ndash;1) &mdash; objectif de rétention d\'eau du canal revêtu';
$ec_lang['cs_lining_area']='Surface de revêtement du canal (L &times; P<sub>w</sub>)';
$ec_lang['cs_annual_value_lost']='Valeur annuelle de l\'eau perdue (devise)';
$ec_lang['cs_annual_value_recovered']='Valeur annuelle récupérée grâce au revêtement (devise)';
$ec_lang['cs_lining_total_cost']='Coût total du revêtement (devise)';
$ec_lang['cs_payback_years']='Délai de récupération simple (années)';
