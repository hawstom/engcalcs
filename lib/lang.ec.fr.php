...
$ec_lang['lpn_ex_net3_world_desc']='Le même réseau qu\'EPANET Net3, placé à un emplacement réel : ses coordonnées sont la longitude et la latitude, et un fond de carte est dessiné derrière lui.';
...
$ec_lang['lpn_units_warn_title']='Cette unité détermine le sens de vos nombres';
$ec_lang['lpn_units_warn_body']='{unit} est l\'unité de ce que vous saisissez pour : {list}. Réinterpréter laisse chaque nombre tel quel et le lit dans la nouvelle unité. Convertir réécrit chacun de ces nombres, afin que le réseau couvre la même étendue qu\'avant.';
$ec_lang['lpn_units_reinterpret']='Réinterpréter (changer leur sens)';
$ec_lang['lpn_units_convert']='Tout convertir';
...
$ec_lang['lpn_units_group_inputs']='Unités des entrées';
$ec_lang['lpn_units_group_results']='Unités des résultats';
...
$ec_lang['lpn_file_import_geo']='Convertir en lat/lon…';
$ec_lang['lpn_file_import_geo_tip']='D\'une grille locale vers le monde réel. Placez un dessin réalisé sur la grille xy sur des coordonnées géographiques, afin qu\'il se positionne sur le fond de carte à son emplacement réel. Chaque nombre que vous avez saisi reste tel quel — seuls le X et le Y deviennent une longitude et une latitude.';
...
$ec_lang['lpn_georef_step1_hint']='Votre projet reste où il est à l\'écran. Déplacez et zoomez la carte en dessous jusqu\'à ce que le terrain derrière lui soit à peu près au bon endroit et à peu près à la bonne taille, puis appuyez sur Placer le modèle ici.';
...
$ec_lang['lpn_tool_add_reservoir_tip']='Cliquez sur la carte pour ajouter un réservoir : une source qui maintient un niveau d\'eau fixe.';
$ec_lang['lpn_tool_add_tank_tip']='Cliquez sur la carte pour ajouter une bâche : un stockage dont vous définissez le niveau d\'eau.';
...
$ec_lang['lpn_find_menu_tip']='Trouver un élément par son identifiant, ou trouver tous les éléments qui répondent à un critère.';
...
$ec_lang['lpn_color_ranges_note']='Le mode ci-dessus définit ces limites à partir des valeurs actuellement sur la carte. Modifiez-les et le même nombre correspondra toujours à la même couleur.';
$ec_lang['lpn_color_criterion_note']='Les limites des plages proviennent d\'une norme de conception, donc le nombre de plages est fixe tant que ce mode est choisi.';
$ec_lang['lpn_color_break_number']='Une limite de plage doit être un nombre. La carte reste inchangée.';
$ec_lang['lpn_color_break_order']='Chaque limite de plage doit être supérieure à la précédente. La carte reste inchangée.';
$ec_lang['lpn_color_break_count']='Il doit y avoir une limite de moins que le nombre de plages. La carte reste inchangée.';
...
$ec_lang['lpn_pane_toggle_tip']='Afficher ou masquer le panneau sous la carte. Il contient le profil et le tableau des jonctions.';
$ec_lang['lpn_pane_resize']='Faites glisser pour agrandir ou réduire le panneau';
$ec_lang['lpn_pane_tab_junctions']='Jonctions';
$ec_lang['lpn_pane_tab_tip']='Toutes les jonctions sous forme de tableau, triable et modifiable.';
$ec_lang['lpn_pane_none']='Ce réseau n\'a pas encore de jonctions.';
$ec_lang['lpn_pane_sort_tip']='Trier selon cette colonne. Cliquez à nouveau pour inverser le tri.';
$ec_lang['lpn_clean_map']='Masquer les affichages de la carte';
$ec_lang['lpn_clean_map_off']='Afficher les affichages de la carte';
$ec_lang['lpn_clean_map_tip']='Masquer la ligne de mode et l\'affichage des coordonnées afin qu\'une capture d\'écran ne montre que la carte. Votre dessin n\'est pas modifié, et ce choix n\'est pas mémorisé — recharger la page fait réapparaître ces affichages.';
...
$ec_lang['lpn_find_menu']='Rechercher';
$ec_lang['lpn_find_title']='Rechercher des éléments';
...
$ec_lang['lpn_find_button']='Rechercher';
...
$ec_lang['lpn_profile_to']='À';
$ec_lang['lpn_profile_pick']='Ajoutez des nœuds au trajet en cliquant sur eux sur la carte';
$ec_lang['lpn_profile_through']='Nœuds intermédiaires';
$ec_lang['lpn_profile_clear']='Tout retirer';
...
$ec_lang['lpn_inp_drop_patterns']='Les courbes de modulation de la demande ont été laissées de côté, car la partie de cette page qui simule un réseau dans le temps ne s\'est pas chargée. Chaque demande est le nombre écrit dans le fichier.';
$ec_lang['lpn_inp_drop_demand_pattern']='Ces jonctions font varier leur demande au cours de la journée. Leurs courbes de modulation ont été importées intégralement, et la demande affichée est celle de l\'instant indiqué par l\'horloge.';
...
$ec_lang['lpn_inp_drop_controls']='Ces commandes et règles ont été laissées de côté. Les conduites, pompes et vannes qu\'elles nomment sont entrées dans l\'état écrit dans le fichier, et le restent.';
...
$ec_lang['lpn_labels_mark_extrema_tip']='Trace un trait au-dessus de la valeur la plus haute de chaque type sur la carte, et un trait au-dessous de la valeur la plus basse de ce type, afin de repérer les deux extrêmes sans lire les nombres.';
$ec_lang['lpn_field_id']='ID';
$ec_lang['lpn_settings_apply_to_all']='Appliquer à tous';
$ec_lang['lpn_settings_apply_to_all_tip']='Chaque élément de ce type déjà dessiné reçoit un identifiant commençant par ce texte. Chacun conserve son numéro. Un identifiant qui ne se termine pas par un numéro n\'est pas modifié.';
$ec_lang['lpn_confirm_apply_prefix']='Renommer {n} éléments afin que leurs identifiants commencent par {prefix} ? Chacun conserve son numéro.';
$ec_lang['lpn_prefix_applied']='{n} éléments renommés. {skipped} autres n\'ont pas été modifiés.';
$ec_lang['lpn_labels_prefix_tip']='Texte affiché avant cette valeur sur la carte';
$ec_lang['lpn_labels_prefix_id_tip']='Texte affiché avant l\'identifiant sur la carte. Laissez ce champ vide et l\'identifiant s\'affiche seul, commençant par la lettre qui lui a été attribuée, comme J1 ou L1.';
$ec_lang['lpn_labels_suffix_tip']='Texte affiché après cette valeur sur la carte';
$ec_lang['lpn_labels_suffix_gradient_tip']='Texte affiché après le gradient de perte de charge sur la carte. Ne tapez pas de signe pourcentage ici ; il est ajouté automatiquement quand l\'unité est le pourcentage.';
$ec_lang['lpn_labels_separator']='Texte entre les valeurs';
$ec_lang['lpn_labels_separator_tip']='Texte entre une valeur et la suivante sur une étiquette. Un espace par défaut.';
...
$ec_lang['lpn_labels_priority_node_tip']='Priorité pour décider quelle étiquette est supprimée en premier quand la carte est chargée : la demande la plus faible, la pression la plus proche du milieu de la plage, ou la cote ou la charge la plus proche de celle des nœuds voisins. La valeur 1 décide en premier.';
...
$ec_lang['lpn_settings_scope_project']='Paramètres du projet';
...
$ec_lang['lpn_settings_colors']='Colorer selon la valeur';
...
$ec_lang['lpn_settings_color_thematic']='Carte thématique : couleurs seulement, sans étiquettes';
...
$ec_lang['lpn_time_running']='Calcul de toute la période avec le solveur EPANET.';
$ec_lang['lpn_time_no_engine']='Le solveur intégré résout un seul instant à la fois : ceci est donc le réseau à {time} uniquement — les demandes portent les coefficients de la courbe de modulation de cet instant, et chaque bâche reste à son niveau de départ au lieu de se remplir et de se vider. Connectez-vous une fois à Internet pour récupérer le solveur EPANET, qui calcule toute la période.';
$ec_lang['lpn_time_slider']='Temps';
$ec_lang['lpn_time_no_period']='Ce projet n\'a pas de période, il n\'y a donc qu\'un seul instant à afficher. Définissez une Durée totale dans les paramètres pour calculer le réseau dans le temps.';
...
$ec_lang['lpn_time_run_tip']='Calcule ce réseau à chacun de ses instants de rapport, du premier au dernier.';
$ec_lang['lpn_time_run_note']='Vous voyez le réseau au premier instant de rapport. Ce réseau est si long à calculer sur toute sa période que les résultats des instants suivants ne sont pas tenus à jour pendant que vous travaillez. Appuyez sur Calculer pour les mettre à jour.';
...
$ec_lang['lpn_settings_sec_visualization']='Visualisation';
$ec_lang['lpn_settings_sec_map']='Carte et page';
$ec_lang['lpn_settings_sec_elements']='Nouveaux éléments';
$ec_lang['lpn_settings_sec_calculation']='Calcul';
$ec_lang['lpn_settings_node_symbology']='Symbologie des nœuds';
$ec_lang['lpn_settings_link_symbology']='Symbologie des liaisons';
...
$ec_lang['lpn_settings_node_link']='Nœud et liaison';
...
$ec_lang['lpn_inp_drop_tank_curve']='Ces bâches ne sont pas à parois verticales droites : le fichier donne leur forme sous forme de courbe. Elles sont importées comme des bâches cylindriques, chacune avec le diamètre indiqué dans le fichier. La surface de l\'eau reste celle que fixe le fichier, donc les résultats correspondent ; seule la forme est simplifiée.';
...
$ec_lang['lpn_inp_drop_gpv_curve']='Cette vanne désigne une courbe de perte de charge absente du fichier. La vanne a été importée sans courbe, donc elle reste ouverte jusqu\'à ce que vous lui en donniez une.';
$ec_lang['lpn_gpv_curve_note']='Jusqu\'à trois points de débit et la perte de charge correspondante. Laissez-les vides et la vanne reste totalement ouverte.';
...
$ec_lang['lpn_mode_add_valve']='Mode : Ajouter une vanne. Cliquez sur un nœud, puis sur un autre nœud, pour les relier. Passez en mode Sélectionner pour modifier ou déplacer des éléments et des étiquettes.';
...
$ec_lang['lpn_scenario_overrides']='Valeurs personnalisées';
...
$ec_lang['lpn_delete_drops_overrides']='Supprimer cet élément abandonnera aussi {n} valeurs que vos scénarios détiennent pour lui. Continuer ?';
