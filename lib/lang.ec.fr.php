...
$ec_lang['lpn_settings_restore_tip']='Réinitialise uniquement les paramètres de ce projet. Votre dessin et vos autres projets ne sont pas modifiés.';
...
$ec_lang['lpn_notes_4_def']='Les scénarios, pour qu\'un même projet puisse contenir plusieurs jeux de demandes. Des tableaux de résultats par nœud et par conduite. Ouvrir un fichier utilisé récemment sans avoir à le rechercher à nouveau. Lire et écrire des fichiers EPANET .inp. Vos commentaires et suggestions sont toujours les bienvenus (voir le lien de retour ci-dessus).';
