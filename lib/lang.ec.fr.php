...
$ec_lang['lpn_field_text_match_pipe']='Aligner sur l\'angle de la conduite';
...
$ec_lang['lpn_examples_size']='{nodes} jonctions, {links} conduites';
...
$ec_lang['lpn_ex_net3_desc']='Le grand exemple d\'EPANET : 97 jonctions, deux bâches et une source en rivière. À ouvrir pour voir à quoi ressemble un modèle de taille réelle sur la carte.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Exécute le solveur EPANET de l\'agence américaine EPA, ici même dans votre navigateur. Les deux solveurs donnent les mêmes résultats, et sur un réseau de cette taille vous ne remarquerez pas de différence de vitesse. La première fois que vous activez cette option, environ 650 Ko sont téléchargés puis conservés sur cet appareil.';
...
$ec_lang['lpn_unit_unknown']='Ce dessin indique une unité que cette page ne propose pas : {unit}. Tout est conservé et affiché exactement comme reçu, et rien n\'a été modifié. Aucun résultat ne peut être donné tant que cette page ne connaît pas cette unité, car il n\'y a aucun moyen de savoir sa grandeur.';
...
$ec_lang['lpn_settings_readability_bias']='Degrés à gauche de la verticale avant qu\'une étiquette ne soit retournée';
