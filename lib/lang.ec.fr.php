...
$ec_lang['lpn_settings_sec_assets']='Nouveaux éléments';
...
$ec_lang['lpn_basemap_satellite_hide']='Masquer les images satellite';
$ec_lang['lpn_basemap_satellite_tip']='Photographies du sol fournies par Mapbox, récupérées sur Internet au fil de vos déplacements et zooms. Utile pour voir où une conduite passe réellement. Votre réseau est dessiné que les images soient affichées ou non.';
$ec_lang['lpn_georef_asdeg_btn']='Ce sont déjà lon/lat';
$ec_lang['lpn_georef_asdeg_tip']='Appuyez ici seulement si les x et y de ce fichier sont réellement une longitude et une latitude. Le réseau se place alors directement à l\'endroit indiqué par ces nombres, et rien n\'a besoin d\'être positionné. Dans tous les cas, chaque nombre reste exactement tel qu\'il est.';
$ec_lang['lpn_georef_asdegrees']='Les x et y de ce fichier ont été lus comme une longitude et une latitude, le réseau est donc déjà sur la carte et rien n\'a été déplacé. Vérifiez qu\'il est au bon endroit, puis appuyez sur Conserver ce placement.';
...
$ec_lang['lpn_menu_project']='Projet';
...
$ec_lang['lpn_run_menu_tip']='Recalcule ce réseau maintenant. Vous cherchez un bouton Calculer ? Tant que ce projet se recalcule après chaque modification, la barre d\'outils n\'a pas de bouton Calculer. Désactivez « Calculer automatiquement » dans Paramètres, sous Calcul, Hydraulique, et le bouton réapparaît.';
...
$ec_lang['lpn_replace_button']='Remplacer';
...
$ec_lang['lpn_profile_draw']='Choisir le tracé sur la carte';
$ec_lang['lpn_profile_draw_stop']='Arrêter de choisir';
...
$ec_lang['lpn_inp_drop_head_pattern']='Ces réservoirs montent et descendent au cours de la journée. Leurs courbes de modulation ont été importées intégralement, et le niveau d\'eau affiché est celui de l\'instant indiqué par l\'horloge.';
$ec_lang['lpn_inp_drop_pump_speed']='Ces pompes tournent à une vitesse différente de celle à laquelle leur courbe a été mesurée, ou changent de vitesse au cours de la journée. La vitesse et sa courbe de modulation ont été importées intégralement, et la charge affichée est celle de l\'instant indiqué par l\'horloge.';
...
$ec_lang['lpn_import_notes_heading']='Du fichier EPANET';
$ec_lang['lpn_file_open_tip']='Ouvre un fichier de projet enregistré depuis cette page.';
$ec_lang['lpn_notes_color_term']='Les limites des bandes de couleur restent les mêmes';
$ec_lang['lpn_notes_color_def']='Les limites des bandes de couleur sont fixées lorsque vous choisissez une méthode de classification des données. Elles ne sont pas recalculées à chaque instant, car les couleurs changeraient alors de signification à chaque pas de temps, ce qui ne serait pas utile pour visualiser votre système. EPANET fonctionne de la même façon. Pour obtenir de nouvelles limites, choisissez de nouveau une méthode ou saisissez les vôtres.';
...
$ec_lang['lpn_time_run_report_tip']='Ce que le solveur EPANET a lui-même imprimé sur le dernier calcul : comment il a convergé, et tout avertissement qu\'il a signalé. C\'est le texte propre du solveur, pas le nôtre.';
...
$ec_lang['lpn_library_curves_tip']='Une courbe est l\'ensemble des points qui indiquent comment une pompe fonctionne : la charge qu\'elle produit pour chaque débit.';
$ec_lang['lpn_library_curves_note']='Une courbe appartient à la pompe ou à la vanne qui l\'utilise ; ce tableau les rassemble toutes pour la lecture. Cliquez sur un identifiant pour accéder à cet élément et modifier ses points à cet endroit. Pour une pompe, la ligne tracée est la courbe utilisée par le calcul, ajustée sur les points ; pour une vanne, ce sont les paliers droits entre eux.';
...
$ec_lang['lpn_library_default_pattern']='Courbe de modulation de la demande par défaut';
$ec_lang['lpn_library_default_pattern_tip']='Toute jonction sans courbe de modulation utilise celle-ci.';
...
$ec_lang['lpn_field_demand_pattern_tip']='Comment la demande de cette jonction monte et descend pendant le calcul. Laissez sur Aucune courbe de modulation pour suivre la courbe propre au projet, quelle qu\'elle soit.';
...
$ec_lang['lpn_field_speed_pattern_tip']='Comment la vitesse de cette pompe monte et descend pendant le calcul. Chaque coefficient EST la vitesse relative pour cette partie de la journée, et remplace la vitesse ci-dessus ; un coefficient de 0 arrête donc la pompe.';
...
$ec_lang['lpn_terrain_menu']='Renseigner les cotes depuis le terrain…';
$ec_lang['lpn_terrain_tip']='Lit la cote du sol sous chaque nœud qui n\'en a pas, et la saisit à votre place. Un nœud qui a déjà une cote n\'est pas modifié, et un seul Annuler rétablit tout. La première utilisation demande votre autorisation, car les positions de vos nœuds sont envoyées à Mapbox.';
$ec_lang['lpn_terrain_accuracy']='Les données de terrain ont une résolution d\'environ 30 m au sol et sont couramment décalées de plusieurs mètres à la verticale. Traitez-les comme une carte de niveau, pas comme un relevé topographique : vérifiez tout ce sur quoi vous vous appuyez.';
...
$ec_lang['lpn_terrain_confirm']='Renseigner la cote de {n} nœud(s) depuis la surface du terrain ?';
...
$ec_lang['lpn_terrain_confirm_default_2']='Remplacer ces {n} par la surface du terrain ?';
...
$ec_lang['lpn_terrain_none_needed']='Chaque nœud a déjà une cote que vous avez définie. Rien n\'a été modifié, et rien n\'a été envoyé — nous n\'écrasons jamais une cote déjà présente.';
$ec_lang['lpn_terrain_no_nodes']='Il n\'y a pas encore de nœuds à renseigner.';
