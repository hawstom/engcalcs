...
$ec_lang['wi_notes_we_def']='q = si (longueur = 0) alors 0 sinon si (pente=0) alors cw*longueur*d<sub>0</sub><sup>1,5</sup> sinon cw/(2,5*pente) * (d<sub>0</sub><sup>2,5</sup> - d1<sup>2,5</sup>) où d<sub>1</sub> et d<sub>0</sub> sont toujours positifs ou nuls';
// Orifice Flow
