...
$ec_lang['mphl_elevation_1']='Hauteur 1';
$ec_lang['mphl_pressure_head_1']="ucfirst("$ec_lang[head] 1");
$ec_lang['mphl_elevation_2']='Hauteur 2';
$ec_lang['mphl_pressure_head_2']="ucfirst("$ec_lang[head] 2");
