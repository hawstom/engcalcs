...
$ec_lang['lpn_file_import_geo']='Ouvrir un fichier xy sur la carte…';
$ec_lang['lpn_file_import_geo_tip']='Ouvre un fichier de projet ou un fichier EPANET dans un nouvel onglet de projet sur cette page, sur la carte routière. Vous placez le dessin sur le monde à la main : déplacez-vous et zoomez jusqu\'au site, puis redimensionnez-le et tournez-le pour l\'ajuster. Si les x et y du fichier sont déjà une longitude et une latitude, appuyez sur le bouton Ce sont déjà lat/lon et le réseau saute directement à l\'endroit qui lui revient. Chaque nombre que vous avez saisi reste tel quel.';
...
$ec_lang['lpn_clean_map_tip']='Retire la barre d\'état et l\'affichage des coordonnées de la carte, afin qu\'une capture d\'écran ne montre que le dessin. Votre dessin n\'est pas modifié, et ce choix n\'est pas enregistré ; recharger la page fait réapparaître ces affichages.';
...
$ec_lang['lpn_inp_drop_quality']='Ce fichier décrit comment la qualité de l\'eau évolue au fil de son parcours : ce que contient l\'eau au départ, où cette substance entre en plus grande quantité, comment elle réagit, et comment les bâches la mélangent. Cette page calcule l\'âge de l\'eau et le traçage de la source, mais pas la chimie, donc rien de tout cela n\'est utilisé ici. Ces lignes sont conservées, et elles sont réécrites si vous enregistrez un fichier EPANET.';
...
$ec_lang['lpn_tip_select']='Utilisez ce mode pour modifier, déplacer et faire glisser des éléments sur la carte. La page revient d\'elle-même à ce mode après certaines actions, comme l\'ouverture d\'un projet.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Masque les étiquettes des nœuds et des liaisons pour ne laisser que les couleurs sur la carte. Le texte que vous avez placé vous-même reste affiché. Vos choix d\'étiquettes sont conservés, et désactiver ceci les fait réapparaître.';
...
$ec_lang['lpn_time_no_period']='Ce projet n\'a pas de période, il n\'y a donc qu\'un seul instant à afficher. Réglez une Durée totale de simulation dans Paramètres pour calculer le réseau dans le temps.';
...
$ec_lang['lpn_time_run_note']='Vous voyez le réseau au premier instant du rapport. Ce réseau met tellement de temps à se calculer sur toute sa période que les résultats des instants ultérieurs ne sont pas tenus à jour pendant que vous travaillez. Appuyez sur le bouton Calculer pour les mettre à jour.';
...
$ec_lang['lpn_georef_asdegrees']='Les x et y de ce fichier ont été lus comme une longitude et une latitude, le réseau est donc déjà sur la carte et rien n\'a été déplacé. Vérifiez qu\'il est au bon endroit, puis appuyez sur le bouton Conserver ce placement.';
...
$ec_lang['lpn_result_water_age_tip']='Depuis combien de temps l\'eau qui arrive ici se trouve dans le réseau. Il n\'existe pas de limite réglementaire à laquelle la comparer : jugez ce nombre en fonction de votre propre réseau.';
...
$ec_lang['lpn_new_coords_xy']='Coordonnées xy';
$ec_lang['lpn_new_coords_geo']='lat/lon';
$ec_lang['lpn_new_coords_tip']='Un projet xy utilise des coordonnées qui ne sont pas une latitude et une longitude. Un projet lat/lon a des coordonnées géographiques, si bien qu\'une carte routière ou une image satellite peut être dessinée derrière lui et que les cotes des nœuds peuvent être lues sur le terrain. Un projet xy peut être converti en lat/lon avec Fichier, Ouvrir un fichier xy sur la carte.';
$ec_lang['lpn_new_place']='Commencer près de ce lieu';
$ec_lang['lpn_new_place_tip']='Facultatif. Tapez une ville, une rue ou un lieu remarquable, et la nouvelle carte s\'ouvre à cet endroit. Le texte que vous saisissez est envoyé au service de recherche de lieux d\'OpenStreetMap, qui vous demande votre autorisation la première fois. Laissez-le vide et la carte s\'ouvre sur le monde entier.';
$ec_lang['lpn_new_place_hint']='Petaluma, Californie';
$ec_lang['lpn_new_create']='Créer';
$ec_lang['lpn_inp_drop_rules']='Ce fichier contient des contrôles basés sur des règles. Ils ne sont pas appliqués ici, si bien que les conduites, pompes et vannes qu\'ils nomment restent dans l\'état écrit dans le fichier. Les règles elles-mêmes sont conservées, et elles sont réécrites si vous enregistrez un fichier EPANET.';
$ec_lang['lpn_inp_drop_energy']='Ce fichier EPANET contient des données de modélisation du coût de pompage. Cette page ne calcule ni l\'énergie ni le coût, donc rien ici n\'utilise ces nombres. Ils sont conservés, et ils sont réécrits si vous enregistrez un fichier EPANET.';
$ec_lang['lpn_inp_drop_tags']='Ce fichier attribue des balises à certaines de ses jonctions, conduites ou autres éléments. Cette page n\'a pas encore d\'endroit pour voir ou modifier une balise. Les balises sont conservées, et elles sont réécrites si vous enregistrez un fichier EPANET.';
$ec_lang['lpn_inp_drop_report']='Ce fichier contient les propres réglages d\'EPANET pour les rapports qu\'il imprime. Cette page affiche ses résultats à sa manière, donc rien ici ne les utilise. Ils sont conservés, et ils sont réécrits si vous enregistrez un fichier EPANET.';
...
$ec_lang['lpn_inp_drop_quality_options']='Ce fichier indique des options EPANET de qualité de l\'eau : Qualité, qui nomme le type d\'analyse de qualité de l\'eau, et deux réglages liés à un produit chimique, Diffusivité relative et Tolérance de qualité. L\'âge de l\'eau et le traçage de la source sont calculés ici ; un produit chimique ne l\'est pas, donc ces deux réglages sont conservés sans être utilisés. Tous sont réécrits si vous enregistrez un fichier EPANET.';
...
$ec_lang['lpn_inp_drop_demand_model']='Ce fichier demande une analyse pilotée par la pression (PDA), dans laquelle une jonction reçoit moins que sa demande lorsque la pression y est faible. Cette page résout en mode piloté par la demande, donc chaque jonction reçoit ici la demande indiquée dans le fichier, quelle que soit la pression qui en résulte. La ligne est conservée et réécrite si vous enregistrez un fichier EPANET.';
...
$ec_lang['lpn_settings_quality_track_tip']='Choisissez ce que le calcul doit suivre à travers les conduites : depuis combien de temps l\'eau est dans le réseau, ou d\'où elle provient. Aucun des deux n\'a besoin d\'une concentration ni d\'un taux de réaction.';
...
$ec_lang['lpn_quality_chemical']='Un produit chimique nommé par ce fichier (conservé, non calculé)';
$ec_lang['lpn_quality_needs_run']='La qualité de l\'eau se propage dans les conduites au fil du temps ; elle nécessite donc le moteur EPANET et une durée totale de simulation. Réglez une Durée totale de simulation sous Temps, puis appuyez sur le bouton Calculer.';
