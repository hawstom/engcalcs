...
$ec_lang['dw_kinematic_viscosity']='Viscosité cinématique, ν <span title="1×10⁻⁶ m²/s for clean water at 20°C" class="ec-tip">?</span>';
...
$ec_lang['mtc_side_slope_1']='Talus 1, z1 (horizontal/vertical)';
$ec_lang['mtc_side_slope_2']='Talus 2, z2 (horizontal/vertical)';
...
$ec_lang['mtc_sgrock']='Masse volumique relative de la roche, SG (2,65)';
...
$ec_lang['mtc_vel_high']='Vitesse élevée - vérifier les pertes de transition, l\'énergie disponible et le coup de bélier.';
...
$ec_lang['or_diameter']='Diamètre ou hauteur, D <span title="Diameter for circular; height for rectangular" class="ec-tip">?</span>';
$ec_lang['or_width']='Largeur, W <span title="Rectangular openings only" class="ec-tip">?</span>';
$ec_lang['or_invert']='Cote du radier <span title="Bottom of opening" class="ec-tip">?</span>';
...
$ec_lang['or_notes_1_def']='Q = C<sub>d</sub> × A × √(2gh). Déversement libre : h = HWE − centroïde. Écoulement noyé (TWE au-dessus du radier) : h = HWE − TWE.';
...
$ec_lang['odt_h1_elev']='Cote de départ, WSE <span title="Starting water surface elevation" class="ec-tip">?</span>';
...
$ec_lang['odt_a_ending']='Superficie finale, A<sub>2</sub> <span title="Interpolated from conic model at ending elevation" class="ec-tip">?</span>';
...
$ec_lang['odt_d']='Orifice D <span title="Diamètre (circulaire) ou hauteur (rectangulaire)" class="ec-tip">?</span>';
$ec_lang['odt_w']='Largeur, W <span title="Rectangular only" class="ec-tip">?</span>';
...
$ec_lang['odt_h1']='Charge initiale, H<sub>1</sub> <span title="CSE initiale moins cote du centroïde de l\'orifice" class="ec-tip">?</span>';
...
$ec_lang['ip_se']='Espacement émetteur, S<sub>e</sub>';
$ec_lang['ip_sl']='Espacement latéral, S<sub>l</sub>';
$ec_lang['ip_n_e']='Émetteurs par rampe, n<sub>e</sub>';
$ec_lang['ip_n_l']='Rampes par zone, n<sub>l</sub>';
$ec_lang['ip_d']='Profondeur d\'application cible, d';
$ec_lang['ip_a_e']='Surface par émetteur, A<sub>e</sub>';
...
$ec_lang['cs_Ec_target']='Objectif de revêtement, E<sub>c,target</sub> <span title="Objectif d\'efficience de transport après revêtement ; fraction 0–1" class="ec-tip">?</span>';
$ec_lang['cs_lining_area']='Surface, L × P<sub>w</sub>';
...
$ec_lang['cs_notes_1_def']='La méthode entrée-sortie estime l\'infiltration en mesurant le débit en tête et en queue d\'un bief de canal : Q<sub>loss</sub> = Q<sub>in</sub> − Q<sub>out</sub>. Efficience de transport E<sub>c</sub> = Q<sub>out</sub> / Q<sub>in</sub>. Le volume annuel suppose un fonctionnement continu à plein débit ; la perte réelle est plus faible pour les canaux saisonniers ou à débit partiel.';
$ec_lang['cs_notes_2_term']='Classes d\'efficience';
$ec_lang['cs_notes_2_def']='Canaux en terre non revêtus typiques : E<sub>c</sub> = 60–80 %. Canaux en terre bien entretenus : 75–85 %. Canaux en béton : 90–98 %. Des pertes supérieures à 30 % du débit entrant justifient souvent un investissement de revêtement. (USBR, FAO)';
...
$ec_lang['rc_notes_2_def']='q<sub>t</sub> est le débit unitaire total à la crête de la chute (débit total par unité de largeur). Pour un canal de largeur de fond B transportant un débit total Q, q<sub>t</sub> ≈ Q / B, ou calculé à partir de la condition de tirant critique à l\'entrée de la chute.';
...
$ec_lang['ip_main_desc']='Estimation de la pression et de l\'uniformité de la branche de test';
$ec_lang['ip_h_supply']='Pression d\'alimentation';
$ec_lang['ip_elev_supply']='Cote d\'alimentation, z<sub>alimentation</sub>';
$ec_lang['ip_q_design']='Débit de conception du goutteur, q<sub>conception</sub>';
$ec_lang['ip_h_design']='Pression de conception du goutteur';
$ec_lang['ip_x']='Exposant de débit du goutteur, x <span title="0,5 pour les goutteurs non compensés standard ; près de 0 pour les goutteurs auto-régulants" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='Lat. <span title="Coché : ce tronçon est un segment de la rampe de test, prélevé par des goutteurs individuels. Non coché : ce tronçon est une main, transmettant le débit aux rampes ne faisant pas partie du cheminement de test." class="ec-tip">?</span>';
$ec_lang['ip_count']='Goutteurs <span title="Rangées de rampe : goutteurs dans ce tronçon uniquement. Rangées de main : total des goutteurs sur les rampes AUTRES que celle-ci qui se ramifient à partir de ce tronçon. Pour le tronçon au point de prise de la rampe de test elle-même, ceci inclut également les rampes au-delà de ce point le long de la main, ou partageant la même jonction (par exemple, une rampe de l\'autre côté) – leur débit se divise à partir de ce même tronçon aussi." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_e']='e <span title="Hauteur de rugosité Darcy-Weisbach" class="ec-tip">?</span>';
$ec_lang['ip_km']='K<sub>m</sub> <span title="Coefficient générique de perte mineure pour les raccords/vannes/coupleurs de ce tronçon (minimum suggéré ≥ 0,5)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='Cote aval <span title="Cote d\'aval de ce tronçon. Optionnelle sur les rangées intérieures (par défaut plat / identique au nœud ci-dessus si laissée vide). Obligatoire sur la dernière rangée : cette valeur est la cote du dernier goutteur, qui définit directement la pression d\'alimentation requise." class="ec-tip">?</span>';
$ec_lang['ip_elev_ds_missing_warn']='La cote du dernier goutteur (dernière rangée) a été laissée vide et a pris la valeur par défaut plat – saisissez-la pour un résultat précis ⚠';
...
$ec_lang['ip_hl']='H<sub>l</sub> <span title="Perte totale du tronçon, H_f + H_m" class="ec-tip">?</span>';
$ec_lang['ip_pressure_warn']='Pression faible/négative – vérifier les conditions subatmosphériques';
$ec_lang['ip_pressure_warn_short']='Faible ⚠';
$ec_lang['ip_h_far']='Pression du dernier goutteur';
$ec_lang['ip_q_supply']='Débit d\'alimentation du cheminement de test, Q<sub>alimentation</sub> <span title="Débit entrant dans le cheminement de test modélisé uniquement, pas dans toute la zone/système – voir Q_zone dans Application Design ci-dessous pour le total à l\'échelle du système." class="ec-tip">?</span>';
$ec_lang['ip_q_critical']='Débit du dernier goutteur, q<sub>dernier</sub>';
$ec_lang['ip_q_avg_lateral']='Débit moyen du goutteur (rampe de test), q<sub>moy</sub>';
$ec_lang['ip_dp_avg']='Est. Δpression, moy. vs. rampe de test <span title="De combien plus haut (ou plus bas) vous pensez qu\'une rampe type/moyenne fonctionne par rapport à cette rampe de test. La rampe de test est délibérément le pire cas présumé, sa propre moyenne est un substitut biaisé vers le bas pour une moyenne de terrain – laissée à 0, le contrôle d\'uniformité et les nombres de conception d\'application ci-dessous utilisent la propre moyenne de la rampe de test (probablement optimiste) telle quelle." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='Est. débit moyen du goutteur sur le terrain, q<sub>moy,terrain</sub> <span title="q_moy_rampe réévaluée à la pression de chaque rangée de rampe plus la différence de pression saisie ci-dessus – une tentative de correction pour le fait que la rampe de test est le pire cas présumé, pas un représentatif. Alimente à la fois le contrôle d\'uniformité et la section de conception d\'application ci-dessous." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='Contrôle d\'uniformité, q<sub>dernier</sub>/q<sub>moy,terrain</sub> <span title="Débit du dernier goutteur divisé par le débit moyen estimé du goutteur sur le terrain – même forme que le contrôle manuel d\'uniformité de distribution de bas quartile (moyenne du groupe bas ÷ moyenne de la population), mais à partir d\'un petit échantillon modélisé et d\'une correction estimée par l\'utilisateur, pas un échantillon statistique complet sur le terrain. Les valeurs à 1 ou au-dessus sont possibles et ne sont pas un bogue : cela signifie simplement que le dernier goutteur n\'est pas le point bas par rapport à la moyenne de terrain estimée (par exemple, une course favorable en pente descendante, ou l\'estimation Δpression ci-dessus est trop faible)." class="ec-tip">?</span>';
$ec_lang['ip_worst_case_warn']='La pression du goutteur de test est égale ou supérieure à la pression d\'alimentation – ce cheminement n\'est probablement pas votre rampe au pire cas. Vérifiez une rampe plus éloignée ou à plus forte friction, ou un profil d\'élévation qui représente mieux le pire cas réel.';
$ec_lang['ip_q_ratio']='Débit du dernier goutteur vs. débit de conception, q<sub>dernier</sub>/q<sub>conception</sub> <span title="Un contrôle séparé, pas un chiffre d\'uniformité : à quelle distance le dernier goutteur fonctionne du débit de conception nominal du fabricant. Au-dessus de 1 : fonctionnant au-dessus de son point de conception (par exemple, à partir d\'un gain d\'élévation favorable en pente descendante). Au-dessous de 1 : fonctionnant sous la conception (cas typique dominé par la friction)." class="ec-tip">?</span>';
...
$ec_lang['ip_notes_1_term']='Méthode';
$ec_lang['ip_notes_1_def']='Estime la pression au dernier (le plus éloigné) goutteur, puis reconstitue la ligne d\'énergie grade vers l\'alimentation, tronçon par tronçon, en ajoutant les pertes par friction et mineure en chemin. L\'élévation et la charge de vitesse sont déduits à chaque nœud pour rapporter la pression réelle à cet endroit. La pression d\'extrémité éloignée estimée est ajustée (bisection) jusqu\'à ce que la pression d\'alimentation requise calculée corresponde à la pression d\'alimentation saisie – le même problème en boucle fermée abordé par le solveur d\'écoulement en conduite sur la calculatrice Manning Pipe Flow, étendu à un réseau ramifié.';
$ec_lang['ip_notes_2_term']='Tronçons Main vs. Rampe';
$ec_lang['ip_notes_2_def']='Chaque rangée est un tronçon le long du seul cheminement hydrauliquement au pire cas (cheminement de test) de l\'alimentation au dernier goutteur. Un tronçon Main ne transmet le débit qu\'aux rampes ne faisant pas partie du cheminement de test, donc son prélèvement est une multiplication plate (débit de conception × compte total de goutteur du tronçon) – pas de sensibilité de pression locale. La main est une conduite-mère partagée, donc le tronçon au point de prise de la rampe de test elle-même doit inclure non seulement les rampes entre ses propres extrémités mais aussi les rampes encore plus bas le long de la main au-delà de cette prise, ou partageant la même jonction (par exemple, une rampe de l\'autre côté) – leur débit se divise à partir de ce même tronçon avant de se diviser, qu\'elles apparaissent ou non ailleurs dans ce tableau. Un tronçon Rampe est un segment de la rampe de test elle-même : le débit du goutteur est calculé à partir de la pression locale réelle via q = k·H<sup>x</sup>, et la perte par friction est réduite par le facteur F(n) de Christiansen pour tenir compte du débit diminuant à mesure que chaque goutteur du tronçon prélève.';
$ec_lang['ip_notes_3_term']='Limitations';
$ec_lang['ip_notes_3_def']='Modélise une pression d\'admission fixe (pas de courbe de pompe), un seul cheminement de test (pas le champ complet), et une courbe de goutteur à 2 paramètres (réglez l\'exposant près de 0 pour approximer un goutteur auto-régulant). Deux ratios différents sont rapportés, délibérément séparés : q<sub>dernier</sub>/q<sub>moy,terrain</sub> est un contrôle d\'uniformité, de forme similaire au contrôle manuel d\'uniformité de distribution de bas quartile (moyenne du groupe bas ÷ moyenne de la population) mais calculé à partir des goutteurs modélisés de la rampe de test elle-même, corrigé par une estimation Δpression saisie plutôt qu\'un échantillon statistique complet sur le terrain – la rampe de test est délibérément le pire cas présumé, sa moyenne brute non corrigée sous-estimerait la vraie moyenne de terrain et rendrait l\'uniformité meilleure qu\'elle ne l\'est ; l\'entrée Δpression existe spécifiquement pour contrer ce biais. Les valeurs à 1 ou au-dessus restent possibles (par exemple, l\'estimation Δpression est trop faible, ou une course favorable en pente descendante). q<sub>dernier</sub>/q<sub>conception</sub> est un contrôle différent, non-uniformité, contre le débit nominal du fabricant – utile pour détecter un système globalement sur- ou sous-pressurisé, mais pas un substitut au chiffre d\'uniformité, puisque le débit de conception/nominal n\'a aucune relation nécessaire à la pression moyenne de fonctionnement réelle du système.';
$ec_lang['ip_notes_4_term']='Référence';
$ec_lang['ip_notes_4_def']='Christiansen, J.E. (1942). "Irrigation by sprinkling." California Agricultural Experiment Station Bulletin 670. Les normes ASAE/ASABE pour la conception de la micro-irrigation utilisent la même approche de perte par friction multi-sortie.';
$ec_lang['ip_notes_5_term']='Conception d\'application';
$ec_lang['ip_notes_5_def']='Le taux d\'application et le débit de la zone/système utilisent le débit moyen estimé du goutteur sur le terrain (q<sub>moy,terrain</sub> – la propre moyenne de la rampe de test, corrigée par l\'estimation Δpression saisie), pas un taux deviné : PR = q<sub>moy,terrain</sub> / A<sub>e</sub>, alimenté par la valeur modélisée corrigée. L\'espacement et les comptes latéraux/goutteurs à l\'échelle du système sont des entrées séparées ici car le cheminement de test modélise uniquement une branche au pire cas, pas chaque rampe du champ.';
