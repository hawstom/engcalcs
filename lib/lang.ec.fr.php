...
$ec_lang['lpn_file_convert_as']='Ouvrir un fichier xy sur la carte…';
$ec_lang['lpn_file_convert_as_tip']='Ouvre un fichier de projet ou un fichier EPANET dans un nouvel onglet de projet sur cette page, sur la carte routière. Vous placez le dessin sur le monde à la main : déplacez-vous et zoomez jusqu\'au site, puis redimensionnez-le et tournez-le pour l\'ajuster. Si les x et y du fichier sont déjà une longitude et une latitude, appuyez sur le bouton Ce sont déjà lat/lon et le réseau saute directement à l\'endroit qui lui revient. Chaque nombre que vous avez saisi reste tel quel.';
