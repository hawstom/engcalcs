...
$ec_lang['lpn_time_format_tip']='Saisissez une heure sous forme d\'heures et de minutes, par exemple 2:30. Un nombre seul est en heures ; un nombre suivi d\'un mot désigne ce mot : 30 minutes.';
$ec_lang['lpn_time_running']='Calcul de toute la période avec le moteur EPANET.';
$ec_lang['lpn_time_no_engine']='Le solveur intégré résout un seul instant à la fois : ceci est donc le réseau à {time} uniquement — les demandes portent les coefficients de la courbe de modulation de cet instant, et chaque bâche reste à son niveau de départ au lieu de se remplir et de se vider. Connectez-vous une fois à Internet pour récupérer le moteur EPANET, qui calcule toute la période.';
