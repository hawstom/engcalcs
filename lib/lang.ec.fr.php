...
$ec_lang['template_translation_help']="Pouvez-vous m'aider à traduire ce calculateur dans votre langue ou l'héberger sur votre site web?";
...
$ec_lang['odt_main_title']='Calculateur gratuit en ligne du temps de vidange par orifice';
$ec_lang['odt_main_desc']='Temps de vidange d\'un bassin par orifice &mdash; Méthode du volume conique';
$ec_lang['odt_h1_elev']='Cote de départ de la surface libre';
$ec_lang['odt_a1']='Superficie du bassin en début de vidange, A1';
$ec_lang['odt_h2_elev']='Cote finale de la surface libre';
$ec_lang['odt_h_orifice']='Cote du centroïde de l\'orifice';
$ec_lang['odt_a0']='Superficie du bassin à la cote de l\'orifice, A0';
