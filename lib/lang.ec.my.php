...
$ec_lang['lpn_inp_drop_quality']='ဤဖိုင်သည် ရေသည် ခရီးသွားသည်နှင့်အမျှ ရေအရည်အသွေး မည်သို့ ပြောင်းလဲသည်ကို ဖော်ပြသည် - အစတွင် ရေထဲတွင် မည်သည့်အရာ ပါဝင်သည်၊ ထိုပစ္စည်း မည်သည့်နေရာမှ ထပ်ဝင်လာသည်၊ ၎င်းသည် မည်သို့ တုံ့ပြန်သည်၊ ရေတိုက်များက မည်သို့ ရောနှောသည်။ ဤစာမျက်နှာသည် ရေသက်တမ်းနှင့် ရင်းမြစ် ခြေရာခံမှုကို တွက်ချက်ပေးသော်လည်း ဓာတုဗေဒကို မတွက်ချက်ပေးသောကြောင့်၊ ၎င်းတို့ကို ဤနေရာတွင် အသုံးမပြုပါ။ ထိုစာကြောင်းများကို ဆက်ထိန်းသိမ်းထားပြီး၊ EPANET ဖိုင်တစ်ခု သိမ်းလိုက်ပါက ၎င်းတို့ကို ပြန်ရေးပေးမည်။';
...
$ec_lang['lpn_tip_select']='မြေပုံပေါ်ရှိ အရာများကို ပြောင်းလဲရန်၊ ရွှေ့ရန်နှင့် ဆွဲရန် ဤမုဒ်ကို သုံးပါ။ ပရောဂျက်တစ်ခု ဖွင့်ခြင်းကဲ့သို့သော လုပ်ဆောင်ချက်အချို့ ပြီးနောက် စာမျက်နှာသည် ဤမုဒ်သို့ အလိုအလျောက် ပြန်ရောက်လာသည်။';
...
$ec_lang['lpn_settings_color_thematic_tip']='ဆက်စပ်နေရာနှင့် ပိုက်လိုင်း အညွှန်းများကို ဖျောက်ထားပြီး မြေပုံပေါ်တွင် အရောင်များသာ ကျန်ရစ်စေသည်။ သင်ကိုယ်တိုင် ထားခဲ့သော စာသားများ ဆက်ရှိနေမည်။ သင့်အညွှန်းရွေးချယ်မှုများကို ထိန်းသိမ်းထားပြီး၊ ဤအရာကို ပိတ်လိုက်ပါက ၎င်းတို့ ပြန်ပေါ်လာပါလိမ့်မည်။';
...
$ec_lang['lpn_geomap']='လတ္တီတွဒ်/လောင်ဂျီတွဒ်';
$ec_lang['lpn_xymap']='xy';
$ec_lang['lpn_file_import_geo']='xy ဖိုင်ကို မြေပုံပေါ်တွင် ဖွင့်ရန်…';
$ec_lang['lpn_file_import_geo_tip']='ပရောဂျက်ဖိုင်တစ်ခု (သို့) EPANET ဖိုင်တစ်ခုကို ဤစာမျက်နှာပေါ်ရှိ ပရောဂျက် tab အသစ်တစ်ခုတွင်၊ လမ်းမြေပုံပေါ်၌ ဖွင့်သည်။ ပုံဆွဲချက်ကို ကမ္ဘာပေါ်တွင် သင်ကိုယ်တိုင် ထားရသည် - နေရာသို့ ရွှေ့ပြီး ဇူးမ်လုပ်ပါ၊ ထို့နောက် ကိုက်ညီအောင် အရွယ်ချိန်ညှိပြီး လှည့်ပါ။ ဖိုင်ထဲရှိ x နှင့် y တို့သည် လောင်ဂျီတွဒ်နှင့် လတ္တီတွဒ် ဖြစ်နှင့်ပြီးသားဆိုလျှင်၊ ဤတို့သည် lat/lon ဖြစ်နှင့်ပြီးသား ခလုတ်ကို နှိပ်ပါ၊ ကွန်ရက်သည် ၎င်းရှိသင့်ရာနေရာသို့ တိုက်ရိုက်ရောက်သွားပါလိမ့်မည်။ သင်ရိုက်ထည့်ခဲ့သော ဂဏန်းတိုင်းသည် ရှိသည့်အတိုင်း ဆက်ရှိနေမည်။';
...
$ec_lang['lpn_clean_map_tip']='အခြေအနေတန်းနှင့် ကိုဩဒိနိတ် ပြသချက်ကို မြေပုံမှ ဖယ်ရှားပါ၊ ဤသို့ဖြင့် screenshot တစ်ခုသည် ပုံဆွဲချက်ကိုသာ ပြပါလိမ့်မည်။ သင့်ပုံဆွဲချက်ကို မထိခိုက်ပါ၊ ဤရွေးချယ်မှုကို မသိမ်းဆည်းပါ - စာမျက်နှာကို ပြန်ဖွင့်လိုက်ပါက ပြသချက်များ ပြန်ရောက်လာမည်။';
...
$ec_lang['lpn_time_no_engine']='တွင်ပါ ဖြေရှင်းစက်သည် အခိုက်တစ်ခုတည်းကို တစ်ကြိမ် တွက်ချက်သောကြောင့်၊ ဤသည်မှာ {time} တွင်သာ ကွန်ရက် ဖြစ်သည် - ပုံစံတိုင်းကို ထိုအခိုက်၌ ဖတ်ယူပြီး၊ ရေတိုက်တိုင်းသည် ပြည့်ခြင်း၊ ကုန်ခြင်း မလုပ်ဘဲ ၎င်း၏ အစပြု အဆင့်၌ပင် ဆက်ရှိနေသည်။ အချိန်ကာလတစ်ခုလုံးကို လည်ပတ်စေသော EPANET ဖြေရှင်းစက်ကို ရယူရန် အင်တာနက်ကို တစ်ကြိမ် ချိတ်ဆက်ပါ။';
$ec_lang['lpn_time_slider']='အချိန်';
$ec_lang['lpn_time_no_period']='ဤပရောဂျက်တွင် အချိန်ကာလ မရှိသောကြောင့်၊ ပြရန် အခိုက်တစ်ခုသာ ရှိသည်။ ကွန်ရက်ကို အချိန်နှင့်အမျှ တွက်ချက်ရန် ဆက်တင်များတွင် စုစုပေါင်း လည်ပတ်ချိန် ကို သတ်မှတ်ပါ။';
...
$ec_lang['lpn_time_run_note']='သင်သည် ပထမဆုံး အစီရင်ခံအချိန်ရှိ ကွန်ရက်ကို ကြည့်နေပါသည်။ ဤကွန်ရက်ကို ၎င်း၏ အချိန်ကာလတစ်ခုလုံးအတွက် တွက်ချက်ရန် ကြာမြင့်လွန်းသောကြောင့်၊ သင်အလုပ်လုပ်နေစဉ် နောက်ပိုင်းအချိန်များ၏ အဖြေများကို မွမ်းမံမထားပါ။ ၎င်းတို့ကို မွမ်းမံရန် တွက်ချက်ရန် ခလုတ်ကို နှိပ်ပါ။';
...
$ec_lang['lpn_georef_asdegrees']='ဤဖိုင်ရှိ x နှင့် y တို့ကို လောင်ဂျီတွဒ်နှင့် လတ္တီတွဒ်အဖြစ် ဖတ်ယူထားသောကြောင့်၊ ကွန်ရက်သည် မြေပုံပေါ်တွင် ရှိပြီးသားဖြစ်ပြီး မည်သည့်အရာမျှ မရွှေ့ရသေးပါ။ မှန်ကန်သောနေရာတွင် ရှိမရှိ စစ်ဆေးပြီး၊ ဤနေရာချထားမှုကို ထားရှိရန် ခလုတ်ကို နှိပ်ပါ။';
...
$ec_lang['lpn_result_water_age_tip']='ဤနေရာသို့ ရောက်ရှိသော ရေသည် စနစ်ထဲတွင် မည်မျှကြာ ရှိနေပြီလဲ ဖြစ်သည်။ နှိုင်းယှဉ်ရန် စည်းမျဉ်းသတ်မှတ်ထားသော ကန့်သတ်ချက် မရှိသောကြောင့်၊ ဤဂဏန်းကို သင့်ကိုယ်ပိုင်စနစ်နှင့် နှိုင်းယှဉ်၍ ဆုံးဖြတ်ပါ။';
...
$ec_lang['lpn_new_coords']='ကိုဩဒိနိတ်များ';
$ec_lang['lpn_new_coords_xy']='xy ကိုဩဒိနိတ်များ';
$ec_lang['lpn_new_coords_geo']='lat/lon';
$ec_lang['lpn_new_coords_tip']='xy ပရောဂျက်တစ်ခုသည် လတ္တီတွဒ်နှင့် လောင်ဂျီတွဒ် မဟုတ်သော ကိုဩဒိနိတ်များကို အသုံးပြုသည်။ lat/lon ပရောဂျက်တစ်ခုတွင် ပထဝီဆိုင်ရာ ကိုဩဒိနိတ်များ ရှိသောကြောင့်၊ နောက်ခံတွင် လမ်းမြေပုံ (သို့) ဂြိုဟ်တု ပုံရိပ် ဆွဲနိုင်ပြီး ဆက်စပ်နေရာများ၏ ရေအမြင့်ကို မြေပြင်မှ ဖတ်ယူနိုင်သည်။ xy ပရောဂျက်တစ်ခုကို ဖိုင်၊ xy ဖိုင်ကို မြေပုံပေါ်တွင် ဖွင့်ရန် ဖြင့် lat/lon အဖြစ် ပြောင်းလဲနိုင်သည်။';
$ec_lang['lpn_new_place']='ဤနေရာအနီးတွင် စတင်ရန်';
$ec_lang['lpn_new_place_tip']='ရွေးချယ်နိုင်သည်။ မြို့၊ လမ်း (သို့) မှတ်ဆိုင်းတစ်ခုကို ရိုက်ထည့်ပါက မြေပုံအသစ်သည် ထိုနေရာတွင် ဖွင့်ပါလိမ့်မည်။ သင်ရိုက်ထည့်သော စကားလုံးများသည် OpenStreetMap ၏ နေရာအမည် ဝန်ဆောင်မှုသို့ ရောက်သွားမည်ဖြစ်ပြီး၊ ၎င်းက ပထမဆုံးအကြိမ်တွင် သင့်ခွင့်ပြုချက်ကို တောင်းပါလိမ့်မည်။ ဗလာထားလိုက်ပါက မြေပုံသည် ကမ္ဘာတစ်ဝှမ်းလုံးပေါ်တွင် ဖွင့်ပါလိမ့်မည်။';
$ec_lang['lpn_new_place_hint']='မန္တလေး၊ မြန်မာ';
$ec_lang['lpn_new_create']='ဖန်တီးရန်';
$ec_lang['lpn_inp_drop_rules']='ဤဖိုင်တွင် စည်းမျဉ်းအခြေခံ ထိန်းချုပ်မှုများ ပါရှိသည်။ ၎င်းတို့ကို ဤနေရာတွင် အသုံးမပြုသောကြောင့်၊ ၎င်းတို့က ဖော်ပြထားသော ပိုက်၊ ရေတင်စက်နှင့် ဗားလ်များသည် ဖိုင်တွင် ရေးထားသော အခြေအနေတွင်ပင် ဆက်ရှိနေမည်။ စည်းမျဉ်းများကိုယ်တိုင်ကို ဆက်ထိန်းသိမ်းထားပြီး၊ EPANET ဖိုင်တစ်ခု သိမ်းလိုက်ပါက ၎င်းတို့ကို ပြန်ရေးပေးမည်။';
$ec_lang['lpn_inp_drop_energy']='ဤ EPANET ဖိုင်တွင် ရေတင်ကုန်ကျစရိတ် တွက်ချက်ရေး ဒေတာများ ပါရှိသည်။ ဤစာမျက်နှာက စွမ်းအင် (သို့) ကုန်ကျစရိတ်ကို မတွက်ချက်ပေးသောကြောင့်၊ ထိုဂဏန်းများကို ဤနေရာတွင် မည်သည့်နေရာမျှ အသုံးမပြုပါ။ ၎င်းတို့ကို ဆက်ထိန်းသိမ်းထားပြီး၊ EPANET ဖိုင်တစ်ခု သိမ်းလိုက်ပါက ၎င်းတို့ကို ပြန်ရေးပေးမည်။';
$ec_lang['lpn_inp_drop_tags']='ဤဖိုင်သည် ၎င်း၏ ဆက်စပ်နေရာ၊ ပိုက်လိုင်း (သို့) အခြားအစိတ်အပိုင်းအချို့အား tag များ ပေးထားသည်။ ဤစာမျက်နှာတွင် tag တစ်ခုကို ကြည့်ရန် (သို့) ပြောင်းလဲရန် နေရာ မရှိသေးပါ။ tag များကို ဆက်ထိန်းသိမ်းထားပြီး၊ EPANET ဖိုင်တစ်ခု သိမ်းလိုက်ပါက ၎င်းတို့ကို ပြန်ရေးပေးမည်။';
$ec_lang['lpn_inp_drop_report']='ဤဖိုင်တွင် EPANET က ၎င်း၏ အစီရင်ခံစာများ ပုံနှိပ်ရန် ကိုယ်ပိုင် သတ်မှတ်ချက်များ ပါရှိသည်။ ဤစာမျက်နှာက ၎င်း၏ အဖြေများကို ၎င်း၏ကိုယ်ပိုင် နည်းလမ်းဖြင့် ပြသောကြောင့်၊ ဤနေရာတွင် ၎င်းတို့ကို အသုံးမပြုပါ။ ၎င်းတို့ကို ဆက်ထိန်းသိမ်းထားပြီး၊ EPANET ဖိုင်တစ်ခု သိမ်းလိုက်ပါက ၎င်းတို့ကို ပြန်ရေးပေးမည်။';
...
$ec_lang['lpn_inp_drop_quality_options']='ဤဖိုင်သည် EPANET ရေအရည်အသွေး ရွေးချယ်စရာများကို ဖော်ပြသည် - Quality က ဆောင်ရွက်မည့် ရေအရည်အသွေး ခွဲခြမ်းစိတ်ဖြာမှု အမျိုးအစားကို အမည်ပေးပြီး၊ ဓာတုပစ္စည်းတစ်ခုနှင့် ဆက်စပ်နေသော သတ်မှတ်ချက် နှစ်ခုဖြစ်သော Relative diffusivity နှင့် Quality tolerance တို့ ပါဝင်သည်။ ရေသက်တမ်းနှင့် source trace ကို ဤနေရာတွင် တွက်ချက်ပေးသော်လည်း၊ ဓာတုပစ္စည်းကို မတွက်ချက်ပေးသောကြောင့်၊ ထိုသတ်မှတ်ချက် နှစ်ခုကို အသုံးမပြုဘဲ ဆက်ထိန်းသိမ်းထားသည်။ EPANET ဖိုင်တစ်ခု သိမ်းလိုက်ပါက ၎င်းတို့ အားလုံးကို ပြန်ရေးပေးမည်။';
...
$ec_lang['lpn_settings_quality_track_tip']='run တစ်ခုသည် ပိုက်လိုင်းများ တစ်လျှောက် မည်သည့်အရာကို ခြေရာခံသင့်သည်ကို ရွေးပါ - ရေသည် စနစ်ထဲတွင် မည်မျှကြာအောင် ရှိနေခဲ့သည်၊ (သို့) ရေသည် မည်သည့်နေရာမှ လာသည်။ ဤနှစ်ခုစလုံးသည် ပါဝင်ပမာဏ (concentration) (သို့) တုံ့ပြန်နှုန်း လိုအပ်မှု မရှိပါ။';
...
$ec_lang['lpn_quality_chemical']='ဤဖိုင်က အမည်ပေးထားသော ဓာတုပစ္စည်းတစ်ခု (သိမ်းထားသည်၊ မတွက်ချက်ပါ)';
$ec_lang['lpn_quality_needs_run']='ရေအရည်အသွေးကို အချိန်နှင့်အမျှ ပိုက်လိုင်းများ တစ်လျှောက် သယ်ဆောင်သွားသောကြောင့်၊ EPANET အင်ဂျင်နှင့် စုစုပေါင်း run အချိန် လိုအပ်သည်။ အချိန် အောက်ရှိ စုစုပေါင်း လည်ပတ်ချိန် ကို သတ်မှတ်ပြီး တွက်ချက်ရန် ခလုတ်ကို နှိပ်ပါ။';
...
$ec_lang['lpn_ff_menu']='မီးငြိမ်းသတ်ရေးစီးနှုန်း…';
...
$ec_lang['lpn_ff_title']='မီးငြိမ်းသတ်ရေးစီးနှုန်း';
...
$ec_lang['lpn_ff_required_node_tip']='သင်၏ မီးဘေးကာကွယ်ရေး ဥပဒေ (သို့) မီးသတ်ဌာနက ဤဆက်စပ်နေရာတည်ရှိရာ မြေအသုံးချမှုအတွက် သီးသန့် လိုအပ်သော မီးငြိမ်းသတ်ရေးစီးနှုန်း။ ဗလာထားလိုက်ပါက ဆက်စပ်နေရာကို လိုအပ်သော မီးငြိမ်းသတ်ရေးစီးနှုန်း ဘောက်စ်ရှိ ဂဏန်းနှင့် စစ်ဆေးမည်။';
...
$ec_lang['lpn_ff_design_nodes']='အခြား ဆက်စပ်နေရာ အားလုံး';
