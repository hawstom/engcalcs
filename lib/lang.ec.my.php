...
$ec_lang['mtc_bend_angle']='<a target="_blank" href="riprap-bend-angle.png">ကောက်ကြောင်းထောင့်, β</a><span class="ec-help" title="Riprap အရွယ်အတွက်။ ပုံကြမ်းအတွက် လင့်ခ်ကိုနှိပ်ပါ။"><span class="ec-tip">?</span></span>';
...
$ec_lang['mtc_solve_for_y']='Q ပေးထားပါက အနက်ရှိုင်း y ကို ဖြေရှင်းခြင်း';
$ec_lang['mtc_solve_desc']='တွက်ချက်မှုပုံစံမှ b, z<sub>1</sub>, z<sub>2</sub>, S နှင့် n တို့ကို အသုံးပြု၍ ပေးထားသော Q အတွက် အနက်ရှိုင်းကို ရှာဖွေသည်။';
$ec_lang['mtc_solver_no_solution']='ဤချောင်းကြောင်းဒေတာများဖြင့် ပေးထားသော Q အတွက် အဖြေရှာမတွေ့ပါ။';
// Weir Flow Simple
