...
$ec_lang['lpn_labels_prefix_id_tip']='地图上编号前显示的文字。留空则单独显示编号，以其被赋予的字母开头，例如 J1 或 L1。';
...
// --- lpn_ delta batch 1 (translation sprint, zh) ---
...
$ec_lang['lpn_units_group_inputs']='输入单位';
$ec_lang['lpn_units_group_results']='结果单位';
...
// --- lpn_ delta batch 2 (translation sprint, zh) ---
...
// --- lpn_ delta batch 3 (translation sprint, zh) ---
...
$ec_lang['lpn_profile_from']='起点';
$ec_lang['lpn_profile_to']='终点';
$ec_lang['lpn_profile_pick']='在地图上点击节点，将其加入路线';
$ec_lang['lpn_profile_through']='途经节点';
$ec_lang['lpn_profile_clear']='全部清除';
...
$ec_lang['lpn_new_geo_us']='空白经纬度项目，美制单位（gpm）';
$ec_lang['lpn_new_geo_si']='空白经纬度项目，国际单位制（L/s）';
...
$ec_lang['lpn_settings_sec_elements']='新建元件';
