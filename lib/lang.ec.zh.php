...
$ec_lang['mhp_annual_kwh']='100%容量时的年发电量';
...
$ec_lang['ps_annual_kwh']='100% 装机容量下的年发电量';
$ec_lang['ps_vel_ok']='1–3 m/s — 在目标范围内 ✓';
$ec_lang['ps_vel_low']='低于 1 m/s — 增大管径 ⚠';
$ec_lang['ps_vel_high']='高于 3 m/s — 减小管径 ⚠';
$ec_lang['ps_hl_ok']='在 10% 目标内 ✓';
$ec_lang['ps_hl_warn']='超过 10% 目标 — 考虑更大管径 ⚠';
$ec_lang['ps_hl_bad']='超过 20% — 重新核算管道尺寸';
...
$ec_lang['ds_main_desc']='滴灌和喷灌 &mdash; 灌水强度与灌水均匀度';
...
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>，其中 A<sub>e</sub> = S<sub>e</sub> &times; S<sub>l</sub> 为每个灌水器控制的面积。较低的灌水强度可为水分入渗提供更多时间 &mdash; 在黏重土壤或坡地上尤为重要。';
...
$ec_lang['cs_Ec_target']='衬砌目标，E<sub>c,target</sub> <span title="Conveyance efficiency goal after lining; fraction 0&ndash;1" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['cs_payback_years']='投资回收期 <span title="Simple payback = total lining cost &divide; annual value recovered" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['cs_notes_3_def']='输入任意统一货币单位的水价值和衬砌成本。衬砌面积 = 渠段长度 &times; 湿周 — 渠道横截面在量测流量水深处的湿周（底宽加两侧湿润坡面）。年回收价值按衬砌渠道持续达到目标 E<sub>c</sub> 计算。季节性渠道或衬砌未达目标效率的实际投资回收期将更长。';
...
$ec_lang['rc_main_desc']='块石陡槽护坡块石尺寸设计 &mdash; Robinson, Rice &amp; Kadavy (1998)';
...
$ec_lang['rc_layer']='块石层厚度（2 &times; D<sub>50</sub>）';
$ec_lang['rc_crest_radius']='顶部堰顶曲线半径（40 &times; D<sub>50</sub>）';
$ec_lang['rc_crest_length']='顶部堰顶曲线弧长';
$ec_lang['rc_apron_length']='出口护坦长度（15 &times; D<sub>50</sub>）<span title="为确保陡槽块石的结构稳定性所必须的护坦长度。"出口段和下游渠道阻力所产生的最小尾水足以确保出口段护坡的稳定性。"（Robinson）" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_qs']='表面单宽流量, q<sub>s</sub>（q<sub>t</sub> &minus; q<sub>m</sub>）';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice &amp; Kadavy (1998) 根据陡槽坡度和单宽流量，建立了两个计算护坡中值粒径 D<sub>50</sub> 的经验公式。公式 1 适用于缓坡（S<sub>0</sub> &lt; 0.10）；公式 2 适用于陡坡（0.10 &le; S<sub>0</sub> &le; 0.40）。两个公式均要求 q<sub>t</sub> 的单位为 m&sup2;/s，输出 D<sub>50</sub> 单位为 mm。经验证范围为 0.02 &le; S<sub>0</sub> &le; 0.40。';
$ec_lang['rc_notes_2_term']='单宽流量';
$ec_lang['rc_notes_2_def']='q<sub>t</sub> 为陡槽堰顶处的总单宽流量（单位宽度上的总流量）。对于底宽为 B、总流量为 Q 的渠道，可近似取 q<sub>t</sub> &asymp; Q / B，或由陡槽进口的临界水深条件计算得出。';
$ec_lang['rc_notes_3_term']='通过块石层的水流';
$ec_lang['rc_notes_3_def']='总流量的一部分流经护坡岩石孔隙（层内流 q<sub>m</sub>）；其余部分在岩石表面流动（q<sub>s</sub> = q<sub>t</sub> &minus; q<sub>m</sub>）。表面水深 d 由曼宁方程根据陡槽糙率 n 对表面流量 q<sub>s</sub> 求解得出。默认孔隙率 n<sub>p</sub> = 0.45，适用于棱角形碎石。';
