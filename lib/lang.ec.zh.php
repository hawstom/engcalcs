...
$ec_lang['about_body_html']='<h3>使命</h3><p>HawsEDC 工程计算器旨在为全球工程师和现场工作者服务——尤其是在缺水、资源匮乏或服务不足地区工作的人。这些工具是更广泛人道主义使命的一部分：以最实际、最有效的方式告诉每一个人，他们永远是被爱和珍视的，他们不必害怕，也不会毁掉一切。</p><p>计算器是载体，目标是一个没有苦难的世界。</p><h3>开源许可证</h3><p>所有代码均在 <a target="_blank" href="https://www.gnu.org/licenses/gpl-3.0.html">GNU 通用公共许可证 v3.0 或更高版本</a>下发布——自由如自由本身。您可以在相同条款下使用、研究、修改和再分发代码。</p><p>版权所有 © 2009–2026 Thomas Gail Haws。</p><h3>源代码</h3><p>完整源代码在 GitHub 上公开提供：</p><p><a target="_blank" href="https://github.com/hawstom/engcalcs">github.com/hawstom/engcalcs</a></p><p>您可以在那里浏览代码、提交问题或 fork 仓库。</p><h3>参与贡献</h3><p>欢迎提交 Pull Request。贡献方式：</p><ul><li><strong>翻译</strong> — 改进或新增语言。提交包含相关 <code>lib/lang.ec.??.php</code> 文件修改的 Pull Request。</li><li><strong>错误报告</strong> — 使用任意计算器页面上的反馈表单，或在 GitHub 上提交问题。</li><li><strong>新计算器</strong> — 特别欢迎为现场工作者和灌溉从业者服务的水力工程工具创意。请参阅仓库中的开发者指南 <code>CLAUDE.md</code>。</li><li><strong>托管镜像</strong> — 如果您能为连接受限地区提供镜像服务，欢迎联系我们。</li></ul><h3>离线使用</h3><p>这些计算器可作为渐进式网络应用（PWA）运行。在联网状态下访问任意计算器页面，您的浏览器将自动缓存所有计算器。此后，所有计算器均可离线使用——无需网络连接。</p><p>在 Android 或 iOS 上，使用浏览器的"添加到主屏幕"功能，将 EngCalcs 作为应用安装到您的设备上。在桌面端，请在浏览器地址栏中找到安装图标。</p><p>您也可以使用浏览器的"另存为…"菜单保存任意单个计算器，以便临时离线使用。</p><h3>联系方式</h3><p>Tom Haws——水力工程师，这些计算器的作者。<br />请使用任意计算器页面上的反馈表单，或访问 <a target="_blank" href="https://github.com/hawstom/engcalcs">GitHub</a> 上的源代码。</p>';
...
$ec_lang['lpn_main_menu']='环状管网（地图界面）';
$ec_lang['lpn_main_title']='免费在线环状管网（地图界面）计算器';
$ec_lang['lpn_main_desc']='在地图上绘制的环状管网的压力与流量';
