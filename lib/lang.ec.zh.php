...
$ec_lang['lpn_settings_engine_epanet_tip']='在您的浏览器中运行美国环保署（EPA）的 EPANET 求解器。内置求解器给出相同的结果且更快，因此除非确实需要 EPANET 本身，否则请保持关闭。';
...
$ec_lang['lpn_scenario_base_value']='基础：{value}';
