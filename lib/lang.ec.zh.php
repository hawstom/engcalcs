...
$ec_lang['mhp_nu']='运动粘度，&nu; <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['mhp_efficiency']='水电站效率，&eta;（0&ndash;1）';
...
$ec_lang['mhp_vel_low']='低于 1 m/s — 减小管径 ⚠';
$ec_lang['mhp_vel_high']='高于 3 m/s — 增大管径 ⚠';
...
$ec_lang['mhp_notes_1_def']='总损失 h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>，其中 h<sub>f</sub> = f(L/D)(v&sup2;/2g) 为达西-魏斯巴赫沿程摩擦损失，h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g 包含进口、弯管与阀门损失。净水头 H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>。';
$ec_lang['mhp_notes_2_term']='流速';
$ec_lang['mhp_notes_2_def']='目标 1&ndash;3 m/s。低于 1 m/s 表明管道过大；高于 3 m/s 将增大摩擦损失和水锤风险。';
$ec_lang['mhp_notes_3_term']='水头损失目标';
$ec_lang['mhp_notes_3_def']='压力管道损失低于毛水头的 10% 一般是经济的。管道费用与损失电量之间的最优权衡通常在高价值发电站约 4&ndash;6% 处。';
$ec_lang['mhp_notes_4_term']='局部损失 k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='典型参考值：锐边进口 0.5，每个 45&deg; 弯头 0.2&ndash;0.3，闸阀（全开）0.1，蝶阀 0.2。累加所有管件得到总 k<sub>m</sub>。默认值 1.5 假设一个进口和两个弯头。';
$ec_lang['mhp_notes_5_term']='管道粗糙度 e';
$ec_lang['mhp_notes_5_def']='典型绝对粗糙度：钢管（新）0.046&nbsp;mm，钢管（旧）0.15&nbsp;mm，HDPE 0.003&nbsp;mm，PVC/uPVC 0.0015&nbsp;mm，混凝土 0.3&ndash;3&nbsp;mm。HDPE 常用于小型微水电压力管道。';
