...
$ec_lang['lpn_profile_draw']='在地图上选择路径';
$ec_lang['lpn_profile_draw_stop']='停止选择';
...
$ec_lang['lpn_library_default_pattern']='默认需水模式';
$ec_lang['lpn_library_default_pattern_tip']='未指定模式的每个节点都使用此模式。';
...
$ec_lang['lpn_terrain_menu']='从地形数据填入高程…';
$ec_lang['lpn_terrain_tip']='读取每个缺少高程的节点所在位置的地面高程，并自动为您填入。已有高程的节点不会被改动，一次撤销即可全部恢复。首次使用时会请求您的许可，因为您节点的位置信息会发送到 Mapbox。';
