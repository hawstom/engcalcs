...
$ec_lang['lpn_field_text_match_pipe']='与管道角度一致';
...
$ec_lang['lpn_ex_net3_desc']='EPANET 的大型示例：97 个节点、两个水箱和一个河流水源。值得打开看看真实规模的模型在地图上是什么样子。';
...
$ec_lang['lpn_settings_engine_epanet_tip']='在您的浏览器中运行美国环保署（EPA）的 EPANET 求解器。两种求解器给出的结果相同，在这种规模的管网上您不会察觉速度差异。首次开启时会下载约 650 KB 数据，此后保存在本设备上。';
...
$ec_lang['lpn_settings_readability_bias']='标签翻转前允许偏离竖直方向的角度（度）';
