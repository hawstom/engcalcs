...
$ec_lang['ds_se']='支管上灌水器间距, S<sub>e</sub>';
$ec_lang['ds_sl']='支管间距（行距）, S<sub>l</sub>';
...
$ec_lang['ds_t_run']='达到目标深度的运行时间（小时）';
...
$ec_lang['cs_L']='渠段长度，L';
$ec_lang['cs_wp']='渠道横截面湿周，P<sub>w</sub>';
$ec_lang['cs_Q_loss_per_L']='单位长度渗漏损失，Q<sub>loss</sub>/L';
$ec_lang['cs_water_value']='水的价值（货币/单位体积）';
$ec_lang['cs_lining_cost']='衬砌成本（货币/单位面积）';
$ec_lang['cs_Ec_target']='衬砌后目标输水效率，E<sub>c,target</sub>（分数，0&ndash;1）— 目标是衬砌渠道保留水分的效果';
$ec_lang['cs_lining_area']='渠道衬砌面积（L &times; P<sub>w</sub>）';
$ec_lang['cs_annual_value_lost']='水年损失价值（货币）';
$ec_lang['cs_annual_value_recovered']='衬砌回收的年价值（货币）';
$ec_lang['cs_lining_total_cost']='衬砌总成本（货币）';
$ec_lang['cs_payback_years']='简单投资回收期（年）';
