...
$ec_lang['lpn_empty_hint']='د اوزارپټې نه د شاليد انځور یا ذخیرې اضافه کولو سره پیل وکړئ، یا د فایل، نوی پروژه پرانیزئ ترڅو د یوې بېلګې نه پیل وکړئ.';
...
$ec_lang['lpn_new_from_examples']='د بېلګو نه';
...
$ec_lang['lpn_new_example_us']='بنسټیزه شبکه، د متحده ایالاتو واحدونه (gpm)';
$ec_lang['lpn_new_example_si']='بنسټیزه شبکه، SI واحدونه (l/s)';
...
$ec_lang['lpn_inp_report_counts']='{nodes} جنکشنونه او ذخیرې، {links} پایپونه او پمپونه، په {units} کې.';
...
$ec_lang['lpn_inp_drop_tcv']='دا کنترول والوونه د خورا لنډو پایپونو په توګه راننوتل چې ورته ځایی ضیاع لري. اوبه ورته ډول چلند کوي؛ عنصر ورته نه دی.';
$ec_lang['lpn_inp_drop_valve']='دا والوونه فشار یا بهاو کنترولوي، او دا پاڼه داسې عنصر نلري. دا د خلاصو پایپونو په توګه راننوتل، نو شبکه لاهم وصل ده، خو نور یې هیڅ شی نه کنترولوي.';
...
$ec_lang['lpn_inp_drop_units']='د دې فایل د بهاو واحدونه نه وو پیژندل شوي، نو ګالن په دقیقه کې انګیرل شول. د پایلو کارونې نه مخکې هره شمېره وګورئ.';
...
$ec_lang['lpn_notes_1_def']='یو ځل یوه ډله غوښتنې حل کوي، د هماغه نړیوال تدریج الگوریتم په کارولو سره چې EPANET یې کاروي. دا نه ماډل کوي چې شبکه د وخت په تیریدو سره څنګه بدلیږي.';
$ec_lang['lpn_notes_2_term']='نه دي ماډل شوي';
$ec_lang['lpn_notes_2_def']='ذخیره ټانکونه، د اوبو کیفیت، او هغه کنترول والوونه چې پخپله خلاصیږي او بندیږي (PRV، PSV، FCV) ماډل شوي نه دي. یو پایپ کولی شي یو ثابت ځایی ضیاع ولري، خو داسې والو نشي کولی چې د خلاص یا بند حالت یې د حل کیدونکي بهاو پورې اړه ولري.';
...
$ec_lang['lpn_diag_no_fixed_head']='یوه ذخیره اضافه کړئ. شبکه د حل کیدو نه مخکې لږ تر لږه یو پیژندل شوی د اوبو کچه ته اړتیا لري.';
...
$ec_lang['lpn_backdrop_position_prompt1']='په شاليد انځور کې هره نقطه کلیک کړئ. دا هغه نقطه ده چې تاسو یې لیږدوئ.';
$ec_lang['lpn_backdrop_position_prompt2']='غوره کړئ چې هغه نقطه چیرته لاړ شي، بیا دوام ورکړئ کلیک کړئ.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='د متحده ایالاتو EPA د EPANET حل کوونکی چلوي، دلته ستاسو براوزر کې. اندرونی حل کوونکی ورته ځوابونه ورکوي او ډیر ژر دی، نو دا غیرفعال پریږدئ پرته له دې چې تاسو ته پخپله EPANET اړتیا وي.';
...
$ec_lang['lpn_settings_symbol_size']='د نښې اندازه (د متن په پرتله)';
...
$ec_lang['lpn_scenario_base_value']='اساس: {value}';
