...
$ec_lang['lpn_main_title']='د EPANET انجن سره وړیا آنلاین د اوبو ویش شبکې محاسبګر';
...
$ec_lang['lpn_settings_engine_epanet']='د EPANET انجن سره حل کول';
$ec_lang['lpn_settings_engine_epanet_tip']='د متحده ایالاتو EPA اصلي EPANET انجن چلوي، دلته ستاسو براوزر کې. اندرونی حل کوونکی ورته ځوابونه ورکوي او ډیر ژر دی، نو دا غیرفعال پریږدئ پرته له دې چې تاسو ته پخپله EPANET اړتیا وي.';
$ec_lang['lpn_engine_loading']='د EPANET انجن پورته کیږي…';
$ec_lang['lpn_engine_failed']='د EPANET انجن نشو پورته کیدی. د اندروني حل کوونکي ښودل کیږي.';
