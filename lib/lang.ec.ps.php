...
$ec_lang['lpn_inp_drop_tanks']='ذخیره ټانکونه پرېښودل شول. دا پاڼه ذخیرې لري چې د اوبو یو ثابت کچه ساتي. ذخیره ټانک ثابته کچه نه ساتي، نو دا ذخیره نه ده.';
$ec_lang['lpn_inp_drop_tank_links']='دا پایپونه پرېښودل شول ځکه چې د یوې پرېښودل شوې ذخیره ټانک سره وصل دي.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='د متحده ایالاتو EPA اصلي EPANET حل کوونکی چلوي، دلته ستاسو براوزر کې. اندرونی حل کوونکی ورته ځوابونه ورکوي او ډیر ژر دی، نو دا غیرفعال پریږدئ پرته له دې چې تاسو ته پخپله EPANET اړتیا وي.';
