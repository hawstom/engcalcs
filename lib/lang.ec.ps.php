...
$ec_lang['lpn_pane_paste_note']='دا جدول د دې لپاره دی چې ارزښتونه د یوې سپریډشیټ نه هغو کرښو کې پیسټ کړئ چې دمخه شته دي. که دا ستاسو اړتیاوې پوره نه کوي، Help، Fix something وکاروئ ترڅو موږ ته ووایاست.';
...
$ec_lang['lpn_georef_projected']='دا پروژه لومړی یو نقشوی پروجیکشن ښیي، نو د دې همغږۍ نشي کولی بیا په نقشه کې ځای پر ځای شي.';
...
$ec_lang['lpn_new_coordsys_geo']='جغرافیایي پروجیکشن';
$ec_lang['lpn_new_coordsys_geo_tip']='یو جغرافیایي پروجیکشن وټاکئ. د Lat/Lon لپاره WGS 84 / Pseudo-Mercator EPSG:3857 وکاروئ.';
...
$ec_lang['lpn_new_crs_tip']='هغه پروجیکشن چې ستاسو همغږۍ لا دمخه پکې اندازه شوي دي. همغږۍ عیناً هماغسې ذخیره کیږي لکه چې تاسو یې لیکئ، او هیڅ شی نه بدلیږي. دا انتخاب دایمي دی؛ یوازینۍ لاره چې تاسو یوه شبکه بلې همغږیو ته بدلولی شئ "د فایل، نوي همغږیو ته پرانیستل" ده، او دا نږدې ده. UTM د نړۍ غالب معیار دی، یوه سیمه خپل دودونه لري، او د ځمکې سروي کوونکی هغه کس دی چې باید ترې پوښتنه وشي که تاسو ډاډه نه یاست.';
...
$ec_lang['lpn_crs_place_projected']='یوه پروجیکت شوې پروژه په خپل مسطح سطح پرانیزي، نه په هغه ځای چې تاسو یې لټولی و. دا مسطح سطح په ځمکه ایښودل یو همغږۍ بدلون ته اړتیا لري، چې دا پاڼه تر اوسه نلري.';
...
$ec_lang['lpn_menu_cue']='له پورتنیو مینو نه پیل وکړئ. د چټکې لاسرسي لپاره اوزارپټه وکاروئ.';
