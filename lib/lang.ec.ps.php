...
$ec_lang['lpn_file_convert_as']='یو xy فایل پر نقشه پرانیزئ…';
$ec_lang['lpn_file_convert_as_tip']='یوه پروژه فایل یا یو EPANET فایل د دې پاڼې پر یوه نوې پروژې ټب کې، پر سرک نقشه پرانیزي. تاسو انځور په لاس د نړۍ پر مخ ځای پر ځای کوئ: سایټ ته پان او زوم وکړئ، بیا یې اندازه او واړول ورسره برابر کړئ. که د فایل x او y دمخه یو طول او عرض البلد وي، د دا لا هم lat/lon دي تڼۍ فشار کړئ او شبکه سمدلاسه هغه ځای ته ځي چېرته چې پورې اړه لري. هره شمېره چې تاسو لیکلې وه لکه هماغسې پاتې کیږي.';
