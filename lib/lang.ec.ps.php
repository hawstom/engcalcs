...
$ec_lang['bpn_line_problem']='د پورتني ستون وګورئ: یوه کرښه یو ناپیژندل شوي ID ته اشاره کوي، ځان ته اشاره کوي، یا حلقه جوړوي، نو د شبکې یوه برخه له سرچینې سره وصل نه ده. دغه کرښې پرته له حل پاتې کیږي.';
$ec_lang['bpn_bad_id_short']='شبکه';
