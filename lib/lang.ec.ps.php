...
// 2026-08-19 translation sprint (batch 1 of 4)
...
$ec_lang['lpn_georef_menu']='lat/lon ته بدلول…';
$ec_lang['lpn_georef_tip']='د یوې سیمه‌یزې ګرېډ نه ریښتینې نړۍ ته. په XY ګرېډ جوړ شوی رسم د جغرافیایي کوارډینیټونو باندې کیږدئ، ترڅو د سړک نقشې کې خپل ځای ونیسي. هره شمېره چې تاسو لیکلې لکه څنګه چې ده پاتې کیږي — یوازې X او Y یو طول البلد او عرض البلد کیږي.';
...
$ec_lang['lpn_pane_tab_junctions_tip']='هر جنکشن د یوه جدول په توګه چې تاسو یې ترتیبولی او سمولی شئ.';
$ec_lang['lpn_pane_junctions_none']='دا شبکه تر اوسه هیڅ جنکشن نلري.';
