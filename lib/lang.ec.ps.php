...
$ec_lang['lpn_main_menu']='د پایپ حلقوي شبکه (د نقشې انټرفېس) — لومړنۍ نسخه';
$ec_lang['lpn_main_title']='لومړنۍ نسخه: د نقشې انټرفېس سره وړیا آنلاین د پایپ حلقوي شبکې کالکولېټر';
$ec_lang['lpn_main_desc']='لومړنۍ نسخه — په نقشه کې د رسم شوې پایپ حلقوي شبکې فشار او بهاو';
