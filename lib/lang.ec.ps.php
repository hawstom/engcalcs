...
$ec_lang['lpn_inp_drop_quality']='دا فایل بیانوي چې د اوبو کیفیت د سفر پر مهال څنګه بدلیږي: په اوبو کې په پیل کې څه شی دی، هغه ماده نور چېرته ننوځي، څنګه تعامل کوي، او ټانکونه څنګه ګډوي. دا پاڼه د اوبو عمر او سرچینې تعقیب حسابوي، خو کیمیا نه، نو له دې نه هیڅ یو دلته کارول کیږي نه. هغه کرښې ساتل کیږي، او که تاسو EPANET فایل وساتئ، بېرته لیکل کیږي.';
...
$ec_lang['lpn_tip_select']='دا حالت وکاروئ ترڅو په نقشه کې شیان بدل کړئ، ولیږدوئ، او کش کړئ. پاڼه ځینو کړنو وروسته، لکه د یوې پروژې پرانیستل، پخپله بېرته دې حالت ته راځي.';
...
$ec_lang['lpn_settings_color_thematic_tip']='د نقطو او تړاوونو لیبلونه پټوي ترڅو یوازې رنګونه پر نقشه پاتې شي. هغه متن چې تاسو پخپله ایښی دی پاتې کیږي. ستاسو د لیبل ټاکنې ساتل کیږي، او دا بندول یې بېرته راولي.';
...
$ec_lang['lpn_file_import_geo']='یو xy فایل پر نقشه پرانیزئ…';
$ec_lang['lpn_file_import_geo_tip']='یوه پروژه فایل یا یو EPANET فایل د دې پاڼې پر یوه نوې پروژې ټب کې، پر سرک نقشه پرانیزي. تاسو انځور په لاس د نړۍ پر مخ ځای پر ځای کوئ: سایټ ته پان او زوم وکړئ، بیا یې اندازه او واړول ورسره برابر کړئ. که د فایل x او y دمخه یو طول او عرض البلد وي، د دا لا هم lat/lon دي تڼۍ فشار کړئ او شبکه سمدلاسه هغه ځای ته ځي چېرته چې پورې اړه لري. هره شمېره چې تاسو لیکلې وه لکه هماغسې پاتې کیږي.';
...
$ec_lang['lpn_clean_map_tip']='د حالت پټه او د همغږۍ لوستنه له نقشې نه لرې کړئ، ترڅو یو سکرین‌شاټ یوازې انځور وښیي. ستاسو انځور نه لمسیږي، او دا ټاکنه نه ساتل کیږي؛ د پاڼې بیا پورته کول لوستنې بېرته راولي.';
...
$ec_lang['lpn_time_no_engine']='جوړ شوی حل کوونکی یوه شیبه پرله‌پسې محاسبوي، نو دا یوازې د {time} لپاره شبکه ده: هره نمونه پدې شیبه لوستل کیږي، او هر ټانک لا هم په خپل پیل کچه ولاړ دی، نه ډکیږي نه خالیږي. یو ځل انټرنیټ سره وصل شئ ترڅو د EPANET حل کوونکی راولئ، چې ټوله موده چلوي.';
$ec_lang['lpn_time_slider']='وخت';
$ec_lang['lpn_time_no_period']='دا پروژه هیڅ وخت موده نلري، نو یوازې یوه شیبه د ښودو لپاره شته. په تنظیماتو کې یو ټول چلولو وخت ټاکئ ترڅو شبکه د وخت په اوږدو کې محاسبه کړئ.';
...
$ec_lang['lpn_time_run_note']='تاسو شبکه د لومړۍ راپور شیبې کې ګورئ. دا شبکه د خپلې ټولې وخت مودې محاسبه کولو لپاره دومره وخت نیسي چې د وروستیو شیبو پایلې ستاسو کار پرمهال تازه نه ساتل کیږي. د محاسبه کول تڼۍ فشار کړئ ترڅو دوی تازه کړئ.';
...
$ec_lang['lpn_georef_asdegrees']='د دې فایل x او y د یو طول او عرض البلد په توګه ولوستل شول، نو شبکه دمخه پر نقشه ده او هیڅ شی نه دی خوځول شوی. وګورئ چې سمه ځای کې ده، بیا د دا ځای وساتم تڼۍ فشار کړئ.';
...
$ec_lang['lpn_result_water_age_tip']='دا ښیي چې دې نقطې ته رسیدونکې اوبه څومره وخت په شبکه کې تیر کړی دی. د پرتلې لپاره یې هیڅ مقرراتي حد نشته، نو دا شمېره د خپلې شبکې پر بنسټ وارزوئ.';
...
$ec_lang['lpn_new_coords']='همغږي';
$ec_lang['lpn_new_coords_xy']='xy همغږي';
$ec_lang['lpn_new_coords_geo']='lat/lon';
$ec_lang['lpn_new_coords_tip']='یوه xy پروژه هغه همغږي کاروي چې عرض او طول البلد نه دي. یوه lat/lon پروژه جغرافیايي همغږي لري، نو یو سرک نقشه یا سپوږمیز انځور یې شاليد کیدی شي او د نقطو لوړوالی د ځمکې سطحې نه لوستل کیدی شي. یوه xy پروژه د فایل، نقشه پر یو xy فایل پرانیزئ سره lat/lon ته بدلیدی شي.';
$ec_lang['lpn_new_place']='دې ځای ته نږدې پیل کول';
$ec_lang['lpn_new_place_tip']='اختیاري. یو ښار، سړک یا نښه ولیکئ او نوې نقشه هلته پرانیزي. هغه ټکي چې تاسو یې لیکئ OpenStreetMap ته د ځای-نوم خدمت ته لاړ شي، چې لومړی ځل ستاسو اجازه غواړي. یې خالي پرېږدئ او نقشه به د ټولې نړۍ سره پرانیزي.';
$ec_lang['lpn_new_place_hint']='پیټالوما، کالیفورنیا';
$ec_lang['lpn_new_create']='جوړول';
$ec_lang['lpn_inp_drop_rules']='دا فایل د قواعدو پر بنسټ کنترولونه لري. دلته پلي نه کیږي، نو هغه پایپونه، پمپونه او والوونه چې نومول شوي دي، د فایل کې لیکل شوي حالت کې پاتې کیږي. قواعد پخپله ساتل کیږي، او که تاسو EPANET فایل وساتئ، بېرته لیکل کیږي.';
$ec_lang['lpn_inp_drop_energy']='دا EPANET فایل د پمپ کولو لګښت ماډل کولو معلومات لري. دا پاڼه انرژي یا لګښت نه حسابوي، نو دلته هغه شمېرې هیڅ ځای نه کارول کیږي. دوی ساتل کیږي، او که تاسو EPANET فایل وساتئ، بېرته لیکل کیږي.';
$ec_lang['lpn_inp_drop_tags']='دا فایل ځینو جنکشنونو، پایپونو یا نورو عناصرو ته ټاګونه ورکوي. تر اوسه پدې پاڼه کې د ټاګ لیدلو یا بدلولو ځای نشته. ټاګونه ساتل کیږي، او که تاسو EPANET فایل وساتئ، بېرته لیکل کیږي.';
$ec_lang['lpn_inp_drop_report']='دا فایل د EPANET خپل تنظیمات لري چې د راپورونو لپاره دي کوم چې دا چاپوي. دا پاڼه خپلې پایلې په خپل ډول ښیي، نو دلته هیڅ شی نه کاروي. دوی ساتل کیږي، او که تاسو EPANET فایل وساتئ، بېرته لیکل کیږي.';
...
$ec_lang['lpn_inp_drop_quality_options']='دا فایل د EPANET د اوبو کیفیت اختیارونه بیانوي: کیفیت، چې د اوبو کیفیت تحلیل ډول نوموي، او دوه تنظیمات چې د کیمیاوي مادې سره اړیکه لري، نسبي خپریدنه او د کیفیت زغم. د اوبو عمر او سرچینې تعقیب دلته حسابیږي؛ یوه کیمیاوي ماده نه حسابیږي، نو دا دوه تنظیمات پرته له کارولو ساتل کیږي. که تاسو EPANET فایل وساتئ، ټول بېرته لیکل کیږي.';
...
$ec_lang['lpn_settings_quality_track_tip']='وټاکئ چې محاسبه به د پایپونو له لارې څه تعقیب کړي: اوبه سیسټم کې څومره موده وې، یا دوی له کومه راغلي. هیڅ یو ته د غلظت یا تعامل کچې اړتیا نشته.';
...
$ec_lang['lpn_quality_chemical']='یوه کیمیاوي ماده چې دا فایل نوموي (ساتل شوې، نه محاسبه شوې)';
$ec_lang['lpn_quality_needs_run']='د اوبو کیفیت د وخت په اوږدو کې د پایپونو سره وړل کیږي، نو دا د EPANET انجن او د ټول چلولو وخت ته اړتیا لري. د وخت لاندې یو ټول چلولو وخت ټاکئ، بیا د محاسبه کول تڼۍ فشار کړئ.';
...
$ec_lang['lpn_ff_required_node_tip']='د دې ځانګړي جنکشن لپاره اړینه اور بهاو، ستاسو د اور قانون یا ستاسو د اور ادارې نه د هغې ځمکې کارونې لپاره چې دا خدمت کوي. یې خالي پرېږدئ او جنکشن به د اړینه اور بهاو بکس کې شمېرې پر بنسټ ازمویل شي.';
...
$ec_lang['lpn_ff_design_nodes']='ټول نور جنکشنونه';
