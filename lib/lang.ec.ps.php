...
$ec_lang['lpn_field_text_match_pipe']='د پایپ د زاویې سره سمون';
...
$ec_lang['lpn_examples_size']='{nodes} جنکشنونه، {links} پایپونه';
...
$ec_lang['lpn_ex_net3_desc']='د EPANET لویه بېلګه: 97 جنکشنونه، دوه ټانکونه، او یو سیندي سرچینه. د پرانیستلو وړ ده ترڅو وګورئ چې یوه حقیقي اندازې ماډل په نقشه کې څنګه ښکاري.';
...
$ec_lang['lpn_new_blank_us']='خالي پروژه، د متحده ایالاتو واحدونه (gpm)';
$ec_lang['lpn_new_blank_si']='خالي پروژه، SI واحدونه (l/s)';
...
$ec_lang['lpn_inp_drop_patterns']='د غوښتنې نمونې پرېښودل شوې. دا پاڼه یو شیبه حل کوي، نو هره غوښتنه هغه شمېره ده چې په فایل کې لیکل شوې.';
...
$ec_lang['lpn_inp_drop_eps']='دا فایل یو داسې سمولیشن بیانوي چې د یوې مودې لپاره چلیږي. دا پاڼه یوازې یوه شیبه حل کوي، نو یوازې پیل حالتونه راننوتل.';
...
$ec_lang['lpn_pump_point1']='ټکی 1 (اړین)';
$ec_lang['lpn_pump_point2']='ټکی 2 (اختیاري)';
$ec_lang['lpn_pump_point3']='ټکی 3 (اختیاري)';
...
$ec_lang['lpn_settings_defaults']='پیل ارزښتونه';
...
$ec_lang['lpn_settings_engine_epanet_tip']='د متحده ایالاتو EPA د EPANET حل کوونکی چلوي، دلته ستاسو براوزر کې. دواړه حل کوونکي ورته ځوابونه ورکوي، او پدې اندازې شبکه کې به تاسو د چټکتیا توپیر ونه ویني. کله چې تاسو دا لومړی ځل فعالوئ، نږدې 650 KB ډاونلوډ کیږي او بیا په دې وسیله کې ساتل کیږي.';
...
$ec_lang['lpn_settings_readability_bias']='هغه درجې چې له عمودي حالت نه لیرې کیدل، مخکې لدې چې لیبل بېرته وګرځول شي';
