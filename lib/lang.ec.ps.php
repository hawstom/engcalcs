...
$ec_lang['lpn_field_text_match_pipe']='د نږدې تړاو سره سمون';
...
$ec_lang['lpn_time_format_tip']='وخت د ساعتونو او دقیقو په توګه ولیکئ، لکه 2:30. یوه ساده شمېره ساعتونه معنی لري؛ شمېره د خپل کلمې سره هغه کلمه معنی لري: 30 دقیقې.';
$ec_lang['lpn_time_running']='ټوله وخت موده د EPANET انجن سره محاسبه کیږي.';
$ec_lang['lpn_time_no_engine']='جوړ شوی حل کوونکی یوازې یوه شیبه پرله‌پسې محاسبوي، نو دا شبکه یوازې د {time} لپاره ده: غوښتنې د هغې شیبې د نمونې ضربونه لري، او هر ټانک لا هم په خپل پیل کچه ولاړ دی، نه ډکیږي نه خالیږي. یو ځل انټرنیټ سره وصل شئ ترڅو د EPANET انجن راولئ، چې ټوله موده محاسبوي.';
