...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="د Darcy-Weisbach د خشونت لوړوالی"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">د جنکشن ضیاع ضریب، k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">د حرکت ویسکوزیته، ν <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="د عادي مات شوي ګرانائټ یا بازالټ ≈ 2.65. د Robinson سمه لړۍ: 2.54 تر 2.82.">د کاڼو ځانګړی ثقل، sg <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_apron_length']='<span class="ec-help" title="د چوټ کاڼو جوړښتي ملاتړ لپاره اړین دی. &quot;هغه لږترلږه لاندنۍ اوبه چې د وتنځي برخې او ښکته‌اړخ کانال مقاومت له امله رامنځته کیږي، د وتنځي برخې کې د کاڼو ثبات ډاډمنولو لپاره کافي ده.&quot; (Robinson)">د وتنځي اپرون اوږدوالی (15 &times; D<sub>50</sub>) <span class="ec-tip">?</span></span>';
