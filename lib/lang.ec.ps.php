...
$ec_lang['lpn_settings_sec_assets']='نوي عناصر';
...
$ec_lang['lpn_basemap_satellite_hide']='د سپوږمیز انځورونه پټ کړئ';
$ec_lang['lpn_basemap_satellite_tip']='د ځمکې انځورونه چې د Mapbox نه راځي، او د انټرنېټ له لارې راولاړل کیږي کله چې تاسو نقشه خوځوئ یا لویه/کوچنۍ کوئ. دا ګټور دي ترڅو وویني چې پایپ په حقیقت کې له کومه تیریږي. ستاسو شبکه هم رسمیږي که دا انځورونه ښکاره وي که نه.';
$ec_lang['lpn_georef_asdeg_btn']='دا لا هم lat/lon دي';
$ec_lang['lpn_georef_asdeg_tip']='دا یوازې هغه وخت کېکاږئ چې د دې فایل x او y په حقیقت کې یو longitude او یو latitude وي. شبکه به بیا هلته ولاړه شي چې دغه شمېرې یې ځای ښیي، او هیڅ ځای ورکول ته اړتیا نشته. هره شمېره په هر حال کې خپل حال ساتي.';
$ec_lang['lpn_georef_asdegrees']='د دې فایل x او y د longitude او latitude په توګه لوستل شوي، نو شبکه لا هم په نقشه کې ده او هیڅ شی نه دی خوځول شوی. وګورئ چې دا په سمه ځای کې ده، بیا "دا ځای وساتئ" کېکاږئ.';
...
$ec_lang['lpn_menu_project']='پروژه';
...
$ec_lang['lpn_run_menu_tip']='دا شبکه اوس بیا محاسبه کړئ. د "چلول" تڼۍ لټوئ؟ ترڅو دا پروژه له هرې بدلون وروسته پخپله بیا محاسبه کیږي، اوزارپټه د "چلول" تڼۍ نلري. په تنظیماتو کې، د محاسبې لاندې، هایدرولیکس کې "پخپله بیا محاسبه کول" غیرفعاله کړئ، او تڼۍ به بېرته راشي.';
...
$ec_lang['lpn_replace_button']='ځای پرځای کول';
...
$ec_lang['lpn_profile_draw']='لار په نقشه کې وټاکئ';
$ec_lang['lpn_profile_draw_stop']='ټاکل ودروئ';
...
$ec_lang['lpn_inp_drop_head_pattern']='دا ذخیرې د ورځې په اوږدو کې لوړیږي او ټیټیږي. د دوی نمونې (پټرنونه) په بشپړه توګه راننوتلې، او هغه د اوبو کچه چې تاسو یې وینئ د هغې شېبې لپاره ده چې ساعت یې ښیي.';
$ec_lang['lpn_inp_drop_pump_speed']='دا پمپونه پر یوه داسې چټکتیا چلیږي چې د دوی له منحني سره یې اندازه شوې چټکتیا سره توپیر لري، یا د ورځې په اوږدو کې چټکتیا بدلوي. چټکتیا او د هغې نمونه په بشپړه توګه راننوتلې، او هغه سر چې تاسو یې وینئ د هغې شېبې لپاره دی چې ساعت یې ښیي.';
...
$ec_lang['lpn_import_notes_heading']='د EPANET فایل نه';
$ec_lang['lpn_file_open_tip']='یوه د پروژې فایل خلاص کړئ چې له دې پاڼې ساتل شوې وه.';
$ec_lang['lpn_notes_color_term']='د رنګ ټوټو پولې یو شان پاتې کیږي';
$ec_lang['lpn_notes_color_def']='د رنګ ټوټو پولې هغه وخت ټاکل کیږي کله چې تاسو د معلوماتو د ډلبندۍ میتود وټاکئ. دا په هر وخت ګام کې بیا نه ټاکل کیږي، ځکه چې دا به رنګونه په هر ګام کې یوه نوې معنی ورکړي، او دا ستاسو د سیستم لیدلو لپاره ګټور نه دی. EPANET په هماغه ډول کار کوي. د نویو پولو ترلاسه کولو لپاره، بیا یو میتود وټاکئ یا خپلې ولیکئ.';
...
$ec_lang['lpn_time_run_report_tip']='هغه څه چې د EPANET حل کوونکي پخپله د وروستي چلولو په اړه چاپ کړل: دا څنګه هوار شو، او هر هغه څه چې یې خبرداری ورکړی و. دا د حل کوونکي خپل متن دی، زموږ نه.';
...
$ec_lang['lpn_library_curves_tip']='یوه منحنۍ هغه ټکي دي چې وایي یو پمپ څنګه کار کوي: پر هر بهاو څومره سر جوړوي.';
$ec_lang['lpn_library_curves_note']='یوه منحنۍ د هغه پمپ یا والو پورې اړه لري چې یې کاروي، نو دا ټول ټولګه یو ځای د لوستلو لپاره ده. یو ID کلیک کړئ ترڅو هغه عنصر ته لاړ شئ او هلته یې ټکي بدل کړئ. د یوه پمپ لپاره رسمه شوې کرښه هغه منحنۍ ده چې چلول یې کاروي، د ټکو له لارې برابره شوې؛ د یوه والو لپاره دا د دوی ترمنځ سیدې مرحلې دي.';
...
$ec_lang['lpn_library_default_pattern']='د غوښتنې تلواله نمونه';
$ec_lang['lpn_library_default_pattern_tip']='هر جنکشن چې نمونه نلري دا کاروي.';
...
$ec_lang['lpn_field_demand_pattern_tip']='دا چې د دې جنکشن غوښتنه د چلولو په اوږدو کې څنګه لوړیږي او ټیټیږي. یې پر "هیڅ نمونه نشته" پرېږدئ ترڅو د پروژې خپلې نمونې تعقیب کړي، هره چې وي.';
...
$ec_lang['lpn_field_speed_pattern_tip']='دا چې د دې پمپ چټکتیا د چلولو په اوږدو کې څنګه لوړیږي او ټیټیږي. هر ضربوونکی د ورځې د هغې برخې لپاره نسبي چټکتیا ده، او د پورتنۍ چټکتیا ځای نیسي، نو د 0 ضربوونکی پمپ درولی شي.';
...
$ec_lang['lpn_terrain_menu']='له ځمکې نه لوړوالي ډکول…';
$ec_lang['lpn_terrain_tip']='د هرې نقطې لاندې چې لوړوالی نلري د ځمکې لوړوالی ولولئ، او ستاسو لپاره یې ولیکئ. هغه نقطه چې لا مخکې لوړوالی لري بې پروا پاتې کیږي، او یو Undo دا ټول بېرته راولي. لومړی کارونه ستاسو اجازه غواړي، ځکه چې ستاسو د نقطو ځایونه Mapbox ته لاړ شي.';
$ec_lang['lpn_terrain_accuracy']='د ځمکې معلومات د ځمکې پر مخ نږدې 30 متره دي او معمولا په عمودي لوري کې څو متره تیر دي. دا د یوې کنتور نقشې په توګه وګڼئ، نه د یوې سروې، هر هغه څه چې تاسو پرې تکیه کوئ وګورئ.';
...
$ec_lang['lpn_terrain_confirm']='د {n} نقطو لوړوالی د ځمکې سطحې نه ډک کړم؟';
...
$ec_lang['lpn_terrain_confirm_default_2']='هغه {n} د ځمکې سطحې سره ځای پرځای کړم؟';
...
$ec_lang['lpn_terrain_none_needed']='هرې نقطې لا مخکې هغه لوړوالی لري چې تاسو ټاکلی دی. هیڅ شی نه دی بدل شوی، او هیڅ شی نه دی لیږل شوی — موږ هیڅکله هغه لوړوالی نه بیا لیکو چې لا مخکې شتون لري.';
$ec_lang['lpn_terrain_no_nodes']='تر اوسه د ډکولو لپاره هیڅ نقطه نشته.';
