...
$ec_lang['lpn_field_text_match_pipe']='مطابقة زاوية الأنبوب';
...
$ec_lang['lpn_examples_size']='{nodes} ملتقى، {links} أنبوب';
...
$ec_lang['lpn_ex_net3_desc']='أكبر أمثلة EPANET: 97 ملتقى، وصهريجان، ومصدر نهر. تستحق الفتح لرؤية شكل نموذج بحجم حقيقي على الخريطة.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='يشغّل حلّال EPANET من وكالة حماية البيئة الأمريكية، هنا في متصفحك. يعطي كلا الحلّالين النتائج نفسها، ولن تلاحظ فرقاً في السرعة على شبكة بهذا الحجم. أول مرة تُفعّل هذا الخيار، يُنزَّل نحو 650 كيلوبايت ثم يُحفظ على هذا الجهاز.';
...
$ec_lang['lpn_unit_unknown']='يذكر هذا الرسم وحدة لا تقدّمها هذه الصفحة: {unit}. كل شيء محفوظ ومعروض تماماً كما ورد، ولم يتغيّر شيء. لا يمكن إعطاء أي نتائج حتى تتعرّف هذه الصفحة على تلك الوحدة، لأنه لا توجد طريقة لمعرفة حجمها.';
...
$ec_lang['lpn_settings_readability_bias']='عدد الدرجات إلى يسار العمودي قبل قلب التسمية';
