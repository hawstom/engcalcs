...
$ec_lang['lpn_file_convert_as']='فتح ملف xy على الخريطة…';
$ec_lang['lpn_file_convert_as_tip']='يفتح ملف مشروع أو ملف EPANET في تبويب مشروع جديد على هذه الصفحة، على خريطة الشوارع. تضع الرسم على العالم بيدك: حرّك وقرّب إلى الموقع، ثم غيّر حجمه واستدر به ليلائمه. إذا كانت x وy في الملف بالفعل خط طول وخط عرض، اضغط زر هذه بالفعل خط العرض وخط الطول وتقفز الشبكة مباشرة إلى مكانها الصحيح. يبقى كل رقم كتبته كما هو.';
