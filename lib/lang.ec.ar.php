...
$ec_lang['lpn_pane_paste_note']='هذا الجدول مخصص لإدخال القيم عبر لصقها من جدول بيانات في صفوف موجودة بالفعل. إذا لم يلبِّ هذا احتياجك، استخدم المساعدة، إصلاح شيء ما لإخبارنا.';
...
$ec_lang['lpn_georef_projected']='يحدد هذا المشروع إسقاطاً خرائطياً بالفعل، لذا لا يمكن وضع إحداثياته على الخريطة مرة أخرى.';
...
$ec_lang['lpn_new_coordsys_geo']='إسقاط جغرافي';
$ec_lang['lpn_new_coordsys_geo_tip']='اختر إسقاطاً جغرافياً. استخدم WGS 84 / Pseudo-Mercator EPSG:3857 لخط العرض وخط الطول.';
...
$ec_lang['lpn_new_crs_tip']='الإسقاط الذي قِيست به إحداثياتك بالفعل. تُخزَّن الإحداثيات تماماً كما تكتبها، ولا يُحوَّل شيء. هذا الاختيار دائم؛ الطريقة الوحيدة لتحويل الشبكة إلى إحداثيات مختلفة هي "ملف، فتح بإحداثيات جديدة"، وهي تقريبية. UTM هو المعيار السائد عالمياً، وقد يكون لمنطقتك أعرافها الخاصة، والمساح المختص هو من تسأله إذا لم تكن متأكداً.';
...
$ec_lang['lpn_crs_place_projected']='يُفتح المشروع المُسقَط على مستواه الخاص، لا في المكان الذي بحثت عنه. وضع ذلك المستوى على الأرض يحتاج إلى تحويل إحداثيات، وهو ما لا تملكه هذه الصفحة بعد.';
...
$ec_lang['lpn_menu_cue']='ابدأ بالقوائم أعلاه. استخدم شريط الأدوات للوصول السريع.';
