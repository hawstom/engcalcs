...
$ec_lang['lpn_main_menu']='شبكة الأنابيب الحلقية (واجهة خريطة) — إصدار أولي';
$ec_lang['lpn_main_title']='إصدار أولي: حاسبة شبكة الأنابيب الحلقية المجانية عبر الإنترنت بواجهة خريطة';
$ec_lang['lpn_main_desc']='إصدار أولي — الضغط والتدفق في شبكة أنابيب حلقية ترسمها على خريطة';
