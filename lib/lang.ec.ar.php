...
$ec_lang['lpn_field_text_match_pipe']='مطابقة أقرب وصلة';
...
$ec_lang['lpn_time_format_tip']='اكتب الوقت كساعات ودقائق، مثل 2:30. الرقم المجرد يعني ساعات؛ والرقم المصحوب بكلمته الخاصة يعني تلك الكلمة: 30 دقيقة.';
$ec_lang['lpn_time_running']='يجري حساب الفترة الزمنية كلها بمحرك EPANET.';
$ec_lang['lpn_time_no_engine']='يحسب الحلّال المدمج لحظة واحدة في كل مرة، لذا هذه هي الشبكة عند {time} فقط: تحمل الطلبات مضاعِفات نمط تلك اللحظة، ولا يزال كل صهريج عند منسوبه الابتدائي بدلاً من الامتلاء والتفريغ. اتصل بالإنترنت مرة واحدة لجلب محرك EPANET، الذي يشغّل الفترة كاملة.';
