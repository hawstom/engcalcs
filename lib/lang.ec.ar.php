...
$ec_lang['lpn_settings_engine_epanet_tip']='يشغّل حلّال EPANET الأصلي من وكالة حماية البيئة الأمريكية، هنا في متصفحك. يعطي الحلّال المدمج النتائج نفسها وهو أسرع، فاترك هذا الخيار متوقفاً ما لم تحتج إلى EPANET نفسه.';
