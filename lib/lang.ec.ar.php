...
$ec_lang['lpn_time_run_note']='أنت تشاهد الشبكة عند أول وقت إبلاغ. إعداد إعادة الحساب تلقائياً موقوف، فلا تبقى نتائج الأوقات اللاحقة محدَّثة أثناء عملك. اضغط زر احسب لتحديثها.';
