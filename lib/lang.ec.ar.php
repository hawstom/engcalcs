...
$ec_lang['mphl_total_junction_k_tip']='معامل الفواقد الموضعية، k<sub>m</sub>. تحدث هذه الفواقد عند نقاط التقاء الأنابيب، والمداخل، والمخارج، والانحناءات، والصمامات — ويوصف هذا النوع من الفواقد اصطلاحاً بأنه "ثانوي"، وهو وصف مضلل؛ ففي الخط القصير قد تساوي هذه الفواقد فواقد الاحتكاك أو تتجاوزها. القيم النموذجية لمعامل k: مدخل حاد 0.5، كل انحناء بزاوية 45° 0.2–0.3، صمام بوابة (مفتوح بالكامل) 0.1، صمام فراشة 0.2، المخرج (إلى خزان أو إلى الجو) 1.0. اجمع معاملات جميع التجهيزات للحصول على مجموع k<sub>m</sub>. القيمة الافتراضية 2.0 تفترض مدخلاً واحداً، ومخرجاً واحداً، وانحناءين بزاوية 45°.';
...
$ec_lang['mphl_note_1']='<dl><dt>لا تأخذ هذه الحاسبة منسوب الأنبوب بعين الاعتبار.</dt><dd>إذا انخفض خط المتدرج الهيدروليكي عن قمة الأنبوب في أي نقطة، فقد لا يكون هذا الحساب صالحاً.</dd><dt>عند وجود مدخل مفتوح (عبّارة)، يجب التحقق من حالات التحكم عند المدخل.</dt><dd>1. لا يمكن أن يكون خط المتدرج الهيدروليكي المنبع أدنى من ارتفاع الجريان الطبيعي المنبع (ولا أدنى من الأنبوب!).</dd><dd>2. منسوب مياه الداخل للعبارة يُمثَّل بشكل أفضل بخط الطاقة المنبع بدلاً من خط المتدرج الهيدروليكي المنبع.</dd><dd>3. انظر <a target="_blank" href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">درسي القصير مدته دقيقتان</a> لحسابات منسوب مياه الداخل البسيطة للعبارات القياسية باستخدام HY-8.</dd>';
...
$ec_lang['mtc_solve_for_y']='إيجاد العمق، y، عند معرفة Q';
$ec_lang['mtc_solve_desc']='باستخدام b وz<sub>1</sub> وz<sub>2</sub> وS وn من نموذج الحاسبة، يتم إيجاد العمق عند قيمة معينة لـ Q.';
