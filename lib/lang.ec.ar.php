...
$ec_lang['mphl_note_1']='<dl><dt>لا تأخذ هذه الحاسبة منسوب الأنبوب بعين الاعتبار.</dt><dd>إذا انخفض خط المتدرج الهيدروليكي عن قمة الأنبوب في أي نقطة، فقد لا يكون هذا الحساب صالحاً.</dd><dt>عند وجود مدخل مفتوح (عبّارة)، يجب التحقق من حالات التحكم عند المدخل.</dt><dd>1. لا يمكن أن يكون خط المتدرج الهيدروليكي المنبع أدنى من ارتفاع الجريان الطبيعي المنبع (ولا أدنى من الأنبوب!).</dd><dd>2. منسوب مياه الداخل للعبارة يُمثَّل بشكل أفضل بخط الطاقة المنبع بدلاً من خط المتدرج الهيدروليكي المنبع.</dd><dd>3. انظر <a target="_blank" href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">درسي القصير مدته دقيقتان</a> لحسابات منسوب مياه الداخل البسيطة للعبارات القياسية باستخدام <a target="_blank" href="https://www.fhwa.dot.gov/engineering/hydraulics/software/hy8/">HY-8</a>، البرنامج المجاني لتصميم العبّارات من إدارة الطرق السريعة الفيدرالية الأمريكية.</dd><dd>4. تحل هذه الصفحة حالة التحكم عند المصب (المخرج) فقط: أنبوب يجري ممتلئاً بالكامل، حيث تُحدِّد ظروف المصب منسوب المياه. يتطلب تصميم العبّارات تحديد ما إذا كان التحكم يحدث عند المدخل أو عند المخرج، لذا استخدم HY-8 كلما احتمل أن يكون أي منهما هو الحاكم.</dd>';
