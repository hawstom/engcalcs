...
$ec_lang['mphl_note_1']='<dl><dt>عند وجود مدخل مفتوح (عبّارة)، يجب التحقق من حالات التحكم عند المدخل.</dt><dd>1. لا يمكن أن يكون خط المتدرج الهيدروليكي المنبع أدنى من ارتفاع الجريان الطبيعي المنبع (ولا أدنى من الأنبوب!).</dd><dd>2. منسوب مياه الداخل للعبارة يُمثَّل بشكل أفضل بخط الطاقة المنبع بدلاً من خط المتدرج الهيدروليكي المنبع.</dd><dd>3. انظر <a href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">درسي القصير مدته دقيقتان</a> لحسابات منسوب مياه الداخل البسيطة للعبارات القياسية باستخدام HY-8.</dd>';
