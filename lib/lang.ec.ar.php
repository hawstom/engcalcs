...
$ec_lang['irr_card_seepage_desc']='قدِّر فقد التسرب من قطاع قناة باستخدام قياسات التدفق الوارد والصادر. احسب كفاءة النقل والفقد السنوي للمياه للمساعدة في تحديد أولويات استثمارات التبطين.';
