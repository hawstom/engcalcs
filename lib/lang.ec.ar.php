...
$ec_lang['lpn_ex_net3_world_title']='EPANET Net3، جغرافي';
$ec_lang['lpn_ex_net3_world_desc']='نفس شبكة EPANET Net3، لكنها موضوعة في موقع حقيقي: إحداثياتها خط طول وخط عرض، وتُرسم خريطة شوارع خلفها.';
...
$ec_lang['lpn_labels_prefix_id_tip']='نص يُعرض قبل المعرّف على الخريطة. اتركه فارغاً ليظهر المعرّف وحده، بدءاً بالحرف الذي أُعطي له، مثل J1 أو L1.';
...
// --- lpn_ sprint 438: alignment, examples, units-warning, basemap, georef, toolbar tips (batch 1) ---
...
$ec_lang['lpn_units_group_inputs']='وحدات المدخلات';
$ec_lang['lpn_units_group_results']='وحدات النتائج';
...
$ec_lang['lpn_file_import_geo']='التحويل إلى إحداثيات جغرافية…';
...
// --- lpn_ sprint 438: color-by-value, georef placement, bottom panel (batch 2) ---
...
// --- lpn_ sprint 438: find, profile, geo project, .inp export, valves (batch 3) ---
...
$ec_lang['lpn_profile_pick']='أضف عقداً إلى المسار بالنقر عليها على الخريطة';
...
$ec_lang['lpn_new_geo_us']='مشروع جغرافي فارغ، وحدات أمريكية (gpm)';
$ec_lang['lpn_new_geo_si']='مشروع جغرافي فارغ، وحدات النظام الدولي (l/s)';
...
// --- lpn_ sprint 438: extended-period time controls, settings search/sections (batch 4) ---
...
$ec_lang['lpn_settings_sec_elements']='العناصر الجديدة';
