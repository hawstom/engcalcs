...
$ec_lang['lpn_inp_drop_quality']='يصف هذا الملف كيف تتغيّر جودة المياه أثناء انتقالها: ما الموجود في الماء ابتداءً، وأين تدخل المزيد من تلك المادة، وكيف تتفاعل، وكيف تختلط الصهاريج. تحسب هذه الصفحة عمر الماء وتتبع المصدر، لكن ليس الكيمياء، فلا يُستخدم شيء من ذلك هنا. تُحفظ تلك السطور، وتُكتب مرة أخرى إذا حفظت ملف EPANET.';
...
$ec_lang['lpn_tip_select']='استخدم هذا الوضع لتغيير الأشياء على الخريطة وتحريكها وسحبها. تعود الصفحة إلى هذا الوضع من تلقاء نفسها بعد بعض الإجراءات، مثل فتح مشروع.';
...
$ec_lang['lpn_settings_color_thematic_tip']='يخفي تسميات العقد والروابط بحيث تبقى الألوان فقط على الخريطة. يبقى النص الذي وضعته بنفسك. تُحفظ اختيارات تسمياتك، وإيقاف هذا يعيدها.';
...
$ec_lang['lpn_file_import_geo']='فتح ملف xy على الخريطة…';
$ec_lang['lpn_file_import_geo_tip']='يفتح ملف مشروع أو ملف EPANET في تبويب مشروع جديد على هذه الصفحة، على خريطة الشوارع. تضع الرسم على العالم بيدك: حرّك وقرّب إلى الموقع، ثم غيّر حجمه واستدر به ليلائمه. إذا كانت x وy في الملف بالفعل خط طول وخط عرض، اضغط زر هذه بالفعل خط العرض وخط الطول وتقفز الشبكة مباشرة إلى مكانها الصحيح. يبقى كل رقم كتبته كما هو.';
...
$ec_lang['lpn_clean_map_tip']='أزل سطر الحالة وقراءة الإحداثيات عن الخريطة، لتُظهر لقطة الشاشة الرسم فقط. رسمك لا يتأثر، ولا يُحفظ هذا الاختيار؛ تُعيد إعادة تحميل الصفحة القراءات إلى الظهور.';
...
$ec_lang['lpn_time_no_engine']='يحسب الحلّال المدمج لحظة واحدة في كل مرة، لذا هذه هي الشبكة عند {time} فقط: تُقرأ كل الأنماط عند تلك اللحظة، ولا يزال كل صهريج عند منسوبه الابتدائي بدلاً من الامتلاء والتفريغ. اتصل بالإنترنت مرة واحدة لجلب حلّال EPANET، الذي يشغّل الفترة كاملة.';
...
$ec_lang['lpn_time_run_note']='أنت تشاهد الشبكة عند أول وقت إبلاغ. يستغرق حساب هذه الشبكة عبر فترتها الزمنية الكاملة وقتاً طويلاً، فلا تبقى نتائج الأوقات اللاحقة محدَّثة أثناء عملك. اضغط زر احسب لتحديثها.';
...
$ec_lang['lpn_georef_asdegrees']='قُرئت x وy في هذا الملف كخط طول وخط عرض، فالشبكة موجودة بالفعل على الخريطة ولم يتحرك شيء. تحقّق من أنها في المكان الصحيح، ثم اضغط زر احتفظ بهذا الوضع.';
...
$ec_lang['lpn_result_water_age_tip']='المدة التي قضاها الماء الواصل إلى هذه النقطة داخل الشبكة. لا يوجد حدّ تنظيمي تقارن به هذا الرقم، فاحكم عليه وفق شبكتك أنت.';
...
$ec_lang['lpn_new_coords']='الإحداثيات';
$ec_lang['lpn_new_coords_xy']='إحداثيات xy';
$ec_lang['lpn_new_coords_geo']='خط العرض وخط الطول';
$ec_lang['lpn_new_coords_tip']='يستخدم مشروع xy إحداثيات ليست خط عرض وخط طول. أما مشروع خط العرض وخط الطول فله إحداثيات جغرافية، بحيث يمكن رسم خريطة شوارع أو صورة قمر صناعي خلفه وقراءة مناسيب العقد من التضاريس. يمكن تحويل مشروع xy إلى خط العرض وخط الطول عبر الملف، فتح ملف xy على الخريطة.';
$ec_lang['lpn_new_place']='ابدأ بالقرب من هذا المكان';
$ec_lang['lpn_new_place_tip']='اختياري. اكتب اسم مدينة أو شارع أو معلم بارز، ويُفتح المشروع الجديد هناك. تُرسل الكلمات التي تكتبها إلى خدمة أسماء الأماكن في OpenStreetMap، التي تطلب إذنك في المرة الأولى. اتركه فارغاً ليُفتح المشروع على العالم كله.';
$ec_lang['lpn_new_place_hint']='بترالوما، كاليفورنيا';
$ec_lang['lpn_new_create']='إنشاء';
$ec_lang['lpn_inp_drop_rules']='يحتوي هذا الملف على عناصر تحكم قائمة على قواعد. لا تُطبَّق هذه القواعد هنا، فتبقى الأنابيب والمضخات والصمامات التي تسمّيها عند الحالة المكتوبة في الملف. تُحفظ القواعد نفسها، وتُكتب مرة أخرى إذا حفظت ملف EPANET.';
$ec_lang['lpn_inp_drop_energy']='يتضمن ملف EPANET هذا بيانات نمذجة تكلفة الضخ. لا تحسب هذه الصفحة الطاقة أو التكلفة، فلا يُستخدم شيء هنا من تلك الأرقام. تُحفظ، وتُكتب مرة أخرى إذا حفظت ملف EPANET.';
$ec_lang['lpn_inp_drop_tags']='يمنح هذا الملف بعض ملتقياته أو أنابيبه أو عناصره الأخرى وسوماً. لا يوجد في هذه الصفحة بعد مكان لرؤية وسم أو تغييره. تُحفظ الوسوم، وتُكتب مرة أخرى إذا حفظت ملف EPANET.';
$ec_lang['lpn_inp_drop_report']='يحمل هذا الملف إعدادات EPANET الخاصة بالتقارير التي يطبعها. تعرض هذه الصفحة إجاباتها بطريقتها الخاصة، فلا يُستخدم شيء هنا منها. تُحفظ، وتُكتب مرة أخرى إذا حفظت ملف EPANET.';
...
$ec_lang['lpn_inp_drop_quality_options']='يذكر هذا الملف خيارات جودة مياه EPANET: Quality، الذي يسمّي نوع تحليل جودة المياه، وإعدادين يخصان مادة كيميائية، هما الانتشارية النسبية وسماحية الجودة. عمر الماء وتتبع المصدر يُحسبان هنا؛ أما المادة الكيميائية فلا، فيُحفظ هذان الإعدادان دون استخدامهما. تُكتب جميعها مرة أخرى إذا حفظت ملف EPANET.';
...
$ec_lang['lpn_settings_quality_track_tip']='اختر ما يجب أن يتتبعه التشغيل عبر الأنابيب: مدة بقاء الماء في الشبكة، أو من أين جاء. لا يحتاج أي منهما إلى تركيز أو معدل تفاعل.';
...
$ec_lang['lpn_quality_chemical']='مادة كيميائية يسمّيها هذا الملف (محفوظة، غير محسوبة)';
$ec_lang['lpn_quality_needs_run']='تُنقل جودة المياه عبر الأنابيب مع الزمن، لذا تحتاج إلى حلّال EPANET ومدة تشغيل كلية. اضبط مدة التشغيل الكلية تحت الزمن، ثم اضغط زر احسب.';
...
$ec_lang['lpn_ff_menu']='تدفق الحريق…';
...
$ec_lang['lpn_ff_title']='تدفق الحريق';
...
$ec_lang['lpn_ff_required_node_tip']='تدفق الحريق المطلوب عند هذا الملتقى تحديداً، حسب كود الحريق لديك أو جهة الإطفاء لاستخدام الأرض الذي يخدمه. اتركه فارغاً ليُختبر الملتقى مقابل الرقم في مربع تدفق الحريق المطلوب.';
...
$ec_lang['lpn_ff_design_nodes']='كل الملتقيات الأخرى';
