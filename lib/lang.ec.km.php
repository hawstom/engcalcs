...
$ec_lang['lpn_inp_drop_quality']='ឯកសារនេះពិពណ៌នាពីរបៀបដែលគុណភាពទឹកផ្លាស់ប្ដូរនៅពេលវាធ្វើដំណើរ៖ អ្វីមាននៅក្នុងទឹកតាំងពីដើម កន្លែងណាដែលសារធាតុនោះចូលបន្ថែម វារំសាយបែបណា និងធុងទឹកលាយបែបណា។ ទំព័រនេះគណនាអាយុទឹក និងការតាមដានប្រភព ប៉ុន្តែមិនគណនាគីមីវិទ្យាទេ ដូច្នេះគ្មានអ្វីនោះត្រូវបានប្រើនៅទីនេះទេ។ បន្ទាត់ទាំងនោះត្រូវបានរក្សាទុក ហើយត្រូវបានសរសេរត្រឡប់វិញ ប្រសិនបើអ្នករក្សាទុកជាឯកសារ EPANET។';
...
$ec_lang['lpn_tip_select']='ប្រើរបៀបនេះដើម្បីផ្លាស់ប្ដូរ ផ្លាស់ទី និងអូសវត្ថុនៅលើផែនទី។ ទំព័រនេះត្រឡប់ទៅរបៀបនេះដោយខ្លួនឯង បន្ទាប់ពីសកម្មភាពខ្លះ ដូចជាការបើកគម្រោងមួយ។';
...
$ec_lang['lpn_settings_color_thematic_tip']='លាក់ស្លាកថ្នាំង និងតំណ ដូច្នេះនៅសល់តែពណ៌លើផែនទី។ អត្ថបទដែលអ្នកបានដាក់ដោយខ្លួនឯងនៅតែមាន។ ជម្រើសស្លាករបស់អ្នកនៅតែរក្សាទុក ហើយបិទវិញនាំពួកវាត្រឡប់មកវិញ។';
...
$ec_lang['lpn_file_import_geo']='បើកឯកសារ xy នៅលើផែនទី…';
$ec_lang['lpn_file_import_geo_tip']='បើកឯកសារគម្រោង ឬឯកសារ EPANET នៅក្នុងផ្ទាំងគម្រោងថ្មីនៅលើទំព័រនេះ លើផែនទីផ្លូវ។ អ្នកដាក់គំនូរនៅលើពិភពលោកដោយដៃ៖ អូស និងពង្រីក/បង្រួមទៅកន្លែងនោះ រួចប្ដូរទំហំ និងបង្វិលវាឲ្យសមទៅនឹងវា។ ប្រសិនបើ x និង y នៅក្នុងឯកសាររួចហើយជាបណ្ដោយ និងទទឹងភូមិសាស្ត្រ សូមចុចប៊ូតុង តម្លៃទាំងនេះជា lat/lon រួចហើយ ហើយបណ្ដាញនឹងលោតទៅត្រង់កន្លែងដែលវាជាកម្មសិទ្ធិភ្លាមៗ។ រាល់លេខដែលអ្នកបានវាយបញ្ចូល នៅតែដដែល។';
...
$ec_lang['lpn_clean_map_tip']='យកបន្ទាត់របៀប និងការអានកូអរដោនេចេញពីផែនទី ដូច្នេះរូបថតអេក្រង់បង្ហាញតែគំនូរប៉ុណ្ណោះ។ គំនូររបស់អ្នកមិនប៉ះពាល់ទេ ហើយជម្រើសនេះមិនត្រូវបានរក្សាទុកទេ; ផ្ទុកទំព័រឡើងវិញនាំការអានទិន្នន័យត្រឡប់មកវិញ។';
...
$ec_lang['lpn_result_water_age_tip']='តើទឹកដែលមកដល់ចំណុចនេះស្ថិតនៅក្នុងបណ្ដាញអស់រយៈពេលប៉ុន្មាន។ គ្មានដែនកំណត់បទប្បញ្ញត្តិសម្រាប់ប្រៀបធៀបនឹងវាទេ ដូច្នេះសូមវាយតម្លៃលេខនេះធៀបនឹងបណ្ដាញផ្ទាល់ខ្លួនរបស់អ្នក។';
...
$ec_lang['lpn_new_coords']='កូអរដោនេ';
$ec_lang['lpn_new_coords_xy']='កូអរដោនេ xy';
$ec_lang['lpn_new_coords_geo']='lat/lon';
$ec_lang['lpn_new_coords_tip']='គម្រោង xy ប្រើកូអរដោនេដែលមិនមែនជា lat/lon ទេ។ គម្រោង lat/lon មានកូអរដោនេភូមិសាស្ត្រ ដូច្នេះផែនទីផ្លូវ ឬរូបភាពផ្កាយរណបអាចត្រូវបានគូរនៅពីក្រោយវា ហើយកម្ពស់ថ្នាំងអាចអានបានពីផ្ទៃដី។ គម្រោង xy អាចត្រូវបានប្ដូរទៅជា lat/lon ដោយប្រើ ឯកសារ, បំលែងទៅជា lat/lon…។';
$ec_lang['lpn_new_place']='ចាប់ផ្ដើមក្បែរទីកន្លែងនេះ';
$ec_lang['lpn_new_place_tip']='ជាជម្រើស។ វាយបញ្ចូលឈ្មោះទីក្រុង ផ្លូវ ឬចំណុចចំណាំមួយ នោះផែនទីថ្មីនឹងបើកនៅទីនោះ។ ពាក្យដែលអ្នកវាយបញ្ចូលនឹងផ្ញើទៅសេវាកម្មឈ្មោះទីកន្លែងរបស់ OpenStreetMap ដែលនឹងសុំការអនុញ្ញាតពីអ្នកលើកទីមួយ។ ទុកឲ្យទទេ ហើយផែនទីនឹងបើកលើពិភពលោកទាំងមូល។';
$ec_lang['lpn_new_place_hint']='សៀមរាប, កម្ពុជា';
$ec_lang['lpn_new_create']='បង្កើត';
$ec_lang['lpn_inp_drop_rules']='ឯកសារនេះមានការត្រួតពិនិត្យតាមក្បួន។ ក្បួនទាំងនេះមិនត្រូវបានអនុវត្តនៅទីនេះទេ ដូច្នេះបំពង់ ម៉ាស៊ីនបូម និងវ៉ាល់ដែលពួកវាដាក់ឈ្មោះ នៅតែស្ថិតក្នុងស្ថានភាពដែលបានសរសេរក្នុងឯកសារ។ ក្បួនខ្លួនឯងត្រូវបានរក្សាទុក ហើយត្រូវបានសរសេរត្រឡប់វិញ ប្រសិនបើអ្នករក្សាទុកជាឯកសារ EPANET។';
$ec_lang['lpn_inp_drop_energy']='ឯកសារ EPANET នេះមានទិន្នន័យគំរូចំណាយថាមពលបូម។ ទំព័រនេះមិនគណនាថាមពល ឬចំណាយទេ ដូច្នេះគ្មានអ្វីនៅទីនេះប្រើលេខទាំងនោះទេ។ ពួកវាត្រូវបានរក្សាទុក ហើយត្រូវបានសរសេរត្រឡប់វិញ ប្រសិនបើអ្នករក្សាទុកជាឯកសារ EPANET។';
$ec_lang['lpn_inp_drop_tags']='ឯកសារនេះដាក់ស្លាកសម្គាល់ទៅថ្នាំង បំពង់ ឬធាតុផ្សេងទៀតរបស់វាមួយចំនួន។ គ្មានកន្លែងនៅលើទំព័រនេះសម្រាប់មើល ឬប្ដូរស្លាកសម្គាល់នៅឡើយទេ។ ស្លាកសម្គាល់ត្រូវបានរក្សាទុក ហើយត្រូវបានសរសេរត្រឡប់វិញ ប្រសិនបើអ្នករក្សាទុកជាឯកសារ EPANET។';
$ec_lang['lpn_inp_drop_report']='ឯកសារនេះផ្ទុកការកំណត់ផ្ទាល់ខ្លួនរបស់ EPANET សម្រាប់របាយការណ៍ដែលវាបោះពុម្ព។ ទំព័រនេះបង្ហាញចម្លើយរបស់ខ្លួនតាមរបៀបផ្ទាល់ខ្លួន ដូច្នេះគ្មានអ្វីនៅទីនេះប្រើវាទេ។ ពួកវាត្រូវបានរក្សាទុក ហើយត្រូវបានសរសេរត្រឡប់វិញ ប្រសិនបើអ្នករក្សាទុកជាឯកសារ EPANET។';
...
$ec_lang['lpn_inp_drop_quality_options']='ឯកសារនេះចែងជម្រើសគុណភាពទឹករបស់ EPANET៖ Quality ដែលកំណត់ប្រភេទនៃការវិភាគគុណភាពទឹក និងការកំណត់ពីរដែលទាក់ទងនឹងសារធាតុគីមី គឺ Relative diffusivity និង Quality tolerance។ អាយុទឹក និងការតាមដានប្រភព ត្រូវបានគណនានៅទីនេះ សារធាតុគីមីមិនត្រូវបានគណនាទេ ដូច្នេះការកំណត់ទាំងពីរនោះត្រូវបានរក្សាទុកដោយមិនប្រើ។ ទាំងអស់នេះត្រូវបានសរសេរត្រឡប់វិញ ប្រសិនបើអ្នករក្សាទុកជាឯកសារ EPANET។';
...
$ec_lang['lpn_settings_quality_track_tip']='ជ្រើសរើសអ្វីដែលការដំណើរការគួរតាមដានតាមបំពង់៖ រយៈពេលប៉ុន្មានដែលទឹកបាននៅក្នុងប្រព័ន្ធ ឬវាមកពីណា។ ទាំងពីរមិនត្រូវការកំហាប់ ឬអត្រាប្រតិកម្មទេ។';
...
$ec_lang['lpn_quality_chemical']='សារធាតុគីមីមួយដែលឯកសារនេះដាក់ឈ្មោះ (បានរក្សាទុក មិនបានគណនា)';
$ec_lang['lpn_quality_needs_run']='គុណភាពទឹកត្រូវបានផ្ទុកតាមបំពង់ឆ្លងកាត់ពេលវេលា ដូច្នេះវាត្រូវការឧបករណ៍ដោះស្រាយ EPANET និងរយៈពេលដំណើរការសរុប។ កំណត់ រយៈពេលដំណើរការសរុប នៅក្រោម ពេលវេលា រួចចុច ដំណើរការ។';
...
$ec_lang['lpn_ff_menu']='លំហូរពន្លត់អគ្គីភ័យ…';
...
$ec_lang['lpn_ff_title']='លំហូរពន្លត់អគ្គីភ័យ';
...
$ec_lang['lpn_ff_required_node_tip']='លំហូរពន្លត់អគ្គីភ័យដែលត្រូវការនៅថ្នាំងជាក់លាក់នេះ ពីក្រម ឬអាជ្ញាធរពន្លត់អគ្គីភ័យរបស់អ្នក សម្រាប់ការប្រើប្រាស់ដីដែលវាបម្រើ។ ទុកវាទទេ ហើយថ្នាំងនេះនឹងត្រូវបានធ្វើតេស្តធៀបនឹងលេខនៅក្នុងប្រអប់ លំហូរពន្លត់អគ្គីភ័យដែលត្រូវការ។';
...
$ec_lang['lpn_ff_design_nodes']='ថ្នាំងផ្សេងទៀតទាំងអស់';
