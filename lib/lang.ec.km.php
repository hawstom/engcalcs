...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="កម្ពស់ភាពរញ៉េរញ៉ៃ Darcy-Weisbach"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_km']='<span class="ec-help" title="ផលបូក សម្ប្រាក k ការបាត់បង់ junction និង fitting ទាំងអស់នៅតាម penstock">សម្ប្រាក k ការបាត់បង់ minor, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s សម្រាប់ទឹកស្អាតនៅជិត 20°C">ភាពខាប់ស៊ីណេម៉ាទិក, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="ថ្មកិនក្រានីត ឬបាសាល់ធម្មតា ≈ 2.65។ ជួរត្រឹមត្រូវតាម Robinson: 2.54 ដល់ 2.82។">ទំងន់ចំពោះថ្ម, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_km']='<span class="ec-help" title="មេគុណបាត់បង់មូលដ្ឋានសរុបសម្រាប់គ្រឿងតភ្ជាប់/សន្ទះបិទបើក/ក្បាលតបំពង់នៃចម្រៀកនេះ (អប្បបរមាដែលណែនាំ &ge;0.5)">k<sub>m</sub> <span class="ec-tip">?</span></span>';
