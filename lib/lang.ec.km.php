...
$ec_lang['bpn_topology_warn']='សូមពិនិត្យជួរឈរ ID ខាងលើ: ខ្សែបំពង់មួយចង្អុលទៅ ID ដែលមិនស្គាល់ ចង្អុលទៅខ្លួនឯង ឬបង្កើតជារង្វិលបិទ ដូច្នេះផ្នែកខ្លះនៃបណ្ដាញមិនបានភ្ជាប់ជាមួយប្រភពទេ។ ខ្សែបំពង់ទាំងនោះមិនត្រូវបានដោះស្រាយឡើយ។';
$ec_lang['bpn_topology_warn_short']='បណ្ដាញ';
...
$ec_lang['lpn_new_blank_us']='គម្រោង XY ទទេ ខ្នាតវាស់ US (gpm)';
$ec_lang['lpn_new_blank_si']='គម្រោង XY ទទេ ខ្នាតវាស់ SI (l/s)';
...
$ec_lang['lpn_inp_drop_patterns']='លំនាំតម្រូវការត្រូវបានលុបចោល ព្រោះផ្នែកនៃទំព័រនេះដែលដំណើរការបណ្ដាញឆ្លងកាត់ពេលវេលា មិនបានផ្ទុកឡើយ។ តម្រូវការនីមួយៗគឺជាលេខដែលសរសេរនៅក្នុងឯកសារ។';
...
$ec_lang['lpn_inp_drop_eps']='ឯកសារនេះពិពណ៌នាការក្លែងធ្វើដែលដំណើរការលើរយៈពេលមួយ។ ផ្នែកនៃទំព័រនេះដែលដំណើរការបណ្ដាញឆ្លងកាត់ពេលវេលា មិនបានផ្ទុកឡើយ ដូច្នេះមានតែលក្ខខណ្ឌចាប់ផ្ដើមប៉ុណ្ណោះដែលចូលមក។';
...
$ec_lang['lpn_notes_1_def']='ដោះស្រាយសំណុំតម្រូវការមួយក្នុងពេលតែមួយ ដោយប្រើក្បួនដោះស្រាយជម្រាលសកលដូចគ្នានឹង EPANET ប្រើដែរ។ វាមិនធ្វើគំរូពីរបៀបដែលបណ្ដាញផ្លាស់ប្ដូរតាមពេលវេលាទេ។ ធុងទឹកមួយត្រូវបានរក្សាឲ្យនៅកម្រិតទឹកដែលអ្នកបានផ្ដល់៖ ក្នុងដំណោះស្រាយតែមួយ វាមិនដែលរីងស្ងួត ហើយក៏មិនដែលពេញដែរ។';
$ec_lang['lpn_notes_2_term']='មិនធ្វើគំរូ';
$ec_lang['lpn_notes_2_def']='គុណភាពទឹក និងតម្រូវការដែលផ្លាស់ប្ដូរពេញមួយថ្ងៃ មិនត្រូវបានធ្វើគំរូទេ។ ចំពោះវ៉ាល់៖ វ៉ាល់ត្រួតពិនិត្យរបាំងលំហូរដំណើរការនៅក្នុងឧបករណ៍ដោះស្រាយណាមួយ ចំណែកឯវ៉ាល់ដែលបើក និងបិទដោយខ្លួនឯង (PRV, PSV, FCV) ត្រូវបានដោះស្រាយដោយឧបករណ៍ដោះស្រាយ EPANET ដែលទំព័រនេះបើកដោយខ្លួនឯង នៅពេលបណ្ដាញរបស់អ្នកមានវ៉ាល់ប្រភេទនេះ។';
...
$ec_lang['lpn_pump_point1']='ចំណុច ១';
$ec_lang['lpn_pump_point2']='ចំណុច ២';
$ec_lang['lpn_pump_point3']='ចំណុច ៣';
...
$ec_lang['lpn_labels_mark_extrema_tip']='គូរបន្ទាត់មួយពីលើតម្លៃខ្ពស់បំផុតនៃប្រភេទនីមួយៗលើផែនទី និងបន្ទាត់មួយពីក្រោមតម្លៃទាបបំផុតនៃប្រភេទនោះ ដើម្បីឲ្យអ្នកអាចរកឃើញចំណុចទាំងពីរ ដោយមិនចាំបាច់អានលេខ។';
...
$ec_lang['lpn_inp_drop_tank_curve']='ធុងទឹកទាំងនេះមិនមានជញ្ជាំងត្រង់ទេ៖ ឯកសារផ្ដល់រូបរាងរបស់វាជាខ្សែកោង។ វាចូលមកជាធុងទឹកមូល ដោយនីមួយៗមានអង្កត់ផ្ចិតសរសេរនៅក្នុងឯកសារ។ ផ្ទៃទឹកនៅតែជាកម្រិតដែលឯកសារកំណត់ ដូច្នេះចម្លើយត្រូវគ្នា មានតែរូបរាងប៉ុណ្ណោះដែលត្រូវបានធ្វើឲ្យសាមញ្ញ។';
...
$ec_lang['lpn_mode_add_valve']='របៀប៖ បន្ថែមវ៉ាល់។ ចុចលើថ្នាំងមួយ បន្ទាប់មកថ្នាំងមួយទៀត ដើម្បីភ្ជាប់ពួកវា។ ប្ដូរទៅរបៀបជ្រើសរើសដើម្បីផ្លាស់ប្ដូរ ឬផ្លាស់ទីធាតុ និងស្លាក។';
...
$ec_lang['lpn_scenario_overrides']='តម្លៃផ្ទាល់ខ្លួន';
...
$ec_lang['lpn_ex_net3_world_desc']='បណ្ដាញដូចគ្នានឹង EPANET Net3 ប៉ុន្តែដាក់ក្នុងទីតាំងពិត៖ កូអរដោនេរបស់វាគឺបណ្ដោយ និងទទឹង ហើយមានផែនទីផ្លូវគូរនៅពីក្រោយ។';
...
$ec_lang['lpn_labels_prefix_id_tip']='អត្ថបទបង្ហាញនៅមុនលេខសម្គាល់លើផែនទី។ ទុកវាទទេ ហើយលេខសម្គាល់នឹងបង្ហាញដោយខ្លួនឯង ចាប់ផ្ដើមដោយអក្សរដែលបានផ្ដល់ឲ្យវា ដូចជា J1 ឬ L1។';
...
$ec_lang['lpn_labels_priority_node_tip']='អាទិភាពសម្រាប់សម្រេចថាស្លាកណាមួយត្រូវលុបចោលមុនគេ នៅពេលផែនទីមានភាពកកកុញ៖ តម្រូវការទាបបំផុត សម្ពាធនៅជិតកណ្ដាលជួរបំផុត ឬកម្ពស់ ឬថ្ពល់ដែលនៅជិតនឹងថ្នាំងជិតខាងបំផុត។ លេខ 1 សម្រេចមុនគេ។';
...
$ec_lang['lpn_settings_colors']='ដាក់ពណ៌តាមតម្លៃ';
...
$ec_lang['lpn_settings_color_thematic']='ផែនទីតាមប្រធានបទ៖ មានតែពណ៌ គ្មានស្លាក';
...
$ec_lang['lpn_units_warn_body']='{unit} ជាឯកតារបស់អ្វីដែលអ្នកបញ្ចូលសម្រាប់៖ {list}។ បកន័យឡើងវិញ ទុកលេខទាំងអស់ដដែល ហើយអានវាតាមឯកតាថ្មី។ បំលែងទាំងអស់ សរសេរលេខទាំងនោះឡើងវិញម្នាក់ៗ ដូច្នេះបណ្ដាញនៅគ្របដណ្ដប់ទំហំដដែលដូចមុន។';
$ec_lang['lpn_units_reinterpret']='បកន័យឡើងវិញ (ប្ដូរអត្ថន័យលេខ)';
$ec_lang['lpn_units_convert']='បំលែងទាំងអស់';
...
$ec_lang['lpn_units_group_inputs']='ឯកតាបញ្ចូល';
$ec_lang['lpn_units_group_results']='ឯកតាលទ្ធផល';
$ec_lang['lpn_basemap_show']='បង្ហាញផែនទីផ្លូវ';
$ec_lang['lpn_basemap_hide']='លាក់ផែនទីផ្លូវ';
$ec_lang['lpn_basemap_tip']='រូបភាពផែនទីផ្លូវពី OpenStreetMap ទាញយកតាមអ៊ីនធឺណិត នៅពេលអ្នកអូស និងពង្រីក/បង្រួម។ បណ្ដាញរបស់អ្នកនៅតែបង្ហាញ ទោះជាផែនទីផ្លូវកំពុងបង្ហាញឬអត់ក៏ដោយ។';
$ec_lang['lpn_geomap']='lat/lon';
$ec_lang['lpn_xymap']='XY';
$ec_lang['lpn_georef_menu']='បំលែងទៅជា lat/lon…';
$ec_lang['lpn_georef_tip']='ពីក្រឡាចត្រង្គមូលដ្ឋានទៅជាកូអរដោនេពិភពលោកពិត។ យកគំនូរដែលបានគូរនៅលើក្រឡាចត្រង្គ XY ដាក់ទៅលើកូអរដោនេភូមិសាស្ត្រ ដូច្នេះវាស្ថិតនៅលើផែនទីផ្លូវត្រូវកន្លែងរបស់វា។ រាល់លេខដែលអ្នកបានវាយ នៅតែដដែល — មានតែ X និង Y ប៉ុណ្ណោះក្លាយទៅជាបណ្ដោយ និងទទឹង។';
$ec_lang['lpn_georef_intro']='បំលែងគម្រោង XY នេះទៅជាគម្រោងភូមិសាស្ត្រឬ? គម្រោងរបស់អ្នកត្រូវបានដាក់នៅចំកណ្ដាលផែនទីពិភពលោក។ ពង្រីក/បង្រួមទៅកន្លែងរបស់អ្នក រួចផ្លាស់ទី ប្ដូរទំហំ និងបង្វិលគំរូតាមចិត្តអ្នក។ នៅពេលអ្នករួចរាល់ចាប់ផ្ដើមកែសម្រួលធាតុនីមួយៗ សូមចុច រក្សាទីតាំងនេះ។';
$ec_lang['lpn_georef_adjust']='អូសគំរូដើម្បីផ្លាស់ទីវា អូសជ្រុងដើម្បីប្ដូរទំហំវា អូសដងតូចមូលនៅខាងលើគំរូដើម្បីបង្វិលវា។ ឬវាយមាត្រដ្ឋាន និងមុំបង្វិលនៅខាងក្រោម។';
$ec_lang['lpn_georef_step1']='ជំហានទី ១ នៃ ២ — មិនទាន់ភ្ជាប់';
$ec_lang['lpn_georef_step2']='ជំហានទី ២ នៃ ២ — បានភ្ជាប់';
...
$ec_lang['lpn_tool_add_tank_tip']='ចុចលើផែនទីដើម្បីបន្ថែមធុងទឹក៖ ធុងស្តុកទឹកមួយដែលមានផ្ទៃទឹកឡើងចុះ ដែលអ្នកកំណត់។';
...
$ec_lang['lpn_find_menu_tip']='រកផ្នែកមួយតាមលេខសម្គាល់របស់វា ឬរកគ្រប់ផ្នែកដែលត្រូវនឹងលក្ខខណ្ឌមួយ។';
...
$ec_lang['lpn_color_ranges_note']='របៀបខាងលើកំណត់ព្រំដែនទាំងនេះ ពីតម្លៃដែលមាននៅលើផែនទីឥឡូវនេះ។ វាយជាន់លើពួកវា ហើយលេខដូចគ្នានឹងតំណាងឲ្យពណ៌ដូចគ្នាជានិច្ច។';
...
$ec_lang['lpn_georef_on_map']='គម្រោងនេះស្ថិតនៅលើ lat/lon រួចហើយ។';
$ec_lang['lpn_georef_empty']='សូមគូរ ឬបើកបណ្ដាញជាមុនសិន។ មិនទាន់មានអ្វីត្រូវដាក់នៅឡើយទេ។';
...
$ec_lang['lpn_pane_toggle_tip']='បង្ហាញ ឬលាក់ផ្ទាំងនៅខាងក្រោមផែនទី។ វាមានទម្រង់បណ្ដោយ និងតារាងថ្នាំង។';
$ec_lang['lpn_pane_resize']='អូសដើម្បីធ្វើឲ្យផ្ទាំងខ្ពស់ ឬទាបជាង';
$ec_lang['lpn_pane_tab_junctions']='ថ្នាំង';
$ec_lang['lpn_pane_tab_junctions_tip']='ថ្នាំងទាំងអស់ជាតារាងមួយដែលអ្នកអាចតម្រៀប និងកែសម្រួល។';
$ec_lang['lpn_pane_junctions_none']='បណ្ដាញនេះមិនទាន់មានថ្នាំងនៅឡើយទេ។';
$ec_lang['lpn_pane_sort_tip']='តម្រៀបតាមជួរឈរនេះ។ ចុចម្ដងទៀតដើម្បីបញ្ច្រាស។';
$ec_lang['lpn_clean_map']='លាក់ការអានទិន្នន័យលើផែនទី';
$ec_lang['lpn_clean_map_off']='បង្ហាញការអានទិន្នន័យលើផែនទី';
$ec_lang['lpn_clean_map_tip']='លាក់បន្ទាត់របៀប និងការអានកូអរដោនេ ដូច្នេះរូបថតអេក្រង់បង្ហាញតែផែនទីប៉ុណ្ណោះ។ គំនូររបស់អ្នកមិនប៉ះពាល់ទេ ហើយជម្រើសនេះមិនត្រូវបានរក្សាទុកទេ — ផ្ទុកទំព័រឡើងវិញនាំការអានទិន្នន័យត្រឡប់មកវិញ។';
$ec_lang['lpn_find_menu']='រក';
$ec_lang['lpn_find_title']='រកធាតុ';
...
$ec_lang['lpn_new_geo_us']='គម្រោង lat/lon ទទេ ខ្នាតវាស់ US (gpm)';
$ec_lang['lpn_new_geo_si']='គម្រោង lat/lon ទទេ ខ្នាតវាស់ SI (l/s)';
...
$ec_lang['lpn_inp_drop_demand_pattern']='ថ្នាំងទាំងនេះផ្លាស់ប្ដូរតម្រូវការរបស់ពួកវាពេញមួយថ្ងៃ។ លំនាំរបស់ពួកវាចូលមកទាំងស្រុង ហើយតម្រូវការដែលអ្នកឃើញ គឺជាតម្លៃសម្រាប់ពេលវេលាដែលនាឡិកាកំពុងបង្ហាញ។';
...
$ec_lang['lpn_inp_drop_gpv_curve']='វ៉ាល់នេះកំណត់ឈ្មោះខ្សែកោងការបាត់បង់ថ្ពល់មួយ ដែលមិននៅក្នុងឯកសារទេ។ វ៉ាល់នេះចូលមក ដោយគ្មានខ្សែកោង ដូច្នេះវានៅតែបើកពេញ រហូតដល់អ្នកផ្ដល់វាមួយ។';
$ec_lang['lpn_gpv_curve_note']='រហូតដល់បីចំណុចនៃលំហូរ និងការបាត់បង់ថ្ពល់នៅលំហូរនោះ។ ទុកពួកវាទទេ ហើយវ៉ាល់នៅតែបើកពេញ។';
...
$ec_lang['lpn_time_no_engine']='ឧបករណ៍ដោះស្រាយខាងក្នុងគណនាតែមួយភ្លែតម្ដងៗ ដូច្នេះនេះជាបណ្ដាញនៅ {time} ប៉ុណ្ណោះ៖ តម្រូវការទាំងអស់ផ្ទុកតម្គុណលំនាំនៃភ្លែតនោះ ហើយធុងទឹកនីមួយៗនៅតែជាប់នឹងកម្រិតចាប់ផ្ដើមរបស់វា ជំនួសឲ្យការបំពេញ និងបង្ហូរ។ ភ្ជាប់អ៊ីនធឺណិតម្ដង ដើម្បីទាញយកឧបករណ៍ដោះស្រាយ EPANET ដែលដំណើរការពេញមួយរយៈពេល។';
$ec_lang['lpn_time_slider']='ពេលវេលា';
$ec_lang['lpn_time_no_period']='គម្រោងនេះមិនមានរយៈពេលទេ ដូច្នេះមានតែភ្លែតមួយប៉ុណ្ណោះដែលត្រូវបង្ហាញ។ កំណត់ រយៈពេលដំណើរការសរុប នៅក្នុងការកំណត់ ដើម្បីគណនាបណ្ដាញនេះឲ្យឃើញការប្រែប្រួលតាមពេលវេលា។';
...
$ec_lang['lpn_time_run_tip']='គណនាបណ្ដាញនេះនៅរាល់ពេលរាយការណ៍របស់វា ចាប់ពីដំបូងរហូតដល់ចុងក្រោយ។';
$ec_lang['lpn_time_run_note']='អ្នកកំពុងឃើញបណ្ដាញនៅពេលរាយការណ៍ដំបូង។ បណ្ដាញនេះចំណាយពេលយូរពេកក្នុងការគណនាពេញមួយរយៈពេលរបស់វា ដូច្នេះលទ្ធផលសម្រាប់ពេលក្រោយៗមិនត្រូវបានធ្វើឲ្យទាន់សម័យ ខណៈពេលអ្នកកំពុងធ្វើការទេ។ ចុច ដំណើរការ ដើម្បីធ្វើឲ្យលទ្ធផលទាំងនោះទាន់សម័យ។';
...
$ec_lang['lpn_settings_sec_visualization']='ការមើលឃើញទិន្នន័យ';
$ec_lang['lpn_settings_sec_map']='ផែនទី និងទំព័រ';
$ec_lang['lpn_settings_sec_elements']='ធាតុថ្មី';
$ec_lang['lpn_settings_sec_calculation']='ការគណនា';
$ec_lang['lpn_settings_node_symbology']='និមិត្តសញ្ញាថ្នាំង';
$ec_lang['lpn_settings_link_symbology']='និមិត្តសញ្ញាតំណ';
...
$ec_lang['lpn_settings_node_link']='ថ្នាំង និងតំណ';
