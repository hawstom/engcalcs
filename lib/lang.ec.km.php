...
$ec_lang['mhp_main_title']='ម៉ាស៊ីនគណនាថាមពល Micro-Hydro លើអនឡាញ ឥតគិតថ្លៃ';
$ec_lang['mhp_main_desc']='ម៉ាស៊ីនគណនាផលិតថាមពល Micro-Hydro ថាមពលទឹករត់ (Run-of-River)';
$ec_lang['mhp_flow']='លំហូរ, Q';
$ec_lang['mhp_gross_head']='ក្បាលទឹកសរុប, H<sub>gross</sub>';
$ec_lang['mhp_diameter']='អង្កត់ផ្ចិតបំពង់សម្ពាធ, D';
$ec_lang['mhp_length']='ប្រវែង, L <span title="ប្រវែងបំពង់ ឬប្រឡាយបញ្ជូនទឹកពីរចនាសម្ព័ន្ធទទួលទឹក" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_ok']='ក្នុងគោលដៅ 10%';
$ec_lang['mhp_hl_warn']='លើសគោលដៅ 10%';
$ec_lang['mhp_hl_warn_tip']='ពិចារណាប្រើបំពង់ធំជាង';
$ec_lang['mhp_hl_bad']='លើស 20%';
$ec_lang['mhp_hl_bad_tip']='ប្តូរទំហំបំពង់';
...
$ec_lang['mhp_notes_4_term']='ការបាត់បង់មូលដ្ឋាន, k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='ការបាត់បង់ទាំងនេះកើតឡើងនៅចំណុចតភ្ជាប់បំពង់ ច្រកចូល ការបត់ និងវ៉ាល់ — ពាក្យ “មូលដ្ឋាន” (minor) ជាទម្លាប់ប៉ុន្តែអាចនាំឲ្យយល់ច្រឡំ; ក្នុងបំពង់សម្ពាធខ្លី វាអាចស្មើ ឬលើសការបាត់បង់ដោយកកិត។ តម្លៃ k ធម្មតា: ច្រកចូលមុតស្រួច 0.5, ការបត់ 45° នីមួយៗ 0.2–0.3, វ៉ាល់ច្រកទ្វារ (បើកពេញ) 0.1, វ៉ាល់ស្លាបយោង 0.2។ បូកសរុបគ្រឿងផ្សំបំពង់ទាំងអស់ដើម្បីទទួលបាន k<sub>m</sub> សរុប។ លំនាំដើម 1.5 សន្មតថាមានច្រកចូលមួយ និងការបត់ពីរ។';
$ec_lang['mhp_notes_5_term']='ភាពរដុបបំពង់ e';
$ec_lang['mhp_notes_5_def']='ភាពរដុបដាច់ខាតធម្មតា៖ ដែក (ថ្មី) 0.046 mm, ដែក (ប្រើហើយ) 0.15 mm, HDPE 0.003 mm, PVC/uPVC 0.0015 mm, បេតុង 0.3–3 mm។ HDPE ត្រូវបានប្រើជាទូទៅសម្រាប់បំពង់សម្ពាធ Micro-Hydro តូចៗ។';
$ec_lang['mhp_notes_6_term']='ប្រសិទ្ធភាព';
$ec_lang['mhp_notes_6_def']='ប្រសិទ្ធភាពរោងចក្រធម្មតា η ស្ថិតចន្លោះ 0.70 ដល់ 0.85 សម្រាប់ទួរប៊ីនប្រភេទ Pelton និង cross-flow ដែលប្រើជាទូទៅក្នុងប្រព័ន្ធ Micro-Hydro។ ប្រើ 0.75 ជាការប៉ាន់ស្មានដំបូងបែបប្រុងប្រយ័ត្ន។';
...
$ec_lang['rc_qt']='ចំណុះប្រតិបត្តិការក្នុងមួយអង្គងសរុប, q<sub>t</sub> <span title="លំហូរក្នុងមួយឯកតាទទឹងនៅច្រកចូលប្រឡាយថ្មជម្រាល។ សម្រាប់ប្រឡាយដែលមានទទឹងបាត B និងលំហូរសរុប Q ប្រើ q_t = Q / B។" class="ec-tip">?</span>';
$ec_lang['rc_np']='ភាពប្រហោងថ្មការពារ, n<sub>p</sub>';
$ec_lang['rc_sg']='ទំងន់ចំពោះថ្ម, sg <span title="ថ្មកិនក្រានីត ឬបាសាល់ធម្មតា ≈ 2.65។ ជួរត្រឹមត្រូវតាម Robinson: 2.54 ដល់ 2.82។" class="ec-tip">?</span>';
$ec_lang['rc_SD']='ការចាត់ថ្នាក់ទំហំថ្ម SD = D<sub>84.1</sub>/D<sub>50</sub> <span title="គម្លាតស្តង់ដារនៃការចាត់ថ្នាក់ទំហំថ្ម។ ថ្មសមភាព ≈ 1.25។ ជួរត្រឹមត្រូវតាម Robinson: 1.15 ដល់ 1.47។" class="ec-tip">?</span>';
$ec_lang['rc_yn']='ជម្រៅធម្មតានៅក្នុងប្រឡាយច្រកចូល, y<sub>n</sub> <span title="ទឹកដាំង (Hp > yn) ជាការល្អ — កាត់បន្ថយការហូរច្រោះខាងលើ។ (USDA)" class="ec-tip">?</span>';
$ec_lang['rc_D50']='ទំហំថ្មមធ្យមដែលត្រូវការ, D<sub>50</sub> <span title="សមីការ 1 (S0 < 0.10) ឬសមីការ 2 (0.10-0.40)។ ជួរត្រឹមត្រូវ: D50 15-278 mm, S0 0.02-0.40។ ក្រៅជួរ: ជាតម្លៃប៉ាន់ស្មានពីក្រៅជួរ។" class="ec-tip">?</span>';
...
$ec_lang['rc_apron_length']='ប្រវែងបន្ទះការពារច្រកចេញ (15 × D<sub>50</sub>) <span title="ត្រូវការសម្រាប់ការទ្រទ្រង់រចនាសម្ព័ន្ធនៃថ្មនៅច្រក។ &quot;ទឹកខាងក្រោមអប្បបរមាដែលកើតឡើងដោយសារតែផលនៃចម្រៀកច្រកចេញ និងភាពទប់ទល់នៃប្រឡាយខាងក្រោម គឺគ្រប់គ្រាន់ដើម្បីធានាស្ថិរភាពនៃថ្មការពារនៅចម្រៀកច្រកចេញ។&quot; (Robinson)" class="ec-tip">?</span>';
$ec_lang['rc_n_chute']='ភាពរដុប Manning ក្នុងច្រក, n';
$ec_lang['rc_Vm']='ល្បឿនហូរកាត់ស្រទាប់ថ្មការពារ, V<sub>m</sub> <span title="ចំណែកនៃ qt ដែលហូរកាត់ប្រហោងថ្ម។ ចំណែកនៅសល់ qs ហូរនៅលើផ្ទៃ។ np លំនាំដើម = 0.45 សម្រាប់ថ្មកិនជ្រួញកែងជ្រុង។" class="ec-tip">?</span>';
...
$ec_lang['rc_Hp']='ក្បាលទឹកស្ទីងច្រកចូល, H<sub>p</sub> <span title="ទឹកដាំងខាងលើ (Hp > yn) ជាការល្អ — កាត់បន្ថយការហូរច្រោះខាងលើ។ (USDA)" class="ec-tip">?</span>';
