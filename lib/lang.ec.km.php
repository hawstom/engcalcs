...
$ec_lang['lpn_settings_sec_assets']='ធាតុថ្មី';
...
$ec_lang['lpn_basemap_satellite_hide']='លាក់រូបភាពផ្កាយរណប';
$ec_lang['lpn_basemap_satellite_tip']='រូបថតដីពី Mapbox ទាញយកតាមអ៊ីនធឺណិត ខណៈអ្នកអូស និងពង្រីក/បង្រួម។ មានប្រយោជន៍សម្រាប់មើលថាបំពង់មួយពិតជាដើរកន្លែងណា។ បណ្ដាញរបស់អ្នកនៅតែបង្ហាញ ទោះជារូបភាពកំពុងបង្ហាញឬអត់ក៏ដោយ។';
$ec_lang['lpn_georef_asdeg_btn']='តម្លៃទាំងនេះជា lon/lat រួចហើយ';
$ec_lang['lpn_georef_asdeg_tip']='ចុចប៊ូតុងនេះលុះត្រាតែ x និង y នៅក្នុងឯកសារនេះពិតជាបណ្ដោយ និងទទឹងភូមិសាស្ត្រ។ បណ្ដាញនោះនឹងលោតទៅកន្លែងដែលលេខទាំងនោះចង្អុលបង្ហាញ ហើយគ្មានអ្វីត្រូវដាក់ទីតាំងទៀតទេ។ លេខនីមួយៗនៅតែដដែលមិនថាបែបណាទេ។';
$ec_lang['lpn_georef_asdegrees']='x និង y នៅក្នុងឯកសារនេះត្រូវបានអានជាបណ្ដោយ និងទទឹងភូមិសាស្ត្រ ដូច្នេះបណ្ដាញនោះស្ថិតនៅលើផែនទីរួចហើយ ហើយគ្មានអ្វីត្រូវបានផ្លាស់ទីទេ។ សូមពិនិត្យមើលថាតើវានៅត្រឹមត្រូវទីតាំងឬអត់ រួចចុច រក្សាទុកទីតាំងនេះ។';
...
$ec_lang['lpn_menu_project']='គម្រោង';
...
$ec_lang['lpn_replace_button']='ជំនួស';
...
$ec_lang['lpn_inp_drop_head_pattern']='អាងស្តុកទាំងនេះឡើង និងចុះកម្រិតទឹកពេញមួយថ្ងៃ។ លំនាំរបស់ពួកវាបានចូលមកគ្រប់ជ្រុងជ្រោយ ហើយកម្រិតទឹកដែលអ្នកឃើញគឺជាកម្រិតសម្រាប់ភ្លែតដែលនាឡិកាកំពុងបង្ហាញ។';
$ec_lang['lpn_inp_drop_pump_speed']='ម៉ាស៊ីនបូមទាំងនេះដំណើរការក្នុងល្បឿនផ្សេងពីល្បឿនដែលខ្សែកោងរបស់វាត្រូវបានវាស់ ឬប្ដូរល្បឿនពេញមួយថ្ងៃ។ ល្បឿន និងលំនាំរបស់វាបានចូលមកគ្រប់ជ្រុងជ្រោយ ហើយកម្ពស់ដែលអ្នកឃើញគឺជាកម្ពស់សម្រាប់ភ្លែតដែលនាឡិកាកំពុងបង្ហាញ។';
...
$ec_lang['lpn_import_notes_heading']='ពីឯកសារ EPANET';
...
$ec_lang['lpn_library_curves_tip']='ខ្សែកោងគឺជាចំណុចដែលប្រាប់ពីរបៀបដែលម៉ាស៊ីនបូមធ្វើការ៖ តើវាបង្កើតកម្ពស់ប៉ុន្មាននៅលំហូរនីមួយៗ។';
$ec_lang['lpn_library_curves_note']='ខ្សែកោងមួយជារបស់ម៉ាស៊ីនបូម ឬវ៉ាល់ដែលប្រើវា ដូច្នេះទីនេះជាសំណុំទាំងមូលនៅកន្លែងតែមួយសម្រាប់អាន។ ចុចលើ ID ដើម្បីទៅកាន់ធាតុនោះ ហើយប្ដូរចំណុចរបស់វានៅទីនោះ។ សម្រាប់ម៉ាស៊ីនបូម បន្ទាត់ដែលបានគូរជាខ្សែកោងដែលការដំណើរការប្រើ សមតាមចំណុចទាំងនោះ; សម្រាប់វ៉ាល់ វាជាជំហានត្រង់រវាងចំណុចទាំងនោះ។';
...
$ec_lang['lpn_field_speed_pattern_tip']='របៀបដែលល្បឿនរបស់ម៉ាស៊ីនបូមនេះឡើង និងចុះពេញការដំណើរការ។ តម្គុណនីមួយៗ គឺជាល្បឿនប្រៀបធៀបសម្រាប់ផ្នែកនោះនៃថ្ងៃ ហើយចូលជំនួសល្បឿនខាងលើ ដូច្នេះតម្គុណ 0 បញ្ឈប់ម៉ាស៊ីនបូម។';
...
$ec_lang['lpn_terrain_menu']='បំពេញកម្ពស់ពីផ្ទៃដី…';
$ec_lang['lpn_terrain_tip']='អានកម្ពស់ដីនៅក្រោមថ្នាំងនីមួយៗដែលមិនទាន់មានកម្ពស់ ហើយវាយបញ្ចូលវាឲ្យអ្នក។ ថ្នាំងណាដែលមានកម្ពស់រួចហើយត្រូវបានទុកមិនប៉ះពាល់ ហើយត្រឡប់ក្រោយម្ដងនាំវាទាំងអស់មកវិញ។ ការប្រើលើកទីមួយសួរការអនុញ្ញាតពីអ្នក ព្រោះទីតាំងថ្នាំងរបស់អ្នកទៅដល់ Mapbox។';
$ec_lang['lpn_terrain_accuracy']='ទិន្នន័យផ្ទៃដីមានភាពម៉ត់ចត់ប្រហែល 30 ម៉ែត្រលើដី ហើយជាធម្មតាខុសពីតម្លៃពិតច្រើនម៉ែត្រតាមបញ្ឈរ។ សូមចាត់ទុកវាដូចផែនទីខ្សែកម្ពស់ មិនមែនការស្ទង់មតិទេ៖ ពិនិត្យអ្វីៗដែលអ្នកពឹងផ្អែក។';
...
$ec_lang['lpn_terrain_confirm']='បំពេញកម្ពស់ថ្នាំង {n} ពីផ្ទៃដីមែនទេ?';
...
$ec_lang['lpn_terrain_confirm_default_2']='ជំនួស {n} នោះដោយកម្ពស់ផ្ទៃដីមែនទេ?';
...
$ec_lang['lpn_terrain_none_needed']='ថ្នាំងគ្រប់មានកម្ពស់ដែលអ្នកបានកំណត់រួចហើយ។ គ្មានអ្វីត្រូវបានផ្លាស់ប្ដូរទេ ហើយគ្មានអ្វីត្រូវបានផ្ញើទេ — យើងមិនដែលសរសេរជាន់ពីលើកម្ពស់ដែលមានរួចហើយឡើយ។';
$ec_lang['lpn_terrain_no_nodes']='មិនទាន់មានថ្នាំងត្រូវបំពេញនៅឡើយទេ។';
