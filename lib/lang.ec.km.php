...
$ec_lang['lpn_file_import_geo']='បំលែងទៅជា lat/lon…';
$ec_lang['lpn_file_import_geo_tip']='ពីក្រឡាចត្រង្គមូលដ្ឋានទៅជាកូអរដោនេពិភពលោកពិត។ យកគំនូរដែលបានគូរនៅលើក្រឡាចត្រង្គ xy ដាក់ទៅលើកូអរដោនេភូមិសាស្ត្រ ដូច្នេះវាស្ថិតនៅលើផែនទីផ្លូវត្រូវកន្លែងរបស់វា។ រាល់លេខដែលអ្នកបានវាយ នៅតែដដែល — មានតែ X និង Y ប៉ុណ្ណោះក្លាយទៅជាបណ្ដោយ និងទទឹង។';
...
$ec_lang['lpn_pane_tab_tip']='ថ្នាំងទាំងអស់ជាតារាងមួយដែលអ្នកអាចតម្រៀប និងកែសម្រួល។';
$ec_lang['lpn_pane_none']='បណ្ដាញនេះមិនទាន់មានថ្នាំងនៅឡើយទេ។';
