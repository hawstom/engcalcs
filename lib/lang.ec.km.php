...
$ec_lang['lpn_settings_engine_epanet_tip']='ដំណើរការឧបករណ៍ដោះស្រាយ EPANET ពី US EPA នៅទីនេះក្នុងកម្មវិធីរុករករបស់អ្នក។ ឧបករណ៍ដោះស្រាយទាំងពីរផ្ដល់ចម្លើយដូចគ្នា ហើយលើបណ្ដាញទំហំនេះ អ្នកនឹងមិនឃើញភាពខុសគ្នានៃល្បឿនទេ។ លើកទីមួយដែលអ្នកបើកវា ទិន្នន័យប្រមាណ 650 KB ត្រូវបានទាញយក ហើយរក្សាទុកនៅក្នុងឧបករណ៍នេះ។';
...
$ec_lang['lpn_examples_size']='{nodes} ថ្នាំង, {links} បំពង់';
...
$ec_lang['lpn_ex_net3_desc']='គំរូធំរបស់ EPANET៖ ថ្នាំង 97 ធុងទឹកពីរ និងប្រភពទន្លេមួយ។ គួរបើកមើលដើម្បីឃើញថាម៉ូដែលទំហំពិតមួយមើលទៅដូចម្ដេចនៅលើផែនទី។';
