...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="גובה הגסות לפי Darcy-Weisbach"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">מקדם אובדן משני, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">צמיגות קינמטית, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_Ec_target']='<span class="ec-help" title="יעד יעילות הולכה לאחר ריפוד; שבר 0&ndash;1">יעד ריפוד, E<sub>c,target</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_payback_years']='<span class="ec-help" title="החזר פשוט = סך עלות הריפוד &divide; ערך שנתי מוחזר">תקופת החזר <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_count']='<span class="ec-help" title="שורות שלוחה: המטפטפים בקטע זה בלבד. שורות קו ראשי: סך המטפטפים בשלוחות האחרות, השונות מזו, המסתעפות מקטע זה. עבור קטע קו הראשי המסתיים בשלוחת הבדיקה, נכללות גם כל השלוחות שמעבר לנקודה זו לאורך הקו הראשי, וכן שלוחות החולקות אותו צומת (למשל שלוחה מהצד הנגדי) &mdash; גם ספיקתן מסתעפת מקטע זה.">מטפטפים <span class="ec-tip">?</span></span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_e']='<span class="ec-help" title="גובה החספוס לפי דרסי-וייסבך">e <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_ratio']='<span class="ec-help" title="זהו מדד שונה מהקירוב שלנו למדד האחידות המקובל.">ספיקת המטפטף האחרון &divide; ספיקת התכנון, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
