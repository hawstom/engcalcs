...
$ec_lang['lpn_time_run_note']='אתם רואים כעת את הרשת בזמן הדיווח הראשון. הגדרת חשב מחדש אוטומטית כבויה, כך שהתוצאות עבור הזמנים המאוחרים יותר אינן מתעדכנות בזמן שאתם עובדים. לחצו על כפתור חשב כדי לעדכן אותן.';
...
$ec_lang['lpn_pane_paste_note']='טבלה זו מיועדת להזנת ערכים באמצעות הדבקה מגיליון אלקטרוני לתוך שורות שכבר קיימות. אם היא אינה עונה על הצרכים שלכם, השתמשו ב"עזרה, תיקון בעיה" כדי לספר לנו.';
...
$ec_lang['lpn_georef_projected']='פרויקט זה כבר מציין הטלת מפה, ולכן לא ניתן למקם את הקואורדינטות שלו על המפה בפעם שנייה.';
...
$ec_lang['lpn_new_coordsys_geo']='הטלה גאוגרפית';
$ec_lang['lpn_new_coordsys_geo_tip']='בחרו הטלה גאוגרפית. השתמשו ב-WGS 84 / Pseudo-Mercator EPSG:3857 עבור קו רוחב/קו אורך.';
...
$ec_lang['lpn_new_crs_tip']='ההטלה שבה כבר נמדדות הקואורדינטות שלכם. הקואורדינטות נשמרות בדיוק כפי שהקלדתם אותן, ושום דבר אינו מומר. בחירה זו קבועה; הדרך היחידה להמיר רשת לקואורדינטות אחרות היא באמצעות "קובץ, פתח לקואורדינטות חדשות", וההמרה משוערת. UTM הוא התקן הדומיננטי בעולם, לאזור מסוים עשויים להיות נהגים משלו, ומודד מקרקעין הוא האדם שכדאי לשאול אם אינכם בטוחים.';
...
$ec_lang['lpn_crs_place_projected']='פרויקט מוטל נפתח על המישור שלו עצמו, לא במקום שחיפשתם. הצבת מישור זה על כדור הארץ דורשת טרנספורמציית קואורדינטות, שלעמוד זה עדיין אין.';
...
$ec_lang['lpn_menu_cue']='התחילו מהתפריטים שלמעלה. השתמשו בסרגל הכלים לגישה מהירה.';
