...
$ec_lang['lpn_georef_on_map']='פרויקט זה כבר נמצא על lat/lon.';
...
$ec_lang['lpn_georef_asdeg_btn']='אלה כבר lat/lon';
...
$ec_lang['lpn_new_coords_tip']='פרויקט xy משתמש בקואורדינטות שאינן קו רוחב וקו אורך. לפרויקט lat/lon יש קואורדינטות גיאוגרפיות, כך שניתן לצייר מאחוריו מפת רחובות או תמונת לוויין, ואפשר לקרוא רומי צמתים מפני הקרקע. ניתן להמיר פרויקט xy לlat/lon באמצעות קובץ, פתיחת קובץ xy על המפה.';
