...
$ec_lang['mhp_length']='אורך, L <span title="אורך צינור ההולכה או התעלה בכניסה (מבנה הקצה)" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_warn']='חורג מיעד 10%';
$ec_lang['mhp_hl_warn_tip']='שקול צינור גדול יותר';
$ec_lang['mhp_hl_bad']='חורג מ-20%';
$ec_lang['mhp_hl_bad_tip']='ממד מחדש את הצינור';
...
$ec_lang['mhp_notes_4_term']='הפסדים משניים (מקומיים), k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='הפסדים אלה מתרחשים בצמתי צינור, בכניסות, בעיקולים ובשסתומים — המונח "משני" מקובל אך מטעה; בצינור לחץ קצר הם עשויים להשתוות לאובדני החיכוך או לעלות עליהם. ערכים אופייניים: כניסה חדה 0.5, כל עיקול 45° בין 0.2–0.3, ברז שער (פתוח לחלוטין) 0.1, שסתום פרפר 0.2. סכום כל האבזרים הוא k<sub>m</sub> הכולל. ברירת המחדל 1.5 מניחה כניסה אחת ושני עיקולים.';
...
$ec_lang['rc_apron_length']='אורך מצוע היציאה (15 × D<sub>50</sub>) <span title="נדרש לתמיכה מבנית בסלעי המגלשה. &quot;מפלס המים התחתון המינימלי הנוצר כתוצאה מקטע היציאה והתנגדות הערוץ שבמורד מספיק כדי להבטיח את יציבות הריפרפ בקטע היציאה.&quot; (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_Hp']='גובה מים בכתר הכניסה, H<sub>p</sub> <span title="הצטברות מים (Hp > yn) רצויה — מפחיתה סחיפה מעלה. (USDA)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
