...
$ec_lang['dw_kinematic_viscosity']='צמיגות קינמטית, ν <span title="1×10⁻⁶ m²/s for clean water at 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_nu']='צמיגות קינמטית, ν <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_vel_high']='מהירות גבוהה — סיכון של פטיש מים והפסדים משניים.';
...
$ec_lang['ds_main_desc']='השקיה בטפטוף וספרינקלר — קצב יישום ואחידות';
...
$ec_lang['ds_notes_3_def']='זמן הפעלה = עומק יעד ÷ קצב יישום. בקרקע משופעת או מהודקת, חלק את זמן ההפעלה לשניים או שלושה מחזורים קצרים יותר עם הפסקות ביניהם למניעת נגר עילי.';
...
$ec_lang['cs_Ec_target']='יעילות יעד, E<sub>c,target</sub> <span title="Conveyance efficiency goal after lining; fraction 0–1" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['cs_payback_years']='תקופת החזר <span title="Simple payback = total lining cost ÷ annual value recovered" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
