...
$ec_lang['mtc_d50_mra']='גודל סלע זוויתי נדרש, D<sub>50</sub> (Maynord, Ruff ו-Abt 1989)';
...
$ec_lang['lpn_main_title']='מחשבון חינמי מקוון לרשת חלוקת מים עם מנוע EPANET';
...
$ec_lang['lpn_empty_hint']='התחילו בהוספת תמונת רקע או מאגר מסרגל הכלים, או פתחו קובץ, פרויקט חדש כדי להתחיל מדוגמה.';
...
$ec_lang['lpn_new_blank_us']='פרויקט ריק, יחידות ארה"ב (gpm)';
$ec_lang['lpn_new_blank_si']='פרויקט ריק, יחידות SI‏ (l/s)';
$ec_lang['lpn_new_from_examples']='מתוך דוגמאות';
...
$ec_lang['lpn_new_example_us']='רשת בסיסית, יחידות ארה"ב (gpm)';
$ec_lang['lpn_new_example_si']='רשת בסיסית, יחידות SI‏ (l/s)';
...
$ec_lang['lpn_inp_report_counts']='{nodes} צמתים ומאגרים, {links} צינורות ומשאבות, ב-{units}.';
...
$ec_lang['lpn_inp_drop_tanks']='מכלי אחסון הושמטו. לעמוד זה יש מאגרים, שמחזיקים מפלס מים קבוע אחד. מכל אחסון אינו מחזיק מפלס קבוע, ולכן הוא אינו מאגר.';
$ec_lang['lpn_inp_drop_tank_links']='צינורות אלה הושמטו משום שהם מתחברים למכל אחסון שהושמט.';
$ec_lang['lpn_inp_drop_tcv']='שסתומי חנק אלה נכנסו כצינורות קצרים מאוד הנושאים את אותו אובדן מקומי. המים מתנהגים באותו אופן; האלמנט אינו זהה.';
$ec_lang['lpn_inp_drop_valve']='שסתומים אלה שולטים בלחץ או בספיקה, ולעמוד זה אין אלמנט כזה. הם נכנסו כצינורות פתוחים, כך שהרשת עדיין מחוברת, אך שום דבר אינו שולט בה יותר.';
...
$ec_lang['lpn_inp_drop_patterns']='תבניות דרישה הושמטו. עמוד זה פותר רגע זמן אחד, כך שכל דרישה היא המספר הכתוב בקובץ.';
...
$ec_lang['lpn_inp_drop_eps']='קובץ זה מתאר סימולציה הרצה על פני תקופת זמן. עמוד זה פותר רגע אחד, כך שרק תנאי ההתחלה נכנסו.';
...
$ec_lang['lpn_inp_drop_units']='יחידות הספיקה בקובץ זה לא זוהו, ולכן הונחו גלונים לדקה. בדקו כל מספר לפני שתשתמשו בתוצאות.';
...
$ec_lang['lpn_notes_1_def']='פותר סדרת דרישות אחת בכל פעם, באמצעות אותו אלגוריתם שיפוע גלובלי ש-EPANET משתמש בו. הוא אינו מדגם כיצד הרשת משתנה לאורך זמן.';
$ec_lang['lpn_notes_2_term']='לא מדוגם';
$ec_lang['lpn_notes_2_def']='מכלים, איכות מים, ושסתומי בקרה הנפתחים ונסגרים באופן עצמאי (PRV,‏ PSV,‏ FCV) אינם מדוגמים. צינור יכול לשאת אובדן מקומי קבוע, אך לא שסתום שמצב הפתיחה או הסגירה שלו תלוי בספיקה שנמצאת בתהליך פתרון.';
...
$ec_lang['lpn_diag_no_fixed_head']='הוסיפו מאגר. הרשת זקוקה לפחות למפלס מים ידוע אחד לפני שניתן לפתור אותה.';
...
$ec_lang['lpn_pump_point1']='נקודה 1 (חובה)';
...
$ec_lang['lpn_backdrop_position_prompt1']='לחצו על כל נקודה בתמונת הרקע. זוהי הנקודה שתזיזו.';
$ec_lang['lpn_backdrop_position_prompt2']='בחרו לאן נקודה זו צריכה ללכת, ואז לחצו על המשך.';
...
$ec_lang['lpn_settings_defaults']='ערכי התחלה';
...
$ec_lang['lpn_settings_engine_epanet']='פתור עם מנוע EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='מריץ את מנוע EPANET המקורי מה-US EPA, כאן בדפדפן שלכם. הפותר המובנה נותן את אותן תשובות והוא מהיר יותר, לכן השאירו אפשרות זו כבויה אלא אם אתם זקוקים ל-EPANET עצמו.';
$ec_lang['lpn_engine_loading']='טוען את מנוע EPANET…';
$ec_lang['lpn_engine_failed']='לא ניתן היה לטעון את מנוע EPANET. מציג את הפותר המובנה במקום.';
...
$ec_lang['lpn_settings_symbol_size']='גודל סמל (יחסית לטקסט)';
