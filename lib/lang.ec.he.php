...
$ec_lang['mhp_km']='מקדם אובדן משני, k<sub>m</sub> <span title="Sum of all junction and fitting loss coefficients along the penstock" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['mhp_nu']='צמיגות קינמטית, &nu; <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['mhp_efficiency']='יעילות מתקן, &eta; (0&ndash;1)';
...
$ec_lang['mhp_notes_1_def']='סך אובדן צינור הלחץ h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, כאשר h<sub>f</sub> = f(L/D)(v&sup2;/2g) הוא אובדן חיכוך לפי דארסי-ויסבאך ו-h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g מכסה כניסה, עקומות ושסתומים. גובה נטו H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='מהירות';
$ec_lang['mhp_notes_2_def']='יעד 1&ndash;3 מ/ש. מתחת ל-1 מ/ש מגדיל את הצינור מעל הצורך; מעל 3 מ/ש מגביר אובדן חיכוך וסיכון לפגיעת פטיש המים.';
$ec_lang['mhp_notes_3_term']='יעד אובדן לחץ';
$ec_lang['mhp_notes_3_def']='אובדן צינור הלחץ מתחת ל-10% מהגובה הברוטו הוא בדרך כלל כלכלי. האיזון האופטימלי בין עלות הצינור לאנרגיה שאבדה נמצא לרוב סביב 4&ndash;6% באתרי חשמל בעלי ערך גבוה.';
$ec_lang['mhp_notes_4_term']='אובדן משני k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='ערכים אופייניים: כניסה חדה 0.5, כל עיקול 45&deg; בין 0.2&ndash;0.3, ברז שער (פתוח לחלוטין) 0.1, שסתום פרפר 0.2. סכום כל האבזרים הוא k<sub>m</sub> הכולל. ברירת המחדל 1.5 מניחה כניסה אחת ושני עיקולים.';
$ec_lang['mhp_notes_5_term']='גסות הצינור e';
$ec_lang['mhp_notes_5_def']='גסות מוחלטת אופיינית: פלדה (חדשה) 0.046&nbsp;מ"מ, פלדה (משומשת) 0.15&nbsp;מ"מ, HDPE 0.003&nbsp;מ"מ, PVC/uPVC 0.0015&nbsp;מ"מ, בטון 0.3&ndash;3&nbsp;מ"מ. HDPE נפוץ בצינורות לחץ קטנים למיקרו-הידרו.';
