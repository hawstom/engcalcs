...
$ec_lang['lpn_field_text_match_pipe']='התאם לקישור הקרוב ביותר';
...
$ec_lang['lpn_time_format_tip']='כתבו זמן כשעות ודקות, כמו 2:30. מספר פשוט פירושו שעות; מספר עם מילה משלו פירושו אותה מילה: 30 דקות.';
$ec_lang['lpn_time_running']='מחשב את כל תקופת הזמן עם מנוע EPANET.';
$ec_lang['lpn_time_no_engine']='הפותר המובנה מחשב רגע אחד בכל פעם, כך שזוהי הרשת ב-{time} בלבד: הדרישות נושאות את מכפילי התבנית של אותו רגע, וכל מכל עדיין נמצא במפלס ההתחלה שלו במקום להתמלא ולהתרוקן. התחברו לאינטרנט פעם אחת כדי להוריד את מנוע EPANET, המריץ את כל התקופה.';
