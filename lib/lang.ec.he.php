...
$ec_lang['lpn_file_convert_as']='פתיחת קובץ xy על המפה…';
$ec_lang['lpn_file_convert_as_tip']='פותח קובץ פרויקט או קובץ EPANET בלשונית פרויקט חדשה בעמוד זה, על מפת הרחובות. אתם ממקמים את השרטוט על העולם בעצמכם: גוללו והגדילו אל האתר, ואז שנו גודל וסובבו כדי שיתאים. אם ה-x וה-y בקובץ כבר הם קו אורך וקו רוחב, לחצו על כפתור אלה כבר lat/lon והרשת קופצת ישר למקומה. כל מספר שהקלדתם נשאר כפי שהוא.';
