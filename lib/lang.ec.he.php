...
$ec_lang['bpn_line_problem']='בדקו את עמודת מזהה במעלה הזרם: קו מצביע על מזהה לא ידוע, מפנה לעצמו, או יוצר לולאה, כך שחלק מהרשת אינו מחובר למקור. קווים אלה נשארים בלתי פתורים.';
$ec_lang['bpn_bad_id_short']='רשת';
