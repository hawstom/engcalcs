...
$ec_lang['lpn_inp_drop_quality']='קובץ זה מתאר כיצד איכות המים משתנה תוך כדי מעבר: מה נמצא במים מלכתחילה, היכן עוד מאותו חומר נכנס, כיצד הוא מגיב, וכיצד המכלים מתערבבים. עמוד זה מחשב גיל מים ומעקב מקור, אך לא את הכימיה, כך שדבר מכל זה אינו בשימוש כאן. שורות אלה נשמרות, והן נכתבות בחזרה אם תשמרו קובץ EPANET.';
...
$ec_lang['lpn_tip_select']='השתמשו במצב זה כדי לשנות, להזיז ולגרור דברים על המפה. העמוד חוזר למצב זה בעצמו לאחר פעולות מסוימות, כגון פתיחת פרויקט.';
...
$ec_lang['lpn_settings_color_thematic_tip']='מסתיר את תוויות הצמתים והקישורים כך שרק הצבעים נשארים על המפה. טקסט שהצבתם בעצמכם נשאר. בחירות התוויות שלכם נשמרות, וכיבוי אפשרות זו מחזיר אותן.';
...
$ec_lang['lpn_file_import_geo']='פתיחת קובץ xy על המפה…';
$ec_lang['lpn_file_import_geo_tip']='פותח קובץ פרויקט או קובץ EPANET בלשונית פרויקט חדשה בעמוד זה, על מפת הרחובות. אתם ממקמים את השרטוט על העולם בעצמכם: גוללו והגדילו אל האתר, ואז שנו גודל וסובבו כדי שיתאים. אם ה-x וה-y בקובץ כבר הם קו אורך וקו רוחב, לחצו על כפתור אלה כבר קו רוחב/אורך והרשת קופצת ישר למקומה. כל מספר שהקלדתם נשאר כפי שהוא.';
...
$ec_lang['lpn_clean_map_tip']='מסירה את שורת המצב ואת קריאת הקואורדינטות מהמפה, כך שצילום מסך יראה רק את השרטוט. השרטוט שלכם אינו נפגע, ובחירה זו אינה נשמרת; טעינה מחדש של העמוד מחזירה את הקריאות.';
...
$ec_lang['lpn_time_no_engine']='הפותר המובנה מחשב רגע אחד בכל פעם, כך שזוהי הרשת ב-{time} בלבד: כל תבנית נקראת באותו רגע, וכל מכל עדיין נמצא במפלס ההתחלה שלו במקום להתמלא ולהתרוקן. התחברו לאינטרנט פעם אחת כדי להוריד את פותר EPANET, המריץ את כל התקופה.';
...
$ec_lang['lpn_time_run_note']='אתם רואים כעת את הרשת בזמן הדיווח הראשון. חישוב רשת זו על פני כל תקופת הזמן שלה אורך זמן רב, כך שהתוצאות עבור הזמנים המאוחרים יותר אינן מתעדכנות בזמן שאתם עובדים. לחצו על כפתור חשב כדי לעדכן אותן.';
...
$ec_lang['lpn_georef_asdegrees']='ה-x וה-y בקובץ זה נקראו כקו אורך וקו רוחב, כך שהרשת כבר נמצאת על המפה ושום דבר לא הוזז. בדקו שהיא במקום הנכון, ואז לחצו על כפתור שמור מיקום זה.';
...
$ec_lang['lpn_result_water_age_tip']='כמה זמן המים המגיעים לנקודה זו נמצאים במערכת. אין מגבלה רגולטורית שאפשר להשוות אליה, כך שיש לשפוט את המספר ביחס למערכת שלכם.';
...
$ec_lang['lpn_new_coords']='קואורדינטות';
$ec_lang['lpn_new_coords_xy']='קואורדינטות xy';
$ec_lang['lpn_new_coords_geo']='קו רוחב/קו אורך';
$ec_lang['lpn_new_coords_tip']='פרויקט xy משתמש בקואורדינטות שאינן קו רוחב וקו אורך. לפרויקט קו רוחב/קו אורך יש קואורדינטות גיאוגרפיות, כך שניתן לצייר מאחוריו מפת רחובות או תמונת לוויין, ואפשר לקרוא רומי צמתים מפני הקרקע. ניתן להמיר פרויקט xy לקו רוחב/קו אורך באמצעות קובץ, פתיחת קובץ xy על המפה.';
$ec_lang['lpn_new_place']='התחילו ליד מקום זה';
$ec_lang['lpn_new_place_tip']='אופציונלי. הקלידו עיר, רחוב או ציון דרך, והמפה החדשה תיפתח שם. המילים שתקלידו נשלחות לשירות שמות המקומות של OpenStreetMap, המבקש את הרשאתכם בפעם הראשונה. השאירו ריק והמפה תיפתח על כל העולם.';
$ec_lang['lpn_new_place_hint']='תל אביב, ישראל';
$ec_lang['lpn_new_create']='יצירה';
$ec_lang['lpn_inp_drop_rules']='לקובץ זה יש בקרות מבוססות-כללים. הן אינן מיושמות כאן, כך שהצינורות, המשאבות והשסתומים שהן מציינות נשארים במצב הכתוב בקובץ. הכללים עצמם נשמרים, והם נכתבים בחזרה אם תשמרו קובץ EPANET.';
$ec_lang['lpn_inp_drop_energy']='קובץ EPANET זה כולל נתוני מידול עלות שאיבה. עמוד זה אינו מחשב אנרגיה או עלות, כך ששום דבר כאן אינו משתמש במספרים אלה. הם נשמרים, והם נכתבים בחזרה אם תשמרו קובץ EPANET.';
$ec_lang['lpn_inp_drop_tags']='קובץ זה נותן תגיות לחלק מהצמתים, הצינורות או האלמנטים האחרים שלו. אין עדיין מקום בעמוד זה לראות תגית או לשנות אותה. התגיות נשמרות, והן נכתבות בחזרה אם תשמרו קובץ EPANET.';
$ec_lang['lpn_inp_drop_report']='קובץ זה מחזיק את הגדרות EPANET עצמן עבור הדוחות שהוא מדפיס. עמוד זה מציג את תוצאותיו בדרכו שלו, כך ששום דבר כאן אינו משתמש בהן. הן נשמרות, והן נכתבות בחזרה אם תשמרו קובץ EPANET.';
...
$ec_lang['lpn_inp_drop_quality_options']='קובץ זה קובע אפשרויות איכות מים של EPANET: Quality, המציינת את סוג ניתוח איכות המים, ושתי הגדרות הקשורות לחומר כימי, מקדם דיפוזיה יחסי וסבילות איכות. גיל המים ומעקב מקור מחושבים כאן; חומר כימי אינו מחושב, כך ששתי ההגדרות הללו נשמרות בלי שנעשה בהן שימוש. כולן נכתבות בחזרה אם תשמרו קובץ EPANET.';
...
$ec_lang['lpn_settings_quality_track_tip']='בחרו מה ההרצה צריכה לעקוב אחריו דרך הצינורות: כמה זמן המים היו במערכת, או מהיכן הם הגיעו. אף אחד מהם אינו זקוק לריכוז או לקצב תגובה.';
...
$ec_lang['lpn_quality_chemical']='חומר כימי שהקובץ הזה מציין (מאוחסן, לא מחושב)';
$ec_lang['lpn_quality_needs_run']='איכות המים נישאת לאורך הצינורות עם הזמן, ולכן היא דורשת את מנוע EPANET וזמן ריצה כולל. הגדירו זמן ריצה כולל תחת זמן, ואז לחצו על כפתור חשב.';
...
$ec_lang['lpn_ff_menu']='ספיקת כיבוי אש…';
...
$ec_lang['lpn_ff_title']='ספיקת כיבוי אש';
...
$ec_lang['lpn_ff_required_node_tip']='ספיקת כיבוי האש הנדרשת בצומת מסוים זה, מתקן הכיבוי או מרשות הכיבוי שלכם עבור השימוש בקרקע שהוא משרת. השאירו ריק והצומת ייבדק כנגד המספר בתיבת ספיקת כיבוי אש נדרשת.';
...
$ec_lang['lpn_ff_design_nodes']='כל שאר הצמתים';
