...
$ec_lang['dw_roughness']='גסות, e';
$ec_lang['dw_roughness_tip']='<span title="גובה הגסות לפי Darcy-Weisbach" class="ec-tip">?</span>';
$ec_lang['dw_kinematic_viscosity']='צמיגות קינמטית, &nu; <span title="1×10⁻⁶ m²/s למים נקיים ב-20°C" class="ec-tip">?</span>';
...
$ec_lang['mi_q_617']='Q <span title="הספיקה המורכבת, Q, המחושבת באמצעות מקדם n מורכב לכל אזור, בהתאם למשוואה 6-17 של Chow (בהנחת מהירויות שוות)" class="ec-tip">?</span>';
...
$ec_lang['mpf_velocity_head']='עומד מהירות, h<sub>v</sub>';
...
$ec_lang['mphl_total_loss'] = 'אובדן לחץ כולל, h<sub>L</sub>';
$ec_lang['mphl_egl_1']='EGL מורד';
$ec_lang['mphl_egl_2']='EGL מעלה';
$ec_lang['mphl_hgl_2']='HGL מעלה בצינור ' . $ec_lang['mpf_see_notes'];
...
$ec_lang['mtc_sgrock']='משקל סגולי של הסלע, sg <span title="ערך אופייני ≈ 2.65 עבור סלע מרוסק" class="ec-tip">?</span>';
$ec_lang['mtc_d50_in']='גודל סלע העיצוב, D<sub>50</sub>';
$ec_lang['mtc_n_strickler']='n לגודל סלע העיצוב לפי שיטת Strickler';
$ec_lang['mtc_n_blodgett']='n לגודל סלע העיצוב לפי שיטת Blodgett';
$ec_lang['mtc_n_bathurst']='n לגודל סלע העיצוב לפי שיטת Bathurst';
$ec_lang['mtc_blodgett_v_bathurst']='Blodgett לעומת Bathurst';
$ec_lang['mtc_d50_bottom']='גודל סלע זוויתי נדרש לקרקעית, D<sub>50</sub> (Isbash ו-MC) <span title="לפי Isbash (1936) ו-Maricopa County, אריזונה, ארה״ב" class="ec-tip">?</span>';
$ec_lang['mtc_d50_z1']='גודל סלע זוויתי נדרש לשיפוע צד 1, D<sub>50</sub> (Isbash ו-MC) <span title="לפי Isbash (1936) ו-Maricopa County, אריזונה, ארה״ב" class="ec-tip">?</span>';
$ec_lang['mtc_d50_z2']='גודל סלע זוויתי נדרש לשיפוע צד 2, D<sub>50</sub> (Isbash ו-MC) <span title="לפי Isbash (1936) ו-Maricopa County, אריזונה, ארה״ב" class="ec-tip">?</span>';
...
$ec_lang['ws_headWaterHeight']='עומק, h';
...
$ec_lang['wi_notes_we_term']='משוואת השפיכון';
...
$ec_lang['or_diameter']='קוטר או גובה, D <span title="קוטר לצורה עגולה; גובה לצורה מלבנית" class="ec-tip">?</span>';
$ec_lang['or_width']='רוחב, W <span title="פתחים מלבניים בלבד" class="ec-tip">?</span>';
$ec_lang['or_invert']='גובה תחתית הפתח <span title="תחתית הפתח" class="ec-tip">?</span>';
...
$ec_lang['odt_a_ending']='שטח סופי, A<sub>2</sub> <span title="מחושב באינטרפולציה ממודל חתך קוני בגובה הסופי" class="ec-tip">?</span>';
...
$ec_lang['odt_d']='קוטר פתח D <span title="קוטר (עגול) או גובה (מלבני)" class="ec-tip">?</span>';
$ec_lang['odt_w']='רוחב פתח, W <span title="מלבני בלבד" class="ec-tip">?</span>';
...
$ec_lang['odt_h1']='עומק התחלתי, H<sub>1</sub> <span title="גובה מפלס המים ההתחלתי פחות גובה צנטרואיד הפתח" class="ec-tip">?</span>';
...
$ec_lang['ip_main_title']='מחשבון מקוון חינמי ללחץ השקיה ואחידות חלוקה';
$ec_lang['ip_main_desc']='לחץ שלוחת בדיקה ואומדן אחידות';
...
$ec_lang['ip_x']='מעריך ספיקת הפולט, x <span title="0.5 לפולטים רגילים ללא ויסות לחץ; קרוב ל-0 לפולטים מווסתי לחץ" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='שלוחה <span title="מסומן: קטע זה הוא חלק משלוחת הבדיקה, שממנה פולטים בודדים מושכים מים. לא מסומן: קטע זה הוא קו ראשי, המעביר ספיקה רק לשלוחות שאינן בנתיב הבדיקה." class="ec-tip">?</span>';
$ec_lang['ip_count']='פולטים <span title="שורות שלוחה: הפולטים בקטע זה בלבד. שורות קו ראשי: סך הפולטים בשלוחות האחרות המסתעפות מקטע זה. עבור הקטע שבנקודת ההסתעפות של שלוחת הבדיקה עצמה, נכללות גם כל השלוחות שבהמשך הקו הראשי מעבר לנקודה זו, וכן שלוחות החולקות את אותו צומת (למשל שלוחה מהצד הנגדי) &mdash; גם ספיקתן עוברת דרך קטע זה." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_e']='e <span title="גובה החספוס לפי דרסי-וייסבך" class="ec-tip">?</span>';
$ec_lang['ip_km']='K<sub>m</sub> <span title="מקדם הפסדים מקומיים כולל עבור האביזרים/המגופים/המחברים של קטע זה (מינימום מומלץ &ge;0.5)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='רום מורד <span title="רום הקצה במורד של קטע זה. אופציונלי בשורות פנימיות (אם נשאר ריק, מניחים אופקי / זהה לצומת שמעל). חובה בשורה האחרונה: ערך זה הוא רום הפולט האחרון, הקובע ישירות את לחץ האספקה הנדרש." class="ec-tip">?</span>';
...
$ec_lang['ip_hl']='H<sub>l</sub> <span title="סך הפסדי הקטע, H_f + H_m" class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='ספיקת אספקה של נתיב הבדיקה, Q<sub>supply</sub> <span title="הספיקה הנכנסת לנתיב הבדיקה הממודל בלבד, לא לכל האזור/המערכת — ראו Q_zone בסעיף תכנון יישום למטה לסך המערכתי." class="ec-tip">?</span>';
...
$ec_lang['ip_dp_avg']='אומדן &Delta;לחץ, ממוצע לעומת שלוחת הבדיקה <span title="בכמה גבוה (או נמוך) לדעתכם פועלת שלוחה טיפוסית/ממוצעת בהשוואה לשלוחת בדיקה זו. שלוחת הבדיקה נבחרת בכוונה כמקרה הגרוע המשוער, ולכן הממוצע שלה עצמה הוא תחליף מוטה כלפי מטה לממוצע השדה &mdash; אם נשאר 0, בדיקת האחידות ומספרי תכנון היישום למטה משתמשים בממוצע (האופטימי כנראה) של שלוחת הבדיקה עצמה כפי שהוא." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='אומדן ספיקת פולט ממוצעת לשדה, q<sub>avg,field</sub> <span title="q_avg_lateral מחושב מחדש בלחץ של כל שורת שלוחה בתוספת הפרש הלחץ שהוזן למעלה &mdash; ניסיון לתקן את היות שלוחת הבדיקה המקרה הגרוע המשוער, ולא שלוחה מייצגת. מזין הן את בדיקת האחידות והן את סעיף תכנון היישום למטה." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='בדיקת אחידות, q<sub>last</sub>/q<sub>avg,field</sub> <span title="הספיקה המחושבת של הפולט האחרון חלקי אומדן ספיקת הפולט הממוצעת לשדה &mdash; אותה צורה כמו אחידות החלוקה של הרבע התחתון המוכרת מספרי הלימוד (ממוצע הקבוצה הנמוכה &divide; ממוצע האוכלוסייה), אך ממדגם ממודל קטן ותיקון שהמשתמש אומד, לא ממדגם סטטיסטי של שדה מלא. ערכים של 1 ומעלה אפשריים ואינם תקלה: פירושם רק שהפולט האחרון אינו הנקודה הנמוכה ביחס לממוצע השדה המשוער (למשל קטע יורד נוח, או אומדן &Delta;לחץ קטן מדי למעלה)." class="ec-tip">?</span>';
...
$ec_lang['ip_q_ratio']='ספיקת הפולט האחרון לעומת ספיקת התכנון, q<sub>last</sub>/q<sub>design</sub> <span title="בדיקה נפרדת, לא מדד אחידות: עד כמה רחוק פועל הפולט האחרון מספיקת התכנון הנקובה של היצרן. מעל 1: פועל מעל נקודת התכנון (למשל בזכות ירידת רום נוחה). מתחת ל-1: פועל מתחת לתכנון (המקרה הטיפוסי שבו שולט החיכוך)." class="ec-tip">?</span>';
...
$ec_lang['ip_notes_1_def']='מנחש את הלחץ בפולט האחרון (המרוחק ביותר), ואז מתקדם לאורך קו האנרגיה בחזרה אל האספקה, קטע אחר קטע, תוך הוספת הפסדי חיכוך והפסדים מקומיים בדרך. הרום ועומד המהירות מנוכים בכל צומת כדי לדווח את הלחץ בפועל שם. לחץ הקצה המרוחק המשוער מכוונן (בשיטת החצייה) עד שלחץ האספקה הנדרש המחושב תואם את לחץ האספקה שהוזן &mdash; אותה בעיית חוג סגור שפותר פותר הזרימה בצינורות במחשבון Manning Pipe Flow, מורחבת לרשת מסתעפת.';
$ec_lang['ip_notes_2_term']='ראשיות לעומת קטעים צדדיים';
$ec_lang['ip_notes_2_def']='כל שורה היא קטע אחד לאורך הנתיב ההידראולי הגרוע ביותר (נתיב הבדיקה) מהאספקה עד הפולט האחרון. קטע קו ראשי רק מעביר ספיקה לשלוחות שאינן בנתיב הבדיקה, ולכן השאיבה שלו היא מכפלה פשוטה (ספיקת תכנון &times; סך הפולטים של הקטע) &mdash; ללא רגישות ללחץ המקומי. הקו הראשי הוא צינור גזע משותף, ולכן הקטע שבנקודת ההסתעפות של שלוחת הבדיקה עצמה חייב לכלול לא רק שלוחות שבין קצותיו אלא גם כל שלוחה שבהמשך הקו הראשי מעבר להסתעפות זו, או החולקת את אותו צומת (למשל שלוחה מהצד הנגדי) &mdash; ספיקתן עוברת דרך אותו קטע לפני שהיא מתפצלת, בין שהן מופיעות במקום אחר בטבלה ובין שלא. קטע שלוחה הוא חלק משלוחת הבדיקה עצמה: ספיקת הפולט מחושבת מהלחץ המקומי בפועל לפי q = k&middot;H<sup>x</sup>, והפסד החיכוך מוקטן במקדם F(n) של Christiansen כדי להביא בחשבון את ירידת הספיקה ככל שכל פולט בקטע מושך מים.';
$ec_lang['ip_notes_3_term']='הגבלות';
$ec_lang['ip_notes_3_def']='ממדל לחץ כניסה קבוע אחד (ללא עקומת משאבה), נתיב בדיקה אחד בלבד (לא את כל השדה) ועקומת פולט דו-פרמטרית (קבעו את המעריך קרוב ל-0 כדי לקרב פולט מווסת לחץ). מדווחים שני יחסים שונים, המופרדים בכוונה: q<sub>last</sub>/q<sub>avg,field</sub> הוא בדיקת אחידות, בעלת אותה צורה כמו אחידות החלוקה של הרבע התחתון מספרי הלימוד (ממוצע הקבוצה הנמוכה &divide; ממוצע האוכלוסייה), אך מחושבת מהפולטים הממודלים של שלוחת הבדיקה עצמה ומתוקנת באומדן &Delta;לחץ שהוזן, ולא ממדגם סטטיסטי של שדה מלא &mdash; שלוחת הבדיקה נבחרת בכוונה כמקרה הגרוע המשוער, ולכן הממוצע הגולמי הלא-מתוקן שלה היה ממעיט בהערכת ממוצע השדה האמיתי וגורם לאחידות להיראות טובה מכפי שהיא; שדה ה-&Delta;לחץ קיים בדיוק כדי לנטרל הטיה זו. ערכים של 1 ומעלה עדיין אפשריים (למשל אומדן &Delta;לחץ קטן מדי, או קטע יורד נוח). q<sub>last</sub>/q<sub>design</sub> הוא בדיקה אחרת, שאינה מדד אחידות, מול הספיקה הנקובה של היצרן &mdash; שימושית לזיהוי מערכת בלחץ יתר או חסר באופן כללי, אך אינה תחליף למדד האחידות, שכן לספיקת התכנון/הנקובה אין קשר הכרחי ללחץ העבודה הממוצע בפועל של המערכת.';
...
$ec_lang['ip_notes_5_def']='קצב היישום וספיקת המערכת/האזור משתמשים באומדן ספיקת הפולט הממוצעת לשדה (q<sub>avg,field</sub> &mdash; הממוצע של שלוחת הבדיקה עצמה, מתוקן באומדן ה-&Delta;לחץ שהוזן), ולא בקצב מנוחש: PR = q<sub>avg,field</sub> / A<sub>e</sub>, הניזון מהערך הממודל המתוקן. המרווחים ומספרי השלוחות/הפולטים ברמת המערכת הם קלטים נפרדים כאן, מפני שנתיב הבדיקה ממדל רק ענף אחד של המקרה הגרוע, לא כל שלוחה בשדה.';
