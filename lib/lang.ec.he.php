...
$ec_lang['lpn_field_text_match_pipe']='התאם לזווית הצינור';
...
$ec_lang['lpn_examples_size']='{nodes} צמתים, {links} צינורות';
...
$ec_lang['lpn_ex_net3_desc']='הדוגמה הגדולה של EPANET: 97 צמתים, שני מכלים ומקור נהר. כדאי לפתוח כדי לראות איך נראה על המפה מודל בגודל אמיתי.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='מריץ את פותר EPANET של ה-US EPA, כאן בדפדפן שלכם. שני הפותרים נותנים את אותן תשובות, וברשת בגודל זה לא תראו הבדל במהירות. בפעם הראשונה שתפעילו אפשרות זו, כ-650 KB מורדים ואז נשמרים במכשיר זה.';
