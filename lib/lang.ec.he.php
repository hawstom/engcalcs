...
$ec_lang['ds_se']='מרווח בין פולטים לאורך הצינור הצדדי, S<sub>e</sub>';
$ec_lang['ds_sl']='מרווח בין צינורות צדדיים (מרווח שורות), S<sub>l</sub>';
...
$ec_lang['ds_pr']='קצב יישום (קצב משקעים), PR';
...
$ec_lang['ds_t_run']='זמן הפעלה לעומק יעד (שעות)';
...
$ec_lang['cs_Q_in']='ספיקת כניסה בראש המקטע, Q<sub>in</sub>';
$ec_lang['cs_Q_out']='ספיקת יציאה בזנב המקטע, Q<sub>out</sub>';
$ec_lang['cs_Q_loss']='קצב אובדן הדליפה, Q<sub>loss</sub>';
$ec_lang['cs_loss_check']='בדיקת מדידה';
$ec_lang['cs_pct_loss']='אובדן כשבר מהספיקה הנכנסת';
...
$ec_lang['cs_wp']='היקף רטוב של חתך התעלה, P<sub>w</sub>';
$ec_lang['cs_Q_loss_per_L']='אובדן חדירה לאורך יחידת אורך, Q<sub>loss</sub>/L';
$ec_lang['cs_water_value']='ערך המים (מטבע ליחידת נפח)';
$ec_lang['cs_lining_cost']='עלות ריפוד (מטבע ליחידת שטח)';
$ec_lang['cs_Ec_target']='יעילות הולכה יעד לאחר ריפוד, E<sub>c,target</sub> (שבר, 0&ndash;1) &mdash; יעד לשמירת המים בתעלה המרופדת';
$ec_lang['cs_lining_area']='שטח ריפוד התעלה (L &times; P<sub>w</sub>)';
$ec_lang['cs_annual_value_lost']='ערך שנתי של מים שאבדו (מטבע)';
$ec_lang['cs_annual_value_recovered']='ערך שנתי שנשמר בזכות הריפוד (מטבע)';
$ec_lang['cs_lining_total_cost']='עלות ריפוד כוללת (מטבע)';
$ec_lang['cs_payback_years']='תקופת החזר פשוטה (שנים)';
