...
$ec_lang['irr_main_desc']='מדידת ספיקת השקיה — שפיכונים ופתחים';
$ec_lang['irr_intro_html']='<p>שפיכונים ופתחים הם הכלים השטחיים הסטנדרטיים למדידת זרימת מים במערכות השקיה. בחרו את המחשבון המתאים למבנה שלכם:</p>';
$ec_lang['irr_card_weir_uniform_head']='שפיכון — כתר רחב (רוחב אחיד)';
$ec_lang['irr_card_weir_uniform_desc']='מדדו את הזרימה מעל כתר סכר ההסטה, מבנה הבקרה, או לוח השפיכון. הזינו את אורך השפיכון ואת עומק מי הזרם העליון מעל הכתר.';
$ec_lang['irr_card_weir_irregular_head']='שפיכון — פרופיל לא סדיר';
$ec_lang['irr_card_weir_irregular_desc']='השתמשו כאשר כתר השפיכון משתנה בגובה או בפרופיל — מוצאי גלישה טבעיים, מבני מדרגה ברוחב משתנה, או מבני בקרה רב-מקטעיים.';
$ec_lang['irr_card_orifice_head']='פתח — שער ראש או הסתעפות צינור';
$ec_lang['irr_card_orifice_desc']='מדדו את הזרימה דרך שער הזזה, הסתעפות צינור, או פתח מעביר. מטפל אוטומטית הן בשפיכה חופשית והן בתנאים מוצפים (זרם תחתון).';
$ec_lang['irr_card_canal_head']='תכנון &amp; ניתוח תעלה';
$ec_lang['irr_card_canal_desc']='תכננו או בדקו תעלת השקיה באמצעות נוסחת מנינג. השתמשו במחשבון הטרפזי לתעלות חדשות; במחשבון החתך הלא סדיר לחתכים טבעיים או מבונים קיימים.';
$ec_lang['irr_card_seepage_head']='חלחול תעלה &amp; יעילות הולכה';
$ec_lang['irr_card_seepage_desc']='אמדו את אובדן החלחול ממקטע תעלה באמצעות מדידות ספיקת כניסה ויציאה. חשבו את יעילות ההולכה ואת אובדן המים השנתי כדי לסייע בתעדוף השקעות ריפוד.';
$ec_lang['irr_quickref_html']='<h3>מדריך מהיר</h3><dl><dt>סכר הסטה או מבנה בקרה</dt><dd>מדדו את עומק מי הזרם העליון מעל כתר השפיכון. השתמשו ב<a href="Weir-Flow-Simple.php">שפיכון פשוט</a> עבור כתר אחיד, או ב<a href="Weir-Flow-Irregular.php">שפיכון לא סדיר</a> עבור כתר בעל פרופיל או מדורג.</dd><dt>שער ראש או הסתעפות צינור</dt><dd>מדדו את מפלס מי הזרם העליון ומפלס מי הזרם התחתון (או רום התחתית בשפיכה חופשית). השתמשו ב<a href="Orifice.php">זרימת פתח</a>. לצינור עגול, D = קוטר הצינור; לשער מלבני, הזינו רוחב W וגובה D.</dd><dt>זמן ריקון מאגר או בריכה</dt><dd>השתמשו ב<a href="Orifice-Drain-Time.php">זמן ניקוז דרך פתח</a> כדי לאמוד כמה זמן דרוש להורדת מפלס בריכה או מאגר דרך פתח תחתי &mdash; שימושי לתכנון אגירת מי השקיה.</dd><dt>תקני שטח</dt><dd>משוואות זרימת השפיכון והפתח המשמשות כאן תואמות את הנהלים של USBR <em>Water Measurement Manual</em> (מהדורה 3), הנדרשים בדרך כלל על ידי מנהלי מים ומחוזות השקיה.</dd></dl>';
...
$ec_lang['cs_main_desc']='אובדן חלחול בתעלה &amp; יעילות הולכה &mdash; שיטת ספיקת כניסה-יציאה';
...
$ec_lang['cs_Ec_target']='יעד ריפוד, E<sub>c,target</sub> <span title="יעד יעילות הולכה לאחר ריפוד; שבר 0&ndash;1" class="ec-tip">?</span>';
...
$ec_lang['cs_payback_years']='תקופת החזר <span title="החזר פשוט = סך עלות הריפוד &divide; ערך שנתי מוחזר" class="ec-tip">?</span>';
...
$ec_lang['cs_notes_1_def']='שיטת ספיקת הכניסה-יציאה אומדת את החלחול על ידי מדידת הספיקה בראש ובזנב של מקטע התעלה: Q<sub>loss</sub> = Q<sub>in</sub> &minus; Q<sub>out</sub>. יעילות ההולכה E<sub>c</sub> = Q<sub>out</sub> / Q<sub>in</sub>. הנפח השנתי מניח הפעלה רציפה בזרימה מלאה; האובדן בפועל נמוך יותר בתעלות עונתיות או בזרימה חלקית.';
$ec_lang['cs_notes_2_term']='דירוגי יעילות';
$ec_lang['cs_notes_2_def']='תעלות עפר טיפוסיות ללא ריפוד: E<sub>c</sub> = 60&ndash;80%. תעלות עפר מתוחזקות היטב: 75&ndash;85%. תעלות מרופדות בבטון: 90&ndash;98%. אובדני חלחול מעל 30% מהספיקה הנכנסת מצדיקים לרוב השקעה בריפוד. (USBR, FAO)';
$ec_lang['cs_notes_3_term']='החזר השקעת הריפוד';
$ec_lang['cs_notes_3_def']='הזינו את ערך המים ואת עלות הריפוד בכל מטבע עקבי. שטח הריפוד = אורך המקטע &times; היקף רטוב &mdash; היקף הרטוב של חתך התעלה בעומק הזרימה הנמדד (רוחב התחתית בתוספת שני המדרונות הרטובים). הערך השנתי המוחזר מניח שהתעלה המרופדת משיגה את יעד E<sub>c</sub> ברציפות. ההחזר בפועל יהיה ארוך יותר בתעלות עונתיות או אם הריפוד אינו מגיע ליעד היעילות.';
...
$ec_lang['ip_x']='מעריך ספיקת המטפטף, x <span title="0.5 למטפטפים רגילים ללא ויסות לחץ; קרוב ל-0 למטפטפים מווסתי לחץ" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='שלוחה <span title="מסומן: קטע זה הוא חלק משלוחת הבדיקה, שממנה מטפטפים בודדים שואבים מים. לא מסומן: קטע זה הוא קו ראשי, המעביר ספיקה בלבד לשלוחות שאינן בנתיב הבדיקה." class="ec-tip">?</span>';
$ec_lang['ip_count']='מטפטפים <span title="שורות שלוחה: המטפטפים בקטע זה בלבד. שורות קו ראשי: סך המטפטפים בשלוחות האחרות, השונות מזו, המסתעפות מקטע זה. עבור קטע קו הראשי המסתיים בשלוחת הבדיקה, נכללות גם כל השלוחות שמעבר לנקודה זו לאורך הקו הראשי, וכן שלוחות החולקות אותו צומת (למשל שלוחה מהצד הנגדי) &mdash; גם ספיקתן מסתעפת מקטע זה." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_e']='e <span title="גובה החספוס לפי דרסי-וייסבך" class="ec-tip">?</span>';
$ec_lang['ip_km']='k<sub>m</sub> <span title="מקדם הפסד מקומי כללי לאביזרים/מגופים/מחברים של קטע זה (מינימום מומלץ &ge;0.5)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='רום מורד <span title="רום קצה מורד הזרם של קטע זה. אופציונלי בשורות פנימיות (אם נשאר ריק, ברירת המחדל אופקי / זהה לצומת שמעליו). חובה בשורה האחרונה: ערך זה הוא רום המטפטף האחרון, הקובע ישירות את לחץ האספקה הנדרש." class="ec-tip">?</span>';
...
$ec_lang['ip_hl']='h<sub>L</sub> <span title="סך הפסד הקטע, h_f + h_m" class="ec-tip">?</span>';
$ec_lang['ip_pressure_warn']='לחץ נמוך/שלילי &mdash; בדקו תנאים תת-אטמוספריים';
$ec_lang['ip_pressure_warn_short']='נמוך';
$ec_lang['ip_h_far']='לחץ המטפטף האחרון';
$ec_lang['ip_q_supply']='ספיקת אספקה של נתיב הבדיקה, Q<sub>supply</sub> <span title="הספיקה הנכנסת לנתיב הבדיקה הממודל בלבד — לכל האזור/המערכת, ראו Q_zone בתכנון היישום למטה." class="ec-tip">?</span>';
...
$ec_lang['ip_dp_avg']='אומדן &Delta;לחץ, ממוצע לעומת שלוחת הבדיקה <span title="בכמה גבוה (או נמוך) אתם מעריכים ששלוחה טיפוסית פועלת בהשוואה לשלוחת בדיקה זו. שלוחת הבדיקה נבחרת בכוונה כמקרה הגרוע ביותר המשוער, כך שהממוצע שלה עצמה הוא הערכת חסר לממוצע השדה &mdash; אם נותר 0, בדיקת האחידות ומספרי תכנון היישום למטה משתמשים בממוצע של שלוחת הבדיקה עצמה (ככל הנראה אופטימי) כפי שהוא." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='אומדן ספיקת מטפטף ממוצעת לשדה, q<sub>avg,field</sub> <span title="q_avg_lateral מחושב מחדש בלחץ של כל שורת שלוחה, בתוספת הפרש הלחץ שהוזן למעלה &mdash; ניסיון לתקן את העובדה ששלוחת הבדיקה היא המקרה הגרוע המשוער, לא שלוחה מייצגת. מזין הן את בדיקת האחידות והן את סעיף תכנון היישום למטה." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='בדיקת אחידות, q<sub>last</sub>/q<sub>avg,field</sub> <span title="הספיקה המחושבת של המטפטף האחרון חלקי אומדן ספיקת המטפטף הממוצעת לשדה &mdash; זהו קירוב לאחידות ההתפלגות ברבע התחתון המקובלת (ממוצע הקבוצה הנמוכה &divide; ממוצע האוכלוסייה); הקירוב מבוסס על מדגם ממודל קטן ותיקון שהמשתמש אמד, ולא על מדגם סטטיסטי של שדה מלא. ערכים של 1 ומעלה אפשריים ותקפים: פירושם רק שלחץ המטפטף האחרון נמצא בגובה או מעל אומדן ממוצע השדה, כך שמטפטף אחר הוא נקודת הלחץ הנמוכה ביותר. הדבר יכול לנבוע מכך שהמטפטף האחרון נמצא בקרקע נמוכה, או מכך שאומדן &Delta;הלחץ קטן מדי." class="ec-tip">?</span>';
$ec_lang['ip_worst_case_warn']='הלחץ במטפטף הבדיקה &ge; לחץ האספקה. סביר שזה אינו המטפטף במקרה הגרוע ביותר, או שניתן להקטין את הצינורות.';
$ec_lang['ip_q_ratio']='ספיקת המטפטף האחרון &divide; ספיקת התכנון, q<sub>last</sub>/q<sub>design</sub> <span title="זהו מדד שונה מהקירוב שלנו למדד האחידות המקובל." class="ec-tip">?</span>';
...
$ec_lang['ip_notes_1_def']='מנחש את הלחץ במטפטף האחרון (המרוחק ביותר), ולאחר מכן מתקדם עם קו גובה האנרגיה בחזרה לעבר האספקה, קטע אחר קטע, תוך הוספת הפסדי חיכוך והפסדים מקומיים בדרך. הרום וגובה המהירות מנוכים בכל צומת כדי לדווח את הלחץ בפועל שם. הלחץ המנוחש בקצה הרחוק מכוונן (בשיטת החצייה) עד שלחץ האספקה הנדרש המחושב תואם את לחץ האספקה שהוזן &mdash; אותה בעיית לולאה סגורה שפותר פותר זרימת הצינורות במחשבון זרימת צינור מנינג, מורחבת לרשת מסתעפת.';
$ec_lang['ip_notes_2_term']='קטעי קו ראשי לעומת שלוחה';
$ec_lang['ip_notes_2_def']='כל שורה היא קטע אחד לאורך הנתיב ההידראולי הגרוע ביותר היחיד (נתיב הבדיקה) מהאספקה עד המטפטף האחרון. קטע קו ראשי מעביר ספיקה רק לשלוחות שאינן בנתיב הבדיקה, כך שהשאיבה שלו היא הכפלה פשוטה (ספיקת תכנון &times; סך מספר המטפטפים בקטע) &mdash; ללא רגישות ללחץ המקומי. הקו הראשי הוא צינור גזע משותף, ולכן קטע קו הראשי המסתיים בשלוחת הבדיקה חייב לכלול לא רק שלוחות שבין נקודות הקצה שלו אלא גם כל שלוחה נוספת בהמשך הקו הראשי מעבר לנקודה זו, או החולקת את אותו צומת (למשל שלוחה בצד הנגדי) &mdash; ספיקתן עוברת דרך אותו קטע לפני שהיא מתפצלת, בין שהן מופיעות במקום אחר בטבלה זו ובין שלא. קטע שלוחה הוא מקטע של שלוחת הבדיקה עצמה: ספיקת המטפטף מחושבת מהלחץ המקומי בפועל באמצעות q = k&middot;H<sup>x</sup>, והפסד החיכוך מוקטן במקדם F(n) של כריסטיאנסן כדי לשקף את ירידת הספיקה ככל שכל מטפטף בקטע שואב מים.';
$ec_lang['ip_notes_3_term']='מגבלות';
$ec_lang['ip_notes_3_def']='מדגמן לחץ אספקה קבוע אחד (ללא עקומת משאבה), נתיב בדיקה יחיד בלבד (לא כל השדה), ועקומת מטפטף דו-פרמטרית (קבעו את המעריך קרוב ל-0 כדי לקרב מטפטף מווסת לחץ). מדווחים שני יחסי אחידות שונים, המופרדים בכוונה: q<sub>last</sub>/q<sub>avg,field</sub> הוא קירוב לאחידות ההתפלגות ברבע התחתון המקובלת (ממוצע הקבוצה הנמוכה &divide; ממוצע האוכלוסייה); אך קירוב זה מבוסס על מדגם ממודל קטן ותיקון שהמשתמש אמד, במקום המדגם הסטטיסטי המקובל של שדה מלא. כמו כן, שלוחת הבדיקה נבחרת בכוונה כמקרה הגרוע ביותר המשוער, כך שהממוצע הגולמי הבלתי-מתוקן שלה היה ממעיט בהערכת ממוצע השדה האמיתי וגורם לאחידות להיראות טובה יותר משהיא באמת; קלט &Delta;הלחץ קיים בדיוק כדי לנטרל הטיה זו. ערכים של 1 ומעלה עדיין אפשריים לאחידות: פירושם רק שלחץ המטפטף האחרון נמצא בגובה או מעל אומדן ממוצע השדה, כך שמטפטף אחר הוא נקודת הלחץ הנמוכה ביותר. הדבר יכול לנבוע מכך שהמטפטף האחרון נמצא בקרקע נמוכה, או מכך שאומדן &Delta;הלחץ קטן מדי. q<sub>last</sub>/q<sub>design</sub> היא בדיקה שונה, שאינה מדד אחידות, מול הספיקה הנקובה של היצרן &mdash; שימושית לזיהוי מערכת בעלת לחץ יתר או חסר באופן כללי, אך זו בדיקה נפרדת שיש לקרוא לצד מספר האחידות, מכיוון שספיקת התכנון/הנקובה אינה תלויה בלחץ העבודה הממוצע בפועל של המערכת.';
$ec_lang['ip_notes_4_term']='התייחסות';
$ec_lang['ip_notes_4_def']='Christiansen, J.E. (1942). &ldquo;Irrigation by sprinkling.&rdquo; California Agricultural Experiment Station Bulletin 670. תקני ASAE/ASABE לתכנון מיקרו-השקיה משתמשים בגישת הפסד חיכוך רב-יציאה זהה.';
$ec_lang['ip_notes_5_term']='תכנון היישום';
$ec_lang['ip_notes_5_def']='קצב היישום וספיקת המערכת/הגוש משתמשים באומדן ספיקת המטפטף הממוצעת לשדה (q<sub>avg,field</sub> &mdash; הממוצע של שלוחת הבדיקה עצמה, מתוקן באומדן ה-&Delta;לחץ שהוזן), ולא בקצב מנוחש: PR = q<sub>avg,field</sub> / A<sub>e</sub>, הניזון מהערך הממודל המתוקן. המרווחים ומספרי השלוחות/המטפטפים ברמת המערכת הם קלטים נפרדים כאן, מכיוון שנתיב הבדיקה מדגמן רק ענף אחד של המקרה הגרוע ביותר, לא כל שלוחה בשדה.';
$ec_lang['irr_card_pressure_head']='לחץ השקיה &amp; אחידות';
