...
$ec_lang['lpn_main_menu']='רשת צנרת טבעתית (ממשק מפה) — גרסה מוקדמת';
$ec_lang['lpn_main_title']='גרסה מוקדמת: מחשבון חינמי מקוון לרשת צנרת טבעתית עם ממשק מפה';
$ec_lang['lpn_main_desc']='גרסה מוקדמת — לחץ וספיקה ברשת צנרת טבעתית שאתם משרטטים על מפה';
