...
$ec_lang['lpn_settings_engine_epanet_tip']='מריץ את פותר EPANET המקורי מה-US EPA, כאן בדפדפן שלכם. הפותר המובנה נותן את אותן תשובות והוא מהיר יותר, לכן השאירו אפשרות זו כבויה אלא אם אתם זקוקים ל-EPANET עצמו.';
...
$ec_lang['lpn_scenario_base_value']='בסיס: {value}';
