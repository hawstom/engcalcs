...
$ec_lang['mpf_note_1']='<dl><dt>זהו הזרימה והעומק בתוך צינור <em>ארוך אינסופית</em>.</dt><dd>כדי לקבל את הזרימה לתוך הצינור ייתכן שיידרש גובה מים עליון גבוה הרבה יותר. הוסף לפחות 1.5 פעמים עומד המהירות כדי לקבל את גובה המים העליון, או <a target="_blank" href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">ראה את המדריך הקצר שלי</a> לחישובי גובה מים עליון לתעלות ניקוז סטנדרטיות באמצעות HY-8.</dd>';
...
$ec_lang['mphl_total_junction_k_tip']='מקדם הפסד מקומי, k<sub>m</sub>. הפסדים אלו מתרחשים בצמתי צנרת, בכניסות, ביציאות, בעיקולים ובשסתומים — המונח "משני" מקובל אך עלול להטעות; בקו קצר הם יכולים להשתוות להפסדי החיכוך או לעלות עליהם. ערכי k אופייניים: כניסת יניקה חדה 0.5, כל עיקול של 45° 0.2–0.3, שסתום שער (פתוח לגמרי) 0.1, שסתום פרפר 0.2, יציאה (למאגר או לאטמוספרה) 1.0. יש לסכם את כל האביזרים לקבלת k<sub>m</sub> הכולל. ברירת המחדל 2.0 מניחה כניסה אחת, יציאה אחת ושני עיקולים של 45°.';
...
$ec_lang['mtc_solve_for_y']='פתרון עבור עומק, y, בהינתן Q';
$ec_lang['mtc_solve_desc']='באמצעות b, z<sub>1</sub>, z<sub>2</sub>, S ו-n מטופס המחשבון, מוצא את העומק עבור Q נתון.';
...
$ec_lang['mhp_notes_6_def']='יעילות המתקן האופיינית &eta; נעה בין 0.70 ל-0.85 לטורבינות Pelton ורוחב-זרימה הנפוצות בהידרו-כוח זעיר. השתמשו ב-0.75 כאומדן ראשוני שמרני.';
...
$ec_lang['irr_card_canal_desc']='תכננו או בדקו תעלת השקיה באמצעות נוסחת Manning. השתמשו במחשבון הטרפזי לתעלות חדשות; במחשבון החתך הלא סדיר לחתכים טבעיים או מבונים קיימים.';
...
$ec_lang['rc_apron_length']='אורך מצוע היציאה (15 × D<sub>50</sub>) <span title="נדרש לתמיכה מבנית בשכבת הסלע במגלשה. &quot;מפלס המים התחתון המינימלי הנוצר כתוצאה מקטע היציאה והתנגדות הערוץ שבמורד מספיק כדי להבטיח את יציבות שכבת הסלע בקטע היציאה.&quot; (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
