...
$ec_lang['lpn_time_run_note']='Ви бачите мережу в перший момент звітування. Налаштування «Розраховувати автоматично» вимкнено, тож результати для пізніших моментів не оновлюються, поки ви працюєте. Натисніть кнопку «Розрахувати», щоб оновити їх.';
...
$ec_lang['lpn_pane_paste_note']='Ця таблиця призначена для введення значень шляхом вставлення з електронної таблиці в рядки, які вже існують. Якщо це не відповідає вашим потребам, скористайтеся «Довідка, Виправити щось», щоб повідомити нас.';
...
$ec_lang['lpn_find_filter_table']='Таблиця для фільтрування';
...
$ec_lang['lpn_georef_projected']='Цей проєкт уже вказує картографічну проєкцію, тож його координати не можна розмістити на карті вдруге.';
...
$ec_lang['lpn_new_coordsys_geo']='Географічна проєкція';
$ec_lang['lpn_new_coordsys_geo_tip']='Виберіть географічну проєкцію. Використовуйте WGS 84 / Pseudo-Mercator EPSG:3857 для широти/довготи.';
$ec_lang['lpn_new_coordsys_local']='Локальна, схематична або власна';
$ec_lang['lpn_new_coordsys_local_tip']='Не прив’язано до географії. Приєднайте власне фонове зображення або жодного.';
$ec_lang['lpn_new_crs']='Картографічна проєкція';
$ec_lang['lpn_new_crs_tip']='Проєкція, в якій уже виміряно ваші координати. Координати зберігаються точно так, як ви їх ввели, і нічого не перетворюється. Цей вибір постійний; єдиний спосіб перевести мережу в інші координати — «Файл, Відкрити в нових координатах», і це наближено. UTM є домінантним світовим стандартом, у регіоні можуть бути власні звичаї, а землевпорядник — той, кого варто запитати, якщо ви не впевнені.';
...
$ec_lang['lpn_crs_place_projected']='Проєкт із проєкцією відкривається на власній площині, а не в місці, яке ви шукали. Щоб розмістити цю площину на Землі, потрібне перетворення координат, якого ця сторінка ще не має.';
$ec_lang['lpn_crs_none']='Без прив’язки до географії';
...
$ec_lang['lpn_menu_cue']='Почніть із меню вгорі. Використовуйте панель інструментів для швидкого доступу.';
