...
$ec_lang['lpn_main_menu']='Кільцева трубопровідна мережа (інтерфейс з картою)';
$ec_lang['lpn_main_title']='Безкоштовний онлайн-калькулятор кільцевої трубопровідної мережі з інтерфейсом карти';
$ec_lang['lpn_main_desc']='Тиск і витрата в кільцевій трубопровідній мережі, яку ви креслите на карті';
