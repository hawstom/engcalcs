...
$ec_lang['lpn_empty_hint']='Почніть з додавання фонового зображення або резервуара з панелі інструментів, або відкрийте меню «Файл → Новий проєкт», щоб почати з прикладу.';
...
$ec_lang['lpn_new_from_examples']='З прикладів';
...
$ec_lang['lpn_new_example_us']='Базова мережа, одиниці США (gpm)';
$ec_lang['lpn_new_example_si']='Базова мережа, одиниці СІ (л/с)';
...
$ec_lang['lpn_inp_report_counts']='{nodes} вузлів і резервуарів, {links} труб і насосів, в одиницях {units}.';
...
$ec_lang['lpn_inp_drop_tcv']='Ці регулювальні дросельні клапани перенесено як дуже короткі труби з такими самими місцевими втратами. Вода поводиться так само; елемент — інший.';
$ec_lang['lpn_inp_drop_valve']='Ці клапани регулюють тиск або витрату, а на цій сторінці немає такого елемента. Вони перенесені як відкриті труби, тому мережа лишається з\'єднаною, але більше нічим не керується.';
...
$ec_lang['lpn_inp_drop_units']='Одиниці витрати в цьому файлі не розпізнано, тому прийнято галони на хвилину. Перевірте кожне число, перш ніж використовувати відповіді.';
...
$ec_lang['lpn_notes_1_def']='Розраховує один набір витрат споживання за раз, використовуючи той самий алгоритм глобального градієнта, що й EPANET. Не моделює, як мережа змінюється з часом.';
$ec_lang['lpn_notes_2_term']='Не моделюється';
$ec_lang['lpn_notes_2_def']='Ємності-накопичувачі, якість води та регулювальні клапани, що самостійно відкриваються й закриваються (PRV, PSV, FCV), не моделюються. Труба може мати фіксовані місцеві втрати, але не клапан, чий стан відкрито/закрито залежить від витрати, яку розраховують.';
...
$ec_lang['lpn_diag_no_fixed_head']='Додайте резервуар. Перш ніж мережу можна буде розрахувати, потрібен хоча б один відомий рівень води.';
...
$ec_lang['lpn_backdrop_position_prompt1']='Клацніть на будь-якій точці фонового зображення. Це точка, яку ви будете переміщувати.';
$ec_lang['lpn_backdrop_position_prompt2']='Виберіть, куди має переміститися ця точка, і клацніть «Продовжити».';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Запускає розв\'язувач EPANET від Агентства з охорони довкілля США (US EPA) прямо у вашому браузері. Вбудований розв\'язувач дає ті самі відповіді й працює швидше, тож залиште це вимкненим, якщо вам не потрібен саме EPANET.';
...
$ec_lang['lpn_settings_text_size']='Розмір тексту';
$ec_lang['lpn_settings_text_size_map']='Відстань на карті';
$ec_lang['lpn_settings_text_size_screen']='Пікселі екрана';
// Symbols (node circles, pipe width, flow arrows, vertex handles) are sized as a MULTIPLE of the
// text size rather than in their own units (Tom, 2026-07-30), so one number changes how big
// everything on the map is and symbols follow the text into map-vs-screen units automatically.
$ec_lang['lpn_settings_symbol_size']='Розмір символів (відносно тексту)';
...
$ec_lang['lpn_settings_text_size_units']='Одиниці розміру тексту';
...
$ec_lang['lpn_scenario_base_value']='Базовий: {value}';
