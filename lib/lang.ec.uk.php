...
$ec_lang['lpn_labels_prefix_id_tip']='Текст, показаний перед ID на карті. Залиште поле порожнім, і ID показуватиметься сам собою, починаючись з літери, яку йому надано, наприклад J1 або L1.';
...
$ec_lang['lpn_push_elements']='Вузли та труби:';
...
// Sprint 316 (2026-08-14): storage tanks, control valves, scenarios.
...
// Translation batch uk-1 (Task: uk sprint 2026-08)
...
$ec_lang['lpn_units_group_inputs']='Одиниці вхідних даних';
$ec_lang['lpn_units_group_results']='Одиниці результатів';
...
$ec_lang['lpn_georef_menu']='Перетворити на lat/lon…';
$ec_lang['lpn_georef_tip']='Із локальної сітки в реальний світ. Розмістіть креслення, зроблене на сітці XY, у географічних координатах, щоб воно лягло на карту вулиць там, де йому належить бути. Кожне введене вами число залишається таким, як є, — змінюються лише X і Y, які стають довготою та широтою.';
...
// Translation batch uk-2 (Task: uk sprint 2026-08)
...
$ec_lang['lpn_pane_tab_junctions_tip']='Усі вузли у вигляді таблиці, яку можна сортувати та редагувати.';
$ec_lang['lpn_pane_junctions_none']='У цій мережі ще немає вузлів.';
...
// Translation batch uk-3 (Task: uk sprint 2026-08)
...
// Translation batch uk-4 (Task: uk sprint 2026-08)
...
$ec_lang['lpn_settings_sec_elements']='Нові елементи';
