...
$ec_lang['bpn_line_problem']='Перевірте стовпець «Верхня за течією»: ділянка вказує на невідомий ID, посилається сама на себе або утворює кільце, тому частина мережі не з\'єднана з джерелом. Такі ділянки залишаються нерозрахованими.';
$ec_lang['bpn_bad_id_short']='Мережа';
