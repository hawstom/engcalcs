...
$ec_lang['lpn_main_title']='Безкоштовний онлайн-калькулятор мережі водопостачання на основі рушія EPANET';
...
$ec_lang['lpn_inp_drop_tanks']='Ємності-накопичувачі пропущено. У цієї сторінки є резервуари, що утримують один фіксований рівень води. Ємність-накопичувач не утримує фіксований рівень, тому вона не є резервуаром.';
$ec_lang['lpn_inp_drop_tank_links']='Ці труби пропущено, бо вони з\'єднуються з пропущеною ємністю.';
...
$ec_lang['lpn_settings_engine_epanet']='Розраховувати рушієм EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='Запускає оригінальний рушій EPANET від Агентства з охорони довкілля США (US EPA) прямо у вашому браузері. Вбудований розв\'язувач дає ті самі відповіді й працює швидше, тож залиште це вимкненим, якщо вам не потрібен саме EPANET.';
$ec_lang['lpn_engine_loading']='Завантаження рушія EPANET…';
$ec_lang['lpn_engine_failed']='Не вдалося завантажити рушій EPANET. Замість нього показано вбудований розв\'язувач.';
