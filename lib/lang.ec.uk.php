...
$ec_lang['lpn_field_text_match_pipe']='Узгодити з кутом труби';
...
$ec_lang['lpn_examples_size']='{nodes} вузлів, {links} труб';
...
$ec_lang['lpn_ex_net3_desc']='Великий приклад EPANET: 97 вузлів, дві ємності й річкове джерело. Варто відкрити, щоб побачити, як виглядає модель реального розміру на карті.';
...
$ec_lang['lpn_new_blank_us']='Порожній проєкт, одиниці США (gpm)';
$ec_lang['lpn_new_blank_si']='Порожній проєкт, одиниці СІ (л/с)';
...
$ec_lang['lpn_inp_drop_patterns']='Графіки витрати споживання пропущено. Ця сторінка розраховує один момент часу, тому кожна витрата дорівнює числу, записаному у файлі.';
...
$ec_lang['lpn_inp_drop_controls']='Керування та правила пропущено. Кожна труба, насос і клапан перенесені в стані, записаному у файлі, і цей стан не змінюється.';
$ec_lang['lpn_inp_drop_eps']='Цей файл описує симуляцію, що триває протягом певного періоду часу. Ця сторінка розраховує один момент, тому перенесено лише початкові умови.';
...
$ec_lang['lpn_pump_point1']='Точка 1 (обов\'язкова)';
$ec_lang['lpn_pump_point2']='Точка 2 (необов\'язкова)';
$ec_lang['lpn_pump_point3']='Точка 3 (необов\'язкова)';
...
$ec_lang['lpn_settings_defaults']='Початкові значення';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Запускає розв\'язувач EPANET від Агентства з охорони довкілля США (US EPA) прямо у вашому браузері. Обидва розв\'язувачі дають однакові відповіді, і на мережі такого розміру різниці у швидкості ви не помітите. Коли ви вмикаєте це вперше, завантажується близько 650 КБ, які потім зберігаються на цьому пристрої.';
...
$ec_lang['lpn_settings_readability_bias']='Градусів ліворуч від вертикалі, перш ніж підпис перевертається';
