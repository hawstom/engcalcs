...
$ec_lang['lpn_settings_engine_epanet_tip']='Запускає оригінальний розв\'язувач EPANET від Агентства з охорони довкілля США (US EPA) прямо у вашому браузері. Вбудований розв\'язувач дає ті самі відповіді й працює швидше, тож залиште це вимкненим, якщо вам не потрібен саме EPANET.';
