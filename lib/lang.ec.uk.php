...
$ec_lang['lpn_file_convert_as']='Відкрити xy-файл на карті…';
$ec_lang['lpn_file_convert_as_tip']='Відкриває файл проєкту або файл EPANET у новій вкладці проєкту на цій сторінці, на карті вулиць. Ви розміщуєте креслення на світі вручну: панорамуйте й масштабуйте до потрібної ділянки, тоді змінюйте розмір і повертайте, щоб підігнати. Якщо x та y у файлі вже є довготою та широтою, натисніть кнопку «Це вже lat/lon», і мережа одразу переміститься туди, куди належить. Кожне введене вами число лишається таким, як є.';
