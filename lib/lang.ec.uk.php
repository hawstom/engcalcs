...
$ec_lang['mtc_solve_for_y']='Визначити глибину, y, за заданою Q';
$ec_lang['mtc_solve_desc']='Використовуючи b, z<sub>1</sub>, z<sub>2</sub>, S та n з форми калькулятора, знаходить глибину для заданої Q.';
