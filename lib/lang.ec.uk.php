...
$ec_lang['lpn_main_menu']='Кільцева трубопровідна мережа (інтерфейс з картою) — ПОПЕРЕДНЯ ВЕРСІЯ';
$ec_lang['lpn_main_title']='ПОПЕРЕДНЯ ВЕРСІЯ: Безкоштовний онлайн-калькулятор кільцевої трубопровідної мережі з інтерфейсом карти';
$ec_lang['lpn_main_desc']='ПОПЕРЕДНЯ ВЕРСІЯ — Тиск і витрата в кільцевій трубопровідній мережі, яку ви креслите на карті';
