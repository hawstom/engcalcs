...
$ec_lang['mpf_velocity_head']='<span class="ec-help" title="حرکی توانائی بطور پانی کے کالم کی اونچائی، v&sup2;/2g">رفتار سر، h<sub>v</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['mphl_note_1']='<dl><dt>یہ حاسبہ پائپ کی بلندی کو مدنظر نہیں رکھتا۔</dt><dd>اگر HGL کسی بھی مقام پر پائپ کی چوٹی سے نیچے چلا جائے تو یہ حساب درست نہ ہو سکتا۔</dd><dt>کھلے ان لیٹ (پائپنالی) کے معاملے میں، ان لیٹ کنٹرول کی حالتوں کی جانچ ضروری ہے۔</dt><dd>1. بالادست HGL، بالادست عام گہرائی بہاؤ بلندی سے اوپر (اور پائپ سے بھی اونچی!) ہونی چاہیے۔</dd><dd>2. پائپنالی کا سر آب بالادست HGL کے مقابلے میں بالادست EGL سے بہتر ظاہر ہوتا ہے۔</dd><dd>3. HY-8 استعمال کرتے ہوئے سادہ معیاری پائپنالی سر آب حساب کے لیے <a target="_blank" href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">میرا 2 منٹ کا ٹیوٹوریل</a> دیکھیں۔</dd>';
...
$ec_lang['mtc_sgrock']='<span class="ec-help" title="پانی کے مقابلے میں کثافت۔ کچلے ہوئے پتھر کے لیے عام طور پر &asymp; 2.65۔">پتھر کی مخصوص کثافت، sg <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_notes_1_def']='آمد-خروج طریقہ نہر کے حصے کے سر اور دم پر بہاؤ ناپ کر رساؤ کا تخمینہ لگاتا ہے: Q<sub>loss</sub> = Q<sub>in</sub> &minus; Q<sub>out</sub>۔ انتقالی کارکردگی E<sub>c</sub> = Q<sub>out</sub> / Q<sub>in</sub>۔ سالانہ حجم مسلسل مکمل بہاؤ آپریشن فرض کرتا ہے؛ موسمی یا جزوی بہاؤ والی نہروں میں اصل نقصان کم ہوگا۔';
$ec_lang['cs_notes_2_term']='کارکردگی کے درجات';
$ec_lang['cs_notes_2_def']='عام غیر استرکاری شدہ مٹی کی نہریں: E<sub>c</sub> = 60&ndash;80%۔ اچھی طرح دیکھ بھال کی گئی مٹی کی نہریں: 75&ndash;85%۔ کنکریٹ استرکاری نہریں: 90&ndash;98%۔ آمد کے 30% سے زیادہ رساؤ نقصان اکثر استرکاری میں سرمایہ کاری کو درست ثابت کرتا ہے۔ (USBR، FAO)';
$ec_lang['cs_notes_3_term']='استرکاری کی واپسی';
$ec_lang['cs_notes_3_def']='کسی بھی مطابقت پذیر کرنسی میں پانی کی قیمت اور استرکاری کی لاگت درج کریں۔ استرکاری کا رقبہ = حصے کی لمبائی &times; تر محیط — ناپی گئی بہاؤ کی گہرائی پر نہر کے عرضی مقطع کا تر محیط (تہ کی چوڑائی جمع دونوں تر ڈھلانیں)۔ سالانہ بحال شدہ قیمت یہ فرض کرتی ہے کہ استرکاری شدہ نہر مسلسل مطلوبہ E<sub>c</sub> حاصل کرتی ہے۔ موسمی نہروں میں، یا اگر استرکاری مطلوبہ کارکردگی تک نہ پہنچے تو اصل واپسی مدت طویل تر ہوگی۔';
...
$ec_lang['ip_notes_1_def']='آخری (سب سے دور) ایمیٹر پر دباؤ کا اندازہ لگاتا ہے، پھر انرجی گریڈ لائن کو سپلائی کی طرف واپس، حصہ بہ حصہ، لے جاتے ہوئے راستے میں رگڑ اور مقامی نقصانات جمع کرتا ہے۔ ہر نوڈ پر بلندی اور رفتاری ہیڈ کو منہا کر کے وہاں کا حقیقی دباؤ رپورٹ کیا جاتا ہے۔ اندازہ کیا گیا دور والے سرے کا دباؤ (تنصیف کے ذریعے) اُس وقت تک درست کیا جاتا رہتا ہے جب تک شمار شدہ مطلوبہ سپلائی دباؤ درج شدہ سپلائی دباؤ کے برابر نہ ہو جائے &mdash; یہ وہی بند حلقے کا مسئلہ ہے جسے Manning پائپ بہاؤ حاسبہ کا حل کنندہ حل کرتا ہے، جسے یہاں شاخ دار جال تک وسیع کیا گیا ہے۔';
$ec_lang['ip_notes_2_term']='مرکزی بمقابلہ لیٹرل حصے';
$ec_lang['ip_notes_2_def']='ہر قطار سپلائی سے آخری ایمیٹر تک واحد ہائیڈرولک لحاظ سے بدترین راستے (ٹیسٹ پاتھ) کا ایک حصہ ہے۔ مرکزی حصہ صرف اُن لیٹرلز کو بہاؤ منتقل کرتا ہے جو ٹیسٹ پاتھ پر نہیں، اس لیے اس کا اخراج ایک سادہ ضرب ہے (ڈیزائن بہاؤ &times; حصے کے کل ایمیٹرز کی تعداد) &mdash; مقامی دباؤ کی کوئی حساسیت نہیں۔ مرکزی لائن ایک مشترکہ تنے کا پائپ ہے، اس لیے ٹیسٹ لیٹرل لائن پر ختم ہونے والے مرکزی لائن کے حصے میں نہ صرف اس کے اپنے سروں کے درمیان کے لیٹرلز شامل ہونے چاہئیں بلکہ وہ تمام لیٹرلز بھی جو اس مقام سے آگے مرکزی لائن پر ہیں، یا وہی جوڑ بانٹتے ہیں (مثلاً مخالف سمت کا لیٹرل) &mdash; ان کا بہاؤ الگ ہونے سے پہلے اسی حصے سے گزرتا ہے، چاہے وہ اس جدول میں کہیں اور نظر آئیں یا نہ آئیں۔ لیٹرل حصہ خود ٹیسٹ لیٹرل کا ایک سیگمنٹ ہے: ایمیٹر کا اخراج اصل مقامی دباؤ سے q = k&middot;H<sup>x</sup> کے ذریعے شمار ہوتا ہے، اور رگڑ کا نقصان Christiansen کے F(n) عامل سے کم کیا جاتا ہے تاکہ حصے میں ہر ایمیٹر کے پانی نکالنے سے بہاؤ کے بتدریج کم ہونے کا حساب رکھا جا سکے۔';
