...
$ec_lang['lpn_field_text_match_pipe']='قریب ترین لنک سے ملائیں';
...
$ec_lang['lpn_time_format_tip']='وقت گھنٹے اور منٹ کی صورت میں لکھیں، جیسے 2:30۔ سادہ عدد کا مطلب گھنٹے ہیں؛ اپنے لفظ کے ساتھ عدد کا مطلب وہی لفظ ہے: 30 منٹ۔';
$ec_lang['lpn_time_running']='EPANET انجن کے ساتھ پورا وقفہ حل کیا جا رہا ہے۔';
$ec_lang['lpn_time_no_engine']='بلٹ ان حل کار ایک وقت میں صرف ایک لمحہ حل کرتا ہے، اس لیے یہ نیٹ ورک صرف {time} پر ہے: طلبیں اسی لمحے کے پیٹرن ضارب لیے ہوئے ہیں، اور ہر ٹینک بھرنے اور خالی ہونے کے بجائے اپنی ابتدائی سطح پر ہی رہتا ہے۔ پورا عرصہ چلانے والا EPANET انجن حاصل کرنے کے لیے ایک بار انٹرنیٹ سے جڑیں۔';
