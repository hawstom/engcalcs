...
$ec_lang['lpn_push_elements']='نوڈز اور پائپ:';
...
$ec_lang['lpn_units_group_inputs']='داخلی اندراج کے یونٹس';
$ec_lang['lpn_units_group_results']='نتائج کے یونٹس';
...
$ec_lang['lpn_georef_menu']='عرض بلد/طول بلد میں تبدیل کریں…';
$ec_lang['lpn_georef_tip']='مقامی گرڈ سے حقیقی دنیا میں۔ XY گرڈ پر بنائی گئی ڈرائنگ کو جغرافیائی احداثیات پر رکھیں، تاکہ یہ سڑکوں کے نقشے پر اپنی صحیح جگہ پر بیٹھے۔ آپ نے جو بھی عدد ٹائپ کیا وہ ویسا ہی رہتا ہے — صرف X اور Y ایک طول بلد اور ایک عرض بلد بن جاتے ہیں۔';
...
$ec_lang['lpn_pane_tab_junctions_tip']='ہر جنکشن ایک جدول کی شکل میں، جسے آپ ترتیب دے سکتے اور ترمیم کر سکتے ہیں۔';
$ec_lang['lpn_pane_junctions_none']='اس نیٹ ورک میں ابھی کوئی جنکشن نہیں ہے۔';
...
$ec_lang['lpn_profile_pick']='نقشے پر نوڈز پر کلک کر کے انہیں راستے میں شامل کریں';
...
$ec_lang['lpn_settings_sec_elements']='نئے عناصر';
