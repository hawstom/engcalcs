...
$ec_lang['mpf_flow_tip']='بہاؤ اور گہرائی ایک لامحدود لمبے پائپ کے لیے حساب کی گئی ہے۔ اس بہاؤ کو پائپ میں داخل کرنے کے لیے زیادہ ہیڈ واٹر گہرائی درکار ہو سکتی ہے۔ تفصیلات اور تدریسی ویڈیو کے لیے نیچے نوٹس دیکھیں۔';
...
$ec_lang['mphl_note_1']='<dl><dt>یہ کیلکولیٹر پائپ کی بلندی کو مدنظر نہیں رکھتا۔</dt><dd>اگر HGL کسی بھی مقام پر پائپ کی چوٹی سے نیچے چلا جائے تو یہ حساب درست نہ ہو سکتا۔</dd><dt>کھلے ان لیٹ (پائپنالی) کے معاملے میں، ان لیٹ کنٹرول کی حالتوں کی جانچ ضروری ہے۔</dt><dd>1. بالادست HGL، بالادست عام گہرائی بہاؤ بلندی سے اوپر (اور پائپ سے بھی اونچی!) ہونی چاہیے۔</dd><dd>2. پائپنالی کا سر آب بالادست HGL کے مقابلے میں بالادست EGL سے بہتر ظاہر ہوتا ہے۔</dd><dd>3. HY-8 استعمال کرتے ہوئے سادہ معیاری پائپنالی سر آب حساب کے لیے <a target="_blank" href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">میرا 2 منٹ کا ٹیوٹوریل</a> دیکھیں۔</dd>';
...
$ec_lang['mtc_solve_for_y']='دیے گئے Q کے لیے گہرائی y کا حل نکالیں';
$ec_lang['mtc_solve_desc']='کیلکولیٹر فارم سے b، z<sub>1</sub>، z<sub>2</sub>، S اور n استعمال کرتے ہوئے، دیے گئے Q کے لیے گہرائی معلوم کرتا ہے۔';
$ec_lang['mtc_solver_no_solution']='ان چینل ان پٹس کے ساتھ دیے گئے Q کے لیے کوئی حل نہیں ملا۔';
// Weir Flow Simple
