...
$ec_lang['bpn_line_problem']='اپ سٹریم کالم کی جانچ کریں: کوئی لائن نامعلوم ID کی طرف اشارہ کرتی ہے، خود کا حوالہ دیتی ہے، یا لوپ بناتی ہے، جس کی وجہ سے نیٹ ورک کا کچھ حصہ سورس سے منسلک نہیں ہے۔ ایسی لائنیں غیر حل شدہ رہ جاتی ہیں۔';
$ec_lang['bpn_bad_id_short']='نیٹ ورک';
