...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="ڈارسی-وائسباخ کھردرا پن کی اونچائی"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_length']='<span class="ec-help" title="داخلہ (آبی سرچشمہ ڈھانچہ) کی ترسیلی پائپ یا فلیوم کی لمبائی">لمبائی، L <span class="ec-tip">?</span></span>';
$ec_lang['mhp_roughness']='پائپ کی کھردرت، e';
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">ثانوی نقصان عامل، k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">حرکیاتی چپچپاہٹ، ν <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_qt']='<span class="ec-help" title="چوٹ ان لیٹ پر فی یونٹ چوڑائی بہاؤ۔ نچلی چوڑائی B اور کل بہاؤ Q والی نہر کے لیے q_t = Q / B استعمال کریں۔">کل یونٹ ڈسچارج، q<sub>t</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_apron_length']='<span class="ec-help" title="چوٹ کی چٹانوں کی ساختی مدد کے لیے ضروری۔ &quot;آؤٹ لیٹ ریچ اور نیچے کی جانب چینل کی مزاحمت کے نتیجے میں پیدا ہونے والا کم از کم ٹیل واٹر آؤٹ لیٹ ریچ میں ریپ‌ریپ کے استحکام کو یقینی بنانے کے لیے کافی ہے۔&quot; (Robinson)">آؤٹ لیٹ ایپرن لمبائی (15 × D<sub>50</sub>) <span class="ec-tip">?</span></span>';
