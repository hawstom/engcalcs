...
$ec_lang['lpn_main_title']='EPANET انجن کے ساتھ مفت آن لائن پانی کی تقسیم کے نیٹ ورک کا کیلکولیٹر';
...
$ec_lang['lpn_empty_hint']='ٹول بار سے پس منظر کی تصویر یا ذخیرہ شامل کر کے شروع کریں، یا فائل، نیا پراجیکٹ کھول کر کسی مثال سے آغاز کریں۔';
...
$ec_lang['lpn_new_blank_us']='خالی پراجیکٹ، US یونٹس (gpm)';
$ec_lang['lpn_new_blank_si']='خالی پراجیکٹ، SI یونٹس (l/s)';
$ec_lang['lpn_new_from_examples']='مثالوں سے';
...
$ec_lang['lpn_new_example_us']='بنیادی نیٹ ورک، US یونٹس (gpm)';
$ec_lang['lpn_new_example_si']='بنیادی نیٹ ورک، SI یونٹس (l/s)';
...
$ec_lang['lpn_inp_report_counts']='{nodes} جنکشن اور ریزروائر، {links} پائپ اور پمپ، {units} میں۔';
...
$ec_lang['lpn_inp_drop_tanks']='سٹوریج ٹینک شامل نہیں کیے گئے۔ اس صفحے میں ریزروائر ہیں، جو ایک مقررہ پانی کی سطح رکھتے ہیں۔ سٹوریج ٹینک مقررہ سطح نہیں رکھتا، اس لیے یہ ریزروائر نہیں ہے۔';
$ec_lang['lpn_inp_drop_tank_links']='یہ پائپ شامل نہیں کیے گئے کیونکہ یہ ایک ایسے ٹینک سے جڑے ہیں جو شامل نہیں کیا گیا۔';
$ec_lang['lpn_inp_drop_tcv']='یہ تھروٹل کنٹرول والوز اسی مقامی نقصان کے حامل بہت مختصر پائپوں کے طور پر شامل ہوئے۔ پانی کا رویہ ویسا ہی رہتا ہے؛ عنصر ویسا نہیں ہے۔';
$ec_lang['lpn_inp_drop_valve']='یہ والوز دباؤ یا بہاؤ کو کنٹرول کرتے ہیں، اور اس صفحے میں ایسا کوئی عنصر نہیں۔ یہ کھلے پائپوں کے طور پر شامل ہوئے، اس لیے نیٹ ورک اب بھی جڑا ہوا ہے، لیکن اب اسے کوئی کنٹرول نہیں کر رہا۔';
...
$ec_lang['lpn_inp_drop_patterns']='طلب کے پیٹرن شامل نہیں کیے گئے۔ یہ صفحہ وقت کے ایک لمحے کو حل کرتا ہے، اس لیے ہر طلب وہی عدد ہے جو فائل میں لکھا گیا ہے۔';
...
$ec_lang['lpn_inp_drop_controls']='کنٹرولز اور قواعد شامل نہیں کیے گئے۔ ہر پائپ، پمپ اور والو اسی حالت میں شامل ہوا جو فائل میں لکھی گئی تھی، اور یہ تبدیل نہیں ہوتا۔';
$ec_lang['lpn_inp_drop_eps']='یہ فائل ایک ایسی سمولیشن بیان کرتی ہے جو ایک عرصے تک چلتی ہے۔ یہ صفحہ ایک لمحہ حل کرتا ہے، اس لیے صرف ابتدائی حالات شامل ہوئے۔';
...
$ec_lang['lpn_notes_1_def']='ایک وقت میں طلبات کا ایک مجموعہ حل کرتا ہے، اسی گلوبل گریڈیئنٹ الگورتھم کا استعمال کرتے ہوئے جو EPANET استعمال کرتا ہے۔ یہ ماڈل نہیں کرتا کہ نیٹ ورک وقت کے ساتھ کیسے تبدیل ہوتا ہے۔';
$ec_lang['lpn_notes_2_term']='ماڈل نہیں کیا گیا';
$ec_lang['lpn_notes_2_def']='ٹینک، پانی کا معیار، اور خود بخود کھلنے بند ہونے والے کنٹرول والوز (PRV، PSV، FCV) ماڈل نہیں کیے جاتے۔ ایک پائپ ایک مقررہ مقامی نقصان رکھ سکتا ہے، لیکن ایسا والو نہیں جس کی کھلی یا بند حالت اسی بہاؤ پر منحصر ہو جسے حل کیا جا رہا ہے۔';
...
$ec_lang['lpn_diag_no_fixed_head']='ایک ریزروائر شامل کریں۔ حل ہونے سے پہلے نیٹ ورک کو کم از کم ایک معلوم پانی کی سطح درکار ہے۔';
...
$ec_lang['lpn_pump_point1']='پوائنٹ 1 (لازمی)';
$ec_lang['lpn_pump_point2']='پوائنٹ 2 (اختیاری)';
$ec_lang['lpn_pump_point3']='پوائنٹ 3 (اختیاری)';
...
$ec_lang['lpn_settings_defaults']='ابتدائی قدریں';
...
$ec_lang['lpn_settings_engine_epanet']='EPANET انجن سے حل کریں';
$ec_lang['lpn_settings_engine_epanet_tip']='US EPA کا اصل EPANET انجن آپ کے براؤزر میں چلاتا ہے۔ بلٹ ان حل کار وہی جوابات دیتا ہے اور تیز تر ہے، اس لیے اسے بند رکھیں جب تک آپ کو خود EPANET کی ضرورت نہ ہو۔';
$ec_lang['lpn_engine_loading']='EPANET انجن لوڈ ہو رہا ہے…';
$ec_lang['lpn_engine_failed']='EPANET انجن لوڈ نہیں ہو سکا۔ اس کی بجائے بلٹ ان حل کار دکھایا جا رہا ہے۔';
