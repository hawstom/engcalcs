...
$ec_lang['mhp_length']='لمبائی، L <span title="داخلہ (آبی سرچشمہ ڈھانچہ) کی ترسیلی پائپ یا فلیوم کی لمبائی" class="ec-tip">?</span>';
...
$ec_lang['mhp_notes_1_def']='کل پینسٹاک نقصان h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>، جہاں h<sub>f</sub> = f(L/D)(v²/2g) ڈارسی-وائزباخ رگڑ نقصان ہے، اور h<sub>m</sub> = k<sub>m</sub>·v²/2g داخلہ، موڑ، اور والوز کا احاطہ کرتا ہے۔ خالص ہیڈ H<sub>net</sub> = H<sub>gross</sub> − h<sub>L</sub>.';
...
$ec_lang['mhp_notes_3_def']='پینسٹاک نقصان مجموعی ہیڈ کے 10% سے کم عموماً اقتصادی ہوتا ہے۔ پائپ کی قیمت اور ضائع ہونے والی طاقت کے درمیان بہترین توازن اکثر 4–6% کے قریب ہوتا ہے جہاں بجلی سب سے زیادہ قیمتی ہو۔';
$ec_lang['mhp_notes_4_term']='مقامی نقصانات، k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='یہ نقصانات پائپ کے جنکشنز، داخلوں، موڑ اور والوز پر ہوتے ہیں — اصطلاح ”معمولی“ روایتی ہے مگر گمراہ کن ہو سکتی ہے؛ مختصر پینسٹاک میں یہ رگڑ کے نقصانات کے برابر یا اس سے زیادہ ہو سکتے ہیں۔ مخصوص k اقدار: تیز داخلہ 0.5، ہر 45° موڑ 0.2–0.3، گیٹ والو (مکمل کھلا) 0.1، بٹرفلائی والو 0.2۔ تمام فٹنگز کا مجموعہ کل k<sub>m</sub> ہے۔ ڈیفالٹ 1.5 ایک داخلہ اور دو موڑ فرض کرتا ہے۔';
...
$ec_lang['cs_Ec_target']='استرکاری کا ہدف، E<sub>c,target</sub> <span title="استرکاری کے بعد انتقالی کارکردگی کا مطلوبہ ہدف؛ حصہ 0&ndash;1" class="ec-tip">?</span>';
...
$ec_lang['cs_payback_years']='واپسی مدت <span title="Simple payback = total lining cost &divide; annual value recovered" class="ec-tip">?</span>';
...
$ec_lang['rc_main_menu']='چٹان چوٹ ڈیزائن (Robinson)';
$ec_lang['rc_main_title']='مفت آن لائن چٹان چوٹ ڈیزائن کیلکولیٹر — Robinson (1998)';
$ec_lang['rc_main_desc']='چٹان چوٹ ریپ‌ریپ سائزنگ — Robinson, Rice & Kadavy (1998)';
$ec_lang['rc_S0']='چوٹ بیڈ ڈھلان، S<sub>0</sub>';
$ec_lang['rc_qt']='کل یونٹ ڈسچارج، q<sub>t</sub> <span title="چوٹ ان لیٹ پر فی یونٹ چوڑائی بہاؤ۔ نچلی چوڑائی B اور کل بہاؤ Q والی نہر کے لیے q_t = Q / B استعمال کریں۔" class="ec-tip">?</span>';
$ec_lang['rc_np']='ریپ‌ریپ پوروسٹی، n<sub>p</sub>';
$ec_lang['rc_sg']='چٹان کی مخصوص کشش ثقل، sg <span title="عام کٹا ہوا گرینائٹ یا بیسالٹ ≈ 2.65۔ Robinson کی درست حد: 2.54 سے 2.82۔" class="ec-tip">?</span>';
$ec_lang['rc_SD']='گریڈیشن SD = D<sub>84.1</sub>/D<sub>50</sub> <span title="گریڈیشن اسٹینڈرڈ ڈیویشن۔ یکساں چٹان ≈ 1.25۔ Robinson کی درست حد: 1.15 سے 1.47۔" class="ec-tip">?</span>';
$ec_lang['rc_yn']='ان لیٹ چینل میں نارمل گہرائی، y<sub>n</sub> <span title="پانی جمع ہونا (Hp > yn) اچھا ہے — اوپری جانب کٹاؤ کم کرتا ہے۔ (USDA)" class="ec-tip">?</span>';
$ec_lang['rc_D50']='مطلوب درمیانہ چٹان سائز، D<sub>50</sub> <span title="مساوات 1 (S0 < 0.10) یا مساوات 2 (0.10-0.40)۔ درست: D50 بین 15 اور 278 ملی میٹر، S0 بین 0.02 اور 0.40۔ حد سے باہر: اضافی تخمینہ۔" class="ec-tip">?</span>';
...
$ec_lang['rc_apron_length']='آؤٹ لیٹ ایپرن لمبائی (15 × D<sub>50</sub>) <span title="چوٹ کی چٹانوں کی ساختی مدد کے لیے ضروری۔ &quot;آؤٹ لیٹ ریچ اور نیچے کی جانب چینل کی مزاحمت کے نتیجے میں پیدا ہونے والا کم از کم ٹیل واٹر آؤٹ لیٹ ریچ میں ریپ‌ریپ کے استحکام کو یقینی بنانے کے لیے کافی ہے۔&quot; (Robinson)" class="ec-tip">?</span>';
$ec_lang['rc_n_chute']='چوٹ میں Manning کی کھردرائی، n';
$ec_lang['rc_Vm']='چٹان مینٹل سے گزرنے کی رفتار، V<sub>m</sub> <span title="qt کا وہ حصہ جو چٹان کے سوراخوں سے گزرتا ہے۔ باقی qs سطح پر بہتا ہے۔ ڈیفالٹ np = 0.45 زاویہ دار کٹی ہوئی چٹان کے لیے۔" class="ec-tip">?</span>';
...
$ec_lang['rc_Hp']='ان لیٹ ویئر ہیڈ، H<sub>p</sub> <span title="پانی جمع ہونا (Hp > yn) اچھا ہے — اوپری جانب کٹاؤ کم کرتا ہے۔ (USDA)" class="ec-tip">?</span>';
$ec_lang['rc_ponding_check']='ان لیٹ پر پانی جمع ہونے کی جانچ';
$ec_lang['rc_pond_ok']  ='H<sub>p</sub> > y<sub>n</sub> — بالائی جانب پانی جمع';
$ec_lang['rc_pond_ok_tip']='چوٹ کے ان لیٹ سے بالائی جانب پانی کا جمع ہونا اچھا ہے؛ یہ بالائی جانب کٹاؤ کم کرتا ہے۔ (USDA)';
$ec_lang['rc_pond_warn']='H<sub>p</sub> ≤ y<sub>n</sub> — پانی جمع نہیں — ان لیٹ کٹاؤ کا امکان';
$ec_lang['rc_pond_warn_tip']='چوٹ کے ان لیٹ سے بالائی جانب پانی جمع نہیں ہو رہا؛ بالائی جانب کٹاؤ ہو سکتا ہے۔ (USDA)';
...
$ec_lang['ip_x']='ایمیٹر اخراج قوت نما، x <span title="معیاری غیر معاوضی ایمیٹرز کے لیے 0.5؛ دباؤ معاوضی ایمیٹرز کے لیے تقریباً 0" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='لیٹرل <span title="نشان زد: یہ ریچ ٹیسٹ لیٹرل کا ایک سیگمنٹ ہے، جس سے انفرادی ایمیٹرز پانی نکالتے ہیں۔ غیر نشان زد: یہ ریچ مرکزی لائن ہے، جو صرف اُن لیٹرلز کو بہاؤ منتقل کرتا ہے جو ٹیسٹ پاتھ پر نہیں ہیں۔" class="ec-tip">?</span>';
$ec_lang['ip_count']='ایمیٹرز <span title="لیٹرل قطاریں: صرف اس ریچ کے ایمیٹرز۔ مرکزی قطاریں: اس ریچ سے شاخ ہونے والے دیگر لیٹرلز کے کل ایمیٹرز۔ ٹیسٹ لیٹرل لائن پر ختم ہونے والے مرکزی لائن کے ریچ کے لیے، اس میں وہ تمام لیٹرلز بھی شامل ہیں جو اس مقام سے آگے مرکزی لائن پر ہیں، یا وہی جوڑ بانٹتے ہیں (مثلاً مخالف سمت کا لیٹرل) &mdash; ان کا بہاؤ بھی اسی ریچ سے گزرتا ہے۔" class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_km']='k<sub>m</sub> <span title="اس ریچ کی فٹنگز/والوز/جوڑنے والوں کے لیے عمومی مقامی نقصان کا عامل (تجویز کردہ کم از کم &ge;0.5)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='زیریں بلندی <span title="اس ریچ کے زیریں سرے کی بلندی۔ اندرونی قطاروں میں اختیاری ہے (خالی چھوڑنے پر ہموار / اوپر والے نوڈ کے برابر مانی جاتی ہے)۔ آخری قطار میں لازمی ہے: یہ قدر آخری ایمیٹر کی بلندی ہے، جو براہِ راست مطلوبہ سپلائی دباؤ متعین کرتی ہے۔" class="ec-tip">?</span>';
...
$ec_lang['ip_hl']='h<sub>L</sub> <span title="ریچ کا کل نقصان، h_f + h_m" class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='ٹیسٹ پاتھ سپلائی بہاؤ، Q<sub>supply</sub> <span title="صرف ماڈل کیے گئے ٹیسٹ پاتھ میں داخل ہونے والا بہاؤ — پورے زون/نظام کے لیے نیچے اطلاق ڈیزائن میں Q_zone دیکھیں۔" class="ec-tip">?</span>';
...
$ec_lang['ip_dp_avg']='تخمینی &Delta;دباؤ، اوسط بمقابلہ ٹیسٹ لیٹرل <span title="آپ کے اندازے میں ایک عام لیٹرل اس ٹیسٹ لیٹرل کے مقابلے میں کتنا زیادہ (یا کم) دباؤ پر چلتا ہے۔ ٹیسٹ لیٹرل کو جان بوجھ کر مفروضہ بدترین صورت رکھا گیا ہے، اس لیے اس کی اپنی اوسط میدانی اوسط سے کم تخمینہ ہے &mdash; اسے 0 پر چھوڑنے سے نیچے دی گئی یکسانیت کی جانچ اور اطلاق ڈیزائن کی قدریں ٹیسٹ لیٹرل کی اپنی (غالباً پُرامید) اوسط جوں کی توں استعمال کرتی ہیں۔" class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='تخمینی میدانی اوسط ایمیٹر بہاؤ، q<sub>avg,field</sub> <span title="q_avg_lateral کو ہر لیٹرل قطار کے دباؤ جمع اوپر درج کردہ دباؤ کے فرق پر دوبارہ جانچا گیا &mdash; اس بات کی اصلاح کی کوشش کہ ٹیسٹ لیٹرل مفروضہ بدترین صورت ہے، نمائندہ نہیں۔ یہ نیچے یکسانیت کی جانچ اور اطلاق ڈیزائن کے حصے دونوں میں استعمال ہوتا ہے۔" class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='یکسانیت کی جانچ، q<sub>last</sub>/q<sub>avg,field</sub> <span title="آخری ایمیٹر کے شمار شدہ بہاؤ کو تخمینی میدانی اوسط ایمیٹر بہاؤ پر تقسیم کیا گیا ہے &mdash; یہ معیاری نچلی چوتھائی تقسیم یکسانیت (نچلے گروہ کی اوسط &divide; مجموعی آبادی کی اوسط) کا تخمینہ ہے؛ لیکن یہ ایک چھوٹے ماڈل شدہ نمونے اور صارف کے تخمینی تصحیح سے حاصل ہوتا ہے، مکمل میدانی شماریاتی نمونے سے نہیں۔ 1 یا اس سے زائد قدریں ممکن اور درست ہیں: ان کا مطلب صرف یہ ہے کہ آخری ایمیٹر کا دباؤ تخمینی میدانی اوسط کے برابر یا اس سے زیادہ ہے، اس لیے کوئی دوسرا ایمیٹر سب سے کم دباؤ کا نقطہ ہے۔ یہ اس لیے ہو سکتا ہے کہ آخری ایمیٹر نشیبی زمین پر ہو یا &Delta;دباؤ کا تخمینہ بہت چھوٹا ہو۔" class="ec-tip">?</span>';
...
$ec_lang['ip_q_ratio']='آخری ایمیٹر بہاؤ &divide; ڈیزائن بہاؤ، q<sub>last</sub>/q<sub>design</sub> <span title="یہ ہمارے معیاری یکسانیت کے پیمانے کے تخمینے سے مختلف ہے۔" class="ec-tip">?</span>';
