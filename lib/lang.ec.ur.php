...
$ec_lang['lpn_time_run_note']='آپ نیٹ ورک کو پہلے رپورٹنگ وقت پر دیکھ رہے ہیں۔ خود بخود دوبارہ حل کریں کی ترتیب بند ہے، اس لیے بعد کے اوقات کے نتائج آپ کے کام کے دوران اپ ڈیٹ نہیں رکھے جاتے۔ انہیں اپ ڈیٹ لانے کے لیے حل کریں بٹن دبائیں۔';
...
$ec_lang['lpn_pane_paste_note']='یہ جدول سپریڈ شیٹ سے پیسٹ کر کے پہلے سے موجود قطاروں میں قدریں درج کرنے کے لیے ہے۔ اگر یہ آپ کی ضرورت پوری نہ کرے تو ہمیں بتانے کے لیے مدد، کچھ ٹھیک کریں استعمال کریں۔';
...
$ec_lang['lpn_georef_projected']='یہ پراجیکٹ پہلے ہی ایک نقشہ پروجیکشن بیان کرتا ہے، اس لیے اس کے احداثیات کو دوبارہ نقشے پر رکھا نہیں جا سکتا۔';
...
$ec_lang['lpn_new_coordsys_geo']='جغرافیائی پروجیکشن';
$ec_lang['lpn_new_coordsys_geo_tip']='ایک جغرافیائی پروجیکشن منتخب کریں۔ Lat/Lon کے لیے WGS 84 / Pseudo-Mercator EPSG:3857 استعمال کریں۔';
...
$ec_lang['lpn_new_crs_tip']='وہ پروجیکشن جس میں آپ کے احداثیات پہلے سے ماپے جا چکے ہیں۔ احداثیات بالکل ویسے ہی محفوظ کیے جاتے ہیں جیسے آپ انہیں ٹائپ کرتے ہیں، اور کچھ بھی تبدیل نہیں کیا جاتا۔ یہ انتخاب مستقل ہے؛ نیٹ ورک کو مختلف احداثیات میں تبدیل کرنے کا واحد طریقہ "فائل، نقشے پر xy فائل کھولیں…" ہے، اور یہ تخمینی ہے۔ UTM دنیا بھر میں غالب معیار ہے، کسی علاقے کے اپنے رواج ہو سکتے ہیں، اور اگر یقین نہ ہو تو زمین کے سرویئر سے رجوع کریں۔';
...
$ec_lang['lpn_crs_place_projected']='ایک پروجیکٹڈ پراجیکٹ اپنے مخصوص پلین پر کھلتا ہے، اس جگہ پر نہیں جو آپ نے تلاش کی۔ اس پلین کو زمین پر رکھنے کے لیے ایک احداثی تبدیلی درکار ہے، جو اس صفحے کے پاس ابھی موجود نہیں۔';
...
$ec_lang['lpn_menu_cue']='اوپر دیے گئے مینیوز سے شروع کریں۔ فوری رسائی کے لیے ٹول بار استعمال کریں۔';
