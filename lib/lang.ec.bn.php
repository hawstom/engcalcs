...
$ec_lang['lpn_backdrop_position_prompt1']='পটভূমি চিত্রে যেকোনো একটি বিন্দুতে ক্লিক করুন। এটিই সেই বিন্দু যা আপনি সরাবেন।';
$ec_lang['lpn_backdrop_position_prompt2']='সেই বিন্দুটি কোথায় যাবে তা বেছে নিন, তারপর চালিয়ে যান ক্লিক করুন।';
...
$ec_lang['lpn_settings_engine_epanet_tip']='US EPA-এর নিজস্ব EPANET সমাধানকারী চালায়, এখানে আপনার ব্রাউজারে। বিল্ট-ইন সমাধানকারী একই উত্তর দেয় এবং দ্রুততর, তাই EPANET নিজে প্রয়োজন না হলে এটি বন্ধ রাখুন।';
...
$ec_lang['lpn_scenario_base_value']='ভিত্তি: {value}';
