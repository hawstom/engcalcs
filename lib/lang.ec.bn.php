...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="ড্যার্সি-ওয়েইসবাখ রুক্ষতা উচ্চতা"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_length']='<span class="ec-help" title="ইনলেট (হেডওয়ার্কস) সরবরাহ পাইপ বা ফ্লুমের দৈর্ঘ্য">দৈর্ঘ্য, L <span class="ec-tip">?</span></span>';
$ec_lang['mhp_roughness']='পাইপের রুক্ষতা, e';
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">স্থানীয় ক্ষতি সহগ, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">গতিগত সান্দ্রতা, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_Ec_target']='<span class="ec-help" title="আস্তরণের পর পরিবহন দক্ষতার লক্ষ্য; ভগ্নাংশ 0&ndash;1">আস্তরণ লক্ষ্য, E<sub>c,target</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_payback_years']='<span class="ec-help" title="সরল পেব্যাক = মোট আস্তরণ খরচ &divide; বার্ষিক পুনরুদ্ধারকৃত মূল্য">পেব্যাক সময়কাল <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_qt']='<span class="ec-help" title="চ্যুট ইনলেটে একক প্রস্থ প্রতি প্রবাহ। তলদেশের প্রস্থ B ও মোট প্রবাহ Q সহ একটি চ্যানেলের জন্য, q_t = Q / B ব্যবহার করুন।">মোট একক প্রবাহ, q<sub>t</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_apron_length']='<span class="ec-help" title="চ্যুটের পাথরের কাঠামোগত সহায়তার জন্য প্রয়োজনীয়। &quot;আউটলেট রিচ ও ভাটির চ্যানেল প্রতিরোধের ফলে যে ন্যূনতম টেলওয়াটার সৃষ্টি হয়, তা আউটলেট রিচে রিপর‍্যাপের স্থিতিশীলতা নিশ্চিত করার জন্য যথেষ্ট।&quot; (Robinson)">আউটলেট এপ্রনের দৈর্ঘ্য (15 &times; D<sub>50</sub>) <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_count']='<span class="ec-help" title="ল্যাটারাল সারি: শুধুমাত্র এই অংশের ড্রিপার। প্রধান লাইন সারি: এই অংশ থেকে শাখা নেওয়া, এই ল্যাটারাল ব্যতীত অন্য ল্যাটারালগুলোর মোট ড্রিপার। পরীক্ষা ল্যাটারাল লাইনে শেষ হওয়া প্রধান লাইনের অংশের জন্য, এতে সেই বিন্দুর পরে প্রধান লাইন বরাবর যেকোনো ল্যাটারাল, বা একই জাংশন শেয়ার করা (যেমন বিপরীত-পাশের ল্যাটারাল) অন্তর্ভুক্ত হয় &mdash; তাদের প্রবাহও এই একই অংশ থেকে শাখা নেয়।">ড্রিপার <span class="ec-tip">?</span></span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_e']='<span class="ec-help" title="ড্যার্সি-ওয়েইসবাখ রুক্ষতা উচ্চতা">e <span class="ec-tip">?</span></span>';
$ec_lang['ip_km']='<span class="ec-help" title="এই অংশের ফিটিং/ভালভ/কাপলারের জন্য সাধারণ স্থানীয়-ক্ষতি সহগ (ন্যূনতম &ge;0.5 প্রস্তাবিত)">k<sub>m</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_dp_avg']='<span class="ec-help" title="একটি সাধারণ ল্যাটারাল এই পরীক্ষা ল্যাটারালের তুলনায় কতটা বেশি (বা কম) চাপে চলে বলে আপনি অনুমান করেন। পরীক্ষা ল্যাটারালকে ইচ্ছাকৃতভাবে সবচেয়ে খারাপ ক্ষেত্র ধরে নেওয়া হয়, তাই এর নিজস্ব গড় মাঠ-গড়ের একটি অবমূল্যায়ন &mdash; 0-এ রেখে দিলে, নিচের সমতা পরীক্ষা ও প্রয়োগ-ডিজাইন সংখ্যাগুলো পরীক্ষা ল্যাটারালের নিজস্ব (সম্ভবত আশাবাদী) গড়কে যথাযথভাবে ব্যবহার করে।">আনু. &Delta;চাপ, গড় বনাম পরীক্ষা ল্যাটারাল <span class="ec-tip">?</span></span>';
$ec_lang['ip_q_avg_field']='<span class="ec-help" title="প্রতিটি ল্যাটারাল সারির চাপে প্লাস উপরে প্রবেশ করা চাপ পার্থক্য যোগ করে q_avg_lateral পুনর্মূল্যায়ন করা হয় &mdash; পরীক্ষা ল্যাটারাল প্রতিনিধিত্বমূলক না হয়ে সবচেয়ে খারাপ ক্ষেত্র ধরে নেওয়ার সংশোধনের একটি প্রচেষ্টা। নিচের সমতা পরীক্ষা ও প্রয়োগ-ডিজাইন উভয় অংশে ব্যবহৃত হয়।">আনু. মাঠ-গড় ড্রিপার প্রবাহ, q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
$ec_lang['ip_du_estimate']='<span class="ec-help" title="শেষ ড্রিপারের গণিত প্রবাহকে আনুমানিক মাঠ-গড় ড্রিপার প্রবাহ দিয়ে ভাগ করা হয় &mdash; এটি প্রমিত নিম্ন-চতুর্থাংশ বিতরণ সমতা (নিম্ন-গ্রুপ গড় &divide; জনসংখ্যার গড়)-এর একটি আনুমানিক রূপ; এটি একটি ছোট মডেলকৃত নমুনা এবং ব্যবহারকারী-অনুমিত সংশোধন থেকে পাওয়া, সম্পূর্ণ-মাঠ পরিসংখ্যানগত নমুনা থেকে নয়। 1 বা তার বেশি মান সম্ভব ও গ্রহণযোগ্য: এর অর্থ শুধু এই যে শেষ ড্রিপারের চাপ আনুমানিক মাঠ-গড়ের সমান বা তার বেশি, তাই অন্য কোনো ড্রিপার সর্বনিম্ন চাপের বিন্দু। এটি হতে পারে কারণ শেষ ড্রিপারটি নিচু জমিতে আছে, অথবা কারণ &Delta;চাপের অনুমান খুব ছোট।">সমতা পরীক্ষা, q<sub>last</sub>/q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_ratio']='<span class="ec-help" title="এটি প্রমিত সমতা পরিমাপের আমাদের আনুমানিক রূপ থেকে ভিন্ন।">শেষ ড্রিপার প্রবাহ &divide; নকশা প্রবাহ, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
