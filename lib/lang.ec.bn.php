...
$ec_lang['lpn_new_coords_tip']='একটি xy প্রকল্প এমন স্থানাঙ্ক ব্যবহার করে যা অক্ষাংশ ও দ্রাঘিমাংশ নয়। একটি lat/lon প্রকল্পে ভৌগোলিক স্থানাঙ্ক থাকে, তাই এর পেছনে একটি রাস্তার মানচিত্র বা স্যাটেলাইট চিত্র আঁকা যায় এবং নোডের উচ্চতা ভূমিরূপ থেকে পড়া যায়। একটি xy প্রকল্পকে ফাইল, একটি xy ফাইল মানচিত্রে খুলুন দিয়ে lat/lonে রূপান্তর করা যায়।';
