...
$ec_lang['mtc_bend_angle']='বাঁক কোণ, β <a target="_blank" href="riprap-bend-angle.png" title="চিত্রের জন্য ক্লিক করুন">?</a> (পাথরের স্তরের আকার নির্ধারণের জন্য)';
...
$ec_lang['rc_apron_length']='<span class="ec-help" title="পাথরের স্তরের কাঠামোগত সহায়তার জন্য প্রয়োজনীয়। &quot;আউটলেট রিচ ও ভাটির চ্যানেল প্রতিরোধের ফলে যে ন্যূনতম টেলওয়াটার সৃষ্টি হয়, তা আউটলেট রিচে পাথরের স্তরের স্থিতিশীলতা নিশ্চিত করার জন্য যথেষ্ট।&quot; (Robinson)">আউটলেট এপ্রনের দৈর্ঘ্য (15 &times; D<sub>50</sub>) <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_notes_2_def']='q<sub>t</sub> হলো খাড়া নালার ক্রেস্টে মোট একক প্রবাহ (প্রতি একক প্রস্থে মোট প্রবাহ)। তলদেশের প্রস্থ B সহ মোট প্রবাহ Q বহনকারী একটি চ্যানেলের জন্য, q<sub>t</sub> &asymp; Q / B আনুমানিক ধরুন, অথবা খাড়া নালার ইনলেটে সংকট-গভীরতা (ক্রিটিক্যাল ডেপথ) শর্ত থেকে এটি গণনা করুন।';
$ec_lang['rc_notes_3_term']='পাথরের আবরণের মধ্য দিয়ে প্রবাহ';
$ec_lang['rc_notes_3_def']='মোট প্রবাহের একটি অংশ পাথরের স্তরের ছিদ্রের মধ্য দিয়ে চলাচল করে (আবরণ প্রবাহ q<sub>m</sub>); অবশিষ্ট অংশ পাথরের পৃষ্ঠের উপর দিয়ে প্রবাহিত হয় (q<sub>s</sub> = q<sub>t</sub> &minus; q<sub>m</sub>)। প্রবাহ গভীরতা d, খাড়া নালার রুক্ষতা n ব্যবহার করে পৃষ্ঠ প্রবাহ q<sub>s</sub>-এর উপর Manning-এর সমীকরণ প্রয়োগ করে গণনা করা হয়। কোণাকার ভাঙা পাথরের জন্য ডিফল্ট ছিদ্রতা n<sub>p</sub> = 0.45 স্বাভাবিক।';
