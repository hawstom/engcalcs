...
$ec_lang['mtc_iteration_tip']='আপনার লক্ষ্য প্রবাহের জন্য একটি সমান পাথরের আকারের দিকে স্বয়ংক্রিয়ভাবে পুনরাবৃত্তি করতে একটি রুক্ষতা বিকল্প (ব্লডগেট–বাথার্স্ট প্রস্তাবিত) এবং একটি পাথরের আকার বিকল্প (Isbash প্রস্তাবিত) নির্বাচন করুন। সম্পূর্ণ পদ্ধতির জন্য নিচের নোট দেখুন, অথবা পুনরাবৃত্তি এড়াতে নিজের রুক্ষতার মান লিখুন এবং পাথরের আকার উপেক্ষা করুন।';
...
$ec_lang['mhp_notes_1_def']='মোট চাপ পাইপ (সরবরাহ পাইপ) ক্ষতি h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, যেখানে h<sub>f</sub> = f(L/D)(v&sup2;/2g) হলো ডার্সি-ওয়েইসবাক ঘর্ষণ ক্ষতি এবং h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g প্রবেশ, বাঁক ও ভালভের ক্ষতি অন্তর্ভুক্ত করে। নিট জলশীর্ষ H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>।';
...
$ec_lang['mhp_notes_3_def']='মোট জলশীর্ষের 10% এর নিচে চাপ পাইপ (সরবরাহ পাইপ) ক্ষতি সাধারণত অর্থনৈতিক। পাইপ খরচ ও হারানো শক্তির মধ্যে সর্বোত্তম ভারসাম্য প্রায়ই সেসব স্থানে 4&ndash;6% এর কাছাকাছি হয় যেখানে বিদ্যুৎ সবচেয়ে মূল্যবান।';
...
$ec_lang['install_android_heading']='অ্যান্ড্রয়েড (Chrome)';
