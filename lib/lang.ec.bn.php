...
$ec_lang['lpn_time_run_note']='আপনি প্রথম প্রতিবেদন সময়ে নেটওয়ার্কটি দেখছেন। স্বয়ংক্রিয়ভাবে পুনরায় গণনা করুন সেটিং বন্ধ আছে, তাই আপনি কাজ করার সময় পরের সময়গুলোর ফলাফল হালনাগাদ রাখা হয় না। সেগুলো হালনাগাদ করতে চালান বোতাম চাপুন।';
...
$ec_lang['lpn_pane_paste_note']='এই সারণিটি একটি স্প্রেডশিট থেকে ইতিমধ্যে বিদ্যমান সারিতে মান পেস্ট করে প্রবেশ করানোর জন্য তৈরি। এটি যদি আপনার প্রয়োজন পূরণ না করে, তাহলে আমাদের জানাতে সহায়তা, কিছু ঠিক করুন ব্যবহার করুন।';
...
$ec_lang['lpn_georef_projected']='এই প্রকল্পে ইতিমধ্যে একটি মানচিত্র প্রক্ষেপণ বলা আছে, তাই এর স্থানাঙ্কগুলো দ্বিতীয়বার মানচিত্রে বসানো যাবে না।';
...
$ec_lang['lpn_new_coordsys_geo']='ভৌগোলিক প্রক্ষেপণ';
$ec_lang['lpn_new_coordsys_geo_tip']='একটি ভৌগোলিক প্রক্ষেপণ নির্বাচন করুন। Lat/Lon-এর জন্য WGS 84 / Pseudo-Mercator EPSG:3857 ব্যবহার করুন।';
...
$ec_lang['lpn_new_crs_tip']='যে প্রক্ষেপণে আপনার স্থানাঙ্কগুলো ইতিমধ্যে পরিমাপ করা আছে। স্থানাঙ্কগুলো ঠিক যেমন আপনি টাইপ করেন তেমনই সংরক্ষিত হয়, এবং কিছুই রূপান্তরিত হয় না। এই নির্বাচনটি স্থায়ী; একটি নেটওয়ার্ককে ভিন্ন স্থানাঙ্কে রূপান্তর করার একমাত্র উপায় হলো "File, Open to new coordinates", এবং এটি আনুমানিক। UTM বিশ্বব্যাপী প্রভাবশালী মানদণ্ড, একটি অঞ্চলের নিজস্ব প্রথাও থাকতে পারে, এবং আপনি নিশ্চিত না হলে একজন ভূমি জরিপকারী জিজ্ঞাসা করার উপযুক্ত ব্যক্তি।';
...
$ec_lang['lpn_crs_place_projected']='একটি প্রক্ষেপিত প্রকল্প আপনার খোঁজা স্থানে নয়, নিজস্ব সমতলে খোলে। সেই সমতলটিকে পৃথিবীর উপর বসাতে একটি স্থানাঙ্ক রূপান্তর প্রয়োজন, যা এই পাতায় এখনও নেই।';
...
$ec_lang['lpn_menu_cue']='উপরের মেনু থেকে শুরু করুন। দ্রুত প্রবেশের জন্য টুলবার ব্যবহার করুন।';
