...
$ec_lang['lpn_file_convert_as']='একটি xy ফাইল মানচিত্রে খুলুন…';
$ec_lang['lpn_file_convert_as_tip']='এই পৃষ্ঠায় একটি নতুন প্রকল্প ট্যাবে, রাস্তার মানচিত্রে একটি প্রকল্প ফাইল বা একটি EPANET ফাইল খোলে। আপনি হাতে অঙ্কনটি পৃথিবীতে বসান: সাইটে প্যান ও জুম করুন, তারপর মাপ ও দিক ঠিক করে বসিয়ে দিন। যদি ফাইলের x ও y ইতিমধ্যে একটি দ্রাঘিমাংশ ও একটি অক্ষাংশ হয়, তাহলে এগুলো ইতিমধ্যে lat/lon বোতাম চাপুন এবং নেটওয়ার্কটি সরাসরি তার প্রকৃত জায়গায় চলে যাবে। আপনার লেখা প্রতিটি সংখ্যা যেমন আছে তেমনই থাকে।';
