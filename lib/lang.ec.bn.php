...
$ec_lang['lpn_inp_drop_patterns']='চাহিদার প্যাটার্ন বাদ দেওয়া হয়েছে। এই পৃষ্ঠা একটি মুহূর্তের জন্য সমাধান করে, তাই প্রতিটি চাহিদা ফাইলে লেখা সংখ্যাটিই থাকে।';
...
$ec_lang['lpn_inp_drop_controls']='কন্ট্রোল ও নিয়মাবলী বাদ দেওয়া হয়েছে। প্রতিটি পাইপ, পাম্প ও ভালভ ফাইলে লেখা অবস্থাতেই এসেছে, এবং পরিবর্তিত হয় না।';
$ec_lang['lpn_inp_drop_eps']='এই ফাইলটি একটি সময়কাল জুড়ে চলা একটি সিমুলেশন বর্ণনা করে। এই পৃষ্ঠা একটি মুহূর্তের জন্য সমাধান করে, তাই শুধু শুরুর অবস্থাগুলোই এসেছে।';
...
$ec_lang['lpn_settings_engine_epanet_tip']='US EPA-এর নিজস্ব EPANET সমাধানকারী চালায়, এখানে আপনার ব্রাউজারে। উভয় সমাধানকারীই একই উত্তর দেয়, এবং এই আকারের নেটওয়ার্কে আপনি গতির কোনো পার্থক্য দেখবেন না। এটি প্রথমবার চালু করলে প্রায় ৬৫০ KB ডাউনলোড হয় এবং তারপর এই ডিভাইসে রাখা হয়।';
...
$ec_lang['lpn_field_text_match_pipe']='পাইপের কোণের সাথে মিলান';
...
$ec_lang['lpn_examples_size']='{nodes}টি জাংশন, {links}টি পাইপ';
...
$ec_lang['lpn_ex_net3_desc']='EPANET-এর বড় নমুনা: 97টি জাংশন, দুটি ট্যাংক এবং একটি নদীর উৎস। একটি বাস্তব আকারের মডেল মানচিত্রে কেমন দেখায় তা দেখার উপযুক্ত।';
