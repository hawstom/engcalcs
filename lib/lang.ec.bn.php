...
$ec_lang['lpn_inp_drop_valve']='এই ভালভগুলো চাপ বা প্রবাহ নিয়ন্ত্রণ করে, এবং এই পৃষ্ঠায় এমন কোনো উপাদান নেই। এগুলো খোলা পাইপ হিসেবে এসেছে, তাই নেটওয়ার্কটি এখনও সংযুক্ত আছে, কিন্তু এটি নিয়ন্ত্রণ করার মতো আর কিছু নেই।';
...
$ec_lang['lpn_notes_1_def']='EPANET যে একই গ্লোবাল গ্র্যাডিয়েন্ট অ্যালগরিদম ব্যবহার করে তা দিয়ে একবারে একসেট চাহিদা সমাধান করে। এটি সময়ের সাথে নেটওয়ার্ক কীভাবে পরিবর্তিত হয় তা মডেল করে না।';
...
$ec_lang['lpn_diag_no_fixed_head']='একটি জলাধার যোগ করুন। সমাধান করার আগে নেটওয়ার্কে অন্তত একটি জানা পানির স্তর থাকা প্রয়োজন।';
