...
$ec_lang['lpn_inp_drop_quality']='এই ফাইলটি বর্ণনা করে পানির গুণমান চলার পথে কীভাবে পরিবর্তিত হয়: শুরুতে পানিতে কী আছে, সেই পদার্থের আরও কোথায় প্রবেশ করে, এটি কীভাবে বিক্রিয়া করে, এবং ট্যাংকগুলো কীভাবে মেশে। এই পৃষ্ঠা পানির বয়স ও উৎস ট্রেস হিসাব করে, কিন্তু রসায়ন নয়, তাই এখানে তার কিছুই ব্যবহার করা হয় না। সেই লাইনগুলো রাখা হয়, এবং আপনি একটি EPANET ফাইল সংরক্ষণ করলে সেগুলো আবার লেখা হয়।';
...
$ec_lang['lpn_tip_select']='মানচিত্রে জিনিস পরিবর্তন, সরানো ও টেনে আনতে এই মোড ব্যবহার করুন। একটি প্রকল্প খোলার মতো কিছু কাজের পর পৃষ্ঠাটি নিজে থেকেই এই মোডে ফিরে আসে।';
...
$ec_lang['lpn_settings_color_thematic_tip']='নোড ও লিংক লেবেল লুকিয়ে ফেলে যাতে মানচিত্রে শুধু রঙই থেকে যায়। আপনি নিজে বসানো টেক্সট থেকে যায়। আপনার লেবেল বাছাইগুলো রাখা থাকে, এবং এটি বন্ধ করলে সেগুলো আবার ফিরে আসে।';
...
$ec_lang['lpn_file_import_geo']='একটি xy ফাইল মানচিত্রে খুলুন…';
$ec_lang['lpn_file_import_geo_tip']='এই পৃষ্ঠায় একটি নতুন প্রকল্প ট্যাবে, রাস্তার মানচিত্রে একটি প্রকল্প ফাইল বা একটি EPANET ফাইল খোলে। আপনি হাতে অঙ্কনটি পৃথিবীতে বসান: সাইটে প্যান ও জুম করুন, তারপর মাপ ও দিক ঠিক করে বসিয়ে দিন। যদি ফাইলের x ও y ইতিমধ্যে একটি দ্রাঘিমাংশ ও একটি অক্ষাংশ হয়, তাহলে এগুলো ইতিমধ্যে lat/lon বোতাম চাপুন এবং নেটওয়ার্কটি সরাসরি তার প্রকৃত জায়গায় চলে যাবে। আপনার লেখা প্রতিটি সংখ্যা যেমন আছে তেমনই থাকে।';
...
$ec_lang['lpn_georef_done']='এটি এখন একটি অক্ষাংশ/দ্রাঘিমাংশ প্রকল্প। কোনো উপাদান তার প্রকৃত অবস্থানের কাছাকাছি সরাতে টেনে আনুন।';
...
$ec_lang['lpn_clean_map_tip']='স্ট্যাটাস স্ট্রিপ ও স্থানাঙ্ক রিডআউট মানচিত্র থেকে সরান, যাতে একটি স্ক্রিনশটে শুধু অঙ্কনটিই দেখা যায়। আপনার অঙ্কন স্পর্শ করা হয় না, এবং এই পছন্দটি সংরক্ষণ করা হয় না; পৃষ্ঠাটি পুনরায় লোড করলে রিডআউটগুলো ফিরে আসে।';
...
$ec_lang['lpn_time_no_engine']='বিল্ট-ইন সমাধানকারী একবারে একটি মুহূর্ত হিসাব করে, তাই এটি শুধুমাত্র {time}-এ নেটওয়ার্ক: প্রতিটি প্যাটার্ন সেই মুহূর্তে পড়া হয়, এবং প্রতিটি ট্যাংক ভরা ও খালি হওয়ার পরিবর্তে তার শুরুর স্তরেই থাকে। পুরো সময়কাল চালানো EPANET সমাধানকারী আনতে একবার ইন্টারনেটে সংযুক্ত হন।';
$ec_lang['lpn_time_slider']='সময়';
$ec_lang['lpn_time_no_period']='এই প্রকল্পের কোনো সময়কাল নেই, তাই দেখানোর মতো শুধু একটি মুহূর্ত আছে। সময়ের সাথে নেটওয়ার্কটি হিসাব করতে সেটিংস-এ একটি মোট চলার সময় নির্ধারণ করুন।';
...
$ec_lang['lpn_time_run_note']='আপনি প্রথম প্রতিবেদন সময়ে নেটওয়ার্কটি দেখছেন। এই নেটওয়ার্কটি তার পুরো সময়কাল জুড়ে হিসাব করতে এত সময় নেয় যে আপনি কাজ করার সময় পরের সময়গুলোর ফলাফল হালনাগাদ রাখা হয় না। সেগুলো হালনাগাদ করতে চালান বোতাম চাপুন।';
...
$ec_lang['lpn_geomap']='অক্ষাংশ/দ্রাঘিমাংশ';
...
$ec_lang['lpn_georef_asdegrees']='এই ফাইলের x ও y একটি দ্রাঘিমাংশ ও একটি অক্ষাংশ হিসেবে পড়া হয়েছে, তাই নেটওয়ার্কটি ইতিমধ্যে মানচিত্রে আছে এবং কিছু সরানো হয়নি। এটি সঠিক জায়গায় আছে কিনা যাচাই করুন, তারপর এই অবস্থান রাখুন বোতাম চাপুন।';
...
$ec_lang['lpn_result_water_age_tip']='এই বিন্দুতে পৌঁছানো পানি সিস্টেমে কতক্ষণ ধরে আছে। এর বিপরীতে তুলনা করার মতো কোনো নিয়ন্ত্রক সীমা নেই, তাই সংখ্যাটি আপনার নিজের সিস্টেমের নিরিখে বিচার করুন।';
...
$ec_lang['lpn_new_coords']='স্থানাঙ্ক';
$ec_lang['lpn_new_coords_xy']='xy স্থানাঙ্ক';
$ec_lang['lpn_new_coords_geo']='অক্ষাংশ/দ্রাঘিমাংশ';
$ec_lang['lpn_new_coords_tip']='একটি xy প্রকল্প এমন স্থানাঙ্ক ব্যবহার করে যা অক্ষাংশ ও দ্রাঘিমাংশ নয়। একটি অক্ষাংশ/দ্রাঘিমাংশ প্রকল্পে ভৌগোলিক স্থানাঙ্ক থাকে, তাই এর পেছনে একটি রাস্তার মানচিত্র বা স্যাটেলাইট চিত্র আঁকা যায় এবং নোডের উচ্চতা ভূমিরূপ থেকে পড়া যায়। একটি xy প্রকল্পকে ফাইল, একটি xy ফাইল মানচিত্রে খুলুন দিয়ে অক্ষাংশ/দ্রাঘিমাংশে রূপান্তর করা যায়।';
$ec_lang['lpn_new_place']='এই স্থানের কাছে শুরু করুন';
$ec_lang['lpn_new_place_tip']='ঐচ্ছিক। একটি শহর, রাস্তা বা ল্যান্ডমার্কের নাম লিখুন এবং নতুন মানচিত্রটি সেখানে খুলবে। আপনার লেখা শব্দগুলো OpenStreetMap-এর স্থান-নাম সেবায় যায়, যা প্রথমবার আপনার অনুমতি চায়। খালি রাখলে মানচিত্রটি পুরো বিশ্ব নিয়ে খুলবে।';
$ec_lang['lpn_new_place_hint']='ঢাকা, বাংলাদেশ';
$ec_lang['lpn_new_create']='তৈরি করুন';
$ec_lang['lpn_inp_drop_rules']='এই ফাইলে নিয়মভিত্তিক নিয়ন্ত্রণ আছে। সেগুলো এখানে প্রয়োগ করা হয় না, তাই সেগুলো যেসব পাইপ, পাম্প ও ভালভের নাম উল্লেখ করে সেগুলো ফাইলে লেখা অবস্থাতেই থেকে যায়। নিয়মগুলো নিজে রাখা হয়, এবং আপনি একটি EPANET ফাইল সংরক্ষণ করলে সেগুলো আবার লেখা হয়।';
$ec_lang['lpn_inp_drop_energy']='এই EPANET ফাইলে পাম্পিং খরচের মডেলিং ডেটা আছে। এই পৃষ্ঠাটি শক্তি বা খরচ হিসাব করে না, তাই এখানে সেই সংখ্যাগুলো ব্যবহার করা হয় না। সেগুলো রাখা হয়, এবং আপনি একটি EPANET ফাইল সংরক্ষণ করলে সেগুলো আবার লেখা হয়।';
$ec_lang['lpn_inp_drop_tags']='এই ফাইলটি এর কিছু সংযোগস্থল, পাইপ বা অন্যান্য উপাদানকে ট্যাগ দেয়। এই পৃষ্ঠায় এখনও কোনো ট্যাগ দেখা বা পরিবর্তন করার জায়গা নেই। ট্যাগগুলো রাখা হয়, এবং আপনি একটি EPANET ফাইল সংরক্ষণ করলে সেগুলো আবার লেখা হয়।';
$ec_lang['lpn_inp_drop_report']='এই ফাইলে EPANET যেসব প্রতিবেদন ছাপায় তার নিজস্ব সেটিংস আছে। এই পৃষ্ঠা তার নিজের পদ্ধতিতে উত্তর দেখায়, তাই এখানে সেগুলো ব্যবহার করা হয় না। সেগুলো রাখা হয়, এবং আপনি একটি EPANET ফাইল সংরক্ষণ করলে সেগুলো আবার লেখা হয়।';
...
$ec_lang['lpn_inp_drop_quality_options']='এই ফাইলে EPANET-এর পানির গুণমান সংক্রান্ত বিকল্পগুলো বলা আছে: Quality, যা পানির গুণমান বিশ্লেষণের ধরন নির্দেশ করে, এবং একটি রাসায়নিকের সাথে যুক্ত দুটি সেটিং, Relative diffusivity ও Quality tolerance। পানির বয়স ও উৎস ট্রেস এখানে হিসাব করা হয়; কোনো রাসায়নিক করা হয় না, তাই সেই দুটি সেটিং ব্যবহার না করেই রাখা হয়। সবগুলো আপনি একটি EPANET ফাইল সংরক্ষণ করলে আবার লেখা হয়।';
...
$ec_lang['lpn_settings_quality_track_tip']='রান-টি পাইপগুলোর মধ্য দিয়ে কী অনুসরণ করবে তা বেছে নিন: পানি সিস্টেমে কতক্ষণ ধরে আছে, নাকি এটি কোথা থেকে এসেছে। কোনোটির জন্যই ঘনমাত্রা বা বিক্রিয়ার হার দরকার নেই।';
...
$ec_lang['lpn_quality_chemical']='এই ফাইলের নামকরণ করা একটি রাসায়নিক (সংরক্ষিত, হিসাব করা নয়)';
$ec_lang['lpn_quality_needs_run']='পানির গুণমান পাইপগুলোর মধ্য দিয়ে সময়ের সাথে বহন করা হয়, তাই এর জন্য EPANET ইঞ্জিন ও একটি মোট চলার সময় দরকার। সময়-এর অধীনে একটি মোট চলার সময় নির্ধারণ করুন, তারপর চালান বোতাম চাপুন।';
...
$ec_lang['lpn_ff_menu']='অগ্নিনির্বাপণ প্রবাহ…';
...
$ec_lang['lpn_ff_title']='অগ্নিনির্বাপণ প্রবাহ';
...
$ec_lang['lpn_ff_required_node_tip']='এই নির্দিষ্ট সংযোগস্থলে যে অগ্নিনির্বাপণ প্রবাহ প্রয়োজন, আপনার ফায়ার কোড বা ফায়ার কর্তৃপক্ষের কাছ থেকে, এটি যে ভূমি ব্যবহারের সেবা দেয় তার জন্য। এটি খালি রাখলে সংযোগস্থলটি প্রয়োজনীয় অগ্নিনির্বাপণ প্রবাহ বাক্সের সংখ্যার বিপরীতে পরীক্ষা করা হয়।';
...
$ec_lang['lpn_ff_design_nodes']='অন্য সব সংযোগস্থল';
