...
$ec_lang['mhp_length']='लंबाई, L <span title="इनलेट (प्रवेश संरचना) आपूर्ति पाइप या फ्ल्यूम की लंबाई" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_warn']='10% लक्ष्य से अधिक';
$ec_lang['mhp_hl_warn_tip']='बड़ा पाइप उपयोग करने पर विचार करें';
$ec_lang['mhp_hl_bad']='20% से अधिक';
$ec_lang['mhp_hl_bad_tip']='पाइप का आकार बदलें';
$ec_lang['mhp_notes_1_term']='हेड हानि';
$ec_lang['mhp_notes_1_def']='कुल पेनस्टॉक हानि h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, जहाँ h<sub>f</sub> = f(L/D)(v&sup2;/2g) डार्सी-वाइसबैक घर्षण हानि है और h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g प्रवेश, मोड़ और वाल्वों को शामिल करती है। शुद्ध हेड H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
...
$ec_lang['mhp_notes_3_def']='सकल हेड के 10% से कम पेनस्टॉक हानि सामान्यतः किफ़ायती होती है। पाइप लागत और खोई शक्ति के बीच इष्टतम संतुलन प्रायः 4&ndash;6% के आसपास होता है, जहाँ बिजली सबसे मूल्यवान होती है।';
$ec_lang['mhp_notes_4_term']='लघु (स्थानीय) हानियाँ, k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='ये हानियाँ पाइप जंक्शनों, प्रवेशों, मोड़ों और वाल्वों पर होती हैं &mdash; शब्द &ldquo;लघु&rdquo; पारंपरिक है परंतु भ्रामक है; एक छोटी पेनस्टॉक में ये घर्षण हानि के बराबर या उससे अधिक हो सकती हैं। विशिष्ट k मान: तीक्ष्ण प्रवेश 0.5, प्रत्येक 45&deg; मोड़ 0.2&ndash;0.3, गेट वाल्व (पूर्ण खुला) 0.1, बटरफ्लाई वाल्व 0.2। सभी फिटिंग्स का योग कुल k<sub>m</sub> देता है। डिफ़ॉल्ट 1.5 एक प्रवेश और दो मोड़ मानता है।';
$ec_lang['mhp_notes_5_term']='पाइप खुरदरापन e';
$ec_lang['mhp_notes_5_def']='सामान्य पूर्ण खुरदरापन: इस्पात (नया) 0.046&nbsp;mm, इस्पात (पुराना) 0.15&nbsp;mm, HDPE 0.003&nbsp;mm, PVC/uPVC 0.0015&nbsp;mm, कंक्रीट 0.3&ndash;3&nbsp;mm। छोटे माइक्रो-हाइड्रो पेनस्टॉक में HDPE आम है।';
...
$ec_lang['rc_qt']='कुल इकाई प्रवाह, q<sub>t</sub> <span title="रॉक चूट इनलेट पर प्रति इकाई चौड़ाई प्रवाह। तल चौड़ाई B वाले चैनल में कुल प्रवाह Q के लिए, q_t = Q / B उपयोग करें।" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
$ec_lang['rc_np']='रिपरैप सरंध्रता, n<sub>p</sub>';
$ec_lang['rc_sg']='चट्टान आपेक्षिक घनत्व, sg <span title="सामान्य कुचली ग्रेनाइट या बेसाल्ट ≈ 2.65। Robinson वैध सीमा: 2.54 से 2.82।" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_yn']='इनलेट चैनल में सामान्य गहराई, y<sub>n</sub> <span title="ताल बनना (Hp > yn) अच्छा है — अपस्ट्रीम कटाव कम करता है। (USDA)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
$ec_lang['rc_D50']='आवश्यक माध्यिका चट्टान आकार, D<sub>50</sub> <span title="समी. 1 (S0 < 0.10) या समी. 2 (0.10-0.40)। वैध: D50 15-278 mm, S0 0.02-0.40। सीमा के बाहर: बहिर्वेशित।" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_apron_length']='निर्गम एप्रन लंबाई (15 × D<sub>50</sub>) <span title="चूट चट्टान के संरचनात्मक समर्थन के लिए आवश्यक। &quot;निर्गम खंड और अनुप्रवाह चैनल प्रतिरोध के परिणामस्वरूप उत्पन्न न्यूनतम टेलवाटर निर्गम खंड में रिपरैप की स्थिरता सुनिश्चित करने के लिए पर्याप्त है।&quot; (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
$ec_lang['rc_n_chute']='चूट में Manning खुरदरापन, n';
$ec_lang['rc_Vm']='चट्टान आवरण से गुज़रता वेग, V<sub>m</sub> <span title="q_t का वह भाग जो चट्टान के छिद्रों से बहता है। शेष q_s सतह पर बहता है। कोणीय कुचली चट्टान के लिए डिफ़ॉल्ट n_p = 0.45।" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_Hp']='इनलेट वियर शीर्ष, H<sub>p</sub> <span title="ताल बनना (Hp > yn) अच्छा है — अपस्ट्रीम कटाव कम करता है। (USDA)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
$ec_lang['rc_ponding_check']='इनलेट पर ताल बनने की जाँच';
$ec_lang['rc_pond_ok']='H<sub>p</sub> > y<sub>n</sub> — अपस्ट्रीम में ताल बनना';
$ec_lang['rc_pond_ok_tip']='चूट इनलेट के अपस्ट्रीम में ताल बनना अच्छा है; यह अपस्ट्रीम कटाव को कम करता है। (USDA)';
$ec_lang['rc_pond_warn']='H<sub>p</sub> ≤ y<sub>n</sub> — कोई ताल नहीं बनता — इनलेट कटाव की संभावना';
$ec_lang['rc_pond_warn_tip']='चूट इनलेट के अपस्ट्रीम में कोई ताल नहीं बनता; अपस्ट्रीम कटाव हो सकता है। (USDA)';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice & Kadavy (1998) ने चूट ढाल और इकाई प्रवाह के आधार पर माध्यिका रिपरैप आकार D<sub>50</sub> के लिए दो अनुभवजन्य समीकरण विकसित किए। समीकरण 1 सौम्य ढालों के लिए लागू होता है (S<sub>0</sub> < 0.10); समीकरण 2 तीव्र ढालों के लिए लागू होता है (0.10 ≤ S<sub>0</sub> ≤ 0.40)। दोनों समीकरणों में q<sub>t</sub> m²/s में आवश्यक है और D<sub>50</sub> mm में प्राप्त होता है। सत्यापित सीमा 0.02 ≤ S<sub>0</sub> ≤ 0.40 है।';
$ec_lang['rc_notes_2_term']='इकाई प्रवाह';
$ec_lang['rc_notes_2_def']='q<sub>t</sub> चूट क्रेस्ट पर कुल इकाई प्रवाह है (प्रति इकाई चौड़ाई कुल प्रवाह)। तल चौड़ाई B और कुल प्रवाह Q वाले चैनल के लिए, q<sub>t</sub> ≈ Q / B अनुमानित करें, या चूट इनलेट पर क्रांतिक गहराई की स्थिति से इसकी गणना करें।';
$ec_lang['rc_notes_3_term']='चट्टान आवरण से प्रवाह';
$ec_lang['rc_notes_3_def']='कुल प्रवाह का एक भाग चट्टान रिपरैप के छिद्रों से होकर बहता है (आवरण प्रवाह q<sub>m</sub>); शेष भाग चट्टान की सतह के ऊपर बहता है (q<sub>s</sub> = q<sub>t</sub> − q<sub>m</sub>)। प्रवाह गहराई d की गणना चूट खुरदरापन n का उपयोग करते हुए सतही प्रवाह q<sub>s</sub> पर Manning के समीकरण से की जाती है। कोणीय कुचली चट्टान के लिए डिफ़ॉल्ट सरंध्रता n<sub>p</sub> = 0.45 विशिष्ट है।';
...
$ec_lang['rc_notes_6_def']='निर्गम खंड में रिपरैप के शीर्ष की ऊँचाई अनुप्रवाह चैनल तल की ऊँचाई पर या उससे नीचे होनी चाहिए। यदि यह अधिक है, तो निर्गम चट्टान अस्थिर होगी।';
$ec_lang['rc_notes_7_term']='इनलेट जलभराव जाँच';
$ec_lang['rc_notes_7_def']='जब इनलेट चैनल में सामान्य गहराई q<sub>t</sub> को पारित करने के लिए आवश्यक वियर शीर्ष (H<sub>p</sub>) से कम होती है, तो चूट इनलेट के अपस्ट्रीम प्रतिबंधित प्रवाह या ताल बनना होता है। यह सामान्यतः स्वीकार्य है — ताल बनना वेग को कम करता है और अपस्ट्रीम कटाव को रोकता है। जाँचने के लिए: दी गई q<sub>t</sub> और क्रेस्ट चौड़ाई के लिए H<sub>p</sub> ज्ञात करने हेतु वियर प्रवाह कैलकुलेटर का उपयोग करें, और इसकी तुलना इनलेट चैनल की सामान्य गहराई से करें। यदि H<sub>p</sub> सामान्य गहराई से अधिक है, तो ताल बनेगा।';
