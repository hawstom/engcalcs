...
$ec_lang['lpn_inp_drop_quality']='यह फ़ाइल बताती है कि पानी के चलने पर उसकी गुणवत्ता कैसे बदलती है: शुरुआत में पानी में क्या है, उस पदार्थ की और मात्रा कहाँ से आती है, वह कैसे प्रतिक्रिया करता है, और टैंक कैसे मिलाते हैं। यह पृष्ठ जल आयु और स्रोत अनुरेखण निकालता है, पर रसायन विज्ञान नहीं, इसलिए यहाँ उसका कोई उपयोग नहीं होता। उन पंक्तियों को रखा जाता है, और यदि आप EPANET फ़ाइल सहेजते हैं तो वे वापस लिखी जाती हैं।';
...
$ec_lang['lpn_tip_select']='मानचित्र पर चीज़ों को बदलने, ले जाने और खींचने के लिए यह मोड उपयोग करें। कुछ कार्यों के बाद, जैसे कोई प्रोजेक्ट खोलना, पृष्ठ अपने आप इस मोड पर वापस आ जाता है।';
...
$ec_lang['lpn_geomap']='अक्षांश/देशांतर';
$ec_lang['lpn_xymap']='xy';
$ec_lang['lpn_file_import_geo']='मानचित्र पर xy फ़ाइल खोलें…';
$ec_lang['lpn_file_import_geo_tip']='यह इस पृष्ठ पर एक नए प्रोजेक्ट टैब में, सड़क मानचित्र पर, एक प्रोजेक्ट फ़ाइल या एक EPANET फ़ाइल खोलता है। आप ड्राइंग को दुनिया पर हाथ से रखते हैं: साइट तक पैन और ज़ूम करें, फिर उसे फिट करने के लिए आकार और घुमाव दें। यदि फ़ाइल में x और y पहले से ही एक देशांतर और एक अक्षांश हैं, तो ये पहले से ही lat/lon हैं बटन दबाएँ और नेटवर्क सीधे अपनी सही जगह पर पहुँच जाता है। आपके टाइप किए हर अंक जैसा है वैसा ही रहता है।';
...
$ec_lang['lpn_clean_map_tip']='मानचित्र से स्थिति पट्टी और निर्देशांक रीडआउट हटाएँ, ताकि स्क्रीनशॉट में केवल ड्राइंग दिखे। आपकी ड्राइंग को छुआ नहीं जाता, और यह चुनाव सहेजा नहीं जाता; पृष्ठ फिर से लोड करने पर रीडआउट वापस आ जाते हैं।';
...
$ec_lang['lpn_result_water_age_tip']='यहाँ तक पहुँचने वाला पानी सिस्टम में कितनी देर से है। इसकी तुलना करने के लिए कोई नियामक सीमा नहीं है, इसलिए इस संख्या को अपने ही सिस्टम के हिसाब से आँकें।';
...
$ec_lang['lpn_new_coords']='निर्देशांक';
$ec_lang['lpn_new_coords_xy']='xy निर्देशांक';
$ec_lang['lpn_new_coords_geo']='अक्षांश/देशांतर';
$ec_lang['lpn_new_coords_tip']='एक xy प्रोजेक्ट ऐसे निर्देशांक उपयोग करता है जो अक्षांश और देशांतर नहीं हैं। एक lat/lon प्रोजेक्ट में भौगोलिक निर्देशांक होते हैं, इसलिए उसके पीछे सड़क मानचित्र या सैटेलाइट चित्र बनाया जा सकता है और नोड की ऊँचाइयाँ भू-भाग से पढ़ी जा सकती हैं। एक xy प्रोजेक्ट को फ़ाइल, मानचित्र पर xy फ़ाइल खोलें… से lat/lon में बदला जा सकता है।';
$ec_lang['lpn_new_place']='इस जगह के पास से शुरू करें';
$ec_lang['lpn_new_place_tip']='वैकल्पिक। कोई शहर, सड़क या पहचान-चिह्न (लैंडमार्क) टाइप करें और नया मानचित्र वहीं खुलेगा। आपके टाइप किए शब्द OpenStreetMap की जगह-नाम सेवा को भेजे जाते हैं, जो पहली बार आपकी अनुमति माँगती है। इसे खाली छोड़ने पर मानचित्र पूरी दुनिया पर खुलता है।';
$ec_lang['lpn_new_place_hint']='जयपुर, राजस्थान';
$ec_lang['lpn_new_create']='बनाएँ';
$ec_lang['lpn_inp_drop_rules']='इस फ़ाइल में नियम-आधारित नियंत्रण हैं। उन्हें यहाँ लागू नहीं किया जाता, इसलिए वे जिन पाइप, पंप और वाल्वों का नाम लेते हैं वे फ़ाइल में लिखी स्थिति में ही बने रहते हैं। नियमों को स्वयं रखा जाता है, और यदि आप EPANET फ़ाइल सहेजते हैं तो वे वापस लिखे जाते हैं।';
$ec_lang['lpn_inp_drop_energy']='इस EPANET फ़ाइल में पंपिंग लागत मॉडलिंग डेटा शामिल है। यह पृष्ठ ऊर्जा या लागत नहीं निकालता, इसलिए यहाँ उन संख्याओं का कोई उपयोग नहीं होता। उन्हें रखा जाता है, और यदि आप EPANET फ़ाइल सहेजते हैं तो वे वापस लिखी जाती हैं।';
$ec_lang['lpn_inp_drop_tags']='इस फ़ाइल में कुछ जंक्शन, पाइप या अन्य तत्वों को टैग दिए गए हैं। इस पृष्ठ पर अभी किसी टैग को देखने या बदलने की कोई जगह नहीं है। टैग को रखा जाता है, और यदि आप EPANET फ़ाइल सहेजते हैं तो वे वापस लिखे जाते हैं।';
$ec_lang['lpn_inp_drop_report']='इस फ़ाइल में EPANET की अपनी उन सेटिंग्स हैं जो वह अपनी रिपोर्ट छापने के लिए उपयोग करता है। यह पृष्ठ अपने उत्तर अपने ही तरीके से दिखाता है, इसलिए यहाँ उनका कोई उपयोग नहीं होता। उन्हें रखा जाता है, और यदि आप EPANET फ़ाइल सहेजते हैं तो वे वापस लिखी जाती हैं।';
...
$ec_lang['lpn_inp_drop_quality_options']='यह फ़ाइल EPANET जल गुणवत्ता विकल्प बताती है: गुणवत्ता, जो जल गुणवत्ता विश्लेषण के प्रकार का नाम लेती है, और एक रसायन से जुड़ी दो सेटिंग्स, सापेक्ष विसरणशीलता और गुणवत्ता सहनशीलता। जल आयु और स्रोत अनुरेखण यहाँ निकाले जाते हैं; एक रसायन नहीं, इसलिए वे दोनों सेटिंग्स बिना उपयोग किए रखी जाती हैं। यदि आप EPANET फ़ाइल सहेजते हैं तो वे सभी वापस लिखी जाती हैं।';
...
$ec_lang['lpn_settings_quality_track_tip']='चुनें कि रन को पाइपों में होकर क्या खोजना चाहिए: पानी सिस्टम में कब से है, या यह कहाँ से आया। इनमें से किसी को भी सांद्रता या प्रतिक्रिया दर की ज़रूरत नहीं है।';
...
$ec_lang['lpn_quality_chemical']='एक रसायन जिसका नाम यह फ़ाइल लेती है (सहेजा गया, परिकलित नहीं)';
...
$ec_lang['lpn_ff_title']='फायर फ्लो';
...
$ec_lang['lpn_ff_required_node_tip']='इस खास जंक्शन पर आवश्यक फायर फ्लो, आपकी अग्नि संहिता या अग्नि प्राधिकरण से, उस भूमि-उपयोग के लिए जिसकी यह सेवा करता है। इसे खाली छोड़ें तो जंक्शन आवश्यक फायर फ्लो बॉक्स की संख्या के मुकाबले जाँचा जाता है।';
...
$ec_lang['lpn_ff_design_nodes']='सभी अन्य जंक्शन';
...
$ec_lang['lpn_ff_rows_more']='{n} और जंक्शन नहीं दिखाए गए हैं।';
