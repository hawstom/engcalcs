...
$ec_lang['lpn_file_convert_as']='मानचित्र पर xy फ़ाइल खोलें…';
$ec_lang['lpn_file_convert_as_tip']='यह इस पृष्ठ पर एक नए प्रोजेक्ट टैब में, सड़क मानचित्र पर, एक प्रोजेक्ट फ़ाइल या एक EPANET फ़ाइल खोलता है। आप ड्राइंग को दुनिया पर हाथ से रखते हैं: साइट तक पैन और ज़ूम करें, फिर उसे फिट करने के लिए आकार और घुमाव दें। यदि फ़ाइल में x और y पहले से ही एक देशांतर और एक अक्षांश हैं, तो ये पहले से ही lat/lon हैं बटन दबाएँ और नेटवर्क सीधे अपनी सही जगह पर पहुँच जाता है। आपके टाइप किए हर अंक जैसा है वैसा ही रहता है।';
