...
$ec_lang['bpn_line_problem']='Проверите колону Узводни ID: нека линија упућује на непознат ID, упућује на саму себе или формира петљу, па део мреже није повезан са извором. Те линије остају нерешене.';
