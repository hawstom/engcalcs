...
$ec_lang['lpn_file_import_geo']='Претвори у геогр. координате…';
$ec_lang['lpn_file_import_geo_tip']='Са локалне мреже координата у стварни свет. Поставите цртеж направљен на xy мрежи на географске координате, тако да се налази на мапи улица тамо где припада. Сваки број који сте уписали остаје какав јесте — само X и Y постају географска дужина и ширина.';
...
$ec_lang['lpn_pane_tab_tip']='Сваки чвор приказан у табели коју можете сортирати и уређивати.';
$ec_lang['lpn_pane_none']='Ова мрежа још нема чворова.';
