...
$ec_lang['lpn_main_menu']='Прстенаста цевна мрежа (интерфејс са картом) — ПРЕЛИМИНАРНА ВЕРЗИЈА';
$ec_lang['lpn_main_title']='ПРЕЛИМИНАРНА ВЕРЗИЈА: Бесплатни онлајн калкулатор прстенасте цевне мреже са интерфејсом карте';
$ec_lang['lpn_main_desc']='ПРЕЛИМИНАРНА ВЕРЗИЈА — Притисак и проток у прстенастој цевној мрежи коју цртате на карти';
