...
$ec_lang['lpn_main_menu']='Прстенаста цевна мрежа (интерфејс са картом)';
$ec_lang['lpn_main_title']='Бесплатни онлајн калкулатор прстенасте цевне мреже са интерфејсом карте';
$ec_lang['lpn_main_desc']='Притисак и проток у прстенастој цевној мрежи коју цртате на карти';
