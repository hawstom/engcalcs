...
$ec_lang['lpn_field_text_match_pipe']='Прати угао цеви';
...
$ec_lang['lpn_examples_size']='{nodes} чворова, {links} цеви';
...
$ec_lang['lpn_ex_net3_desc']='EPANET-ов велики пример: 97 чворова, два танка и извор из реке. Вреди отворити да видите како модел реалне величине изгледа на мапи.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Покреће EPANET решавач америчке агенције EPA, овде у вашем прегледачу. Оба решавача дају исте резултате, а за мрежу ове величине нећете приметити разлику у брзини. При првом укључивању преузима се око 650 KB, који потом остаје сачуван на овом уређају.';
...
$ec_lang['lpn_settings_readability_bias']='Степени лево од вертикале пре него што се ознака окрене';
