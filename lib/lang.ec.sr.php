...
$ec_lang['lpn_georef_asdeg_btn']='Ово су већ геогр. дужина/ширина';
...
$ec_lang['lpn_menu_project']='Пројекат';
...
$ec_lang['lpn_run_menu_tip']='Поново израчунај ову мрежу сада. Тражите дугме Израчунај? Иако се овај пројекат поново израчунава после сваке измене, трака алатки нема дугме Израчунај. Искључите „Аутоматски израчунавај” у Подешавањима, под Прорачун, Хидраулика, и дугме се враћа.';
...
$ec_lang['lpn_profile_draw']='Изаберите трасу на мапи';
$ec_lang['lpn_profile_draw_stop']='Прекини бирање';
...
$ec_lang['lpn_import_notes_heading']='Из EPANET датотеке';
$ec_lang['lpn_file_open_tip']='Отвори пројектну датотеку сачувану са ове странице.';
$ec_lang['lpn_notes_color_term']='Границе боја остају исте';
$ec_lang['lpn_notes_color_def']='Границе боја се одређују када изаберете метод класификације података. Не одређују се поново на сваком временском тренутку, јер би то учинило да боје значе нешто ново на сваком кораку, а то не помаже при визуелизацији вашег система. EPANET ради на исти начин. Да бисте добили нове границе, изаберите метод поново или упишите сопствене.';
...
$ec_lang['lpn_time_run_report_tip']='Оно што је сам EPANET решавач испечатао о последњем прорачуну: како се решење усталило и на шта је упозорио. Ово је сопствени текст решавача, не наш.';
...
$ec_lang['lpn_library_default_pattern']='Подразумевани образац потрошње';
$ec_lang['lpn_library_default_pattern_tip']='Сваки чвор без обрасца користи овај.';
...
$ec_lang['lpn_field_demand_pattern_tip']='Како се потрошња овог чвора диже и спушта током прорачуна. Оставите на Нема обрасца да прати образац који је сопствен пројекту.';
...
$ec_lang['lpn_terrain_menu']='Попуни коте из терена…';
$ec_lang['lpn_terrain_tip']='Очитава коту терена испод сваког чвора који је нема, и уписује је уместо вас. Чвор који већ има коту остаје нетакнут, а један Опозив враћа све назад. Прва употреба тражи вашу дозволу, јер положаји ваших чворова иду ка Mapbox-у.';
$ec_lang['lpn_terrain_accuracy']='Подаци о терену су тачни на око 30 m по хоризонтали, а често су погрешни неколико метара по вертикали. Третирајте их као топографску карту, не као геодетско снимање: проверите све на шта се ослањате.';
...
$ec_lang['lpn_terrain_confirm']='Попунити коту {n} чвора(ова) са површине терена?';
...
$ec_lang['lpn_terrain_confirm_default_2']='Заменити тих {n} површином терена?';
