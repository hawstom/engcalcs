...
$ec_lang['mhp_length']='Дужина, L <span title="Дужина доводне цеви или канала на водозахвату (улазу)" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_ok']='у оквиру циља од 10%';
$ec_lang['mhp_hl_warn']='прелази циљ од 10%';
$ec_lang['mhp_hl_warn_tip']='Размотрите шири цевовод';
$ec_lang['mhp_hl_bad']='прелази 20%';
$ec_lang['mhp_hl_bad_tip']='Редимензионишите цевовод';
...
$ec_lang['mhp_notes_4_def']='Ови губици настају на спојевима цеви, улазима, кривинама и вентилима — назив „мали" губици је уобичајен, али је заваравајући: код кратког напорног цевовода они могу бити једнаки или чак већи од губитака трењем. Типичне вредности k: оштар улазни отвор 0,5, свако колено од 45° 0,2–0,3, засун (потпуно отворен) 0,1, лептирасти вентил 0,2. Саберите коефицијенте свих фитинга за укупно k<sub>m</sub>. Подразумевана вредност 1,5 претпоставља један улаз и два колена.';
...
$ec_lang['rc_qt']='Јединични проток, q<sub>t</sub> <span title="Проток по јединици ширине при улазу у брзотек. За канал са ширином дна B и укупним протоком Q користите q_t = Q / B." class="ec-tip">?</span>';
$ec_lang['rc_np']='Порозност каменог поплочавања, n<sub>p</sub>';
$ec_lang['rc_sg']='Специфична тежина камена, sg <span title="Типичан дробљени гранит или базалт ≈ 2,65. Опсег по Robinson: 2,54 до 2,82." class="ec-tip">?</span>';
$ec_lang['rc_SD']='Гранулометрија SD = D<sub>84.1</sub>/D<sub>50</sub> <span title="Стандардна девијација гранулометријског састава. Уједначен камен ≈ 1,25. Опсег по Robinson: 1,15 до 1,47." class="ec-tip">?</span>';
$ec_lang['rc_yn']='Нормална дубина у улазном каналу, y<sub>n</sub> <span title="Успор (Hp > yn) је пожељан — смањује ерозију узводно. (USDA)" class="ec-tip">?</span>';
$ec_lang['rc_D50']='Потребна средња величина камена, D<sub>50</sub> <span title="Јед. 1 (S0 < 0,10) или Јед. 2 (0,10–0,40). Важи: D50 15–278 мм, S0 0,02–0,40. Ван опсега: екстраполација." class="ec-tip">?</span>';
...
$ec_lang['rc_apron_length']='Дужина излазне плоче (15 × D<sub>50</sub>) <span title="Потребна за конструктивну подршку камена брзотека. „Минимална доња вода која настаје услед излазне деонице и отпора низводног канала довољна је да обезбеди стабилност поплочавања у излазној деоници." (Robinson)" class="ec-tip">?</span>';
$ec_lang['rc_n_chute']='Манингов коефицијент храпавости у брзотоку, n';
$ec_lang['rc_Vm']='Брзина кроз камену мантију, V<sub>m</sub> <span title="Део qt који тече кроз поре камена. Остатак qs тече по површини. Подразумевана вредност np = 0,45 за угласти дробљени камен." class="ec-tip">?</span>';
...
$ec_lang['rc_Hp']='Преливна висина на улазу, H<sub>p</sub> <span title="Успор (Hp > yn) је пожељан — смањује ерозију узводно. (USDA)" class="ec-tip">?</span>';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice & Kadavy (1998) развили су две емпиријске једначине за средњу величину поплочавања D<sub>50</sub> на основу пада брзотека и јединичног протока. Једначина 1 се примењује за благе падове (S<sub>0</sub> < 0,10); Једначина 2 — за стрме падове (0,10 ≤ S<sub>0</sub> ≤ 0,40). Обе једначине захтевају q<sub>t</sub> у м²/с и враћају D<sub>50</sub> у мм. Валидирани опсег је 0,02 ≤ S<sub>0</sub> ≤ 0,40.';
...
$ec_lang['rc_notes_7_term']='Провера успора на улазу';
