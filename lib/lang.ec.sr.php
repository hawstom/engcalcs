...
$ec_lang['odt_main_title']='Бесплатни онлајн калкулатор времена пражњења кроз отвор';
$ec_lang['odt_main_desc']='Време пражњења акумулације кроз отвор &mdash; Метод конусног запремине';
$ec_lang['odt_h1_elev']='Почетна кота нивоа воде';
$ec_lang['odt_a1']='Почетна површина акумулације, A1';
$ec_lang['odt_h2_elev']='Завршна кота нивоа воде';
$ec_lang['odt_h_orifice']='Кота тежишта отвора';
$ec_lang['odt_a0']='Површина акумулације на коти отвора, A0';
...
$ec_lang['template_translation_help']='Можете ли помоћи у побољшању превода, програмирању или хостовању ових калкулатора?  ';
