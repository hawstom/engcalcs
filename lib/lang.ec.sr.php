...
$ec_lang['mpf_note_1']='<dl><dt>Ово је проток и дубина унутар <em>бесконачно дугачке</em> цеви.</dt><dd>За унос воде у цев може бити потребна знатно већа дубина нивоа воде. Додајте најмање 1,5 пута брзинску висину да бисте добили дубину нивоа воде или <a target="_blank" href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">погледајте мој 2-минутни туторијал</a> за стандардна израчунавања нивоа воде на пропусту помоћу HY-8.</dd>';
...
$ec_lang['odt_main_desc']='Време пражњења базена, акумулације или резервоара &mdash; излаз кроз отвор, метод конусне запремине';
