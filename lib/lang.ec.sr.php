...
$ec_lang['lpn_time_run_note']='Видите мрежу у првом извештајном тренутку. Подешавање Аутоматски израчунавај је искључено, па резултати за касније тренутке не остају ажурни док радите. Притисните дугме Израчунај да бисте их ажурирали.';
...
// Sprint 584-wave1 batch 1 (translator agent, sr)
...
// Sprint 584-wave1 batch 2 (translator agent, sr)
...
$ec_lang['lpn_pane_paste_note']='Ова табела је намењена за уношење вредности лепљењем из табеларног прорачуна у редове који већ постоје. Ако вам ово не одговара, користите Помоћ, Пријави проблем да нам јавите.';
...
$ec_lang['lpn_georef_projected']='Овај пројекат већ наводи пројекцију карте, па се његове координате не могу поново поставити на карту.';
...
$ec_lang['lpn_new_coordsys_geo']='Географска пројекција';
$ec_lang['lpn_new_coordsys_geo_tip']='Изаберите географску пројекцију. Користите WGS 84 / Pseudo-Mercator EPSG:3857 за геогр. ширину/дужину.';
...
$ec_lang['lpn_new_crs_tip']='Пројекција у којој су ваше координате већ измерене. Координате се чувају тачно онако како их уносите, и ништа се не претвара. Овај избор је трајан; једини начин да претворите мрежу у другачије координате јесте „Датотека, Отвори у новим координатама“, и то је приближно. UTM је доминантан светски стандард, регион може имати своје обичаје, а геометар је особа коју треба питати ако нисте сигурни.';
...
$ec_lang['lpn_crs_place_projected']='Пројектован пројекат се отвара на сопственој равни, а не на месту које сте претражили. Постављање те равни на Земљу захтева трансформацију координата, коју ова страница још нема.';
...
$ec_lang['lpn_menu_cue']='Почните од менија изнад. Користите траку алата за брз приступ.';
