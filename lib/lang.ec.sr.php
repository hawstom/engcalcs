...
$ec_lang['cs_Ec_target']='Циљ облагања, E<sub>c,target</sub> <span title="Циљна ефикасност транспорта воде након облагања; удео 0–1" class="ec-tip">?</span>';
...
$ec_lang['cs_payback_years']='Период поврата инвестиције <span title="Прост поврат = укупан трошак облагања &divide; годишња опорављена вредност" class="ec-tip">?</span>';
...
$ec_lang['ip_x']='Експонент протока емитера, x <span title="0,5 за стандардне емитере без компензације притиска; близу 0 за емитере са компензацијом притиска" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='Лат. <span title="Означено: ова деоница је сегмент тестне латерале, из које појединачни емитери узимају воду. Неозначено: ова деоница је магистрала, која само преноси проток ка латералама ван путање теста." class="ec-tip">?</span>';
$ec_lang['ip_count']='Емитери <span title="Редови латерале: емитери само у овој деоници. Редови магистрале: укупан број емитера на латералама ОСИМ ове, које се одвајају од ове деонице. За деоницу магистрале која се завршава код тестне латерале, ово укључује и све латерале даље низ магистралу иза те тачке, или које деле исти чвор (нпр. латерала на супротној страни) &mdash; и њихов проток се такође одваја од исте деонице." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_e']='e <span title="Darcy-Weisbach висина храпавости" class="ec-tip">?</span>';
$ec_lang['ip_km']='k<sub>m</sub> <span title="Генерички коефицијент локалног губитка за фитинге/вентиле/спојнице ове деонице (препоручена минимална вредност &ge;0,5)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='Низв. кота <span title="Кота низводног краја ове деонице. Опционо код унутрашњих редова (подразумевано равно / исто као претходни чвор ако се остави празно). Обавезно у последњем реду: та вредност је кота последњег емитера, која директно одређује потребан притисак напајања." class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='Проток напајања путање теста, Q<sub>supply</sub> <span title="Проток који улази само у моделирану путању теста &mdash; за целу зону/систем, погледајте Q_zone у делу Пројектовање примене испод." class="ec-tip">?</span>';
...
$ec_lang['ip_q_ratio']='Проток последњег емитера &divide; пројектни проток, q<sub>last</sub>/q<sub>design</sub> <span title="Ово се разликује од наше приближне процене стандардне мере уједначености." class="ec-tip">?</span>';
