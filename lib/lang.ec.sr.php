...
$ec_lang['lpn_ex_net3_world_desc']='Иста мрежа као EPANET Net3, постављена на стварну локацију: њене координате су географска дужина и ширина, а испод ње је нацртана мапа улица.';
...
$ec_lang['lpn_demand_tip']='Проток који се узима из мреже у овом чвору. Унесите негативан број за проток који се уводи у мрежу овде.';
...
$ec_lang['lpn_new_blank_us']='Празан XY пројекат, амерички јединице (gpm)';
$ec_lang['lpn_new_blank_si']='Празан XY пројекат, SI јединице (l/s)';
...
$ec_lang['lpn_file_import_inp_tip']='Учитајте мрежу из EPANET датотеке, било .inp текстуалне датотеке или .net датотеке коју EPANET чува, и сачувајте је у овом прегледачу као нови пројекат. Ова страница не може да запише EPANET датотеку назад, па користите Датотека, Сачувај као да сачувате свој рад.';
...
$ec_lang['lpn_inp_report_lead']='Ова страница не садржи све што EPANET садржи. Ево шта се променило приликом увоза:';
...
$ec_lang['lpn_inp_drop_valve']='Ови вентили су описани кривом или фиксним падом притиска, а ова страница нема такав елемент. Пренети су као отворене цеви, па је мрежа и даље повезана, али ништа тамо више не одржава притисак или проток.';
...
$ec_lang['lpn_inp_drop_pump_other']='Ова пумпа је описана снагом, брзином или распоредом, а не кривом. Пренета је без криве, па не додаје напор.';
...
$ec_lang['lpn_inp_drop_quality']='Квалитет воде, хемијска реакција и подешавања енергије пумпе су изостављени. Ова страница решава само проток и притисак.';
...
$ec_lang['lpn_notes_1_term']='Стационарно стање';
$ec_lang['lpn_notes_1_def']='Решава по један скуп потрошњи одједном, користећи исти алгоритам глобалног градијента који користи и EPANET. Не моделује како се мрежа мења током времена. Тенк се држи на нивоу воде који му задате: унутар једног решења он никада не пресуши и никада се не напуни.';
$ec_lang['lpn_notes_2_term']='Није моделовано';
$ec_lang['lpn_notes_2_def']='Квалитет воде и потрошње које се мењају током дана нису моделовани. Вентили: пригушни вентил ради у оба решавача, а вентили који се сами отварају и затварају (PRV, PSV, FCV) се решавају помоћу EPANET решавача, који ова страница сама укључује када ваша мрежа садржи такав вентил.';
...
$ec_lang['lpn_notes_4_term']='Планирана проширења';
$ec_lang['lpn_notes_4_def']='Сценарији, како би један пројекат могао да садржи више скупова потрошњи. Табеле резултата за чворове и цеви. Записивање EPANET .inp датотека, како би пројекат могао да се врати назад у EPANET. Коментари и предлози су увек добродошли (видите везу за повратне информације изнад).';
...
$ec_lang['lpn_mode_select']='Режим: Избор. Кликните елемент или ознаку да бисте је видели или изменили. Превуците да бисте померили чвор, тачку прегиба или ознаку. Двапут кликните на цев да бисте додали или уклонили тачку прегиба.';
...
$ec_lang['lpn_mode_add_pipe']='Режим: Додавање цеви. Кликните на чвор, па на други чвор, да бисте их повезали. Пређите у режим Избор да бисте мењали или померали елементе и ознаке.';
$ec_lang['lpn_mode_add_pump']='Режим: Додавање пумпе. Кликните на чвор, па на други чвор, да бисте их повезали. Пређите у режим Избор да бисте мењали или померали елементе и ознаке.';
$ec_lang['lpn_mode_add_valve']='Режим: Додавање вентила. Кликните на чвор, па на други чвор, да бисте их повезали. Пређите у режим Избор да бисте мењали или померали елементе и ознаке.';
// Text was wrong (Tom, 2026-07-30): "click a node first to anchor it there" implied a two-click
// sequence (click node, THEN click to place), but placing near a node anchors it in that ONE click.
$ec_lang['lpn_mode_add_text']='Режим: Додавање текста. Кликните на мапу да бисте поставили текстуалну ознаку. Кликните близу чвора да бисте текст везали за тај чвор. Пређите у режим Избор да бисте мењали или померали елементе и ознаке.';
...
$ec_lang['lpn_tip_select']='Користите овај режим да бисте мењали, померали и превлачили ствари на мапи.';
...
$ec_lang['lpn_labels_mark_extrema_tip']='Исцртава линију изнад највеће вредности сваке врсте на мапи, и линију испод најмање вредности те врсте, тако да крајности можете препознати без читања бројева.';
...
$ec_lang['lpn_confirm_apply_prefix']='Преименовати {n} елемената тако да њихови ID-еви почињу са {prefix}? Сваки задржава свој број.';
$ec_lang['lpn_prefix_applied']='Преименовано {n} елемената. {skipped} других је остало непромењено.';
$ec_lang['lpn_labels_prefix_tip']='Текст приказан пре ове вредности на мапи';
$ec_lang['lpn_labels_prefix_id_tip']='Текст приказан пре ID-а на мапи. Оставите ово празно и ID се приказује сам, почевши словом које му је додељено, на пример J1 или L1.';
$ec_lang['lpn_labels_suffix_tip']='Текст приказан после ове вредности на мапи';
$ec_lang['lpn_labels_suffix_gradient_tip']='Текст приказан после градијента губитка напора на мапи. Овде немојте уписивати знак процента. Он се додаје аутоматски када су јединице проценти.';
$ec_lang['lpn_labels_separator']='Текст између вредности';
$ec_lang['lpn_labels_separator_tip']='Текст између једне и следеће вредности на ознаци. Подразумевано је размак.';
...
$ec_lang['lpn_labels_priority_node_tip']='Приоритет за одлучивање чија се ознака прва изоставља када је мапа претрпана: најмања потрошња, притисак најближи средини опсега, или кота или напор најближи оном код суседних чворова. 1 одлучује прво.';
...
$ec_lang['lpn_settings_scope_project']='Подешавања пројекта';
$ec_lang['lpn_settings_scope_calculator']='Подешавања калкулатора';
...
$ec_lang['lpn_settings_defaults_note']='Користи се за елементе које убудуће направите. Постојећи елементи се не мењају.';
$ec_lang['lpn_settings_push_note']='Примењују се само својства чије су ознаке тренутно приказане.';
$ec_lang['lpn_settings_push_btn']='Примени почетне вредности на све елементе';
$ec_lang['lpn_push_confirm']='Заменити ова својства на сваком постојећем елементу тренутним почетним вредностима? Вредности које сте уписали биће преписане. Ово можете поништити.';
$ec_lang['lpn_push_properties']='Својства:';
$ec_lang['lpn_push_elements']='Чворови и цеви:';
...
$ec_lang['lpn_push_nothing']='Ниједан постојећи елемент нема ниједно од својстава која се примењују.';
...
$ec_lang['lpn_field_active_tip']='Уклоните ознаку да бисте оставили елемент на цртежу, али изван мреже: приказује се сиво и решавач га занемарује. У сценарију се на овај начин предложена цев укључује и искључује.';
$ec_lang['lpn_settings_emitter_exponent']='Експонент прскалице';
// The Settings panel's Computation section (Tom, 2026-08-10). "Computation", not "Solver": what the
// two rows under it decide is the arithmetic the user gets, and "solver" names the internals.
$ec_lang['lpn_settings_computation']='Прорачун';
...
$ec_lang['lpn_settings_map_height_px']='Висина мапе (пиксели екрана)';
...
$ec_lang['lpn_settings_map_height_tip']='На малом екрану мапа се исцртава нижа од овога, тако да увек остаје део странице за скроловање.';
$ec_lang['lpn_settings_legend_position']='Положај легенде';
...
$ec_lang['lpn_settings_colors']='Боја према вредности';
...
$ec_lang['lpn_units_warn_title']='Ова јединица одређује шта ваши бројеви значе';
$ec_lang['lpn_units_warn_body']='{unit} је јединица за оно што уносите за: {list}. Реинтерпретација оставља сваки број какав јесте и чита га у новој јединици. Претварање свих преписује сваки од тих бројева, тако да мрежа обухвата исти простор као и раније.';
$ec_lang['lpn_units_reinterpret']='Реинтерпретирај (промени шта значе)';
$ec_lang['lpn_units_convert']='Претвори их све';
...
$ec_lang['lpn_units_group_inputs']='Јединице уноса';
$ec_lang['lpn_units_group_results']='Јединице резултата';
...
$ec_lang['lpn_georef_menu']='Претвори у геогр. координате…';
$ec_lang['lpn_georef_tip']='Са локалне мреже координата у стварни свет. Поставите цртеж направљен на XY мрежи на географске координате, тако да се налази на мапи улица тамо где припада. Сваки број који сте уписали остаје какав јесте — само X и Y постају географска дужина и ширина.';
$ec_lang['lpn_georef_intro']='Претворити овај XY пројекат у пројекат са геогр. координатама? Ваш пројекат је постављен у центар светске мапе. Зумирајте до своје локације и померајте, мењајте величину и окрећите модел колико год желите. Када будете спремни да почнете да подешавате елементе, притисните Задржи овај положај.';
$ec_lang['lpn_georef_adjust']='Превуците модел да га померите, превуците угао да му промените величину, превуците округлу ручку изнад модела да га окренете. Или упишите размеру и угао окретања испод.';
$ec_lang['lpn_georef_step1']='Корак 1 од 2 — одвојено';
$ec_lang['lpn_georef_step2']='Корак 2 од 2 — прикачено';
$ec_lang['lpn_georef_step1_hint']='Ваш пројекат остаје тамо где јесте на екрану. Померајте и зумирајте мапу испод њега док подлога иза њега не буде отприлике на правом месту и отприлике праве величине, а затим притисните Постави модел овде.';
...
$ec_lang['lpn_tool_add_reservoir_tip']='Кликните на мапу да додате резервоар: извор који одржава један стални ниво воде.';
$ec_lang['lpn_tool_add_tank_tip']='Кликните на мапу да додате танк: складиште чији ниво воде сами подешавате.';
...
$ec_lang['lpn_find_menu_tip']='Пронађи део по његовом ID-у, или пронађи сваки део који испуњава услов.';
...
$ec_lang['lpn_color_ranges_note']='Режим изнад поставља ове границе на основу вредности које су тренутно на мапи. Упишите преко њих и исти број ће увек значити исту боју.';
$ec_lang['lpn_color_criterion_note']='Границе опсега потичу из пројектног стандарда, па је број опсега фиксан док је тај режим изабран.';
$ec_lang['lpn_color_break_number']='Граница опсега мора бити број. Мапа остаје непромењена.';
$ec_lang['lpn_color_break_order']='Свака граница опсега мора бити већа од претходне. Мапа остаје непромењена.';
$ec_lang['lpn_color_break_count']='Мора бити једна граница мање него што има опсега. Мапа остаје непромењена.';
...
$ec_lang['lpn_georef_done']='Ово је сада пројекат са геогр. координатама. Превуците било који елемент да га померите ближе месту где стварно јесте.';
$ec_lang['lpn_georef_on_map']='Овај пројекат је већ на геогр. координатама.';
$ec_lang['lpn_georef_empty']='Прво нацртајте или отворите мрежу. Још нема ништа за постављање.';
...
$ec_lang['lpn_pane_toggle_tip']='Прикажи или сакриј панел испод мапе. У њему су профил и табела чворова.';
$ec_lang['lpn_pane_resize']='Превуците да панел учините вишим или нижим';
$ec_lang['lpn_pane_tab_junctions']='Чворови';
$ec_lang['lpn_pane_tab_junctions_tip']='Сваки чвор приказан у табели коју можете сортирати и уређивати.';
$ec_lang['lpn_pane_junctions_none']='Ова мрежа још нема чворова.';
...
$ec_lang['lpn_clean_map_tip']='Сакриј линију режима и очитавање координата тако да снимак екрана прикаже само мапу. Ваш цртеж се не мења, а овај избор се не чува — поновно учитавање странице враћа очитавања.';
$ec_lang['lpn_find_menu']='Пронађи';
$ec_lang['lpn_find_title']='Пронађи елементе';
...
$ec_lang['lpn_profile_title']='Профил дуж трасе';
$ec_lang['lpn_profile_from']='Од';
$ec_lang['lpn_profile_to']='До';
$ec_lang['lpn_profile_pick']='Додајте чворове на трасу кликом на њих на мапи';
$ec_lang['lpn_profile_through']='Чворови на путу';
$ec_lang['lpn_profile_clear']='Уклони све';
...
$ec_lang['lpn_new_geo_us']='Празан пројекат са геогр. координатама, амерички јединице (gpm)';
$ec_lang['lpn_new_geo_si']='Празан пројекат са геогр. координатама, SI јединице (l/s)';
...
$ec_lang['lpn_select_first']='Ништа није изабрано. Прво кликните елемент на мапи, па притисните Обриши.';
...
$ec_lang['lpn_time_no_engine']='Уграђени решавач обрађује по један тренутак, тако да ово приказује мрежу само у тренутку {time}: потрошње носе множиоце обрасца за тај тренутак, а сваки танк и даље стоји на свом почетном нивоу уместо да се пуни и празни. Повежите се једном на интернет да преузмете EPANET решавач, који обрађује цео период.';
...
$ec_lang['lpn_time_run']='Покрени';
$ec_lang['lpn_time_run_tip']='Обрађује ову мрежу у сваком њеном извештајном тренутку, од првог до последњег.';
$ec_lang['lpn_time_run_note']='Мрежа је приказана у првом извештајном тренутку. Обрада целе мреже кроз њен временски период траје толико дуго да резултати за касније тренутке не остају ажурни док радите. Притисните Покрени да их ажурирате.';
...
$ec_lang['lpn_settings_sec_elements']='Нови елементи';
