...
$ec_lang['template_translation_help']='Daha iyi bir ifade ya da başka bir şey önerebilir misiniz? Lütfen bize bildirin.';
...
$ec_lang['ip_du_estimate']='<span class="ec-help" title="Son damlatıcının hesaplanan debisi, tahmini saha-ortalama damlatıcı debisine bölünür — bu, standart düşük-çeyrek Dağılım Düzgünlüğü\'nün (düşük-grup ortalama &divide; nüfus ortalaması) bir yaklaşımıdır; ancak bu, tam saha istatistiksel örneği yerine küçük bir modellenen örnekten ve kullanıcı tarafından tahmin edilen bir düzeltmeden elde edilir. 1\'e eşit veya üzerindeki değerler mümkündür ve geçerlidir: bunlar yalnızca son damlatıcının basıncının tahmini saha ortalamasında veya üzerinde olduğu, dolayısıyla en düşük basınç noktasının başka bir damlatıcı olduğu anlamına gelir. Bunun nedeni son damlatıcının alçak zeminde olması veya &Delta;basınç tahmininin çok küçük olması olabilir.">Düzgünlük kontrolü, q<sub>last</sub>/q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
$ec_lang['ip_worst_case_warn']='Test damlatıcısındaki basınç &ge; besleme basıncı. Bu muhtemelen en kötü durumdaki damlatıcı değildir, ya da borular daha küçük seçilebilir.';
$ec_lang['ip_q_ratio']='<span class="ec-help" title="Bu, standart düzgünlük ölçüsüne ilişkin yaklaşımımızdan farklıdır.">Son damlatıcı debisi &divide; tasarım debisi, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
