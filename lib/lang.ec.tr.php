...
$ec_lang['mhp_efficiency']='Santral verimi, &eta; (0&ndash;1)';
...
$ec_lang['mhp_vel_low']='1 m/s altında — çapı azaltın ⚠';
$ec_lang['mhp_vel_high']='3 m/s üzerinde — çapı artırın ⚠';
...
$ec_lang['mhp_notes_1_def']='Toplam cebri boru kaybı h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>; burada h<sub>f</sub> = f(L/D)(v&sup2;/2g) Darcy-Weisbach sürtünme kaybıdır ve h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g giriş, dirsek ve vanaları kapsar. Net yük H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Hız';
$ec_lang['mhp_notes_2_def']='Hedef 1&ndash;3 m/s. 1 m/s altı boru aşırı boyutlanmış; 3 m/s üstü sürtünme kayıplarını ve su darbesi riskini artırır.';
$ec_lang['mhp_notes_3_term']='Yük Kaybı Hedefi';
$ec_lang['mhp_notes_3_def']='Brüt yükün %10\'unun altındaki cebri boru kayıpları genellikle ekonomiktir. Boru maliyeti ile kaybedilen güç arasındaki optimum denge, yüksek değerli elektrik tesislerinde genellikle %4&ndash;6 civarındadır.';
$ec_lang['mhp_notes_4_term']='Lokal Kayıplar k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Tipik değerler: keskin giriş 0.5, her 45&deg; dirsek 0.2&ndash;0.3, sürgü vana (tam açık) 0.1, kelebek vana 0.2. Tüm bağlantı parçalarının toplamı toplam k<sub>m</sub>\'yi verir. Varsayılan 1.5, bir giriş ve iki dirsek varsayar.';
$ec_lang['mhp_notes_5_term']='Boru Pürüzlülüğü e';
$ec_lang['mhp_notes_5_def']='Tipik mutlak pürüzlülük: çelik (yeni) 0.046&nbsp;mm, çelik (kullanılmış) 0.15&nbsp;mm, HDPE 0.003&nbsp;mm, PVC/uPVC 0.0015&nbsp;mm, beton 0.3&ndash;3&nbsp;mm. HDPE, küçük mikro-hidro cebri borularında yaygındır.';
