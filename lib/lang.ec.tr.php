...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="Darcy-Weisbach pürüzlülük yüksekliği"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_km']='<span class="ec-help" title="Cebri boru boyunca tüm birleşim ve bağlantı parçası kayıp katsayılarının toplamı">Yerel kayıp katsayısı, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="Temiz su için 20°C civarında 1×10⁻⁶ m²/s">Kinematik viskozite, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_count']='<span class="ec-help" title="Lateral satırları: bu hattaki damlatıcılar sadece. Ana satırları: bu hattan branşlanan diğer lateral\'lerdeki toplam damlatıcılar. Test lateral\'inin kendi alındığı hat için, bu aynı zamanda o alındıktan sonra ana hat boyunca diğer lateral\'leri veya aynı kavşağı paylaşan (örneğin ters taraf lateral) damlatıcıları içerir — akışları bu aynı hattan branşlanır, bu tabloda başka yerde göründükleri olsa da.">Damlatıcılar <span class="ec-tip">?</span></span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_e']='<span class="ec-help" title="Darcy-Weisbach pürüzlülük yüksekliği">e <span class="ec-tip">?</span></span>';
