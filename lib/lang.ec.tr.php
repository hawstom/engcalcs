...
$ec_lang['lpn_units_length']='Uzunluk ve harita';
...
$ec_lang['lpn_file_write_failed']='Dosyaya yazılamadı. Dosya taşınmış veya yeniden adlandırılmış olabilir, ya da izin geri alınmış olabilir. Çalışmanız bu tarayıcıda hâlâ kayıtlıdır. Dosyayı yeniden seçmek için Dosyaya Kaydet\'i kullanın.';
...
$ec_lang['lpn_lock_dismiss']='Kapat';
...
$ec_lang['lpn_notes_1_def']='EPANET\'in kullandığı aynı gradyan yöntemini kullanarak seferde bir talep kümesini çözer. Şebekenin zaman içinde nasıl değiştiğini modellemez.';
...
$ec_lang['lpn_notes_epanet_term']='Hazen-Williams sabitleri artık EPANET ile eşleşiyor (Ağustos 2026)';
...
$ec_lang['lpn_pump_curve_source']='Eğri';
...
$ec_lang['lpn_field_text_size']='Boyut ×';
...
$ec_lang['lpn_backdrop_scale']='Görüntüyü ölçekle';
$ec_lang['lpn_backdrop_position']='Görüntüyü konumlandır';
...
$ec_lang['lpn_settings_defaults']='Varsayılan girdiler';
...
$ec_lang['lpn_settings_push_btn']='Varsayılanları tüm öğelere uygula';
$ec_lang['lpn_push_confirm']='Bu özellikler mevcut her öğede geçerli varsayılan girdilerle değiştirilsin mi? Yazdığınız değerlerin üzerine yazılır. Bunu geri alabilirsiniz.';
$ec_lang['lpn_push_properties']='Özellikler:';
$ec_lang['lpn_push_elements']='Öğeler:';
$ec_lang['lpn_push_none_displayed']='Şu anda etiket olarak gösterilen bir varsayılan girdi yok, bu yüzden uygulanacak bir şey yok. İstediğiniz özelliklerin etiketlerini Etiketler panelinde açın, ardından tekrar deneyin.';
...
$ec_lang['lpn_settings_text_size_map']='Harita birimleri';
...
$ec_lang['lpn_settings_map_display']='Harita görünümü ve boyutları';
