...
$ec_lang['cs_main_desc']='Kanal Sızıntı Kaybı &amp; İletim Verimliliği &mdash; Giriş-Çıkış Yöntemi';
$ec_lang['cs_Q_in']='Güzergah başındaki giriş debisi, Q<sub>in</sub>';
$ec_lang['cs_Q_out']='Güzergah sonundaki çıkış debisi, Q<sub>out</sub>';
$ec_lang['cs_Q_loss']='Sızıntı kayıp debisi, Q<sub>loss</sub>';
$ec_lang['cs_loss_check']='Ölçüm kontrolü';
$ec_lang['cs_pct_loss']='Girişin kaybolan oranı';
...
$ec_lang['cs_wp']='Kanal kesit ıslak çevresi, P<sub>w</sub>';
$ec_lang['cs_Q_loss_per_L']='Birim uzunluk başına sızıntı kaybı, Q<sub>loss</sub>/L';
$ec_lang['cs_water_value']='Su değeri (para / hacim birimi)';
$ec_lang['cs_lining_cost']='Astar maliyeti (para / alan birimi)';
$ec_lang['cs_Ec_target']='Astarlamadan sonra hedef iletim verimliliği, E<sub>c,target</sub> (oran, 0&ndash;1) &mdash; astarlı kanalın suyu ne kadar iyi tutacağına ilişkin hedef';
$ec_lang['cs_lining_area']='Kanal astar alanı (L &times; P<sub>w</sub>)';
$ec_lang['cs_annual_value_lost']='Kaybedilen su yıllık değeri (para)';
$ec_lang['cs_annual_value_recovered']='Astarlamadan kurtarılan yıllık değer (para)';
$ec_lang['cs_lining_total_cost']='Toplam astar maliyeti (para)';
$ec_lang['cs_payback_years']='Basit geri ödeme süresi (yıl)';
...
$ec_lang['cs_notes_1_def']='Giriş-çıkış yöntemi, bir kanal güzergahının başındaki ve sonundaki akışı ölçerek sızıntıyı tahmin eder: Q<sub>loss</sub> = Q<sub>in</sub> &minus; Q<sub>out</sub>. İletim verimliliği E<sub>c</sub> = Q<sub>out</sub> / Q<sub>in</sub>. Yıllık hacim, sürekli tam debi ile çalışma varsayımına dayanır; mevsimsel veya kısmi debi durumunda gerçek kayıp daha düşük olacaktır.';
$ec_lang['cs_notes_2_term']='Verimlilik Değerlendirmeleri';
$ec_lang['cs_notes_2_def']='Tipik astarlanmamış toprak kanallar: E<sub>c</sub> = %60&ndash;80. İyi bakımlı toprak kanallar: %75&ndash;85. Beton astarlı kanallar: %90&ndash;98. Girişin %30\'unu aşan sızıntı kayıpları çoğunlukla astar yatırımını haklı kılar. (USBR, FAO)';
$ec_lang['cs_notes_3_term']='Astar Geri Ödeme';
$ec_lang['cs_notes_3_def']='Su değerini ve astar maliyetini herhangi bir tutarlı para biriminde girin. Astar alanı = güzergah uzunluğu &times; ıslak çevre &mdash; ölçülen akış derinliğindeki kanal kesitinin ıslak çevresi (taban genişliği artı her iki ıslak yamaç). Kurtarılan yıllık değer, astarlı kanalın hedef E<sub>c</sub>\'yi sürekli olarak sağladığını varsayar. Mevsimsel kanallar için veya astar hedef verimliliğe ulaşmadığında gerçek geri ödeme süresi daha uzun olacaktır.';
...
$ec_lang['rc_main_desc']='Taş Düşü Parça Taşı Boyutlandırması &mdash; Robinson, Rice &amp; Kadavy (1998)';
...
$ec_lang['rc_layer']='Taş tabaka kalınlığı (2 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_radius']='Üst eşik eğri yarıçapı (40 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_length']='Üst eşik eğri yay uzunluğu';
$ec_lang['rc_apron_length']='Çıkış önlük uzunluğu (15 &times; D<sub>50</sub>) <span title="Düşü taşının yapısal desteği için gereklidir. &quot;Çıkış kesimi ve mansap kanal direncinden kaynaklanan minimum kuyruk suyu, çıkış kesimindeki parça taşının stabilitesini sağlamaya yeterlidir.&quot; (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_qs']='Yüzey birim debisi, q<sub>s</sub> (q<sub>t</sub> &minus; q<sub>m</sub>)';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice &amp; Kadavy (1998), düşü eğimi ve birim deşarj temelinde ortanca parça taşı boyutu D<sub>50</sub> için iki ampirik denklem geliştirmiştir. Denklem 1 hafif eğimler için geçerlidir (S<sub>0</sub> &lt; 0,10); Denklem 2 dik eğimler için geçerlidir (0,10 &le; S<sub>0</sub> &le; 0,40). Her iki denklem de q<sub>t</sub>\'yi m&sup2;/s cinsinden gerektirir ve D<sub>50</sub>\'yi mm cinsinden verir. Doğrulanmış aralık 0,02 &le; S<sub>0</sub> &le; 0,40\'tır.';
$ec_lang['rc_notes_2_term']='Birim Deşarj';
$ec_lang['rc_notes_2_def']='q<sub>t</sub>, düşü eşiğindeki toplam birim deşarjdır (birim genişlik başına toplam debi). B taban genişliğinde ve Q toplam debili bir kanal için q<sub>t</sub> &asymp; Q / B olarak yaklaşık alınabilir veya düşü girişindeki kritik derinlik koşulundan hesaplanabilir.';
$ec_lang['rc_notes_3_term']='Taş Mantosu İçinden Akış';
$ec_lang['rc_notes_3_def']='Toplam akışın bir kısmı parça taşı gözeneklerinden geçer (manto akışı q<sub>m</sub>); geri kalanı taş yüzeyinden akar (q<sub>s</sub> = q<sub>t</sub> &minus; q<sub>m</sub>). Akış derinliği d, düşü pürüzlülüğü n kullanılarak yüzey akışı q<sub>s</sub>\'ye uygulanan Manning denkleminden hesaplanır. Varsayılan gözeneklilik n<sub>p</sub> = 0,45, köşeli kırma kaya için tipiktir.';
