...
$ec_lang['mhp_length']='Uzunluk, L <span title="Giriş (su alma yapısı) besleme borusu veya oluğunun uzunluğu" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_ok']='%10 hedefi içinde';
$ec_lang['mhp_hl_warn']='%10 hedefini aşıyor';
$ec_lang['mhp_hl_warn_tip']='Daha büyük boru düşünün';
$ec_lang['mhp_hl_bad']='%20\'yi aşıyor';
$ec_lang['mhp_hl_bad_tip']='Boruyu yeniden boyutlandırın';
...
$ec_lang['mhp_notes_4_term']='Yerel Kayıplar, k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Bu kayıplar boru bağlantılarında, girişlerde, dirseklerde ve vanalarda oluşur — "küçük" terimi geleneksel ama yanıltıcıdır; kısa bir cebri boruda bu kayıplar sürtünme kayıplarına eşit veya onu aşabilir. Tipik k değerleri: keskin giriş ağzı 0,5, her 45° dirsek 0,2–0,3, sürgülü vana (tam açık) 0,1, kelebek vana 0,2. Tüm bağlantı parçalarının toplamı toplam k<sub>m</sub>\'yi verir. Varsayılan 1,5 değeri, bir giriş ve iki dirsek varsayar.';
...
$ec_lang['rc_qt']='Toplam birim debi, q<sub>t</sub> <span title="Düşü girişinde birim genişlik başına debi. B taban genişliğinde ve Q toplam debili bir kanal için q_t = Q / B kullanın." class="ec-tip">?</span>';
$ec_lang['rc_np']='Parça taşı gözenekliliği, n<sub>p</sub>';
$ec_lang['rc_sg']='Kaya özgül ağırlığı, sg <span title="Tipik kırma granit veya bazalt ≈ 2,65. Robinson geçerli aralığı: 2,54–2,82." class="ec-tip">?</span>';
$ec_lang['rc_SD']='Granülometri SD = D<sub>84.1</sub>/D<sub>50</sub> <span title="Granülometri standart sapması. Tekdüze kaya ≈ 1,25. Robinson geçerli aralığı: 1,15–1,47." class="ec-tip">?</span>';
$ec_lang['rc_yn']='Giriş kanalında normal derinlik, y<sub>n</sub> <span title="Göllenme (Hp > yn) olumludur — memba erozyonunu azaltır. (USDA)" class="ec-tip">?</span>';
$ec_lang['rc_D50']='Gerekli ortanca kaya boyutu, D<sub>50</sub> <span title="Denklem 1 (S0 < 0.10) veya Denklem 2 (0,10–0,40). Geçerli: D50 15–278 mm, S0 0,02–0,40. Aralık dışı: ekstrapolasyon." class="ec-tip">?</span>';
...
$ec_lang['rc_apron_length']='Çıkış apronu uzunluğu (15 × D<sub>50</sub>) <span title="Düşü taşının yapısal desteği için gereklidir. &quot;Çıkış kesimi ve mansap kanal direncinden kaynaklanan minimum kuyruk suyu, çıkış kesimindeki parça taşının stabilitesini sağlamaya yeterlidir.&quot; (Robinson)" class="ec-tip">?</span>';
$ec_lang['rc_n_chute']='Düşüde Manning pürüzlülüğü, n';
$ec_lang['rc_Vm']='Taş mantosu içindeki hız, V<sub>m</sub> <span title="Kaya gözeneklerinden geçen qt fraksiyonu. Kalan qs yüzeyden akar. Varsayılan np = 0,45 köşeli kırma kaya için tipiktir." class="ec-tip">?</span>';
...
$ec_lang['rc_Hp']='Giriş savak yükü, H<sub>p</sub> <span title="Göllenme (Hp > yn) olumludur — memba erozyonunu azaltır. (USDA)" class="ec-tip">?</span>';
