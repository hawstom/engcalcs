...
$ec_lang['lpn_inp_drop_quality']='Bu dosya, su kalitesinin taşınırken nasıl değiştiğini tanımlıyor: suda başlangıçta ne olduğu, o maddenin nerede daha fazla girdiği, nasıl tepkimeye girdiği ve depoların nasıl karıştığı. Bu sayfa su yaşını ve kaynak izlemeyi hesaplar, ama kimyayı hesaplamaz, bu yüzden bunların hiçbiri burada kullanılmaz. Bu satırlar korunur ve bir EPANET dosyası kaydederseniz geri yazılır.';
...
$ec_lang['lpn_tip_select']='Haritadaki şeyleri değiştirmek, taşımak ve sürüklemek için bu modu kullanın. Sayfa, bir proje açmak gibi bazı işlemlerden sonra kendiliğinden bu moda döner.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Düğüm ve hat etiketlerini gizler, böylece haritada yalnızca renkler kalır. Kendi eklediğiniz Metin kalır. Etiket seçimleriniz korunur, bunu kapattığınızda geri gelirler.';
...
$ec_lang['lpn_file_import_geo']='Bir xy dosyasını haritada aç…';
$ec_lang['lpn_file_import_geo_tip']='Bu sayfada bir proje dosyasını veya bir EPANET dosyasını, sokak haritası üzerinde yeni bir proje sekmesinde açar. Çizimi dünya üzerine elle yerleştirirsiniz: sahaya kaydırıp yakınlaştırın, sonra sığacak şekilde boyutlandırıp döndürün. Dosyadaki x ve y zaten bir boylam ve enlemse, Bunlar zaten enlem/boylam düğmesine basın ve şebeke doğrudan ait olduğu yere atlar. Yazdığınız her sayı olduğu gibi kalır.';
...
$ec_lang['lpn_clean_map_tip']='Durum şeridini ve koordinat göstergesini haritadan kaldırın, böylece bir ekran görüntüsü yalnızca çizimi gösterir. Çiziminize dokunulmaz ve bu seçim saklanmaz; sayfayı yeniden yüklemek göstergeleri geri getirir.';
...
$ec_lang['lpn_time_no_engine']='Yerleşik çözücü seferde yalnızca bir anı hesaplar, bu yüzden bu yalnızca {time} anındaki şebekedir: her desen o anda okunur, ve her depo dolup boşalmak yerine hâlâ başlangıç seviyesindedir. Tüm dönemi çalıştıran EPANET çözücüsünü almak için bir kez internete bağlanın.';
$ec_lang['lpn_time_slider']='Zaman';
$ec_lang['lpn_time_no_period']='Bu projenin bir zaman dilimi yok, bu yüzden gösterilecek tek bir an var. Şebekeyi zaman içinde hesaplamak için Ayarlar\'da bir Toplam çalışma süresi belirleyin.';
...
$ec_lang['lpn_time_run_note']='Şebekeyi ilk raporlama zamanında görüyorsunuz. Bu şebekenin tüm zaman dilimi boyunca hesaplanması o kadar uzun sürüyor ki, siz çalışırken sonraki zamanların sonuçları güncel tutulmuyor. Bunları güncellemek için Hesapla düğmesine basın.';
...
$ec_lang['lpn_georef_asdegrees']='Bu dosyadaki x ve y bir boylam ve enlem olarak okundu, bu yüzden şebeke zaten haritada ve hiçbir şey taşınmadı. Doğru yerde olduğunu kontrol edin, ardından Bu yerleşimi koru düğmesine basın.';
...
$ec_lang['lpn_result_water_age_tip']='Bu noktaya ulaşan suyun sistemde ne kadar süredir bulunduğu. Karşılaştırılacak bir yönetmelik sınırı yoktur, bu yüzden sayıyı kendi sisteminize göre değerlendirin.';
...
$ec_lang['lpn_new_coords_xy']='xy koordinatları';
$ec_lang['lpn_new_coords_geo']='enlem/boylam';
$ec_lang['lpn_new_coords_tip']='Bir xy projesi, enlem ve boylam olmayan koordinatlar kullanır. Bir enlem/boylam projesinin coğrafi koordinatları vardır, bu yüzden arkasına bir sokak haritası veya uydu görüntüsü çizilebilir ve düğüm kotları arazi verisinden okunabilir. Bir xy projesi, Dosya, Bir xy dosyasını haritada aç ile enlem/boylama dönüştürülebilir.';
$ec_lang['lpn_new_place']='Bu yerin yakınından başla';
$ec_lang['lpn_new_place_tip']='İsteğe bağlı. Bir kasaba, sokak veya belirgin bir yer yazın; yeni harita orada açılır. Yazdığınız kelimeler, ilk seferde izninizi isteyen OpenStreetMap yer adı hizmetine gönderilir. Boş bırakırsanız harita tüm dünya üzerinde açılır.';
$ec_lang['lpn_new_place_hint']='Petaluma, Kaliforniya';
$ec_lang['lpn_new_create']='Oluştur';
$ec_lang['lpn_inp_drop_rules']='Bu dosyada kural tabanlı kontroller var. Bunlar burada uygulanmaz, bu yüzden adlandırdıkları borular, pompalar ve vanalar dosyada yazılı durumda kalır. Kuralların kendisi korunur ve bir EPANET dosyası kaydederseniz geri yazılır.';
$ec_lang['lpn_inp_drop_energy']='Bu EPANET dosyası pompalama maliyeti modelleme verisi içeriyor. Bu sayfa enerji veya maliyet hesaplamaz, bu yüzden burada bu sayılar kullanılmaz. Korunurlar ve bir EPANET dosyası kaydederseniz geri yazılırlar.';
$ec_lang['lpn_inp_drop_tags']='Bu dosya bazı düğümlerine, borularına veya diğer öğelerine etiket veriyor. Bu sayfada henüz bir etiketi görecek veya değiştirecek bir yer yok. Etiketler korunur ve bir EPANET dosyası kaydederseniz geri yazılır.';
$ec_lang['lpn_inp_drop_report']='Bu dosya, EPANET\'in yazdırdığı raporlar için kendi ayarlarını tutuyor. Bu sayfa yanıtlarını kendi yoluyla gösterir, bu yüzden burada bunlar kullanılmaz. Korunurlar ve bir EPANET dosyası kaydederseniz geri yazılırlar.';
...
$ec_lang['lpn_inp_drop_quality_options']='Bu dosya EPANET su kalitesi seçeneklerini belirtiyor: su kalitesi analizinin türünü adlandıran Kalite, ve bir kimyasalla ilgili iki ayar, Bağıl difüzivite ve Kalite toleransı. Su yaşı ve kaynak izleme burada hesaplanır; bir kimyasal hesaplanmaz, bu yüzden bu iki ayar kullanılmadan korunur. Hepsi bir EPANET dosyası kaydederseniz geri yazılır.';
...
$ec_lang['lpn_settings_quality_track_tip']='Çalışmanın borular boyunca neyi izleyeceğini seçin: suyun sistemde ne kadar süredir bulunduğu, ya da nereden geldiği. İkisi de bir derişim veya tepkime hızı gerektirmez.';
...
$ec_lang['lpn_quality_chemical']='Bu dosyanın adlandırdığı bir kimyasal (saklanır, hesaplanmaz)';
$ec_lang['lpn_quality_needs_run']='Su kalitesi zaman içinde borular boyunca taşınır, bu yüzden EPANET motoruna ve bir toplam çalışma süresine ihtiyaç duyar. Zaman altında bir Toplam çalışma süresi belirleyin, sonra Hesapla düğmesine basın.';
...
$ec_lang['lpn_ff_menu']='Yangın debisi…';
...
$ec_lang['lpn_ff_title']='Yangın debisi';
...
$ec_lang['lpn_ff_required_node_tip']='Bu düğümde, hizmet ettiği arazi kullanımı için yangın yönetmeliğinizin veya itfaiye teşkilatınızın istediği yangın debisi. Boş bırakırsanız düğüm, Gereken yangın debisi kutusundaki sayıya karşı sınanır.';
