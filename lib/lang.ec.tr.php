...
$ec_lang['lpn_scenario_base_value']='Temel: {value}';
...
$ec_lang['lpn_settings_engine_epanet_tip']='ABD EPA\'dan EPANET\'in kendi çözücüsünü, burada tarayıcınızda çalıştırır. Yerleşik çözücü aynı sonuçları verir ve daha hızlıdır, bu yüzden EPANET\'in kendisine ihtiyacınız olmadıkça bunu kapalı bırakın.';
