...
$ec_lang['dw_roughness']='Pürüzlülük, e';
$ec_lang['dw_roughness_tip']='<span title="Darcy-Weisbach pürüzlülük yüksekliği" class="ec-tip">?</span>';
$ec_lang['dw_kinematic_viscosity']='Kinematik viskozite, &nu; <span title="Temiz su için 20°C\'de 1×10⁻⁶ m²/s" class="ec-tip">?</span>';
...
$ec_lang['mi_q_617']='Q <span title="Chow 6-17\'ye göre her bölge için bileşik n kullanılarak hesaplanan bileşik akış, Q (eşit hızlar)" class="ec-tip">?</span>';
...
$ec_lang['mi_d50in']='Kaplama<br />orta<br />taş<br />boyutu';
...
$ec_lang['mtc_sgrock']='Taşın özgül ağırlığı, sg <span title="Kırma taş için tipik &asymp; 2.65" class="ec-tip">?</span>';
...
$ec_lang['mtc_d50_bottom']='Taban için gerekli köşeli taş boyutu, D<sub>50</sub> (Isbash ve MC) <span title="Isbash (1936) ve Maricopa County, Arizona, US\'ye göre." class="ec-tip">?</span>';
$ec_lang['mtc_d50_z1']='Yan eğim 1 için gerekli köşeli taş boyutu, D<sub>50</sub> (Isbash ve MC) <span title="Isbash (1936) ve Maricopa County, Arizona, US\'ye göre." class="ec-tip">?</span>';
$ec_lang['mtc_d50_z2']='Yan eğim 2 için gerekli köşeli taş boyutu, D<sub>50</sub> (Isbash ve MC) <span title="Isbash (1936) ve Maricopa County, Arizona, US\'ye göre." class="ec-tip">?</span>';
...
$ec_lang['mtc_vel_high']='Hız yüksek — geçiş kayıplarını, mevcut enerjiyi ve su darbesi riskini kontrol edin.';
...
$ec_lang['or_diameter']='Çap veya yükseklik, D <span title="Dairesel için çap; dikdörtgen için yükseklik" class="ec-tip">?</span>';
$ec_lang['or_width']='Genişlik, W <span title="Yalnızca dikdörtgen açıklıklar için" class="ec-tip">?</span>';
$ec_lang['or_invert']='Taban kotu <span title="Açıklığın alt noktası" class="ec-tip">?</span>';
...
$ec_lang['mhp_length']='Cebri boru uzunluğu, L';
$ec_lang['mhp_roughness']='Boru pürüzlülüğü, e';
$ec_lang['mhp_km']='Yerel kayıp katsayısı, k<sub>m</sub> <span title="Cebri boru boyunca tüm birleşim ve bağlantı parçası kayıp katsayılarının toplamı" class="ec-tip">?</span>';
$ec_lang['mhp_nu']='Kinematik viskozite, ν <span title="Temiz su için 20°C civarında 1×10⁻⁶ m²/s" class="ec-tip">?</span>';
$ec_lang['mhp_efficiency']='Santral verimi, η (0–1)';
$ec_lang['mhp_velocity']='Akış hızı, v';
$ec_lang['mhp_vel_check']='Hız kontrolü';
$ec_lang['mhp_f']='Sürtünme katsayısı, f';
$ec_lang['mhp_hf']='Sürtünme kayıplı yük, h<sub>f</sub>';
$ec_lang['mhp_hm']='Yerel yük kaybı, h<sub>m</sub>';
$ec_lang['mhp_hl']='Toplam cebri boru kaybı, h<sub>L</sub>';
...
$ec_lang['mhp_hl_ok']='%10 hedef içinde ✓';
$ec_lang['mhp_hl_warn']='%10 hedefi aşıyor — daha büyük boru düşünün ⚠';
$ec_lang['mhp_hl_bad']='%20\'yi aşıyor — boruyu yeniden boyutlandırın';
$ec_lang['mhp_notes_1_term']='Yük Kaybı';
$ec_lang['mhp_notes_1_def']='Toplam cebri boru kaybı h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>; burada h<sub>f</sub> = f(L/D)(v²/2g) Darcy-Weisbach sürtünme kaybıdır ve h<sub>m</sub> = k<sub>m</sub>·v²/2g giriş, dirsek ve vanaları kapsar. Net yük H<sub>net</sub> = H<sub>gross</sub> − h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Hız';
$ec_lang['mhp_notes_2_def']='Hedef 1–3 m/s. 1 m/s altı boru aşırı boyutlanmış; 3 m/s üstü sürtünme kayıplarını ve su darbesi riskini artırır.';
$ec_lang['mhp_notes_3_term']='Yük Kaybı Hedefi';
$ec_lang['mhp_notes_3_def']='Brüt yükün %10\'unun altındaki cebri boru kayıpları genellikle ekonomiktir. Boru maliyeti ile kaybedilen güç arasındaki optimum denge, yüksek değerli elektrik tesislerinde genellikle %4–6 civarındadır.';
$ec_lang['mhp_notes_4_term']='Lokal Kayıplar k<sub>m</sub>';
...
$ec_lang['odt_a_ending']='Bitiş alanı, A<sub>2</sub> <span title="Bitiş kotunda konik modelden interpolasyonla elde edilir" class="ec-tip">?</span>';
...
$ec_lang['cs_Ec_target']='Astar hedefi, E<sub>c,target</sub> <span title="Kaplamadan sonra iletim verimliliği hedefi; kesir 0–1" class="ec-tip">?</span>';
...
$ec_lang['cs_payback_years']='Geri ödeme süresi <span title="Basit geri ödeme = toplam astar maliyeti ÷ yıllık kazanılan değer" class="ec-tip">?</span>';
$ec_lang['cs_loss_positive']='Qin > Qout — sızıntı tespit edildi ✓';
$ec_lang['cs_loss_zero']='Qin = Qout — ölçülebilir kayıp yok';
$ec_lang['cs_loss_negative']='Uyarı: Qout > Qin — ölçümleri kontrol edin ⚠';
$ec_lang['cs_Ec_good']='İyi — Ec ≥ %80 ✓';
$ec_lang['cs_Ec_fair']='Orta — Ec %60–80';
$ec_lang['cs_Ec_poor']='Zayıf — Ec < %60 ⚠';
$ec_lang['cs_notes_1_term']='Yöntem';
...
$ec_lang['rc_qt']='Toplam birim deşarj, q<sub>t</sub> <span title="Düşü girişinde birim genişlik başına debi. B taban genişliğinde ve Q toplam debili bir kanal için q_t = Q / B kullanın." style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_sg_ok']   ='sg geçerli aralıkta (2,54–2,82) ✓';
$ec_lang['rc_sg_low']  ='Uyarı: sg < 2,54 — Robinson geçerli aralığının altında';
$ec_lang['rc_sg_high'] ='Uyarı: sg > 2,82 — Robinson geçerli aralığının üzerinde';
$ec_lang['rc_SD_ok']   ='SD geçerli aralıkta (1,15–1,47) ✓';
$ec_lang['rc_SD_low']  ='Uyarı: SD < 1,15 — Robinson geçerli aralığının altında';
$ec_lang['rc_SD_high'] ='Uyarı: SD > 1,47 — Robinson geçerli aralığının üzerinde';
$ec_lang['rc_layer']='Taş tabaka kalınlığı (2 × D<sub>50</sub>)';
$ec_lang['rc_crest_radius']='Üst eşik eğri yarıçapı (40 × D<sub>50</sub>)';
$ec_lang['rc_crest_length']='Üst eşik eğri yay uzunluğu';
$ec_lang['rc_apron_length']='Çıkış önlük uzunluğu (15 × D<sub>50</sub>) <span title="Düşü taşının yapısal desteği için gereklidir. "Çıkış kesimi ve mansap kanal direncinden kaynaklanan minimum kuyruk suyu, çıkış kesimindeki parça taşının stabilitesini sağlamaya yeterlidir." (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
$ec_lang['rc_n_chute']='Düşüde Manning pürüzlülüğü, n';
$ec_lang['rc_Vm']='Taş mantosu içindeki hız, V<sub>m</sub> <span title="Kaya gözeneklerinden geçen qt fraksiyonu. Kalan qs yüzeyden akar. Varsayılan np = 0,45 köşeli kırma kaya için tipiktir." style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_eq1']='Denk. 1 (S0 < 0,10) — hafif eğim';
$ec_lang['rc_eq2']='Denk. 2 (0,10 ≤ S0 ≤ 0,40) — dik eğim';
$ec_lang['rc_eq_warn_low']='Uyarı: S0 < 0,02 — Robinson doğrulama aralığının altında';
$ec_lang['rc_eq_warn_high']='Uyarı: S0 > 0,40 — Robinson doğrulama aralığının üzerinde';
$ec_lang['rc_notes_1_term']='Taş Boyutlandırma Denklemleri';
$ec_lang['rc_notes_1_def']='Robinson, Rice & Kadavy (1998), düşü eğimi ve birim deşarj temelinde ortanca parça taşı boyutu D<sub>50</sub> için iki ampirik denklem geliştirmiştir. Denklem 1 hafif eğimler için geçerlidir (S<sub>0</sub> < 0,10); Denklem 2 dik eğimler için geçerlidir (0,10 ≤ S<sub>0</sub> ≤ 0,40). Her iki denklem de q<sub>t</sub>\'yi m²/s cinsinden gerektirir ve D<sub>50</sub>\'yi mm cinsinden verir. Doğrulanmış aralık 0,02 ≤ S<sub>0</sub> ≤ 0,40\'tır.';
$ec_lang['rc_notes_2_term']='Birim Deşarj';
$ec_lang['rc_notes_2_def']='q<sub>t</sub>, düşü eşiğindeki toplam birim deşarjdır (birim genişlik başına toplam debi). B taban genişliğinde ve Q toplam debili bir kanal için q<sub>t</sub> ≈ Q / B olarak yaklaşık alınabilir veya düşü girişindeki kritik derinlik koşulundan hesaplanabilir.';
$ec_lang['rc_notes_3_term']='Taş Mantosu İçinden Akış';
$ec_lang['rc_notes_3_def']='Toplam akışın bir kısmı parça taşı gözeneklerinden geçer (manto akışı q<sub>m</sub>); geri kalanı taş yüzeyinden akar (q<sub>s</sub> = q<sub>t</sub> − q<sub>m</sub>). Akış derinliği d, düşü pürüzlülüğü n kullanılarak yüzey akışı q<sub>s</sub>\'ye uygulanan Manning denkleminden hesaplanır. Varsayılan gözeneklilik n<sub>p</sub> = 0,45, köşeli kırma kaya için tipiktir.';
...
$ec_lang['ip_main_title']='Ücretsiz Çevrimiçi Sulama Basıncı ve Dağıtım Uniformluğu Hesaplayıcısı';
$ec_lang['ip_main_desc']='Test Dalı Basıncı ve Uniformluk Tahmini';
$ec_lang['ip_h_supply']='Beslenme basıncı';
$ec_lang['ip_elev_supply']='Beslenme kotü, z<sub>beslenme</sub>';
$ec_lang['ip_q_design']='Damlatıcı tasarım debisi, q<sub>tasarım</sub>';
$ec_lang['ip_h_design']='Damlatıcı tasarım basıncı';
$ec_lang['ip_x']='Damlatıcı deşarj üssü, x <span title="Standart kompanse etmeyen damlatıcılar için 0,5; kompanse edici damlatıcılar için 0\'a yakın" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='Lat. <span title="İşaretli: bu hat test lateral\'inin bir parçasıdır, bireysel damlatıcılar tarafından çekilir. İşaretli değil: bu hat bir ana hattır, sadece test yolunda olmayan lateral\'lere akış iletir." class="ec-tip">?</span>';
$ec_lang['ip_count']='Damlatıcılar <span title="Lateral satırları: bu hattaki damlatıcılar sadece. Ana satırları: bu hattan branşlanan diğer lateral\'lerdeki toplam damlatıcılar. Test lateral\'inin kendi alındığı hat için, bu aynı zamanda o alındıktan sonra ana hat boyunca diğer lateral\'leri veya aynı kavşağı paylaşan (örneğin ters taraf lateral) damlatıcıları içerir — akışları bu aynı hattan branşlanır, bu tabloda başka yerde göründükleri olsa da." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_e']='e <span title="Darcy-Weisbach pürüzlülük yüksekliği" class="ec-tip">?</span>';
$ec_lang['ip_km']='K<sub>m</sub> <span title="Bu hattaki tertibatlar/valflar/bağlantılar için jenerik ikincil kayıp katsayısı (≥0,5 önerilen minimum)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='MS Kot. <span title="Bu hattın mansap uç kotü. İç satırlarda isteğe bağlı (boş bırakılırsa düz olarak varsayılır / yukarıdaki düğümle aynı). Son satırda gerekli: bu değer son damlatıcının kotüdür, doğrudan gerekli beslenme basıncını belirler." class="ec-tip">?</span>';
$ec_lang['ip_elev_ds_missing_warn']='Son damlatıcı kotü (son satır) boş bırakıldı ve düz olarak varsayıldı — doğru sonuç için girin ⚠';
...
$ec_lang['ip_hl']='H<sub>l</sub> <span title="Toplam hat kaybı, H_f + H_m" class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='Test yolu beslenme debisi, Q<sub>beslenme</sub> <span title="Sadece modellenen test yoluna giren debi, tüm bölge/sistem değil — Uygulama Tasarımı aşağısında Q_zone için bkz." class="ec-tip">?</span>';
$ec_lang['ip_q_critical']='Son damlatıcı debisi, q<sub>son</sub>';
$ec_lang['ip_q_avg_lateral']='Ortalama damlatıcı debisi (test lateral), q<sub>ort</sub>';
$ec_lang['ip_dp_avg']='Tah. &Delta;basınç, ort. vs. test lateral <span title="Bu test lateral\'ine kıyasla tipik/ortalama lateral\'in ne kadar daha yüksek (veya daha düşük) çalıştığına inanıyorsunuz. Test lateral kasıtlı olarak en kötü durum varsayıldığından, kendi ortalaması saha ortalaması için taraflı-düşük bir yaklaşımdır — 0\'da bırakıldığında, aşağıdaki uniformluk kontrolü ve uygulama tasarımı sayıları test lateral\'inin kendi (muhtemelen iyimser) ortalamasını olduğu gibi kullanır." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='Tah. saha-ortalama damlatıcı debisi, q<sub>ort,saha</sub> <span title="q_avg_lateral yeniden değerlendirilir her lateral satırındaki basınç artı yukarıda girilen basınç farkında — test lateral\'inin en kötü durum varsayıldığı değil temsilci olan için düzeltme denemesi. Aşağıdaki uniformluk kontrolü ve uygulama tasarımı bölümünün her ikisini de besler." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='Uniformluk kontrolü, q<sub>son</sub>/q<sub>ort,saha</sub> <span title="Son damlatıcının hesaplanan debisi tahmini saha-ortalama damlatıcı debisine bölünür — ders kitabı düşük-çeyrek Dağıtım Uniformluğu şekli (düşük-grup ortalama ÷ nüfus ortalaması), ancak küçük modellenen örnek ve kullanıcı-tahmini düzeltme, tam saha istatistiksel örneği değil. 1\'de veya üzerinde olan değerler mümkündür ve bir hata değildir: bu sadece son damlatıcının tahmini saha ortalaması göreceli düşük nokta olmadığı anlamına gelir (örneğin uygun bir aşağı doğru koşu, veya yukarıdaki &Delta;basınç tahmini çok küçük)." class="ec-tip">?</span>';
...
$ec_lang['ip_q_ratio']='Son damlatıcı debisi vs. tasarım debisi, q<sub>son</sub>/q<sub>tasarım</sub> <span title="Ayrı bir kontrol, uniformluk rakamı değil: son damlatıcı üreticinin nominal tasarım debisinden ne kadar uzak çalıştığı. 1\'in üzerinde: tasarım noktasının üzerinde çalışıyor (örneğin uygun bir aşağı doğru yükseklik kazancından). 1\'in altında: tasarımın altında çalışıyor (tipik sürtünme-baskın durum)." class="ec-tip">?</span>';
...
$ec_lang['ip_notes_1_term']='Yöntem';
$ec_lang['ip_notes_1_def']='Son (en uzak) damlatıcıdaki basıncı tahmin eder, ardından Enerji Seviye Hattını beslenme doğrultusunda geri doğru, hat çerçevesi çerçevesi hareket ettirir, yol boyunca sürtünme ve ikincil kayıpları ekler. Yükseklik ve hız yükü her düğümde geri alınır ve orada gerçek basınç bildirilir. Tahmin edilen uzak uç basıncı, hesaplanan gerekli beslenme basıncı girilen beslenme basıncına eşleşene kadar ayarlanır (bisection) — Manning Boru Akımı hesap makinesindeki boru akımı çözücüsü tarafından ele alınan aynı kapalı devre problemi, branşlı bir ağa genişletilmiştir.';
$ec_lang['ip_notes_2_term']='Ana Hat vs. Lateral Hatlar';
$ec_lang['ip_notes_2_def']='Her satır beslenme kaynağından son damlatıcıya tekil hidroliksel en kötü yol (test yolu) boyunca bir hattır. Ana hat sadece test yolunda olmayan lateral\'lere akış iletir, bu nedenle kaynağı düz çarpım (tasarım debisi × hattın toplam damlatıcı sayısı) — yerel basınç hassasiyeti yok. Ana hat paylaşılan trunk borusudur, bu nedenle test lateral\'inin kendi alındığı hattın hemen sağında sadece kendi uç noktaları arasındaki lateral\'leri değil, aynı zamanda o alındıktan sonra ana hat boyunca diğer lateral\'leri veya aynı kavşağı paylaşan lateral\'leri (örneğin ters taraf lateral) dahil etmelidir — akışları bu aynı hattan branşlanır, bu tabloda başka yerde göründükleri olsa da. Lateral hat test lateral\'inin kendisinin bir parçasıdır: damlatıcı deşarjı gerçek yerel basınç aracılığıyla q = k·H<sup>x</sup> hesaplanır, ve sürtünme kaybı her damlatıcının hattın dışını çekmesiyle akış adımını hesaplamak için Christiansen\'in F(n) faktörü tarafından azaltılır.';
$ec_lang['ip_notes_3_term']='Sınırlamalar';
$ec_lang['ip_notes_3_def']='Bir sabit giriş basıncı (pompa eğrisi yok), sadece test yolu (tüm alan değil), ve iki parametreli damlatıcı eğrisi (üssü 0\'a yakın ayarlayın kompanse edici damlatıcı yaklaştırmak için) modeller. İki farklı oran raporlanır, kasıtlı olarak ayrı tutulur: q<sub>son</sub>/q<sub>ort,saha</sub> uniformluk kontrolüdür, ders kitabı düşük-çeyrek Dağıtım Uniformluğu şekli (düşük-grup ortalama ÷ nüfus ortalaması), ancak test lateral\'inin kendi modellenen damlatıcılarından hesaplanan, tam saha istatistiksel örneği değil girilen &Delta;basınç tahmini tarafından düzeltilmiş — test lateral kasıtlı olarak en kötü durum varsayıldığından, ham, düzeltilmeyen ortalama gerçek saha ortalamasını küçümser ve uniformluk göründüğünden daha iyi görünmesine neden olur; &Delta;basınç girişi bu yanlılığa karşı koymak için özel olarak var olur. 1\'de veya üzerinde olan değerler yine de mümkündür (örneğin &Delta;basınç tahmini çok küçük, veya uygun bir aşağı doğru koşu). q<sub>son</sub>/q<sub>tasarım</sub> farklı, uniformluk olmayan kontrol üreticinin nominal debisi karşılaştırması — sistem genel olarak aşırı- veya eksik-basınçlandırılmış olduğunu fark etmek için yararlı ama uniformluk sayısına ikame değil, çünkü tasarım/nominal debi sistemin gerçek ortalama çalışma basıncı ile gerekli ilişki yok.';
$ec_lang['ip_notes_4_term']='Referans';
$ec_lang['ip_notes_4_def']='Christiansen, J.E. (1942). &ldquo;Sprinkling tarafından irrigasyon.&rdquo; California Tarımsal Deneme İstasyonu Bülteni 670. ASAE/ASABE mikroirrigasyon tasarımı standartları aynı multi-outlet sürtünme-kayıp yaklaşımını kullanır.';
$ec_lang['ip_notes_5_term']='Uygulama Tasarımı';
$ec_lang['ip_notes_5_def']='Uygulama oranı ve sistem/bölge debi tahmini saha-ortalama damlatıcı debisini (q<sub>ort,saha</sub> — test lateral\'inin kendi ortalaması, girilen &Delta;basınç tahmini tarafından düzeltilmiş), tahmin edilen oran değil kullanır: PR = q<sub>ort,saha</sub> / A<sub>e</sub>, düzeltilmiş modellenen değer tarafından beslenmiş. Aralık ve sistem-geniş lateral/damlatıcı sayıları ayrı girdilerdir çünkü test yolu sadece bir en kötü durum dalı modeller, sahada her lateral değil.';
