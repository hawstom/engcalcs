...
$ec_lang['lpn_field_text_match_pipe']='Boru açısıyla eşleştir';
...
$ec_lang['lpn_examples_size']='{nodes} düğüm, {links} boru';
...
$ec_lang['lpn_ex_net3_desc']='EPANET\'in büyük örneği: 97 düğüm, iki depo ve bir nehir kaynağı. Gerçek boyutlu bir modelin haritada nasıl göründüğünü görmek için açmaya değer.';
...
$ec_lang['lpn_inp_drop_controls']='Kontroller ve kurallar dışarıda bırakıldı. Her boru, pompa ve vana dosyada yazılı durumda aktarıldı ve değişmez.';
$ec_lang['lpn_inp_drop_eps']='Bu dosya bir zaman dilimi boyunca çalışan bir simülasyonu tanımlıyor. Bu sayfa tek bir anı çözer, bu yüzden yalnızca başlangıç koşulları aktarıldı.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='ABD EPA\'dan EPANET\'in kendi çözücüsünü, burada tarayıcınızda çalıştırır. Her iki çözücü de aynı sonuçları verir ve bu boyuttaki bir şebekede bir hız farkı görmezsiniz. Bunu ilk kez açtığınızda yaklaşık 650 KB indirilir ve ardından bu cihazda tutulur.';
