...
$ec_lang['mpf_velocity_head']='<span class="ec-help" title="Su sütunu yüksekliği olarak kinetik enerji, v&sup2;/2g">Hız yükü, h<sub>v</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['mtc_sgrock']='<span class="ec-help" title="Suya göre yoğunluk. Kırma taş için tipik &asymp; 2,65.">Taşın özgül ağırlığı, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="Suya göre yoğunluk. Kırma granit veya bazalt için tipik &asymp; 2,65. Robinson geçerli aralığı: 2,54&ndash;2,82.">Kaya özgül ağırlığı, sg <span class="ec-tip">?</span></span>';
