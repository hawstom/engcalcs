...
$ec_lang['dw_kinematic_viscosity']='Kinematik viskozite, ν <span title="1×10⁻⁶ m²/s for clean water at 20°C" class="ec-tip">?</span>';
...
$ec_lang['or_notes_1_def']='Q = C<sub>d</sub> × A × √(2gh). Serbest çıkış: h = HWE − ağırlık merkezi kotu. Batık akış (TWE taban kotu üzerinde): h = HWE − TWE.';
