...
$ec_lang['lpn_field_text_match_pipe']='ከቧንቧው ማዕዘን ጋር አመሳስል';
...
$ec_lang['lpn_examples_size']='{nodes} መገናኛዎች፣ {links} ቧንቧዎች';
...
$ec_lang['lpn_ex_net3_desc']='የEPANET ትልቁ ናሙና፦ 97 መገናኛዎች፣ ሁለት ታንኮች እና የወንዝ ምንጭ። እውነተኛ መጠን ያለው ሞዴል በካርታው ላይ እንዴት እንደሚታይ ለማየት መክፈት ተገቢ ነው።';
...
$ec_lang['lpn_inp_drop_eps']='ይህ ፋይል በጊዜ ሂደት የሚሮጥ ማስመሰያ ይገልጻል። ይህ ገጽ አንድ ወቅት ብቻ ስለሚፈታ፣ የመነሻ ሁኔታዎች ብቻ ገብተዋል።';
...
$ec_lang['lpn_pump_point1']='ነጥብ 1 (ያስፈልጋል)';
$ec_lang['lpn_pump_point2']='ነጥብ 2 (አማራጭ)';
$ec_lang['lpn_pump_point3']='ነጥብ 3 (አማራጭ)';
...
$ec_lang['lpn_settings_engine_epanet_tip']='ከUS EPA የተገኘውን የEPANET ራሱን ፈታች እዚሁ በአሳሽዎ ውስጥ ያሄዳል። ሁለቱም ፈታቾች ተመሳሳይ መልስ ይሰጣሉ፣ በዚህ መጠን ባለው መረብ ላይም የፍጥነት ልዩነት አያዩም። ይህን ለመጀመሪያ ጊዜ ሲያበሩ፣ በግምት 650 ኪ.ባ. ይወርዳል፣ ከዚያም በዚህ መሣሪያ ላይ ይቀመጣል።';
...
$ec_lang['lpn_settings_readability_bias']='ምልክት ከመገልበጡ በፊት ከቋሚው ግራ ያለው ዲግሪ';
