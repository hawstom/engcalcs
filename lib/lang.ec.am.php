...
$ec_lang['dw_kinematic_viscosity']='ኪኔማቲክ ቪስኮሲቲ, ν <span title="1×10⁻⁶ m²/s for clean water at 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_nu']='የኪነማቲክ viscosity, ν <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['ds_main_desc']='ጠብታ & ርጭት መስኖ — አፈጻጸም መጠን እና አጠቃቀም ወጥነት';
...
$ec_lang['ds_notes_3_def']='የሩጫ ጊዜ = ዒላማ ጥልቀት ÷ አፈፃፀም መጠን። በዳገታማ ወይም በጠጣር አፈር ላይ የሩጫ ጊዜን በሁለት ወይም ሦስት አጭር ዙሮች ይከፋፍሉ።';
...
$ec_lang['cs_Ec_target']='ከሽፋን በኋላ ዒላማ የማስተላለፊያ ብቃት, E<sub>c,target</sub> (ክፍልፋይ, 0–1) — የተሸፈነ ቦይ ውሃ ምን ያህል እንደሚይዝ ዒላማ';
