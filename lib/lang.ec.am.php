...
$ec_lang['rc_np']='የድንጋይ ሽፋን ስርቅ, n<sub>p</sub>';
...
$ec_lang['rc_notes_3_def']='ከጠቅላላ ፍሰት ውስጥ ክፍል የሆነው በድንጋይ ሽፋን ቀዳዳዎች ውስጥ ያልፋል (የሽፋን ፍሰት q<sub>m</sub>)፤ ቀሪው ከድንጋይ ገጽ በላይ ይፈስሳል (q<sub>s</sub> = q<sub>t</sub> − q<sub>m</sub>)። የፍሰት ጥልቀት d የፈጣን ቦዩን ሻካራነት n ተጠቅሞ በገጽ ፍሰት q<sub>s</sub> ላይ ከ Manning&rsquo;s ቀመር ይሰላል። ለማዕዘናዊ የተቀጠቀጠ ድንጋይ ነባሪ ስርቅ n<sub>p</sub> = 0.45 ዓይነተኛ ነው።';
