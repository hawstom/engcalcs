...
$ec_lang['lpn_main_title']='ከEPANET ሞተር ጋር ነፃ የመስመር ላይ የውሃ ስርጭት መረብ ማስያ';
...
$ec_lang['lpn_inp_drop_tanks']='ማከማቻ ታንኮች ቀርተዋል። ይህ ገጽ አንድ ቋሚ የውሃ ደረጃ የሚይዙ ማጠራቀሚያዎች አሉት። ማከማቻ ታንክ ቋሚ ደረጃ ስለማይይዝ ማጠራቀሚያ አይደለም።';
$ec_lang['lpn_inp_drop_tank_links']='እነዚህ ቧንቧዎች ካልገባ ታንክ ጋር ስለሚገናኙ ቀርተዋል።';
...
$ec_lang['lpn_settings_engine_epanet']='በEPANET ሞተር ፍታ';
$ec_lang['lpn_settings_engine_epanet_tip']='ከUS EPA የመጣውን የመጀመሪያውን EPANET ሞተር፣ እዚሁ በአሳሽዎ ውስጥ ያሄዳል። አብሮ የተሰራው ማስያ ተመሳሳይ መልስ ይሰጣል እና ፈጣን ነው፣ ስለዚህ ራሱ EPANET የሚያስፈልግዎት ካልሆነ በስተቀር ይህን ጠፍቶ ይተውት።';
$ec_lang['lpn_engine_loading']='የEPANET ሞተር በመጫን ላይ…';
$ec_lang['lpn_engine_failed']='የEPANET ሞተር ሊጫን አልቻለም። በምትኩ አብሮ የተሰራውን ማስያ በማሳየት ላይ።';
