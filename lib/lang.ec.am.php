...
$ec_lang['dw_kinematic_viscosity']='ኪነቲካዊ viscosity, v, በ m<sup>2</sup>/ሰከ (1E-6 ለ ንጹህ ውሃ በክፍል ሙቀት)';
...
$ec_lang['or_diameter']='ዲያሜትር (ክብ) ወይም ከፍታ (አራት ማዕዘን), D';
$ec_lang['or_width']='ስፋት, W (አራት ማዕዘን ብቻ)';
$ec_lang['or_invert']='የክፍት ቦታ invert ከፍታ (የክፍት ቦታ ታቹ)';
...
$ec_lang['or_velocity']='ፍጥነት በክፍት ቦታ, v';
...
$ec_lang['mhp_gross_head']='ጠቅላላ ጭንቅ (ከፍታ ልዩነት), H<sub>gross</sub>';
$ec_lang['mhp_head_loss']='የውሃ ቱቦ ጭንቅ ኪሳራዎች, h<sub>L</sub>';
...
$ec_lang['mhp_notes_2_def']='የተጣራ ጭንቅ = ጠቅላላ ጭንቅ &minus; የውሃ ቱቦ ጭንቅ ኪሳራዎች። የተለመደ የመጀመሪያ ግምት h<sub>L</sub> &asymp; H<sub>gross</sub> 5% ነው። ለበለጠ ትክክለኛ የቱቦ ኪሳራ ግምቶች <a href="Darcy-Weisbach.php">ዳርሲ-ዌይስባክ ካልኩሌተር</a> ይጠቀሙ።';
$ec_lang['mhp_notes_3_term']='ብቃት';
$ec_lang['mhp_notes_3_def']='በማይክሮ-ሃይድሮ ውስጥ ለሚገኙ ፔልተን እና ክሮስ-ፍሎው ተርባይኖች የተለመደ የፋብሪካ ብቃት &eta; ከ0.70 እስከ 0.85 ይደርሳል። ወግ አጥባቂ የመጀመሪያ ግምት ሆኖ 0.75 ይጠቀሙ።';
$ec_lang['mhp_notes_4_term']='ዓመታዊ ኃይል';
$ec_lang['mhp_notes_4_def']='ዓመታዊ ኃይል ያለማቋረጥ ሙሉ ፍሰት ስራ (8760 ሰዓታት/ዓ.ም.) ይገምታል። ወቅታዊ የፍሰት ለውጥ፣ የጥገና ቆምታ እና የጭነት ምጣኔ ምክንያት ትክክለኛ ምርት ያነሰ ይሆናል።';
// Penstock Design
$ec_lang['ps_main_menu']='የቧንቧ ጫና ዲዛይን';
$ec_lang['ps_main_title']='ነፃ የኦንላይን የቧንቧ ጫና ዲዛይን ካልኩሌተር';
$ec_lang['ps_main_desc']='ማይክሮ-ሃይድሮ የቧንቧ መጠን ስሌት — የጫና ኪሳራ፣ ኃይልና ፍጥነት';
$ec_lang['ps_flow']='የፍሰት መጠን፣ Q';
$ec_lang['ps_gross_head']='ጠቅላላ ጫና፣ H<sub>gross</sub>';
$ec_lang['ps_diameter']='የቧንቧ ዲያሜትር፣ D';
$ec_lang['ps_length']='የቧንቧ ርዝማኔ፣ L';
$ec_lang['ps_roughness']='የቧንቧ ሻካራነት፣ e';
$ec_lang['ps_km']='ሁለተኛ ደረጃ ኪሳራ ቅሬ፣ k<sub>m</sub>';
$ec_lang['ps_nu']='ኪነቲክ ቁርቁሮ፣ &nu;፣ m<sup>2</sup>/s ሆኖ (20&deg;C አካባቢ ለውሃ 1E-6)';
$ec_lang['ps_efficiency']='የፋብሪካ ብቃት፣ &eta; (0&ndash;1)';
$ec_lang['ps_velocity']='የፍሰት ፍጥነት፣ v';
$ec_lang['ps_vel_check']='የፍጥነት ምርመራ';
$ec_lang['ps_f']='የፍሰት ጎሳ ቁጥር፣ f';
$ec_lang['ps_hf']='የፍሰት ጎሳ ምክንያት ጫና ኪሳራ፣ h<sub>f</sub>';
$ec_lang['ps_hm']='ሁለተኛ ደረጃ ጫና ኪሳራ፣ h<sub>m</sub>';
$ec_lang['ps_hl']='ጠቅላላ የቧንቧ ጫና ኪሳራ፣ h<sub>L</sub>';
...
$ec_lang['ps_notes_2_def']='ዒላማ 1&ndash;3 m/s። ከ1 m/s በታች ቧንቧው አስፈላጊ ያህል ትልቅ ነው; ከ3 m/s በላይ ፍሰት ኪሳራ እና የውሃ መምቻ አደጋ ይጨምራሉ።';
$ec_lang['ps_notes_3_term']='የጫና ኪሳራ ዒላማ';
$ec_lang['ps_notes_3_def']='ከጠቅላላ ጫና 10% በታች ያለ ኪሳራ በአጠቃላይ ኢኮኖሚያዊ ነው። ለከፍተኛ ዋጋ ኤሌክትሪክ ቦታዎች የቧንቧ ወጪ እና ጠፍቶ ኃይል ሚዛን ብዙ ጊዜ 4&ndash;6% አካባቢ ነው።';
$ec_lang['ps_notes_4_term']='ሁለተኛ ደረጃ ኪሳራዎች k<sub>m</sub>';
...
$ec_lang['cs_water_value']='የውሃ ዋጋ (ምንዛሬ በአሃድ ድምር)';
$ec_lang['cs_lining_cost']='የሽፋን ወጪ (ምንዛሬ በአሃድ ስፋት)';
