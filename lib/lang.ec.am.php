...
$ec_lang['mtc_n_strickler']='n ከንድፍ የድንጋይ መጠን (የStrickler ዘዴ)';
$ec_lang['mtc_n_blodgett']='n ከንድፍ የድንጋይ መጠን (የBlodgett ዘዴ)';
$ec_lang['mtc_n_bathurst']='n ከንድፍ የድንጋይ መጠን (የBathurst ዘዴ)';
$ec_lang['mtc_n_pi']='n ከንድፍ የድንጋይ መጠን (የPhillips & Ingersoll ዘዴ)';
...
$ec_lang['mhp_annual_kwh']='P እንደ ዓመታዊ ሃይል';
...
$ec_lang['mhp_notes_3_def']='ከጠቅላላ ሄድ ከ10% በታች የሆነ የፔንስቶክ (የአቅርቦት ቧንቧ) ኪሳራ በአጠቃላይ ኢኮኖሚያዊ ነው። በቧንቧ ዋጋና በጠፋ ኃይል መካከል ያለው ምርጥ ሚዛን ኤሌክትሪክ በጣም ውድ በሆነበት ጊዜ ብዙውን ጊዜ በ4–6% አካባቢ ይወድቃል።';
...
$ec_lang['lpn_georef_projected']='ይህ ፕሮጀክት አስቀድሞ የካርታ ፕሮጀክሽን ገልጿል፣ ስለዚህ መጋጠሚያዎቹ በካርታው ላይ ለሁለተኛ ጊዜ ሊቀመጡ አይችሉም።';
...
$ec_lang['lpn_new_coordsys_geo']='ጂኦግራፊያዊ ፕሮጀክሽን';
$ec_lang['lpn_new_coordsys_geo_tip']='ጂኦግራፊያዊ ፕሮጀክሽን ይምረጡ። ለላቲትዩድ/ሎንግቲትዩድ WGS 84 / Pseudo-Mercator EPSG:3857 ይጠቀሙ።';
...
$ec_lang['lpn_new_crs_tip']='መጋጠሚያዎችዎ አስቀድመው የተለኩበት ፕሮጀክሽን ነው። መጋጠሚያዎች እርስዎ በሚተይቧቸው መልኩ በትክክል ይቀመጣሉ፣ ምንም አይቀየርም። ይህ ምርጫ ቋሚ ነው፤ መረብን ወደ ሌላ መጋጠሚያዎች የሚቀይሩበት ብቸኛው መንገድ «ፋይል፣ ወደ አዲስ መጋጠሚያዎች ክፈት» ሲሆን፣ ይህም ግምታዊ ነው። UTM በዓለም አቀፍ ደረጃ የበላይ ደረጃ ነው፣ አንድ አካባቢ የራሱ ልማድ ሊኖረው ይችላል፣ እርግጠኛ ካልሆኑ የመሬት ቀያሽ (ላንድ ሰርቬየር) የሚጠየቅ ሰው ነው።';
...
$ec_lang['lpn_crs_place_projected']='የተተነበየ (ፕሮጀክት የተደረገ) ፕሮጀክት እርስዎ በፈለጉት ቦታ ሳይሆን በራሱ አውሮፕላን ላይ ይከፈታል። ያንን አውሮፕላን በምድር ላይ ማስቀመጥ የመጋጠሚያ ለውጥ (ትራንስፎርም) ይፈልጋል፣ ይህም ገጽ እስካሁን የለውም።';
...
$ec_lang['lpn_menu_cue']='ከላይ ካሉት ምናሌዎች ይጀምሩ። ለፈጣን መዳረሻ የመሳሪያ ደረድሩን ይጠቀሙ።';
...
$ec_lang['lpn_cp_length_tip']='የርዝመት ከፍተኛ ገደብ፦ ከዚህ ረዘም ያለ ማንኛውም ግቤት ይታወሳል።';
$ec_lang['lpn_cp_low']='ዝቅተኛ ገደብ';
$ec_lang['lpn_cp_low_tip']='ዝቅተኛ ገደብ፦ ይህ የሚጠብቁት ትንሹ ዋጋ ነው። ቁጥሮች እንደ ቁጥር ይነጻጸራሉ፣ ጽሑፍም በመዝገበ ቃላት ቅደም ተከተል ይነጻጸራል።';
...
$ec_lang['lpn_cp_val_upper']='ሁሉም አቢይ ፊደል';
...
$ec_lang['lpn_cp_bad_case']='ይህ ዋጋ ለዚህ ንብረት እንደሚያስፈልገው ሁሉም አቢይ ፊደል አይደለም።';
$ec_lang['lpn_cp_bad_chars']='ይህ ዋጋ ይህ ንብረት የማይፈቅደውን ፊደል ይጠቀማል።';
$ec_lang['lpn_cp_bad_space']='ክፍተት (ስፔስ) በሌሎች ፊደላት መካከል ብቻ ይፈቀዳል።';
$ec_lang['lpn_cp_bad_minlength']='ይህ ዋጋ ይህ ንብረት ከሚፈቅደው ያጥራል።';
$ec_lang['lpn_cp_bad_length']='ይህ ዋጋ ይህ ንብረት ከሚፈቅደው ይረዝማል።';
$ec_lang['lpn_cp_bad_low']='ይህ ዋጋ ከዚህ ንብረት ዝቅተኛ ገደብ በታች ነው።';
