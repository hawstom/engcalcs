...
$ec_lang['mi_tau']='የታች<br />ሸርሸር<br />&tau;';
$ec_lang['mi_t']='T';
...
$ec_lang['mtc_side_slope_1']='የጎን ቁልቁለት 1 (አግድም/ቁጥር)';
$ec_lang['mtc_side_slope_2']='የጎን ቁልቁለት 2 (አግድም/ቁጥር)';
$ec_lang['mtc_channel_slope']='የቦይ ቁልቁለት, S';
$ec_lang['mtc_flow_depth']='የፍሰት ጥልቀት, y';
$ec_lang['mtc_bend_angle']='የጥምዝ ማዕዘን <a target="_blank" href="riprap-bend-angle.png" title="ምስሉን ለማየት ጠቅ አድርግ">?</a> (ለ riprap ስሌት)';
$ec_lang['mtc_sgrock']='የድንጋይ ልዩ ስበት (2.65)';
...
// Robinson Rock Chute
$ec_lang['rrc_main_menu']='Robinson የድንጋይ ቁልቁል';
$ec_lang['rrc_main_desc']='Robinson የድንጋይ ቁልቁል ንድፍ Spreadsheet';
// Weir Flow Simple
...
$ec_lang['or_diameter']='ዲያሜትር ወይም ቁመት, D <span title="Diameter for circular; height for rectangular" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['or_width']='ስፋት, W <span title="Rectangular openings only" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['or_invert']='ላይ ሳይወድቅ ከፍታ <span title="Bottom of opening" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['or_regime_submerged']='የተጠለቀ ቀዳዳ (TWE ከ invert በላይ) — ተፈቅዷል ✓';
...
$ec_lang['or_notes_1_def']='Q = C<sub>d</sub> &times; A &times; &radic;(2gh)። ለነፃ ፍሰት: h = HWE &minus; ማዕከል። ለተጠለቀ ፍሰት (TWE ከ invert በላይ): h = HWE &minus; TWE።';
...
$ec_lang['or_notes_4_def']='TWE ከክፍት ቦታ invert በላይ ሲሆን ይህ ካልኩሌተር h = HWE &minus; TWE ተጠቅሞ የተጠለቀ ቀዳዳ እኩልታ ያለቃ ያሠራል። TWE ከ invert ወይም ዝቅ ሲሆን ነፃ ፍሰት h = HWE &minus; ማዕከል ሆኖ ይወሰዳል።';
// Orifice Drain Time
$ec_lang['odt_main_menu']='ቀዳዳ ፍሳሽ ጊዜ';
$ec_lang['odt_main_title']='ነፃ ኦንላይን ቀዳዳ ፍሳሽ ጊዜ ካልኩሌተር — ኩሬ፣ ቤዝን ወይም ታንክ';
$ec_lang['odt_main_desc']='ኩሬ ወይም ቤዝን ቀዳዳ ፍሳሽ ጊዜ &mdash; ኮኒካዊ ድምር ዘዴ';
...
$ec_lang['odt_notes_1_def']='t = &radic;H<sub>1</sub> / (C<sub>d</sub> A<sub>or</sub> &radic;(2g)) &times; (2A<sub>x</sub>/5 + 8&radic;(A<sub>x</sub>A<sub>0</sub>)/15 + 16A<sub>0</sub>/15) ከጭንቅ H እስከ ቀዳዳ ፍሳሽ ጊዜ ይሰጣል። ፍሳሽ ጊዜ = t(H<sub>1</sub>,A<sub>1</sub>,A<sub>0</sub>) &minus; t(H<sub>2</sub>,A<sub>2</sub>,A<sub>0</sub>)፣ H<sub>1</sub> = የጀምር ከፍታ &minus; ቀዳዳ ከፍታ፣ H<sub>2</sub> = የማብቂያ ከፍታ &minus; ቀዳዳ ከፍታ።';
...
$ec_lang['odt_h1']='የጀምር ጭንቅ, H<sub>1</sub> (WSE &minus; ማዕከል)';
...
$ec_lang['mhp_km']='ጠንካራ ኪሳራ ቅንጅት, k<sub>m</sub> <span title="Sum of all junction and fitting loss coefficients along the penstock" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['mhp_nu']='የኪነማቲክ viscosity, &nu; <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_vel_low']='ከ1 m/s በታች — ዲያሜትሩን ቀንሱ ⚠';
$ec_lang['mhp_vel_high']='ከ3 m/s በላይ — ዲያሜትሩን ጨምሩ ⚠';
...
$ec_lang['mhp_notes_1_def']='ጠቅላላ ኪሳራ h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>፤ h<sub>f</sub> = f(L/D)(v&sup2;/2g) የዳርሲ-ዋይስባክ ፍሰት ኪሳራ ነው፤ h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g መግቢያ፣ ጥምዝ እና ቫልቮችን ይሸፍናል። ንጹህ ጫና H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='ፍጥነት';
$ec_lang['mhp_notes_2_def']='ዒላማ 1&ndash;3 m/s። ከ1 m/s በታች ቧንቧው አስፈላጊ ያህል ትልቅ ነው; ከ3 m/s በላይ ፍሰት ኪሳራ እና የውሃ መምቻ አደጋ ይጨምራሉ።';
$ec_lang['mhp_notes_3_term']='የጫና ኪሳራ ዒላማ';
$ec_lang['mhp_notes_3_def']='ከጠቅላላ ጫና 10% በታች ያለ ኪሳራ በአጠቃላይ ኢኮኖሚያዊ ነው። ለከፍተኛ ዋጋ ኤሌክትሪክ ቦታዎች የቧንቧ ወጪ እና ጠፍቶ ኃይል ሚዛን ብዙ ጊዜ 4&ndash;6% አካባቢ ነው።';
$ec_lang['mhp_notes_4_term']='ሁለተኛ ደረጃ ኪሳራዎች k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='ተለምዷዊ እሴቶች: ሹል መግቢያ 0.5፣ እያንዳንዱ 45&deg; ጥምዝ 0.2&ndash;0.3፣ ቤይ ቫልቭ (ሙሉ ክፍት) 0.1፣ ቢራቢሮ ቫልቭ 0.2። ሁሉም ፊቲንጎች ሲደማሙ k<sub>m</sub> ይሆናሉ። ነባሪ 1.5 አንድ መግቢያ እና ሁለት ጥምዝ ያስቆጥራል።';
$ec_lang['mhp_notes_5_term']='የቧንቧ ሻካራነት e';
$ec_lang['mhp_notes_5_def']='ተለምዷዊ ፍፁም ሻካራነት: ብረት (አዲስ) 0.046&nbsp;ሚሜ፣ ብረት (ያረጀ) 0.15&nbsp;ሚሜ፣ HDPE 0.003&nbsp;ሚሜ፣ PVC/uPVC 0.0015&nbsp;ሚሜ፣ ኮንክሪት 0.3&ndash;3&nbsp;ሚሜ። HDPE ለትንሽ ማይክሮ-ሃይድሮ ቧንቧዎች ተለምዷዊ ነው።';
...
$ec_lang['ds_main_desc']='ጠብታ &amp; ርጭት መስኖ &mdash; አፈጻጸም መጠን እና አጠቃቀም ወጥነት';
$ec_lang['ds_q_avg']='አማካኝ የኤሚተር ፍሰት መጠን, q';
$ec_lang['ds_q_min']='ዝቅተኛ የኤሚተር ፍሰት መጠን, q<sub>min</sub>';
$ec_lang['ds_se']='የኤሚተር ክፍተት በላተራል ላይ, S<sub>e</sub>';
$ec_lang['ds_sl']='የላተራል ክፍተት (የረድፍ ክፍተት), S<sub>l</sub>';
$ec_lang['ds_n_e']='ኤሚተሮች በላተራል, n<sub>e</sub>';
$ec_lang['ds_n_l']='ላተራሎች በዞን, n<sub>l</sub>';
$ec_lang['ds_d']='ዒላማ አፈፃፀም ጥልቀት, d';
$ec_lang['ds_a_e']='ስፋት ለእያንዳንዱ ኤሚተር, A<sub>e</sub>';
$ec_lang['ds_pr']='አፈፃፀም መጠን (የዝናብ መጠን), PR';
$ec_lang['ds_du']='የስርጭት ወጥነት, DU';
$ec_lang['ds_du_check']='DU ጥራት ምርመራ';
$ec_lang['ds_q_lat']='ፍሰት በላተራል, Q<sub>lat</sub>';
$ec_lang['ds_q_sys']='የዞን ፍሰት, Q<sub>zone</sub>';
$ec_lang['ds_t_run']='የሩጫ ጊዜ ለዒላማ ጥልቀት (ሰዓታት)';
$ec_lang['ds_du_excellent']='አስደናቂ — DU ≥ 90% ✓';
$ec_lang['ds_du_good']='ጥሩ — DU ≥ 80% ✓';
$ec_lang['ds_du_acceptable']='ተቀባይ — DU ≥ 70%';
$ec_lang['ds_du_poor']='ደካማ — DU < 70% — ዲዛይን ይገምግሙ ⚠';
$ec_lang['ds_notes_1_term']='አፈፃፀም መጠን';
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>, A<sub>e</sub> = S<sub>e</sub> &times; S<sub>l</sub> ለእያንዳንዱ ኤሚተር የሚሸፈን ስፋት ነው። ዝቅተኛ አፈፃፀም መጠን ለምድር ዘለቃ የበለጠ ጊዜ ይሰጣል &mdash; በከባድ አፈር ወይም ዳገታማ ሜዳዎች አስፈላጊ ነው።';
$ec_lang['ds_notes_2_term']='የስርጭት ወጥነት (DU)';
...
$ec_lang['cs_Ec_target']='ከሽፋን በኋላ ዒላማ የማስተላለፊያ ብቃት, E<sub>c,target</sub> (ክፍልፋይ, 0&ndash;1) &mdash; የተሸፈነ ቦይ ውሃ ምን ያህል እንደሚይዝ ዒላማ';
$ec_lang['cs_lining_area']='የቦይ ሽፋን ስፋት (L &times; P<sub>w</sub>)';
...
$ec_lang['cs_notes_3_def']='የውሃ ዋጋ እና የሽፋን ወጪ በማናቸውም ወጥ ምንዛሬ ያስገቡ። የሽፋን ስፋት = የደረጃ ርዝመት &times; የተረጠቀ ዙሪያ &mdash; በተለካ ፍሰት ጥልቀት ላይ የቦይ መስቀለኛ ክፍል የተረጠቀ ዙሪያ (የታቹ ስፋት ከሁለቱም የተረጠቁ ጎኖች ጋር)። የሚመለሰው ዓመታዊ ዋጋ የተሸፈነ ቦይ ዒላማ E<sub>c</sub>ን ያለማቋረጥ ያሳካዋል ብሎ ይገምታል። ለወቅታዊ ቦዮች ወይም ሽፋኑ ዒላማ ብቃቱን ካልደረሰ ትክክለኛ ክፍያ መመለሻ ጊዜ ይረዝማል።';
...
$ec_lang['rc_main_desc']='የድንጋይ ቱቦ ሪፕራፕ ማቀናጀት &mdash; Robinson, Rice &amp; Kadavy (1998)';
...
$ec_lang['rc_layer']='የድንጋይ ሽፋን ውፍረት (2 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_radius']='የላይኛው ጫፍ 곡선 ራዲየስ (40 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_length']='የላይኛው ጫፍ ቀስት ርዝማኔ';
$ec_lang['rc_apron_length']='የማውጫ ሰሌዳ ርዝማኔ (15 &times; D<sub>50</sub>) <span title="ለቱቦ ድንጋይ አወቃቀራዊ ድጋፍ የሚያስፈልግ። &quot;ከማውጫ ደረስ እና ከዳር ቦይ ተቃውሞ የሚከሰተው ዝቅተኛ ጭራ ውሃ በማውጫ ደረስ ውስጥ ሪፕራፕ መረጋጋትን ለማረጋገጥ በቂ ነው።&quot; (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_qs']='የላይ ፊት የአሃድ ፍሳሽ, q<sub>s</sub> (q<sub>t</sub> &minus; q<sub>m</sub>)';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice &amp; Kadavy (1998) የቱቦ ቁልቁለት እና የአሃድ ፍሳሽ ላይ ተመስርተው ለመካከለኛ ሪፕራፕ መጠን D<sub>50</sub> ሁለት ተሞክሮ ቀመሮችን አዘጋጅተዋል። ቀመር 1 ለቀስ ቁልቁለቶች (S<sub>0</sub> &lt; 0.10) ይተገበራል; ቀመር 2 ለቁልቁለት ቁልቁለቶች (0.10 &le; S<sub>0</sub> &le; 0.40)። ሁለቱም ቀመሮች q<sub>t</sub> m&sup2;/s ውስጥ ይፈልጋሉ እና D<sub>50</sub> mm ይሰጣሉ። የተረጋገጠ ወሰን 0.02 &le; S<sub>0</sub> &le; 0.40 ነው።';
$ec_lang['rc_notes_2_term']='የአሃድ ፍሳሽ';
$ec_lang['rc_notes_2_def']='q<sub>t</sub> በቱቦ ጫፍ ላይ ጠቅላላ የአሃድ ፍሳሽ ነው (በአሃድ ስፋት ጠቅላላ ፍሳሽ)። ጠቅላላ ፍሳሽ Q ያለው የታች ስፋት B ቦይ ለ, q<sub>t</sub> &asymp; Q / B ወደ ቅርብ ያምጡ, ወይም በቱቦ መግቢያ ላይ ወሳኝ-ጥልቀት ሁኔታ ካስሉ።';
$ec_lang['rc_notes_3_term']='ከድንጋይ ሽፋን ውስጥ ፍሳሽ';
$ec_lang['rc_notes_3_def']='ከጠቅላላ ፍሳሽ ክፍል ከድንጋይ ሪፕራፕ ቀዳዳዎች ውስጥ ይፈስሳል (የሽፋን ፍሳሽ q<sub>m</sub>); ቀሪ ከድንጋይ ገጽ ላይ ይፈስሳል (q<sub>s</sub> = q<sub>t</sub> &minus; q<sub>m</sub>)። ፍሳሽ ጥልቀት d የቱቦ ድርቅ n ተጠቅሞ ከገጽ ፍሳሽ q<sub>s</sub> ላይ Manning ቀመር ተግብሮ ይሰላል። ለማዕዘናዊ ተቀጠቀጠ ድንጋይ ነባሪ ቀዳዳ ጥቅጥቅ n<sub>p</sub> = 0.45 ዓይነተኛ ነው።';
