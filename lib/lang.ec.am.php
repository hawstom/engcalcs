...
$ec_lang['lpn_field_text_match_pipe']='ከቅርቡ ግንኙነት ጋር አመሳስል';
...
$ec_lang['lpn_time_format_tip']='ጊዜን እንደ ሰዓትና ደቂቃ ይጻፉ፣ ለምሳሌ 2:30። ተራ ቁጥር ሰዓት ማለት ነው፤ የራሱ ቃል ያለው ቁጥር ግን ያንን ቃል ማለት ነው፦ 30 ደቂቃ።';
$ec_lang['lpn_time_running']='ጠቅላላውን ጊዜ በEPANET ሞተር በማስላት ላይ።';
$ec_lang['lpn_time_no_engine']='አብሮ የተሰራው ፈታች በአንድ ጊዜ አንድ ቅጽበት ብቻ ያሰላል፣ ስለዚህ ይህ የመረቡ ሁኔታ በ{time} ላይ ብቻ ነው፦ ፍላጎቶቹ የዚያን ቅጽበት የስርዓት ብዜቶች ይይዛሉ፣ እያንዳንዱ ታንክም ከመሙላትና ከመትፋት ይልቅ በመነሻ ደረጃው ላይ ይቆያል። የEPANET ሞተርን ለማምጣት አንድ ጊዜ በኢንተርኔት ይገናኙ፣ እሱም ጠቅላላውን ጊዜ ያሰላል።';
