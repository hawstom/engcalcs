...
$ec_lang['lpn_basemap_satellite_hide']='የሳተላይት ምስሎችን ደብቅ';
$ec_lang['lpn_basemap_satellite_tip']='ከMapbox የተገኙ የመሬት ፎቶግራፎች፣ ካርታውን ሲያንቀሳቅሱና ሲያጎሉ በኢንተርኔት ይመጣሉ። ቧንቧ በትክክል የት እንደሚያልፍ ለማየት ጠቃሚ። መረብዎ ምስሎቹ ቢታዩም ባይታዩም ይሳላል።';
$ec_lang['lpn_georef_asdeg_btn']='እነዚህ ቀድሞውኑ ኬክሮስ/ኬንትሮስ ናቸው';
$ec_lang['lpn_georef_asdeg_tip']='ይህን የሚጫኑት በዚህ ፋይል ውስጥ ያለው x እና y በእውነት ኬንትሮስና ኬክሮስ ከሆኑ ብቻ ነው። መረቡ ወዲያውኑ እነዚያ ቁጥሮች ወደሚያመለክቱት ቦታ ይዘላል፣ ምንም ነገር ማስቀመጥ አያስፈልግም። እያንዳንዱ ቁጥር በሁለቱም ሁኔታ በትክክል እንዳለ ይቆያል።';
$ec_lang['lpn_georef_asdegrees']='በዚህ ፋይል ውስጥ ያለው x እና y እንደ ኬንትሮስና ኬክሮስ ተነብቧል፣ ስለዚህ መረቡ ቀድሞውኑ በካርታው ላይ ነው፣ ምንም ነገርም አልተንቀሳቀሰም። በትክክለኛው ቦታ መሆኑን ያረጋግጡ፣ ከዚያም ይህን ስፍራ አቆይ የሚለውን ይጫኑ።';
...
$ec_lang['lpn_menu_project']='ፕሮጀክት';
...
$ec_lang['lpn_run_menu_tip']='ይህን መረብ አሁን እንደገና ያሰላል። የአስላ አዝራር እየፈለጉ ነው? ይህ ፕሮጀክት ከእያንዳንዱ ለውጥ በኋላ እንደገና ቢያሰላም፣ የመሳሪያ አሞሌው ምንም የአስላ አዝራር የለውም። በቅንብሮች ውስጥ፣ በስሌት፣ ሃይድሮሊክስ ስር ያለውን «በራስ-ሰር እንደገና አስላ»ን ካጠፉ፣ አዝራሩ ይመለሳል።';
...
$ec_lang['lpn_replace_button']='ለውጥ';
...
$ec_lang['lpn_inp_drop_head_pattern']='እነዚህ ማጠራቀሚያዎች በቀኑ ውስጥ ይነሳሉ ይወርዳሉም። ስርዓቶቻቸው ሙሉ በሙሉ ገብተዋል፣ የሚያዩትም የውሃ ደረጃ ሰዓቱ ለሚያሳየው ቅጽበት የሆነው ነው።';
$ec_lang['lpn_inp_drop_pump_speed']='እነዚህ ፓምፖች ኩርባቸው ከተለካበት ውጭ በሆነ ፍጥነት ይሮጣሉ፣ ወይም በቀኑ ውስጥ ፍጥነት ይቀይራሉ። ፍጥነቱና ስርዓቱ ሙሉ በሙሉ ገብተዋል፣ የሚያዩትም ሄድ ሰዓቱ ለሚያሳየው ቅጽበት የሆነው ነው።';
...
$ec_lang['lpn_import_notes_heading']='ከEPANET ፋይል';
$ec_lang['lpn_file_open_tip']='ከዚህ ገጽ የተቀመጠ የፕሮጀክት ፋይል ይክፈቱ።';
$ec_lang['lpn_notes_color_term']='የቀለም ክልል ወሰኖች ተመሳሳይ ሆነው ይቆያሉ';
$ec_lang['lpn_notes_color_def']='የቀለም ክልል ወሰኖች የሚዘጋጁት የመረጃ ምድብ ዘዴ ሲመርጡ ነው። በእያንዳንዱ የጊዜ ደረጃ እንደገና አይዘጋጁም፣ ምክንያቱም ያ ቀለሞቹ በእያንዳንዱ ደረጃ አዲስ ነገር እንዲያመለክቱ ስለሚያደርግ፣ ይህም ሲስተምዎን ለማየት አይረዳም። EPANET በተመሳሳይ መንገድ ይሰራል። አዲስ ወሰኖች ለማግኘት፣ ዘዴውን እንደገና ይምረጡ ወይም የራስዎን ይተይቡ።';
...
$ec_lang['lpn_time_run_report_tip']='የEPANET ፈታች ራሱ ስለ መጨረሻው ስራ ያተመው፦ እንዴት እንደረጋ፣ እና ስለምንም ያስጠነቀቀው ነገር። ይህ የፈታቹ ራሱ ጽሑፍ ነው፣ የእኛ አይደለም።';
...
$ec_lang['lpn_library_curves_tip']='ኩርባ ፓምፕ እንዴት እንደሚሰራ የሚናገሩ ነጥቦች ናቸው፦ በእያንዳንዱ ፍሰት ምን ያህል ሄድ እንደሚሰራ።';
$ec_lang['lpn_library_curves_note']='ኩርባ የሚጠቀመው ፓምፕ ወይም ቫልቭ የራሱ ነው፣ ይህም ለማንበብ በአንድ ቦታ የተሰበሰበ ሙሉ ስብስብ ነው። ወደዚያ አካል ሄደው ነጥቦቹን ለመቀየር አንድ ID ይጫኑ። ለፓምፕ የሚሳለው መስመር ስራው የሚጠቀመው ኩርባ ነው፣ በነጥቦቹ ውስጥ የተስማማ፤ ለቫልቭ ደግሞ በመካከላቸው ያለው ቀጥተኛ ደረጃዎች ናቸው።';
...
$ec_lang['lpn_library_default_pattern']='ነባሪ የፍላጎት ስርዓት';
$ec_lang['lpn_library_default_pattern_tip']='ምንም ስርዓት የሌለው እያንዳንዱ መገናኛ ይህን ይጠቀማል።';
...
$ec_lang['lpn_field_demand_pattern_tip']='የዚህ መገናኛ ፍላጎት በስራው ውስጥ እንዴት እንደሚነሳ እንደሚወርድም። ራሱ የፕሮጀክቱ ስርዓት የሆነውን ለመከተል፣ ምንም ስርዓት የለም ብለው ይተውት።';
...
$ec_lang['lpn_field_speed_pattern_tip']='የዚህ ፓምፕ ፍጥነት በስራው ውስጥ እንዴት እንደሚነሳ እንደሚወርድም። እያንዳንዱ ማባዣ ለዚያ የቀኑ ክፍል ራሱ አንጻራዊ ፍጥነት ነው፣ ከላይ ያለውን ፍጥነት ይተካል፣ ስለዚህ የ0 ማባዣ ፓምፑን ያቆማል።';
...
$ec_lang['lpn_terrain_menu']='ከመሬቱ ከፍታዎችን ሙላ…';
$ec_lang['lpn_terrain_tip']='ምንም ከፍታ የሌለውን እያንዳንዱን መገናኛ ስር ያለውን የመሬት ከፍታ ያነብና ለእርስዎ ይተይባል። ቀድሞውኑ ከፍታ ያለው መገናኛ አይነካካም፣ አንድ ቀልብስም ሁሉንም መልሶ ያመጣል። የመጀመሪያው አጠቃቀም ፈቃድዎን ይጠይቃል፣ ምክንያቱም የመገናኛዎችዎ ቦታዎች ወደ Mapbox ስለሚላኩ።';
$ec_lang['lpn_terrain_accuracy']='የመሬት መረጃው በመሬት ላይ በግምት 30 ሜትር ስፋት ያለውና በአቀባዊ ብዙ ጊዜ ብዙ ሜትሮች የተሳሳተ ነው። እንደ ኮንቱር ካርታ ይያዙት እንጂ እንደ ቅየሳ አይደለም፦ የሚተማመኑበትን ማንኛውንም ነገር ያረጋግጡ።';
...
$ec_lang['lpn_terrain_confirm']='የ{n} መገናኛ(ዎች) ከፍታ ከመሬት ገጽታ ይሙላ?';
...
$ec_lang['lpn_terrain_confirm_default_2']='እነዚያን {n} በመሬት ገጽታ ይተኩ?';
...
$ec_lang['lpn_terrain_none_needed']='እያንዳንዱ መገናኛ እርስዎ ካስቀመጡት ከፍታ አለው። ምንም ነገርም አልተቀየረም፣ ምንም ነገርም አልተላከም — ቀድሞውኑ ያለ ከፍታ በጭራሽ አንተካም።';
$ec_lang['lpn_terrain_no_nodes']='እስካሁን የሚሞላ መገናኛ የለም።';
