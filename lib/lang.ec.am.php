...
$ec_lang['lpn_inp_drop_units']='በዚህ ፋይል ውስጥ ያሉት የፍሰት መለኪያ ክፍሎች አልታወቁም፣ ስለዚህ ጋሎን በደቂቃ ተብሎ ተገምቷል። መልሶቹን ከመጠቀምዎ በፊት እያንዳንዱን ቁጥር ያረጋግጡ።';
...
$ec_lang['lpn_backdrop_position_prompt1']='በበስተጀርባ ምስሉ ላይ ማንኛውንም ነጥብ ይጫኑ። ይህ የሚያንቀሳቅሱት ነጥብ ነው።';
$ec_lang['lpn_backdrop_position_prompt2']='ያ ነጥብ የት መሄድ እንዳለበት ይምረጡ፣ ከዚያም ቀጥል የሚለውን ይጫኑ።';
...
$ec_lang['lpn_settings_engine_epanet_tip']='ከUS EPA የመጣውን የEPANET ራሱን ፈታች፣ እዚሁ በአሳሽዎ ውስጥ ያሄዳል። አብሮ የተሰራው ማስያ ተመሳሳይ መልስ ይሰጣል እና ፈጣን ነው፣ ስለዚህ ራሱ EPANET የሚያስፈልግዎት ካልሆነ በስተቀር ይህን ጠፍቶ ይተውት።';
...
$ec_lang['lpn_settings_symbol_size']='የምልክት መጠን (ከጽሑፍ አንጻር)';
