...
$ec_lang['ip_main_menu']='ስንጋይ ግፊት';
$ec_lang['ip_main_title']='ነፃ ኦንላይን ስንጋይ ግፊት &amp; ስርጭት ወጥነት ካልኩሌተር';
$ec_lang['ip_main_desc']='የሙከራ ቅርንጫፍ ግፊት እና ወጥነት ግምት';
...
$ec_lang['ip_is_lateral']='ላት. <span title="ተሳሚ: ይህ reach ለሙከራ ላተራል ክፍል ነው, በሳቢዮች ዓይነተኛ. ተሳሚ ያልሆነ: ይህ reach ዋና ነው, ለራስ ፍሰት ለላተራሎች ብቻ ስንጋይ የሚልክ." class="ec-tip">?</span>';
$ec_lang['ip_count']='ሳቢዮች <span title="ላተራል ረድፍ: በዚህ reach ውስጥ ሳቢዮች. ዋና ረድፍ: በሌሎች ላተራሎች ላይ ጠቅላላ ሳቢዮች ከዚህ reach ስለ ይውጣ. ለሙከራ ላተራል&rsquo;ሰ ራስ ስታር ጀርባ, ይህ አንድ ላተራሎች ለ ውስጥ ጨምር ወይም ስታር ሙሉ (ለምሳሌ, ተቃራኒ-ጎን ላተራል) &mdash; የ ፍሰት ይህ reach ሙሉ ለ ተሰላ, ምንም ነገር ወይም ሌላ ቦታ ይህ ሠንጠረዥ ውስጥ ይታያል." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_e']='e <span title="Darcy-Weisbach ሩቅ ሻካርነት ከፍታ" class="ec-tip">?</span>';
$ec_lang['ip_km']='K<sub>m</sub> <span title="ጠቅላላ ትንንሽ-ኪሳራ ቅንጅት ለዚህ reach&rsquo;ሰ ፊት/ቫልቭ/ማያያዣዎች (&ge;0.5 ጠቁሞ ዝቅተኛ)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='DS Elev. <span title="ወደ ታች-ጀርባ ከፍታ የዚህ reach. አማራጭ በውስጠ ረድፎች (ደከምርኝ ወደ ጠፍጣፋ / ከላይ ሳቢ ተመሳሳይ ከሆነ). ያስፈልጋል የመጨረሻ ረድፍ: ዋጋ የሚቋጠር ኤሚተር&rsquo;ሰ ከፍታ, ቀጥተኛ የሚከለከል አቅርቦት ግፊት." class="ec-tip">?</span>';
...
$ec_lang['ip_hl']='H<sub>l</sub> <span title="ጠቅላላ reach ኪሳራ, H_f + H_m" class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='የሙከራ መንገድ አቅርቦት ፍሰት, Q<sub>supply</sub> <span title="ፍሰት ወደ ሞዴል ሙከራ መንገድ ብቻ, ሙሉ ዞን/ስርዓት ሳይደለም &mdash; Q_zone በ አፈፃፀም ዲዛይን ዲያግራም ይመልከት." class="ec-tip">?</span>';
$ec_lang['ip_q_critical']='የሚቋጠር ኤሚተር ፍሰት, q<sub>last</sub>';
$ec_lang['ip_q_avg_lateral']='አማካይ ኤሚተር ፍሰት (ሙከራ ላተራል), q<sub>avg</sub>';
$ec_lang['ip_dp_avg']='ግምታዊ Δግፊት, አማካይ vs. ሙከራ ላተራል <span title="ምን ያህል ከፍ ወይም ዝቅ ነቁ ተለምዷዊ/መካከለኛ ላተራል ይህ ሙከራ ላተራል ጋር ያምናል. ሙከራ ላተራል ይንቀሳቀሱ ከሁ አስተውውቀት, ነገር ግን ራስ 0, አጣምሮ ወጥነት-ይሂድ ቁጥር ከ ሙከራ ላተራል&rsquo;ሰ ራስ (ምናልባት optimistic) አማካይ ነድፍ ተጠቀም." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='ግምታዊ ሜዳ-አማካይ ኤሚተር ፍሰት, q<sub>avg,field</sub> <span title="q_avg_lateral በእያንዳንዱ ላተራል ረድፍ&rsquo;ሰ ግፊት ሲደምር Δግፊት ከላይ &mdash; ሙከራ ላተራል&rsquo;ሰ ራስ አማካይ, ሰመወ ትክክለኛ Δግፊት ትክክለኛ ሜዳ አማካይ ምክንያት ይሆናል ብለን ተስቶ. አቅርቦት አማካይ ወጥነት-ይሂድ እና አፈፃፀም-ዲዛይን ክፍል ገበታ ዲያግራም." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='ወጥነት-ይሂድ, q<sub>last</sub>/q<sub>avg,field</sub> <span title="የሚቋጠር ኤሚተር&rsquo;ሰ ሞዴል ፍሰት ግምታዊ ሜዳ-አማካይ ኤሚተር ፍሰት በ ተከፍሎ &mdash; ተመሳሳይ ቅርጽ ናቦታ ዝቅተኛ-ሩብ ስርጭት ወጥነት (ዝቅተኛ-ቡድን አማካይ ÷ ሳቢ ቁጥር), ሆኖም ከትንሽ ሞዴል ናሙና ተሰማ እና ጠቁሞ-ግምታዊ ትክክለኛ, ሙሉ-ሜዳ ሕታዊ ናሙና ሳይደለም. ዋጋ ከ 1 ከላይ ምቾት ይሆናል (ለምሳሌ, ያወቁ ዝቅተኛ ጀርባ ሮጫ, ወይም Δግፊት ግምታዊ ማለት ትንሽ)." class="ec-tip">?</span>';
...
$ec_lang['ip_notes_3_def']='ሞዴል አንድ ቋሚ ወደ ግፊት (ምንም ሙሌት ኩርቫ), አንድ ሙከራ መንገድ ብቻ (ሙሉ ሜዳ ሳይደለም), ሪ 2-ደግሞ ኤሚተር ጠጀር (አቀናበር አስተውውቀት ወደ 0 ወደ approxim ግፊት-ካካሺ ኤሚተር). ሁለት የተለየ ቤተሰብ ጠቁሞ, ይመድቡ ደግሞ: q<sub>last</sub>/q<sub>avg,field</sub> ወጥነት-ይሂድ, ነድፍ ዝቅተኛ-ሩብ ስርጭት ወጥነት (ዝቅተኛ-ቡድን አማካይ ÷ ሳቢ ቁጥር) ሆኖም ሞዴል ሙከራ ላተራል&rsquo;ሰ ራስ ኤሚተሮች ተሰማ, ሰመወ ብ ግቤት Δግፊት ወጥነት ከ ሙሉ-ሜዳ ሕታዊ ናሙና ሳይደለም &mdash; ሙከራ ላተራል ይንቀሳቀሱ ከሁ ዕሙልት, ከሌለ ራስ አማካይ ሰመወ ሳቢ ሜዳ አማካይ ሩቅ ብልግ-ዕሙልት; Δግፊት ግቤት ሁኔታ ገዳ ሆኗል ተስቶ. ዋጋ ከ 1 ከላይ ምቾት ይሆናል (ለምሳሌ, Δግፊት ግቤት ምናልባት ትንሽ, ወይም አንድ ወደ ታች ሮጫ). q<sub>last</sub>/q<sub>design</sub> ለየት ይሂድ, እንደ-ወጥነት ይሂድ ዋናው ዲዛይን ፍሰት &mdash; ምርጥ ለ spotting አንድ over- ወይም under-ጫናበር ስርዓት በአጠቃላይ, ግን ተሙሉ ወጥነት ስሌት, ከዲዛይን ፍሰት ምንም አስፈላጊ ግንኙነት ለ ስርዓት&rsquo;ሰ ትክክለኛ ሙሉ ሁኔታ ግፊት.';
...
$ec_lang['ip_notes_5_def']='አፈፃፀም ወደ ስርዓት/ዞን ፍሰት ሪያ ግምታዊ ሜዳ-አማካይ ኤሚተር ፍሰት (q<sub>avg,field</sub> &mdash; ሙከራ ላተራል&rsquo;ሰ ራስ አማካይ, ሰመወ ብ ግቤት Δግፊት), ሳይ ግምታዊ ወደ: PR = q<sub>avg,field</sub> / A<sub>e</sub>, ሪያ ሞዴል ዋጋ. ክፍተት ስርዓት-ሰፊ ላተራል/ኤሚተር ቁጥር ለየት ግቤት ዲያግራም ሙከራ መንገድ ሞዴል ብቸኛ ዕሙልት ቅርንጫፍ, ሙሉ ሜዳ ሉዋ ላተራል ሳይደለም.';
