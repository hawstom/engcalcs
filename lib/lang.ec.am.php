...
$ec_lang['ip_main_title']='ነፃ ኦንላይን የመስኖ ግፊት &amp; ስርጭት ወጥነት ካልኩሌተር';
$ec_lang['ip_main_desc']='የሙከራ ላተራል ግፊት እና ወጥነት ግምት';
$ec_lang['ip_h_supply']='አቅርቦት ግፊት';
$ec_lang['ip_elev_supply']='አቅርቦት ከፍታ, z<sub>supply</sub>';
$ec_lang['ip_q_design']='ኤሚተር ዲዛይን ፍሰት, q<sub>design</sub>';
$ec_lang['ip_h_design']='ኤሚተር ዲዛይን ግፊት';
$ec_lang['ip_x']='የኤሚተር ፍሰት ኤክስፖነንት, x <span title="ለመደበኛ ግፊት የማይካኩ ኤሚተሮች 0.5፤ ግፊት ለሚካኩ ኤሚተሮች ወደ 0 ቅርብ" class="ec-tip">?</span>';
...
$ec_lang['ip_elev_ds_missing_warn']='የሚቋጠር ኤሚተር ከፍታ (የመጨረሻ ረድፍ) ባዶ ተወስደ ወደ ጠፍጣፋ &mdash; ትክክለኛ ወደ ውጤት ግቤት ⚠';
$ec_lang['ip_flow']='ፍሰት';
...
$ec_lang['ip_pressure_warn']='ዝቅተኛ/አሉታዊ ግፊት &mdash; ምንም subatmospheric ሁኔታዎች ጠንቅ';
$ec_lang['ip_pressure_warn_short']='ዝቅተኛ ⚠';
$ec_lang['ip_h_far']='የሚቋጠር ኤሚተር ግፊት';
...
$ec_lang['ip_q_critical']='የሚቋጠር ኤሚተር ፍሰት, q<sub>last</sub>';
...
$ec_lang['ip_du_estimate']='የወጥነት ማረጋገጫ, q<sub>last</sub>/q<sub>avg,field</sub> <span title="የመጨረሻው ኤሚተር የተሰላ ፍሰት በግምታዊው የማሳ አማካይ የኤሚተር ፍሰት ሲካፈል &mdash; በመማሪያ መጻሕፍት እንደሚታወቀው የታችኛው ሩብ የስርጭት ወጥነት (የታችኛው ቡድን አማካይ &divide; የጠቅላላው አማካይ) ያለ ቅርጽ፣ ነገር ግን ከትንሽ የተቀረጸ ናሙናና ተጠቃሚው ከገመተው እርማት እንጂ ከመላው ማሳ ስታቲስቲካዊ ናሙና አይደለም። 1 ወይም ከዚያ በላይ እሴቶች ይቻላሉ፤ ስህተትም አይደሉም: የመጨረሻው ኤሚተር ከግምታዊው የማሳ አማካይ አንጻር ዝቅተኛው ነጥብ አለመሆኑን ብቻ ያሳያል (ለምሳሌ ወደ ታች የሚወርድ ምቹ መስመር፣ ወይም ከላይ ያለው የ&Delta;ግፊት ግምት በጣም ትንሽ ነው)።" class="ec-tip">?</span>';
$ec_lang['ip_worst_case_warn']='ሙከራ ኤሚተር ግፊት ከ ወይም አቅርቦት ግፊት ከ ላይ &mdash; ይህ መንገድ ምናልባት ያወቁ ዕሙልት ላተራል ሳይደለም. ለ ሩቅ ወይም ከፍ-ግፊት ላተራል ጠንቅ, ወይም ከፍታ ገበታ ተገቢ ይህ ግዴታ ሁኔታ ሊወስናለ.';
$ec_lang['ip_q_ratio']='የመጨረሻው ኤሚተር ፍሰት ከዲዛይን ፍሰት ጋር, q<sub>last</sub>/q<sub>design</sub> <span title="የተለየ ማረጋገጫ ነው፤ የወጥነት መለኪያ አይደለም: የመጨረሻው ኤሚተር ከአምራቹ የተሰጠው የዲዛይን ፍሰት በምን ያህል እንደሚርቅ። ከ1 በላይ: ከዲዛይን ነጥቡ በላይ ይሠራል (ለምሳሌ በምቹ የከፍታ ቅናሽ ምክንያት)። ከ1 በታች: ከዲዛይን በታች ይሠራል (በፍትጊያ የሚመራ የተለመደ ሁኔታ)።" class="ec-tip">?</span>';
