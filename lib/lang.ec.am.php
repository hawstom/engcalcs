...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="የDarcy-Weisbach ሻካርነት ቁመት"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_length']='<span class="ec-help" title="የመግቢያ (ርዕስ ሥራ) ማድረሻ ቧንቧ ወይም ትራፍ ርዝመት">ርዝመት፣ L <span class="ec-tip">?</span></span>';
$ec_lang['mhp_roughness']='የቧንቧ ሻካራነት፣ e';
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">ጠንካራ ኪሳራ ቅንጅት, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">የኪነማቲክ viscosity, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="ዓይነተኛ የተቀጠቀጠ ግራናይት ወይም ባዛልት ≈ 2.65። Robinson ትክክለኛ ወሰን፦ 2.54 እስከ 2.82።">የድንጋይ ልዩ ስበት, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_apron_length']='<span class="ec-help" title="ለፈጣን ቦዩ ድንጋይ አወቃቀራዊ ድጋፍ ያስፈልጋል። &quot;በመውጫ ክፍልና በታችኛው ቦይ ተቃውሞ ምክንያት የሚፈጠረው ዝቅተኛ የጅራት ውሃ በመውጫ ክፍል ውስጥ ያለውን ሪፕራፕ መረጋጋት ለማረጋገጥ በቂ ነው።&quot; (Robinson)">የመውጫ ሰሌዳ ርዝመት (15 × D<sub>50</sub>) <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_e']='<span class="ec-help" title="የ Darcy-Weisbach የሻካራነት ቁመት">e <span class="ec-tip">?</span></span>';
