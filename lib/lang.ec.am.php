...
$ec_lang['lpn_labels_prefix_id_tip']='በካርታው ላይ ከመለያው በፊት የሚታይ ጽሑፍ። ይህን ባዶ ይተውት፣ መለያውም በተሰጠው ፊደል ጀምሮ ብቻውን ይታያል፣ እንደ J1 ወይም L1።';
...
$ec_lang['lpn_push_elements']='ነጥቦችና ቧንቧዎች፦';
...
$ec_lang['lpn_georef_menu']='ወደ ኬክሮስ/ኬንትሮስ ቀይር…';
$ec_lang['lpn_georef_tip']='ከአካባቢያዊ ፍርግርግ ወደ እውነተኛው ዓለም። በXY ፍርግርግ ላይ የተሳለ ስዕል ወደ ጂኦግራፊያዊ መጋጠሚያዎች ያድርጉት፣ በዚህም በመንገድ ካርታው ላይ በሚገባው ቦታ ይቀመጣል። የተየቡት እያንዳንዱ ቁጥር እንዳለ ይቆያል — X እና Y ብቻ ወደ ኬንትሮስና ኬክሮስ ይቀየራሉ።';
...
$ec_lang['lpn_pane_tab_junctions_tip']='እያንዳንዱ መገናኛ በሠንጠረዥ ሆኖ፣ መደርደርና ማስተካከል ይችላሉ።';
$ec_lang['lpn_pane_junctions_none']='ይህ መረብ እስካሁን መገናኛዎች የሉትም።';
...
$ec_lang['lpn_settings_sec_elements']='አዲስ አካሎች';
