...
$ec_lang['mtc_note_1']='<dl><dt>አውቶማቲክ የድንጋይ መጠን እና ሻካሪነት ንድፍ ድግግሞሽ</dt><dd>የሻካሪነት አማራጭ (Blodgett–Bathurst ይመከራል) እና የንድፍ የድንጋይ መጠን አማራጭ (Isbash ይመከራል) ይምረጡ። የሚፈለገውን ፍሰት በወጥ የድንጋይ መጠን ለማግኘት ጥልቀቱን እና የድንጋይ መጠን የደህንነት ሁኔታን ያስተካክሉ። ማንኛውንም ግቤት በቀየሩ ቁጥር ካልኩሌተሩ እነዚህን ደረጃዎች ይደግማል፦ 1. ሻካሪነት ከንድፍ የድንጋይ መጠን ይሰላል። 2. የተመረጠው ዘዴ የሰጠው ሻካሪነት ዋጋ ወደ ግቤት ሻካሪነት ይገለበጣል። 3. የቦይ ፍሰት እና የሚፈለግ የድንጋይ መጠን ይሰላሉ። 4. የንድፍ የድንጋይ መጠን ይስተካከላል። 5. በንድፍ የድንጋይ መጠን ስህተት እጅግ አነስተኛ እስኪሆን ድረስ ይደገማል።</dd><dt>መሠረታዊ ካልኩሌተር (ያለ ድግግሞሽ)</dt><dd>የሚፈልጉትን የሻካሪነት ዋጋ ያስገቡ። የንድፍ የድንጋይ መጠን ግቤት ቦታን ችላ ይበሉ።</dd></dl>';
...
$ec_lang['mhp_hl_ok_tip']='የሄድ ኪሳራ ከጠቅላላ ሄድ ከ10% በታች ነው። ይህ የቧንቧ መጠን ኢኮኖሚያዊ ነው።';
$ec_lang['mhp_hl_warn_tip']='የሄድ ኪሳራ ከጠቅላላ ሄድ ከ10% በላይ ነው። ትልቅ ቧንቧ ያስቡ።';
$ec_lang['mhp_hl_bad_tip']='የሄድ ኪሳራ ከጠቅላላ ሄድ ከ20% በላይ ነው። የቧንቧውን መጠን ይቀይሩ።';
...
$ec_lang['lpn_inp_drop_quality']='ይህ ፋይል ውሃው ሲጓዝ ጥራቱ እንዴት እንደሚለወጥ ይገልጻል፦ በውሃው ውስጥ መጀመሪያ ላይ ያለው ምንድን ነው፣ ተጨማሪ ከየት ይገባል፣ እንዴት ይገባባል፣ ታንኮቹም እንዴት ይቀላቀላሉ። ይህ ገጽ የውሃ እድሜንና የምንጭ ፍለጋን ያሰላል፣ ኬሚካልን ግን አይደለም፣ ስለዚህ ከዚያ ውስጥ ምንም እዚህ ጥቅም ላይ አይውልም። እነዚያ መስመሮች ይያዛሉ፣ የEPANET ፋይል ካስቀመጡም ይመለሳሉ።';
...
$ec_lang['lpn_tip_select']='አካሎችን በካርታው ላይ ለመቀየር፣ ለማንቀሳቀስ እና ለመጎተት ይህን ሁነታ ይጠቀሙ። እንደ ፕሮጀክት መክፈት ካሉ አንዳንድ ተግባራት በኋላ ገጹ ራሱ ወደዚህ ሁነታ ይመለሳል።';
...
$ec_lang['lpn_settings_color_thematic_tip']='የነጥብና የቧንቧ ምልክቶችን ይደብቃል፣ ቀለሞቹ ብቻ በካርታው ላይ እንዲቀሩ። እርስዎ ራስዎ ያስቀመጡት ጽሑፍ ይቆያል። የምልክት ምርጫዎችዎ ይያዛሉ፣ ይህን ካጠፉም ይመለሳሉ።';
...
$ec_lang['lpn_file_import_geo']='xy ፋይል ካርታው ላይ ክፈት…';
$ec_lang['lpn_file_import_geo_tip']='የፕሮጀክት ፋይል ወይም የEPANET ፋይል በዚህ ገጽ ላይ አዲስ የፕሮጀክት ትር ውስጥ ይከፍታል፣ በመንገድ ካርታው ላይ። ስዕሉን በእጅዎ በዓለም ላይ ያስቀምጣሉ፦ ወደ ቦታው ይንቀሳቀሱና ያጉሉ፣ ከዚያም ልክ እንዲሆን መጠኑንና አቅጣጫውን ያስተካክሉ። በፋይሉ ውስጥ ያለው x እና y ቀድሞውኑ ኬንትሮስና ኬክሮስ ከሆኑ፣ እነዚህ ቀድሞውኑ ኬክሮስ/ኬንትሮስ ናቸው የሚለውን አዝራር ይጫኑ፣ መረቡም በቀጥታ ወደሚገባው ቦታ ይዘላል። የተየቡት ቁጥር ሁሉ እንዳለ ይቆያል።';
...
$ec_lang['lpn_color_break_number']='ወሰን ቁጥር መሆን አለበት። ካርታው አልተለወጠም።';
$ec_lang['lpn_color_break_order']='እያንዳንዱ ወሰን ከቀደመው መብለጥ አለበት። ካርታው አልተለወጠም።';
$ec_lang['lpn_color_break_count']='ከቀለሞቹ ቁጥር በአንድ ያነሰ ወሰን ሊኖር ይገባል። ካርታው አልተለወጠም።';
...
$ec_lang['lpn_clean_map_tip']='የሁኔታ መስመሩንና የመጋጠሚያ ንባቡን ከካርታው ላይ ያውጣ፣ ስክሪንሾት ስዕሉን ብቻ እንዲያሳይ። ስዕልዎ አይነካም፣ ይህ ምርጫም አይቀመጥም፤ ገጹን እንደገና ሲጭኑ ንባቦቹ ይመለሳሉ።';
...
$ec_lang['lpn_time_no_engine']='አብሮ የተሰራው ፈታች አንድ ቅጽበት በአንድ ጊዜ ያሰላል፣ ስለዚህ ይህ የመረቡ ሁኔታ በ{time} ላይ ብቻ ነው፦ እያንዳንዱ ስርዓት በዚያ ቅጽበት ይነበባል፣ እያንዳንዱ ታንክም ከመሙላትና ከመትፋት ይልቅ በመነሻ ደረጃው ላይ ይቆያል። የEPANET ፈታችን ለማምጣት አንድ ጊዜ በኢንተርኔት ይገናኙ፣ እሱም ጠቅላላውን ወቅት ያሰላል።';
...
$ec_lang['lpn_time_run_note']='እየተመለከቱ ያለው መረብ በመጀመሪያው የዘገባ ጊዜ ላይ ነው። ይህ መረብ ጠቅላላውን የጊዜ ወቅት ለማስላት ብዙ ጊዜ ስለሚወስድ፣ የኋለኞቹ ጊዜያት ውጤቶች እየሠሩ ባሉበት ወቅት ወቅታዊ ሆነው አይቆዩም። ወቅታዊ ለማድረግ አስላ የሚለውን ይጫኑ።';
...
$ec_lang['lpn_georef_asdegrees']='በዚህ ፋይል ውስጥ ያለው x እና y እንደ ኬንትሮስና ኬክሮስ ተነብበዋል፣ ስለዚህ መረቡ አስቀድሞ ካርታው ላይ ነው፣ ምንም ነገርም አልተንቀሳቀሰም። በትክክለኛው ቦታ መሆኑን ያረጋግጡ፣ ከዚያም ይህን አቀማመጥ ጠብቅ የሚለውን አዝራር ይጫኑ።';
...
$ec_lang['lpn_result_water_age_tip']='ወደዚህ ነጥብ የሚደርሰው ውሃ በስርዓቱ ውስጥ ምን ያህል ጊዜ እንደቆየ። ከእሱ ጋር የሚነጻጸር የቁጥጥር ገደብ የለም፣ ስለዚህ ቁጥሩን በራስዎ ስርዓት ልክ ይመዝኑት።';
...
$ec_lang['lpn_find_q_err_dot']='በሚፈልጉት ነገርና በንብረቱ መካከል ነጥብ ያድርጉ፣ ለምሳሌ መገናኛ.መለያ';
$ec_lang['lpn_find_q_err_prop']='የ{scope} ንብረት አይደለም፦ {w}። ከእነዚህ ውስጥ አንዱን ይሞክሩ፦ {list}';
$ec_lang['lpn_find_q_err_op']='ለ{prop} የሚሆን ሁኔታ አይደለም፦ {w}። ከእነዚህ ውስጥ አንዱን ይሞክሩ፦ {list}';
$ec_lang['lpn_find_q_err_value']='ይህ ሁኔታ ከእሱ በኋላ ዋጋ ያስፈልገዋል፦ {op}';
$ec_lang['lpn_find_q_err_quote']='በጽሑፍ ዋጋ ዙሪያ ትዕምርተ ጥቅስ ያድርጉ፦ {w} ቁጥር አይደለም።';
$ec_lang['lpn_find_q_err_quote_end']='ይህ በትዕምርተ ጥቅስ የተከበበ ጽሑፍ መዝጊያ ትዕምርተ ጥቅስ የለውም።';
...
$ec_lang['lpn_profile_rename']='የመንገድ ስም ቀይር…';
$ec_lang['lpn_profile_delete']='መንገድ አጥፋ';
$ec_lang['lpn_profile_prompt_name']='ለዚህ መንገድ ስም';
...
$ec_lang['lpn_new_coords_xy']='xy መጋጠሚያዎች';
$ec_lang['lpn_new_coords_geo']='ኬክሮስ/ኬንትሮስ';
$ec_lang['lpn_new_coords_tip']='የxy ፕሮጀክት ኬክሮስና ኬንትሮስ ያልሆኑ መጋጠሚያዎችን ይጠቀማል። የኬክሮስ/ኬንትሮስ ፕሮጀክት ጂኦግራፊያዊ መጋጠሚያዎች አሉት፣ ስለዚህ የመንገድ ካርታ ወይም የሳተላይት ምስል ከጀርባው ሊሳል ይችላል፣ የነጥብ ከፍታዎችም ከመሬት ገጽታ ሊነበቡ ይችላሉ። የxy ፕሮጀክት ፋይል፣ በካርታው ላይ xy ፋይል ክፈት በሚለው ወደ ኬክሮስ/ኬንትሮስ ሊለወጥ ይችላል።';
$ec_lang['lpn_new_place']='ከዚህ ቦታ አጠገብ ጀምር';
$ec_lang['lpn_new_place_tip']='አማራጭ ነው። ከተማ፣ መንገድ ወይም ምልክት ይተይቡ፣ አዲሱ ካርታም እዚያ ይከፈታል። የሚተይቡት ቃላት ወደ OpenStreetMap የቦታ ስም አገልግሎት ይላካሉ፣ እሱም ለመጀመሪያ ጊዜ ፍቃድዎን ይጠይቃል። ባዶ ይተውት እና ካርታው በመላው ዓለም ላይ ይከፈታል።';
$ec_lang['lpn_new_place_hint']='ፔታሉማ፣ ካሊፎርኒያ';
$ec_lang['lpn_new_create']='ፍጠር';
$ec_lang['lpn_inp_drop_rules']='ይህ ፋይል በህግ ላይ የተመሰረቱ መቆጣጠሪያዎች አሉት። እዚህ አይተገበሩም፣ ስለዚህ የሚጠቅሷቸው ቧንቧዎች፣ ፓምፖችና ቫልቮች በፋይሉ ውስጥ በተጻፈው ሁኔታ ይቆያሉ። ህጎቹ ራሳቸው ይያዛሉ፣ የEPANET ፋይል ካስቀመጡም ይመለሳሉ።';
$ec_lang['lpn_inp_drop_energy']='ይህ የEPANET ፋይል የፓምፕ ወጪ ስሌት መረጃ ይይዛል። ይህ ገጽ ኃይል ወይም ወጪ ስለማያሰላ፣ እነዚያ ቁጥሮች እዚህ ጥቅም ላይ አይውሉም። ይያዛሉ፣ የEPANET ፋይል ካስቀመጡም ይመለሳሉ።';
$ec_lang['lpn_inp_drop_tags']='ይህ ፋይል ለአንዳንድ መገናኛዎቹ፣ ቧንቧዎቹ ወይም ሌሎች አካሎቹ መለያ ስም (tag) ይሰጣል። እስካሁን በዚህ ገጽ ላይ መለያ ስም ለማየት ወይም ለመቀየር ቦታ የለም። መለያ ስሞቹ ይያዛሉ፣ የEPANET ፋይል ካስቀመጡም ይመለሳሉ።';
$ec_lang['lpn_inp_drop_report']='ይህ ፋይል EPANET ለራሱ ለሚያትማቸው ሪፖርቶች የራሱ ቅንብሮች ይይዛል። ይህ ገጽ ውጤቶቹን በራሱ መንገድ ስለሚያሳይ፣ እነሱ እዚህ ጥቅም ላይ አይውሉም። ይያዛሉ፣ የEPANET ፋይል ካስቀመጡም ይመለሳሉ።';
$ec_lang['lpn_inp_drop_sections']='ይህ ፋይል ይህ ገጽ በጭራሽ የማያነበው ክፍል ይይዛል። እዚህ ጥቅም ላይ አይውልም። ሙሉ በሙሉ ይያዛል፣ የEPANET ፋይል ካስቀመጡም ይመለሳል።';
$ec_lang['lpn_inp_drop_quality_options']='ይህ ፋይል የEPANET የውሃ ጥራት አማራጮችን ይገልጻል፦ የውሃ ጥራት ትንተናውን ዓይነት የሚሰይመው Quality፣ እና ከኬሚካል ጋር የሚሄዱ ሁለት ቅንብሮች፣ አንጻራዊ ስርጭትና የጥራት ልዩነት ገደብ። የውሃ እድሜና የምንጭ ፍለጋ እዚህ ይሰላሉ፤ ኬሚካል ግን አይሰላም፣ ስለዚህ እነዚያ ሁለት ቅንብሮች ጥቅም ላይ ሳይውሉ ይያዛሉ። ሁሉም የEPANET ፋይል ካስቀመጡ ይመለሳሉ።';
...
$ec_lang['lpn_settings_quality_track_tip']='ስራው በቧንቧዎቹ ውስጥ ምን መከታተል እንዳለበት ይምረጡ፦ ውሃው በስርዓቱ ውስጥ ምን ያህል ጊዜ እንደቆየ፣ ወይም ከየት እንደመጣ። ለሁለቱም ትኩረት ወይም ግብረ-መልስ መጠን አያስፈልግም።';
...
$ec_lang['lpn_quality_chemical']='ይህ ፋይል የሚሰይመው ኬሚካል (የተያዘ እንጂ ያልተሰላ)';
$ec_lang['lpn_quality_needs_run']='የውሃ ጥራት በጊዜ ሂደት በቧንቧዎቹ ውስጥ ስለሚጓዝ፣ የEPANET ፈታችና ጠቅላላ የመሮጫ ጊዜ ያስፈልገዋል። በጊዜ ስር ጠቅላላ የመሮጫ ጊዜ ያዘጋጁ፣ ከዚያም አሩጥ የሚለውን ይጫኑ።';
...
$ec_lang['lpn_ff_required_node_tip']='ከእሳት ደንብዎ ወይም ከእሳት ባለስልጣንዎ ለዚህ ልዩ መገናኛ የሚያገለግለውን የመሬት አጠቃቀም መሠረት የሚያስፈልገው የእሳት ፍሰት። ባዶ ይተውት እና መገናኛው በሚያስፈልግ የእሳት ፍሰት ሳጥን ውስጥ ባለው ቁጥር ይፈተናል።';
