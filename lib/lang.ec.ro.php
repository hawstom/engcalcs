...
$ec_lang['lpn_inp_drop_quality']='Acest fișier descrie cum se schimbă calitatea apei pe măsură ce călătorește: ce se află inițial în apă, unde intră mai multă din acea substanță, cum reacționează și cum se amestecă în bazine. Această pagină calculează vechimea apei și urmărirea sursei, dar nu chimia, deci nimic din asta nu este folosit aici. Acele linii sunt păstrate și sunt scrise înapoi dacă salvați un fișier EPANET.';
...
$ec_lang['lpn_tip_select']='Folosiți acest mod pentru a modifica, muta și trage elemente pe hartă. Pagina revine singură la acest mod după unele acțiuni, cum ar fi deschiderea unui proiect.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Ascunde etichetele nodurilor și ale legăturilor astfel încât rămân pe hartă doar culorile. Textul plasat de dvs. rămâne. Alegerile dvs. de etichete sunt păstrate, iar dezactivarea acestei opțiuni le readuce.';
...
$ec_lang['lpn_geomap']='coordonate lat/lon';
$ec_lang['lpn_xymap']='xy';
$ec_lang['lpn_file_import_geo']='Deschide un fișier xy pe hartă…';
$ec_lang['lpn_file_import_geo_tip']='Deschide un fișier de proiect sau un fișier EPANET într-un nou tab de proiect pe această pagină, pe harta stradală. Plasați desenul pe glob manual: deplasați și măriți spre amplasament, apoi dimensionați-l și rotiți-l pentru a se potrivi. Dacă x și y din fișier sunt deja o longitudine și o latitudine, apăsați butonul Acestea sunt deja lat/lon și rețeaua sare direct unde îi este locul. Fiecare număr pe care l-ați introdus rămâne așa cum este.';
...
$ec_lang['lpn_clean_map_tip']='Ia de pe hartă bara de stare și indicatorul de coordonate, astfel încât o captură de ecran să arate doar desenul. Desenul dvs. nu este atins, iar această alegere nu este salvată; reîncărcarea paginii readuce indicatoarele.';
...
$ec_lang['lpn_time_no_engine']='Rezolvitorul intern calculează un singur moment o dată, deci aceasta este rețeaua doar la {time}: fiecare model este citit la acel moment, iar fiecare bazin rămâne încă la nivelul lui de pornire, în loc să se umple și să se golească. Conectați-vă la internet o dată pentru a obține rezolvitorul EPANET, care calculează întreaga perioadă.';
$ec_lang['lpn_time_slider']='Timp';
$ec_lang['lpn_time_no_period']='Acest proiect nu are o perioadă de timp, deci există un singur moment de arătat. Stabiliți o Durată totală de rulare în Setări pentru a calcula rețeaua în timp.';
...
$ec_lang['lpn_time_run_note']='Vedeți rețeaua la primul timp de raportare. Această rețea durează atât de mult pentru a fi calculată pe întreaga ei perioadă de timp încât rezultatele pentru timpii ulteriori nu sunt ținute la zi cât timp lucrați. Apăsați butonul Calculează pentru a le aduce la zi.';
...
$ec_lang['lpn_georef_asdegrees']='X și y din acest fișier au fost citite ca o longitudine și o latitudine, deci rețeaua este deja pe hartă și nimic nu a fost mutat. Verificați că se află în locul potrivit, apoi apăsați butonul Păstrează acest amplasament.';
...
$ec_lang['lpn_result_water_age_tip']='Cât timp a stat în rețea apa care ajunge în acest punct. Nu există o limită reglementară cu care să comparați acest număr, așa că evaluați-l în raport cu propria dvs. rețea.';
...
$ec_lang['lpn_new_coords_xy']='coordonate xy';
$ec_lang['lpn_new_coords_geo']='coordonate lat/lon';
$ec_lang['lpn_new_coords_tip']='Un proiect xy folosește coordonate care nu sunt latitudine și longitudine. Un proiect lat/lon are coordonate geografice, astfel încât o hartă stradală sau o imagine din satelit poate fi desenată în spatele lui, iar cotele nodurilor pot fi citite de pe teren. Un proiect xy poate fi convertit în lat/lon cu Fișier, Deschide un fișier xy pe hartă.';
$ec_lang['lpn_new_place']='Începe lângă acest loc';
$ec_lang['lpn_new_place_tip']='Opțional. Introduceți un oraș, o stradă sau un reper și noua hartă se deschide acolo. Cuvintele pe care le introduceți ajung la serviciul de nume de locuri al OpenStreetMap, care vă cere permisiunea prima dată. Lăsați-l gol și harta se deschide pe întreaga lume.';
$ec_lang['lpn_new_place_hint']='Sibiu, România';
$ec_lang['lpn_new_create']='Creează';
$ec_lang['lpn_inp_drop_rules']='Acest fișier are comenzi bazate pe reguli. Ele nu sunt aplicate aici, deci conductele, pompele și vanele pe care le numesc rămân în starea scrisă în fișier. Regulile în sine sunt păstrate și sunt scrise înapoi dacă salvați un fișier EPANET.';
$ec_lang['lpn_inp_drop_energy']='Acest fișier EPANET include date de modelare a costului pompării. Această pagină nu calculează energia sau costul, deci nimic aici nu folosește aceste numere. Ele sunt păstrate și sunt scrise înapoi dacă salvați un fișier EPANET.';
$ec_lang['lpn_inp_drop_tags']='Acest fișier atribuie etichete unora dintre joncțiunile, conductele sau alte elemente ale sale. Deocamdată nu există niciun loc pe această pagină pentru a vedea sau schimba o astfel de etichetă. Etichetele sunt păstrate și sunt scrise înapoi dacă salvați un fișier EPANET.';
$ec_lang['lpn_inp_drop_report']='Acest fișier conține setările proprii ale EPANET pentru rapoartele pe care le tipărește. Această pagină își arată răspunsurile în felul ei propriu, deci nimic aici nu le folosește. Ele sunt păstrate și sunt scrise înapoi dacă salvați un fișier EPANET.';
...
$ec_lang['lpn_inp_drop_quality_options']='Acest fișier stabilește opțiuni EPANET pentru calitatea apei: Quality, care numește tipul de analiză a calității apei, și două setări legate de o substanță chimică, Relative diffusivity și Quality tolerance. Vechimea apei și urmărirea sursei sunt calculate aici; o substanță chimică nu este, deci acele două setări sunt păstrate fără a fi folosite. Toate sunt scrise înapoi dacă salvați un fișier EPANET.';
...
$ec_lang['lpn_settings_quality_track_tip']='Alegeți ce trebuie să urmărească rularea prin conducte: cât timp a stat apa în sistem, sau de unde provine. Niciuna dintre ele nu are nevoie de o concentrație sau de o rată de reacție.';
...
$ec_lang['lpn_quality_chemical']='O substanță chimică numită de acest fișier (stocată, nu calculată)';
$ec_lang['lpn_quality_needs_run']='Calitatea apei este purtată de-a lungul conductelor în timp, deci are nevoie de motorul EPANET și de o durată totală de rulare. Stabiliți o Durată totală de rulare la Timp, apoi apăsați butonul Calculează.';
...
$ec_lang['lpn_ff_menu']='Debit de incendiu…';
...
$ec_lang['lpn_ff_title']='Debit de incendiu';
...
$ec_lang['lpn_ff_required_node_tip']='Debitul de incendiu necesar la această joncțiune anume, din codul dvs. de incendiu sau de la autoritatea dvs. pentru incendii, pentru utilizarea terenului pe care îl deservește. Lăsați-l gol și joncțiunea este testată față de numărul din caseta Debit de incendiu necesar.';
