...
$ec_lang['mtc_side_slope_1']='Taluz 1, z1 (orizontal/vertical)';
$ec_lang['mtc_side_slope_2']='Taluz 2, z2 (orizontal/vertical)';
$ec_lang['mtc_channel_slope']='Panta canalului, S';
$ec_lang['mtc_flow_depth']='Adâncimea de curgere, y';
$ec_lang['mtc_bend_angle']='Unghi de curbă, β <a target="_blank" href="riprap-bend-angle.png" title="Faceți clic pentru imagine">?</a> (pentru dimensionarea riprapului)';
$ec_lang['mtc_sgrock']='Greutatea specifică a rocii, SG (2,65)';
...
$ec_lang['mtc_vel_high']='Viteză ridicată - verificați pierderile la tranziții, energia disponibilă și lovitura de berbec.';
...
$ec_lang['ip_sl']='Distanța dintre ramuri laterale, S<sub>l</sub>';
$ec_lang['ip_n_e']='Emițătoare pe ramură laterală, n<sub>e</sub>';
$ec_lang['ip_n_l']='Ramuri laterale pe zonă, n<sub>l</sub>';
$ec_lang['ip_d']='Adâncimea de udare țintă, d';
$ec_lang['ip_a_e']='Suprafața per emițător, A<sub>e</sub>';
$ec_lang['ip_pr']='Rata de aplicare, PR';
$ec_lang['ip_q_lat']='Debit pe ramură laterală, Q<sub>lat</sub>';
...
$ec_lang['ip_main_title']='Calculator Online Gratuit Presiune Irigație &amp; Uniformitate Distribuție';
$ec_lang['ip_main_desc']='Estimare Presiune Ramură Test și Uniformitate';
$ec_lang['ip_h_supply']='Presiune alimentare';
$ec_lang['ip_elev_supply']='Cota alimentare, z<sub>supply<\/sub>';
$ec_lang['ip_q_design']='Debit design emițător, q<sub>design<\/sub>';
$ec_lang['ip_h_design']='Presiune design emițător';
$ec_lang['ip_x']='Exponent debit emițător, x <span title="0,5 pentru emițători standard necompensați; aproape 0 pentru emițători cu compensare presiune" class="ec-tip">?<\/span>';
$ec_lang['ip_reach_table_title']='Cale test';
...
$ec_lang['ip_is_lateral']='Lat. <span title="Bifat: acest tronson este segment al lateralului test, tras de emițători individuali. Nebifat: acest tronson este principal, doar transmițând debit către laterale care nu sunt pe calea test." class="ec-tip">?<\/span>';
$ec_lang['ip_count']='Emițători <span title="Rânduri laterale: emițători numai în acest tronson. Rânduri principale: total emițători pe laterale ALTELE decât aceasta care se ramifică din acest tronson. Pentru tronsoanele chiar la prelevarea proprie a lateralului test, aceasta include și oricare laterale dincolo de acel punct de-a lungul principalului, sau care împart același junction (de ex. o laterală de parte opusă) &mdash; fluxul lor se ramifică din acest tronson la fel." class="ec-tip">?<\/span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_e']='e <span title="Înălțime rugozitate Darcy-Weisbach" class="ec-tip">?<\/span>';
$ec_lang['ip_km']='K<sub>m<\/sub> <span title="Coeficient generic de pierdere minoră pentru fitinguri/valve/cuplaje ale acestui tronson (&ge;0,5 minim sugerat)" class="ec-tip">?<\/span>';
$ec_lang['ip_elev_ds']='Cota Aval <span title="Cota capătului aval al acestui tronson. Opțional pe rânduri interioare (implicit plat / la fel ca nodul deasupra dacă se lasă gol). Necesar pe rândul final: acea valoare este cota ultimului emițător, care stabilește direct presiunea de alimentare necesară." class="ec-tip">?<\/span>';
$ec_lang['ip_elev_ds_missing_warn']='Cota ultimului emițător (rândul final) a fost lăsată goală și s-a setat implicit la plat &mdash; introduceți-o pentru rezultat exact ⚠';
...
$ec_lang['ip_hl']='H<sub>l<\/sub> <span title="Pierdere totală tronson, H_f + H_m" class="ec-tip">?<\/span>';
$ec_lang['ip_pressure_warn']='Presiune scăzută/negativă &mdash; verificați condițiile subatmosferice';
$ec_lang['ip_pressure_warn_short']='Scăzută ⚠';
$ec_lang['ip_h_far']='Presiunea ultimului emițător';
$ec_lang['ip_q_supply']='Debit alimentare cale test, Q<sub>supply<\/sub> <span title="Debit care intră în calea test modelată doar, nu în toată zona/sistemul — vezi Q_zone în Proiectare Aplicație mai jos pentru totalul pe întreg sistemul." class="ec-tip">?<\/span>';
$ec_lang['ip_q_critical']='Debitul ultimului emițător, q<sub>last<\/sub>';
$ec_lang['ip_q_avg_lateral']='Debit emițător mediu (lateralul test), q<sub>avg<\/sub>';
$ec_lang['ip_dp_avg']='Est. &Delta;presiune, med. vs. lateralul test <span title="Cât de mult mai mare (sau mai mic) credeți că funcționează un lateralul tipic/mediu în comparație cu acest lateralul test. Lateralul test este deliberat presupus cel mai rău caz, deci media sa proprie este un înlocuitor defavorabil pentru o medie de teren &mdash; lăsat la 0, verificarea uniformității și numerele proiectării aplicației mai jos folosesc media proprie a lateralului test (probabil optimistă) ca atare." class="ec-tip">?<\/span>';
$ec_lang['ip_q_avg_field']='Est. debit mediu emițător teren, q<sub>avg,field<\/sub> <span title="q_avg_lateral reevaluat la presiunea fiecărui rând lateral plus diferența de presiune introdusă mai sus &mdash; o încercare să se corecteze faptul că lateralul test este presupus cazul cel mai rău, nu unul reprezentativ. Alimentează atât verificarea uniformității, cât și secțiunea proiectării aplicației mai jos." class="ec-tip">?<\/span>';
$ec_lang['ip_du_estimate']='Verificare uniformitate, q<sub>last<\/sub>/q<sub>avg,field<\/sub> <span title="Debitul calculat al ultimului emițător împărțit la debitul mediu estimat al emițătorului teren &mdash; aceeași formă ca Uniformitatea Distribuției de cartă de referință cu sfert-jos (medie grup-scăzut ÷ medie populație), dar din eșantion modelat mic și corecție estimată de utilizator, nu eșantion statistic complet teren. Valorile la sau deasupra 1 sunt posibile și nu sunt defecte: doar înseamnă că ultimul emițător nu este punctul scăzut relativ la media estimată teren (de ex. alergare favorabilă în jos, sau estimarea &Delta;presiune mai sus este prea mică)." class="ec-tip">?<\/span>';
$ec_lang['ip_worst_case_warn']='Presiunea emițătorului test este la sau deasupra presiunii de alimentare &mdash; această cale nu este probabil lateralul dvs. de cel mai rău caz. Verificați o laterală mai îndepărtată sau cu frecare mai mare, sau un profil de elevație care reprezentă mai bine cel mai rău caz real.';
$ec_lang['ip_q_ratio']='Debitul ultimului emițător vs. debitul design, q<sub>last<\/sub>/q<sub>design<\/sub> <span title="O verificare separată, nu o cifră uniformitate: cât de departe funcționează ultimul emițător de debitul design nominalizat al fabricantului. Deasupra 1: funcționând deasupra punctului design (de ex. din câștig elevație favorabil în jos). Sub 1: funcționând sub design (caz tipic dominat de frecare)." class="ec-tip">?<\/span>';
$ec_lang['ip_no_solution']='Fără soluție: presiunea de alimentare necesară depășește presiunea de alimentare introdusă. Măriți presiunea de alimentare, reduceți cererea, sau folosiți o conductă mai mare.';
$ec_lang['ip_notes_1_term']='Metodă';
$ec_lang['ip_notes_1_def']='Ghicește presiunea la ultimul (cel mai îndepărtat) emițător, apoi merge Linia Gradului Energetic înapoi către alimentare, tronson după tronson, adăugând fricțiune și pierderi minore pe parcurs. Elevația și sarcina vitezei sunt scoase la iveală la fiecare nod pentru a raporta presiunea reală acolo. Presiunea capătului îndepărtat ghicit este ajustată (bisecție) până când presiunea de alimentare calculată necesară se potrivește cu presiunea de alimentare introdusă &mdash; aceeași problemă în buclă închisă abordată de rezolvatorul curgerii conductei pe calculatorul Manning Pipe Flow, extins la o rețea de ramificație.';
$ec_lang['ip_notes_2_term']='Tronsoane Principale vs. Laterale';
$ec_lang['ip_notes_2_def']='Fiecare rând este un tronson de-a lungul căii hidraulic cel mai rău (calea test) de la alimentare la ultimul emițător. Un tronson Principal transmite doar flux către laterale care nu sunt pe calea test, deci extracția sa este multiplicare plată (debit design &times; numărarea emițătorului total al tronsoanelor) &mdash; fără sensibilitate presiune locală. Principalul este o conductă trunchi partajată, deci tronsoanele chiar la prelevarea proprie a lateralului test trebuie să includă nu doar laterale între propriile sale capete, ci și orice laterale încă mai departe de-a lungul principalului dincolo de această prelevare, sau care împarte același junction (de ex. o laterală de parte opusă) &mdash; fluxul lor se ramifică de la acest tronson înainte de a se despărți, indiferent dacă apar oriunde altundeva în tabel. Un tronson Lateral este segment al lateralului test propriu: descărcare emițător se calculează din presiune locală reală via q = k·H<sup>x<\/sup>, și pierdere frecare este redusă cu factorul F(n) al lui Christiansen pentru a ține cont de flux care coboară pe măsură ce fiecare emițător din tronson trage.';
$ec_lang['ip_notes_3_term']='Limitări';
$ec_lang['ip_notes_3_def']='Modelează o presiune de intrare fixă (fără curbă pompă), o cale test doar (nu terenul complet), și o curbă emițător cu 2 parametri (setați exponentul aproape de 0 pentru a aproxima un emițător cu compensare presiune). Două rapoarte diferite sunt raportate, deliberat ținute separate: q<sub>last<\/sub>/q<sub>avg,field<\/sub> este verificare uniformitate, conformă cu Uniformitate Distribuție sfert-jos din manual (medie grup-scăzut ÷ medie populație) dar calculată din emițători modelați proprii ai lateralului test, corectată de estimare &Delta;presiune introdusă mai degrabă decât eșantion statistic complet teren &mdash; lateralul test este deliberat presupus cel mai rău caz, deci media brută necorectat ar subestime media terenului adevărat și ar face uniformitate să pară mai bună decât este; intrarea &Delta;presiune există special pentru a contracara acea prejudecată. Valorile la sau deasupra 1 sunt încă posibile (de ex. estimare &Delta;presiune prea mică, sau alergare favorabilă în jos). q<sub>last<\/sub>/q<sub>design<\/sub> este o verificare diferită non-uniformitate împotriva debitului nominalizat al fabricantului &mdash; util pentru detectarea unui sistem supra sau sub-presionat în general, dar nu înlocuitor pentru numărul uniformitate, deoarece debit design/nominalizat nu are relație necesară cu presiunea medie de funcționare reală a sistemului.';
$ec_lang['ip_notes_4_term']='Referință';
$ec_lang['ip_notes_4_def']='Christiansen, J.E. (1942). &ldquo;Irigație prin aspersiune.&rdquo; Buletin 670 al Stației de Experiment Agricol California. Standardele ASAE/ASABE pentru proiectare microirigație folosesc aceeași abordare pierdere frecare multi-ieșire.';
$ec_lang['ip_notes_5_term']='Proiectare Aplicație';
$ec_lang['ip_notes_5_def']='Rata de aplicare și debit sistem/zonă folosesc debitul emițător mediu estimat teren (q<sub>avg,field<\/sub> &mdash; media proprie a lateralului test, corectată de estimare &Delta;presiune introdusă), nu o rată ghicită: PR = q<sub>avg,field<\/sub> / A<sub>e<\/sub>, alimentată de valoarea modelată corectată. Distanța și numărări laterale/emițătoare pe întreg sistemul sunt intrări separate aici deoarece calea test modelează doar o ramură cel mai rău caz, nu fiecare laterală din teren.';
