...
$ec_lang['ip_x']='Exponentul de debit al emițătorului, x <span title="0,5 pentru emițători standard necompensați; aproape de 0 pentru emițători cu compensare de presiune" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='Lat. <span title="Bifat: acest tronson este un segment al lateralului test, din care emițătorii individuali preiau apă. Nebifat: acest tronson este o conductă principală, transmițând doar debit către laterale care nu sunt pe calea test." class="ec-tip">?</span>';
$ec_lang['ip_count']='Emițători <span title="Rânduri laterale: emițători doar în acest tronson. Rânduri principale: total emițători pe laterale ALTELE decât acesta, care se ramifică din acest tronson. Pentru tronsonul liniei principale care se termină la linia lateralului test, aceasta include și orice laterale dincolo de acel punct de-a lungul principalului, sau care împart aceeași joncțiune (de ex. un lateral de partea opusă) &mdash; debitul lor se ramifică tot din acest tronson." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_e']='e <span title="Înălțime rugozitate Darcy-Weisbach" class="ec-tip">?</span>';
$ec_lang['ip_km']='k<sub>m</sub> <span title="Coeficient generic de pierdere locală pentru fitingurile/valvele/cuplajele acestui tronson (&ge;0,5 minim sugerat)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='Cota Aval <span title="Cota capătului aval al acestui tronson. Opțional pe rândurile interioare (implicit plat / la fel ca nodul de deasupra dacă se lasă gol). Necesară pe rândul final: acea valoare este cota ultimului emițător, care stabilește direct presiunea de alimentare necesară." class="ec-tip">?</span>';
...
$ec_lang['ip_hl']='h<sub>L</sub> <span title="Pierderea totală a tronsonului, h_f + h_m" class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='Debitul de alimentare al căii test, Q<sub>supply</sub> <span title="Debitul care intră doar în calea test modelată &mdash; pentru întreaga zonă/sistem, vezi Q_zone în Proiectarea Aplicației de mai jos." class="ec-tip">?</span>';
...
$ec_lang['ip_q_ratio']='Debitul ultimului emițător ÷ debitul de proiectare, q<sub>last</sub>/q<sub>design</sub> <span title="Aceasta este diferită de aproximarea noastră a măsurii standard de uniformitate." class="ec-tip">?</span>';
...
$ec_lang['ip_notes_4_def']='Christiansen, J.E. (1942). &ldquo;Irigație prin aspersiune.&rdquo; Buletin 670 al Stației de Experiment Agricol California. Standardele ASAE/ASABE pentru proiectarea microirigației folosesc aceeași abordare a pierderii prin frecare cu ieșiri multiple.';
