...
$ec_lang['lpn_main_title']='Calculator online gratuit pentru rețele de distribuție a apei, cu motorul EPANET';
...
$ec_lang['lpn_new_from_examples']='Din exemple';
...
$ec_lang['lpn_new_example_us']='Rețea de bază, unități US (gpm)';
$ec_lang['lpn_new_example_si']='Rețea de bază, unități SI (l/s)';
...
$ec_lang['lpn_inp_drop_tanks']='Bazinele de acumulare au fost omise. Această pagină are rezervoare, care mențin un nivel fix al apei. Un bazin de acumulare nu menține un nivel fix, deci nu este un rezervor.';
$ec_lang['lpn_inp_drop_tank_links']='Aceste conducte au fost omise deoarece se conectează la un bazin de acumulare care a fost omis.';
...
$ec_lang['lpn_inp_drop_units']='Unitățile de debit din acest fișier nu au fost recunoscute, deci s-au presupus galoane pe minut. Verificați fiecare număr înainte de a folosi rezultatele.';
...
$ec_lang['lpn_backdrop_position_prompt1']='Faceți clic pe orice punct de pe imaginea de fundal. Acesta este punctul pe care îl veți muta.';
$ec_lang['lpn_backdrop_position_prompt2']='Alegeți unde ar trebui să ajungă acel punct, apoi faceți clic pe Continuare.';
...
$ec_lang['lpn_settings_engine_epanet']='Rezolvă cu motorul EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='Rulează motorul EPANET original de la US EPA, chiar aici, în browserul dvs. Rezolvitorul integrat oferă aceleași rezultate și este mai rapid, deci lăsați această opțiune dezactivată, cu excepția cazului în care aveți nevoie chiar de EPANET.';
$ec_lang['lpn_engine_loading']='Se încarcă motorul EPANET…';
$ec_lang['lpn_engine_failed']='Motorul EPANET nu a putut fi încărcat. Se afișează în schimb rezolvitorul integrat.';
...
$ec_lang['lpn_settings_symbol_size']='Dimensiune simbol (relativ la text)';
