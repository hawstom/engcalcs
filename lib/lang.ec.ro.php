...
$ec_lang['or_diameter']='Diametru sau înălțime, D <span title="Diametru pentru circular; înălțime pentru dreptunghiular" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['or_width']='Lățime, W <span title="Numai deschideri dreptunghiulare" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['or_invert']='Cotă radier <span title="Fundul deschiderii" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_h1_elev']='NWS inițial <span title="Cota inițială a suprafeței apei" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_a_ending']='Aria finală, A<sub>2</sub> <span title="Interpolată din modelul conic la cota finală" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_d']='D orificiu <span title="Diametru (circular) sau înălțime (dreptunghiular)" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['odt_w']='Lățimea orificiului, W <span title="Numai dreptunghiular" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['dw_kinematic_viscosity']='Vâscozitate cinematică, ν <span title="1×10⁻⁶ m²/s for clean water at 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_km']='Coeficient de pierderi locale, k<sub>m</sub> <span title="Suma coeficienților de pierdere la racorduri și armături de-a lungul conductei sub presiune" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['ds_main_desc']='Irigare prin picurare & aspersiune — rata de aplicare și uniformitate';
...
$ec_lang['ds_notes_3_def']='Timp de funcționare = adâncime țintă ÷ rată de aplicare. Pe sol înclinat sau compactat, împărțiți timpul de funcționare în două sau trei cicluri mai scurte cu pauze între ele pentru a evita scurgerea superficială.';
