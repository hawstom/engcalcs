...
$ec_lang['mhp_length']='Lungimea, L <span title="Lungimea conductei de aducțiune sau a jgheabului de la lucrările de captare" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_warn']='depășește ținta de 10%';
$ec_lang['mhp_hl_warn_tip']='Luați în calcul o conductă mai mare';
$ec_lang['mhp_hl_bad']='depășește 20%';
$ec_lang['mhp_hl_bad_tip']='Redimensionați conducta';
...
$ec_lang['mhp_notes_4_def']='Aceste pierderi apar la joncțiunile conductei, la intrare, la coturi și la vane — termenul „minore” este convențional, dar înșelător; într-o conductă sub presiune scurtă, ele pot fi egale cu sau pot depăși pierderile prin frecare. Valori tipice: intrare cu margine ascuțită 0,5, fiecare cot de 45° 0,2–0,3, robinet cu sertar (complet deschis) 0,1, robinet fluture 0,2. Suma tuturor fitingurilor dă k<sub>m</sub> total. Valoarea implicită 1,5 presupune o intrare și două coturi.';
$ec_lang['mhp_notes_5_term']='Rugozitatea conductei e';
$ec_lang['mhp_notes_5_def']='Rugozitate absolută tipică: oțel (nou) 0,046 mm, oțel (uzat) 0,15 mm, HDPE 0,003 mm, PVC/uPVC 0,0015 mm, beton 0,3–3 mm. HDPE este frecvent utilizat pentru conductele sub presiune de mici dimensiuni din sistemele micro-hidro.';
...
$ec_lang['rc_sg']='Densitatea relativă a rocii, sg <span title="Granit sau bazalt concasat tipic ≈ 2,65. Interval valid Robinson: 2,54–2,82." style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_apron_length']='Lungimea radierului de ieșire (15 × D<sub>50</sub>) <span title="Necesară pentru susținerea structurală a pietrei canalului rapid. &quot;Nivelul minim de apă din aval, rezultat din tronsonul de ieșire și din rezistența canalului din aval, este suficient pentru a asigura stabilitatea pietrei de protecție în tronsonul de ieșire.&quot; (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
