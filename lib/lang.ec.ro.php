...
$ec_lang['mhp_efficiency']='Randamentul centralei, &eta; (0&ndash;1)';
...
$ec_lang['mhp_notes_1_def']='Pierderea totală h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, unde h<sub>f</sub> = f(L/D)(v&sup2;/2g) este pierderea prin frecare Darcy-Weisbach, iar h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g acoperă intrarea, coturi și armături. Sarcina netă H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Viteză';
$ec_lang['mhp_notes_2_def']='Țintă 1&ndash;3 m/s. Sub 1 m/s conducta este supradimensionată; peste 3 m/s cresc pierderile prin frecare și riscul de lovitură de berbec.';
$ec_lang['mhp_notes_3_term']='Ținta pierderilor de sarcină';
$ec_lang['mhp_notes_3_def']='Pierderile în conducta forțată sub 10% din sarcina brută sunt în general economice. Compromisul optim între costul conductei și puterea pierdută se situează adesea în jurul a 4&ndash;6% pentru siturile cu electricitate de mare valoare.';
$ec_lang['mhp_notes_4_term']='Pierderi locale k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Valori tipice: intrare cu margine ascuțită 0.5, fiecare cot de 45&deg; între 0.2&ndash;0.3, robinet cu sertar (complet deschis) 0.1, robinet fluture 0.2. Suma tuturor fitingurilor dă k<sub>m</sub> total. Valoarea implicită 1.5 presupune o intrare și două coturi.';
$ec_lang['mhp_notes_5_term']='Rugozitatea conductei e';
$ec_lang['mhp_notes_5_def']='Rugozitate absolută tipică: oțel (nou) 0.046&nbsp;mm, oțel (uzat) 0.15&nbsp;mm, HDPE 0.003&nbsp;mm, PVC/uPVC 0.0015&nbsp;mm, beton 0.3&ndash;3&nbsp;mm. HDPE este des utilizat la conductele forțate micro-hidro de mici dimensiuni.';
