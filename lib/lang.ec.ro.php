...
$ec_lang['lpn_field_text_match_pipe']='Aliniere cu legătura cea mai apropiată';
...
$ec_lang['lpn_time_format_tip']='Scrieți o oră ca ore și minute, de exemplu 2:30. Un număr simplu înseamnă ore; un număr cu propriul cuvânt înseamnă acel cuvânt: 30 minute.';
$ec_lang['lpn_time_running']='Se calculează întreaga perioadă de timp cu motorul EPANET.';
$ec_lang['lpn_time_no_engine']='Rezolvitorul intern calculează un singur moment o dată, deci aceasta este rețeaua doar la {time}: cerințele au multiplicatorii modelului pentru acel moment, iar fiecare bazin rămâne încă la nivelul de start, în loc să se umple și să se golească. Conectați-vă o dată la internet pentru a prelua motorul EPANET, care rulează întreaga perioadă.';
