...
$ec_lang['lpn_field_text_match_pipe']='Alinhar com o ângulo do tubo';
...
$ec_lang['lpn_examples_size']='{nodes} junções, {links} tubos';
...
$ec_lang['lpn_ex_net3_desc']='O grande exemplo do EPANET: 97 junções, dois tanques e uma fonte de rio. Vale a pena abrir para ver como fica no mapa um modelo de tamanho real.';
...
$ec_lang['lpn_new_blank_us']='Projeto em branco, unidades US (gpm)';
$ec_lang['lpn_new_blank_si']='Projeto em branco, unidades SI (l/s)';
...
$ec_lang['lpn_inp_drop_controls']='Controles e regras foram deixados de fora. Cada tubulação, bomba e válvula entrou no estado escrito no arquivo, e não muda.';
$ec_lang['lpn_inp_drop_eps']='Este arquivo descreve uma simulação que é executada ao longo de um período de tempo. Esta página resolve um único instante, então apenas as condições iniciais foram importadas.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Executa o solucionador do EPANET da EPA dos EUA, aqui no seu navegador. Os dois solucionadores dão as mesmas respostas, e numa rede deste tamanho você não notará diferença de velocidade. Na primeira vez que você ativar isto, cerca de 650 KB serão baixados e depois mantidos neste dispositivo.';
...
$ec_lang['lpn_unit_unknown']='Este desenho declara uma unidade que esta página não oferece: {unit}. Tudo é mantido e exibido exatamente como veio, e nada foi alterado. Nenhum resultado pode ser dado até que esta página conheça essa unidade, porque não há como saber o seu tamanho.';
...
$ec_lang['lpn_settings_readability_bias']='Graus à esquerda da vertical antes de um rótulo ser virado';
