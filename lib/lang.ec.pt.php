...
$ec_lang['mhp_length']='Comprimento, L <span title="Comprimento da tubagem ou canal de adução na entrada (obras de captação)" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_warn']='supera o objetivo de 10%';
$ec_lang['mhp_hl_warn_tip']='Considerar tubagem de maior diâmetro';
$ec_lang['mhp_hl_bad']='supera 20%';
$ec_lang['mhp_hl_bad_tip']='Redimensionar a tubagem';
...
$ec_lang['mhp_notes_2_def']='Verifique se a velocidade é razoável para o desnível disponível e o custo da tubagem. Velocidade muito baixa pode indicar tubagem sobredimensionada; velocidade muito alta pode aumentar as perdas por atrito e o risco de golpe de aríete.';
...
$ec_lang['mhp_notes_4_term']='Perdas Menores (Localizadas), k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Essas perdas ocorrem em junções de tubulação, entradas, curvas e válvulas — o termo "menores" é convencional mas enganoso; numa conduta forçada curta, podem igualar ou superar as perdas por atrito. Valores típicos de k: entrada com aresta viva 0,5, cada curva a 45° 0,2–0,3, válvula de gaveta (totalmente aberta) 0,1, válvula borboleta 0,2. Somar todos os acessórios para obter o k<sub>m</sub> total. O valor por defeito 1,5 assume uma entrada e duas curvas.';
...
$ec_lang['rc_apron_length']='Comprimento da laje de saída (15 × D<sub>50</sub>) <span title="Necessário para suporte estrutural da rocha da calha. &quot;O tirante mínimo a jusante resultante do trecho de saída e da resistência do canal a jusante é suficiente para garantir a estabilidade do enrocamento no trecho de saída.&quot; (Robinson)" class="ec-tip">?</span>';
