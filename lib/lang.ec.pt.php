...
$ec_lang['lpn_georef_projected']='Este projeto já indica uma projeção de mapa, então suas coordenadas não podem ser posicionadas no mapa uma segunda vez.';
...
$ec_lang['lpn_new_coordsys_geo']='Projeção geográfica';
$ec_lang['lpn_new_coordsys_geo_tip']='Selecione uma projeção geográfica. Use WGS 84 / Pseudo-Mercator EPSG:3857 para Lat/Lon.';
