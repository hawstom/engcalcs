...
$ec_lang['dw_kinematic_viscosity']='Viscosidade cinemática, ν <span title="1×10⁻⁶ m²/s for clean water at 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_nu']='Viscosidade cinemática, ν <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_vel_high']='Velocidade elevada — risco de golpe de aríete e perdas menores em pontos altos.';
...
$ec_lang['ds_main_desc']='Irrigação por gotejamento e aspersão — taxa de aplicação e uniformidade';
...
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>, onde A<sub>e</sub> = S<sub>e</sub> × S<sub>l</sub> é a área atendida por cada emissor. Uma taxa de aplicação menor dá mais tempo para infiltração — importante em solos pesados ou campos inclinados.';
...
$ec_lang['ds_notes_3_def']='Tempo de funcionamento = lâmina desejada ÷ taxa de aplicação. Em solo com declividade ou compactado, divida o tempo em dois ou três ciclos mais curtos com intervalos entre eles para evitar escoamento superficial.';
...
$ec_lang['cs_Ec_target']='Objetivo de revestimento, E<sub>c,target</sub> <span title="Conveyance efficiency goal after lining; fraction 0–1" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['cs_payback_years']='Período de retorno <span title="Simple payback = total lining cost ÷ annual value recovered" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mtc_vel_high']='Velocidade elevada — verificar perdas de transição e energia disponível.';
