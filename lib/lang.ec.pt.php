...
$ec_lang['ds_main_desc']='Irrigação por gotejamento e aspersão — taxa de aplicação';
$ec_lang['ds_q_avg']='Vazão do emissor, q';
...
$ec_lang['ds_notes_2_term']='Tempo de funcionamento';
$ec_lang['ds_notes_2_def']='Tempo de funcionamento = lâmina desejada ÷ taxa de aplicação. Em solo com declividade ou compactado, divida o tempo em dois ou três ciclos mais curtos com intervalos entre eles para evitar escoamento superficial.';
