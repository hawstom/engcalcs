...
$ec_lang['lpn_basemap_satellite_hide']='Ocultar imagens de satélite';
$ec_lang['lpn_basemap_satellite_tip']='Fotografias do terreno vindas do Mapbox, buscadas pela internet à medida que você desloca e amplia o mapa. Útil para ver por onde uma tubulação realmente passa. Sua rede é desenhada quer as imagens estejam aparecendo ou não.';
$ec_lang['lpn_georef_asdeg_btn']='Estes já são lat/lon';
$ec_lang['lpn_georef_asdeg_tip']='Pressione isto somente se o x e o y deste arquivo realmente forem uma longitude e uma latitude. A rede então salta para onde esses números dizem que ela está, e nada precisa ser posicionado. De qualquer forma, cada número permanece exatamente como está.';
$ec_lang['lpn_georef_asdegrees']='O x e o y deste arquivo foram lidos como uma longitude e uma latitude, então a rede já está no mapa e nada foi movido. Verifique se ela está no lugar certo e depois pressione Manter este posicionamento.';
...
$ec_lang['lpn_menu_project']='Projeto';
...
$ec_lang['lpn_run_menu_tip']='Recalcula esta rede agora. Está procurando um botão Executar? Enquanto este projeto recalcula depois de cada mudança, a barra de ferramentas não tem um botão Executar. Desligue "Recalcular automaticamente" em Configurações, em Cálculo, Hidráulica, e o botão volta.';
...
$ec_lang['lpn_replace_button']='Substituir';
...
$ec_lang['lpn_profile_draw']='Escolha o caminho no mapa';
$ec_lang['lpn_profile_draw_stop']='Parar de escolher';
...
$ec_lang['lpn_inp_drop_head_pattern']='Estes reservatórios sobem e descem ao longo do dia. Seus padrões vieram completos, e o nível de água que você vê é o do momento que o relógio está mostrando.';
$ec_lang['lpn_inp_drop_pump_speed']='Estas bombas funcionam em uma velocidade diferente daquela em que sua curva foi medida, ou mudam de velocidade ao longo do dia. A velocidade e seu padrão vieram completos, e a carga que você vê é a do momento que o relógio está mostrando.';
...
$ec_lang['lpn_import_notes_heading']='Do arquivo EPANET';
...
$ec_lang['lpn_notes_color_def']='Os limites das faixas de cor são definidos quando você escolhe um método de classificação dos dados. Eles não são redefinidos a cada horário, porque isso faria as cores significarem algo novo a cada instante, o que não ajuda a visualizar o seu sistema. O EPANET funciona da mesma forma. Para obter novos limites, escolha um método novamente ou digite os seus.';
...
$ec_lang['lpn_time_run_report_tip']='O que o próprio solucionador EPANET imprimiu sobre a última execução: como ele convergiu, e o que ele avisou. É o texto do próprio solucionador, não o nosso.';
...
$ec_lang['lpn_library_curves_tip']='Uma curva é o conjunto de pontos que diz como uma bomba se comporta: quanta carga ela produz em cada vazão.';
$ec_lang['lpn_library_curves_note']='Uma curva pertence à bomba ou à válvula que a usa, então este é o conjunto inteiro reunido para leitura. Clique em um ID para ir até aquele elemento e alterar seus pontos ali. Para uma bomba, a linha desenhada é a curva que a execução usa, ajustada pelos pontos; para uma válvula, são degraus retos entre eles.';
...
$ec_lang['lpn_library_default_pattern']='Padrão de demanda predefinido';
$ec_lang['lpn_library_default_pattern_tip']='Toda junção sem padrão usa este aqui.';
...
$ec_lang['lpn_field_demand_pattern_tip']='Como a demanda desta junção sobe e desce ao longo da execução. Deixe em Nenhum padrão para seguir o padrão próprio do projeto, seja ele qual for.';
...
$ec_lang['lpn_field_speed_pattern_tip']='Como a velocidade desta bomba sobe e desce ao longo da execução. Cada multiplicador É a velocidade relativa para aquela parte do dia, e toma o lugar da velocidade acima, então um multiplicador de 0 para a bomba.';
...
$ec_lang['lpn_terrain_menu']='Preencher elevações a partir do terreno…';
$ec_lang['lpn_terrain_tip']='Lê a elevação do terreno sob cada nó que não tem uma, e a digita para você. Um nó que já tem uma elevação é deixado como está, e um único Desfazer traz tudo de volta. O primeiro uso pede a sua permissão, porque as posições dos seus nós vão para o Mapbox.';
$ec_lang['lpn_terrain_accuracy']='Os dados de terreno têm cerca de 30 m sobre o solo e costumam ter um erro de vários metros na vertical. Trate-os como um mapa de curvas de nível, não como um levantamento: verifique tudo aquilo em que você confia.';
...
$ec_lang['lpn_terrain_confirm']='Preencher a elevação de {n} nó(s) a partir da superfície do terreno?';
...
$ec_lang['lpn_terrain_confirm_default_2']='Substituir esses {n} pela superfície do terreno?';
...
$ec_lang['lpn_terrain_none_needed']='Todo nó já tem uma elevação definida por você. Nada foi alterado, e nada foi enviado — nunca sobrescrevemos uma elevação que já está lá.';
$ec_lang['lpn_terrain_no_nodes']='Ainda não há nós para preencher.';
