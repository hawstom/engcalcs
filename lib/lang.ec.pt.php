...
$ec_lang['bpn_line_problem']='Verifique a coluna ID montante: um trecho aponta para um ID desconhecido, faz referência a si mesmo, ou forma uma malha (loop), de modo que parte da rede não está conectada à fonte. Esses trechos ficam sem solução.';
$ec_lang['bpn_bad_id_short']='Rede';
