...
$ec_lang['consent_decline']='Recusar';
...
$ec_lang['lpn_main_title']='Calculadora Gratuita Online de Rede de Distribuição de Água com o Motor EPANET';
...
$ec_lang['lpn_new_from_examples']='A partir de exemplos';
...
$ec_lang['lpn_new_example_us']='Rede básica, unidades US (gpm)';
$ec_lang['lpn_new_example_si']='Rede básica, unidades SI (l/s)';
...
$ec_lang['lpn_inp_drop_tanks']='Os tanques de armazenamento foram deixados de fora. Esta página tem reservatórios, que mantêm um nível de água fixo. Um tanque de armazenamento não mantém um nível fixo, então não é um reservatório.';
$ec_lang['lpn_inp_drop_tank_links']='Estas tubulações foram deixadas de fora porque se conectam a um tanque que foi deixado de fora.';
...
$ec_lang['lpn_inp_drop_units']='As unidades de vazão deste arquivo não foram reconhecidas, então foram consideradas galões por minuto. Verifique cada número antes de usar os resultados.';
...
$ec_lang['lpn_backdrop_scale']='Definir escala da imagem';
$ec_lang['lpn_backdrop_position']='Mover imagem';
...
$ec_lang['lpn_settings_engine_epanet']='Resolver com o mecanismo do EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='Executa o mecanismo original do EPANET da EPA dos EUA, aqui no seu navegador. O solucionador integrado dá as mesmas respostas e é mais rápido, então deixe isto desativado a menos que você precise do próprio EPANET.';
$ec_lang['lpn_engine_loading']='Carregando o mecanismo do EPANET…';
$ec_lang['lpn_engine_failed']='Não foi possível carregar o mecanismo do EPANET. Mostrando o solucionador integrado em vez disso.';
...
$ec_lang['lpn_settings_text_size_map']='Distância do mapa';
