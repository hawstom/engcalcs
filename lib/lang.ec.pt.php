...
$ec_lang['dw_kinematic_viscosity']='Viscosidade cinemática, ν <span title="1×10⁻⁶ m²/s for clean water at 20°C" class="ec-tip">?</span>';
...
$ec_lang['mi_tau']='Força tang.<br />τ';
$ec_lang['mi_t']='T';
...
$ec_lang['mtc_side_slope_1']='Declividade do lado 1, z1 (horizontal / vertical)';
$ec_lang['mtc_side_slope_2']='Declividade do lado 2, z2 (horizontal / vertical)';
$ec_lang['mtc_channel_slope']='Declividade do canal, S (vertical / horizontal)';
...
$ec_lang['mtc_sgrock']='Gravidade específica da rocha, SG (2.65)';
$ec_lang['mtc_d50_in']='Tamanho de rocha, D50';
...
$ec_lang['mtc_vel_high']='Velocidade elevada — verificar perdas de transição, energia disponível e golpe de aríete.';
$ec_lang['mtc_vel_low']='Velocidade baixa — risco de sedimentação.';
$ec_lang['mtc_vel_ok_short']='OK';
$ec_lang['mtc_vel_high_short']='Alto';
$ec_lang['mtc_vel_low_short']='Baixo';
...
$ec_lang['or_diameter']='Diâmetro ou altura, D <span title="Diameter for circular; height for rectangular" class="ec-tip">?</span>';
$ec_lang['or_width']='Largura, W <span title="Rectangular openings only" class="ec-tip">?</span>';
$ec_lang['or_invert']='Cota da soleira <span title="Bottom of opening" class="ec-tip">?</span>';
...
$ec_lang['or_regime_submerged']='Orifício submerso (TWE acima do centroide) — válido ✓';
...
$ec_lang['or_notes_1_def']='Q = C<sub>d</sub> × A × √(2gh). Saída livre: h = HWE − centroide. Escoamento submerso (TWE acima da soleira): h = HWE − TWE.';
...
$ec_lang['or_notes_4_def']='Quando TWE está acima da soleira da abertura, a calculadora aplica automaticamente a equação de orifício submerso com h = HWE − TWE. Quando TWE é igual ou inferior à soleira, assume-se saída livre e h = HWE − centroide.';
// Micro-Hydro Power
...
$ec_lang['mhp_km']='Coeficiente de perda menor, k<sub>m</sub> <span title="Sum of all junction and fitting loss coefficients along the penstock" class="ec-tip">?</span>';
$ec_lang['mhp_nu']='Viscosidade cinemática, ν <span title="1×10⁻⁶ m²/s for clean water near 20°C" class="ec-tip">?</span>';
...
$ec_lang['mhp_notes_2_def']='Objetivo: 1–3 m/s. Abaixo de 1 m/s a tubagem fica sobredimensionada para a vazão; acima de 3 m/s aumentam as perdas por atrito e o risco de golpe de aríete.';
$ec_lang['mhp_notes_3_term']='Objetivo de perda de carga';
$ec_lang['mhp_notes_3_def']='Perdas na conduta forçada inferiores a 10% da altura bruta são geralmente económicas. O equilíbrio ótimo entre o custo da tubagem e a potência perdida situa-se frequentemente entre 4–6% para locais com eletricidade de alto valor.';
$ec_lang['mhp_notes_4_term']='Perdas menores k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Valores típicos: entrada com aresta viva 0,5, cada curva a 45° 0,2–0,3, válvula de gaveta (totalmente aberta) 0,1, válvula borboleta 0,2. Somar todos os acessórios para obter o k<sub>m</sub> total. O valor por defeito 1,5 assume uma entrada e duas curvas.';
$ec_lang['mhp_notes_5_term']='Rugosidade da tubagem e';
$ec_lang['mhp_notes_5_def']='Rugosidade absoluta típica: aço (novo) 0,046 mm, aço (usado) 0,15 mm, HDPE 0,003 mm, PVC/uPVC 0,0015 mm, betão 0,3–3 mm. O HDPE é comum em condutas forçadas de pequenas instalações micro-hidráulicas.';
...
$ec_lang['odt_main_desc']='Tempo de Esvaziamento de Lagoa ou Bacia por Orifício — Método do Volume Cônico';
$ec_lang['odt_h1_elev']='Cota inicial da superfície <span title="Starting water surface elevation" class="ec-tip">?</span>';
...
$ec_lang['odt_d']='Orifício D <span title="Diameter (circular) or height (rectangular)" class="ec-tip">?</span>';
$ec_lang['odt_w']='Largura do orifício, W <span title="Rectangular only" class="ec-tip">?</span>';
...
$ec_lang['cs_Ec_target']='Objetivo de revestimento, E<sub>c,target</sub> <span title="Objetivo de eficiência de condução após revestimento; fração 0–1" class="ec-tip">?</span>';
...
$ec_lang['cs_payback_years']='Período de retorno <span title="Simple payback = total lining cost ÷ annual value recovered" class="ec-tip">?</span>';
...
$ec_lang['ip_main_desc']='Estimativa de Pressão e Uniformidade do Ramo de Teste';
...
$ec_lang['ip_x']='Expoente de descarga do emissor, x <span title="0,5 para emissores não compensadores padrão; próximo a 0 para emissores com compensação de pressão" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='Lat. <span title="Marcado: este trecho é um segmento da lateral de teste, extraído por emissores individuais. Desmarcado: este trecho é uma principal, apenas passando fluxo para laterais não no caminho de teste." class="ec-tip">?</span>';
$ec_lang['ip_count']='Emissores <span title="Linhas laterais: emissores neste trecho apenas. Linhas principais: emissores totais em laterais OUTRAS que ramificam deste trecho. Para o trecho exatamente na própria tomada da lateral de teste, isto também inclui quaisquer laterais ainda mais abaixo na principal, ou compartilhando a mesma junção (por ex., uma lateral no lado oposto) — seu fluxo ramifica deste mesmo trecho também." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_e']='e <span title="Altura de rugosidade Darcy-Weisbach" class="ec-tip">?</span>';
$ec_lang['ip_km']='K<sub>m</sub> <span title="Coeficiente genérico de perda menor para acessórios/válvulas/acopladores deste trecho (≥0,5 mínimo sugerido)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='Elev. JUS <span title="Elevação da extremidade a jusante deste trecho. Opcional em linhas interiores (padroniza para plano / mesma do nó acima se deixado em branco). Obrigatório na última linha: esse valor é a elevação do último emissor, que define diretamente a pressão de abastecimento necessária." class="ec-tip">?</span>';
...
$ec_lang['ip_hl']='H<sub>l</sub> <span title="Perda total do trecho, H_f + H_m" class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='Vazão de abastecimento do caminho de teste, Q<sub>supply</sub> <span title="Fluxo entrando apenas no caminho de teste modelado, não a zona/sistema inteiro — ver Q_zone no Projeto de Aplicação abaixo para o total do sistema." class="ec-tip">?</span>';
...
$ec_lang['ip_dp_avg']='Est. ΔPressão, média vs. lateral de teste <span title="Quanto maior (ou menor) você acredita que uma lateral típica/média funciona comparada a esta lateral de teste. A lateral de teste é deliberadamente o pior caso presumido, portanto sua própria média é uma substituição enviesada para uma média de campo — deixado em 0, a verificação de uniformidade e os números de projeto-aplicação abaixo usam a própria média da lateral de teste (provavelmente otimista) como está." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='Est. vazão média do emissor em campo, q<sub>avg,field</sub> <span title="q_avg_lateral reavaliado em cada pressão de linha lateral mais a diferença de pressão inserida acima — uma tentativa de corrigir pela lateral de teste ser o pior caso presumido, não um representativo. Alimenta tanto a verificação de uniformidade quanto a seção de projeto-aplicação abaixo." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='Verificação de uniformidade, q<sub>last</sub>/q<sub>avg,field</sub> <span title="Vazão do último emissor dividida pela vazão média estimada do emissor em campo — mesma forma que a Uniformidade de Distribuição baixa-quarto textbook (média de grupo-baixo ÷ média populacional), mas computada a partir dos emissores modelados da própria lateral de teste, corrigida por uma estimativa ΔPressão inserida em vez de amostra estatística de campo completo. Valores em ou acima de 1 são possíveis e não um erro: apenas significa que o último emissor não é o ponto baixo em relação à média estimada em campo (por ex., uma corrida favorável downhill, ou a estimativa ΔPressão acima é muito pequena)." class="ec-tip">?</span>';
...
$ec_lang['ip_q_ratio']='Vazão do último emissor vs. vazão de projeto, q<sub>last</sub>/q<sub>design</sub> <span title="Uma verificação separada, não uma figura de uniformidade: quão longe o último emissor funciona do ponto de vazão de projeto nominal do fabricante. Acima de 1: funcionando acima de seu ponto de projeto (por ex., de ganho de elevação downhill favorável). Abaixo de 1: funcionando sob projeto (caso típico dominado por fricção)." class="ec-tip">?</span>';
$ec_lang['ip_no_solution']='Sem solução: pressão de abastecimento necessária excede a pressão de abastecimento inserida. Aumentar pressão de abastecimento, reduzir demanda, ou usar um tubo maior.';
$ec_lang['ip_notes_1_term']='Método';
