...
$ec_lang['ip_q_ratio']='Vazão do último emissor vs. vazão de projeto, q<sub>last</sub>/q<sub>design</sub> <span title="Uma verificação separada, não uma figura de uniformidade: quão longe o último emissor funciona do ponto de vazão de projeto nominal do fabricante. Acima de 1: funcionando acima de seu ponto de projeto (por ex., de ganho de elevação em declive favorável). Abaixo de 1: funcionando sob projeto (caso típico dominado por fricção)." class="ec-tip">?</span>';
