...
$ec_lang['lpn_field_text_match_pipe']='Corresponder ao trecho mais próximo';
...
$ec_lang['lpn_field_show_always']='Sempre mostrar este rótulo';
...
$ec_lang['lpn_settings_label_max_width']='Mostrar rótulos quando a vista for mais estreita do que isto (unidades do mapa)';
$ec_lang['lpn_settings_label_use_view']='Usar vista atual';
$ec_lang['lpn_settings_label_always']='Sempre mostrar rótulos';
...
$ec_lang['lpn_time_no_engine']='O solucionador integrado calcula um momento de cada vez, então esta é a rede apenas em {time}: as demandas carregam os multiplicadores de padrão daquele momento, e cada tanque ainda está no seu nível inicial, em vez de encher e esvaziar. Conecte-se à internet uma vez para obter o motor EPANET, que simula todo o período.';
$ec_lang['lpn_time_running']='Calculando todo o período de tempo com o motor EPANET.';
$ec_lang['lpn_time_format_tip']='Escreva um horário como horas e minutos, como 2:30. Um número simples significa horas; um número com sua própria palavra significa essa palavra: 30 minutos.';
