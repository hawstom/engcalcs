...
$ec_lang['dw_roughness']='Rugosidade, e';
$ec_lang['dw_roughness_tip']='<span title="Altura de rugosidade de Darcy-Weisbach" class="ec-tip">?</span>';
$ec_lang['dw_kinematic_viscosity']='Viscosidade cinemática, &nu; <span title="1×10⁻⁶ m²/s para água limpa a 20°C" class="ec-tip">?</span>';
...
$ec_lang['mpf_velocity_head']='Carga de velocidade, h<sub>v</sub>';
...
$ec_lang['mphl_hgl_2']='LP a montante na tubulação ' . $ec_lang['mpf_see_notes'];
$ec_lang['mphl_note_1']='<dl><dt>Para uma condição de entrada aberta (bueiro), é necessário verificar as condições de controle de entrada.</dt><dd>1. A LP a montante deve estar acima da elevação do escoamento à profundidade normal a montante (e acima da tubulação!).</dd><dd>2. O nível de água a montante de um bueiro é melhor representado pela LE a montante do que pela LP a montante.</dd><dd>3. Veja <a target="_blank" href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">meu tutorial de 2 minutos</a> para cálculos simples de nível de água em bueiros usando HY-8.</dd>';
...
$ec_lang['ws_headWaterHeight']='Carga, h';
...
$ec_lang['or_diameter']='Diâmetro ou altura, D <span title="Diâmetro para circular; altura para retangular" class="ec-tip">?</span>';
$ec_lang['or_width']='Largura, W <span title="Apenas para aberturas retangulares" class="ec-tip">?</span>';
$ec_lang['or_invert']='Cota da soleira <span title="Fundo da abertura" class="ec-tip">?</span>';
...
$ec_lang['odt_a_ending']='Área final, A<sub>2</sub> <span title="Interpolada a partir do modelo cônico na cota final" class="ec-tip">?</span>';
...
$ec_lang['odt_d']='Orifício D <span title="Diâmetro (circular) ou altura (retangular)" class="ec-tip">?</span>';
$ec_lang['odt_w']='Largura do orifício, W <span title="Apenas retangular" class="ec-tip">?</span>';
...
$ec_lang['odt_h1']='Carga inicial, H<sub>1</sub> <span title="Cota inicial da superfície d\'água menos a cota do centroide do orifício" class="ec-tip">?</span>';
