...
$ec_lang['lpn_settings_sec_assets']='Nuovi elementi';
...
$ec_lang['lpn_georef_asdegrees']='La x e la y in questo file sono state lette come una longitudine e una latitudine, quindi la rete è già sulla mappa e non è stato spostato nulla. Controlla che sia nel posto giusto, poi premi Mantieni questo posizionamento.';
...
$ec_lang['lpn_menu_project']='Progetto';
...
$ec_lang['lpn_run_menu_tip']='Ricalcola subito questa rete. Cerchi un pulsante Calcola? Finché questo progetto si ricalcola dopo ogni modifica, la barra degli strumenti non ha un pulsante Calcola. Disattiva “Ricalcola automaticamente” in Impostazioni, sotto Calcolo, Idraulica, e il pulsante ricompare.';
...
$ec_lang['lpn_profile_draw']='Scegli il percorso sulla mappa';
$ec_lang['lpn_profile_draw_stop']='Interrompi la scelta';
...
$ec_lang['lpn_import_notes_heading']='Dal file EPANET';
$ec_lang['lpn_file_open_tip']='Apre un file di progetto salvato da questa pagina.';
$ec_lang['lpn_notes_color_term']='I confini delle fasce di colore restano gli stessi';
$ec_lang['lpn_notes_color_def']='I confini delle fasce di colore vengono impostati quando scegli un metodo di classificazione dei dati. Non vengono impostati di nuovo a ogni passo temporale, perché ciò farebbe sì che i colori assumano un significato nuovo a ogni passo, il che non aiuta a visualizzare il tuo sistema. EPANET funziona allo stesso modo. Per ottenere nuovi confini, scegli di nuovo un metodo oppure digita i tuoi valori.';
...
$ec_lang['lpn_time_run_report_tip']='Ciò che il risolutore EPANET stesso ha stampato sull\'ultimo calcolo: come si è stabilizzato, ed eventuali avvisi. È il testo del risolutore stesso, non il nostro.';
...
$ec_lang['lpn_library_default_pattern']='Modello di richiesta predefinito';
$ec_lang['lpn_library_default_pattern_tip']='Ogni nodo senza un modello usa questo.';
...
$ec_lang['lpn_field_demand_pattern_tip']='Come sale e scende la richiesta di questo nodo nel corso del calcolo. Lascialo su Nessun modello per seguire il modello proprio del progetto.';
...
$ec_lang['lpn_terrain_menu']='Compila le quote dal terreno…';
$ec_lang['lpn_terrain_tip']='Legge la quota del terreno sotto ogni nodo che non ne ha una, e la digita per te. Un nodo che ha già una quota viene lasciato invariato, e un solo Annulla riporta tutto indietro. Il primo utilizzo chiede il tuo permesso, perché le posizioni dei tuoi nodi vengono inviate a Mapbox.';
$ec_lang['lpn_terrain_accuracy']='I dati del terreno hanno una risoluzione di circa 30 m sul terreno e sono spesso imprecisi di diversi metri in verticale. Trattali come una mappa a curve di livello, non come un rilievo: verifica tutto ciò su cui fai affidamento.';
...
$ec_lang['lpn_terrain_confirm']='Compilare la quota di {n} nodo/i dalla superficie del terreno?';
...
$ec_lang['lpn_terrain_confirm_default_2']='Sostituire quei {n} con la superficie del terreno?';
