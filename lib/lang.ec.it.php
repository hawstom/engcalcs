...
$ec_lang['ds_main_desc']='Irrigazione a goccia e a pioggia &mdash; portata di adacquamento e uniformità';
$ec_lang['ds_q_avg']='Portata media dell\'erogatore, q';
$ec_lang['ds_q_min']='Portata minima dell\'erogatore, q<sub>min</sub>';
$ec_lang['ds_se']='Distanza tra erogatori lungo la manichetta, S<sub>e</sub>';
$ec_lang['ds_sl']='Interasse tra manichette (interfila), S<sub>l</sub>';
...
$ec_lang['ds_pr']='Portata di adacquamento (intensità pluviometrica), PR';
$ec_lang['ds_du']='Uniformità di distribuzione, DU';
$ec_lang['ds_du_check']='Verifica qualità DU';
$ec_lang['ds_q_lat']='Portata per manichetta, Q<sub>lat</sub>';
$ec_lang['ds_q_sys']='Portata di zona, Q<sub>zone</sub>';
$ec_lang['ds_t_run']='Tempo di irrigazione per la profondità obiettivo (ore)';
$ec_lang['ds_du_excellent']='Eccellente — DU ≥ 90% ✓';
$ec_lang['ds_du_good']='Buono — DU ≥ 80% ✓';
$ec_lang['ds_du_acceptable']='Accettabile — DU ≥ 70%';
$ec_lang['ds_du_poor']='Scarso — DU < 70% — rivedere il progetto ⚠';
$ec_lang['ds_notes_1_term']='Portata di adacquamento';
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>, dove A<sub>e</sub> = S<sub>e</sub> &times; S<sub>l</sub> è la superficie servita da ciascun erogatore. Una portata di adacquamento più bassa lascia più tempo all\'infiltrazione &mdash; importante su suoli pesanti o campi in pendenza.';
$ec_lang['ds_notes_2_term']='Uniformità di distribuzione (DU)';
$ec_lang['ds_notes_2_def']='DU = q<sub>min</sub> / q<sub>avg</sub>. Un DU di 1,0 (100%) significa che tutti gli erogatori erogano in modo identico. Valori inferiori a 0,80 sprecano acqua nelle zone ben irrigate lasciando punti più asciutti. L\'uniformità diminuisce con eccessive variazioni di pressione lungo la manichetta, l\'usura degli erogatori o ostruzioni parziali.';
$ec_lang['ds_notes_3_term']='Tempo di irrigazione';
$ec_lang['ds_notes_3_def']='Tempo di irrigazione = profondità obiettivo &divide; portata di adacquamento. Su suoli in pendenza o compatti, suddividere il tempo di irrigazione in due o tre cicli più brevi con pause tra loro per evitare il ruscellamento superficiale.';
...
$ec_lang['cs_main_desc']='Percolazione dal Canale &amp; Efficienza di Convogliamento &mdash; Metodo Afflusso-Deflusso';
$ec_lang['cs_Q_in']='Portata all\'inizio del tratto, Q<sub>in</sub>';
$ec_lang['cs_Q_out']='Portata alla fine del tratto, Q<sub>out</sub>';
$ec_lang['cs_L']='Lunghezza del tratto, L';
$ec_lang['cs_wp']='Perimetro bagnato della sezione trasversale del canale, P<sub>w</sub>';
$ec_lang['cs_Q_loss']='Portata di perdita per percolazione, Q<sub>loss</sub>';
$ec_lang['cs_loss_check']='Verifica misurazione';
$ec_lang['cs_pct_loss']='Perdita come frazione dell\'afflusso';
...
$ec_lang['cs_Q_loss_per_L']='Perdita per percolazione per unità di lunghezza, Q<sub>loss</sub>/L';
$ec_lang['cs_water_value']='Valore dell\'acqua (valuta per unità di volume)';
$ec_lang['cs_lining_cost']='Costo del rivestimento (valuta per unità di area)';
$ec_lang['cs_Ec_target']='Efficienza di convogliamento obiettivo dopo il rivestimento, E<sub>c,obiettivo</sub> (frazione, 0&ndash;1) &mdash; obiettivo di ritenzione idrica del canale rivestito';
$ec_lang['cs_lining_area']='Area di rivestimento del canale (L &times; P<sub>w</sub>)';
$ec_lang['cs_annual_value_lost']='Valore annuo dell\'acqua persa (valuta)';
$ec_lang['cs_annual_value_recovered']='Valore annuo recuperato con il rivestimento (valuta)';
$ec_lang['cs_lining_total_cost']='Costo totale del rivestimento (valuta)';
$ec_lang['cs_payback_years']='Periodo di ammortamento semplice (anni)';
...
$ec_lang['rc_main_desc']='Dimensionamento del Pietrame per Scivolo &mdash; Robinson, Rice &amp; Kadavy (1998)';
...
$ec_lang['rc_layer']='Spessore dello strato di pietrame (2 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_radius']='Raggio di curvatura in sommità (40 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_length']='Lunghezza d\'arco in sommità';
$ec_lang['rc_apron_length']='Lunghezza del grembiule di uscita (15 &times; D<sub>50</sub>) <span title="Necessario per il supporto strutturale della roccia dello scivolo. &quot;Il minimo tirante di valle risultante dal tratto di uscita e dalla resistenza del canale a valle è sufficiente a garantire la stabilità del pietrame nel tratto di uscita.&quot; (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_qs']='Portata specifica superficiale, q<sub>s</sub> (q<sub>t</sub> &minus; q<sub>m</sub>)';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice &amp; Kadavy (1998) hanno sviluppato due equazioni empiriche per la dimensione mediana del pietrame D<sub>50</sub> in funzione della pendenza dello scivolo e della portata specifica. L\'equazione 1 si applica a pendenze dolci (S<sub>0</sub> &lt; 0,10); l\'equazione 2 a pendenze ripide (0,10 &le; S<sub>0</sub> &le; 0,40). Entrambe le equazioni richiedono q<sub>t</sub> in m&sup2;/s e restituiscono D<sub>50</sub> in mm. L\'intervallo validato è 0,02 &le; S<sub>0</sub> &le; 0,40.';
$ec_lang['rc_notes_2_term']='Portata specifica';
$ec_lang['rc_notes_2_def']='q<sub>t</sub> è la portata specifica totale alla sommità dello scivolo (portata totale per unità di larghezza). Per un canale di larghezza di fondo B con portata totale Q, q<sub>t</sub> &asymp; Q / B, oppure si calcola dalla condizione di tirante critico all\'ingresso dello scivolo.';
$ec_lang['rc_notes_3_term']='Deflusso attraverso il mantello di roccia';
$ec_lang['rc_notes_3_def']='Una frazione della portata totale scorre attraverso i pori del pietrame (portata di mantello q<sub>m</sub>); il resto scorre sulla superficie della roccia (q<sub>s</sub> = q<sub>t</sub> &minus; q<sub>m</sub>). L\'altezza idrica d è calcolata con l\'equazione di Manning applicata alla portata superficiale q<sub>s</sub> usando la rugosità n dello scivolo. La porosità predefinita n<sub>p</sub> = 0,45 è tipica per roccia frantumata angolare.';
