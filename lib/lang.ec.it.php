...
$ec_lang['bpn_line_problem']='Verificare la colonna Monte: un tratto punta a un ID sconosciuto, fa riferimento a se stesso, oppure forma un anello, per cui parte della rete non è collegata alla fonte. Quei tratti restano irrisolti.';
$ec_lang['bpn_bad_id_short']='Rete';
...
$ec_lang['lpn_inp_drop_quality']='Questo file descrive come la qualità dell\'acqua cambia mentre viaggia: che cosa contiene l\'acqua all\'inizio, dove entra altra di quella sostanza, come reagisce, e come si mescolano le vasche. Questa pagina calcola l\'età dell\'acqua e la traccia sorgente, ma non la chimica, quindi nulla di ciò viene usato qui. Quelle righe sono conservate, e sono riscritte se salvi un file EPANET.';
...
$ec_lang['lpn_tip_select']='Usa questa modalità per modificare, spostare e trascinare elementi sulla mappa. La pagina torna da sola a questa modalità dopo alcune azioni, come l\'apertura di un progetto.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Nasconde le etichette dei nodi e delle tubazioni, così sulla mappa restano solo i colori. Il testo che hai collocato tu stesso resta. Le tue scelte di etichette vengono conservate, e disattivando questa opzione ricompaiono.';
...
$ec_lang['lpn_file_import_geo']='Apri un file xy sulla mappa…';
$ec_lang['lpn_file_import_geo_tip']='Apre un file di progetto o un file EPANET in una nuova scheda di progetto su questa pagina, sulla mappa stradale. Colloca tu stesso il disegno sul mondo: sposta e ingrandisci fino al sito, poi ridimensiona e ruota per adattarlo. Se la x e la y nel file sono già una longitudine e una latitudine, premi il pulsante Sono già lat/lon e la rete salta direttamente dove appartiene. Ogni numero che hai digitato resta com\'è.';
...
$ec_lang['lpn_clean_map_tip']='Togli dalla mappa la barra di stato e l\'indicazione delle coordinate, così una schermata mostra solo il disegno. Il tuo disegno non viene toccato, e questa scelta non viene salvata: ricaricando la pagina le indicazioni ricompaiono.';
...
$ec_lang['lpn_time_no_period']='Questo progetto non ha un periodo di tempo, quindi c\'è un solo istante da mostrare. Imposta una Durata totale del calcolo in Impostazioni per calcolare la rete nel tempo.';
...
$ec_lang['lpn_time_run_note']='Stai vedendo la rete al primo passo di riferimento. Questa rete richiede così tanto tempo per essere calcolata sull\'intero periodo che i risultati per gli istanti successivi non vengono aggiornati mentre lavori. Premi il pulsante Calcola per aggiornarli.';
...
$ec_lang['lpn_basemap_satellite_hide']='Nascondi immagini satellitari';
$ec_lang['lpn_basemap_satellite_tip']='Fotografie del terreno da Mapbox, scaricate da internet mentre sposti e ingrandisci la vista. Utili per vedere dove passa davvero una tubazione. La tua rete viene disegnata sia che le immagini siano visibili sia che non lo siano.';
$ec_lang['lpn_georef_asdeg_btn']='Questi sono già lat/lon';
$ec_lang['lpn_georef_asdeg_tip']='Premi questo pulsante solo se la x e la y in questo file sono davvero una longitudine e una latitudine. La rete si sposta allora dove quei numeri indicano, e non serve posizionare nulla. Ogni numero resta esattamente com\'è in entrambi i casi.';
$ec_lang['lpn_georef_asdegrees']='La x e la y in questo file sono state lette come una longitudine e una latitudine, quindi la rete è già sulla mappa e non è stato spostato nulla. Controlla che sia nel posto giusto, poi premi il pulsante Mantieni questo posizionamento.';
...
$ec_lang['lpn_inp_drop_head_pattern']='Questi serbatoi salgono e scendono nel corso della giornata. I loro modelli temporali sono stati importati per intero, e il livello dell\'acqua che vedi è quello relativo al momento indicato dall\'orologio.';
$ec_lang['lpn_inp_drop_pump_speed']='Queste pompe funzionano a una velocità diversa da quella a cui è stata misurata la loro curva, oppure cambiano velocità nel corso della giornata. La velocità e il suo modello temporale sono stati importati per intero, e il carico che vedi è quello relativo al momento indicato dall\'orologio.';
...
$ec_lang['lpn_library_curves_tip']='Una curva è l\'insieme dei punti che indicano come si comporta una pompa: quanto carico produce a ogni portata.';
$ec_lang['lpn_library_curves_note']='Una curva appartiene alla pompa o alla valvola che la usa, quindi questo è l\'insieme completo in un solo posto da leggere. Fai clic su un ID per andare a quell\'elemento e modificarne lì i punti. Per una pompa, la linea disegnata è la curva usata dal calcolo, interpolata tra i punti; per una valvola sono i gradini diritti tra un punto e l\'altro.';
...
$ec_lang['lpn_field_speed_pattern_tip']='Come sale e scende la velocità di questa pompa nel corso del calcolo. Ogni moltiplicatore È la velocità relativa per quella parte della giornata, e prende il posto della velocità sopra indicata, quindi un moltiplicatore di 0 ferma la pompa.';
...
$ec_lang['lpn_terrain_none_needed']='Ogni nodo ha già una quota impostata da te. Non è stato cambiato nulla, e non è stato inviato nulla: non sovrascriviamo mai una quota già presente.';
$ec_lang['lpn_terrain_no_nodes']='Non ci sono ancora nodi da compilare.';
...
$ec_lang['lpn_result_water_age_tip']='Da quanto tempo l\'acqua che arriva in questo punto è nel sistema. Non esiste un limite normativo con cui confrontarla, quindi valuta il numero rispetto al tuo stesso sistema.';
...
$ec_lang['lpn_new_coords_xy']='coordinate xy';
$ec_lang['lpn_new_coords_geo']='lat/lon';
$ec_lang['lpn_new_coords_tip']='Un progetto xy usa coordinate che non sono latitudine e longitudine. Un progetto lat/lon ha coordinate geografiche, quindi dietro di esso si possono disegnare una mappa stradale o un\'immagine satellitare, e le quote dei nodi possono essere lette dal terreno. Un progetto xy può essere convertito in lat/lon con File, Apri un file xy sulla mappa.';
$ec_lang['lpn_new_place']='Inizia vicino a questo luogo';
$ec_lang['lpn_new_place_tip']='Facoltativo. Digita una città, una via o un punto di riferimento e la nuova mappa si apre lì. Le parole che digiti vengono inviate al servizio di nomi di luogo di OpenStreetMap, che la prima volta chiede il tuo permesso. Lascialo vuoto e la mappa si apre sul mondo intero.';
$ec_lang['lpn_new_place_hint']='Roma, Italia';
$ec_lang['lpn_new_create']='Crea';
$ec_lang['lpn_inp_drop_rules']='Questo file contiene controlli basati su regole. Non sono applicati qui, quindi le tubazioni, le pompe e le valvole che nominano restano nello stato scritto nel file. Le regole stesse vengono conservate, e sono riscritte se salvi un file EPANET.';
$ec_lang['lpn_inp_drop_energy']='Questo file EPANET include dati di modellazione del costo di pompaggio. Questa pagina non calcola l\'energia o il costo, quindi nulla qui usa quei numeri. Sono conservati, e sono riscritti se salvi un file EPANET.';
$ec_lang['lpn_inp_drop_tags']='Questo file assegna etichette identificative ad alcuni dei suoi nodi, tubazioni o altri elementi. Non c\'è ancora, su questa pagina, un posto dove vedere o cambiare un\'etichetta identificativa. Le etichette identificative sono conservate, e sono riscritte se salvi un file EPANET.';
$ec_lang['lpn_inp_drop_report']='Questo file contiene le impostazioni proprie di EPANET per i rapporti che stampa. Questa pagina mostra le sue risposte a modo suo, quindi nulla qui le usa. Sono conservate, e sono riscritte se salvi un file EPANET.';
...
$ec_lang['lpn_inp_drop_quality_options']='Questo file indica le opzioni di qualità dell\'acqua di EPANET: Quality, che nomina il tipo di analisi della qualità dell\'acqua, e due impostazioni legate a una sostanza chimica, Relative diffusivity e Quality tolerance. L\'età dell\'acqua e la traccia sorgente vengono calcolate qui; una sostanza chimica no, quindi quelle due impostazioni sono conservate senza essere usate. Tutte sono riscritte se salvi un file EPANET.';
...
$ec_lang['lpn_settings_quality_track_tip']='Scegli che cosa deve seguire il calcolo lungo le tubazioni: da quanto tempo l\'acqua è nel sistema, oppure da dove proviene. Nessuno dei due richiede una concentrazione o una velocità di reazione.';
...
$ec_lang['lpn_quality_chemical']='Una sostanza chimica indicata da questo file (conservata, non calcolata)';
$ec_lang['lpn_quality_needs_run']='La qualità dell\'acqua viene seguita lungo le tubazioni nel tempo, quindi richiede il motore EPANET e una durata totale del calcolo. Imposta una Durata totale del calcolo in Tempo, poi premi il pulsante Calcola.';
...
$ec_lang['lpn_ff_menu']='Portata antincendio…';
...
$ec_lang['lpn_ff_title']='Portata antincendio';
...
$ec_lang['lpn_ff_required_node_tip']='La portata antincendio richiesta in questo particolare nodo, secondo il tuo codice antincendio o la tua autorità antincendio per l\'uso del suolo che serve. Lascialo vuoto e il nodo viene verificato rispetto al numero nel campo Portata antincendio richiesta.';
