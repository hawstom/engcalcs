...
$ec_lang['lpn_field_text_match_pipe']='Segui l\'angolo della tubazione';
...
$ec_lang['lpn_examples_size']='{nodes} nodi, {links} tubazioni';
...
$ec_lang['lpn_ex_net3_desc']='Il grande esempio di EPANET: 97 nodi, due vasche e una sorgente fluviale. Vale la pena aprirlo per vedere come appare sulla mappa un modello di dimensioni reali.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Esegue il risolutore EPANET dell\'agenzia statunitense EPA, qui nel tuo browser. Entrambi i risolutori danno gli stessi risultati, e su una rete di queste dimensioni non noterai differenze di velocità. La prima volta che lo attivi, vengono scaricati circa 650 KB, che restano poi conservati su questo dispositivo.';
