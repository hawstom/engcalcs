...
$ec_lang['cs_Ec_target']='Obiettivo di rivestimento, E<sub>c,target</sub> <span title="Obiettivo di efficienza di trasporto dopo il rivestimento; frazione 0&ndash;1" class="ec-tip">?</span>';
...
$ec_lang['cs_payback_years']='Periodo di ammortamento <span title="Ammortamento semplice = costo totale del rivestimento &divide; valore annuo recuperato" class="ec-tip">?</span>';
...
$ec_lang['ip_x']='Esponente di scarico dell\'emettitore, x <span title="0,5 per emettitori standard non compensati; vicino a 0 per emettitori autocompensanti" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='Lat. <span title="Selezionato: questo tratto è un segmento dell\'ala laterale di prova, dalla quale i singoli emettitori prelevano acqua. Non selezionato: questo tratto è una condotta principale, che si limita a trasmettere la portata alle ali laterali non presenti nel percorso di prova." class="ec-tip">?</span>';
$ec_lang['ip_count']='Emettitori <span title="Righe ala laterale: emettitori solo in questo tratto. Righe condotta principale: numero totale di emettitori sulle ali laterali DIVERSE da questa che si diramano da questo tratto. Per il tratto della condotta principale che termina all\'ala laterale di prova, questo include anche tutte le ali laterali oltre quel punto lungo la condotta principale, o che condividono lo stesso nodo (ad esempio un\'ala laterale sul lato opposto) &mdash; anche la loro portata si dirama da questo stesso tratto." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_km']='k<sub>m</sub> <span title="Coefficiente generico di perdita concentrata per raccordi/valvole/giunti di questo tratto (minimo consigliato &ge;0,5)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='Elev. V. <span title="Quota all\'estremità di valle di questo tratto. Facoltativa nelle righe interne (predefinita: piatta, cioè uguale al nodo superiore, se lasciata vuota). Obbligatoria nell\'ultima riga: quel valore è la quota dell\'ultimo emettitore, che determina direttamente la pressione di alimentazione richiesta." class="ec-tip">?</span>';
...
$ec_lang['ip_hl']='h<sub>L</sub> <span title="Perdita totale del tratto, h_f + h_m" class="ec-tip">?</span>';
...
$ec_lang['ip_q_supply']='Portata di alimentazione del percorso di prova, Q<sub>supply</sub> <span title="Portata in ingresso al solo percorso di prova modellato — per l\'intera zona/sistema, vedere Q_zone in Progettazione dell\'applicazione qui sotto." class="ec-tip">?</span>';
...
$ec_lang['ip_dp_avg']='Stima &Delta;pressione, media rispetto all\'ala laterale di prova <span title="Quanto più alta (o più bassa) si stima che un\'ala laterale tipica operi rispetto a questa ala laterale di prova. L\'ala laterale di prova è deliberatamente il caso peggiore presunto, quindi la sua stessa media è una sottostima della media di campo &mdash; se lasciato a 0, la verifica di uniformità e i valori di progettazione dell\'applicazione qui sotto usano la media dell\'ala laterale di prova stessa (probabilmente ottimistica) così com\'è." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='Stima della portata media di campo dell\'emettitore, q<sub>avg,field</sub> <span title="q_avg_lateral rivalutata alla pressione di ciascuna riga dell\'ala laterale più la differenza di pressione inserita sopra &mdash; un tentativo di correggere il fatto che l\'ala laterale di prova sia il caso peggiore presunto, non uno rappresentativo. Alimenta sia la verifica di uniformità sia la sezione di progettazione dell\'applicazione qui sotto." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='Verifica di uniformità, q<sub>last</sub>/q<sub>avg,field</sub> <span title="Portata calcolata dell\'ultimo emettitore divisa per la portata media di campo stimata dell\'emettitore &mdash; questa è un\'approssimazione della uniformità di distribuzione del quarto inferiore standard (media del gruppo inferiore &divide; media della popolazione); questa deriva da un piccolo campione modellato e da una correzione stimata dall\'utente anziché da un campione statistico completo sul campo. Valori pari o superiori a 1 sono possibili e validi: significano solo che la pressione dell\'ultimo emettitore è pari o superiore alla media di campo stimata, quindi qualche altro emettitore è il punto di pressione più bassa. Ciò potrebbe essere dovuto al fatto che l\'ultimo emettitore si trova su un terreno più basso oppure che la stima di &Delta;pressione è troppo piccola." class="ec-tip">?</span>';
...
$ec_lang['ip_q_ratio']='Portata dell\'ultimo emettitore &divide; portata di progetto, q<sub>last</sub>/q<sub>design</sub> <span title="Questo è diverso dalla nostra approssimazione della misura di uniformità standard." class="ec-tip">?</span>';
