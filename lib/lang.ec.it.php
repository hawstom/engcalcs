...
$ec_lang['mhp_vel_low']='inferiore a 1 m/s — ridurre il diametro ⚠';
$ec_lang['mhp_vel_high']='superiore a 3 m/s — aumentare il diametro ⚠';
...
$ec_lang['mhp_notes_1_def']='Perdita totale nella condotta forzata h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, dove h<sub>f</sub> = f(L/D)(v&sup2;/2g) è la perdita per attrito di Darcy-Weisbach e h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g comprende imbocchi, curve e valvole. Altezza netta H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Velocità';
$ec_lang['mhp_notes_2_def']='Obiettivo: 1&ndash;3 m/s. Al di sotto di 1 m/s la tubazione risulta sovradimensionata per la portata; al di sopra di 3 m/s aumentano le perdite per attrito e il rischio di colpo d\'ariete.';
$ec_lang['mhp_notes_3_term']='Obiettivo di perdita di carico';
$ec_lang['mhp_notes_3_def']='Perdite nella condotta forzata inferiori al 10% dell\'altezza lorda sono generalmente economiche. Il compromesso ottimale tra costo della tubazione e potenza persa si attesta spesso intorno al 4&ndash;6% per i siti ad alta valorizzazione dell\'energia elettrica.';
