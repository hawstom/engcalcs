...
$ec_lang['lpn_field_text_match_pipe']='Segui l\'angolo del collegamento più vicino';
...
$ec_lang['lpn_field_show_always']='Mostra sempre questa etichetta';
...
$ec_lang['lpn_settings_label_max_width']='Mostra le etichette quando la vista è più stretta di questo valore (unità della mappa)';
$ec_lang['lpn_settings_label_use_view']='Usa la vista attuale';
$ec_lang['lpn_settings_label_always']='Mostra sempre le etichette';
...
$ec_lang['lpn_pane_tab_junctions_tip']='Ogni nodo in una tabella che puoi ordinare e modificare.';
$ec_lang['lpn_pane_junctions_none']='Questa rete non ha ancora nodi.';
...
$ec_lang['lpn_time_format_tip']='Scrivi un orario come ore e minuti, ad esempio 2:30. Un numero semplice indica le ore; un numero seguito da una parola indica quella parola: 30 minuti.';
$ec_lang['lpn_time_running']='Calcolo dell\'intero periodo con il motore EPANET in corso.';
$ec_lang['lpn_time_no_engine']='Il risolutore integrato calcola un solo momento alla volta, quindi questa è la rete solo a {time}: le richieste portano i moltiplicatori del modello di quel momento, e ogni vasca resta comunque al proprio livello iniziale invece di riempirsi e svuotarsi. Connettiti a internet una volta per scaricare il motore EPANET, che calcola l\'intero periodo.';
