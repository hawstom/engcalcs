...
$ec_lang['mhp_length']='Lunghezza, L <span title="Lunghezza della tubazione o del canale di adduzione dall\'opera di presa" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_warn']='supera il target del 10%';
$ec_lang['mhp_hl_warn_tip']='Considerare una tubazione più grande';
$ec_lang['mhp_hl_bad']='supera il 20%';
$ec_lang['mhp_hl_bad_tip']='Ridimensionare la tubazione';
...
$ec_lang['mhp_notes_4_term']='Perdite minori (locali), k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Queste perdite si verificano nei raccordi, negli imbocchi, nelle curve e nelle valvole della tubazione — il termine "minori" è convenzionale ma fuorviante: in una condotta forzata corta possono eguagliare o superare le perdite per attrito. Valori tipici: imbocco con spigolo vivo 0,5, ogni curva a 45° 0,2–0,3, saracinesca (completamente aperta) 0,1, valvola a farfalla 0,2. Sommare tutti i raccordi per ottenere il k<sub>m</sub> totale. Il valore predefinito 1,5 presuppone un imbocco e due curve.';
...
$ec_lang['rc_notes_7_def']='Quando il tirante normale nel canale di ingresso è inferiore al carico sullo stramazzo (H<sub>p</sub>) necessario per transitare q<sub>t</sub>, si verifica un deflusso limitato o un rigurgito a monte dell\'imbocco dello scivolo. Ciò è generalmente accettabile — il rigurgito riduce la velocità e previene l\'erosione a monte. Per verificare: utilizzare una calcolatrice di stramazzo per trovare H<sub>p</sub> per il q<sub>t</sub> e la larghezza di cresta dati, e confrontarlo con il tirante normale del canale di ingresso. Se H<sub>p</sub> supera il tirante normale, si verificherà rigurgito.';
