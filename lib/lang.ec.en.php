...
$ec_lang['mtc_d50_in']='Design rock size';
...
$ec_lang['mtc_note_1']='<p>Notes:</p><dl><dt>Automated rock size and roughness design iteration</dt><dd>Choose a roughness radio button (BB recommended), and a rock size radio button (Isbash recommended). Enter a design rock size safety factor. Every time you change any input value, the following iteration cycle happens until the design rock size and the required rock size are very close: 1. Roughness is calculated from design rock size. 2. The requested roughness calculation is copied to input roughness. 3. Channel flow and required rock size are calculated. 4. Design rock size is adjusted. 5. Repeat.</dd><dt>Basic calculator (no iteration)</dt><dd>Enter your desired roughness value. Ignore the design rock size input area.</dd></dl>';
// Robinson Rock Chute
