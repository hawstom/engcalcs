...
$ec_lang['cs_Q_in']='Inflow at head of reach, Q<sub>in</sub>';
$ec_lang['cs_Q_out']='Outflow at tail of reach, Q<sub>out</sub>';
$ec_lang['cs_L']='Reach length, L';
$ec_lang['cs_wp']='Wetted perimeter of canal cross-section, P<sub>w</sub>';
$ec_lang['cs_Q_loss']='Seepage loss rate, Q<sub>loss</sub>';
$ec_lang['cs_loss_check']='Measurement check';
$ec_lang['cs_pct_loss']='Loss as fraction of inflow';
...
$ec_lang['cs_Q_loss_per_L']='Seepage loss per unit length, Q<sub>loss</sub>/L';
$ec_lang['cs_water_value']='Value of water (currency / unit volume)';
$ec_lang['cs_lining_cost']='Lining cost (currency / unit area)';
$ec_lang['cs_Ec_target']='Target conveyance efficiency after lining, E<sub>c,target</sub> (fraction, 0&ndash;1) &mdash; goal for how well the lined canal will retain water';
$ec_lang['cs_lining_area']='Canal lining area (L &times; P<sub>w</sub>)';
$ec_lang['cs_annual_value_lost']='Annual value of water lost (currency)';
$ec_lang['cs_annual_value_recovered']='Annual value recovered by lining (currency)';
$ec_lang['cs_lining_total_cost']='Total lining cost (currency)';
$ec_lang['cs_payback_years']='Simple payback period (years)';
