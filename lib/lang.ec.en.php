...
$ec_lang['lpn_settings_engine_epanet_tip']='Runs the original EPANET solver from the US EPA, here in your browser. The built-in solver gives the same answers and is faster, so leave this off unless you need EPANET itself.';
