...
$ec_lang['lpn_settings_browser_scope_note']='Saved in this calculator, for every project.';
$ec_lang['lpn_settings_this_calculator']='This calculator';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Runs the original EPANET engine from the US EPA, here in your browser. The built-in solver gives the same answers and is faster, so leave this off unless you need EPANET itself.';
$ec_lang_syn['lpn_settings_engine_epanet_tip']='';
$ec_lang['lpn_engine_loading']='Loading the EPANET engine…';
$ec_lang_syn['lpn_engine_loading']='';
$ec_lang['lpn_engine_failed']='The EPANET engine could not be loaded. Showing the built-in solver instead.';
