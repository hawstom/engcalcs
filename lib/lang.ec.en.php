...
$ec_lang['lpn_survey_report_lead']='Below is every line that could not be taken as it stands, and everything that was changed on the way in. Nothing was thrown away quietly.';
$ec_lang['lpn_survey_note_row_short']='Line {line} too few columns: {detail} See entire line below.';
$ec_lang['lpn_survey_note_coord_missing']='Line {line} empty {axis}. See entire line below.';
$ec_lang['lpn_survey_note_lon_missing']='The longitude column is empty on this row, so no junction was made for it.';
$ec_lang['lpn_survey_note_bad_coord']='Line {line} invalid {axis}: {detail} See entire line below.';
...
$ec_lang['lpn_survey_note_coord_range']='Line {line} {axis} out of range: {detail} See entire line below.';
...
$ec_lang['lpn_survey_note_bad_elev']='Line {line} non-numeric elevation: {detail} Junction made. See entire line below.';
...
$ec_lang['lpn_survey_note_id_duplicate']='Line {line} repeated name: {detail} Junction made, under a name of ours. See entire line below.';
$ec_lang['lpn_survey_note_id_taken']='Line {line} name already in this project: {detail} Junction made, under a name of ours. See entire line below.';
$ec_lang['lpn_survey_note_id_invalid']='Line {line} name cannot be an ID here: {detail} Junction made, under a name of ours. See entire line below.';
