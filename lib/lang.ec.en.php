...
$ec_lang['lpn_result_water_age_tip']='How long the water reaching this point has been in the system. There is no regulatory limit to compare it against, so judge the number against your own system.';
...
$ec_lang['lpn_inp_drop_net_options']='This EPANET .net file states settings in places this page has no name for, so they could not be carried across. Everything else came over. If you need them, open the file in EPANET and use File, Export, Network to save it as an .inp file, then import that.';
