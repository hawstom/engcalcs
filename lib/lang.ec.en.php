...
$ec_lang['mtc_d50_in']='Median rock size';
$ec_lang['mtc_n_strickler']='n for rock size per Strickler <button type="button" id="n_strickler_copy" class="d-print-none">Copy to input</button>';
$ec_lang['mtc_n_blodgett']='n for rock size per Blodgett <button type="button" id="n_blodgett_copy" class="d-print-none">Copy to input</button>';
$ec_lang['mtc_n_bathurst']='n for rock size per Bathurst <button type="button" id="n_bathurst_copy" class="d-print-none">Copy to  input</button>';
