...
$ec_lang['hw_pipe_diameter']='Pipe diameter, d<sub>0</sub>';
$ec_lang['hw_roughness']='Hazen-Williams roughness coefficient, C';
$ec_lang['hw_k']='Minor loss coefficient, K';
$ec_lang['hw_length']='Pipe length, l';
$ec_lang['hw_flow']='Flow, Q';
$ec_lang['hw_velocity']='Velocity, V';
$ec_lang['hw_velocity_head']='Velocity head, h<sub>v</sub>';
$ec_lang['hw_flow_area']='Flow area, A';
$ec_lang['hw_wetted_perimeter']='Wetted perimeter, P';
$ec_lang['hw_hydraulic_radius']='Hydraulic radius, R';
$ec_lang['hw_friction_slope']='Friction slope';
$ec_lang['hw_friction_loss']='Friction loss, h<sub>f</sub>';
$ec_lang['hw_minor_loss']='Minor head loss, h<sub>m</sub>';
$ec_lang['hw_total_loss']='Total head loss, h<sub>l</sub>';
$ec_lang['hw_shear_stress']='Shear stress (tractive force), tau';
