...
$ec_lang['lpn_empty_hint']='Add a backdrop or a reservoir (or other element) to start, or use "Draw example network."';
...
$ec_lang['lpn_notes_3_def']='One network is saved automatically in this browser, with no guarantee about saved data going forward. This is an early preview -- please use it for small and test networks only.';
$ec_lang['lpn_notes_4_term']='Roadmap';
$ec_lang['lpn_notes_4_def']='A map backdrop image, and saving, downloading, and sharing networks between devices, are planned. Comments and suggestions are always welcome (see the feedback link above).';
