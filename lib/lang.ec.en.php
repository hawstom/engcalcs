...
$ec_lang['lpn_meter_pipe_unknown']='Nothing in this project is named {id}, so the meter was left where it was.';
$ec_lang['lpn_meter_placed']='Meter {id} added. Its account number and demand are typed in the Customers table, or press it in Select to open its box.';
$ec_lang['lpn_field_meter_pipe_tip']='The asset that this service connects to. Type another one here or in the Customers table to change it, and drag the circle on the pipe to move where along it the service connects.';
