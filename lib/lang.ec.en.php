...
$ec_lang_syn['consent_accept_all']='Allow (permit, accept) this and any later ask; do not ask (question) me again';
$ec_lang['consent_decline']='Refuse all';
$ec_lang_syn['consent_decline']='Refuse (decline, deny) this and any later ask; do not ask (question) me again';
...
$ec_lang_syn['dw_main_title']='| gloss: head loss';
...
$ec_lang_syn['hw_main_title']='| gloss: head loss';
...
$ec_lang_syn['mi_main_title']='| gloss: irregular channel';
...
$ec_lang_syn['mi_tau']='| layout: column heading; symbol';
$ec_lang['mi_t']='T';
$ec_lang_syn['mi_t']='| layout: column heading; symbol';
$ec_lang['mi_pw']='P<sub>w</sub>';
$ec_lang_syn['mi_pw']='| layout: column heading; symbol';
$ec_lang['mi_a']='A';
$ec_lang_syn['mi_a']='| layout: column heading; symbol';
...
$ec_lang['mi_fr617']='Fr';
$ec_lang_syn['mi_fr617']='| layout: column heading; symbol';
$ec_lang['mi_hv617']='h<sub>v</sub>';
$ec_lang_syn['mi_hv617']='| layout: column heading; symbol';
$ec_lang['mi_q617']='Q';
$ec_lang_syn['mi_q617']='The composite flow, Q, using composite n for each region according to Chow 6-17, equal velocities | layout: column heading';
...
$ec_lang_syn['mphl_main_title']='| gloss: head loss';
...
$ec_lang_syn['mphl_junction_loss']='| gloss: minor loss';
...
$ec_lang_syn['mhp_main_title']='Microhydropower electricity generation';
$ec_lang['mhp_main_desc']='Run-of-River Micro-Hydro Power Output Calculator';
$ec_lang_syn['mhp_main_desc']='| gloss: run-of-river';
$ec_lang['mhp_gross_head']='Gross head, H<sub>gross</sub>';
$ec_lang_syn['mhp_gross_head']='| gloss: gross head';
...
$ec_lang_syn['mhp_diameter']='| gloss: penstock';
$ec_lang['mhp_length']='Length, L';
$ec_lang_syn['mhp_length']='| gloss: penstock';
...
$ec_lang_syn['mhp_vel_high_short']='(velocity is) high';
$ec_lang['mhp_vel_low_short']='Low';
$ec_lang_syn['mhp_vel_low_short']='(velocity is) low';
$ec_lang['mhp_vel_ok_tip']='Velocity is in the efficient range for penstock design.';
$ec_lang['mhp_hl_ok_tip']='Head loss is under 10% of gross head. This pipe size is economical.';
$ec_lang['mhp_hl_warn_tip']='Head loss is over 10% of gross head. Consider a larger pipe.';
$ec_lang['mhp_hl_bad_tip']='Head loss is over 20% of gross head. Resize the pipe.';
...
$ec_lang_syn['ip_main_title']='Pressure in a pressurized drip/sprinkler irrigation network. Uniformity means evenness of water application among emitters, an irrigation-engineering statistic.';
...
$ec_lang_syn['ip_hm']='Minor (local) head loss. | symbol';
...
$ec_lang_syn['ip_q_critical']='| symbol';
...
$ec_lang['bpn_not_connected_short']='Not connected';
$ec_lang['bpn_dup_id_short']='Duplicate ID';
...
$ec_lang['lpn_color_ranges_note']='The boundaries below are fixed once set; they do not follow the results as they change. Choosing a data classification method above sets the boundaries from the current state of the system. If you change any value by hand, the method above becomes Manual.';
$ec_lang['lpn_color_criterion_note']='This method takes its boundaries from a design standard, so the number of colors is fixed while this method is selected.';
...
$ec_lang['lpn_help_screenshots']='Screenshot gallery';
...
$ec_lang['lpn_find_conn_no_fixed']='This network has no reservoir or tank, so there is no source to reach. Only no links at node and no open links at node can be searched.';
...
$ec_lang['lpn_find_q_aside']='The controls cannot express the query below, so they are hidden.';
$ec_lang['lpn_find_q_restore']='Use the controls instead';
$ec_lang['lpn_replace_q_bad']='This query cannot be understood, so nothing can be changed. Fix it above first.';
...
$ec_lang['lpn_find_q_err_scope']='There is nothing called {w} to search. Try one of: {list}';
...
$ec_lang['lpn_find_q_err_close']='This parenthesis ( was opened and never closed.';
$ec_lang['lpn_find_q_err_open']='This parenthesis ) closes nothing.';
...
$ec_lang['lpn_diag_not_converged_error']='It stopped after {iterations} iterations at a relative error of {error}, which did not reach the Accuracy setting of {accuracy}.';
...
$ec_lang['lpn_curve_kind_head']='Pump head';
$ec_lang['lpn_curve_kind_effic']='Pump efficiency';
$ec_lang['lpn_curve_kind_volume']='Tank volume';
$ec_lang['lpn_curve_kind_headloss']='Valve head loss';
...
$ec_lang['lpn_curve_kind_generic']='Kind not stated';
...
$ec_lang['lpn_curve_volume_col']='Volume';
...
$ec_lang['lpn_pump_effic_global']='This pump has no efficiency curve selected, so it runs at the efficiency set for the whole network, {percent}.';
$ec_lang['lpn_pump_effic_unstated']='This pump refers to an efficiency curve called {name}, which nothing in this project defines, so it runs at the efficiency set for the whole network, {percent}.';
...
$ec_lang['lpn_cp_low_tip']='Low limit: This is the smallest value you expect. Numbers are compared as numbers and text in dictionary order.';
$ec_lang['lpn_cp_high']='High limit';
$ec_lang['lpn_cp_high_tip']='High limit: This is the largest value you expect. Numbers are compared as numbers and text in dictionary order.';
...
$ec_lang['lpn_settings_legend_off']='None';
...
$ec_lang['lpn_settings_snap_off']='Off';
...
$ec_lang['lpn_setbox_divider']='Width of the Settings section list';
...
$ec_lang['lpn_library_pipetypes_tip']='A pipe type is a definition several pipes can refer to for their diameter, roughness and reaction coefficients. Editing the definition edits every pipe that uses it.';
...
// placeholders, not concatenation (Task 193).
$ec_lang['lpn_library_pipetype_in_use']='This pipe type is used by {count} pipes: {ids}. Detach it from them before deleting it.';
...
$ec_lang['lpn_terrain_blank_ids']='These nodes still have no elevation: {ids}';
...
$ec_lang['lpn_ff_col_atrequired']='Pressure at required flow';
$ec_lang['lpn_ff_col_affected']='Worst effect';
...
$ec_lang['lpn_ff_affect_link']='{id} reaches {velocity}';
$ec_lang['lpn_ff_more']='and {n} more affected';
...
$ec_lang['lpn_ff_err_at_rest']='Already below the residual before any fire flow is drawn';
...
$ec_lang['lpn_survey_err_no_latlon']='This page could not find a latitude column and a longitude column in that file. Name two of the columns latitude and longitude, in the first row of the file, and try again. The first row reads: {detail}';
$ec_lang['lpn_survey_err_ambiguous_lat']='More than one column in that file could be the latitude ({detail}), and this page will not choose between them. Leave one of them named as the latitude and try again.';
...
$ec_lang['lpn_survey_map_lines']='Latitude comes from the column {lat}, longitude from {lon}, the name from {id}, and the elevation from {elev}.';
...
$ec_lang['lpn_survey_elev_unit']='Elevations in the file are read as {file}, and this project is showing {project}.';
$ec_lang['lpn_survey_elev_assumed']='The file does not say what unit its elevations are in, so they are read as {project}, which is the unit this project is showing.';
...
$ec_lang['lpn_survey_report_heading']='Imported {file}';
$ec_lang['lpn_survey_report_counts']='{n} junction(s) created.';
$ec_lang['lpn_survey_report_elev']='{n} of them took an elevation from the file.';
$ec_lang['lpn_survey_report_clean']='Every point in the file came across, and nothing was changed on the way in.';
$ec_lang['lpn_survey_report_lead']='Nothing in your file was thrown away quietly. Below is every row that could not be taken as it stands, and everything that was changed on the way in:';
$ec_lang['lpn_survey_note_row_short']='This row does not have enough columns to hold a position, so no junction was made for it.';
$ec_lang['lpn_survey_note_lat_missing']='The latitude column is empty on this row, so no junction was made for it.';
$ec_lang['lpn_survey_note_lon_missing']='The longitude column is empty on this row, so no junction was made for it.';
$ec_lang['lpn_survey_note_bad_lat']='The latitude here does not read as a decimal number of degrees ({detail}), so no junction was made for this row. Degrees, minutes and seconds are not read; convert them to decimal degrees first.';
...
$ec_lang['lpn_survey_note_bad_elev']='The elevation here does not read as a number ({detail}). The junction was still made, and its elevation follows the Elevation setting for new assets.';
$ec_lang['lpn_survey_note_ambiguous_elev']='More than one column could be the elevation ({detail}), so none of them was read and every elevation follows the Elevation setting for new assets.';
$ec_lang['lpn_survey_note_blank_rows']='Blank lines were passed over: {detail}.';
$ec_lang['lpn_survey_note_id_duplicate']='This name is used more than once in the file, so this junction was given a name of ours instead.';
$ec_lang['lpn_survey_note_id_taken']='This name already belongs to something in the project, so this junction was given a name of ours instead.';
$ec_lang['lpn_survey_note_id_invalid']='This name cannot be used as an ID here, so this junction was given a name of ours instead.';
...
$ec_lang['lpn_survey_note_elev_converted']='The elevations in the file are in {detail}, which is not the unit this project is showing, so those numbers were converted. Every other number came across exactly as the file states it.';
