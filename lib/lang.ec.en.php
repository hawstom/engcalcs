...
$ec_lang['mtc_iteration_tip']='Choose a roughness option (Blodgett–Bathurst recommended) and a rock size option (Isbash recommended) to auto-iterate toward a uniform rock size for your target flow. See Notes below for the full method, or enter your own roughness value and ignore rock size to skip iteration.';
