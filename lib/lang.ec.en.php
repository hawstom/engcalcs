...
$ec_lang['lpn_survey_note_line']='Line {line} (see below): {code} - {text}';
...
$ec_lang['lpn_survey_note_bad_elev']='The elevation does not read as a number. Junction made without one.';
