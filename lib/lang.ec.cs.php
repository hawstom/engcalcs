...
$ec_lang['template_feedback']='Pošlete nám prosím návrhy nebo pochvalu. Posloužila vám tato bezplatná kalkulačka dobře?';
...
$ec_lang['lpn_main_menu']='Okruhová potrubní síť (mapové rozhraní) — PŘEDBĚŽNÁ VERZE';
$ec_lang['lpn_main_title']='PŘEDBĚŽNÁ VERZE: Bezplatný online kalkulátor okruhové potrubní sítě s mapovým rozhraním';
$ec_lang['lpn_main_desc']='PŘEDBĚŽNÁ VERZE — Tlak a průtok v okruhové potrubní síti, kterou nakreslíte do mapy';
