...
$ec_lang['lpn_field_text_match_pipe']='Podle úhlu potrubí';
...
$ec_lang['lpn_ex_net3_desc']='Velký vzorový model EPANETu: 97 uzlů, dvě nádrže a zdroj z řeky. Stojí za otevření, abyste viděli, jak vypadá model reálné velikosti na mapě.';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Spustí řešič EPANET od americké agentury EPA přímo zde ve vašem prohlížeči. Oba řešiče dávají stejné výsledky a u sítě této velikosti nepoznáte rozdíl v rychlosti. Při prvním zapnutí této volby se stáhne přibližně 650 KB dat, které pak zůstanou uloženy v tomto zařízení.';
...
$ec_lang['lpn_settings_readability_bias']='Stupně vlevo od svislice, než se popisek otočí';
