...
$ec_lang['ds_main_desc']='Kapková a postřiková závlaha &mdash; dávka vody a rovnoměrnost závlahy';
$ec_lang['ds_q_avg']='Průměrný průtok emiteru, q';
$ec_lang['ds_q_min']='Minimální průtok emiteru, q<sub>min</sub>';
$ec_lang['ds_se']='Rozteč emiterů podél postranní větve, S<sub>e</sub>';
$ec_lang['ds_sl']='Rozteč postranních větví (vzdálenost řad), S<sub>l</sub>';
$ec_lang['ds_n_e']='Emitory na postranní větev, n<sub>e</sub>';
$ec_lang['ds_n_l']='Postranní větve na zónu, n<sub>l</sub>';
$ec_lang['ds_d']='Cílová hloubka závlahy, d';
$ec_lang['ds_a_e']='Plocha na jeden emitor, A<sub>e</sub>';
$ec_lang['ds_pr']='Dávka vody (intenzita závlahy), PR';
$ec_lang['ds_du']='Rovnoměrnost distribuce, DU';
$ec_lang['ds_du_check']='Kontrola kvality DU';
$ec_lang['ds_q_lat']='Průtok postranní větví, Q<sub>lat</sub>';
$ec_lang['ds_q_sys']='Průtok zónou, Q<sub>zone</sub>';
$ec_lang['ds_t_run']='Doba závlahy pro cílovou hloubku (hodiny)';
$ec_lang['ds_du_excellent']='Výborná — DU ≥ 90% ✓';
$ec_lang['ds_du_good']='Dobrá — DU ≥ 80% ✓';
$ec_lang['ds_du_acceptable']='Přijatelná — DU ≥ 70%';
$ec_lang['ds_du_poor']='Špatná — DU < 70% — přezkoumat návrh ⚠';
$ec_lang['ds_notes_1_term']='Dávka vody';
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>, kde A<sub>e</sub> = S<sub>e</sub> &times; S<sub>l</sub> je plocha zásobovaná každým emitorem. Nižší dávka vody poskytuje více času pro vsak &mdash; důležité na těžkých půdách nebo svažitých polích.';
$ec_lang['ds_notes_2_term']='Rovnoměrnost distribuce (DU)';
...
$ec_lang['cs_water_value']='Hodnota vody (měna za jednotku objemu)';
$ec_lang['cs_lining_cost']='Náklady na zpevnění (měna za jednotku plochy)';
$ec_lang['cs_Ec_target']='Cílová dopravní účinnost po zpevnění, E<sub>c,target</sub> (podíl, 0&ndash;1) &mdash; cíl pro zachování vody v zpevněném kanálu';
$ec_lang['cs_lining_area']='Plocha zpevnění kanálu (L &times; P<sub>w</sub>)';
...
$ec_lang['rc_main_desc']='Dimenzování Záhozu Kamenného Skluzu &mdash; Robinson, Rice &amp; Kadavy (1998)';
...
$ec_lang['rc_layer']='Tloušťka kamenné vrstvy (2 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_radius']='Poloměr oblouku na koruně (40 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_length']='Délka oblouku na koruně';
$ec_lang['rc_apron_length']='Délka vývarové desky na výtoku (15 &times; D<sub>50</sub>) <span title="Nezbytné pro konstrukční stabilitu kamene skluzu. „Minimální dolní voda vzniklá odporem výtokového úseku a dolního koryta postačuje k zajištění stability záhozu ve výtokovém úseku." (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_qs']='Povrchový jednotkový průtok, q<sub>s</sub> (q<sub>t</sub> &minus; q<sub>m</sub>)';
