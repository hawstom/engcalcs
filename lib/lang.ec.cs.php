...
$ec_lang['mhp_km']='Součinitel místní ztráty, k<sub>m</sub> <span title="Součet všech součinitelů ztrát na armaturách a conectích v přiváděcím potrubí" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['mhp_nu']='Kinematická viskozita, ν <span title="1×10⁻⁶ m²/s pro čistou vodu poblíž 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_vel_low']='pod 1 m/s — zmenšete průměr ⚠';
$ec_lang['mhp_vel_high']='nad 3 m/s — zvětšete průměr ⚠';
...
$ec_lang['mhp_notes_1_def']='Celková ztráta h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, kde h<sub>f</sub> = f(L/D)(v&sup2;/2g) je třecí ztráta podle Darcy-Weisbacha a h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g zahrnuje vtok, kolena a armatury. Čistá výška H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Rychlost';
$ec_lang['mhp_notes_2_def']='Cíl 1&ndash;3 m/s. Pod 1 m/s je potrubí předimenzované; nad 3 m/s narůstají třecí ztráty a riziko vodního rázu.';
$ec_lang['mhp_notes_3_term']='Cílová ztráta tlakové výšky';
$ec_lang['mhp_notes_3_def']='Ztráty v přiváděcím potrubí pod 10% hrubé výšky jsou zpravidla hospodárné. Optimální kompromis mezi náklady na potrubí a ztrátou výkonu se obvykle pohybuje kolem 4&ndash;6% pro lokality s vysokou hodnotou elektřiny.';
$ec_lang['mhp_notes_4_term']='Místní ztráty k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Typické hodnoty: ostrý vtok 0.5, každé koleno 45&deg; 0.2&ndash;0.3, šoupě (plně otevřené) 0.1, klapka 0.2. Součet všech armatur tvoří celkový k<sub>m</sub>. Výchozí hodnota 1.5 předpokládá jeden vtok a dvě kolena.';
$ec_lang['mhp_notes_5_term']='Drsnost potrubí e';
$ec_lang['mhp_notes_5_def']='Typická absolutní drsnost: ocel (nová) 0.046&nbsp;mm, ocel (použitá) 0.15&nbsp;mm, HDPE 0.003&nbsp;mm, PVC/uPVC 0.0015&nbsp;mm, beton 0.3&ndash;3&nbsp;mm. HDPE je běžný materiál pro malá přiváděcí potrubí mikro-vodních elektráren.';
