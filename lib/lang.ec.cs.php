...
$ec_lang['lpn_inp_drop_quality']='Tento soubor popisuje, jak se kvalita vody mění při průchodu sítí: co je ve vodě na začátku, kde do ní vstupuje více této látky, jak reaguje a jak se mísí v nádržích. Tato stránka počítá stáří vody a sledování zdroje, ale ne chemii, takže se zde nic z toho nepoužívá. Tyto řádky jsou zachovány a při uložení souboru EPANET se zapíší zpět.';
...
$ec_lang['lpn_tip_select']='Tento režim použijte ke změně, přesunu a přetažení věcí na mapě. Stránka se do tohoto režimu sama vrací po některých akcích, jako je otevření projektu.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Skryje popisky uzlů a potrubí, takže na mapě zůstanou pouze barvy. Text, který jste umístili sami, zůstává. Vaše volby popisků jsou zachovány a vypnutím této volby se vrátí zpět.';
...
$ec_lang['lpn_file_import_geo']='Otevřít soubor xy na mapě…';
$ec_lang['lpn_file_import_geo_tip']='Otevře soubor projektu nebo soubor EPANET na nové kartě projektu na této stránce, na mapě ulic. Výkres na svět umístíte ručně: posunete a přiblížíte mapu k místu, poté výkres zvětšíte nebo zmenšíte a otočíte, aby seděl. Pokud x a y v souboru už jsou zeměpisná délka a šířka, stiskněte tlačítko Toto už jsou lat/lon a síť skočí přímo tam, kam patří. Každé číslo, které jste zadali, zůstává stejné.';
...
$ec_lang['lpn_clean_map_tip']='Odstraní z mapy stavový pruh a údaj o souřadnicích, takže snímek obrazovky ukáže jen výkres. Váš výkres zůstává beze změny a tato volba se neukládá; po znovunačtení stránky se údaje vrátí.';
...
$ec_lang['lpn_time_run_note']='Vidíte síť v prvním vykazovaném čase. Výpočet celého časového období této sítě trvá tak dlouho, že se výsledky pro pozdější časy během práce neaktualizují. Stiskněte tlačítko Vypočítat, aby se aktualizovaly.';
...
$ec_lang['lpn_georef_asdegrees']='X a y v tomto souboru byly načteny jako zeměpisná délka a šířka, takže síť je již na mapě a nic se nepřesunulo. Zkontrolujte, že je na správném místě, a poté stiskněte tlačítko Ponechat toto umístění.';
...
$ec_lang['lpn_result_water_age_tip']='Jak dlouho je voda, která sem dorazila, v systému. Neexistuje žádný předpisový limit, se kterým by se dalo porovnat, takže toto číslo posuzujte podle vlastní sítě.';
...
$ec_lang['lpn_geomap']='zeměpisná šířka/délka';
...
$ec_lang['lpn_new_coords_xy']='souřadnice xy';
$ec_lang['lpn_new_coords_geo']='zeměpisná šířka/délka';
$ec_lang['lpn_new_coords_tip']='Projekt xy používá souřadnice, které nejsou zeměpisnou šířkou a délkou. Projekt lat/lon má zeměpisné souřadnice, takže za ním lze nakreslit mapu ulic nebo satelitní snímek a nadmořské výšky uzlů lze načíst z terénu. Projekt xy lze převést na lat/lon pomocí Soubor, Otevřít soubor xy na mapě.';
$ec_lang['lpn_new_place']='Začít poblíž tohoto místa';
$ec_lang['lpn_new_place_tip']='Nepovinné. Zadejte město, ulici nebo orientační bod a nová mapa se otevře tam. Slova, která zadáte, se odešlou vyhledávací službě míst OpenStreetMap, která se poprvé zeptá na váš souhlas. Ponechte prázdné a mapa se otevře na celém světě.';
$ec_lang['lpn_new_place_hint']='Petaluma, Kalifornie';
$ec_lang['lpn_new_create']='Vytvořit';
$ec_lang['lpn_inp_drop_rules']='Tento soubor obsahuje pravidlová ovládání. Zde se nepoužívají, takže potrubí, čerpadla a ventily, které pojmenovávají, zůstávají ve stavu zapsaném v souboru. Samotná pravidla jsou zachována a při uložení souboru EPANET se zapíší zpět.';
$ec_lang['lpn_inp_drop_energy']='Tento soubor EPANET obsahuje údaje pro modelování nákladů na čerpání. Tato stránka neřeší energii ani náklady, takže tato čísla se zde nikde nepoužívají. Jsou zachována a při uložení souboru EPANET se zapíší zpět.';
$ec_lang['lpn_inp_drop_tags']='Tento soubor přiřazuje značky některým svým uzlům, potrubím nebo jiným prvkům. Na této stránce zatím není místo, kde by šla značka zobrazit nebo změnit. Značky jsou zachovány a při uložení souboru EPANET se zapíší zpět.';
$ec_lang['lpn_inp_drop_report']='Tento soubor obsahuje vlastní nastavení EPANET pro sestavy, které tiskne. Tato stránka zobrazuje své výsledky vlastním způsobem, takže se zde nic z toho nepoužívá. Je to zachováno a při uložení souboru EPANET se to zapíše zpět.';
...
$ec_lang['lpn_inp_drop_quality_options']='Tento soubor uvádí možnosti kvality vody EPANET: Quality, která pojmenovává druh analýzy kvality vody, a dvě nastavení patřící k chemické látce, Relativní difuzivitu a Toleranci kvality. Stáří vody a sledování zdroje se zde počítají, chemická látka ne, takže tato dvě nastavení jsou zachována, aniž by se použila. Vše z toho se při uložení souboru EPANET zapíše zpět.';
...
$ec_lang['lpn_settings_quality_track_tip']='Zvolte, co má výpočet sledovat v potrubích: jak dlouho je voda v systému, nebo odkud pochází. Ani jedno nepotřebuje koncentraci ani rychlost reakce.';
...
$ec_lang['lpn_quality_chemical']='Chemická látka pojmenovaná tímto souborem (uložená, nikoli vypočtená)';
...
$ec_lang['lpn_ff_menu']='Požární průtok…';
...
$ec_lang['lpn_ff_title']='Požární průtok';
...
$ec_lang['lpn_ff_required_node_tip']='Požární průtok požadovaný přímo u tohoto uzlu, podle vašeho požárního předpisu nebo hasičského sboru pro využití území, které obsluhuje. Ponechte prázdné a uzel bude testován proti číslu v poli Požadovaný požární průtok.';
