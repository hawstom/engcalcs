...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="Výška drsnosti Darcy-Weisbach"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_km']='<span class="ec-help" title="Součet všech součinitelů ztrát na armaturách a conectích v přiváděcím potrubí">Součinitel místní ztráty, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s pro čistou vodu poblíž 20°C">Kinematická viskozita, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="Typický drcený granit nebo čedič ≈ 2,65. Platný rozsah Robinson: 2,54 až 2,82.">Relativní hustota horniny, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_e']='<span class="ec-help" title="Darcyho-Weisbachova výška drsnosti">e <span class="ec-tip">?</span></span>';
