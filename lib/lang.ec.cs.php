...
$ec_lang['lpn_settings_engine_epanet']='Řešit pomocí výpočetního jádra EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='Spustí původní výpočetní jádro EPANET od americké agentury EPA přímo ve vašem prohlížeči. Vestavěný řešič dává stejné výsledky a je rychlejší, proto tuto volbu nechte vypnutou, pokud nepotřebujete přímo EPANET.';
$ec_lang['lpn_engine_loading']='Načítání výpočetního jádra EPANET…';
$ec_lang['lpn_engine_failed']='Výpočetní jádro EPANET se nepodařilo načíst. Místo něj se zobrazuje vestavěný řešič.';
