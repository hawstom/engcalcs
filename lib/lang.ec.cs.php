...
$ec_lang['ds_main_desc']='Kapková a postřiková závlaha — dávka vody a rovnoměrnost závlahy';
...
$ec_lang['ds_notes_3_def']='Doba závlahy = cílová hloubka ÷ dávka vody. Na svažitých nebo zhutnělých půdách rozdělte dobu závlahy do dvou nebo tří kratších cyklů s přestávkami, abyste se vyhnuli povrchovému odtoku.';
...
$ec_lang['cs_Ec_target']='Cílová dopravní účinnost po zpevnění, E<sub>c,target</sub> (podíl, 0–1) — cíl pro zachování vody v zpevněném kanálu';
