...
$ec_lang['mhp_length']='Délka, L <span title="Délka přiváděcího potrubí nebo žlabu od vtokového (odběrného) objektu" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_ok']='v rámci cílové hodnoty 10 %';
$ec_lang['mhp_hl_warn']='překračuje cílovou hodnotu 10 %';
$ec_lang['mhp_hl_warn_tip']='Zvažte větší potrubí';
$ec_lang['mhp_hl_bad']='překračuje 20 %';
$ec_lang['mhp_hl_bad_tip']='Změňte rozměry potrubí';
...
$ec_lang['mhp_notes_4_def']='K těmto ztrátám dochází na spojích potrubí, vtocích, kolenech a armaturách — označení „místní“ je zavedené, ale zavádějící: u krátkého tlakovodu mohou dosahovat stejné hodnoty jako třecí ztráty nebo je i převyšovat. Typické hodnoty k: ostrý vtok 0,5, každé koleno 45° 0,2–0,3, šoupě (plně otevřené) 0,1, klapka 0,2. Součet všech armatur tvoří celkový k<sub>m</sub>. Výchozí hodnota 1,5 předpokládá jeden vtok a dvě kolena.';
...
$ec_lang['rc_qt']='Celkový měrný průtok, q<sub>t</sub> <span title="Průtok na jednotku šířky na vtoku skluzu. Pro koryto o šířce dna B s celkovým průtokem Q použijte q_t = Q / B." class="ec-tip">?</span>';
$ec_lang['rc_np']='Pórovitost záhozu, n<sub>p</sub>';
$ec_lang['rc_sg']='Relativní hustota horniny, sg <span title="Typický drcený granit nebo čedič ≈ 2,65. Platný rozsah Robinson: 2,54 až 2,82." class="ec-tip">?</span>';
$ec_lang['rc_SD']='Zrnitostní SD = D<sub>84.1</sub>/D<sub>50</sub> <span title="Směrodatná odchylka zrnitosti. Rovnoměrné kamení ≈ 1,25. Platný rozsah Robinson: 1,15 až 1,47." class="ec-tip">?</span>';
$ec_lang['rc_yn']='Normální hloubka ve vtokové stoce, y<sub>n</sub> <span title="Vzdutí (Hp > yn) je žádoucí — snižuje erozi proti proudu od vtoku. (USDA)" class="ec-tip">?</span>';
$ec_lang['rc_D50']='Požadovaná střední velikost kamene, D<sub>50</sub> <span title="Rovnice 1 (S0 &lt; 0,10) nebo rovnice 2 (0,10–0,40). Platné rozmezí: D50 15–278 mm, S0 0,02–0,40. Mimo rozsah: extrapolováno." class="ec-tip">?</span>';
...
$ec_lang['rc_apron_length']='Délka vývarové desky na výtoku (15 × D<sub>50</sub>) <span title="Nezbytné pro konstrukční podporu kamene skluzu. &quot;Minimální hladina dolní vody vznikající v důsledku odporu výtokového úseku a navazujícího koryta postačuje k zajištění stability záhozu ve výtokovém úseku.&quot; (Robinson)" class="ec-tip">?</span>';
$ec_lang['rc_n_chute']='Manningova drsnost skluzu, n';
$ec_lang['rc_Vm']='Rychlost proudění kamennou vrstvou, V<sub>m</sub> <span title="Část qt protékající póry kamenného záhozu. Zbytek qs teče po povrchu. Výchozí np = 0,45 pro ostrohranný drcený kámen." class="ec-tip">?</span>';
...
$ec_lang['rc_Hp']='Vzdutí na vtoku, H<sub>p</sub> <span title="Vzdutí (Hp > yn) je žádoucí — snižuje erozi proti proudu od vtoku. (USDA)" class="ec-tip">?</span>';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice & Kadavy (1998) vyvinuli dvě empirické rovnice pro střední velikost záhozu D<sub>50</sub> na základě sklonu skluzu a měrného průtoku. Rovnice 1 platí pro mírné svahy (S<sub>0</sub> < 0,10); rovnice 2 platí pro strmé svahy (0,10 ≤ S<sub>0</sub> ≤ 0,40). Obě rovnice vyžadují q<sub>t</sub> v m²/s a vracejí D<sub>50</sub> v mm. Ověřený rozsah je 0,02 ≤ S<sub>0</sub> ≤ 0,40.';
