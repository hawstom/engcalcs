...
$ec_lang['lpn_file_convert_as']='Otevřít soubor xy na mapě…';
$ec_lang['lpn_file_convert_as_tip']='Otevře soubor projektu nebo soubor EPANET na nové kartě projektu na této stránce, na mapě ulic. Výkres na svět umístíte ručně: posunete a přiblížíte mapu k místu, poté výkres zvětšíte nebo zmenšíte a otočíte, aby seděl. Pokud x a y v souboru už jsou zeměpisná délka a šířka, stiskněte tlačítko Toto už jsou lat/lon a síť skočí přímo tam, kam patří. Každé číslo, které jste zadali, zůstává stejné.';
