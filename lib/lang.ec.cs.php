...
$ec_lang['dw_roughness']='Drsnost, e';
$ec_lang['dw_roughness_tip']='<span title="Výška drsnosti Darcy-Weisbach" class="ec-tip">?</span>';
$ec_lang['dw_kinematic_viscosity']='Kinematická viskozita, &nu; <span title="1×10⁻⁶ m²/s pro čistou vodu při 20°C" class="ec-tip">?</span>';
...
$ec_lang['ws_headWaterHeight']='Přepadová výška, h';
...
$ec_lang['or_width']='Šířka, W <span title="Pouze obdélníkové otvory" class="ec-tip">?</span>';
...
$ec_lang['odt_a_ending']='Koncová plocha, A<sub>2</sub> <span title="Interpolováno z kónického modelu na koncové kótě" class="ec-tip">?</span>';
...
$ec_lang['odt_d']='Otvor D <span title="Průměr (kruhový) nebo výška (obdélníkový)" class="ec-tip">?</span>';
$ec_lang['odt_w']='Šířka otvoru, W <span title="Pouze obdélníkový" class="ec-tip">?</span>';
...
$ec_lang['odt_h1']='Počáteční výška, H<sub>1</sub> <span title="Počáteční kóta hladiny vody minus kóta těžiště otvoru" class="ec-tip">?</span>';
