...
$ec_lang['template_translation_help']='您能帮助我改进翻译、编程或托管这些计算器吗？  ';
...
$ec_lang['odt_main_title']='免费在线孔口排水时间计算器';
$ec_lang['odt_main_desc']='池塘孔口排水时间 &mdash; 锥体体积法';
$ec_lang['odt_h1_elev']='初始水面高程';
$ec_lang['odt_a1']='初始池塘面积，A1';
$ec_lang['odt_h2_elev']='终止水面高程';
$ec_lang['odt_h_orifice']='孔口形心高程';
$ec_lang['odt_a0']='孔口高程处池塘面积，A0';
...
$ec_lang['odt_notes_2_def']='锥体体积法将池塘模型化为初始水面面积 A<sub>1</sub> 与孔口形心高程处面积 A<sub>0</sub> 之间的锥形截面。终止高程处的池塘面积 A<sub>2</sub> 由 A<sub>1</sub> 和 A<sub>0</sub> 按锥形截面模型插值得出。从初始到终止高程的排水时间等于从 H<sub>1</sub> 到孔口的总排水时间减去从 H<sub>2</sub> 到孔口的剩余排水时间。';
