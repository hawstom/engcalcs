...
$ec_lang['lpn_settings_engine_epanet_tip']='Запускает расчётное ядро EPANET Агентства по охране окружающей среды США прямо здесь, в вашем браузере. Встроенное расчётное ядро даёт те же ответы и работает быстрее, поэтому оставляйте эту настройку выключенной, если вам не нужен именно EPANET.';
