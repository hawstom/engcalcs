...
$ec_lang['lpn_file_convert_as']='Открыть xy-файл на карте…';
$ec_lang['lpn_file_convert_as_tip']='Открывает файл проекта или файл EPANET в новой вкладке проекта на этой странице, поверх карты улиц. Вы размещаете чертёж на местности вручную: панорамируете и масштабируете карту к нужному месту, затем меняете размер и поворот, чтобы он подошёл. Если x и y в файле уже являются долготой и широтой, нажмите кнопку «Это уже широта/долгота», и сеть сразу переместится туда, где ей место. Каждое введённое вами число остаётся таким, как есть.';
