...
$ec_lang['mpf_velocity_head']='<span class="ec-help" title="Кинетическая энергия в виде высоты столба воды, v&sup2;/2g">Скоростной напор, h<sub>v</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['mtc_sgrock']='<span class="ec-help" title="Плотность относительно воды. Обычно &asymp; 2,65 для дробленого камня.">Относительная плотность камня, sg <span class="ec-tip">?</span></span>';
