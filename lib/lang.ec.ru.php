...
$ec_lang['lpn_main_menu']='Кольцевая трубопроводная сеть (интерфейс с картой)';
$ec_lang['lpn_main_title']='Бесплатный онлайн-калькулятор кольцевой трубопроводной сети с интерфейсом карты';
$ec_lang['lpn_main_desc']='Давление и расход в кольцевой трубопроводной сети, которую вы чертите на карте';
