...
$ec_lang['lpn_menu_cue']='Начните с меню выше. Используйте панель инструментов для быстрого доступа.';
...
$ec_lang['lpn_georef_projected']='Этот проект уже задаёт картографическую проекцию, поэтому его координаты нельзя разместить на карте повторно.';
...
$ec_lang['lpn_new_coordsys_geo']='Географическая проекция';
$ec_lang['lpn_new_coordsys_geo_tip']='Выберите географическую проекцию. Для широты и долготы используйте WGS 84 / Pseudo-Mercator EPSG:3857.';
...
$ec_lang['lpn_new_crs_tip']='Проекция, в которой уже измерены ваши координаты. Координаты хранятся точно так, как вы их вводите, и ничего не преобразуется. Этот выбор постоянный; единственный способ преобразовать сеть в другие координаты — команда «Файл» → «Открыть xy-файл на карте…», и он приближённый. UTM — преобладающий мировой стандарт, но в отдельном регионе могут быть свои традиции, и, если вы не уверены, спросите геодезиста.';
...
$ec_lang['lpn_crs_place_projected']='Проект с проекцией открывается в собственной плоскости, а не в месте, которое вы искали. Чтобы разместить эту плоскость на Земле, нужно преобразование координат, которого на этой странице пока нет.';
...
$ec_lang['lpn_pane_paste_note']='Эта таблица предназначена для ввода значений путём вставки из электронной таблицы в уже существующие строки. Если это не отвечает вашим потребностям, воспользуйтесь пунктом «Справка» → «Устранение проблем», чтобы сообщить нам.';
...
$ec_lang['lpn_find_filter_table']='Таблица для фильтрации';
