...
$ec_lang['lpn_new_blank_us']='Пустой xy-проект, американские единицы (gpm)';
$ec_lang['lpn_new_blank_si']='Пустой xy-проект, единицы СИ (л/с)';
...
$ec_lang['lpn_units_group_inputs']='Единицы ввода';
$ec_lang['lpn_units_group_results']='Единицы результатов';
...
$ec_lang['lpn_file_import_geo']='Преобразовать в широту/долготу…';
...
$ec_lang['lpn_georef_done']='Теперь это проект с широтой и долготой. Перетащите любой элемент, чтобы приблизить его к тому месту, где он находится на самом деле.';
$ec_lang['lpn_georef_on_map']='Этот проект уже привязан к широте и долготе.';
...
$ec_lang['lpn_profile_pick']='Добавляйте узлы в маршрут, щёлкая по ним на карте';
$ec_lang['lpn_profile_through']='Узлы на пути';
$ec_lang['lpn_profile_clear']='Удалить все';
...
$ec_lang['lpn_new_geo_us']='Пустой проект (широта/долгота), американские единицы (gpm)';
$ec_lang['lpn_new_geo_si']='Пустой проект (широта/долгота), единицы СИ (л/с)';
...
$ec_lang['lpn_georef_asdeg_btn']='Это уже долгота и широта';
...
$ec_lang['lpn_profile_draw']='Выбрать маршрут на карте';
$ec_lang['lpn_profile_draw_stop']='Прекратить выбор';
...
$ec_lang['lpn_library_default_pattern']='График расхода отбора по умолчанию';
$ec_lang['lpn_library_default_pattern_tip']='Этот график использует каждый узел, у которого нет своего графика.';
...
$ec_lang['lpn_terrain_menu']='Заполнить отметки по рельефу местности…';
$ec_lang['lpn_terrain_tip']='Считывает отметку земли под каждым узлом, у которого её нет, и вписывает её за вас. Узел, у которого отметка уже есть, остаётся без изменений, а одна отмена возвращает всё обратно. При первом использовании страница спросит ваше разрешение, потому что положения ваших узлов отправляются в Mapbox.';
