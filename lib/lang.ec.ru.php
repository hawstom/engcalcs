...
$ec_lang['lpn_time_run_note']='Вы видите сеть на первый момент вывода результатов. Настройка «Пересчитывать автоматически» отключена, поэтому результаты для более поздних моментов не обновляются, пока вы работаете. Нажмите кнопку «Рассчитать», чтобы обновить их.';
