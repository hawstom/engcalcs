...
// Batch: 2026 delta translation, keys new to ru payload (146.xx series continued).
...
$ec_lang['lpn_georef_menu']='Преобразовать в широту/долготу…';
$ec_lang['lpn_georef_tip']='Из локальной сетки в реальный мир. Помещает чертёж, сделанный на сетке XY, в географические координаты, чтобы он лёг на карту улиц там, где ему положено быть. Каждое введённое вами число остаётся таким, как есть, — меняются только X и Y, которые становятся долготой и широтой.';
...
$ec_lang['lpn_pane_tab_junctions_tip']='Все узлы в виде таблицы, которую можно сортировать и редактировать.';
$ec_lang['lpn_pane_junctions_none']='В этой сети пока нет узлов.';
...
$ec_lang['lpn_settings_sec_elements']='Новые элементы';
