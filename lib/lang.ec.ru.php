...
$ec_lang['template_translation_help']='Можете предложить более удачную формулировку или что-то ещё? Пожалуйста, напишите нам.';
...
$ec_lang['odt_main_desc']='Время опорожнения пруда, бассейна или резервуара &mdash; выпуск через отверстие, метод конического объёма';
...
$ec_lang['ip_worst_case_warn']='Давление тестового эмиттера &ge; давления подачи. Это, вероятно, не наихудший эмиттер, либо трубы можно выбрать меньшего диаметра.';
