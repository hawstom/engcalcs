...
$ec_lang['bpn_line_problem']='Проверьте столбец «Вышестоящий»: участок указывает на неизвестный ID, ссылается сам на себя или образует кольцо, из-за чего часть сети не соединена с источником. Эти участки остаются нерешёнными.';
$ec_lang['bpn_bad_id_short']='Сеть';
