...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="Высота шероховатости (абсолютная шероховатость) по Дарси-Вейсбах"><span class="ec-tip">?</span></span>';
...
$ec_lang['mtc_sgrock']='<span class="ec-help" title="Обычно &asymp; 2,65 для дробленого камня">Относительная плотность камня, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_length']='<span class="ec-help" title="Длина подводящего трубопровода или лотка от водозаборного сооружения">Длина, L <span class="ec-tip">?</span></span>';
$ec_lang['mhp_roughness']='Шероховатость трубы, e';
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">Коэффициент местных потерь, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">Кинематическая вязкость, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_Ec_target']='<span class="ec-help" title="Целевой КПД водоподачи после облицовки; доля 0–1">Целевой КПД, E<sub>c,target</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_payback_years']='<span class="ec-help" title="Simple payback = total lining cost ÷ annual value recovered">Период окупаемости <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="Типичный дроблёный гранит или базальт ≈ 2,65. Диапазон по Robinson: 2,54 до 2,82.">Относительная плотность камня, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_count']='<span class="ec-help" title="Строки латерали: эмиттеры только в этом участке. Строки магистрали: всего эмиттеров на латеральных ветвях, КРОМЕ данной, отходящих от этого участка. Для участка, расположенного в точке подключения собственной тестовой латерали, это также включает любые латерали, расположенные ниже по магистрали после подключения или соединённые в одной точке (например, латераль с противоположной стороны) &mdash; поток через них проходит также через этот же участок перед разделением, независимо от их наличия в этой таблице.">Эмиттеры <span class="ec-tip">?</span></span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_e']='<span class="ec-help" title="Абсолютная высота шероховатости Дарси-Вейсбаха">e <span class="ec-tip">?</span></span>';
$ec_lang['ip_km']='<span class="ec-help" title="Общий коэффициент местных потерь для фитингов/задвижек/соединителей этого участка (&ge;0,5 рекомендуется как минимум)">k<sub>m</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_supply']='<span class="ec-help" title="Расход, входящий только в смоделированный тестовый путь, не во всю зону/систему — см. Q_zone в Проектировании приложения ниже для системного итога.">Расход подачи тестовой трассы, Q<sub>supply</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_dp_avg']='<span class="ec-help" title="На сколько выше (или ниже) вы считаете, что типичная/средняя латераль работает по сравнению с этой тестовой латералью. Тестовая латераль специально принята за наихудший случай, поэтому её собственное среднее — смещённо-низкий заменитель полевого среднего — при оставлении на 0, проверка однородности и числа проектирования приложения ниже используют собственное (вероятно оптимистичное) среднее тестовой латерали как есть.">Оценённая &Delta;давления, среднее по сравнению с тестовой латералью <span class="ec-tip">?</span></span>';
$ec_lang['ip_q_avg_field']='<span class="ec-help" title="q_avg_lateral пересчитанный при давлении каждой строки латерали плюс введённое различие давления выше — попытка учесть, что тестовая латераль принята за наихудший случай, не репрезентативную. Используется как для проверки однородности, так и для раздела проектирования приложения ниже.">Оценённый полевой средний расход эмиттера, q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
$ec_lang['ip_du_estimate']='<span class="ec-help" title="Расход последнего эмиттера, разделённый на оценённый полевой средний расход эмиттера — той же формы, что классическая равномерность распределения по нижней четверти (среднее нижней группы &divide; среднее совокупности), но вычисленная из небольшого смоделированного образца и пользовательской оценки, не полного полевого статистического образца. Значения на уровне или выше 1 возможны и это не ошибка: это просто означает, что последний эмиттер не является низкой точкой относительно оценённого полевого среднего (например, благоприятный уклон вниз, или оценка &Delta;давления выше слишком мала).">Проверка однородности, q<sub>last</sub>/q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_ratio']='<span class="ec-help" title="Отдельная проверка, не цифра однородности: насколько расход последнего эмиттера отступает от номинального расчётного расхода производителя. Выше 1: работает выше своей расчётной точки (например, благодаря выигрышу в отметке вниз по потоку). Ниже 1: работает ниже расчёта (типичный случай, контролируемый трением).">Расход последнего эмиттера к расчётному, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
