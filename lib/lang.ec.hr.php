...
$ec_lang['dw_kinematic_viscosity']='Kinematička viskoznost, ν <span title="1×10⁻⁶ m²/s for clean water at 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_nu']='Kinematička viskoznost, ν <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['mhp_efficiency']='Stupanj korisnog djelovanja postrojenja, η (0–1)';
...
$ec_lang['mhp_notes_1_def']='Ukupni gubitak h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, gdje je h<sub>f</sub> = f(L/D)(v²/2g) gubitak trenjem prema Darcy-Weisbachu, a h<sub>m</sub> = k<sub>m</sub>·v²/2g uključuje ulaz, koljena i ventile. Neto visina H<sub>net</sub> = H<sub>gross</sub> − h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Brzina';
$ec_lang['mhp_notes_2_def']='Cilj 1–3 m/s. Ispod 1 m/s cijev je predimenzionirana; iznad 3 m/s rastu gubici trenjem i rizik od vodnog udara.';
$ec_lang['mhp_notes_3_term']='Ciljni gubitak tlačne visine';
$ec_lang['mhp_notes_3_def']='Gubici u dovodnoj cijevi ispod 10% bruto visine su ekonomični. Optimalni kompromis između cijene cijevi i izgubljene snage obično je oko 4–6% za objekte s visoko vrijednom električnom energijom.';
...
$ec_lang['ds_main_desc']='Navodnjavanje kap po kap i raspršivanjem — norma navodnjavanja i ujednačenost';
...
$ec_lang['ds_notes_3_def']='Trajanje navodnjavanja = ciljna dubina ÷ norma navodnjavanja. Na nagnutom ili zbijenom tlu podijelite trajanje na dva ili tri kraća ciklusa s pauzama između njih kako biste izbjegli površinsko otjecanje.';
...
$ec_lang['cs_Ec_target']='Ciljna korisnost, E<sub>c,target</sub> <span title="Conveyance efficiency goal after lining; fraction 0–1" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['cs_payback_years']='Razdoblje amortizacije <span title="Simple payback = total lining cost ÷ annual value recovered" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice & Kadavy (1998) razvili su dvije empirijske jednadžbe za medijalnu veličinu obloga D<sub>50</sub> na temelju nagiba žlijeba i jediničnog protoka. Jednadžba 1 primjenjuje se za blage nagibe (S<sub>0</sub> < 0,10); Jednadžba 2 — za strme nagibe (0,10 ≤ S<sub>0</sub> ≤ 0,40). Obje jednadžbe zahtijevaju q<sub>t</sub> u m²/s i vraćaju D<sub>50</sub> u mm. Validirani raspon je 0,02 ≤ S<sub>0</sub> ≤ 0,40.';
...
$ec_lang['rc_notes_3_def']='Dio ukupnog protoka prolazi kroz pore kamenog obloga (protok kroz plašt q<sub>m</sub>); ostatak teče po površini kamena (q<sub>s</sub> = q<sub>t</sub> − q<sub>m</sub>). Dubina toka d izračunava se Manningovom jednadžbom primijenjenom na površinski protok q<sub>s</sub> s koeficijentom hrapavosti žlijeba n. Zadana poroznost n<sub>p</sub> = 0,45 tipična je za uglati drobljeni kamen.';
