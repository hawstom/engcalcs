...
$ec_lang['template_translation_help']='Možete li predložiti bolju formulaciju ili nešto drugo? Javite nam.';
...
$ec_lang['mpf_velocity_head']='<span class="ec-help" title="Kinetička energija izražena kao visina vodenog stupca, v&sup2;/2g">Brzinska visina, h<sub>v</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['mtc_sgrock']='<span class="ec-help" title="Gustoća u odnosu na vodu. Tipično &asymp; 2,65 za drobljeni kamen.">Relativna gustoća kamena, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_ratio']='<span class="ec-help" title="Ovo se razlikuje od naše procjene standardne mjere jednolikosti.">Protok zadnjeg emitera &divide; projektni protok, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_notes_3_def']='Modelira jedan fiksni tlak opskrbe (nema krivulje pumpe), samo jedan testni put (ne cijelo polje), i 2-parametarsku krivulju emitera (postavite eksponent blizu 0 za približavanje emiteru s kompenzacijom tlaka). Izvještavaju se dva različita omjera jednolikosti, namjerno odvojena: q<sub>last</sub>/q<sub>avg,field</sub> je približna vrijednost standardne jednolikosti distribucije niske grupe (prosjek niske grupe ÷ srednja vrijednost populacije); no ovo dolazi iz malog modeliranog uzorka i korisnički procijenjene ispravke, umjesto iz standardnog punog statističkog uzorka polja. Osim toga, testna laterala je namjerno pretpostavljeni najgori slučaj, pa bi njezin sirovi, neispravljeni prosjek podcijenio stvarni prosjek polja i učinio da jednolikost izgleda bolje nego što jest; unos &Delta;tlaka postoji upravo da se suprotstavi toj pristranosti. Vrijednosti jednolikosti na ili iznad 1 su i dalje moguće: to samo znači da je tlak zadnjeg emitera na ili iznad procijenjenog prosjeka polja, pa je neki drugi emiter točka najniže tlaka. To može biti zato što je zadnji emiter na nižem terenu ili zato što je procjena &Delta;tlaka premala. q<sub>last</sub>/q<sub>design</sub> je drugačija provjera, koja ne mjeri jednolikost, prema proizvođačevu nominalnom protoku &mdash; korisna za otkrivanje sustava koji je općenito pod previsokim ili preniskim tlakom, ali to je zasebna provjera koju treba čitati uz broj jednolikosti, jer projektni/nominalni protok ne ovisi o stvarnom prosječnom radnom tlaku sustava.';
