...
$ec_lang['lpn_field_text_match_pipe']='Poravnaj s kutom cijevi';
...
$ec_lang['lpn_examples_size']='{nodes} čvorova, {links} cijevi';
...
$ec_lang['lpn_ex_net3_desc']='EPANET-ov veliki primjer: 97 čvorova, dva spremnika i riječni izvor. Vrijedi ga otvoriti da vidite kako model stvarne veličine izgleda na karti.';
...
$ec_lang['lpn_inp_drop_controls']='Kontrole i pravila su izostavljeni. Svaka cijev, pumpa i ventil uvezeni su u stanju zapisanom u datoteci i to se stanje ne mijenja.';
$ec_lang['lpn_inp_drop_eps']='Ova datoteka opisuje simulaciju koja se odvija tijekom razdoblja. Ova stranica rješava jedan trenutak, pa su uvezeni samo početni uvjeti.';
...
$ec_lang['lpn_settings_defaults']='Početne vrijednosti';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Pokreće EPANET rješavač američke agencije EPA, ovdje u vašem pregledniku. Oba rješavača daju iste rezultate, a na mreži ove veličine nećete primijetiti razliku u brzini. Kad ovo prvi put uključite, preuzima se oko 650 KB, koji zatim ostaje na ovom uređaju.';
...
$ec_lang['lpn_unit_unknown']='Ovaj crtež navodi jedinicu koju ova stranica ne nudi: {unit}. Sve je zadržano i prikazano točno onako kako je uneseno, i ništa nije promijenjeno. Rezultati se ne mogu dati dok stranica ne prepozna tu jedinicu, jer nema načina utvrditi koliko je velika.';
...
$ec_lang['lpn_settings_readability_bias']='Stupnjevi lijevo od okomice prije nego se oznaka okrene';
