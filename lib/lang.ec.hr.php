...
$ec_lang['ec_name_label']='Oznaka:';
$ec_lang['ec_name_placeholder']='Oznaka za označivanje/dijeljenje';
$ec_lang['ec_name_hint']='slova, brojevi, razmaci, – _ .';
...
$ec_lang['cs_Q_in']='Dotok na početku dionica, Q<sub>in</sub>';
$ec_lang['cs_Q_out']='Otjecaj na kraju dionice, Q<sub>out</sub>';
$ec_lang['cs_Q_loss']='Stopa gubitka procjeđivanjem, Q<sub>loss</sub>';
$ec_lang['cs_loss_check']='Provjera mjerenja';
$ec_lang['cs_pct_loss']='Gubitak kao udio dotoka';
...
$ec_lang['cs_wp']='Omočeni opseg kanalne poprečnog presjeka, P<sub>w</sub>';
$ec_lang['cs_Q_loss_per_L']='Gubitak procjeđivanjem po jedinici duljine, Q<sub>loss</sub>/L';
$ec_lang['cs_water_value']='Vrijednost vode (valuta / jedinica volumena)';
$ec_lang['cs_lining_cost']='Trošak obloge (valuta / jedinica površine)';
$ec_lang['cs_Ec_target']='Ciljna korisnost transporta nakon obloge, E<sub>c,target</sub> (udio, 0&ndash;1) &mdash; cilj koji predstavlja koliko će dobro obloženi kanal zadržavati vodu';
$ec_lang['cs_lining_area']='Površina za oblogu kanala (L &times; P<sub>w</sub>)';
$ec_lang['cs_annual_value_lost']='Godišnja vrijednost izgubljene vode (valuta)';
$ec_lang['cs_annual_value_recovered']='Godišnja vrijednost oporavljena oblogom (valuta)';
$ec_lang['cs_lining_total_cost']='Ukupni trošak obloge (valuta)';
$ec_lang['cs_payback_years']='Razdoblje jednostavne amortizacije (godine)';
