...
$ec_lang['lpn_inp_drop_quality']='Ova datoteka opisuje kako se kvaliteta vode mijenja dok putuje: što je u vodi na početku, gdje ulazi više te tvari, kako reagira, i kako se miješa u spremnicima. Ova stranica izračunava starost vode i praćenje izvora, ali ne kemiju, pa se ništa od toga ovdje ne koristi. Ti retci se zadržavaju i zapisuju natrag ako spremite EPANET datoteku.';
...
$ec_lang['lpn_tip_select']='Koristite ovaj način rada da promijenite, pomaknete i povlačite stvari na karti. Stranica se sama vraća u ovaj način rada nakon nekih radnji, poput otvaranja projekta.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Skriva oznake čvorova i vodova tako da na karti ostanu samo boje. Tekst koji ste sami postavili ostaje. Vaš odabir oznaka se zadržava, a isključivanjem ove opcije oznake se vraćaju.';
...
$ec_lang['lpn_geomap']='zem. šir./duž.';
$ec_lang['lpn_xymap']='xy';
$ec_lang['lpn_file_import_geo']='Otvori xy datoteku na karti…';
$ec_lang['lpn_file_import_geo_tip']='Otvara projektnu datoteku ili EPANET datoteku u novoj kartici projekta na ovoj stranici, na karti ulica. Crtež na svijet postavljate ručno: pomaknite i zumirajte do lokacije, zatim mu prilagodite veličinu i okrenite ga. Ako su x i y u datoteci već zemljopisna dužina i širina, pritisnite gumb Ovo su već lat/lon i mreža će skočiti izravno onamo gdje pripada. Svaki broj koji ste upisali ostaje kakav jest.';
...
$ec_lang['lpn_georef_done']='Ovo je sada zem. šir./duž. projekt. Povucite bilo koji element da ga pomaknete bliže mjestu gdje se stvarno nalazi.';
...
$ec_lang['lpn_clean_map_tip']='Uklonite traku stanja i očitanje koordinata s karte, tako da snimka zaslona prikazuje samo crtež. Vaš crtež se ne dira, a ovaj izbor se ne pohranjuje; ponovno učitavanje stranice vraća očitanja.';
...
$ec_lang['lpn_time_no_engine']='Ugrađeni rješavač izračunava jedan trenutak odjednom, pa je ovo mreža samo u trenutku {time}: svaki se obrazac čita u tom trenutku, a svaki spremnik i dalje ostaje na svojoj početnoj razini umjesto da se puni i prazni. Povežite se jednom na internet da dohvatite EPANET rješavač, koji rješava cijelo razdoblje.';
...
$ec_lang['lpn_time_run_note']='Vidite mrežu u prvom trenutku izvještavanja. Ovoj mreži treba toliko dugo da izračuna cijelo svoje razdoblje da se rezultati za kasnija vremena ne ažuriraju dok radite. Pritisnite gumb Pokreni da ih ažurirate.';
...
$ec_lang['lpn_georef_asdegrees']='X i y u ovoj datoteci pročitani su kao zemljopisna dužina i širina, pa je mreža već na karti i ništa nije pomaknuto. Provjerite je li na pravom mjestu, zatim pritisnite gumb Zadrži ovaj položaj.';
...
$ec_lang['lpn_result_water_age_tip']='Koliko je dugo voda koja stiže do ove točke bila u sustavu. Ne postoji propisano ograničenje s kojim biste tu vrijednost uspoređivali, pa broj prosudite prema vlastitom sustavu.';
...
$ec_lang['lpn_new_coords_xy']='xy koordinate';
$ec_lang['lpn_new_coords_geo']='zem. šir./duž.';
$ec_lang['lpn_new_coords_tip']='Xy projekt koristi koordinate koje nisu zemljopisna širina i dužina. Zem. šir./duž. projekt ima geografske koordinate, pa se iza njega može nacrtati karta ulica ili satelitska slika, a kote čvorova mogu se očitati iz terena. Xy projekt može se pretvoriti u zem. šir./duž. pomoću Datoteka, Otvori xy datoteku na karti.';
$ec_lang['lpn_new_place']='Započni blizu ovog mjesta';
$ec_lang['lpn_new_place_tip']='Neobavezno. Upišite grad, ulicu ili znamenitost i nova karta otvorit će se ondje. Riječi koje upišete šalju se OpenStreetMapovoj usluzi za nazive mjesta, koja prvi put traži vaš pristanak. Ostavite prazno i karta će se otvoriti na cijelom svijetu.';
$ec_lang['lpn_new_place_hint']='Petaluma, Kalifornija';
$ec_lang['lpn_new_create']='Stvori';
$ec_lang['lpn_inp_drop_rules']='Ova datoteka ima kontrole temeljene na pravilima. One se ovdje ne primjenjuju, pa cijevi, pumpe i ventili koje navode ostaju u stanju zapisanom u datoteci. Sama pravila se zadržavaju i zapisuju natrag ako spremite EPANET datoteku.';
$ec_lang['lpn_inp_drop_energy']='Ova EPANET datoteka sadrži podatke za modeliranje troška pumpanja. Ova stranica ne izračunava energiju ni trošak, pa se ti brojevi ovdje ne koriste. Zadržavaju se i zapisuju natrag ako spremite EPANET datoteku.';
$ec_lang['lpn_inp_drop_tags']='Ova datoteka dodjeljuje tagove nekim svojim čvorovima, cijevima ili drugim elementima. Na ovoj stranici još ne postoji mjesto za prikaz ili promjenu taga. Tagovi se zadržavaju i zapisuju natrag ako spremite EPANET datoteku.';
$ec_lang['lpn_inp_drop_report']='Ova datoteka sadrži EPANET-ove vlastite postavke za izvještaje koje ispisuje. Ova stranica prikazuje svoje odgovore na svoj način, pa se ovdje ništa od toga ne koristi. Zadržavaju se i zapisuju natrag ako spremite EPANET datoteku.';
...
$ec_lang['lpn_inp_drop_quality_options']='Ova datoteka navodi EPANET-ove opcije kvalitete vode: Quality, koja imenuje vrstu analize kvalitete vode, i dvije postavke vezane uz kemikaliju, Relative diffusivity i Quality tolerance. Starost vode i praćenje izvora ovdje se izračunavaju; kemikalija se ne izračunava, pa se te dvije postavke zadržavaju bez upotrebe. Sve se zapisuju natrag ako spremite EPANET datoteku.';
...
$ec_lang['lpn_settings_quality_track_tip']='Odaberite što pokretanje treba pratiti kroz cijevi: koliko je dugo voda u sustavu, ili odakle je došla. Ni za jedno nije potrebna koncentracija ni brzina reakcije.';
...
$ec_lang['lpn_quality_chemical']='Kemikalija koju navodi ova datoteka (pohranjena, ne izračunata)';
$ec_lang['lpn_quality_needs_run']='Kvaliteta vode nosi se kroz cijevi tijekom vremena, pa je potreban EPANET rješavač i ukupno vrijeme rada. Postavite Ukupno vrijeme rada pod Vrijeme, zatim pritisnite Pokreni.';
...
$ec_lang['lpn_ff_menu']='Protupožarni protok…';
...
$ec_lang['lpn_ff_title']='Protupožarni protok';
...
$ec_lang['lpn_ff_required_node_tip']='Protupožarni protok potreban na ovom određenom čvoru, prema vašem protupožarnom propisu ili vatrogasnom tijelu, za namjenu površine koju opslužuje. Ostavite prazno i čvor se testira prema broju u polju Potrebni protupožarni protok.';
