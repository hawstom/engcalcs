...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="Visina hrapavosti (Darcy-Weisbach)"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">Koeficijent lokalnih gubitaka, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">Kinematička viskoznost, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_e']='<span class="ec-help" title="Darcy-Weisbach visina hrapavosti">e <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_ratio']='<span class="ec-help" title="Odvojena provjera, ne figura jednolikosti: koliko daleko zadnji emiter ide od proizvođačeva nominalnog projektnog protoka. Iznad 1: radi iznad svoje projektne točke (npr. iz povoljnog padajućeg dobinka elevacije). Ispod 1: radi ispod projektnog (tipičan slučaj dominiran trenjem).">Protok zadnjeg emitera prema projektnom protoku, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_payback_years']='<span class="ec-help" title="Simple payback = total lining cost ÷ annual value recovered">Razdoblje amortizacije <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="Tipičan drobljeni granit ili bazalt ≈ 2,65. Robinsonov važeći raspon: 2,54 do 2,82.">Relativna gustoća kamena, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_yn']='<span class="ec-help" title="Uspor (Hp &gt; yn) je dobar &mdash; smanjuje eroziju uzvodno. (USDA)">Normalna dubina u ulaznom kanalu, y<sub>n</sub> <span class="ec-tip">?</span></span>';
