...
$ec_lang['lpn_inp_drop_quality']='Diese Datei beschreibt, wie sich die Wasserqualität unterwegs ändert: was anfangs im Wasser enthalten ist, wo mehr von diesem Stoff eintritt, wie er reagiert und wie die Tanks mischen. Diese Seite berechnet Wasseralter und Quellenverfolgung, aber nicht die Chemie, daher wird nichts davon hier verwendet. Diese Zeilen werden beibehalten und beim Speichern als EPANET-Datei zurückgeschrieben.';
...
$ec_lang['lpn_tip_select']='Verwenden Sie diesen Modus, um Dinge auf der Karte zu ändern, zu verschieben und zu ziehen. Die Seite kehrt nach manchen Aktionen von selbst zu diesem Modus zurück, etwa nach dem Öffnen eines Projekts.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Blendet die Knoten- und Rohrbeschriftungen aus, sodass nur die Farben auf der Karte bleiben. Von Ihnen selbst platzierter Text bleibt erhalten. Ihre Beschriftungsauswahl bleibt gespeichert und kehrt zurück, wenn Sie dies wieder ausschalten.';
...
$ec_lang['lpn_file_import_geo']='Eine xy-Datei auf der Karte öffnen…';
$ec_lang['lpn_file_import_geo_tip']='Öffnet eine Projektdatei oder eine EPANET-Datei in einem neuen Projekt-Tab auf dieser Seite, auf der Straßenkarte. Sie platzieren die Zeichnung von Hand auf der Welt: Schwenken und zoomen Sie zum Standort, dann skalieren und drehen Sie sie passend. Wenn x und y in der Datei bereits eine Länge und eine Breite sind, drücken Sie Diese sind bereits Breite/Länge, und das Netz springt direkt an seinen richtigen Platz. Jede von Ihnen eingegebene Zahl bleibt genau, wie sie ist.';
...
$ec_lang['lpn_clean_map_tip']='Blendet die Statuszeile und die Koordinatenanzeige von der Karte aus, sodass ein Screenshot nur die Zeichnung zeigt. Ihre Zeichnung bleibt unverändert, und diese Wahl wird nicht gespeichert; beim Neuladen der Seite erscheinen die Anzeigen wieder.';
...
$ec_lang['lpn_result_water_age_tip']='Wie lange sich das Wasser, das diesen Punkt erreicht, bereits im System befindet. Es gibt keinen behördlichen Grenzwert, an dem sich die Zahl messen lässt; beurteilen Sie sie im Zusammenhang mit Ihrem eigenen System.';
...
$ec_lang['lpn_new_coords_xy']='xy-Koordinaten';
$ec_lang['lpn_new_coords_geo']='Breite/Länge';
$ec_lang['lpn_new_coords_tip']='Ein xy-Projekt verwendet Koordinaten, die keine Breite und Länge sind. Ein Breite/Länge-Projekt hat geografische Koordinaten, sodass eine Straßenkarte oder ein Satellitenbild dahinter gezeichnet werden kann und Knotenhöhen aus dem Gelände gelesen werden können. Ein xy-Projekt kann mit Datei, Eine xy-Datei auf der Karte öffnen in ein Breite/Länge-Projekt umgewandelt werden.';
$ec_lang['lpn_new_place']='In der Nähe dieses Ortes beginnen';
$ec_lang['lpn_new_place_tip']='Optional. Geben Sie eine Stadt, eine Straße oder ein Wahrzeichen ein, und die neue Karte öffnet sich dort. Die eingegebenen Wörter gehen an den Ortsnamendienst von OpenStreetMap, der Sie beim ersten Mal um Erlaubnis bittet. Bleibt es leer, öffnet sich die Karte bei der ganzen Welt.';
$ec_lang['lpn_new_place_hint']='Petaluma, Kalifornien';
$ec_lang['lpn_new_create']='Erstellen';
$ec_lang['lpn_inp_drop_rules']='Diese Datei hat regelbasierte Steuerungen. Sie werden hier nicht angewendet, daher bleiben die darin genannten Rohre, Pumpen und Ventile in dem in der Datei geschriebenen Zustand. Die Regeln selbst werden beibehalten und beim Speichern als EPANET-Datei zurückgeschrieben.';
$ec_lang['lpn_inp_drop_energy']='Diese EPANET-Datei enthält Daten zur Pumpenkostenmodellierung. Diese Seite berechnet keine Energie oder Kosten, daher verwendet nichts hier diese Zahlen. Sie werden beibehalten und beim Speichern als EPANET-Datei zurückgeschrieben.';
$ec_lang['lpn_inp_drop_tags']='Diese Datei gibt einigen ihrer Entnahmeknoten, Rohre oder anderen Elemente Kennzeichnungen. Auf dieser Seite gibt es noch keine Stelle, um eine Kennzeichnung zu sehen oder zu ändern. Die Kennzeichnungen werden beibehalten und beim Speichern als EPANET-Datei zurückgeschrieben.';
$ec_lang['lpn_inp_drop_report']='Diese Datei enthält EPANETs eigene Einstellungen für die von ihm gedruckten Berichte. Diese Seite zeigt ihre Ergebnisse auf ihre eigene Art, daher verwendet nichts hier diese Einstellungen. Sie werden beibehalten und beim Speichern als EPANET-Datei zurückgeschrieben.';
...
$ec_lang['lpn_inp_drop_quality_options']='Diese Datei gibt EPANET-Wasserqualitätsoptionen an: Qualität, die die Art der Wasserqualitätsanalyse benennt, sowie zwei Einstellungen zu einer Chemikalie, Relative Diffusivität und Qualitätstoleranz. Wasseralter und Quellenverfolgung werden hier berechnet; eine Chemikalie nicht, daher werden diese beiden Einstellungen beibehalten, ohne verwendet zu werden. Alle werden beim Speichern als EPANET-Datei zurückgeschrieben.';
...
$ec_lang['lpn_settings_quality_track_tip']='Wählen Sie, was der Lauf durch die Rohre verfolgen soll: wie lange das Wasser schon im System ist, oder woher es kommt. Keines von beiden braucht eine Konzentration oder eine Reaktionsrate.';
...
$ec_lang['lpn_quality_chemical']='Eine von dieser Datei benannte Chemikalie (gespeichert, nicht berechnet)';
$ec_lang['lpn_quality_needs_run']='Die Wasserqualität wird über die Zeit durch die Rohre mitgeführt, daher braucht sie den EPANET-Löser und eine Gesamtlaufzeit. Legen Sie unter Zeit eine Gesamtlaufzeit fest, und drücken Sie dann auf die Schaltfläche Berechnen.';
...
$ec_lang['lpn_ff_required_node_tip']='Der an diesem bestimmten Entnahmeknoten erforderliche Löschwasserbedarf, laut Ihrer Feuerschutzvorschrift oder Ihrer Feuerwehrbehörde für die von ihm versorgte Landnutzung. Lassen Sie es leer, wird der Entnahmeknoten gegen die Zahl im Feld Löschwasserbedarf getestet.';
