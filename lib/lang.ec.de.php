...
$ec_lang['mphl_total_junction_k_tip']='Minderverlust (Einzelverlust)-Beiwert, k<sub>m</sub>. Diese Verluste treten an Rohrverzweigungen, Einläufen, Auslässen, Krümmern und Armaturen auf — die Bezeichnung „gering“ ist üblich, aber irreführend; auf einer kurzen Leitung können sie die Reibungsverluste erreichen oder übersteigen. Typische k-Werte: scharfkantiger Einlauf 0,5, je 45°-Krümmer 0,2–0,3, Schieber (vollständig geöffnet) 0,1, Klappenventil 0,2, Auslass (in Reservoir oder Atmosphäre) 1,0. Alle Formstücke zur Ermittlung des gesamten k<sub>m</sub> addieren. Der Standardwert 2,0 geht von einem Einlauf, einem Auslass und zwei 45°-Krümmern aus.';
