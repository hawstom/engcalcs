...
$ec_lang['mtc_sgrock']='Rohdichte des Steins, sg <span title="Typisch &asymp; 2,65 für Schotter" class="ec-tip">?</span>';
...
$ec_lang['ip_se']='Emitterabstand entlang der Lateral, S<sub>e</sub>';
$ec_lang['ip_sl']='Lateralabstand (Reihenabstand), S<sub>l</sub>';
$ec_lang['ip_n_e']='Emitter pro Lateral, n<sub>e</sub>';
$ec_lang['ip_n_l']='Lateralen pro Zone, n<sub>l</sub>';
$ec_lang['ip_d']='Ziel-Ausbringungstiefe, d';
$ec_lang['ip_a_e']='Fläche pro Emitter, A<sub>e</sub>';
$ec_lang['ip_pr']='Ausbringungsrate (Niederschlagsrate), PR';
$ec_lang['ip_q_lat']='Durchfluss pro Lateral, Q<sub>lat</sub>';
$ec_lang['ip_q_sys']='Zonendurchfluss, Q<sub>zone</sub>';
$ec_lang['ip_t_run']='Laufzeit für Zieltiefe (Stunden)';
$ec_lang['ip_main_menu']='Bewässerungsdruck';
$ec_lang['ip_main_title']='Kostenloser Online-Rechner Bewässerungsdruck und Verteilungsgleichförmigkeit';
$ec_lang['ip_main_desc']='Testleitung – Druckprofil und Gleichförmigkeitsschätzung';
...
$ec_lang['ip_x']='Emitter-Abflussexponent, x <span title="0,5 für Standard-Druckausgleicher; nahe 0 für druckkompensierte Emitter" class="ec-tip">?</span>';
$ec_lang['ip_reach_table_title']='Teststrecke';
...
$ec_lang['ip_is_lateral']='Lat. <span title="Aktiviert: Diese Strecke ist ein Segment der Testleitung, die von einzelnen Emittern gezogen wird. Deaktiviert: Diese Strecke ist eine Hauptleitung und leitet Durchfluss nur an Leitungen weiter, die nicht auf dem Testpfad liegen." class="ec-tip">?</span>';
$ec_lang['ip_count']='Emitter <span title="Laterale Reihen: Emitter in dieser Strecke nur. Hauptleitungsreihen: Gesamtemitter auf Leitungen AUSSER dieser, die von dieser Strecke abzweigen. Für die Strecke rechts neben der Abzweigstelle der Testleitung selbst zählen auch alle Leitungen noch weiter unten in der Hauptleitung oder an derselben Verbindung (z. B. eine Gegenleitung) — ihr Durchfluss fließt durch diese gleiche Strecke ab, ob hier aufgelistet oder nicht." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_e']='e <span title="Darcy-Weisbach-Rauheitshöhe" class="ec-tip">?</span>';
$ec_lang['ip_km']='K<sub>m</sub> <span title="Generischer Einzelwiderstands-Beiwert für Armaturen, Ventile und Kupplungen dieser Strecke (Minimum ≥0,5 empfohlen)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='US Höhe <span title="Höhe am Unterwasserende dieser Strecke. Optional auf inneren Reihen (Standard flach / gleich wie der Knoten oben, falls leer gelassen). Erforderlich auf der letzten Reihe: dieser Wert ist die Höhe des letzten Emitters, der direkt den erforderlichen Versorgungsdruck festlegt." class="ec-tip">?</span>';
$ec_lang['ip_elev_ds_missing_warn']='Höhe des letzten Emitters (letzte Reihe) wurde leer gelassen und ist auf flach voreingestellt — Wert eingeben für genaues Ergebnis ⚠';
...
$ec_lang['ip_pressure_warn']='Niedriger/negativer Druck — Bedingungen unterhalb des atmosphärischen Drucks prüfen';
$ec_lang['ip_pressure_warn_short']='Niedrig ⚠';
$ec_lang['ip_h_far']='Druck des letzten Emitters';
$ec_lang['ip_q_supply']='Teststrecken-Versorgungsdurchfluss, Q<sub>supply</sub> <span title="Durchfluss, der nur in den modellierten Testpfad eintritt, nicht in die ganze Zone/das System — siehe Q_zone unter Anwendungsauslegung unten für die systemweit gesamte." class="ec-tip">?</span>';
...
$ec_lang['ip_dp_avg']='Geschätzter Druckunterschied, Durchschn. gegenüber Testleitung <span title="Wie viel höher (oder niedriger) Sie glauben, dass eine typische/durchschnittliche Leitung im Vergleich zu dieser Testleitung läuft. Die Testleitung ist bewusst der angenommene schlechteste Fall, daher ist sein eigener Durchschnitt ein überoptimistischer Ersatz für einen Feldurchschnitt — auf 0 gelassen, verwenden die Gleichförmigkeitsprüfung und die Anwendungsauslegungszahlen unten die eigene (wahrscheinlich optimistische) Testleitung als-ist." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='Geschätzter durchschnittlicher Emitter-Feldurchfluss, q<sub>avg,field</sub> <span title="q_avg_lateral neu bewertet bei jedem Druck der Laterale-Reihe plus dem oben eingegebenen Druckunterschied — ein Versuch, den Fehler korrigieren, dass die Testleitung der angenommene schlechteste Fall ist, nicht ein repräsentativer. Speist sowohl die Gleichförmigkeitsprüfung als auch den Anwendungsauslegungsbereich unten." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='Gleichförmigkeitsprüfung, q<sub>last</sub>/q<sub>avg,field</sub> <span title="Durchfluss des letzten Emitters geteilt durch den geschätzten durchschnittlichen Emitter-Feldurchfluss — gleiche Form wie im Lehrbuch Tiefquartil-Verteilungsgleichförmigkeit (Durchschnitt der Tiefgruppe ÷ Populationsmittelwert), aber aus einer kleinen modellierten Stichprobe und einer vom Benutzer geschätzten Korrektur, nicht aus einer vollständigen statistischen Feldstichprobe. Werte bei oder über 1 sind möglich und kein Fehler: Das bedeutet nur, dass der letzte Emitter nicht der Tiefpunkt relativ zum geschätzten Feldurchschnitt ist (z. B. ein günstiger Abwärtsverlauf, oder der Druckunterschied oben ist zu klein)." class="ec-tip">?</span>';
$ec_lang['ip_worst_case_warn']='Der Testemmitter-Druck liegt bei oder über dem Versorgungsdruck — dieser Pfad ist wahrscheinlich nicht Ihre Schlechtfall-Leitung. Prüfen Sie auf eine entferntere oder höhere-Reibungs-Leitung, oder ein Höhenprofil, das den tatsächlichen schlechtesten Fall besser darstellt.';
$ec_lang['ip_q_ratio']='Durchfluss des letzten Emitters gegenüber Bemessungsdurchfluss, q<sub>last</sub>/q<sub>design</sub> <span title="Eine separate Prüfung, keine Gleichförmigkeitszahl: wie weit der letzte Emitter vom Herstellernennenwert abläuft. Über 1: läuft über seinem Bemessungspunkt (z. B. von einem günstigen Abwärtsgewinn). Unter 1: läuft unter Bemessung (typischer Fall mit Reibungsdominanz)." class="ec-tip">?</span>';
$ec_lang['ip_no_solution']='Keine Lösung: erforderlicher Versorgungsdruck übersteigt den eingegebenen Versorgungsdruck. Versorgungsdruck erhöhen, Bedarf reduzieren oder größeres Rohr verwenden.';
$ec_lang['ip_notes_1_term']='Methode';
$ec_lang['ip_notes_1_def']='Schätzt den Druck am letzten (entferntesten) Emitter, marschiert dann die Energiegradienlinie zurück zur Versorgung, Strecke für Strecke, und addiert dabei Reibungs- und Einzelverluste. Höhe und Geschwindigkeitshöhe werden an jedem Knoten rückgerechnet, um den tatsächlichen Druck dort zu melden. Der geschätzte Fernendruck wird (Bisektion) angepasst, bis der berechnete erforderliche Versorgungsdruck mit dem eingegebenen Versorgungsdruck übereinstimmt — das gleiche geschlossene Probleme, das vom Rohrdurchfluss-Solver im Manning-Rohrdurchfluss-Rechner gelöst wird, erweitert auf ein verzweigtes Netzwerk.';
$ec_lang['ip_notes_2_term']='Hauptleitung gegenüber Lateralstrecken';
$ec_lang['ip_notes_2_def']='Jede Reihe ist eine Strecke entlang des einzigen hydraulisch schlechtesten Pfades (des Testpfades) von der Versorgung zum letzten Emitter. Eine Hauptleitungsstrecke leitet Durchfluss nur zu Leitungen weiter, die nicht auf dem Testpfad liegen, daher ist sein Entnahmewert eine einfache Multiplikation (Bemessungsdurchfluss × Gesamt-Emitter-Anzahl dieser Strecke) — keine lokale Druckempfindlichkeit. Die Hauptleitung ist ein gemeinsames Stammrohr, daher muss die Strecke rechts neben der Abzweigstelle der Testleitung selbst nicht nur Leitungen zwischen ihren eigenen Endpunkten, sondern auch alle Leitungen noch weiter unten in der Hauptleitung jenseits dieser Abzweigstelle oder an derselben Verbindung (z. B. eine Gegenleitung) einschließen — ihr Durchfluss fließt durch diese gleiche Strecke, ob oder ob nicht an anderer Stelle in dieser Tabelle aufgelistet. Eine Lateralstrecke ist ein Segment der Testleitung selbst: Die Emitter-Entladung wird aus dem tatsächlichen lokalen Druck über q = k·H<sup>x</sup> berechnet, und der Reibungsverlust wird durch Christiansens F(n)-Faktor reduziert, um die Durchflussabnahme zu berücksichtigen, da jeder Emitter in der Strecke abzweigt.';
$ec_lang['ip_notes_3_term']='Grenzen';
$ec_lang['ip_notes_3_def']='Modelliert einen festen Eingangsdruck (keine Pumpenkennlinie), einen Testpfad nur (nicht das gesamte Feld), und eine 2-Parameter-Emitterkurve (setzen Sie den Exponent nahe 0, um eine druckkompensierte Emitter approximieren). Zwei verschiedene Verhältnisse werden bewusst separat angegeben: q<sub>last</sub>/q<sub>avg,field</sub> ist eine Gleichförmigkeitsprüfung, geformt wie Lehrbuch-Tiefquartil-Verteilungsgleichförmigkeit (Durchschnitt der Tiefgruppe ÷ Populationsmittelwert), aber berechnet aus den eigenen modellierten Emittern der Testleitung, korrigiert durch einen eingegebenen Druckunterschied-Schätzung statt einer vollständigen statistischen Feldstichprobe — die Testleitung ist bewusst der angenommene schlechteste Fall, daher würde sein ungeminderter Durchschnitt den wahren Feldurchschnitt unterschätzen und würde die Gleichförmigkeit besser aussehen lassen als sie ist; die Druckunterschiedseingabe existiert speziell, um diese Verzerrung zu zähmen. Werte bei oder über 1 sind immer noch möglich (z. B. die Druckunterschied-Schätzung ist zu klein, oder ein günstiger Abwärtsverlauf). q<sub>last</sub>/q<sub>design</sub> ist eine verschiedene Nicht-Gleichförmigkeitsprüfung gegen den Herstellernennenwert-Durchfluss — nützlich zum Erkennen eines über- oder unterdruck-Gesamtsystems, aber kein Ersatz für die Gleichförmigkeitszahl, da der Bemessungs-/Nenndurchfluss keine notwendige Beziehung zum tatsächlichen mittleren Betriebsdruck des Systems hat.';
$ec_lang['ip_notes_4_term']='Literatur';
$ec_lang['ip_notes_4_def']='Christiansen, J.E. (1942). „Bewässerung durch Besprühen." California Agricultural Experiment Station Bulletin 670. ASAE/ASABE-Standards für die Mikrobewässerungsauslegung verwenden den gleichen Multi-Auslass-Reibungsverlust-Ansatz.';
$ec_lang['ip_notes_5_term']='Anwendungsauslegung';
$ec_lang['ip_notes_5_def']='Anwendungsrate und System-/Zonen-Durchfluss verwenden den geschätzten durchschnittlichen Emitter-Feldurchfluss (q<sub>avg,field</sub> — den eigenen Durchschnitt der Testleitung, korrigiert durch die eingegebene Druckunterschied-Schätzung), nicht einen geschätzten Satz: PR = q<sub>avg,field</sub> / A<sub>e</sub>, gespeist von dem korrigierten modellierten Wert. Abstand und systemweite Lateral-/Emitter-Anzahlen sind separate Eingaben hier, da der Testpfad nur einen Schlechtfall-Zweig modelliert, nicht jeden Lateral im Feld.';
