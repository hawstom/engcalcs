...
$ec_lang['lpn_file_convert_as']='Eine xy-Datei auf der Karte öffnen…';
$ec_lang['lpn_file_convert_as_tip']='Öffnet eine Projektdatei oder eine EPANET-Datei in einem neuen Projekt-Tab auf dieser Seite, auf der Straßenkarte. Sie platzieren die Zeichnung von Hand auf der Welt: Schwenken und zoomen Sie zum Standort, dann skalieren und drehen Sie sie passend. Wenn x und y in der Datei bereits eine Länge und eine Breite sind, drücken Sie Diese sind bereits Breite/Länge, und das Netz springt direkt an seinen richtigen Platz. Jede von Ihnen eingegebene Zahl bleibt genau, wie sie ist.';
