...
$ec_lang['mhp_nu']='Kinematische Viskosität, &nu;, in m<sup>2</sup>/s (1E-6 für Wasser nahe 20&deg;C)';
...
$ec_lang['mhp_vel_low']='unter 1 m/s — Durchmesser verkleinern ⚠';
$ec_lang['mhp_vel_high']='über 3 m/s — Durchmesser vergrößern ⚠';
...
$ec_lang['mhp_notes_1_def']='Gesamtverlust der Druckrohrleitung h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, wobei h<sub>f</sub> = f(L/D)(v&sup2;/2g) der Darcy-Weisbach-Reibungsverlust ist und h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g Einläufe, Krümmer und Armaturen berücksichtigt. Nettofallhöhe H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Fließgeschwindigkeit';
$ec_lang['mhp_notes_2_def']='Zielbereich: 1&ndash;3 m/s. Unter 1 m/s ist das Rohr für den Durchfluss überdimensioniert; über 3 m/s steigen die Reibungsverluste und das Risiko eines Wasserschlags.';
$ec_lang['mhp_notes_3_term']='Druckverlustziel';
$ec_lang['mhp_notes_3_def']='Verluste in der Druckrohrleitung unter 10 % der Bruttofallhöhe sind in der Regel wirtschaftlich. Der optimale Kompromiss zwischen Rohrkosten und Leistungsverlust liegt für wertvolle Stromerzeugungs-Standorte oft bei 4&ndash;6 %.';
$ec_lang['mhp_notes_4_term']='Einzelwiderstände k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Typische Werte: scharfkantige Einlauföffnung 0,5, jeder 45&deg;-Krümmer 0,2&ndash;0,3, Schieber (vollständig geöffnet) 0,1, Schmetterlingsklappe 0,2. Alle Einbauten summieren für den Gesamt-k<sub>m</sub>. Standardwert 1,5 geht von einem Einlauf und zwei Krümmern aus.';
$ec_lang['mhp_notes_5_term']='Rohrrauheit e';
$ec_lang['mhp_notes_5_def']='Typische absolute Rauheit: Stahl (neu) 0,046&nbsp;mm, Stahl (gebraucht) 0,15&nbsp;mm, HDPE 0,003&nbsp;mm, PVC/uPVC 0,0015&nbsp;mm, Beton 0,3&ndash;3&nbsp;mm. HDPE ist bei kleinen Mikro-Wasserkraft-Druckrohrleitungen weit verbreitet.';
