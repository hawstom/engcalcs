...
$ec_lang['ds_main_desc']='Tropf- &amp; Sprinklerbewässerung &mdash; Ausbringungsrate und Gleichmäßigkeit';
$ec_lang['ds_q_avg']='Durchschnittliche Emitterdurchflussrate, q';
$ec_lang['ds_q_min']='Minimale Emitterdurchflussrate, q<sub>min</sub>';
...
$ec_lang['ds_du']='Verteilungsgleichmäßigkeit, DU';
$ec_lang['ds_du_check']='DU-Qualitätsprüfung';
...
$ec_lang['ds_du_excellent']='Ausgezeichnet — DU ≥ 90% ✓';
$ec_lang['ds_du_good']='Gut — DU ≥ 80% ✓';
$ec_lang['ds_du_acceptable']='Akzeptabel — DU ≥ 70%';
$ec_lang['ds_du_poor']='Schlecht — DU < 70% — Design überprüfen ⚠';
$ec_lang['ds_notes_1_term']='Ausbringungsrate';
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>, wobei A<sub>e</sub> = S<sub>e</sub> &times; S<sub>l</sub> die von jedem Emitter versorgte Fläche ist. Eine niedrigere Ausbringungsrate gibt mehr Zeit für die Infiltration &mdash; wichtig bei schweren Böden oder geneigten Feldern.';
$ec_lang['ds_notes_2_term']='Verteilungsgleichmäßigkeit (DU)';
$ec_lang['ds_notes_2_def']='DU = q<sub>min</sub> / q<sub>avg</sub>. Ein DU von 1,0 (100%) bedeutet, dass alle Emitter identisch fließen. Werte unter 0,80 verschwenden Wasser in gut bewässerten Bereichen, während trockenere Stellen entstehen. Die Gleichmäßigkeit nimmt bei übermäßigen Druckschwankungen entlang der Lateral, Emitterverschleiß oder teilweiser Verstopfung ab.';
$ec_lang['ds_notes_3_term']='Laufzeit';
$ec_lang['ds_notes_3_def']='Laufzeit = Zieltiefe &divide; Ausbringungsrate. Auf geneigtem oder verdichtetem Boden die Laufzeit in zwei oder drei kürzere Zyklen mit Ruhepausen aufteilen, um Oberflächenabfluss zu vermeiden.';
...
$ec_lang['cs_main_desc']='Kanaldurchsickerungsverlust &amp; Transportwirkungsgrad &mdash; Zu-/Abfluss-Methode';
...
$ec_lang['cs_water_value']='Wasserpreis (Währung je Volumeneinheit)';
$ec_lang['cs_lining_cost']='Auskleidungskosten (Währung je Flächeneinheit)';
$ec_lang['cs_Ec_target']='Angestrebter Transportwirkungsgrad nach Auskleidung, E<sub>c,target</sub> (Bruchteil, 0&ndash;1) &mdash; Ziel für den Wasserrückhalt des ausgekleideten Kanals';
$ec_lang['cs_lining_area']='Kanalauskleidungsfläche (L &times; P<sub>w</sub>)';
...
$ec_lang['cs_notes_1_def']='Die Zu-/Abfluss-Methode schätzt die Versickerung durch Messung des Durchflusses am Anfang und Ende einer Kanalhaltung: Q<sub>loss</sub> = Q<sub>in</sub> &minus; Q<sub>out</sub>. Transportwirkungsgrad E<sub>c</sub> = Q<sub>out</sub> / Q<sub>in</sub>. Das Jahresvolumen setzt einen kontinuierlichen Vollbetrieb voraus; tatsächliche Verluste sind bei saisonalem oder Teilbetrieb geringer.';
$ec_lang['cs_notes_2_term']='Wirkungsgradklassen';
$ec_lang['cs_notes_2_def']='Typische unbefestigte Erdkanäle: E<sub>c</sub> = 60&ndash;80%. Gut unterhaltene Erdkanäle: 75&ndash;85%. Betonausgekleidete Kanäle: 90&ndash;98%. Versickerungsverluste über 30&nbsp;% des Zuflusses rechtfertigen häufig eine Auskleidungsinvestition. (USBR, FAO)';
$ec_lang['cs_notes_3_term']='Amortisation der Auskleidung';
$ec_lang['cs_notes_3_def']='Wasserpreis und Auskleidungskosten in einer einheitlichen Währung eingeben. Auskleidungsfläche = Haltungslänge &times; benetzter Umfang &mdash; der benetzte Umfang des Kanalquerschnitts bei der gemessenen Fließtiefe (Sohlbreite plus beide benetzten Böschungen). Der jährlich zurückgewonnene Wert setzt voraus, dass der ausgekleidete Kanal das Ziel-E<sub>c</sub> dauerhaft erreicht. Die tatsächliche Amortisationszeit ist bei saisonalen Kanälen oder bei Nichterreichen der Zieleffizienz länger.';
...
$ec_lang['rc_main_desc']='Steingerinne Bruchsteinbemessung &mdash; Robinson, Rice &amp; Kadavy (1998)';
...
$ec_lang['rc_layer']='Steinlagenstärke (2 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_radius']='Krümmungsradius Oberkante (40 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_length']='Bogenlänge Oberkante';
$ec_lang['rc_apron_length']='Vorschüttstrecke Auslauf (15 &times; D<sub>50</sub>) <span title="Erforderlich zur Lagestabilisierung des Gerinneschotters. &quot;Der minimale Unterwasserstand, der durch den Auslaufbereich und den Widerstand des Unterliegergerinnes entsteht, ist ausreichend, um die Stabilität des Bruchsteins im Auslaufbereich zu gewährleisten.&quot; (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_qs']='Oberflächenspezifischer Abfluss, q<sub>s</sub> (q<sub>t</sub> &minus; q<sub>m</sub>)';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice &amp; Kadavy (1998) entwickelten zwei empirische Gleichungen für den mittleren Bruchsteindurchmesser D<sub>50</sub> in Abhängigkeit von Gefälle und spezifischem Abfluss. Gleichung 1 gilt für flache Gefälle (S<sub>0</sub> &lt; 0,10); Gleichung 2 gilt für steile Gefälle (0,10 &le; S<sub>0</sub> &le; 0,40). Beide Gleichungen erfordern q<sub>t</sub> in m&sup2;/s und liefern D<sub>50</sub> in mm. Der validierte Bereich ist 0,02 &le; S<sub>0</sub> &le; 0,40.';
$ec_lang['rc_notes_2_term']='Spezifischer Abfluss';
$ec_lang['rc_notes_2_def']='q<sub>t</sub> ist der gesamte spezifische Abfluss an der Gerinneoberkante (Gesamtabfluss je Breiteneinheit). Für ein Gerinne mit Sohlbreite B und Gesamtabfluss Q gilt näherungsweise q<sub>t</sub> &asymp; Q / B, oder es wird aus der Grenztiefenbedingung am Gerinneeinlauf berechnet.';
$ec_lang['rc_notes_3_term']='Durchfluss durch die Steinmatte';
$ec_lang['rc_notes_3_def']='Ein Teil des Gesamtabflusses fließt durch die Poren des Bruchsteins (Mattendurchfluss q<sub>m</sub>); der Rest fließt über die Steinoberfläche (q<sub>s</sub> = q<sub>t</sub> &minus; q<sub>m</sub>). Die Fließtiefe d wird aus der Manning-Gleichung für den Oberflächenabfluss q<sub>s</sub> mit der Gerinnorauheit n berechnet. Die Standardporosität n<sub>p</sub> = 0,45 ist typisch für gebrochenes Kantgestein.';
