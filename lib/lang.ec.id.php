...
$ec_lang['lpn_field_text_match_pipe']='Samakan dengan penghubung terdekat';
...
$ec_lang['lpn_field_show_always']='Selalu tampilkan label ini';
...
$ec_lang['lpn_settings_label_max_width']='Tampilkan label saat tampilan lebih sempit dari ini (satuan peta)';
$ec_lang['lpn_settings_label_use_view']='Gunakan tampilan saat ini';
$ec_lang['lpn_settings_label_always']='Selalu tampilkan label';
...
$ec_lang['lpn_time_format_tip']='Tulis waktu sebagai jam dan menit, seperti 2:30. Angka polos berarti jam; angka dengan satuannya sendiri berarti satuan itu: 30 menit.';
$ec_lang['lpn_time_running']='Menyelesaikan seluruh periode waktu dengan mesin EPANET.';
$ec_lang['lpn_time_no_engine']='Penyelesai bawaan menyelesaikan satu saat dalam satu waktu, sehingga ini adalah jaringan pada {time} saja: kebutuhan membawa pengali pola untuk saat itu, dan setiap tangki masih berada pada tingkat awalnya, bukan terisi dan mengosong. Sambungkan ke internet sekali untuk mengambil mesin EPANET, yang menjalankan seluruh periode.';
