...
$ec_lang['ds_se']='Jarak emitter sepanjang lateral, S<sub>e</sub>';
$ec_lang['ds_sl']='Jarak lateral (jarak baris), S<sub>l</sub>';
...
$ec_lang['ds_pr']='Laju aplikasi (laju presipitasi), PR';
...
$ec_lang['ds_t_run']='Waktu operasi untuk kedalaman target (jam)';
...
$ec_lang['cs_wp']='Keliling basah penampang saluran, P<sub>w</sub>';
$ec_lang['cs_Q_loss_per_L']='Kehilangan rembesan per satuan panjang, Q<sub>loss</sub>/L';
$ec_lang['cs_water_value']='Nilai air (mata uang / unit volume)';
$ec_lang['cs_lining_cost']='Biaya pelapisan (mata uang / unit luas)';
$ec_lang['cs_Ec_target']='Target efisiensi konveyans setelah pelapisan, E<sub>c,target</sub> (fraksi, 0&ndash;1) &mdash; tujuan untuk seberapa baik saluran berlapis akan mempertahankan air';
$ec_lang['cs_lining_area']='Luas pelapisan saluran (L &times; P<sub>w</sub>)';
$ec_lang['cs_annual_value_lost']='Nilai tahunan air yang hilang (mata uang)';
$ec_lang['cs_annual_value_recovered']='Nilai tahunan yang dipulihkan oleh pelapisan (mata uang)';
$ec_lang['cs_lining_total_cost']='Biaya pelapisan total (mata uang)';
$ec_lang['cs_payback_years']='Periode pengembalian sederhana (tahun)';
