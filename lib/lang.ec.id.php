...
$ec_lang['dw_roughness_tip']='<span class="ec-help" title="Tinggi kekasaran Darcy-Weisbach"><span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">Koefisien kehilangan minor, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">Viskositas kinematik, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="Granit atau basalt pecah biasa ≈ 2.65. Rentang valid Robinson: 2.54 hingga 2.82.">Berat jenis batu, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_apron_length']='<span class="ec-help" title="Diperlukan untuk dukungan struktural batu saluran curam. &quot;Tailwater minimum yang terjadi akibat saluran outlet dan resistansi saluran hilir cukup untuk memastikan stabilitas riprap pada saluran outlet.&quot; (Robinson)">Panjang lantai hilir outlet (15 × D<sub>50</sub>) <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_e']='<span class="ec-help" title="Tinggi kekasaran Darcy-Weisbach">e <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_dp_avg']='<span class="ec-help" title="Seberapa jauh lebih tinggi (atau lebih rendah) Anda memperkirakan lateral tipikal beroperasi dibandingkan lateral pengujian ini. Lateral pengujian sengaja dianggap sebagai kasus terburuk, sehingga rata-ratanya sendiri merupakan estimasi yang terlalu rendah untuk rata-rata lapangan — jika dibiarkan pada 0, pemeriksaan keseragaman dan angka desain aplikasi di bawah menggunakan rata-rata lateral pengujian itu sendiri (kemungkinan optimistis) apa adanya.">Est. &Delta;tekanan, rata-rata vs. lateral pengujian <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_ratio']='<span class="ec-help" title="Ini berbeda dari pendekatan kami terhadap ukuran keseragaman standar.">Debit emiter terakhir &divide; debit desain, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
