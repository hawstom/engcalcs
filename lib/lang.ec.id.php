...
$ec_lang['mpf_velocity_head']='<span class="ec-help" title="Energi kinetik sebagai tinggi kolom air, v&sup2;/2g">Tinggi kecepatan, h<sub>v</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['mphl_total_junction_k_tip']='Koefisien kehilangan kecil (lokal), k<sub>m</sub>. Kehilangan ini terjadi pada sambungan pipa, pintu masuk, pintu keluar, belokan, dan katup — istilah "minor" bersifat konvensional namun menyesatkan; pada jalur pipa pendek, kehilangan ini dapat menyamai atau bahkan melebihi kehilangan gesekan. Nilai k tipikal: pintu masuk tajam (sharp intake) 0,5, setiap belokan 45° 0,2–0,3, katup gerbang (gate valve, terbuka penuh) 0,1, katup kupu-kupu (butterfly valve) 0,2, pintu keluar (ke reservoir atau atmosfer) 1,0. Jumlahkan semua fitting untuk mendapatkan total k<sub>m</sub>. Nilai default 2,0 mengasumsikan satu pintu masuk, satu pintu keluar, dan dua belokan 45°.';
...
$ec_lang['mtc_sgrock']='<span class="ec-help" title="Massa jenis relatif terhadap air. Umumnya &asymp; 2,65 untuk batu pecah.">Berat jenis batu, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['rc_sg']='<span class="ec-help" title="Massa jenis relatif terhadap air. Granit atau basal pecah biasa &asymp; 2,65. Rentang valid Robinson: 2,54 hingga 2,82.">Berat jenis batu, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_notes_4_def']='Christiansen, J.E. (1942). &ldquo;Irrigation by sprinkling.&rdquo; California Agricultural Experiment Station Bulletin 670. Standar ASAE/ASABE untuk desain mikroirigasi menggunakan pendekatan kehilangan gesekan multi-outlet yang sama.';
