...
$ec_lang['ip_se']='Jarak emitter, S<sub>e</sub>';
$ec_lang['ip_sl']='Jarak lateral, S<sub>l</sub>';
$ec_lang['ip_n_e']='Emitter per lateral, n<sub>e</sub>';
$ec_lang['ip_n_l']='Lateral per zona, n<sub>l</sub>';
$ec_lang['ip_d']='Kedalaman aplikasi target, d';
$ec_lang['ip_a_e']='Luas per emitter, A<sub>e</sub>';
$ec_lang['ip_pr']='Laju aplikasi, PR';
$ec_lang['ip_q_lat']='Aliran per lateral, Q<sub>lat</sub>';
$ec_lang['ip_q_sys']='Aliran zona, Q<sub>zone</sub>';
...
$ec_lang['ip_main_desc']='Estimasi Tekanan dan Keseragaman Percabangan Pengujian';
$ec_lang['ip_h_supply']='Tekanan pasokan';
$ec_lang['ip_elev_supply']='Elevasi pasokan, z<sub>supply</sub>';
$ec_lang['ip_q_design']='Debit desain emitter, q<sub>design</sub>';
$ec_lang['ip_h_design']='Tekanan desain emitter';
$ec_lang['ip_x']='Eksponen debit emitter, x <span title="0.5 untuk emitter non-kompensasi standar; mendekati 0 untuk emitter kompensasi tekanan" class="ec-tip">?</span>';
...
$ec_lang['ip_is_lateral']='Lat. <span title="Dicentang: segmen ini adalah bagian dari lateral pengujian, ditarik oleh emitter individual. Tidak dicentang: segmen ini adalah pipa utama, hanya mengalirkan debit ke lateral yang tidak pada jalur pengujian." class="ec-tip">?</span>';
$ec_lang['ip_count']='Emitter <span title="Baris lateral: emitter di segmen ini saja. Baris pipa utama: total emitter pada lateral SELAIN ini yang bercabang dari segmen ini. Untuk segmen di pengambilan lateral pengujian sendiri, ini juga mencakup lateral apa pun di luar titik itu di sepanjang pipa utama, atau berbagi sambungan yang sama (misalnya lateral sisi berlawanan) — aliran mereka juga bercabang dari segmen yang sama." class="ec-tip">?</span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_e']='e <span title="Tinggi kekasaran Darcy-Weisbach" class="ec-tip">?</span>';
$ec_lang['ip_km']='K<sub>m</sub> <span title="Koefisien kehilangan minor generik untuk fitting/katup/kopel segmen ini (minimum ≥0.5 disarankan)" class="ec-tip">?</span>';
$ec_lang['ip_elev_ds']='Elev. Hilir <span title="Elevasi hilir segmen. Opsional pada baris interior (default rata / sama dengan node di atas jika dikosongkan). Diperlukan pada baris terakhir: nilai itu adalah elevasi emitter terakhir, yang secara langsung menetapkan tekanan pasokan yang diperlukan." class="ec-tip">?</span>';
$ec_lang['ip_elev_ds_missing_warn']='Elevasi emitter terakhir (baris terakhir) dibiarkan kosong dan default rata — masukkan untuk hasil yang akurat ⚠';
$ec_lang['ip_flow']='Aliran';
$ec_lang['ip_press']='Tekan.';
$ec_lang['ip_v']='V';
...
$ec_lang['ip_pressure_warn']='Tekanan rendah/negatif — periksa kondisi subatmosfer';
$ec_lang['ip_pressure_warn_short']='Rendah ⚠';
$ec_lang['ip_h_far']='Tekanan emitter terakhir';
$ec_lang['ip_q_supply']='Aliran pasokan jalur pengujian, Q<sub>supply</sub> <span title="Aliran yang masuk jalur pengujian model saja, bukan seluruh zona/sistem — lihat Q_zone dalam Desain Aplikasi di bawah untuk total sistem." class="ec-tip">?</span>';
$ec_lang['ip_q_critical']='Aliran emitter terakhir, q<sub>last</sub>';
$ec_lang['ip_q_avg_lateral']='Aliran emitter rata-rata (lateral pengujian), q<sub>avg</sub>';
$ec_lang['ip_dp_avg']='Est. Δtekanan, rata-rata vs. lateral pengujian <span title="Seberapa jauh lebih tinggi (atau lebih rendah) Anda percaya lateral tipikal/rata-rata berjalan dibandingkan lateral pengujian ini. Lateral pengujian sengaja dianggap kasus terburuk, jadi rata-rata sendiri adalah pengganti dengan bias-rendah untuk rata-rata lapangan — dibiarkan di 0, pemeriksaan keseragaman dan angka desain-aplikasi di bawah menggunakan rata-rata sendiri lateral pengujian (kemungkinan optimis) apa adanya." class="ec-tip">?</span>';
$ec_lang['ip_q_avg_field']='Est. aliran emitter rata-rata lapangan, q<sub>avg,field</sub> <span title="q_avg_lateral dievaluasi kembali pada tekanan setiap baris lateral ditambah perbedaan tekanan yang dimasukkan di atas — upaya untuk mengoreksi lateral pengujian yang dianggap kasus terburuk, bukan kasus representatif. Menyuplai pemeriksaan keseragaman dan bagian desain-aplikasi di bawah." class="ec-tip">?</span>';
$ec_lang['ip_du_estimate']='Pemeriksaan keseragaman, q<sub>last</sub>/q<sub>avg,field</sub> <span title="Aliran emitter terakhir yang dihitung dibagi aliran emitter rata-rata lapangan yang diestimasi — bentuk yang sama dengan Keseragaman Distribusi kuartal-rendah buku teks (rata-rata grup rendah ÷ rerata populasi), tetapi dari sampel model kecil dan koreksi yang diestimasi pengguna, bukan sampel statistik lapangan penuh. Nilai pada atau di atas 1 dimungkinkan dan bukan bug: hanya berarti emitter terakhir bukanlah titik rendah relatif terhadap rata-rata lapangan yang diestimasi (misalnya lari downhill yang menguntungkan, atau estimasi Δtekanan di atas terlalu kecil)." class="ec-tip">?</span>';
$ec_lang['ip_worst_case_warn']='Tekanan emitter pengujian sama dengan atau di atas tekanan pasokan — jalur ini tidak mungkin lateral kasus terburuk Anda. Periksa lateral yang lebih jauh atau gesekan lebih tinggi, atau profil elevasi yang lebih baik mewakili kasus terburuk nyata.';
$ec_lang['ip_q_ratio']='Aliran emitter terakhir vs. debit desain, q<sub>last</sub>/q<sub>design</sub> <span title="Pemeriksaan terpisah, bukan angka keseragaman: seberapa jauh emitter terakhir berjalan dari debit desain yang dinilai pabrikan. Di atas 1: berjalan di atas titik desainnya (misalnya dari keuntungan elevasi downhill yang menguntungkan). Di bawah 1: berjalan di bawah desain (kasus dominasi-gesekan tipikal)." class="ec-tip">?</span>';
$ec_lang['ip_no_solution']='Tidak ada solusi: tekanan pasokan yang diperlukan melebihi tekanan pasokan yang dimasukkan. Tingkatkan tekanan pasokan, kurangi permintaan, atau gunakan pipa lebih besar.';
$ec_lang['ip_notes_1_term']='Metode';
$ec_lang['ip_notes_1_def']='Menebak tekanan pada emitter terakhir (paling jauh), kemudian bergerak Garis Kelas Energi kembali ke pasokan, segmen demi segmen, menambahkan kehilangan gesekan dan minor di sepanjang jalan. Elevasi dan tinggi kecepatan dikeluarkan pada setiap node untuk melaporkan tekanan aktual di sana. Tekanan ujung jauh yang ditebak disesuaikan (biseksi) sampai tekanan pasokan yang diperlukan yang dihitung cocok dengan tekanan pasokan yang dimasukkan — masalah loop-tertutup yang sama ditangani oleh pemecah aliran pipa pada kalkulator Aliran Pipa Manning, diperluas ke jaringan bercabang.';
$ec_lang['ip_notes_2_term']='Segmen Pipa Utama vs. Lateral';
$ec_lang['ip_notes_2_def']='Setiap baris adalah satu segmen di sepanjang jalur terburuk hidraulis tunggal (jalur pengujian) dari pasokan ke emitter terakhir. Segmen Pipa Utama hanya mengalirkan debit ke lateral yang tidak pada jalur pengujian, jadi penarikannya adalah perkalian rata (debit desain × jumlah emitter total segmen) — tanpa kepekaan tekanan lokal. Pipa utama adalah pipa batang bersama, jadi segmen tepat di pengambilan lateral pengujian sendiri harus mencakup tidak hanya lateral antara titik akhirnya sendiri tetapi juga lateral apa pun yang lebih jauh di bawah pipa utama di luar pengambilan itu, atau berbagi sambungan yang sama (misalnya lateral sisi berlawanan) — aliran mereka bercabang dari segmen yang sama sebelum terpisah, terlepas dari apakah mereka muncul di tempat lain dalam tabel ini. Segmen Lateral adalah segmen dari lateral pengujian itu sendiri: debit emitter dihitung dari tekanan lokal aktual melalui q = k·H<sup>x</sup>, dan kehilangan gesekan dikurangi oleh faktor F(n) Christiansen untuk mempertimbangkan aliran menurun saat setiap emitter di segmen menarik.';
$ec_lang['ip_notes_3_term']='Keterbatasan';
$ec_lang['ip_notes_3_def']='Model satu tekanan inlet tetap (tanpa kurva pompa), satu jalur pengujian saja (bukan seluruh lapangan), dan kurva emitter parameter-2 (atur eksponen mendekati 0 untuk mendekatkan emitter kompensasi tekanan). Dua rasio berbeda dilaporkan, sengaja dipisahkan: q<sub>last</sub>/q<sub>avg,field</sub> adalah pemeriksaan keseragaman, berbentuk seperti Keseragaman Distribusi kuartal-rendah buku teks (rata-rata grup rendah ÷ rerata populasi) tetapi dihitung dari emitter model lateral pengujian sendiri, dikoreksi oleh estimasi Δtekanan yang dimasukkan daripada sampel statistik lapangan penuh — lateral pengujian sengaja dianggap kasus terburuk, jadi rata-rata mentahnya yang tidak dikoreksi akan meremehkan rerata lapangan sejati dan membuat keseragaman terlihat lebih baik dari yang sebenarnya; input Δtekanan ada khusus untuk mengatasi bias itu. Nilai pada atau di atas 1 masih dimungkinkan (misalnya estimasi Δtekanan terlalu kecil, atau lari downhill yang menguntungkan). q<sub>last</sub>/q<sub>design</sub> adalah pemeriksaan non-keseragaman yang berbeda terhadap debit yang dinilai pabrikan — berguna untuk mendeteksi sistem yang over- atau under-pressured secara keseluruhan, tetapi bukan pengganti angka keseragaman, karena debit desain/dinilai tidak memiliki hubungan perlu dengan tekanan operasi rata-rata sistem nyata.';
...
$ec_lang['ip_notes_5_def']='Laju aplikasi dan aliran sistem/zona menggunakan aliran emitter rata-rata lapangan yang diestimasi (q<sub>avg,field</sub> — rata-rata lateral pengujian sendiri, dikoreksi oleh estimasi Δtekanan yang dimasukkan), bukan laju yang ditebak: PR = q<sub>avg,field</sub> / A<sub>e</sub>, disuplai oleh nilai model yang dikoreksi. Jarak dan penghitungan lateral/emitter sistem-luas adalah input terpisah di sini karena jalur pengujian hanya model satu cabang kasus-terburuk, bukan setiap lateral di lapangan.';
