...
$ec_lang['lpn_inp_drop_quality']='Berkas ini menjelaskan bagaimana kualitas air berubah saat mengalir: apa yang ada dalam air pada awalnya, di mana lagi zat tersebut masuk, bagaimana zat itu bereaksi, dan bagaimana tangki mencampurnya. Halaman ini menghitung usia air dan penelusuran sumber, tetapi bukan kimianya, sehingga tidak ada yang digunakan di sini. Baris-baris tersebut tetap disimpan, dan akan ditulis kembali jika Anda menyimpan berkas EPANET.';
...
$ec_lang['lpn_tip_select']='Gunakan mode ini untuk mengubah, memindahkan, dan menyeret elemen di peta. Halaman ini akan kembali ke mode ini dengan sendirinya setelah tindakan tertentu, seperti membuka proyek.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Menyembunyikan label simpul dan penghubung sehingga hanya warna yang tersisa di peta. Teks yang Anda tempatkan sendiri tetap ada. Pilihan label Anda tetap disimpan, dan menonaktifkan ini akan mengembalikannya.';
...
$ec_lang['lpn_file_import_geo']='Buka berkas xy di peta…';
$ec_lang['lpn_file_import_geo_tip']='Membuka berkas proyek atau berkas EPANET pada tab proyek baru di halaman ini, di atas peta jalan. Anda menempatkan gambar pada dunia secara manual: geser dan perbesar ke lokasi, lalu ubah ukuran dan putar agar sesuai. Jika x dan y pada berkas sudah berupa garis bujur dan garis lintang, tekan tombol Ini sudah lat/lon dan jaringan akan langsung berpindah ke tempatnya. Setiap angka yang Anda ketik tetap seperti semula.';
...
$ec_lang['lpn_clean_map_tip']='Hilangkan bilah status dan pembacaan koordinat dari peta, sehingga tangkapan layar hanya menampilkan gambar. Gambar Anda tidak tersentuh, dan pilihan ini tidak disimpan; memuat ulang halaman akan mengembalikan tampilan tersebut.';
...
$ec_lang['lpn_time_no_engine']='Penyelesai bawaan menghitung satu saat dalam satu waktu, sehingga ini adalah jaringan pada {time} saja: setiap pola dibaca pada saat itu, dan setiap tangki masih berada pada tingkat awalnya, bukan terisi dan mengosong. Sambungkan ke internet sekali untuk mengambil penyelesai EPANET, yang menjalankan seluruh periode.';
$ec_lang['lpn_time_slider']='Waktu';
$ec_lang['lpn_time_no_period']='Proyek ini tidak memiliki periode waktu, sehingga hanya ada satu saat yang dapat ditampilkan. Atur Total waktu berjalan di Pengaturan untuk menghitung jaringan sepanjang waktu.';
...
$ec_lang['lpn_time_run_note']='Anda sedang melihat jaringan pada waktu pelaporan pertama. Jaringan ini membutuhkan waktu yang sangat lama untuk dihitung sepanjang seluruh periode waktunya, sehingga hasil pada waktu-waktu berikutnya tidak diperbarui selama Anda bekerja. Tekan tombol Hitung untuk memperbaruinya.';
...
$ec_lang['lpn_georef_asdegrees']='X dan y pada berkas ini dibaca sebagai garis bujur dan garis lintang, sehingga jaringan sudah berada di peta dan tidak ada yang dipindahkan. Periksa apakah letaknya sudah benar, lalu tekan tombol Simpan penempatan ini.';
...
$ec_lang['lpn_result_water_age_tip']='Berapa lama air yang mencapai titik ini telah berada dalam sistem. Tidak ada batas regulasi untuk membandingkannya, jadi nilai ini harus dinilai berdasarkan sistem Anda sendiri.';
...
$ec_lang['lpn_new_coords_xy']='koordinat xy';
$ec_lang['lpn_new_coords_geo']='lat/lon';
$ec_lang['lpn_new_coords_tip']='Proyek xy menggunakan koordinat yang bukan garis lintang dan garis bujur. Proyek lat/lon memiliki koordinat geografis, sehingga peta jalan atau gambar satelit dapat digambar di belakangnya dan elevasi simpul dapat dibaca dari medan. Proyek xy dapat diubah menjadi lat/lon dengan File, Buka berkas xy di peta.';
$ec_lang['lpn_new_place']='Mulai di dekat tempat ini';
$ec_lang['lpn_new_place_tip']='Opsional. Ketik nama kota, jalan, atau tempat terkenal, dan peta baru akan terbuka di sana. Kata-kata yang Anda ketik dikirim ke layanan nama tempat OpenStreetMap, yang akan meminta izin Anda pada penggunaan pertama. Biarkan kosong dan peta akan terbuka pada seluruh dunia.';
$ec_lang['lpn_new_place_hint']='Bandung, Jawa Barat';
$ec_lang['lpn_new_create']='Buat';
$ec_lang['lpn_inp_drop_rules']='Berkas ini memiliki kendali berbasis aturan. Aturan tersebut tidak diterapkan di sini, sehingga pipa, pompa, dan katup yang disebutnya tetap berada pada keadaan yang tertulis dalam berkas. Aturan itu sendiri tetap disimpan, dan akan ditulis kembali jika Anda menyimpan berkas EPANET.';
$ec_lang['lpn_inp_drop_energy']='Berkas EPANET ini menyertakan data pemodelan biaya pemompaan. Halaman ini tidak menghitung energi atau biaya, sehingga tidak ada yang menggunakan angka tersebut di sini. Data itu tetap disimpan, dan akan ditulis kembali jika Anda menyimpan berkas EPANET.';
$ec_lang['lpn_inp_drop_tags']='Berkas ini memberi tag pada sebagian simpul, pipa, atau elemen lainnya. Belum ada tempat di halaman ini untuk melihat atau mengubah tag. Tag tersebut tetap disimpan, dan akan ditulis kembali jika Anda menyimpan berkas EPANET.';
$ec_lang['lpn_inp_drop_report']='Berkas ini menyimpan pengaturan EPANET sendiri untuk laporan yang dicetaknya. Halaman ini menampilkan jawabannya dengan caranya sendiri, sehingga tidak ada yang menggunakan pengaturan itu di sini. Pengaturan itu tetap disimpan, dan akan ditulis kembali jika Anda menyimpan berkas EPANET.';
...
$ec_lang['lpn_inp_drop_quality_options']='Berkas ini menyatakan opsi kualitas air EPANET: Quality, yang menyebutkan jenis analisis kualitas air, serta dua pengaturan yang menyertai bahan kimia, yaitu Relative diffusivity dan Quality tolerance. Usia air dan penelusuran sumber dihitung di halaman ini; bahan kimia tidak, sehingga kedua pengaturan itu tetap disimpan tanpa digunakan. Semuanya akan ditulis kembali jika Anda menyimpan berkas EPANET.';
...
$ec_lang['lpn_settings_quality_track_tip']='Pilih apa yang akan diikuti oleh proses ini melalui pipa: berapa lama air telah berada dalam sistem, atau dari mana asalnya. Tak satu pun dari keduanya memerlukan konsentrasi atau laju reaksi.';
...
$ec_lang['lpn_quality_chemical']='Bahan kimia yang disebutkan berkas ini (disimpan, tidak dihitung)';
$ec_lang['lpn_quality_needs_run']='Kualitas air dibawa sepanjang pipa seiring waktu, sehingga memerlukan penyelesai EPANET dan Total waktu berjalan. Atur Total waktu berjalan di bawah Waktu, lalu tekan tombol Hitung.';
...
$ec_lang['lpn_ff_menu']='Debit kebakaran…';
...
$ec_lang['lpn_ff_title']='Debit kebakaran';
...
$ec_lang['lpn_ff_required_node_tip']='Debit kebakaran yang disyaratkan pada simpul ini secara khusus, dari kode kebakaran atau otoritas pemadam kebakaran Anda untuk peruntukan lahan yang dilayaninya. Biarkan kosong dan simpul ini akan diuji terhadap angka pada kotak Debit kebakaran yang diperlukan.';
...
$ec_lang['lpn_ff_rows_more']='{n} simpul lainnya tidak ditampilkan.';
