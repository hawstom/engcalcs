...
$ec_lang['lpn_inp_drop_controls']='Kendali dan aturan tidak disertakan. Setiap pipa, pompa, dan katup masuk pada keadaan yang tertulis di berkas, dan tidak berubah.';
$ec_lang['lpn_inp_drop_eps']='Berkas ini menjelaskan simulasi yang berjalan sepanjang suatu periode waktu. Halaman ini menyelesaikan satu saat, sehingga hanya kondisi awal yang masuk.';
...
$ec_lang['lpn_pump_point1']='Titik 1 (wajib)';
$ec_lang['lpn_pump_point2']='Titik 2 (opsional)';
$ec_lang['lpn_pump_point3']='Titik 3 (opsional)';
...
$ec_lang['lpn_settings_defaults']='Nilai awal';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Menjalankan penyelesai EPANET dari US EPA, di peramban Anda ini. Kedua penyelesai memberikan hasil yang sama, dan pada jaringan seukuran ini Anda tidak akan melihat perbedaan kecepatan. Saat pertama kali Anda mengaktifkan ini, sekitar 650 KB diunduh lalu disimpan di perangkat ini.';
...
$ec_lang['lpn_field_text_match_pipe']='Samakan dengan sudut pipa';
...
$ec_lang['lpn_examples_size']='{nodes} simpul, {links} pipa';
...
$ec_lang['lpn_ex_net3_desc']='Contoh besar dari EPANET: 97 simpul, dua tangki, dan satu sumber sungai. Layak dibuka untuk melihat tampilan model berukuran nyata di peta.';
...
$ec_lang['lpn_unit_unknown']='Gambar ini menyatakan satuan yang tidak tersedia di halaman ini: {unit}. Semuanya disimpan dan ditampilkan persis seperti saat masuk, dan tidak ada yang diubah. Tidak ada jawaban yang dapat diberikan sampai halaman ini mengenali satuan tersebut, karena tidak ada cara untuk mengetahui besarnya.';
...
$ec_lang['lpn_settings_readability_bias']='Derajat ke kiri dari vertikal sebelum label diputar balik';
