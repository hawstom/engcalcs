...
$ec_lang['or_diameter']='Diameter atau tinggi, D <span title="Diameter for circular; height for rectangular" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['or_width']='Lebar, W <span title="Rectangular openings only" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['or_invert']='Elevasi dasar <span title="Bottom of opening" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_h1_elev']='Elevasi permukaan air awal <span title="Starting water surface elevation" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_a_ending']='Luas akhir, A<sub>2</sub> <span title="Interpolated from conic model at ending elevation" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_d']='Orifis D <span title="Diameter (circular) or height (rectangular)" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['odt_w']='Lebar orifis, W <span title="Rectangular only" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_h1']='Tinggi awal, H<sub>1</sub> <span title="Starting WSE minus orifice centroid elevation" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['ds_main_desc']='Irigasi Tetes &amp; Sprinkler &mdash; Laju Aplikasi dan Keseragaman';
$ec_lang['ds_q_avg']='Laju aliran emitter rata-rata, q';
$ec_lang['ds_q_min']='Laju aliran emitter minimum, q<sub>min</sub>';
...
$ec_lang['ds_du']='Keseragaman distribusi, DU';
$ec_lang['ds_du_check']='Pemeriksaan kualitas DU';
...
$ec_lang['ds_du_excellent']='Sangat Baik — DU ≥ 90% ✓';
$ec_lang['ds_du_good']='Baik — DU ≥ 80% ✓';
$ec_lang['ds_du_acceptable']='Dapat Diterima — DU ≥ 70%';
$ec_lang['ds_du_poor']='Buruk — DU < 70% — tinjau desain ⚠';
$ec_lang['ds_notes_1_term']='Laju Aplikasi';
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>, di mana A<sub>e</sub> = S<sub>e</sub> &times; S<sub>l</sub> adalah luas yang dilayani oleh setiap emitter. Laju aplikasi yang lebih rendah memberikan lebih banyak waktu untuk infiltrasi &mdash; penting pada tanah berat atau lahan miring.';
$ec_lang['ds_notes_2_term']='Keseragaman Distribusi (DU)';
...
$ec_lang['cs_Ec_target']='Target efisiensi konveyans, E<sub>c,target</sub> <span title="Conveyance efficiency goal after lining; fraction 0&ndash;1" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['cs_lining_area']='Luas pelapisan, L &times; P<sub>w</sub>';
...
$ec_lang['cs_payback_years']='Periode pengembalian <span title="Simple payback = total lining cost &divide; annual value recovered" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['rc_main_desc']='Penentuan Ukuran Riprap Peluncur Batu &mdash; Robinson, Rice &amp; Kadavy (1998)';
...
$ec_lang['rc_qs']='Debit satuan permukaan, q<sub>s</sub> (q<sub>t</sub> &minus; q<sub>m</sub>)';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice &amp; Kadavy (1998) mengembangkan dua persamaan empiris untuk ukuran median riprap D<sub>50</sub> berdasarkan kemiringan peluncur dan debit satuan. Persamaan 1 berlaku untuk kemiringan landai (S<sub>0</sub> &lt; 0.10); Persamaan 2 berlaku untuk kemiringan curam (0.10 &le; S<sub>0</sub> &le; 0.40). Kedua persamaan memerlukan q<sub>t</sub> dalam m&sup2;/s dan menghasilkan D<sub>50</sub> dalam mm. Rentang yang divalidasi adalah 0.02 &le; S<sub>0</sub> &le; 0.40.';
$ec_lang['rc_notes_2_term']='Debit Satuan';
$ec_lang['rc_notes_2_def']='q<sub>t</sub> adalah debit satuan total di mercu peluncur (total debit per satuan lebar). Untuk saluran dengan lebar dasar B yang membawa debit total Q, perkirakan q<sub>t</sub> &asymp; Q / B, atau hitung dari kondisi kedalaman kritis di inlet peluncur.';
$ec_lang['rc_notes_3_term']='Aliran Melalui Mantel Batu';
$ec_lang['rc_notes_3_def']='Sebagian dari total debit bergerak melalui pori-pori riprap batu (debit mantel q<sub>m</sub>); sisanya mengalir di atas permukaan batu (q<sub>s</sub> = q<sub>t</sub> &minus; q<sub>m</sub>). Kedalaman aliran d dihitung dari persamaan Manning yang diterapkan pada debit permukaan q<sub>s</sub> menggunakan kekasaran peluncur n. Porositas default n<sub>p</sub> = 0.45 adalah tipikal untuk batu pecah bersudut.';
