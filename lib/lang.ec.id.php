...
$ec_lang['lpn_basemap_satellite_hide']='Sembunyikan citra satelit';
$ec_lang['lpn_basemap_satellite_tip']='Foto permukaan tanah dari Mapbox, diambil lewat internet saat Anda menggeser dan memperbesar peta. Berguna untuk melihat ke mana sebenarnya sebuah pipa berjalan. Jaringan Anda tetap digambar baik citra ditampilkan atau tidak.';
$ec_lang['lpn_georef_asdeg_btn']='Ini sudah bujur/lintang';
$ec_lang['lpn_georef_asdeg_tip']='Tekan ini hanya jika x dan y pada berkas ini benar-benar sebuah garis bujur dan garis lintang. Jaringan kemudian langsung berpindah ke tempat yang ditunjukkan angka tersebut, dan tidak perlu ditempatkan lagi. Setiap angka tetap seperti semula dalam kedua kasus.';
$ec_lang['lpn_georef_asdegrees']='X dan y pada berkas ini dibaca sebagai garis bujur dan garis lintang, sehingga jaringan sudah berada di peta dan tidak ada yang dipindahkan. Periksa apakah letaknya sudah benar, lalu tekan Simpan penempatan ini.';
...
$ec_lang['lpn_menu_project']='Proyek';
...
$ec_lang['lpn_run_menu_tip']='Hitung ulang jaringan ini sekarang. Mencari tombol Jalankan? Selama proyek ini menghitung ulang setelah setiap perubahan, bilah alat tidak memiliki tombol Jalankan. Matikan “Hitung ulang otomatis” di Pengaturan, pada Perhitungan, Hidraulika, dan tombolnya akan muncul kembali.';
...
$ec_lang['lpn_replace_button']='Ganti';
...
$ec_lang['lpn_profile_draw']='Pilih rute pada peta';
$ec_lang['lpn_profile_draw_stop']='Berhenti memilih';
...
$ec_lang['lpn_inp_drop_head_pattern']='Reservoir-reservoir ini naik dan turun sepanjang hari. Polanya masuk secara utuh, dan muka air yang Anda lihat adalah muka air pada saat yang ditunjukkan oleh jam.';
$ec_lang['lpn_inp_drop_pump_speed']='Pompa-pompa ini berputar pada kecepatan yang berbeda dari kecepatan saat kurvanya diukur, atau berubah kecepatan sepanjang hari. Kecepatan dan polanya masuk secara utuh, dan tinggi tekan yang Anda lihat adalah tinggi tekan pada saat yang ditunjukkan oleh jam.';
...
$ec_lang['lpn_import_notes_heading']='Dari berkas EPANET';
...
$ec_lang['lpn_time_run_report_tip']='Apa yang dicetak sendiri oleh penyelesai EPANET tentang proses terakhir: bagaimana hasilnya konvergen, dan apa pun yang diperingatkannya. Ini adalah teks asli dari penyelesai itu sendiri, bukan dari kami.';
...
$ec_lang['lpn_library_curves_tip']='Kurva adalah titik-titik yang menyatakan kinerja sebuah pompa: berapa tinggi tekan yang dihasilkannya pada setiap debit.';
$ec_lang['lpn_library_curves_note']='Sebuah kurva dimiliki oleh pompa atau katup yang menggunakannya, sehingga ini adalah kumpulan lengkapnya di satu tempat untuk dibaca. Klik sebuah ID untuk membuka aset itu dan mengubah titik-titiknya di sana. Untuk pompa, garis yang digambar adalah kurva yang digunakan proses, dicocokkan melalui titik-titiknya; untuk katup, garis itu adalah anak tangga lurus di antara titik-titik tersebut.';
...
$ec_lang['lpn_library_default_pattern']='Pola kebutuhan default';
$ec_lang['lpn_library_default_pattern_tip']='Setiap simpul tanpa pola menggunakan pola ini.';
...
$ec_lang['lpn_field_demand_pattern_tip']='Bagaimana kebutuhan simpul ini naik dan turun sepanjang proses. Biarkan pada Tidak ada pola untuk mengikuti pola milik proyek itu sendiri, apa pun itu.';
...
$ec_lang['lpn_field_speed_pattern_tip']='Bagaimana kecepatan pompa ini naik dan turun sepanjang proses. Setiap pengali ADALAH kecepatan relatif untuk bagian hari itu, dan menggantikan kecepatan di atas, sehingga pengali 0 menghentikan pompa.';
...
$ec_lang['lpn_terrain_menu']='Isi elevasi dari permukaan tanah…';
$ec_lang['lpn_terrain_tip']='Membaca elevasi tanah di bawah setiap simpul yang belum memilikinya, dan mengetikkannya untuk Anda. Simpul yang sudah memiliki elevasi tidak disentuh, dan satu kali Undo mengembalikan semuanya. Penggunaan pertama akan meminta izin Anda, karena posisi simpul-simpul Anda dikirim ke Mapbox.';
$ec_lang['lpn_terrain_accuracy']='Data medan memiliki resolusi sekitar 30 m di permukaan tanah, dan umumnya meleset beberapa meter secara vertikal. Perlakukan ini sebagai peta kontur, bukan hasil survei: periksa apa pun yang menjadi andalan Anda.';
...
$ec_lang['lpn_terrain_confirm']='Isi elevasi {n} simpul dari permukaan tanah?';
...
$ec_lang['lpn_terrain_confirm_default_2']='Ganti {n} simpul itu dengan permukaan tanah?';
...
$ec_lang['lpn_terrain_none_needed']='Setiap simpul sudah memiliki elevasi yang Anda tetapkan sendiri. Tidak ada yang diubah, dan tidak ada yang dikirim — kami tidak pernah menimpa elevasi yang sudah ada.';
$ec_lang['lpn_terrain_no_nodes']='Belum ada simpul untuk diisi.';
