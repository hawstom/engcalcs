...
$ec_lang['mhp_km']='Koefisien kehilangan minor, k<sub>m</sub> <span title="Sum of all junction and fitting loss coefficients along the penstock" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['mhp_nu']='Viskositas kinematik, &nu; <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_vel_low']='di bawah 1 m/s — kurangi diameter ⚠';
$ec_lang['mhp_vel_high']='di atas 3 m/s — tambah diameter ⚠';
...
$ec_lang['mhp_notes_1_def']='Total kehilangan h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, di mana h<sub>f</sub> = f(L/D)(v&sup2;/2g) adalah kehilangan gesekan Darcy-Weisbach dan h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g mencakup inlet, belokan, dan katup. Tinggi neto H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Kecepatan';
$ec_lang['mhp_notes_2_def']='Target 1&ndash;3 m/s. Di bawah 1 m/s pipa terlalu besar; di atas 3 m/s meningkatkan kehilangan gesekan dan risiko pukulan air.';
$ec_lang['mhp_notes_3_term']='Target Kehilangan Tinggi';
$ec_lang['mhp_notes_3_def']='Kehilangan penstock di bawah 10% dari tinggi bruto umumnya ekonomis. Titik optimal antara biaya pipa dan daya yang hilang sering berada di sekitar 4&ndash;6% untuk lokasi listrik bernilai tinggi.';
$ec_lang['mhp_notes_4_term']='Kehilangan Minor k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Nilai tipikal: inlet tajam 0.5, setiap belokan 45&deg; antara 0.2&ndash;0.3, katup gerbang (terbuka penuh) 0.1, katup kupu-kupu 0.2. Jumlah semua fitting menghasilkan k<sub>m</sub> total. Default 1.5 mengasumsikan satu inlet dan dua belokan.';
$ec_lang['mhp_notes_5_term']='Kekasaran Pipa e';
$ec_lang['mhp_notes_5_def']='Kekasaran absolut tipikal: baja (baru) 0.046&nbsp;mm, baja (bekas) 0.15&nbsp;mm, HDPE 0.003&nbsp;mm, PVC/uPVC 0.0015&nbsp;mm, beton 0.3&ndash;3&nbsp;mm. HDPE umum digunakan untuk pipa penstock mikro-hidro kecil.';
