...
$ec_lang['lpn_time_run_note']='Виждате мрежата в първия момент на отчитане. Настройката Преизчислявай автоматично е изключена, затова резултатите за по-късните моменти не се актуализират, докато работите. Натиснете бутона „Изчисли“, за да ги актуализирате.';
