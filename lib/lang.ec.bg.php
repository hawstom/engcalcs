...
$ec_lang['lpn_file_import_geo']='Преобразувай в lat/lon…';
$ec_lang['lpn_file_import_geo_tip']='От локална мрежа към реалния свят. Поставя чертеж, направен върху мрежата xy, върху географски координати, така че да застане на уличната карта там, където му е мястото. Всяко въведено от вас число остава такова, каквото е — само X и Y стават географска дължина и ширина.';
...
$ec_lang['lpn_pane_tab_tip']='Всички възли като таблица, която можете да сортирате и редактирате.';
$ec_lang['lpn_pane_none']='Тази мрежа все още няма възли.';
