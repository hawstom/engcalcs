...
$ec_lang['mhp_length']='Дължина на напорния тръбопровод, L <span title="Дължина на подвеждащия (входен) тръбопровод или улей" class="ec-tip">?</span>';
...
$ec_lang['mhp_hl_warn']='надвишава целевите 10%';
$ec_lang['mhp_hl_warn_tip']='Помислете за по-голяма тръба';
$ec_lang['mhp_hl_bad']='надвишава 20%';
$ec_lang['mhp_hl_bad_tip']='Преоразмерете тръбата';
...
$ec_lang['mhp_notes_4_def']='Тези загуби възникват при връзки, входове, колена и спирателни органи на тръбопровода — терминът „местни“ (или „незначителни“) е условен и подвеждащ; при къс напорен тръбопровод те могат да се равняват на загубите от триене или да ги надвишават. Типични стойности: остър вход 0.5, всяко коляно 45° между 0.2–0.3, спирателен кран (напълно отворен) 0.1, пеперудна клапа 0.2. Сумирайте всички фитинги за общ k<sub>m</sub>. Стойността по подразбиране 1.5 приема един вход и две колена.';
...
$ec_lang['rc_apron_length']='Дължина на водобойната плоча (15 × D<sub>50</sub>) <span title="Необходима за конструктивна опора на камъка на бързотока. „Минималната опашна вода, която се получава в резултат на съпротивлението на изходния участък и низходящия канал, е достатъчна да осигури стабилността на облицовката в изходния участък.“ (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
