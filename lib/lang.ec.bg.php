...
$ec_lang['mphl_total_junction_k_tip']='Коефициент на местни (локални) загуби, k<sub>m</sub>. Тези загуби възникват при тръбни съединения, входове, изходи, колена и спирателни органи — терминът „местни“ е утвърден, но подвеждащ; в къс тръбопровод те могат да се изравнят или да надвишат загубите от триене. Типични стойности на k: остър входен отвор 0,5, всяко коляно от 45° 0,2–0,3, шибърен вентил (напълно отворен) 0,1, пеперудков клапан 0,2, изход (към резервоар или атмосферата) 1,0. Сборувайте всички фитинги за общия k<sub>m</sub>. Стойността по подразбиране 2,0 приема един вход, един изход и две колена от 45°.';
