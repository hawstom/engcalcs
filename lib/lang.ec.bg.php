...
$ec_lang['lpn_file_import_geo']='Отвори xy файл на картата…';
$ec_lang['lpn_file_import_geo_tip']='Отваря файл на проект или EPANET файл в нов раздел на проект на тази страница, върху уличната карта. Поставяте чертежа върху света на ръка: преместете и мащабирайте до обекта, после го оразмерете и завъртете да пасне. Ако x и y във файла вече са дължина и ширина, натиснете бутона „Това вече е lat/lon“ и мрежата отива направо там, където принадлежи. Всяко въведено от вас число остава такова, каквото е.';
...
$ec_lang['lpn_clean_map_tip']='Маха лентата за състоянието и показанието на координатите от картата, така че екранна снимка да показва само чертежа. Чертежът ви не се засяга, и този избор не се запазва; презареждането на страницата връща показанията обратно.';
...
$ec_lang['lpn_inp_drop_quality']='Този файл описва как качеството на водата се променя, докато тя се движи: какво съдържа водата в началото, откъде постъпва още от това вещество, как реагира и как се смесват цистерните. Тази страница изчислява възрастта на водата и проследяването на източник, но не химията, затова нищо от това не се използва тук. Тези редове се пазят и се записват обратно, ако запишете EPANET файл.';
...
$ec_lang['lpn_tip_select']='Използвайте този режим, за да променяте, премествате и плъзгате неща на картата. Страницата се връща в този режим сама след някои действия, например отваряне на проект.';
...
$ec_lang['lpn_settings_color_thematic_tip']='Скрива етикетите на възлите и връзките, така че на картата остават само цветовете. Текстът, който сте поставили сами, остава. Изборите ви за етикети се пазят, а изключването на това ги връща обратно.';
...
$ec_lang['lpn_georef_asdegrees']='x и y в този файл бяха прочетени като дължина и ширина, затова мрежата вече е на картата и нищо не е било преместено. Проверете дали е на правилното място, после натиснете „Запази това разположение“.';
...
$ec_lang['lpn_result_water_age_tip']='Колко дълго водата, достигаща до тази точка, е била в системата. Няма нормативна граница, с която да се сравнява, затова преценявайте числото спрямо собствената си система.';
...
$ec_lang['lpn_new_coords_tip']='Проект от тип xy използва координати, които не са географска ширина и дължина. Проект от тип lat/lon има географски координати, затова зад него може да се начертае улична карта или сателитна снимка, а котите на възлите могат да се четат от терена. Проект от тип xy може да се преобразува в lat/lon чрез Файл, Отвори xy файл на картата.';
$ec_lang['lpn_new_place']='Стартирай близо до това място';
$ec_lang['lpn_new_place_tip']='По желание. Въведете град, улица или ориентир и новата карта се отваря там. Въведените от вас думи отиват към услугата на OpenStreetMap за имена на места, която пита за разрешение първия път. Оставете полето празно и картата се отваря на целия свят.';
$ec_lang['lpn_new_place_hint']='Пловдив, България';
$ec_lang['lpn_new_create']='Създай';
$ec_lang['lpn_inp_drop_rules']='Този файл има управления, базирани на правила. Те не се прилагат тук, затова тръбите, помпите и вентилите, които назовават, остават в състоянието, записано във файла. Самите правила се пазят и се записват обратно, ако запишете EPANET файл.';
$ec_lang['lpn_inp_drop_energy']='Този EPANET файл включва данни за моделиране на разходите за помпене. Тази страница не изчислява енергия или разходи, затова нищо тук не използва тези числа. Те се пазят и се записват обратно, ако запишете EPANET файл.';
$ec_lang['lpn_inp_drop_tags']='Този файл дава тагове на някои от своите възли, тръби или други елементи. На тази страница засега няма къде да видите таг или да го промените. Таговете се пазят и се записват обратно, ако запишете EPANET файл.';
$ec_lang['lpn_inp_drop_report']='Този файл съдържа собствените настройки на EPANET за отчетите, които отпечатва. Тази страница показва резултатите си по свой начин, затова нищо тук не ги използва. Те се пазят и се записват обратно, ако запишете EPANET файл.';
...
$ec_lang['lpn_inp_drop_quality_options']='Този файл задава опции на EPANET за качеството на водата: Quality, която назовава вида анализ на качеството на водата, и две настройки, свързани с химично вещество, Relative diffusivity и Quality tolerance. Възрастта на водата и проследяването на източник се изчисляват тук; химията — не, затова тези две настройки се пазят, без да се използват. Всички те се записват обратно, ако запишете EPANET файл.';
...
$ec_lang['lpn_settings_quality_track_tip']='Изберете какво трябва да проследи изчислението през тръбите: колко дълго водата е била в системата или откъде идва. Нито едното от двете не се нуждае от концентрация или скорост на реакция.';
...
$ec_lang['lpn_quality_chemical']='Химично вещество, назовано от този файл (само се пази, не се изчислява)';
$ec_lang['lpn_quality_needs_run']='Качеството на водата се пренася по тръбите във времето, затова се нуждае от EPANET и от общо време на изпълнение. Задайте Общо време на изпълнение под Време, после натиснете бутона „Изчисли“.';
...
$ec_lang['lpn_ff_menu']='Противопожарно водно количество…';
...
$ec_lang['lpn_ff_title']='Противопожарно водно количество';
...
$ec_lang['lpn_ff_required_node_tip']='Противопожарното водно количество, изисквано точно за този възел, съгласно вашия нормативен акт или противопожарен орган за начина на ползване на територията, която обслужва. Оставете полето празно и възелът се изпитва спрямо числото в полето „Изисквано противопожарно водно количество“.';
...
$ec_lang['lpn_ff_design_nodes']='Всички други възли';
