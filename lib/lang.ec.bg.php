...
$ec_lang['dw_kinematic_viscosity']='Кинематична вискозност, ν <span title="1×10⁻⁶ m²/s for clean water at 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['or_diameter']='Диаметър или височина, D <span title="Diameter for circular; height for rectangular" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['or_width']='Ширина, W <span title="Rectangular openings only" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['or_invert']='Инвертна кота <span title="Bottom of opening" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_h1_elev']='Начална кота <span title="Starting water surface elevation" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_a_ending']='Крайна площ, A<sub>2</sub> <span title="Interpolated from conic model at ending elevation" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['odt_d']='Отвор D <span title="Diameter (circular) or height (rectangular)" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['odt_w']='Ширина на отвор, W <span title="Rectangular only" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_km']='Коефициент на местните загуби, k<sub>m</sub> <span title="Sum of all junction and fitting loss coefficients along the penstock" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
$ec_lang['mhp_nu']='Кинематична вискозност, ν <span title="1×10⁻⁶ m²/s for clean water near 20°C" style="cursor:help;color:steelblue;font-size:0.9em">?</span>';
...
$ec_lang['mhp_vel_low']='под 1 м/с — намалете диаметъра ⚠';
$ec_lang['mhp_vel_high']='над 3 м/с — увеличете диаметъра ⚠';
...
$ec_lang['ds_main_menu']='Норма на поливане (капково/разпръскване)';
$ec_lang['ds_main_title']='Безплатен онлайн калкулатор за норма на поливане при капково/разпръскващо напояване';
$ec_lang['ds_main_desc']='Капково и разпръскващо напояване — норма на поливане и равномерност';
$ec_lang['ds_q_avg']='Средна дебит на емитера, q';
$ec_lang['ds_q_min']='Минимална дебит на емитера, q<sub>min</sub>';
$ec_lang['ds_se']='Разстояние между емитери по латерала, S<sub>e</sub>';
$ec_lang['ds_sl']='Разстояние между латерали (разстояние между редовете), S<sub>l</sub>';
$ec_lang['ds_n_e']='Емитери на латерал, n<sub>e</sub>';
$ec_lang['ds_n_l']='Латерали на зона, n<sub>l</sub>';
$ec_lang['ds_d']='Целева дълбочина на поливане, d';
$ec_lang['ds_a_e']='Площ на един емитер, A<sub>e</sub>';
$ec_lang['ds_pr']='Норма на поливане (норма на валежи), PR';
$ec_lang['ds_du']='Равномерност на разпределение, DU';
$ec_lang['ds_du_check']='Проверка на качеството на DU';
$ec_lang['ds_q_lat']='Дебит на латерал, Q<sub>lat</sub>';
$ec_lang['ds_q_sys']='Дебит на зоната, Q<sub>zone</sub>';
$ec_lang['ds_t_run']='Работно време за целева дълбочина (часове)';
$ec_lang['ds_du_excellent']='Отлично — DU ≥ 90% ✓';
$ec_lang['ds_du_good']='Добро — DU ≥ 80% ✓';
$ec_lang['ds_du_acceptable']='Приемливо — DU ≥ 70%';
$ec_lang['ds_du_poor']='Лошо — DU < 70% — преразгледайте проекта ⚠';
$ec_lang['ds_notes_1_term']='Норма на поливане';
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>, където A<sub>e</sub> = S<sub>e</sub> × S<sub>l</sub> е площта, обслужвана от всеки емитер. По-ниската норма на поливане дава повече време за инфилтрация — важно при тежки почви или наклонени полета.';
$ec_lang['ds_notes_2_term']='Равномерност на разпределение (DU)';
$ec_lang['ds_notes_2_def']='DU = q<sub>min</sub> / q<sub>avg</sub>. DU от 1,0 (100%) означава, че всички емитери текат еднакво. Стойности под 0,80 губят вода в добре напоявани зони, оставяйки по-сухи петна. Равномерността намалява при прекомерни колебания на налягането по латерала, износване или частично запушване на емитерите.';
$ec_lang['ds_notes_3_term']='Работно време';
$ec_lang['ds_notes_3_def']='Работно време = целева дълбочина ÷ норма на поливане. При наклонена или уплътнена почва разделете работното време на два или три по-кратки цикъла с почивки между тях, за да избегнете повърхностно оттичане.';
...
$ec_lang['cs_Ec_target']='Целева ефективност на транспортиране след облицоване, E<sub>c,target</sub> (дял, 0–1) — цел за задържане на вода от облицования канал';
...
$ec_lang['irr_card_drip_head']='Проектиране на Капково & Дъждовално Напояване';
$ec_lang['irr_card_drip_desc']='Изчислете нормата на прилагане, равномерността на разпределение, дебита на страничния клон, дебита на зоната и времето на работа за система за капково или дъждовално напояване. Въведете дебита на емитера, разстоянието между емитерите и целевата дълбочина.';
...
$ec_lang['rc_apron_length']='Дължина на изходния праг (15 × D<sub>50</sub>) <span title="Необходим за конструктивна опора на камъка на улея. «Минималният подпор, възникващ в резултат на съпротивлението на изходния участък и низходящия канал, е достатъчен за осигуряване на устойчивостта на наброската в изходния участък.» (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
// Manning Trapezoid — velocity check keys
$ec_lang['mtc_vel_check']='Проверка на скоростта';
$ec_lang['mtc_vel_ok']='Скоростта е разумна за предположения за равномерно течение.';
$ec_lang['mtc_vel_high']='Висока скорост — проверете наличния пад и загубите при разширение.';
