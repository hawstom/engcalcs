...
$ec_lang['ds_main_desc']='Капково и разпръскващо напояване — норма на поливане';
$ec_lang['ds_q_avg']='Дебит на емитера, q';
...
$ec_lang['ds_notes_2_term']='Работно време';
$ec_lang['ds_notes_2_def']='Работно време = целева дълбочина ÷ норма на поливане. При наклонена или уплътнена почва разделете работното време на два или три по-кратки цикъла с почивки между тях, за да избегнете повърхностно оттичане.';
