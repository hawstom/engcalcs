...
$ec_lang['lpn_field_text_match_pipe']='Съвпадение с най-близката тръба';
...
$ec_lang['lpn_time_format_tip']='Запишете време като часове и минути, например 2:30. Обикновено число означава часове; число със собствена дума означава тази дума: 30 минути.';
$ec_lang['lpn_time_running']='Изчислява се целият период от време с модула на EPANET.';
$ec_lang['lpn_time_no_engine']='Вграденият решаващ алгоритъм изчислява само по един момент от време, затова това е мрежата само в {time}: потребностите носят множителите на графика за този момент, а всяка цистерна все още стои на началното си ниво, вместо да се пълни и изпразва. Свържете се веднъж с интернет, за да изтеглите модула на EPANET, който изчислява целия период.';
