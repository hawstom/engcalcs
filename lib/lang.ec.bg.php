...
$ec_lang['mpf_note_1']='<dl><dt>Това е дебитът и дълбочината в <em>безкрайно дълга</em> тръба.</dt><dd>За вкарването на потока в тръбата може да е необходима значително по-голяма дълбочина на горната вода. Добавете поне 1,5 пъти скоростния напор за да получите дълбочината на горната вода или <a href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">вижте моя 2-минутен урок</a> за стандартни изчисления на горна вода за водостоци с HY-8.</dd>';
...
$ec_lang['mphl_note_1']='<dl><dt>При отворен вход (водосток) е необходима проверка за контрол при входа.</dt><dd>1. HGL нагоре по течението не може да бъде по-ниско от котата на нормалното течение нагоре по течението (или по-ниско от тръбата!).</dd><dd>2. Горната вода на водосток се представя по-добре от EGL нагоре по течението, отколкото от HGL нагоре по течението.</dd><dd>3. Вижте <a href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">моя 2-минутен урок</a> за прости стандартни изчисления на горна вода за водостоци с HY-8.</dd>';
