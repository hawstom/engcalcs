...
$ec_lang['ds_main_desc']='Капково и разпръскващо напояване &mdash; норма на поливане и равномерност';
...
$ec_lang['ds_notes_1_def']='PR = q / A<sub>e</sub>, където A<sub>e</sub> = S<sub>e</sub> &times; S<sub>l</sub> е площта, обслужвана от всеки емитер. По-ниската норма на поливане дава повече време за инфилтрация &mdash; важно при тежки почви или наклонени полета.';
...
$ec_lang['ds_notes_3_def']='Работно време = целева дълбочина &divide; норма на поливане. При наклонена или уплътнена почва разделете работното време на два или три по-кратки цикъла с почивки между тях, за да избегнете повърхностно оттичане.';
...
$ec_lang['about_body_html']='<h3>Мисия</h3><p>Инженерните Калкулатори на HawsEDC съществуват, за да служат на инженери и полеви работници по целия свят — особено на работещите в региони с недостиг на вода, ограничени ресурси или недостатъчно обслужване. Тези инструменти са част от по-широка хуманитарна мисия: да каже на всеки човек по най-практичния и ефективен начин, че е обичан и ценен завинаги, че няма от какво да се страхува и че няма да провали всичко.</p><p>Калкулаторите са превозното средство. Дестинацията е свят без страдание.</p><h3>Лиценз с Отворен Код</h3><p>Целият код е публикуван под <a target="_blank" href="https://www.gnu.org/licenses/gpl-3.0.html">GNU Общ Публичен Лиценз v3.0 или по-нова версия</a> — свободен като в свобода. Можете да използвате, изучавате, модифицирате и преразпространявате кода при същите условия.</p><p>Copyright &copy; 2009&ndash;2026 Thomas Gail Haws.</p><h3>Изходен Код</h3><p>Пълният изходен код е публично достъпен в Bitbucket:</p><p><a target="_blank" href="https://bitbucket.org/hawstom/engcalcs">bitbucket.org/hawstom/engcalcs</a></p><p>Можете да разглеждате кода, да подавате проблеми или да форкнете хранилището там.</p><h3>Принос</h3><p>Pull заявките са добре дошли. Начини за принос:</p><ul><li><strong>Преводи</strong> — подобрете или добавете език. Отворете pull заявка с промени в съответния файл <code>lib/lang.ec.??.php</code>.</li><li><strong>Доклади за грешки</strong> — използвайте формуляра за обратна връзка на всяка страница с калкулатор или подайте проблем в Bitbucket.</li><li><strong>Нови калкулатори</strong> — идеи за хидравлично инженерни инструменти, обслужващи полеви работници и специалисти по напояване, са особено добре дошли. Вижте ръководството за разработчици <code>CLAUDE.md</code> в хранилището.</li><li><strong>Хостинг</strong> — ако можете да огледалите тези калкулатори за регион с ограничена свързаност, моля, свържете се с нас.</li></ul><h3>Офлайн Изтегляния</h3><p>Можете да запишете всеки калкулатор на локалното си устройство, като използвате менюто „Запази като&hellip;" на браузъра си.</p><p>Офлайн ZIP изтеглянето все още не е налично, но е планирано — предназначено за инженери и полеви работници в райони с ограничен или скъп достъп до интернет. Целта е самостоятелен пакет, работещ от локален диск или USB устройство без необходимост от сървър.</p><p>Ако имате идеи или можете да помогнете с реализацията, моля, допринесете чрез хранилището или формуляра за обратна връзка.</p><h3>Прогресивно Уеб Приложение (PWA)</h3><p>Тези калкулатори все още не са Прогресивно Уеб Приложение, но поддръжката на PWA е в пътната карта. Целта е да позволи на инженерите да инсталират калкулаторите на телефон или таблет и да ги използват офлайн на терен — особено ценно в региони с ниска свързаност.</p><h3>Контакт</h3><p>Tom Haws — хидравличен инженер и автор на тези калкулатори.<br />Използвайте формуляра за обратна връзка на всяка страница с калкулатор или получете достъп до изходния код на <a target="_blank" href="https://bitbucket.org/hawstom/engcalcs">Bitbucket</a>.</p>';
