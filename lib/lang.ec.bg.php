...
$ec_lang['mi_q_617']='<span class="ec-help" title="Съставен дебит Q, изчислен със съставно n за всеки регион съгласно Chow 6-17, при равни скорости">Q <span class="ec-tip">?</span></span>';
...
$ec_lang['mhp_km']='<span class="ec-help" title="Sum of all junction and fitting loss coefficients along the penstock">Коефициент на местните загуби, k<sub>m</sub> <span class="ec-tip">?</span></span>';
$ec_lang['mhp_nu']='<span class="ec-help" title="1×10⁻⁶ m²/s for clean water near 20°C">Кинематична вискозност, ν <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_Ec_target']='<span class="ec-help" title="Целева ефективност на транспортиране след облицоване; дял 0&ndash;1">Целева стойност след облицоване, E<sub>c,target</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_payback_years']='<span class="ec-help" title="Прост срок на откупуване = обща цена на облицовката &divide; годишна възстановена стойност">Срок на откупуване <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_x']='<span class="ec-help" title="0,5 за стандартни некомпенсиращи емитери; близо до 0 за емитери с компенсация на налягането">Показател на степента на дебита на емитера, x <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_is_lateral']='<span class="ec-help" title="Отметнато: този участък е сегмент от пробния латерал, от който отделните емитери черпят вода. Неотметнато: този участък е главен тръбопровод, който само пропуска дебита към латерали извън пробния път.">Лат. <span class="ec-tip">?</span></span>';
$ec_lang['ip_count']='<span class="ec-help" title="Редове за латерал: емитерите само в този участък. Редове за главен тръбопровод: общият брой емитери на латерали, РАЗЛИЧНИ от този, които се отклоняват от този участък. За участъка на главния тръбопровод, който завършва при пробния латерал, това включва и всички латерали по-нататък по главния тръбопровод след тази точка, както и споделящите същия възел (напр. латерал от срещуположната страна) &mdash; техният дебит също се отклонява от този участък.">Емитери <span class="ec-tip">?</span></span>';
$ec_lang['ip_length']='L';
$ec_lang['ip_diameter']='D';
$ec_lang['ip_roughness']='e';
$ec_lang['ip_e']='<span class="ec-help" title="Височина на грапавостта по Дарси-Вайсбах">e <span class="ec-tip">?</span></span>';
$ec_lang['ip_km']='<span class="ec-help" title="Общ коефициент на местни загуби за фитингите/крановете/съединителите на този участък (&ge;0,5 препоръчителен минимум)">k<sub>m</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_supply']='<span class="ec-help" title="Дебитът, който постъпва само в моделирания пробен път &mdash; за целия обхват на зоната/системата вижте Q_zone в раздела Проектиране на поливането по-долу.">Дебит на подаване по пробния път, Q<sub>supply</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_dp_avg']='<span class="ec-help" title="С колко по-високо (или по-ниско) налягане според вас работи типичен латерал в сравнение с този пробен латерал. Пробният латерал е нарочно предполагаемият най-неблагоприятен случай, затова собствената му средна стойност подценява средната за полето &mdash; ако се остави на 0, проверката за равномерност и числата за проектиране на поливането по-долу използват (вероятно оптимистичната) собствена средна стойност на пробния латерал без корекция.">Оценка на &Delta;налягане, средно спрямо пробния латерал <span class="ec-tip">?</span></span>';
$ec_lang['ip_q_avg_field']='<span class="ec-help" title="q_avg_lateral, преизчислен при налягането на всеки ред от латерала плюс въведената по-горе разлика в налягането &mdash; опит за корекция на факта, че пробният латерал е предполагаемият най-неблагоприятен случай, а не представителен. Захранва както проверката за равномерност, така и раздела за проектиране на поливането по-долу.">Оценен среден дебит на емитер за полето, q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
$ec_lang['ip_du_estimate']='<span class="ec-help" title="Изчисленият дебит на последния емитер, разделен на оценения среден дебит на емитер за полето &mdash; това е приближение на стандартната равномерност на разпределение по долната четвърт (средно на долната група &divide; средно за съвкупността); тук обаче става дума за малка моделирана извадка и оценена от потребителя корекция, а не за пълна статистическа извадка за полето. Стойности, равни на или над 1, са възможни и валидни: те просто означават, че налягането при последния емитер е равно на или над оценената средна стойност за полето, така че друг емитер е точката с най-ниско налягане. Това може да се дължи на това, че последният емитер е на по-ниска кота, или защото оценката на &Delta;налягане е твърде малка.">Проверка за равномерност, q<sub>last</sub>/q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_ratio']='<span class="ec-help" title="Това е различно от нашето приближение на стандартния показател за равномерност.">Дебит на последния емитер &divide; проектен дебит, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
