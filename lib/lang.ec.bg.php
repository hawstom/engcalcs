...
$ec_lang['template_translation_help']='Можете ли да предложите по-добра формулировка или нещо друго? Моля, споделете с нас.';
...
$ec_lang['odt_main_desc']='Време за изпразване на езерце, басейн или резервоар &mdash; изход през отвор, метод на коничния обем';
