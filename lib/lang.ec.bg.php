...
$ec_lang['irr_card_canal_desc']='Проектирайте или проверете напоителен канал по формулата на Manning. Използвайте трапецовидния калкулатор за нови канали и калкулатора за произволно сечение за съществуващи естествени или изградени участъци.';
