...
$ec_lang['lpn_settings_engine_epanet_tip']='Стартира собствения решаващ модул на EPANET от американската EPA тук, във вашия браузър. Вграденият решаващ модул дава същите резултати и е по-бърз, затова оставете това изключено, освен ако не ви трябва самият EPANET.';
