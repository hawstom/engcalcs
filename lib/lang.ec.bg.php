...
$ec_lang['bpn_line_problem']='Проверете колоната Нагоре по течението ID: участък сочи към непознат ID, сочи сам към себе си или образува пръстен, така че част от мрежата не е свързана с източника. Тези участъци остават нерешени.';
$ec_lang['bpn_bad_id_short']='Мрежа';
