...
$ec_lang['lpn_file_convert_as']='Отвори xy файл на картата…';
$ec_lang['lpn_file_convert_as_tip']='Отваря файл на проект или EPANET файл в нов раздел на проект на тази страница, върху уличната карта. Поставяте чертежа върху света на ръка: преместете и мащабирайте до обекта, после го оразмерете и завъртете да пасне. Ако x и y във файла вече са дължина и ширина, натиснете бутона „Това вече е lat/lon“ и мрежата отива направо там, където принадлежи. Всяко въведено от вас число остава такова, каквото е.';
