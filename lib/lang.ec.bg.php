...
$ec_lang['lpn_pane_paste_note']='Тази таблица е предназначена за въвеждане на стойности чрез поставяне от електронна таблица в редове, които вече съществуват. Ако това не отговаря на вашите нужди, използвайте Помощ, Съобщи за проблем, за да ни уведомите.';
...
$ec_lang['lpn_georef_projected']='Този проект вече указва картна проекция, затова координатите му не могат да бъдат поставени на картата втори път.';
...
$ec_lang['lpn_new_coordsys_geo']='Географска проекция';
$ec_lang['lpn_new_coordsys_geo_tip']='Изберете географска проекция. Използвайте WGS 84 / Pseudo-Mercator EPSG:3857 за геогр. ширина/дължина.';
$ec_lang['lpn_new_coordsys_local']='Локална, схематична или потребителска';
$ec_lang['lpn_new_coordsys_local_tip']='Без географска привръзка. Прикачете свое собствено фоново изображение или никакво.';
$ec_lang['lpn_new_crs']='Картна проекция';
$ec_lang['lpn_new_crs_tip']='Проекцията, в която вече са измерени вашите координати. Координатите се съхраняват точно както ги въвеждате, и нищо не се преобразува. Този избор е постоянен; единственият начин да преобразувате мрежа в различни координати е с „Файл, Отвори в нови координати“, и той е приблизителен. UTM е доминиращият световен стандарт, даден регион може да има собствени практики, а геодезистът е човекът, когото да попитате, ако не сте сигурни.';
...
$ec_lang['lpn_crs_place_projected']='Проектиран проект се отваря върху собствената си равнина, а не на мястото, което сте търсили. Поставянето на тази равнина върху Земята изисква координатна трансформация, каквато тази страница все още няма.';
$ec_lang['lpn_crs_none']='Без географска привръзка';
...
$ec_lang['lpn_menu_cue']='Започнете от менютата по-горе. Използвайте лентата с инструменти за бърз достъп.';
