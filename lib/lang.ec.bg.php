...
$ec_lang['mphl_note_1']='<dl><dt>Този калкулатор не отчита котата на тръбата.</dt><dd>Ако HGL падне под горния ръб на тръбата в която и да е точка, това изчисление може да не е валидно.</dd><dt>При отворен вход (водосток) е необходима проверка за условия на контрол при входа.</dt><dd>1. HGL нагоре по течението трябва да бъде над котата на нормалната дълбочина на течението нагоре по течението (и по-високо от тръбата!).</dd><dd>2. Горната вода на водосток се представя по-добре чрез EGL нагоре по течението, отколкото чрез HGL нагоре по течението.</dd><dd>3. Вижте <a target="_blank" href="https://www.youtube.com/watch?v=0O1Ezk8SVxU">моя 2-минутен урок</a> за прости стандартни изчисления на горна вода за водостоци с HY-8.</dd>';
...
$ec_lang['mtc_solve_for_y']='Намерете дълбочината, y, при дадено Q';
$ec_lang['mtc_solve_desc']='Използвайки b, z<sub>1</sub>, z<sub>2</sub>, S и n от формуляра на калкулатора, намира дълбочината за дадено Q.';
