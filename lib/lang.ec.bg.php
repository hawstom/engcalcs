...
$ec_lang['lpn_field_text_match_pipe']='Съвпадение с ъгъла на тръбата';
...
$ec_lang['lpn_examples_size']='{nodes} възела, {links} тръби';
...
$ec_lang['lpn_ex_net3_desc']='Големият пример на EPANET: 97 възела, две цистерни и речен източник. Струва си да го отворите, за да видите как изглежда модел с реален размер на картата.';
...
$ec_lang['lpn_new_blank_us']='Празен проект, американски единици (gpm)';
$ec_lang['lpn_new_blank_si']='Празен проект, единици SI (l/s)';
...
$ec_lang['lpn_inp_drop_patterns']='Графиците на потреблението бяха пропуснати. Тази страница решава един момент във времето, затова всяка потребност е числото, записано във файла.';
...
$ec_lang['lpn_inp_drop_controls']='Управляващите правила бяха пропуснати. Всяка тръба, помпа и вентил бяха внесени в състоянието, записано във файла, и не се променят.';
$ec_lang['lpn_inp_drop_eps']='Този файл описва симулация, протичаща за определен период от време. Тази страница решава един момент, затова бяха внесени само началните условия.';
...
$ec_lang['lpn_pump_point1']='Точка 1 (задължителна)';
$ec_lang['lpn_pump_point2']='Точка 2 (незадължителна)';
$ec_lang['lpn_pump_point3']='Точка 3 (незадължителна)';
...
$ec_lang['lpn_settings_defaults']='Начални стойности';
...
$ec_lang['lpn_settings_engine_epanet_tip']='Стартира решаващия модул на EPANET от американската EPA тук, във вашия браузър. И двата решаващи модула дават еднакви резултати, и при мрежа с такъв размер няма да усетите разлика в скоростта. При първото включване се изтеглят около 650 KB, които след това остават на това устройство.';
...
$ec_lang['lpn_unit_unknown']='Този чертеж посочва единица, каквато тази страница не предлага: {unit}. Всичко е запазено и показано точно както е получено, и нищо не е променено. Не могат да бъдат дадени резултати, докато тази страница не разпознае тази единица, защото няма как да се определи колко голяма е тя.';
...
$ec_lang['lpn_settings_readability_bias']='Градуси наляво от вертикалата, преди етикетът да бъде обърнат';
