...
$ec_lang['lpn_settings_sec_assets']='Нови елементи';
...
$ec_lang['lpn_basemap_satellite_hide']='Скрий сателитните изображения';
$ec_lang['lpn_basemap_satellite_tip']='Снимки на земната повърхност от Mapbox, изтеглени през интернет, докато премествате и мащабирате изгледа. Полезни, за да видите къде наистина минава дадена тръба. Мрежата ви се чертае независимо дали изображенията са показани.';
$ec_lang['lpn_georef_asdeg_btn']='Това вече е геогр. дължина/ширина';
$ec_lang['lpn_georef_asdeg_tip']='Натиснете това само ако x и y в този файл наистина са географска дължина и ширина. Тогава мрежата веднага застава там, където сочат тези числа, и нищо не се налага да поставяте ръчно. Всяко число остава точно такова, каквото е, при всички положения.';
$ec_lang['lpn_georef_asdegrees']='X и y в този файл бяха прочетени като географска дължина и ширина, така че мрежата вече е на картата и нищо не е местено. Проверете дали е на правилното място, после натиснете „Запази това разположение“.';
...
$ec_lang['lpn_run_menu_tip']='Преизчисли тази мрежа сега. Търсите бутон „Изчисли“? Докато този проект се преизчислява след всяка промяна, лентата с инструменти няма бутон „Изчисли“. Изключете „Преизчислявай автоматично“ в Настройки, под Изчисление, Хидравлика, и бутонът се връща.';
...
$ec_lang['lpn_profile_draw']='Изберете пътя на картата';
$ec_lang['lpn_profile_draw_stop']='Спри избора';
...
$ec_lang['lpn_inp_drop_head_pattern']='Тези резервоари се покачват и понижават през деня. Графиците им бяха внесени изцяло, а показаното водно ниво е за момента, който часовникът показва.';
$ec_lang['lpn_inp_drop_pump_speed']='Тези помпи работят при скорост, различна от тази, при която е измерена кривата им, или сменят скоростта си през деня. Скоростта и графикът ѝ бяха внесени изцяло, а показаният напор е за момента, който часовникът показва.';
...
$ec_lang['lpn_import_notes_heading']='От файла на EPANET';
...
$ec_lang['lpn_notes_color_def']='Границите на цветовите диапазони се задават, когато изберете метод за класифициране на данните. Те не се задават отново на всяка стъпка от времето, защото това би направило цветовете да означават нещо ново на всяка стъпка, а това не помага за визуализирането на системата ви. EPANET работи по същия начин. За да получите нови граници, изберете метод отново или въведете свои собствени.';
...
$ec_lang['lpn_time_run_report_tip']='Това, което самият решаващ модул на EPANET е отпечатал за последното изпълнение: как се е стабилизирал и за какво е предупредил. Това е собственият текст на решаващия модул, не наш.';
...
$ec_lang['lpn_library_curves_tip']='Кривата е точките, които показват как работи помпата: колко напор създава при всяко водно количество.';
$ec_lang['lpn_library_curves_note']='Кривата принадлежи на помпата или вентила, който я използва, затова тук е целият набор на едно място за преглед. Щракнете върху ID, за да отидете на този обект и да промените точките му там. За помпа начертаната линия е кривата, използвана при изчислението, прекарана през точките; за вентил това са правите отсечки между тях.';
...
$ec_lang['lpn_library_default_pattern']='График на потребността по подразбиране';
$ec_lang['lpn_library_default_pattern_tip']='Всеки възел без свой график използва този.';
...
$ec_lang['lpn_field_demand_pattern_tip']='Как потребността на този възел се покачва и понижава през изчислението. Оставете „Без график“, за да следва графика на самия проект.';
...
$ec_lang['lpn_field_speed_pattern_tip']='Как скоростта на тази помпа се покачва и понижава през изчислението. Всеки коефициент Е относителната скорост за тази част от денонощието и заменя скоростта по-горе, така че коефициент 0 спира помпата.';
...
$ec_lang['lpn_terrain_menu']='Попълни коти от терена…';
$ec_lang['lpn_terrain_tip']='Прочита котата на земята под всеки възел, който няма такава, и я въвежда вместо вас. Възел, който вече има кота, се оставя непроменен, а едно Undo връща всичко обратно. При първа употреба се иска разрешението ви, защото позициите на възлите ви отиват към Mapbox.';
$ec_lang['lpn_terrain_accuracy']='Данните за терена имат разделителна способност от около 30 m на земята и обикновено грешка от няколко метра по вертикала. Приемайте ги като хоризонтали, не като геодезическо заснемане: проверявайте всичко, на което разчитате.';
...
$ec_lang['lpn_terrain_confirm']='Да се попълни ли котата на {n} възел(а) от повърхността на терена?';
...
$ec_lang['lpn_terrain_confirm_default_2']='Да се заменят ли тези {n} с повърхността на терена?';
...
$ec_lang['lpn_terrain_none_needed']='Всеки възел вече има кота, зададена от вас. Нищо не бе променено и нищо не бе изпратено — никога не презаписваме кота, която вече е налична.';
$ec_lang['lpn_terrain_no_nodes']='Все още няма възли за попълване.';
