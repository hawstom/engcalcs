...
$ec_lang['lpn_main_menu']='Пръстеновидна тръбна мрежа (интерфейс с карта)';
$ec_lang['lpn_main_title']='Безплатен онлайн калкулатор за пръстеновидна тръбна мрежа с интерфейс с карта';
$ec_lang['lpn_main_desc']='Налягане и водно количество в пръстеновидна тръбна мрежа, която чертаете върху карта';
