...
$ec_lang['mpf_velocity_head']='<span class="ec-help" title="Кинетична енергия, изразена като височина на воден стълб, v&sup2;/2g">Скоростен напор, h<sub>v</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['mtc_sgrock']='<span class="ec-help" title="Плътност спрямо водата. Обичайно &asymp; 2,65 за трошен камък.">Относителна плътност на камъка, sg <span class="ec-tip">?</span></span>';
...
$ec_lang['cs_notes_3_def']='Въведете стойността на водата и цената на облицовката в произволна, но последователна валута. Площ на облицовката = дължина на участъка &times; омокрен периметър &mdash; омокреният периметър на напречното сечение на канала при измерената дълбочина на потока (ширина на дъното плюс двата омокрени откоса). Годишната възстановена стойност предполага, че облицованият канал постига целевата E<sub>c</sub> непрекъснато. Действителният срок на откупуване ще бъде по-дълъг при сезонни канали или ако облицовката не достигне целевата ефективност.';
