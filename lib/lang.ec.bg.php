...
$ec_lang['mhp_efficiency']='КПД на централата, &eta; (0&ndash;1)';
...
$ec_lang['mhp_notes_1_def']='Обща загуба h<sub>L</sub> = h<sub>f</sub> + h<sub>m</sub>, където h<sub>f</sub> = f(L/D)(v&sup2;/2g) е загубата от триене по Дарси-Вайсбах, а h<sub>m</sub> = k<sub>m</sub>&middot;v&sup2;/2g включва вход, колена и спирателни органи. Нетен напор H<sub>net</sub> = H<sub>gross</sub> &minus; h<sub>L</sub>.';
$ec_lang['mhp_notes_2_term']='Скорост';
$ec_lang['mhp_notes_2_def']='Целева скорост 1&ndash;3 м/с. Под 1 м/с тръбата е свръхоразмерена; над 3 м/с нарастват загубите от триене и рискът от хидравличен удар.';
$ec_lang['mhp_notes_3_term']='Целева загуба на напор';
$ec_lang['mhp_notes_3_def']='Загуба под 10% от брутния напор е икономически оправдана. Оптималният компромис между цената на тръбата и изгубената мощност обикновено е около 4&ndash;6% за обекти с висока стойност на електроенергията.';
$ec_lang['mhp_notes_4_term']='Местни загуби k<sub>m</sub>';
$ec_lang['mhp_notes_4_def']='Типични стойности: остър вход 0.5, всяко коляно 45&deg; между 0.2&ndash;0.3, спирателен кран (напълно отворен) 0.1, пеперудна клапа 0.2. Сумирайте всички фитинги за общ k<sub>m</sub>. Стойността по подразбиране 1.5 приема един вход и две колена.';
$ec_lang['mhp_notes_5_term']='Грапавост на тръбата e';
$ec_lang['mhp_notes_5_def']='Типична абсолютна грапавост: стомана (нова) 0.046&nbsp;мм, стомана (стара) 0.15&nbsp;мм, HDPE 0.003&nbsp;мм, PVC/uPVC 0.0015&nbsp;мм, бетон 0.3&ndash;3&nbsp;мм. HDPE е широко разпространен за малки микрохидро тръбопроводи.';
...
$ec_lang['cs_main_desc']='Просмукване от канал &amp; ефективност на транспортиране &mdash; метод вход-изход';
...
$ec_lang['cs_Ec_target']='Целева ефективност на транспортиране след облицоване, E<sub>c,target</sub> (дял, 0&ndash;1) &mdash; цел за задържане на вода от облицования канал';
$ec_lang['cs_lining_area']='Площ на облицовката на канала (L &times; P<sub>w</sub>)';
...
$ec_lang['rc_main_desc']='Оразмеряване на Каменна Наброска за Улей &mdash; Robinson, Rice &amp; Kadavy (1998)';
...
$ec_lang['rc_layer']='Дебелина на слоя наброска (2 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_radius']='Радиус на кривата на гребена (40 &times; D<sub>50</sub>)';
$ec_lang['rc_crest_length']='Дължина на дъгата на кривата на гребена';
$ec_lang['rc_apron_length']='Дължина на изходния праг (15 &times; D<sub>50</sub>) <span title="Необходим за конструктивна опора на камъка на улея. «Минималният подпор, възникващ в резултат на съпротивлението на изходния участък и низходящия канал, е достатъчен за осигуряване на устойчивостта на наброската в изходния участък.» (Robinson)" style="cursor:help;color:#06c;font-size:0.9em">?</span>';
...
$ec_lang['rc_qs']='Повърхностен специфичен дебит, q<sub>s</sub> (q<sub>t</sub> &minus; q<sub>m</sub>)';
...
$ec_lang['rc_notes_1_def']='Robinson, Rice &amp; Kadavy (1998) разработиха две емпирични уравнения за медианен размер на наброската D<sub>50</sub> въз основа на наклона на улея и специфичния дебит. Уравнение 1 се прилага за полегати наклони (S<sub>0</sub> &lt; 0,10); Уравнение 2 — за стръмни наклони (0,10 &le; S<sub>0</sub> &le; 0,40). И двете уравнения изискват q<sub>t</sub> в м&sup2;/с и връщат D<sub>50</sub> в мм. Валидираният диапазон е 0,02 &le; S<sub>0</sub> &le; 0,40.';
$ec_lang['rc_notes_2_term']='Специфичен дебит';
$ec_lang['rc_notes_2_def']='q<sub>t</sub> е общият специфичен дебит при гребена на улея (общ дебит на единица ширина). За канал с ширина на дъното B и общ дебит Q приближено q<sub>t</sub> &asymp; Q / B, или го изчислете от условието за критична дълбочина при входа на улея.';
$ec_lang['rc_notes_3_term']='Поток през каменната мантия';
$ec_lang['rc_notes_3_def']='Част от общия дебит преминава през порите на каменната наброска (дебит през мантията q<sub>m</sub>); остатъкът тече по повърхността на камъка (q<sub>s</sub> = q<sub>t</sub> &minus; q<sub>m</sub>). Дълбочината на потока d се изчислява по уравнението на Manning за повърхностния дебит q<sub>s</sub> с коефициента на грапавост на улея n. Порьозността по подразбиране n<sub>p</sub> = 0,45 е типична за ъглест натрошен камък.';
