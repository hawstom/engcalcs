...
$ec_lang['mphl_hgl_egl_tip']='Може да не е валидно, ако тръбата е разположена високо. Вижте бележките.';
...
$ec_lang['mtc_n_pi']='n за проектния размер на камъните по Phillips & Ingersoll';
...
$ec_lang['mhp_hl_ok_tip']='В рамките на целта от 10% — икономично.';
$ec_lang['mhp_hl_warn_tip']='Надвишава целта от 10%. Помислете за по-голяма тръба.';
$ec_lang['mhp_hl_bad_tip']='Надвишава целта от 20%. Увеличете размера на тръбата.';
...
$ec_lang['bpn_topology_warn']='Проверете колоната Нагоре по течението ID: участък сочи към непознат ID, сочи сам към себе си или образува пръстен, така че част от мрежата не е свързана с източника. Тези участъци остават нерешени.';
...
$ec_lang['lpn_ex_net3_world_desc']='Същата мрежа като EPANET Net3, поставена на реално място: координатите ѝ са географска дължина и ширина, а зад нея е начертана уличната карта.';
...
$ec_lang['lpn_demand_tip']='Водно количество, изтеглено от мрежата в този възел. Въведете отрицателно число за водно количество, подавано в мрежата тук.';
$ec_lang['lpn_units_warn_title']='Тази единица определя какво означават числата ви';
$ec_lang['lpn_units_warn_body']='{unit} е единицата на това, което въвеждате за: {list}. „Преизтълкувай“ оставя всяко число такова, каквото е, и го чете в новата единица. „Преизчисли всички“ пренаписва всяко от тези числа, така че мрежата да покрива същата площ, както преди.';
$ec_lang['lpn_units_reinterpret']='Преизтълкувай (промени какво означават)';
$ec_lang['lpn_units_convert']='Преизчисли всички';
...
$ec_lang['lpn_units_group_inputs']='Единици на въвежданите данни';
$ec_lang['lpn_units_group_results']='Единици на резултатите';
...
$ec_lang['lpn_georef_menu']='Преобразувай в lat/lon…';
$ec_lang['lpn_georef_tip']='От локална мрежа към реалния свят. Поставя чертеж, направен върху мрежата XY, върху географски координати, така че да застане на уличната карта там, където му е мястото. Всяко въведено от вас число остава такова, каквото е — само X и Y стават географска дължина и ширина.';
$ec_lang['lpn_georef_intro']='Да се преобразува ли този проект XY в географски проект? Проектът ви е поставен в центъра на световна карта. Мащабирайте до вашето местоположение и премествайте, преоразмерявайте и завъртайте модела колкото пъти пожелаете. Когато сте готови да започнете да коригирате елементи, натиснете „Запази това разположение“.';
$ec_lang['lpn_georef_adjust']='Плъзнете модела, за да го преместите, плъзнете ъгъл, за да го преоразмерите, плъзнете кръглата дръжка над модела, за да го завъртите. Или въведете мащаба и ъгъла на завъртане по-долу.';
$ec_lang['lpn_georef_step1']='Стъпка 1 от 2 — отделен';
$ec_lang['lpn_georef_step2']='Стъпка 2 от 2 — прикрепен';
...
$ec_lang['lpn_tool_add_reservoir_tip']='Щракнете върху картата, за да добавите резервоар: източник, който поддържа едно постоянно водно ниво.';
$ec_lang['lpn_tool_add_tank_tip']='Щракнете върху картата, за да добавите цистерна: съоръжение за съхранение с водна повърхност, която вие задавате.';
...
$ec_lang['lpn_find_menu_tip']='Намерете елемент по неговия идентификатор, или намерете всички елементи, отговарящи на дадено условие.';
...
$ec_lang['lpn_color_ranges_note']='Режимът по-горе задава тези граници от стойностите, които в момента са на картата. Въведете нови стойности и едно и също число винаги ще означава един и същ цвят.';
$ec_lang['lpn_color_criterion_note']='Границите на диапазоните идват от проектен стандарт, затова броят на диапазоните е фиксиран, докато е избран този режим.';
$ec_lang['lpn_color_break_number']='Границата на диапазон трябва да е число. Картата остава непроменена.';
$ec_lang['lpn_color_break_order']='Всяка граница на диапазон трябва да е по-голяма от предходната. Картата остава непроменена.';
$ec_lang['lpn_color_break_count']='Границите трябва да са с една по-малко от броя на диапазоните. Картата остава непроменена.';
...
$ec_lang['lpn_georef_confirm']='Да се постави ли моделът тук за постоянно? След това все още можете да плъзгате отделни елементи, но чертежът престава да бъде проект XY. За да върнете XY, затворете този проект без запис.';
$ec_lang['lpn_georef_done']='Това вече е проект lat/lon. Плъзнете кой да е елемент, за да го приближите до мястото, където наистина се намира.';
$ec_lang['lpn_georef_on_map']='Този проект вече е на lat/lon.';
$ec_lang['lpn_georef_empty']='Първо начертайте или отворете мрежа. Все още няма какво да се постави.';
...
$ec_lang['lpn_pane_toggle_tip']='Показва или скрива панела под картата. В него са профилът и таблицата с възлите.';
$ec_lang['lpn_pane_resize']='Плъзнете, за да направите панела по-висок или по-нисък';
$ec_lang['lpn_pane_tab_junctions']='Възли';
$ec_lang['lpn_pane_tab_junctions_tip']='Всички възли като таблица, която можете да сортирате и редактирате.';
$ec_lang['lpn_pane_junctions_none']='Тази мрежа все още няма възли.';
$ec_lang['lpn_pane_sort_tip']='Сортирай по тази колона. Щракнете отново, за да обърнете реда.';
$ec_lang['lpn_clean_map']='Скрий показанията на картата';
$ec_lang['lpn_clean_map_off']='Покажи показанията на картата';
$ec_lang['lpn_clean_map_tip']='Скрива реда с режима и показанието на координатите, така че екранна снимка да показва само картата. Чертежът ви не се засяга, и този избор не се запазва — презареждането на страницата връща показанията обратно.';
...
$ec_lang['lpn_find_menu']='Търсене';
$ec_lang['lpn_find_title']='Търсене на елементи';
...
$ec_lang['lpn_profile_from']='От';
$ec_lang['lpn_profile_to']='До';
$ec_lang['lpn_profile_pick']='Добавете възли към маршрута, като щраквате върху тях на картата';
$ec_lang['lpn_profile_through']='Възли по пътя';
$ec_lang['lpn_profile_clear']='Премахни всички';
...
$ec_lang['lpn_new_blank_us']='Празен проект XY, американски единици (gpm)';
$ec_lang['lpn_new_blank_si']='Празен проект XY, единици SI (L/s)';
$ec_lang['lpn_new_geo_us']='Празен проект lat/lon, американски единици (gpm)';
$ec_lang['lpn_new_geo_si']='Празен проект lat/lon, единици SI (L/s)';
...
$ec_lang['lpn_file_import_inp_tip']='Прочита мрежа от файл на EPANET — текстовия файл .inp или файла .net, който EPANET записва — и я запазва в този браузър като нов проект. Тази страница не може да записва обратно файл на EPANET, затова използвайте Файл, Запиши като, за да запазите работата си.';
...
$ec_lang['lpn_inp_report_lead']='Тази страница не поддържа всичко, което поддържа EPANET. Ето какво се промени при внасянето:';
...
$ec_lang['lpn_inp_drop_valve']='Тези вентили се описват с крива или с фиксиран пад на налягането, а тази страница няма такъв елемент. Те бяха внесени като отворени тръби, така че мрежата остава свързана, но вече нищо не поддържа налягане или водно количество там.';
$ec_lang['lpn_inp_drop_tank_curve']='Тези цистерни не са с прави стени: файлът задава формата им чрез крива. Те бяха внесени като кръгли цистерни, всяка с диаметъра, записан във файла. Водната повърхност остава тази, зададена от файла, така че резултатите съвпадат; опростена е само формата.';
...
$ec_lang['lpn_inp_drop_patterns']='Графиците на потреблението бяха пропуснати, защото частта от тази страница, която изчислява мрежата през времето, не се зареди. Всяка потребност е числото, записано във файла.';
$ec_lang['lpn_inp_drop_demand_pattern']='Тези възли променят потребността си през деня. Графиците им са внесени изцяло, а потребността, която виждате, е тази за момента, който часовникът показва.';
...
$ec_lang['lpn_inp_drop_curve_missing']='Тази помпа сочи крива, която не е във файла. Тя бе внесена без крива, затова не добавя напор.';
$ec_lang['lpn_inp_drop_pump_other']='Тази помпа е описана чрез мощност, скорост или график, а не чрез крива. Тя бе внесена без крива, затова не добавя напор.';
...
$ec_lang['lpn_inp_drop_controls']='Тези управления и правила бяха пропуснати. Тръбите, помпите и вентилите, които те посочват, бяха внесени в състоянието, записано във файла, и остават такива.';
$ec_lang['lpn_inp_drop_eps']='Този файл описва симулация, която протича за период от време. Частта от тази страница, която изчислява мрежата през времето, не се зареди, затова бяха внесени само началните условия.';
$ec_lang['lpn_inp_drop_quality']='Настройките за качество на водата, химични реакции и енергия на помпите бяха пропуснати. Тази страница решава само водно количество и налягане.';
...
$ec_lang['lpn_lock_prompt_name']='Какво трябва да виждат колегите ви, когато този проект е отворен от вас? Инициалите ви са идеални. Всеки, който отвори същия файл, може да го види, затова не използвайте нищо лично.';
...
$ec_lang['lpn_lock_open_copy']='Създай копие';
$ec_lang['lpn_lock_break']='Разбий заключването';
$ec_lang['lpn_lock_open_heading_times']='{name} има отворен този файл; последната редакция е била преди {x}, {y} след последното записване.';
$ec_lang['lpn_lock_open_heading_unsaved']='{name} има отворен този файл; последната редакция е била преди {x} и нищо от нея все още не е записано във файла.';
$ec_lang['lpn_lock_open_heading_saved']='{name} има отворен този файл; последната редакция е била преди {x}, а работата му е записана във файла.';
$ec_lang['lpn_lock_open_heading_seen']='{name} има отворен този файл, но не го е редактирал. Браузърът му последно се е обадил преди {x}.';
$ec_lang['lpn_lock_open_choices']='Вашите възможности: (1) Отказ и помолете ги да го отворят, ако е необходимо, и после да го затворят правилно (затварянето на браузъра не затваря проекта), (2) Отвори само за четене, или (3) ако нищо друго не помогне, можете да разбиете заключването им. Незаписаната им работа не се губи, но те няма да могат да запишат върху вашите промени, и може да се наложи някой да обедини двете ръчно.';
...
$ec_lang['lpn_file_training_3']='Дайте кратко име, по което колегите ви ще ви разпознават. Инициалите ви са идеални. Всеки, който отвори същия файл, може да го види, затова не използвайте нищо лично.';
$ec_lang['lpn_file_training_name']='Вашите инициали';
...
$ec_lang['lpn_notes_1_term']='Установен режим';
$ec_lang['lpn_notes_1_def']='Решава по един набор от потребности наведнъж, използвайки същия глобален градиентен алгоритъм, който използва EPANET. Не моделира как мрежата се променя във времето. Цистерна се поддържа на зададеното от вас водно ниво: в рамките на едно решение тя никога не се изпразва и никога не се пълни.';
$ec_lang['lpn_notes_2_term']='Не се моделира';
$ec_lang['lpn_notes_2_def']='Качеството на водата и потребностите, които се променят през деня, не се моделират. За вентилите: дроселиращият вентил работи с всеки от двата решаващи модула, а вентилите, които се отварят и затварят сами (PRV, PSV, FCV), се решават с решаващия модул на EPANET, който тази страница включва автоматично, когато мрежата ви съдържа такъв.';
...
$ec_lang['lpn_inp_drop_gpv_curve']='Този вентил сочи крива на загуба на напор, която не е във файла. Вентилът бе внесен без крива, затова остава напълно отворен, докато не му зададете такава.';
$ec_lang['lpn_gpv_curve_note']='До три точки от водно количество и загубата на напор при това водно количество. Оставете ги празни и вентилът остава напълно отворен.';
...
$ec_lang['lpn_pump_curve_source']='Източник на кривата';
$ec_lang['lpn_pump_curve_own']='Въведете точки по-долу';
$ec_lang['lpn_pump_curve_ref_note']='Използва се кривата, въведена за помпа {id}.';
$ec_lang['lpn_pump_curve_note']='Една, две или три точки — вижте „Помпена крива“ в Бележките по-долу.';
...
$ec_lang['lpn_mode_select']='Режим: Избор. Щракнете върху елемент или етикет, за да го видите или промените. Плъзнете, за да преместите възел, пречупна точка или етикет. Щракнете двукратно върху тръба, за да добавите или премахнете пречупна точка.';
...
$ec_lang['lpn_mode_add_pipe']='Режим: Добавяне на тръба. Щракнете върху възел, после върху друг възел, за да ги свържете. Превключете към режим Избор, за да променяте или премествате елементи и етикети.';
$ec_lang['lpn_mode_add_pump']='Режим: Добавяне на помпа. Щракнете върху възел, после върху друг възел, за да ги свържете. Превключете към режим Избор, за да променяте или премествате елементи и етикети.';
$ec_lang['lpn_mode_add_valve']='Режим: Добавяне на вентил. Щракнете върху възел, после върху друг възел, за да ги свържете. Превключете към режим Избор, за да променяте или премествате елементи и етикети.';
// Text was wrong (Tom, 2026-07-30): "click a node first to anchor it there" implied a two-click
// sequence (click node, THEN click to place), but placing near a node anchors it in that ONE click.
$ec_lang['lpn_mode_add_text']='Режим: Добавяне на текст. Щракнете върху картата, за да поставите текстов етикет. Щракнете близо до възел, за да прикачите текста към него. Превключете към режим Избор, за да променяте или премествате елементи и етикети.';
...
$ec_lang['lpn_tip_select']='Използвайте този режим, за да променяте, премествате и плъзгате неща на картата.';
...
$ec_lang['lpn_labels_mark_extrema_tip']='Чертае линия над най-високата стойност от всеки вид на картата и линия под най-ниската стойност от този вид, за да разпознавате двата края, без да четете числата.';
$ec_lang['lpn_settings_apply_to_all']='Приложи към всички';
$ec_lang['lpn_settings_apply_to_all_tip']='Всеки вече начертан елемент от този вид получава ID, започващ с този текст. Всеки запазва номера си. ID, който не завършва на число, остава непроменен.';
$ec_lang['lpn_confirm_apply_prefix']='Да преименувам ли {n} елемента, така че техните ID да започват с {prefix}? Всеки запазва номера си.';
$ec_lang['lpn_prefix_applied']='Преименувани {n} елемента. {skipped} други останаха непроменени.';
$ec_lang['lpn_labels_prefix_tip']='Текст, показван преди тази стойност на картата';
$ec_lang['lpn_labels_prefix_id_tip']='Текст, показван преди ID-то на картата. Оставете полето празно и ID-то се показва само по себе си, започвайки с буквата, дадена му, например J1 или L1.';
$ec_lang['lpn_labels_suffix_tip']='Текст, показван след тази стойност на картата';
$ec_lang['lpn_labels_suffix_gradient_tip']='Текст, показван след градиента на загубата на напор на картата. Не въвеждайте знак за процент тук. Той се добавя автоматично, когато единиците са проценти.';
$ec_lang['lpn_labels_separator']='Текст между стойностите';
$ec_lang['lpn_labels_separator_tip']='Текст между една стойност и следващата в етикет. По подразбиране е интервал.';
...
$ec_lang['lpn_labels_priority_node_tip']='Приоритет за определяне кой етикет отпада първи, когато картата е претрупана: най-ниската потребност, налягането, най-близко до средата на диапазона, или котата, или напора, най-близки до тези на съседните възли. 1 решава първи.';
...
$ec_lang['lpn_settings_scope_project']='Настройки на проекта';
$ec_lang['lpn_settings_scope_calculator']='Настройки на калкулатора';
...
$ec_lang['lpn_settings_defaults_note']='Използват се за елементи, които създавате оттук нататък. Съществуващите елементи не се променят.';
$ec_lang['lpn_settings_push_note']='Прилагат се само свойствата, чиито етикети се показват в момента.';
$ec_lang['lpn_settings_push_btn']='Приложи началните стойности към всички елементи';
$ec_lang['lpn_push_confirm']='Да се заменят ли тези свойства на всеки съществуващ елемент с текущите начални стойности? Въведените от вас стойности ще бъдат презаписани. Можете да отмените това.';
$ec_lang['lpn_push_properties']='Свойства:';
$ec_lang['lpn_push_elements']='Възли и тръби:';
...
$ec_lang['lpn_scenario_overrides']='Свои стойности';
...
$ec_lang['lpn_delete_drops_overrides']='Изтриването на този елемент изхвърля и {n} стойности, които вашите сценарии пазят за него. Продължи ли?';
...
$ec_lang['lpn_settings_computation']='Изчисление';
$ec_lang['lpn_settings_tolerance']='Толеранс на сходимост';
$ec_lang['lpn_settings_tolerance_tip']='Колко близо трябва да стигне решаващият алгоритъм, преди да спре. По-малко число е по-точно и отнема повече време.';
$ec_lang['lpn_settings_engine_epanet']='Решавай с решаващия модул на EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='Стартира решаващия модул на EPANET от американската агенция EPA, тук във вашия браузър. При мрежа с такъв размер няма да усетите разлика в скоростта. Двата решаващи модула се съгласуват в общи линии, но не напълно точно: EPANET закръгля стойността, която използва за земното ускорение, затова местните (локални) загуби при него излизат около 0,08% по-ниски, отколкото при вградения решаващ алгоритъм, а при грапавост по Манинг загубата на напор излиза около 0,6% по-ниска. При първото отмятане на това поле се изтеглят около 650 KB, които след това остават на това устройство.';
...
$ec_lang['lpn_engine_minor_loss_note']='Забележка: с решаващия модул на EPANET местните (локални) загуби излизат съвсем малко по-ниски, отколкото с вградения решаващ алгоритъм, защото EPANET закръгля стойността, която използва за земното ускорение.';
...
$ec_lang['lpn_settings_map_height_tip']='На малък екран картата се изчертава по-ниска от това, така че винаги остава част от страницата за превъртане.';
$ec_lang['lpn_settings_legend_position']='Позиция на легендата';
...
$ec_lang['lpn_settings_colors']='Оцветяване по стойност';
...
$ec_lang['lpn_settings_color_thematic']='Тематична карта: само цветове, без етикети';
...
$ec_lang['lpn_time_menu_tip']='Задайте колко дълго работи тази мрежа и я преминавайте момент по момент.';
...
$ec_lang['lpn_time_running']='Изчислява се целият период от време с решаващия модул на EPANET.';
$ec_lang['lpn_time_no_engine']='Вграденият решаващ алгоритъм изчислява само по един момент от време, затова това е мрежата само в {time}: потребностите носят множителите на графика за този момент, а всяка цистерна все още стои на началното си ниво, вместо да се пълни и изпразва. Свържете се веднъж с интернет, за да изтеглите решаващия модул на EPANET, който изчислява целия период.';
$ec_lang['lpn_time_slider']='Време';
$ec_lang['lpn_time_no_period']='Този проект няма времеви период, затова има само един момент за показване. Задайте Общо време на изпълнение в Настройки, за да изчислите мрежата във времето.';
...
$ec_lang['lpn_time_run_tip']='Изчислява мрежата във всеки от моментите на отчитане, от първия до последния.';
$ec_lang['lpn_time_run_note']='Виждате мрежата в първия момент на отчитане. Изчисляването на тази мрежа за целия ѝ времеви период отнема толкова дълго, че резултатите за по-късните моменти не се актуализират, докато работите. Натиснете „Изчисли“, за да ги актуализирате.';
...
$ec_lang['lpn_settings_node_symbology']='Символика на възлите';
$ec_lang['lpn_settings_link_symbology']='Символика на тръбите';
$ec_lang['lpn_settings_node_link']='Възли и участъци';
