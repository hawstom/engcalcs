...
$ec_lang['irr_main_title']='Безплатни онлайн калкулатори за измерване на водно количество при напояване';
$ec_lang['irr_main_desc']='Измерване на водно количество при напояване — преливници и отвори';
$ec_lang['irr_intro_html']='<p>Преливниците и отворите са стандартните полеви инструменти за измерване на водното количество в напоителни системи. Изберете калкулатора, който съответства на вашето съоръжение:</p>';
$ec_lang['irr_card_weir_uniform_head']='Преливник — широкогребенен (еднородна ширина)';
$ec_lang['irr_card_weir_uniform_desc']='Измерете водното количество над гребена на отводнителна язовирна стена, контролно съоръжение или дъска на преливник. Въведете дължината на преливника и дълбочината на водата над гребена.';
...
$ec_lang['irr_card_orifice_desc']='Измерете водното количество през шлюзов затвор, тръбен изход или отвор на водосток. Автоматично се обработват както свободно изтичане, така и потопени условия (с повишено ниво надолу по течението).';
...
$ec_lang['ip_count']='<span class="ec-help" title="Редове за латерал: емитерите само в този участък. Редове за главен тръбопровод: общият брой емитери на латерали, РАЗЛИЧНИ от този, които се отклоняват от този участък. За участъка на главния тръбопровод, който завършва при пробния латерал, това включва и всички латерали по-нататък по главния тръбопровод след тази точка, както и споделящите същия възел (напр. латерал от срещуположната страна) &mdash; тяхното водно количество също се отклонява от този участък.">Емитери <span class="ec-tip">?</span></span>';
$ec_lang['ip_length']='L';
...
$ec_lang['ip_q_avg_field']='<span class="ec-help" title="q_avg_lateral, преизчислен при налягането на всеки ред от латерала плюс въведената по-горе разлика в налягането &mdash; опит за корекция на факта, че пробният латерал е предполагаемият най-неблагоприятен случай, а не представителен. Захранва както проверката за равномерност, така и раздела за проектиране на поливането по-долу.">Оценено средно водно количество на емитер за полето, q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
$ec_lang['ip_du_estimate']='<span class="ec-help" title="Изчисленото водно количество на последния емитер, разделено на оцененото средно водно количество на емитер за полето &mdash; това е приближение на стандартната равномерност на разпределение по долната четвърт (средно на долната група &divide; средно за съвкупността); тук обаче става дума за малка моделирана извадка и оценена от потребителя корекция, а не за пълна статистическа извадка за полето. Стойности, равни на или над 1, са възможни и валидни: те просто означават, че налягането при последния емитер е равно на или над оценената средна стойност за полето, така че друг емитер е точката с най-ниско налягане. Това може да се дължи на това, че последният емитер е на по-ниска кота, или защото оценката на &Delta;налягане е твърде малка.">Проверка за равномерност, q<sub>last</sub>/q<sub>avg,field</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_q_ratio']='<span class="ec-help" title="Това е различно от нашето приближение на стандартния показател за равномерност.">Водно количество на последния емитер &divide; проектно водно количество, q<sub>last</sub>/q<sub>design</sub> <span class="ec-tip">?</span></span>';
...
$ec_lang['ip_notes_5_def']='Нормата на поливане и водното количество на системата/зоната използват оцененото средно водно количество на емитер за полето (q<sub>avg,field</sub> &mdash; собствената средна стойност на пробния латерал, коригирана с въведената оценка за &Delta;налягане), а не предполагаема норма: PR = q<sub>avg,field</sub> / A<sub>e</sub>, захранена от коригираната моделирана стойност. Разстоянията и общият брой латерали/емитери за системата са отделни входни данни тук, защото пробният път моделира само един клон с най-неблагоприятен случай, а не всеки латерал в полето.';
