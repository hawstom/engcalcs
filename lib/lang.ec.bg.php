...
$ec_lang['lpn_main_menu']='Пръстеновидна тръбна мрежа (интерфейс с карта) — ПРЕДВАРИТЕЛНА ВЕРСИЯ';
$ec_lang['lpn_main_title']='ПРЕДВАРИТЕЛНА ВЕРСИЯ: Безплатен онлайн калкулатор за пръстеновидна тръбна мрежа с интерфейс с карта';
$ec_lang['lpn_main_desc']='ПРЕДВАРИТЕЛНА ВЕРСИЯ — Налягане и водно количество в пръстеновидна тръбна мрежа, която чертаете върху карта';
