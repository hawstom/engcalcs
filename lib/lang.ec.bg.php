...
$ec_lang['mtc_iteration_tip']='Изберете опция за грапавина (препоръчва се Blodgett–Bathurst) и опция за размер на камъните (препоръчва се Isbash), за да се извърши автоматична итерация към равномерен размер на камъните за целевото водно количество. Вижте бележките по-долу за пълния метод, или въведете собствена стойност на грапавината и игнорирайте размера на камъните, за да пропуснете итерацията.';
