...
$ec_lang['index_title']='Безплатни онлайн инженерни калкулатори';
...
$ec_lang['bpn_line_table_title']='Тръбопроводни участъци';
$ec_lang['bpn_id']='ID';
...
$ec_lang['bpn_sketch_title']='Схема на мрежата';
...
$ec_lang['lpn_main_title']='Безплатен онлайн калкулатор за водоразпределителна мрежа с двигателя EPANET';
...
$ec_lang['lpn_empty_hint']='Започнете, като добавите фоново изображение или резервоар от лентата с инструменти, или отворете Файл, Нов проект, за да започнете от пример.';
...
$ec_lang['lpn_v2_restore_prompt']='Този калкулатор съхранява единиците и въведените стойности на проекта така, както са въведени, но по-рано преобразуваше числата в SI за съхранение. Този проект е записан преди тази промяна, така че числата му са съхранени в SI. Да ги преобразуваме ли за последен път в текущите единици? За да прецените, ето някои диаметри, които биха се преобразували, с техните стойности преди и след:';
...
$ec_lang['lpn_new_from_examples']='От примери';
...
$ec_lang['lpn_new_example_us']='Основна мрежа, американски единици (gpm)';
$ec_lang['lpn_new_example_si']='Основна мрежа, единици SI (l/s)';
...
$ec_lang['lpn_inp_report_counts']='{nodes} възела и резервоара, {links} тръби и помпи, в {units}.';
...
$ec_lang['lpn_inp_drop_tanks']='Резервоарите с променливо ниво (тип „tank“ в EPANET) бяха пропуснати. Тази страница има резервоари, които поддържат едно фиксирано водно ниво. Резервоар с променливо ниво не поддържа фиксирано ниво, затова не е резервоар в смисъла на тази страница.';
$ec_lang['lpn_inp_drop_tank_links']='Тези тръби бяха пропуснати, защото се свързват с резервоар с променливо ниво, който бе пропуснат.';
$ec_lang['lpn_inp_drop_tcv']='Тези дроселиращи регулиращи вентили (TCV) бяха внесени като много къси тръби, носещи същата местна загуба. Водата се държи по същия начин, но елементът не е същият.';
$ec_lang['lpn_inp_drop_valve']='Тези вентили регулират налягане или водно количество, а тази страница няма такъв елемент. Те бяха внесени като отворени тръби, така че мрежата остава свързана, но вече нищо не я регулира.';
...
$ec_lang['lpn_inp_drop_units']='Единиците за водно количество в този файл не бяха разпознати, затова бе прието галони в минута. Проверете всяко число, преди да използвате резултатите.';
...
$ec_lang['lpn_close_save_prompt']='Да запишем ли промените в {name}, преди да го затворим?';
// A browser project is in no file at all, so closing it really is the end of it. Said plainly rather
// than softened -- this is the one destructive act left on the page.
$ec_lang['lpn_close_browser_prompt']='{name} се съхранява само в този браузър. Ако го затворите, без да го запишете във файл, той ще изчезне завинаги.';
...
$ec_lang['lpn_file_reconnect_prompt']='Този проект произхожда от {file}. Браузърът ви отново се нуждае от разрешението ви, преди да може да записва в него. Свържете се отново по-долу.';
...
$ec_lang['lpn_notes_1_def']='Решава по един набор от потребности наведнъж, използвайки същия глобален градиентен алгоритъм, който използва EPANET. Не моделира как мрежата се променя във времето.';
$ec_lang['lpn_notes_2_term']='Не се моделира';
$ec_lang['lpn_notes_2_def']='Резервоари с променливо ниво, качество на водата и регулиращи вентили, които се отварят и затварят сами (PRV, PSV, FCV), не се моделират. Тръба може да носи фиксирана местна загуба, но не и вентил, чието отворено или затворено състояние зависи от водното количество, което се търси.';
...
$ec_lang['lpn_diag_no_fixed_head']='Добавете резервоар. Мрежата се нуждае от поне едно известно водно ниво, преди да може да бъде решена.';
...
$ec_lang['lpn_backdrop_position_prompt1']='Щракнете върху произволна точка от фоновото изображение. Това е точката, която ще преместите.';
$ec_lang['lpn_backdrop_position_prompt2']='Изберете къде трябва да отиде тази точка, после щракнете Продължи.';
...
$ec_lang['lpn_settings_engine_epanet']='Решавай с двигателя на EPANET';
$ec_lang['lpn_settings_engine_epanet_tip']='Стартира оригиналния двигател на EPANET от американската EPA тук, във вашия браузър. Вграденият решаващ алгоритъм дава същите резултати и е по-бърз, затова оставете това изключено, освен ако не ви трябва самият EPANET.';
$ec_lang['lpn_engine_loading']='Зареждане на двигателя на EPANET…';
$ec_lang['lpn_engine_failed']='Двигателят на EPANET не можа да бъде зареден. Вместо него се показва вграденият решаващ алгоритъм.';
...
$ec_lang['lpn_settings_symbol_size']='Размер на символите (спрямо текста)';
