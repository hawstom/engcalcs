...
echoCalculatorForm(
	//Inputs
	Array(
		Array('name' => 'd', 'type' => 'number', 'units' => Array('m','mm','ft','in'), 'label' => $ec_lang['hw_pipe_diameter']),
		Array('name' => 'c', 'type' => 'number', 'units' => NULL, 'label' => $ec_lang['hw_roughness']),
		Array('name' => 'k', 'type' => 'number', 'units' => NULL, 'label' => $ec_lang['hw_k']),
		Array('name' => 'l', 'type' => 'number', 'units' => Array('m','mm','ft','in'), 'label' => $ec_lang['hw_length']),
		Array('name' => 'q', 'type' => 'number', 'units' => Array('m3ps','lps','mld','ft3ps','gpm','mgd'), 'label' => $ec_lang['hw_flow']),
	),
	//Results
	Array(
		Array('name' => 'a', 'units' => Array('m2','mm2','ft2','in2'), 'label' => $ec_lang['hw_flow_area']),
		Array('name' => 'pw', 'units' => Array('m','mm','ft','in'), 'label' => $ec_lang['hw_wetted_perimeter']),
		Array('name' => 'rh', 'units' => Array('m','mm','ft','in'), 'label' => $ec_lang['hw_hydraulic_radius']),
		Array('name' => 'v', 'units' => Array('mps','ftps','mph'), 'label' => $ec_lang['hw_velocity']),
		Array('name' => 'hv', 'units' => Array('mh2o','mmh2o','kpa','fth2o','inh2o','psi'), 'label' => $ec_lang['hw_velocity_head']),
		...
		Array('name' => 'hf', 'units' => Array('mh2o','mmh2o','kpa','fth2o','inh2o','psi'), 'label' => $ec_lang['hw_friction_loss']),
		Array('name' => 'hm', 'units' => Array('mh2o','mmh2o','kpa','fth2o','inh2o','psi'), 'label' => $ec_lang['hw_minor_loss']),
		Array('name' => 'hl', 'units' => Array('mh2o','mmh2o','kpa','fth2o','inh2o','psi'), 'label' => $ec_lang['hw_total_loss']),
	)
);
?>
...
EngCalcs.pageCalculator = function(f) {
	...
	rh = d / 4;
	v = q / a;
	sf = 7.8828 / Math.pow(d, 4.8704) * Math.pow(q / (k * c), 1.852);
	...
	hv = v * v / (2 * g) * (1000 * g);
	hf = sf * l  * (1000 * g);
	// From 7.8828/d^4.8704 * (Q/(k*C))^1.852
	hm = hv * k;
	hl = +hf + +hm;
