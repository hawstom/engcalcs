...
<p class="collapse show d-print-none" id="relatedCalcs">
	<?=$ec_lang['ec_related_calcs']?> <a href="<?=EC_LWN_APP_URL?>">LibreWaterNet.org</a> &middot; <a href="Branched-Network.php"><?=$ec_lang['bpn_main_menu']?></a> &middot; <a href="Darcy-Weisbach.php"><?=$ec_lang['dw_main_menu']?></a> &middot; <a href="Manning-Pipe-Head-Loss.php"><?=$ec_lang['mphl_main_menu']?></a> &middot; <a href="Manning-Pipe-Flow.php"><?=$ec_lang['mpf_main_menu']?></a> <a data-bs-toggle="collapse" href="#relatedCalcs" aria-expanded="true" aria-controls="relatedCalcs"><?=$ec_lang['view_hide_line']?></a>
</p>
<?php
echoCalculatorForm(
	//Inputs
	Array(
		...
		Array('name' => 'c', 'type' => 'number', 'default' => '130', 'units' => NULL, 'label' => '<a target="_blank" rel="noopener" href="'.ecRefUrl('hazen_williams_c').'">'.$ec_lang['hw_roughness'].'</a>'),
