...
<p class="collapse show d-print-none" id="relatedCalcs">
	<?=$ec_lang['ec_related_calcs']?> <a href="Branched-Network.php"><?=$ec_lang['bpn_main_menu']?></a> &middot; <a href="<?=EC_LWN_APP_URL?>">LibreWaterNet.org</a> <a data-bs-toggle="collapse" href="#relatedCalcs" aria-expanded="true" aria-controls="relatedCalcs"><?=$ec_lang['view_hide_line']?></a>
</p>
<?php
echoCalculatorForm(
	// Inputs
