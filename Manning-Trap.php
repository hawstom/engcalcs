...
echoCalculatorForm(
	...
	Array(
		...
		Array('d50_strickler', Array('m', 'mm', 'ft', 'in'), 'Implied riprap size per Strickler based on n (Adjust n so this equals your design lining.)'),
		Array('d50_bottom', Array('m', 'mm', 'ft', 'in'), 'Required bottom angular riprap size, D50, <small>per Isbash (1936), Robinson, and Maricopa County, Arizona, US</small>'),
		Array('d50_z1', Array('m', 'mm', 'ft', 'in'), 'Required side slope 1 angular riprap size, D50, <small>per Isbash (1936), Robinson, and Maricopa County, Arizona, US</small>'),
		Array('d50_z2', Array('m', 'mm', 'ft', 'in'), 'Required side slope 2 angular riprap size, D50, <small>per Isbash (1936), Robinson, and Maricopa County, Arizona, US</small>'),
