...
echoCalculatorForm(
	...
	Array(
		...
		Array('name' => 'n_in', 'type' => 'number', 'default' => '0.025', 'units' => NULL, 'label' => ecLinkTipLabel(ecRefUrl('manning_n'), $ec_lang['mpf_manningRoughness'], $ec_lang['mtc_iteration_tip']).'<br /> <input type="radio" name="n_radio" id="n_radio_strickler" value="strickler" onchange="EngCalcs.submitForm()" /><label for="n_radio_strickler">Strickler</label> <input type="radio" name="n_radio" id="n_radio_bb" value="bb" onchange="EngCalcs.submitForm()" /><label for="n_radio_bb">B/B</label> <input type="radio" name="n_radio" id="n_radio_pi" value="pi" onchange="EngCalcs.submitForm()" /><label for="n_radio_pi">P&amp;I</label>'),
