...
echoCalculatorForm(
	...
	Array(
		...
		Array('name' => 'e',      'type' => 'number', 'default' => Array('us' => '0.00015', 'si' => '0.05'), 'units' => 'roughness',         'label' => ecLinkTipLabel(ecRefUrl('darcy_weisbach_e'), $ec_lang['dw_roughness'], $ec_lang['dw_roughness_tip'])),
