...
echoCalculatorForm(
	...
	Array(
		...
		Array('name' => 'km',     'type' => 'number', 'default' => '1.5',  'units' => NULL,                             'label' => '<a target="_blank" href="https://www.engineeringtoolbox.com/minor-loss-coefficients-pipes-d_626.html">'.$ec_lang['mphl_total_junction_k_short'].'</a><span class="ec-help" title="'.htmlspecialchars(strip_tags($ec_lang['mphl_total_junction_k']).' '.$ec_lang['mpf_see_notes']).'"><span class="ec-tip">?</span></span>'),
