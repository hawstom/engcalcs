...
EngCalcs.pageConfig = {
	...
	lpn_profile_edit_say: <?=json_encode($ec_lang['lpn_profile_edit_say'])?>,
...
<?php   // Every example card's title and description, emitted BY PATTERN rather than one line each.
	...
	lpn_ff_hydrant_node: <?=json_encode($ec_lang['lpn_ff_hydrant_node'])?>,
	lpn_ff_hydrant_node_tip: <?=json_encode($ec_lang['lpn_ff_hydrant_node_tip'])?>,
	lpn_ff_no_junctions: <?=json_encode($ec_lang['lpn_ff_no_junctions'])?>,
	lpn_ff_lateral_length: <?=json_encode($ec_lang['lpn_ff_lateral_length'])?>,
	lpn_ff_lateral_length_tip: <?=json_encode($ec_lang['lpn_ff_lateral_length_tip'])?>,
	lpn_ff_residual: <?=json_encode($ec_lang['lpn_ff_residual'])?>,
	lpn_ff_residual_tip: <?=json_encode($ec_lang['lpn_ff_residual_tip'])?>,
	lpn_ff_critical: <?=json_encode($ec_lang['lpn_ff_critical'])?>,
	lpn_ff_critical_outlet: <?=json_encode($ec_lang['lpn_ff_critical_outlet'])?>,
	lpn_ff_critical_tip: <?=json_encode($ec_lang['lpn_ff_critical_tip'])?>,
	lpn_ff_assumptions: <?=json_encode($ec_lang['lpn_ff_assumptions'])?>,
	lpn_ff_assumptions_intro: <?=json_encode($ec_lang['lpn_ff_assumptions_intro'])?>,
	lpn_ff_lateral_diameter: <?=json_encode($ec_lang['lpn_ff_lateral_diameter'])?>,
	lpn_ff_lateral_diameter_tip: <?=json_encode($ec_lang['lpn_ff_lateral_diameter_tip'])?>,
	lpn_ff_lateral_roughness: <?=json_encode($ec_lang['lpn_ff_lateral_roughness'])?>,
	lpn_ff_lateral_roughness_tip: <?=json_encode($ec_lang['lpn_ff_lateral_roughness_tip'])?>,
	lpn_ff_barrel_diameter: <?=json_encode($ec_lang['lpn_ff_barrel_diameter'])?>,
	lpn_ff_barrel_diameter_tip: <?=json_encode($ec_lang['lpn_ff_barrel_diameter_tip'])?>,
	lpn_ff_barrel_length: <?=json_encode($ec_lang['lpn_ff_barrel_length'])?>,
	lpn_ff_barrel_length_tip: <?=json_encode($ec_lang['lpn_ff_barrel_length_tip'])?>,
	lpn_ff_barrel_roughness: <?=json_encode($ec_lang['lpn_ff_barrel_roughness'])?>,
	lpn_ff_barrel_roughness_tip: <?=json_encode($ec_lang['lpn_ff_barrel_roughness_tip'])?>,
	lpn_ff_k_tip: <?=json_encode($ec_lang['lpn_ff_k_tip'])?>,
	lpn_ff_k_label: <?=json_encode($ec_lang['lpn_ff_k_label'])?>,
	lpn_ff_k_default: <?=json_encode($ec_lang['lpn_ff_k_default'])?>,
	lpn_ff_k_reference_supplied: <?=json_encode($ec_lang['lpn_ff_k_reference_supplied'])?>,
	lpn_ff_k_part_awwa: <?=json_encode($ec_lang['lpn_ff_k_part_awwa'])?>,
	lpn_ff_k_part_fittings: <?=json_encode($ec_lang['lpn_ff_k_part_fittings'])?>,
	lpn_ff_calculate: <?=json_encode($ec_lang['lpn_ff_calculate'])?>,
	lpn_ff_back: <?=json_encode($ec_lang['lpn_ff_back'])?>,
	...
	lpn_ff_result_flow: <?=json_encode($ec_lang['lpn_ff_result_flow'])?>,
	lpn_ff_result_at: <?=json_encode($ec_lang['lpn_ff_result_at'])?>,
	lpn_ff_result_static: <?=json_encode($ec_lang['lpn_ff_result_static'])?>,
	lpn_ff_result_solves: <?=json_encode($ec_lang['lpn_ff_result_solves'])?>,
	lpn_ff_iso: <?=json_encode($ec_lang['lpn_ff_iso'])?>,
	lpn_ff_iso_exceeded: <?=json_encode($ec_lang['lpn_ff_iso_exceeded'])?>,
	lpn_ff_used: <?=json_encode($ec_lang['lpn_ff_used'])?>,
	lpn_ff_source_supplied: <?=json_encode($ec_lang['lpn_ff_source_supplied'])?>,
	lpn_ff_source_default: <?=json_encode($ec_lang['lpn_ff_source_default'])?>,
	lpn_ff_err_length: <?=json_encode($ec_lang['lpn_ff_err_length'])?>,
	lpn_ff_err_at_rest: <?=json_encode($ec_lang['lpn_ff_err_at_rest'])?>,
	lpn_ff_err_ceiling: <?=json_encode($ec_lang['lpn_ff_err_ceiling'])?>,
	lpn_ff_err_converge: <?=json_encode($ec_lang['lpn_ff_err_converge'])?>,
	lpn_ff_err_solve: <?=json_encode($ec_lang['lpn_ff_err_solve'])?>,
	lpn_ff_err_no_hydrant: <?=json_encode($ec_lang['lpn_ff_err_no_hydrant'])?>,
	lpn_ff_err_no_critical: <?=json_encode($ec_lang['lpn_ff_err_no_critical'])?>,
