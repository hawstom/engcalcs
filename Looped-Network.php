...
<?php   // Every example card's title and description, emitted BY PATTERN rather than one line each.
	...
	lpn_field_text_all_zoom: <?=json_encode($ec_lang['lpn_field_text_all_zoom'])?>,
	lpn_field_text_all_zoom_tip: <?=json_encode($ec_lang['lpn_field_text_all_zoom_tip'])?>,
	...
	lpn_labels_restore: <?=json_encode($ec_lang['lpn_labels_restore'])?>,
	lpn_labels_restore_tip: <?=json_encode($ec_lang['lpn_labels_restore_tip'])?>,
	lpn_confirm_labels_restore: <?=json_encode($ec_lang['lpn_confirm_labels_restore'])?>,
