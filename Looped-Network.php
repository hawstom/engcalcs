...
EngCalcs.pageConfig = {
	...
	lpn_new_blank: <?=json_encode($ec_lang['lpn_new_blank'])?>,
	lpn_new_from_examples: <?=json_encode($ec_lang['lpn_new_from_examples'])?>,
	lpn_new_example_us: <?=json_encode($ec_lang['lpn_new_example_us'])?>,
	lpn_new_example_si: <?=json_encode($ec_lang['lpn_new_example_si'])?>,
	...
	lpn_file_reconnect_prompt: <?=json_encode($ec_lang['lpn_file_reconnect_prompt'])?>,
