...
<?php   // Every example card's title and description, emitted BY PATTERN rather than one line each.
	...
	lpn_labels_hide_all: <?=json_encode($ec_lang['lpn_labels_hide_all'])?>,
	lpn_labels_hide_all_tip: <?=json_encode($ec_lang['lpn_labels_hide_all_tip'])?>,
	lpn_labels_hide_all_note: <?=json_encode($ec_lang['lpn_labels_hide_all_note'])?>,
