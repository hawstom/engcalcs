...
EngCalcs.pageConfig = {
	...
	lpn_find_op_conn_any: <?=json_encode($ec_lang['lpn_find_op_conn_any'])?>,
	lpn_find_op_conn_unlinked: <?=json_encode($ec_lang['lpn_find_op_conn_unlinked'])?>,
	lpn_find_op_conn_closed: <?=json_encode($ec_lang['lpn_find_op_conn_closed'])?>,
	lpn_find_op_conn_nosource: <?=json_encode($ec_lang['lpn_find_op_conn_nosource'])?>,
	lpn_find_conn_unlinked: <?=json_encode($ec_lang['lpn_find_conn_unlinked'])?>,
	lpn_find_conn_closed: <?=json_encode($ec_lang['lpn_find_conn_closed'])?>,
	lpn_find_conn_nosource: <?=json_encode($ec_lang['lpn_find_conn_nosource'])?>,
