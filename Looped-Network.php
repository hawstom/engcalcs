...
EngCalcs.pageConfig = {
	...
	lpn_tool_area_tip: <?=json_encode($ec_lang['lpn_tool_area_tip'])?>,
	lpn_area_selected: <?=json_encode($ec_lang['lpn_area_selected'])?>,
	lpn_area_none: <?=json_encode($ec_lang['lpn_area_none'])?>,
	...
	lpn_units_nondestructive: <?=json_encode($ec_lang['lpn_units_nondestructive'])?>,
	lpn_units_nondestructive_desc: <?=json_encode($ec_lang['lpn_units_nondestructive_desc'])?>,
	lpn_units_destructive: <?=json_encode($ec_lang['lpn_units_destructive'])?>,
	lpn_units_destructive_desc: <?=json_encode($ec_lang['lpn_units_destructive_desc'])?>,
	...
	lpn_find_prop_demand_desc: <?=json_encode($ec_lang['lpn_find_prop_demand_desc'])?>,
	...
	lpn_find_query_label: <?=json_encode($ec_lang['lpn_find_query_label'])?>,
	lpn_find_query_hint: <?=json_encode($ec_lang['lpn_find_query_hint'])?>,
	lpn_find_q_and: <?=json_encode($ec_lang['lpn_find_q_and'])?>,
	...
	lpn_find_q_err_dot: <?=json_encode($ec_lang['lpn_find_q_err_dot'])?>,
	lpn_find_q_err_prop: <?=json_encode($ec_lang['lpn_find_q_err_prop'])?>,
	lpn_find_q_err_op: <?=json_encode($ec_lang['lpn_find_q_err_op'])?>,
	lpn_find_q_err_value: <?=json_encode($ec_lang['lpn_find_q_err_value'])?>,
	lpn_find_q_err_quote: <?=json_encode($ec_lang['lpn_find_q_err_quote'])?>,
	lpn_find_q_err_quote_end: <?=json_encode($ec_lang['lpn_find_q_err_quote_end'])?>,
	lpn_find_q_err_close: <?=json_encode($ec_lang['lpn_find_q_err_close'])?>,
	lpn_find_q_err_open: <?=json_encode($ec_lang['lpn_find_q_err_open'])?>,
	lpn_find_q_err_end: <?=json_encode($ec_lang['lpn_find_q_err_end'])?>,
	...
	lpn_replace_btn: <?=json_encode($ec_lang['lpn_replace_btn'])?>,
	lpn_replace_preview: <?=json_encode($ec_lang['lpn_replace_preview'])?>,
	lpn_replace_apply: <?=json_encode($ec_lang['lpn_replace_apply'])?>,
	lpn_replace_done: <?=json_encode($ec_lang['lpn_replace_done'])?>,
	lpn_replace_none: <?=json_encode($ec_lang['lpn_replace_none'])?>,
	lpn_replace_no_value: <?=json_encode($ec_lang['lpn_replace_no_value'])?>,
	...
	lpn_profile_tap_start: <?=json_encode($ec_lang['lpn_profile_tap_start'])?>,
	lpn_profile_tap_more: <?=json_encode($ec_lang['lpn_profile_tap_more'])?>,
	lpn_profile_say_idle: <?=json_encode($ec_lang['lpn_profile_say_idle'])?>,
	lpn_profile_none: <?=json_encode($ec_lang['lpn_profile_none'])?>,
	...
	lpn_profile_edit_click: <?=json_encode($ec_lang['lpn_profile_edit_click'])?>,
	lpn_profile_edit_tap: <?=json_encode($ec_lang['lpn_profile_edit_tap'])?>,
	lpn_profile_edit_nowhere: <?=json_encode($ec_lang['lpn_profile_edit_nowhere'])?>,
	...
	lpn_time_play_tip: <?=json_encode($ec_lang['lpn_time_play_tip'])?>,
	lpn_time_pause_tip: <?=json_encode($ec_lang['lpn_time_pause_tip'])?>,
...
<?php   // The run box (Task 450). Three new strings; `lpn_time_running` above says what it says
	...
	lpn_time_run_report_copy: <?=json_encode($ec_lang['lpn_time_run_report_copy'])?>,
	lpn_time_run_report_copied: <?=json_encode($ec_lang['lpn_time_run_report_copied'])?>,
...
<?php // Libraries (Tasks 462/460). ?>
	...
	lpn_library_curve_copy_manual: <?=json_encode($ec_lang['lpn_library_curve_copy_manual'])?>,
	lpn_library_curve_used_by: <?=json_encode($ec_lang['lpn_library_curve_used_by'])?>,
	lpn_library_curve_unused: <?=json_encode($ec_lang['lpn_library_curve_unused'])?>,
	lpn_library_curve_in_use: <?=json_encode($ec_lang['lpn_library_curve_in_use'])?>,
	lpn_library_curve_x: <?=json_encode($ec_lang['lpn_library_curve_x'])?>,
	lpn_library_curve_y: <?=json_encode($ec_lang['lpn_library_curve_y'])?>,
<?php // The pipe type library (Task 465). ?>
	lpn_library_pipetypes: <?=json_encode($ec_lang['lpn_library_pipetypes'])?>,
	lpn_library_pipetypes_tip: <?=json_encode($ec_lang['lpn_library_pipetypes_tip'])?>,
	lpn_library_pipetypes_note: <?=json_encode($ec_lang['lpn_library_pipetypes_note'])?>,
	lpn_library_pipetype_add: <?=json_encode($ec_lang['lpn_library_pipetype_add'])?>,
	lpn_library_pipetype_blank_tip: <?=json_encode($ec_lang['lpn_library_pipetype_blank_tip'])?>,
	lpn_library_pipetype_used_by: <?=json_encode($ec_lang['lpn_library_pipetype_used_by'])?>,
	lpn_library_pipetype_unused: <?=json_encode($ec_lang['lpn_library_pipetype_unused'])?>,
	lpn_library_pipetype_in_use: <?=json_encode($ec_lang['lpn_library_pipetype_in_use'])?>,
	lpn_field_pipetype: <?=json_encode($ec_lang['lpn_field_pipetype'])?>,
	lpn_field_pipetype_tip: <?=json_encode($ec_lang['lpn_field_pipetype_tip'])?>,
	...
	lpn_field_pump_speed: <?=json_encode($ec_lang['lpn_field_pump_speed'])?>,
	lpn_field_pump_speed_tip: <?=json_encode($ec_lang['lpn_field_pump_speed_tip'])?>,
...
<?php   // Every example card's title and description, emitted BY PATTERN rather than one line each.
	...
	lpn_field_text_attached_tip: <?=json_encode($ec_lang['lpn_field_text_attached_tip'])?>,
	...
	// The addresses themselves live in lib/References.lib.php, which every page that links one
	// of these tables now reads from (Task 500). The KEYS here are the pageConfig contract.
...
<?php // **A KEY THAT WAS TRANSLATED INTO ALL 26 AND NEVER REACHED THE PAGE.** The Labels panel read
	...
	lpn_pump_curve_source_tip: <?=json_encode($ec_lang['lpn_pump_curve_source_tip'])?>,
...
<?php   // The Task 608 pair: the wait a reader is currently in, and the one failure a background
	...
	lpn_diag_not_converged_error: <?=json_encode($ec_lang['lpn_diag_not_converged_error'])?>,
	...
	lpn_result_avg_water_age: <?=json_encode($ec_lang['lpn_result_avg_water_age'])?>,
	...
	lpn_source_type_flowpaced: <?=json_encode($ec_lang['lpn_source_type_flowpaced'])?>,
	lpn_source_quality: <?=json_encode($ec_lang['lpn_source_quality'])?>,
	lpn_source_quality_tip: <?=json_encode($ec_lang['lpn_source_quality_tip'])?>,
	lpn_source_pattern: <?=json_encode($ec_lang['lpn_source_pattern'])?>,
	lpn_source_pattern_tip: <?=json_encode($ec_lang['lpn_source_pattern_tip'])?>,
	lpn_mixing_model: <?=json_encode($ec_lang['lpn_mixing_model'])?>,
	lpn_mixing_model_tip: <?=json_encode($ec_lang['lpn_mixing_model_tip'])?>,
	lpn_mixing_mixed: <?=json_encode($ec_lang['lpn_mixing_mixed'])?>,
	lpn_mixing_2comp: <?=json_encode($ec_lang['lpn_mixing_2comp'])?>,
	lpn_mixing_fifo: <?=json_encode($ec_lang['lpn_mixing_fifo'])?>,
	lpn_mixing_lifo: <?=json_encode($ec_lang['lpn_mixing_lifo'])?>,
	lpn_mixing_fraction: <?=json_encode($ec_lang['lpn_mixing_fraction'])?>,
	lpn_mixing_fraction_tip: <?=json_encode($ec_lang['lpn_mixing_fraction_tip'])?>,
	lpn_reaction_bulk: <?=json_encode($ec_lang['lpn_reaction_bulk'])?>,
	lpn_reaction_bulk_tip: <?=json_encode($ec_lang['lpn_reaction_bulk_tip'])?>,
	lpn_reaction_wall: <?=json_encode($ec_lang['lpn_reaction_wall'])?>,
	lpn_reaction_wall_tip: <?=json_encode($ec_lang['lpn_reaction_wall_tip'])?>,
	lpn_reaction_order_bulk: <?=json_encode($ec_lang['lpn_reaction_order_bulk'])?>,
	lpn_reaction_order_bulk_tip: <?=json_encode($ec_lang['lpn_reaction_order_bulk_tip'])?>,
	lpn_reaction_order_tank: <?=json_encode($ec_lang['lpn_reaction_order_tank'])?>,
	lpn_reaction_order_tank_tip: <?=json_encode($ec_lang['lpn_reaction_order_tank_tip'])?>,
	lpn_reaction_order_wall: <?=json_encode($ec_lang['lpn_reaction_order_wall'])?>,
	lpn_reaction_order_wall_tip: <?=json_encode($ec_lang['lpn_reaction_order_wall_tip'])?>,
	lpn_reaction_order_unstated: <?=json_encode($ec_lang['lpn_reaction_order_unstated'])?>,
	lpn_reaction_order_zero: <?=json_encode($ec_lang['lpn_reaction_order_zero'])?>,
	lpn_reaction_order_first: <?=json_encode($ec_lang['lpn_reaction_order_first'])?>,
	lpn_reaction_limiting: <?=json_encode($ec_lang['lpn_reaction_limiting'])?>,
	lpn_reaction_limiting_tip: <?=json_encode($ec_lang['lpn_reaction_limiting_tip'])?>,
	lpn_reaction_rough_corr: <?=json_encode($ec_lang['lpn_reaction_rough_corr'])?>,
	lpn_reaction_rough_corr_tip: <?=json_encode($ec_lang['lpn_reaction_rough_corr_tip'])?>,
	lpn_reaction_pipe_tip: <?=json_encode($ec_lang['lpn_reaction_pipe_tip'])?>,
	lpn_reaction_tank: <?=json_encode($ec_lang['lpn_reaction_tank'])?>,
	lpn_reaction_tank_tip: <?=json_encode($ec_lang['lpn_reaction_tank_tip'])?>,
	lpn_reaction_bulk_short: <?=json_encode($ec_lang['lpn_reaction_bulk_short'])?>,
	lpn_reaction_wall_short: <?=json_encode($ec_lang['lpn_reaction_wall_short'])?>,
	lpn_reaction_tank_short: <?=json_encode($ec_lang['lpn_reaction_tank_short'])?>,
	...
	lpn_ff_col_static_tip: <?=json_encode($ec_lang['lpn_ff_col_static_tip'])?>,
	...
	lpn_ff_static_failed: <?=json_encode($ec_lang['lpn_ff_static_failed'])?>,
	lpn_ff_col_modes: <?=json_encode($ec_lang['lpn_ff_col_modes'])?>,
	lpn_ff_mode_fire: <?=json_encode($ec_lang['lpn_ff_mode_fire'])?>,
...
<?php // Help > Install, the door that moved off the suite navbar with the divorce (Task 625).
	...
	lpn_inp_drop_head_pattern: <?=json_encode($ec_lang['lpn_inp_drop_head_pattern'])?>,
	...
	lpn_import_notes_heading: <?=json_encode($ec_lang['lpn_import_notes_heading'])?>,
...
<?php // Scenarios (ROADMAP Task 184) -- the selector/readout in the map's status strip, the
	...
	lpn_scenario_mark_tip: <?=json_encode($ec_lang['lpn_scenario_mark_tip'])?>,
	lpn_scenario_overrides_tip: <?=json_encode($ec_lang['lpn_scenario_overrides_tip'])?>,
...
<?php // **ELEVATION ON CREATION** (Task 542). The row is built only on a geographic project with a
	...
	lpn_elev_dem_none: <?=json_encode($ec_lang['lpn_elev_dem_none'])?>,
...
<?php   // EPANET said no (Task 471), and the controls it would have said no over (Task 466). ?>
	...
	lpn_settings_show_arrows: <?=json_encode($ec_lang['lpn_settings_show_arrows'])?>,
	lpn_settings_show_arrows_tip: <?=json_encode($ec_lang['lpn_settings_show_arrows_tip'])?>,
	...
	lpn_settings_snap_off: <?=json_encode($ec_lang['lpn_settings_snap_off'])?>,
...
<?php   // Place-name search and terrain elevations (Task 507). js/lpn-search.js and
        // js/lpn-terrain.js read these by BRACKET lookup on EngCalcs.pageConfig, so
        // dev/scripts/pageconfig_check.php cannot see them -- each site carries its English
        // literal as the fallback, which is what shipped before these keys existed and is what a
        // missing entry here degrades to. Every string either feature shows is in this list,
        // consent dialogs included: a permission question in a language the reader does not have
        // is not a permission question. ?>
	lpn_search_menu: <?=json_encode($ec_lang['lpn_search_menu'])?>,
	lpn_search_tip: <?=json_encode($ec_lang['lpn_search_tip'])?>,
	lpn_search_bar: <?=json_encode($ec_lang['lpn_search_bar'])?>,
	lpn_search_consent_1: <?=json_encode($ec_lang['lpn_search_consent_1'])?>,
	lpn_search_consent_2: <?=json_encode($ec_lang['lpn_search_consent_2'])?>,
	lpn_search_consent_3: <?=json_encode($ec_lang['lpn_search_consent_3'])?>,
	lpn_search_consent_4: <?=json_encode($ec_lang['lpn_search_consent_4'])?>,
	lpn_search_refused: <?=json_encode($ec_lang['lpn_search_refused'])?>,
	lpn_search_prompt: <?=json_encode($ec_lang['lpn_search_prompt'])?>,
	lpn_search_empty: <?=json_encode($ec_lang['lpn_search_empty'])?>,
	lpn_search_working: <?=json_encode($ec_lang['lpn_search_working'])?>,
	lpn_search_busy: <?=json_encode($ec_lang['lpn_search_busy'])?>,
	lpn_search_choose: <?=json_encode($ec_lang['lpn_search_choose'])?>,
	lpn_search_nochoice: <?=json_encode($ec_lang['lpn_search_nochoice'])?>,
	lpn_search_badchoice: <?=json_encode($ec_lang['lpn_search_badchoice'])?>,
	lpn_search_none: <?=json_encode($ec_lang['lpn_search_none'])?>,
	lpn_search_rate: <?=json_encode($ec_lang['lpn_search_rate'])?>,
	lpn_search_http: <?=json_encode($ec_lang['lpn_search_http'])?>,
	lpn_search_timeout: <?=json_encode($ec_lang['lpn_search_timeout'])?>,
	lpn_search_unreadable: <?=json_encode($ec_lang['lpn_search_unreadable'])?>,
	...
	lpn_terrain_consent_3: <?=json_encode($ec_lang['lpn_terrain_consent_3'])?>,
	lpn_terrain_consent_4: <?=json_encode($ec_lang['lpn_terrain_consent_4'])?>,
	lpn_terrain_refused: <?=json_encode($ec_lang['lpn_terrain_refused'])?>,
	lpn_terrain_confirm: <?=json_encode($ec_lang['lpn_terrain_confirm'])?>,
	lpn_terrain_confirm_default_1: <?=json_encode($ec_lang['lpn_terrain_confirm_default_1'])?>,
	lpn_terrain_confirm_default_2: <?=json_encode($ec_lang['lpn_terrain_confirm_default_2'])?>,
	lpn_terrain_keep: <?=json_encode($ec_lang['lpn_terrain_keep'])?>,
...
<?php   // Reading a surveyed point list (Task 592). js/lpn-survey.js reads these through a pageConfig
	...
	lpn_survey_column_n: <?=json_encode($ec_lang['lpn_survey_column_n'])?>,
	...
	lpn_survey_err_no_coords: <?=json_encode($ec_lang['lpn_survey_err_no_coords'])?>,
	...
	lpn_survey_format_hint: <?=json_encode($ec_lang['lpn_survey_format_hint'])?>,
	lpn_survey_create: <?=json_encode($ec_lang['lpn_survey_create'])?>,
	lpn_survey_fmt_pnezd: <?=json_encode($ec_lang['lpn_survey_fmt_pnezd'])?>,
	lpn_survey_fmt_penzd: <?=json_encode($ec_lang['lpn_survey_fmt_penzd'])?>,
	lpn_survey_fmt_pnez: <?=json_encode($ec_lang['lpn_survey_fmt_pnez'])?>,
	lpn_survey_fmt_penz: <?=json_encode($ec_lang['lpn_survey_fmt_penz'])?>,
	lpn_survey_fmt_nezd: <?=json_encode($ec_lang['lpn_survey_fmt_nezd'])?>,
	lpn_survey_fmt_enzd: <?=json_encode($ec_lang['lpn_survey_fmt_enzd'])?>,
	lpn_survey_fmt_nez: <?=json_encode($ec_lang['lpn_survey_fmt_nez'])?>,
	lpn_survey_fmt_enz: <?=json_encode($ec_lang['lpn_survey_fmt_enz'])?>,
	lpn_survey_from_header: <?=json_encode($ec_lang['lpn_survey_from_header'])?>,
	lpn_survey_from_format: <?=json_encode($ec_lang['lpn_survey_from_format'])?>,
