...
**2 still to read**, of 9 untranslated keys, of 1778 English keys. A key already marked _Ruled OK_ below needs nothing from you;
...
- **`lpn_menu_cue`**
  > Every command is in the menus above.
  @@ NEEDS RULING
