...
**2 still to read on master**, of 184 untranslated keys, of 2034 English keys. **A branch section follows if anything is waiting there.** A key already marked _Ruled OK_ below needs nothing from you;
...
## lpn_  (184, 2 to read @@ NEEDS RULING)
...
**74 still to read**, of 97 new keys across 17 unmerged branch(es).
...
### feat/convert-as (`0efb47fd`) — 28 new, 28 to read @@ NEEDS RULING
...
### feat/customer-node (`61bd2109`) — adds no English strings
...
### feat/table-editing (`889888e8`) — 17 new, 17 to read @@ NEEDS RULING
...
### merge/0925 (`30d7b174`) — 1 new, 1 to read @@ NEEDS RULING
