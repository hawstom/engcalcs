...
**80 still to read on master**, of 140 untranslated keys, of 2008 English keys. **A branch section follows if anything is waiting there.** A key already marked _Ruled OK_ below needs nothing from you;
...
## lpn_  (140, 80 to read @@ NEEDS RULING)
...
**55 still to read**, of 70 new keys across 8 unmerged branch(es).
...
### feat/engine-fetch-wait (`1a783fa3`) — adds no English strings
