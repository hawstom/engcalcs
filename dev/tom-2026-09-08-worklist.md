...
- 186, 266, 603 done: 186 and 603 CLOSED. 266 stays open until the lpn batch lands (RUNNING).
...
- Non-hog boxes survive reload: RUNNING.
- Shift+Enter: answered (standard in Excel, Calc, Sheets). DONE.
- 266 follow-ups (1)-(8): RUNNING.
...
- Favicons: first round rejected by Tom; retry on WT-WIDE and WT-TALL-3 with catwalk RUNNING.
...
- Unselect with Esc: RUNNING (lpn batch).
...
- lpn_tool_area_tip rewrite: RUNNING (lpn batch).
