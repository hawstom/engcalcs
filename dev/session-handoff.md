...
- **8105 `feat/table-editing`**: R-254..R-259, the spreadsheet heading (click selects, ⋮ menu,
  ...
  `{project}-{table}`). Back with its agent for the divider harness at dsf 1.25+ and a duplicate
  Cancel key; check its HEAD and suite before telling him it is ready.
