...
const SPECS = ['boot', 'menu', 'files', 'reload', 'locking', 'missing', 'fallback', 'degrade', 'saveas', 'find', 'boxes', 'geo', 'basemap', 'units', 'color', 'profile', 'place', 'goto', 'gallery', 'noscroll', 'labelcols', 'share', 'geohit', 'toolbar', 'visibility', 'perf', 'time', 'search', 'setbox', 'crossproject', 'pane', 'library', 'projectmenu', 'tabcolumn', 'smallscreen', 'mtcbuttons', 'phonemenu', 'hiddenlbl', 'cursorflicker', 'nodehit', 'lblhit', 'areadrag', 'mapscale', 'pan', 'worldmap'];
