...
| **Enforceable and not yet enforced** — the rows below | 27 | The decoration that could stop being decoration. Three landed with this survey, and a fourth (row 3b) the same day, from a defect the survey's own row 1 sibling had been blind to. |
