...
//
// **WHAT THE MEASUREMENT LED TO, 2026-09-22: THE LATTICE STAYS BLIND, ON PURPOSE.** Scaling it with
// the box was built and measured (section 20b) -- it stacked wide labels and moved and hid more of
// everything else -- so the assertions below still describe the shipped lattice. The fix that
// shipped is room to grow (section 20c, label-prefix-acceptance-harness.js), which leaves every spot
// where it was and changes which one a label is willing to stand on.
