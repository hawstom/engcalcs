...
| `dev/enforceable-rules-survey.md` | Which of this file's rules a script COULD hold, ranked, with the count: 63 enforced, 4 left that no blocking check can hold, 41 permanently prose (Task 322) |
