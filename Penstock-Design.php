...
echoCalculatorForm(
	...
	Array(
		...
		Array('name' => 'vel_check',  'units' => NULL,                     'label' => $ec_lang['ps_vel_check'].' '.$ec_lang['mpf_see_notes']),
		...
		Array('name' => 'hl_check',   'units' => NULL,                     'label' => $ec_lang['ps_hl_check'].' '.$ec_lang['mpf_see_notes']),
