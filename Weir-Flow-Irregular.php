...
$html_desc = $ec_lang['wi_main_desc'];
...
echoCalculatorForm(
    ...
    Array(
        ...
        Array('name' => 'cw', 'type' => 'number', 'default' => '3', 'units' => NULL, 'label' => '<a target="_blank" rel="noopener" href="'.ecRefUrl('weir_coefficient').'">'.$ec_lang['ws_weirCoefficient'].'</a>'),
    ),
    //Results
    NULL,
    $flagFormAppend = true,
