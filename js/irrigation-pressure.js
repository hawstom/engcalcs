...
EngCalcs.ipWriteRows = function (objForm) {
	...
	for (i = 0; i < this.rowResults.length; i += 1) {
		...
		document.getElementsByName('v')[i].innerHTML = (r.v * vu).toFixed(4) + EngCalcs.inlineRangeWarnHtml(r.v, EngCalcs.VELOCITY_OK.min, EngCalcs.VELOCITY_OK.max, velocityLabels);
